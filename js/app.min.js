...
!function(){"use strict";function e(e,t,s,n,l,c,o,a,r){e.search={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[],e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.products=[],e.bundles=[];var i=function(){o.getAllProductBundle().then(function(t){return 200==t.statusCode&&t.response.success?(e.bundles=t.response.result,void(e.bundlecopy=angular.copy(e.bundles))):void c.error(t.response.msg,"Error")})};e.edit=function(e){n.go("main.products-add",{p_id:e})},e.searchData=function(){l(function(){e.$apply(function(){e.bundles=s("filter")(e.bundlecopy,e.txtSearch)}),$(".table").trigger("footable_redraw")},200)},e.refresh=function(){i()},e.updateStatus=function(t){console.log("updateStatus: ",t),e.applicationStatus=t;var n=[];"All"==t?n=e.bundlecopy:"Publish"==t?n=s("filter")(e.bundlecopy,{is_published:1}):"Archived"==t?n=s("filter")(e.bundlecopy,{is_archived:1}):"Draft"==t&&(n=s("filter")(e.bundlecopy,{is_published:0})),l(function(){e.$apply(function(){e.bundles=n}),$(".table").trigger("footable_redraw")},100)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.bundles,function(t){t.selected=e.selectDeselectAll,e.selectSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.pb_id===t.pb_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pb_id!==t.pb_id}),e.selectSomeData=e.selectedDatas.length>0},e.archiveSelected=function(){r.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,l){s.selected&&o.archiveBundle(s.pb_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(c.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&n.reload(),l(),void 0):void c.error(s.response.msg,"Error")})})})},e.publishSelected=function(){r.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,l){s.selected&&o.publishBundle(s.pb_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(c.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&n.reload(),l(),void 0):void c.error(s.response.msg,"Error")})})})},e.refresh()}angular.module("POS17").controller("productBundlesController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","supplierFctry","ngDialog"]}();
!function(){"use strict";function e(e,s,t,o,r,i,n,l,d,c,a,u){e.details={},e.ptypes={},e["package"]={},e.items={},e.list1=[],e.list2=[],e.attributes=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.add=!1,e.displayComposite=!1,e.displayImage=!1,e.txtSearch="";var p=function(){n.getAllProduct().then(function(s){200==s.statusCode&&s.response.success&&(e.list1=s.response.result,e.copy=angular.copy(s.response.result),_.each(e.list1,function(e){e.selected=!1})),e.models={selected:null,lists:{Package:e.list2,Products:e.list1}}})};e.refresh=function(){p()},e.searchData=function(s){e.list1=t("filter")(e.copy,s)},l.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?e.ptypes=s.response.result:o.error(s.response.msg,"Error")}),_.isEmpty(r.pb_id)?(e.showPublish=!1,e.showArchive=!1):(e.displayComposite=!0,e.displayImage=!0,n.getProductBundleDetails(r.pb_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,console.log("$scope.details:",e.details),e.items=s.response.result,e.list2=_.map(_.each(e.items.products,"product_detail"),function(e){return e.product_detail}),e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived))})),e.$watch("models",function(s){e.modelAsJson=s},!0),e.dropCallback=function(s,t,o){if(console.log("dropCallback: "),!_.isUndefined(e.modelAsJson.lists.Package)){var r=_.filter(e.modelAsJson.lists.Package,{p_id:o.p_id}),i=_.filter(e.modelAsJson.lists.Products,{p_id:o.p_id});if(r.length>1)for(var n=e.modelAsJson.lists.Package,l=0;l<n.length;l++){var d=n[l];if(d.p_id==o.p_id)return n.splice(l,1)}if(i.length>1)for(var n=e.modelAsJson.lists.Products,l=0;l<n.length;l++){var d=n[l];d.p_id==o.p_id&&n.splice(l,1)}e.items.products=e.modelAsJson.lists.Package,e.items.products=_.map(e.items.products,function(e){return{product_id:e.p_id}}),console.log("$scope.items.products: ",e.items.products)}},e.remove=function(s){e.list2.splice(s,1),e.items.products.splice(s,1)},e.removeAll=function(s){e.list2=s,_.each(e.list2,function(t){return e.list2.splice(s,1)}),_.each(e.items.products,function(t){return e.items.products.splice(s,1)})},e.openUploader=function(){var e=u.open({animation:!0,templateUrl:"./modules/products/product-bundle.upload.modal.html",controller:"productBundleUploaderModalCtrl",size:"lg",resolve:{product_bundle_id:function(){return r.pb_id}}});e.result.then(function(e){s.reload()})},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.archiveProduct=function(e){n.archiveBundle(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.publishProduct=function(e){n.publishBundle(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.onDragstart=function(e,s){if(e.dragging=!0,s.dataTransfer.setDragImage){var t=new Image;t.src="./images/cargo-128.png",s.dataTransfer.setDragImage(t,0,0)}},e.addProductBundle=function(){r.pb_id&&n.updateProductBundle(r.pb_id,e.items).then(function(e){200==e.statusCode&&e.response.success&&(o.success(e.response.msg,"Success"),s.go(s.current,r,{reload:!0}))})},e.addProduct=function(){r.pb_id?n.updateProductBundle(r.pb_id,e.details).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,o.success(t.response.msg,"Success"),console.log("UPDATE"),e.items=e.details,s.go(s.current,{},{reload:!0}))}):n.saveProductBundle(e.details).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,o.success(t.response.msg,"Success"),s.go(s.current,{pb_id:e.details.pb_id},{reload:!0}),console.log("SUCCESS"),e.items=e.details)})},e.refresh()}angular.module("POS17").controller("productsBundleController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","ngDialog","productFactory","ptypeFactory","storeFactory","priceHistoryFactory","supplierFctry","$uibModal"]}();
!function(){"use strict";function n(n,e,l,o,d,i){if(console.log("productBundleUploaderModalCtrl"),i){var r=n.uploader=new l({url:o+d+"product-bundle/"+i+"/upload-image"});console.log("uploader:",r)}r.filters.push({name:"imageFilter",fn:function(n,e){var l="|"+n.type.slice(n.type.lastIndexOf("/")+1)+"|";return-1!=="|jpg|png|jpeg|bmp|gif|".indexOf(l)}}),r.onAfterAddingFile=function(n){console.log("onAfterAddingFile",n.file)},r.onAfterAddingAll=function(n){var e=[],e=n;_.map(e,function(n){return n.file}),console.log("onAfterAddingAll",e)},n.cancel=function(){e.dismiss("cancel")}}angular.module("POS17").controller("productBundleUploaderModalCtrl",n),n.$inject=["$scope","$uibModalInstance","FileUploader","API_URL","API_VERSION","product_bundle_id"]}();
...
!function(){"use strict";function t(t,e,r,o,c,n,i,a){function s(){a.getAllCategory().then(function(e){if(200==e.statusCode&&e.response.success){for(var r=e.response.result,o=0;o<r.length;o++){var c=r[o],n=c.name,i=c.parent_id,a=c.c_id;l[i]?(c={parentid:i,label:n,item:c},null!=c&&(l[i].items||(l[i].items=[]),l[i].items[l[i].items.length]=c,l[a]=c)):(l[a]={parentid:i,label:n,item:c},u[a]=l[a])}t.categoryData=_(u).omit(_.isUndefined).omit(_.isNull).value(),console.log("categoryData: ",t.categoryData)}})}t.search={},t.currentPage=1,t.entryLimit=5,t.productIsLoading=!0,t.selectDeselectAll=!1,t.applicationStatus="All",t.displayModel="List",t.viewby=25,t.pageSize=t.viewby,t.currentPage=1,t.itemsPerPage=20,t.totalUsers=0,t.categories=[];var u=[],l=[];t.side=!1,s();var d=function(){t.products=[],t.productscopy=[],i.getAllProduct().then(function(e){if(200==e.statusCode&&e.response.success){var r=e.response.result;t.productscopy=angular.copy(r),c(function(){t.$apply(function(){t.products=r,t.totalItems=t.products.length,t.noOfPages=Math.ceil(t.totalItems/t.entryLimit)}),c(function(){t.productIsLoading=!1},800)},200)}else n.error(e.response.msg,"Error")})},p=function(){t.$watch("mytree.currentNode",function(e,r){var o=[],n={},i={};if(t.category=[],t.tree=[],t.currentNode=[],t.mytree&&angular.isObject(t.mytree.currentNode)){t.currentNode=t.mytree.currentNode.item;var a=_.map(t.productscopy,function(e){var r=_.filter(e.product_category,{category_id:t.currentNode.c_id});return r.length>0?_.find(r,function(t){return t}):void 0});i=_.filter(a,function(t){return _.isUndefined(t)?void 0:t}),n=_.map(_.each(i,"product_id"),function(t){return t.product_id}),_.forEach(n,function(e){o.push(_.find(t.productscopy,{p_id:e}))}),c(function(){t.$apply(function(){t.products=o}),$(".table").trigger("footable_redraw")},100)}},!1)};a.getAllCategory().then(function(e){200==e.statusCode&&e.response.success&&(t.categories=e.response.result,console.log("$scope.categories:",t.categories))}),t.setPage=function(e){t.currentPage=e},t.setItemsPerPage=function(e){t.itemsPerPage=e,t.currentPage=1},t.edit=function(t){o.go("main.products-add",{p_id:t})},t.searchData=function(){c(function(){t.$apply(function(){t.products=r("filter")(t.productscopy,t.txtSearch)}),$(".table").trigger("footable_redraw")},200)},t.refresh=function(){t.productIsLoading=!0,d(),p()},t.updateStatus=function(e){t.applicationStatus=e;var o=[];"All"==e?o=t.productscopy:"Publish"==e?o=r("filter")(t.productscopy,{is_published:1}):"Archived"==e?o=r("filter")(t.productscopy,{is_archived:1}):"Draft"==e&&(o=r("filter")(t.productscopy,{is_published:0})),c(function(){t.$apply(function(){t.products=o}),$(".table").trigger("footable_redraw")},100)},t.paginate=function(){$(".table").trigger("footable_redraw")},t.changeSelectDeselectAll=function(){_.each(t.products,function(e){e.selected=t.selectDeselectAll})},t.refresh()}angular.module("POS17").controller("productsController",t),t.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","categoryFactory"]}();

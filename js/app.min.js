...
!function(){"use strict";function t(t,e,r,o,s,u,i,n,a){t.getAllProductAttributes=function(){t.attributes=[],n.getProductAttributes(u.p_id).then(function(e){if(console.log("data: ",e.response),200==e.statusCode&&e.response.success){var r=e.response.result;s(function(){t.$apply(function(){t.attributes=r.attributes,console.log("attributes: ",t.attributes)})})}else o.error(e.response.msg,"Error")})},t.getAllProductAttributes()}angular.module("POS17").controller("productAttributeCtrl",t),t.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","$uibModal","productFactory","attributeFactory"]}();
!function(){"use strict";function t(t,e,r,c,o,s){t.selectDeselectAll=!1,t.applicationStatus="All",t.displayModel="List",t.viewby=25,t.currentPage=1,t.itemsPerPage=25;var u=function(){t.products=[],t.productscopy=[],s.getAllProduct().then(function(e){200==e.statusCode&&e.response.success?(t.products=e.response.result,t.productscopy=angular.copy(t.products),t.totalItems=t.products.length):toastr.error(e.response.msg,"Error")})};t.setPage=function(e){t.currentPage=e},t.setItemsPerPage=function(e){t.itemsPerPage=e,t.currentPage=1},t.edit=function(t){c.go("main.products-add",{p_id:t})},t.searchData=function(){t.products=r("filter")(t.productscopy,t.txtSearch)},t.refresh=function(){u()},t.updateStatus=function(e){t.applicationStatus=e;var c=[];"All"==e?c=t.productscopy:"Publish"==e?c=r("filter")(t.productscopy,{is_published:1}):"Archived"==e?c=r("filter")(t.productscopy,{is_archived:1}):"Draft"==e&&(c=r("filter")(t.productscopy,{is_published:0})),o(function(){t.$apply(function(){t.products=c}),$(".table").trigger("footable_redraw")},100)},t.paginate=function(){$(".table").trigger("footable_redraw")},t.changeSelectDeselectAll=function(){_.each(t.products,function(e){e.selected=t.selectDeselectAll})},t.refresh()}angular.module("POS17").controller("productsController",t),t.$inject=["$scope","$http","$filter","$state","$timeout","productFactory"]}();
...
!function(){"use strict";function t(t,r,n){return{getAllAttribute:function(){return t.all("attributes").customGET().then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},getAllAttributeDetails:function(r){return t.all("attributes").customGET(r).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},getAllAttributeGroupDetails:function(r){return t.all("attributegroup").customGET(r).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},saveAttributeGroup:function(r){return t.all("attributegroup").customPOST(r).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},deleteAttribute:function(r){return t.all("attributes").customDELETE(r).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},updateAttributeGroup:function(r,e){return t.all("attributegroup/"+r).customPUT(e).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},getAllAttributeGroup:function(){return t.all("attributegroup").customGET().then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},deleteAttributeGroup:function(r){return t.all("attributegroup").customDELETE(r).then(function(t){return t},function(t){return t.data})},getAllAttributeTypes:function(){return t.all("attributeTypes").customGET().then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},saveAttribute:function(r){return t.all("attributes").customPOST(r).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},updateAttribute:function(r,e){return t.all("attributes/"+r).customPUT(e).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})}}}angular.module("POS17").factory("attributeFactory",t),t.$inject=["Restangular","API_URL","toastr"]}();

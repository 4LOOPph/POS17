!function(){"use strict";angular.module("POS17",["ngSanitize","ngAnimate","ui.router","chart.js","angular-flot","ui.bootstrap","textAngular","ngFileUpload","ui.footable","restangular","toastr","angularMoment","angularSpinner","ngDialog","ui.select","mgcrea.ngStrap","LocalStorageModule","dibari.angular-ellipsis"]).constant("API_URL","http://52.64.27.145:5001").constant("API_VERSION","/api/1.0/").constant("ACCESS_CODE","RamfCHdallM7ekG2Lf1EXFOLSxfFxpKR").config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","API_URL","API_VERSION","ACCESS_CODE","$provide","localStorageServiceProvider",function(t,e,r,n,o,a,i,s,l,u){r.html5Mode(!1),e.otherwise("/login"),t.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),n.interceptors.push("httpInterceptor"),n.interceptors.push("authInterceptor"),n.defaults.headers.common.accesskey=s,l.value("baseURL",a),o.setDefaultHeaders({accesskey:s}),o.setBaseUrl(a+i)}]).run(["$state","$rootScope","usSpinnerService","AuthFctry",function(t,e,r,n){e.$state=t,e.$on("loading:progress",function(){r.spin("spinner-1")}),e.$on("loading:finish",function(){r.stop("spinner-1")}),e.$on("unauthorized",function(){n.setCurrentUser(null),n.setUserToken(null),t.go("login")})}]).factory("httpInterceptor",["$q","$rootScope",function(t,e){var r=0;return{request:function(n){return 1===++r&&e.$broadcast("loading:progress"),n||t.when(n)},response:function(n){return 0===--r&&e.$broadcast("loading:finish"),n||t.when(n)},responseError:function(n){return 0===--r&&e.$broadcast("loading:finish"),t.reject(n)}}}])}();
!function(){"use strict";function e(e,o,s){e.profile={},e.logoutApp=function(){s.logout().then(function(e){200==e.statusCode&&e.response.success&&o.go("login")})},e.getCurrentUser=function(){s.userprofile().then(function(o){200==o.statusCode&&o.response.success&&(console.log("resp: ",o.response),e.profile=o.response.result)})},e.getCurrentUser()}angular.module("POS17").controller("MainCtrl",e),e.$inject=["$scope","$state","AuthFctry"]}();
...
!function(){"use strict";function s(s,e,t,r,o,a,n,d,i,u,l,c,p,g){s.suppliers=[],s.ptypes=[],s.attributes=[],s.details={},s.details.start_date=new Date,s.details.end_date=new Date,s.details.is_published=!1,s.details.is_archived=!1,s.showPublish=!1,s.showArchive=!1,s.tabprod={product:!1,store:!0,price:!0,category:!0,attribute:!0,variation:!0},d.getAllSuppliers().then(function(e){200==e.statusCode&&e.response.success?s.suppliers=e.response.result:r.error(e.response.msg,"Error")}),n.getAllProdType().then(function(e){200==e.statusCode&&e.response.success?(s.ptypes=e.response.result,s.details.ptype_id=s.ptypes[0].ptype_id):r.error(e.response.msg,"Error")}),o.p_id&&a.getProductDetails(o.p_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result,s.showPublish=1!=s.details.is_published,s.showArchive=0==s.details.is_archived,s.tabprod={product:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1},s.details.start_date=new Date(s.details.start_date),s.details.end_date=new Date(s.details.end_date),s.details.ptype_id=e.response.result.productType_id,s.details.is_published=s.IntToBoolean(s.details.is_published),s.details.is_archived=s.IntToBoolean(s.details.is_archived))}),s.IntToBoolean=function(s){return 1===s},s.BooleanToInt=function(s){return s===!0?1:0},s.removethumb=function(){s.details.img_default=null,s.details.img_default_url="http://placehold.it/250x250"},s.upload=function(e){s.details.img_default_url=null},s.archiveProduct=function(s){a.archiveProduct(s).then(function(s){200==s.statusCode&&s.response.success?(r.success(s.response.msg,"Success"),e.go(e.current,null,{reload:!0})):r.error(s.response.msg,"Error")})},s.publishProduct=function(s){a.publishProduct(s).then(function(s){200==s.statusCode&&s.response.success?(r.success(s.response.msg,"Success"),e.go(e.current,null,{reload:!0})):r.error(s.response.msg,"Error")})},s.addProduct=function(){o.p_id?g.upload({url:l+c+"product/"+o.p_id,fields:s.details,product_img:s.details.img_default,method:"PUT"}).then(function(s){if(200===s.data.statusCode&&s.data.response.success)r.success(s.data.response.msg,"Success"),e.go("products",null,{reload:!0});else{if(400!==s.data.statusCode||s.data.response.success||!_.isArray(s.data.response.result))return void r.error(s.data.response.msg,"Error");_.each(s.data.response.result,function(s){r.warning(s.msg,"Warning")})}},function(s){console.log("Error status: "+s.status)},function(s){parseInt(100*s.loaded/s.total)}):g.upload({url:l+c+"product",fields:s.details,product_img:s.details.img_default}).then(function(s){if(200===s.data.statusCode&&s.data.response.success)r.success(s.data.response.msg,"Success"),e.go("products",null,{reload:!0});else{if(400!==s.data.statusCode||s.data.response.success||!_.isArray(s.data.response.result))return void r.error(s.data.response.msg,"Error");_.each(s.data.response.result,function(s){r.warning(s.msg,"Warning")})}},function(s){console.log("Error status: "+s.status)},function(s){parseInt(100*s.loaded/s.total)})}}angular.module("POS17").controller("productsAEController",s),s.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","API_URL","API_VERSION","ACCESS_CODE","Upload"]}();
!function(){"use strict";function e(e,r,t,s,o,c,n,a,i,l,p,u,d,y){e.prodStores=[],e.selectedStores=[],e.applicationStatus="",e.getAllStore=function(){e.stores=[],e.storesCopy=[],async.waterfall([function(r){i.getAllStore().then(function(t){200==t.statusCode&&t.response.success?(e.stores=t.response.result,e.storesCopy=angular.copy(e.stores),r(null,e.stores)):s.error(t.response.msg,"Error")})},function(r,t){o.p_id?l.getPriceHistory(o.p_id).then(function(t){200==t.statusCode&&t.response.success&&t.response.result.length>0?(e.prodStore=t.response.result,_.each(e.storesCopy,function(r){var t=_.find(e.prodStore,function(e){return r.store_id===e.store_id});t&&(r.selected=!0,r.base_price=t.base_price,r.regular_price=t.regular_price,r.rrp=t.rrp,r.sale_price=t.sale_price,r.sale_percent=t.sale_percent,r.fk_product_id=o.p_id,e.selectedStores.push(r))}),e.itemArray=angular.copy(e.storesCopy)):200==t.statusCode&&t.response.success&&0===t.response.result.length?e.itemArray=angular.copy(r):s.error(t.response.msg,"Error")}):e.itemArray=angular.copy(r)}])},e.getAllStore(),e.paginate=function(){$("#tblStore").trigger("footable_redraw")},e.updateStatus=function(r){e.applicationStatus=r,""===r?e.itemArray=angular.copy(e.storesCopy):(e.itemArray.splice(0,e.itemArray.length),_.each(e.storesCopy,function(r){_.find(e.selectedStores,function(e){return r.store_id===e.store_id})&&e.itemArray.push(r)}))},e.searchStore=function(){if(e.txtSearch){e.itemArray.splice(0,e.itemArray.length);var r=t("filter")(e.storesCopy,e.txtSearch);e.itemArray=angular.copy(r)}},e.searchStatus=function(){""===e.txtSearch&&(e.itemArray.splice(0,e.itemArray.length),e.itemArray=angular.copy(e.storesCopy))},e.changeSelectDeselectAll=function(){_.each(e.itemArray,function(r){r.selected=e.selectDeselectAll,e.checkStoresChanges(r)})},e.checkStoresChanges=function(r){if(r.selected){var t=_.find(e.selectedStores,function(e){return e.store_id===r.store_id});t||(r.base_price=0,r.regular_price=0,r.rrp=0,r.sale_price=0,r.sale_percent=0,r.fk_product_id=o.p_id,e.selectedStores.push(r))}else e.selectedStores=_.filter(e.selectedStores,function(e){return e.store_id!==r.store_id})},e.saveStore=function(r){return o.p_id?void l.saveSP(o.p_id,e.selectedStores).then(function(e){200===e.statusCode&&e.response.success?s.success(e.response.msg,"Success"):s.error(e.response.msg,"Error")}):void s.warning("WARNING: Unable to save.. no available products","WARNING")}}angular.module("POS17").controller("productStoreCtrl",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","API_URL","API_VERSION","ACCESS_CODE","Upload"]}();
...
!function(){"use strict";function t(t,e,r,c,o,s){t.products={},t.productscopy=[],t.selectDeselectAll=!1,t.applicationStatus="All",t.displayModel="List",t.viewby=25,t.currentPage=1,t.itemsPerPage=t.viewby,t.maxSize=5,s.getAllProduct().then(function(e){200==e.statusCode&&e.response.success?(t.products=e.response.result,t.productscopy=angular.copy(t.products),t.totalItems=t.products.length):toastr.error(e.response.msg,"Error")}),t.setPage=function(e){t.currentPage=e},t.setItemsPerPage=function(e){t.itemsPerPage=e,t.currentPage=1},t.edit=function(t){c.go("main.products-add",{p_id:t})},t.searchData=function(){t.products=r("filter")(t.productscopy,t.txtSearch)},t.updateStatus=function(e){t.applicationStatus=e;var c=[];"All"==e?c=t.productscopy:"Publish"==e?c=r("filter")(t.productscopy,{is_published:1}):"Archived"==e?c=r("filter")(t.productscopy,{is_archived:1}):"Draft"==e&&(c=r("filter")(t.productscopy,{is_published:0})),o(function(){t.$apply(function(){t.products=c}),$(".table").trigger("footable_redraw")},100)},t.paginate=function(){$(".table").trigger("footable_redraw")},t.changeSelectDeselectAll=function(){_.each(t.products,function(e){e.selected=t.selectDeselectAll})}}angular.module("POS17").controller("productsController",t),t.$inject=["$scope","$http","$filter","$state","$timeout","productFactory"]}();
...
!function(){"use strict";function e(e,t,s,o,c,r,n){e.selectDeselectAll=!1,e.selectedDatas=[];var l=function(){n.getAllStore().then(function(t){e.stores={},e.storescopy=[],200==t.statusCode&&t.response.success&&(e.stores=t.response.result,e.storescopy=angular.copy(e.stores))})};e.edit=function(e){o.go("main.settings-stores-add",{store_id:e})},e.searchData=function(){e.stores=s("filter")(e.storescopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.stores,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.refresh=function(){l()},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.store_id===t.store_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.store_id!==t.store_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){r.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;_.each(e.selectedDatas,function(e){e.selected&&(++t,n.deleteStore(e.store_id,function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void o.reload()):void c.error(e.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("storesController",e),e.$inject=["$scope","$http","$filter","$state","toastr","ngDialog","storeFactory"]}();
!function(){"use strict";function s(s,e,t,o,r,n,i,a){s.details={},o.store_id&&a.getStoreDetails(o.store_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)}),s.saveStore=function(){o.store_id?(console.log("UPDATE"),a.updateStore(o.store_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)console.log("RESPONSE: ",s),r(function(){n.go("main.settings-stores")},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void i.error(s.response.msg,"Error");_.each(s.response.result,function(s){i.warning(s.msg,"Warning")})}})):a.saveStore(s.details).then(function(s){if(console.log("data:",s),200==s.statusCode&&s.response.success)r(function(){n.go("main.settings-stores")},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void i.error(s.response.msg,"Error");_.each(s.response.result,function(s){i.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("storesDetailController",s),s.$inject=["$scope","$http","$filter","$stateParams","$timeout","$state","toastr","storeFactory"]}();
...
!function(){"use strict";function e(e,t,s,n,a,c,l){e.selectDeselectAll=!1,e.selectedDatas=[];var o=function(){e.banks={},e.bankscopy=[],l.getAllBanks().then(function(t){200==t.statusCode&&t.response.success&&(e.banks=t.response.result,e.bankscopy=angular.copy(e.banks))})};e.refresh=function(){o()},e.edit=function(e){n.go("main.settings-banks-add",{bk_id:e})},e.searchData=function(){e.banks=s("filter")(e.bankscopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.banks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.bk_id===t.bk_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.bk_id!==t.bk_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){a.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;_.each(e.selectedDatas,function(e){e.selected&&(++t,l.deleteBank(e.bk_id,function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void n.reload()):void c.error(e.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("banksController",e),e.$inject=["$scope","$http","$filter","$state","ngDialog","toastr","bankFctry"]}();
!function(){"use strict";function s(s,e,n,t,r,o,a){s.details={},n.bk_id&&a.getBankDetails(n.bk_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)}),s.saveBank=function(){n.bk_id?a.updateBank(stateParams.bk_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)console.log("RESPONSE: ",s),r(function(){t.go("main.settings-banks")},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void o.error(s.response.msg,"Error");_.each(s.response.result,function(s){o.warning(s.msg,"Warning")})}}):a.saveBank(s.details).then(function(s){if(console.log("data:",s),200==s.statusCode&&s.response.success)r(function(){t.go("main.settings-banks")},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void o.error(s.response.msg,"Error");_.each(s.response.result,function(s){o.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("bankDetailsController",s),s.$inject=["$scope","$http","$stateParams","$state","$timeout","toastr","bankFctry"]}();
...
!function(){"use strict";function e(e,t,a,s,c,n,l){e.selectDeselectAll=!1,e.selectedDatas=[];var r=function(){e.attribute={},e.attributecopy=[],l.getAllAttribute().then(function(t){200==t.statusCode&&t.response.success&&(e.attribute=t.response.result,e.attributecopy=angular.copy(e.attribute))})};e.refresh=function(){r()},e.edit=function(e){s.go("main.settings-attributes-add",{att_id:e})},e.searchData=function(){e.attribute=a("filter")(e.attributecopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.attribute,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.att_id===t.att_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.att_id!==t.att_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;_.each(e.selectedDatas,function(e){e.selected&&(++t,bankFctry.deleteBank(e.att_id,function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void s.reload()):void n.error(e.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("attributesController",e),e.$inject=["$scope","$http","$filter","$state","ngDialog","toastr","attributeFactory"]}();
!function(){"use strict";function i(i,s,t,e){i.details={},t.att_id&&e.getAllAttributeDetails(t.att_id).then(function(s){200==s.statusCode&&s.response.success&&(i.details=s.response.result,i.details.is_visible=1==i.details.is_visible,i.details.is_search=1==i.details.is_search,i.details.is_required=1==i.details.is_required,i.details.is_variation=1==i.details.is_variation,i.details.is_customizable=1==i.details.is_customizable,i.details.is_unique=1==i.details.is_unique,i.details.is_comparable=1==i.details.is_comparable)})}angular.module("POS17").controller("attributeDetailsController",i),i.$inject=["$scope","$http","$stateParams","attributeFactory"]}();
!function(){"use strict";function e(e,t,s,o,a,r,c,n){e.selectDeselectAll=!1,e.selectedDatas=[];var l=function(){n.getAllAttributeGroup().then(function(t){e.groups=[],e.attributecopy=[],200==t.statusCode&&t.response.success&&(e.groups=t.response.result,_.each(e.groups,function(e){e.date_created=moment(e.date_created).format("YYYY-MM-DD")}),e.attributecopy=angular.copy(e.groups))})};e.refresh=function(){l()},e.changeSelectDeselectAll=function(){_.each(e.groups,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.searchData=function(){e.groups=s("filter")(e.attributecopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.id===t.id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.id!==t.id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){a.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;_.each(e.selectedDatas,function(e){e.selected&&(++t,n.deleteAttributeGroup(e.id,function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void o.reload()):void r.error(e.response.msg,"Error")}))})})},e.addGroups=function(){var s=t.open({animation:!0,templateUrl:"./modules/attributes/attribute.groups.modal.html",controller:"attributeGroup",size:"md",resolve:{items:function(){return e.items}}});c(function(){s.close("closing")},2e3),s.result.then(function(e){})},e.refresh()}angular.module("POS17").controller("attributeGroups",e),e.$inject=["$scope","$uibModal","$filter","$state","ngDialog","toastr","$timeout","attributeFactory"]}();
...
!function(){"use strict";function e(e,t,c,s,a,o,n){e.selectDeselectAll=!1,e.selectedDatas=[];var l=function(){e.categories={},e.categoriescopy=[],n.getAllCategory().then(function(t){200==t.statusCode&&t.response.success&&(e.categories=t.response.result,e.categoriescopy=angular.copy(e.categories))})};e.refresh=function(){l()},e.edit=function(e){s.go("main.settings-categories-add",{c_id:e})},e.searchData=function(){e.categories=c("filter")(e.categoriescopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.categories,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.c_id===t.c_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.c_id!==t.c_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){a.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;_.each(e.selectedDatas,function(e){e.selected&&(++t,bankFctry.deleteBank(e.c_id,function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),void s.reload()):void o.error(e.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("categoryController",e),e.$inject=["$scope","$http","$filter","$state","ngDialog","toastr","categoryFactory"]}();
!function(){"use strict";function e(e,t,s){e.details={},t.c_id&&s.getCategoryDetails(t.c_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result)})}angular.module("POS17").controller("categoryDetailsController",e),e.$inject=["$scope","$stateParams","categoryFactory"]}();
...
!function(){"use strict";function e(e,t,c,s,l,o,n){e.selectDeselectAll=!1,e.selectedDatas=[];var a=function(){e.producttypes={},e.producttypescopy=[],n.getAllProdType().then(function(t){200==t.statusCode&&t.response.success&&(e.producttypes=t.response.result,e.producttypescopy=angular.copy(e.producttypes))})};e.refresh=function(){a()},e.edit=function(e){c.go("main.settings-producttype-add",{ptype_id:e})},e.searchData=function(){e.producttypes=s("filter")(e.producttypescopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.producttypes,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.ptype_id===t.ptype_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.ptype_id!==t.ptype_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){l.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){})},e.refresh()}angular.module("POS17").controller("productTypeController",e),e.$inject=["$scope","$http","$state","$filter","ngDialog","toastr","ptypeFactory"]}();
!function(){"use strict";function e(e,t,s,o){e.details={},s.ptype_id&&o.getAllProdTypeDetails(s.ptype_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,console.log("$scope.details:",e.details))})}angular.module("POS17").controller("producttypeDetailController",e),e.$inject=["$scope","$http","$stateParams","ptypeFactory"]}();
...
!function(){"use strict";function e(e,t,s,l,c,n){e.selectDeselectAll=!1,e.selectedDatas=[];var a=function(){e.suppliers={},e.supplierscopy=[],n.getAllSuppliers().then(function(t){200==t.statusCode&&t.response.success&&(e.suppliers=t.response.result,e.supplierscopy=angular.copy(e.suppliers))})};e.refresh=function(){a()},e.edit=function(e){l.go("main.settings-suppliers-add",{s_id:e})},e.searchData=function(){e.suppliers=s("filter")(e.supplierscopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.suppliers,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.s_id===t.s_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.s_id!==t.s_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){})},e.refresh()}angular.module("POS17").controller("suppliersController",e),e.$inject=["$scope","$http","$filter","$state","ngDialog","supplierFctry"]}();
!function(){"use strict";function s(s,e,t,l){s.details={},t.s_id&&l.getAllSuppliersDetails(t.s_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)})}angular.module("POS17").controller("suppliersDetailsController",s),s.$inject=["$scope","$http","$stateParams","supplierFctry"]}();
...
!function(){"use strict";function e(e,t,s,n,l,o){e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.selectDeselectAll=!1,e.selectedDatas=[];var c=function(){e.persons={},e.personscopy=[],o.getAllPerson().then(function(t){200==t.statusCode&&t.response.success&&(e.persons=t.response.result,e.personscopy=angular.copy(e.persons))})};e.refresh=function(){c()},e.edit=function(e){n.go("main.settings-humanresource-detail",{id:e})},e.updateStatus=function(t){e.applicationStatus=t,"All"==t?e.persons=e.personscopy:"Employee"==t?e.persons=s("filter")(e.personscopy,{per_type_id:1}):"Customer"==t&&(e.persons=s("filter")(e.personscopy,{per_type_id:2}))},e.searchData=function(){e.persons=s("filter")(e.personscopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.persons,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.id===t.id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.id!==t.id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){l.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){})},e.refresh()}angular.module("POS17").controller("personController",e),e.$inject=["$scope","$http","$filter","$state","ngDialog","personFactory"]}();
!function(){"use strict";function e(e,s,t){e.details={},s.id&&t.getAllPersonDetail(s.id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.details.isActive=1==e.details.isActive)})}angular.module("POS17").controller("personDetailController",e),e.$inject=["$scope","$stateParams","personFactory"]}();
...
!function(){"use strict";function t(t,r,n){return{getAllAttribute:function(){return t.all("attributes").customGET().then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},getAllAttributeDetails:function(r){return t.all("attributes").customGET(r).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},getAllAttributeGroupDetails:function(r){return t.all("attributegroup").customGET(r).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},getAllAttributeGroup:function(){return t.all("attributegroup").customGET().then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},getAllAttributeTypes:function(){return t.all("attributeTypes").customGET().then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})},deleteAttributeGroup:function(r){return t.all("attributegroup").customGET(r).then(function(t){return t},function(t){var r=n.error(t.data.response.msg,"Error");return r})}}}angular.module("POS17").factory("attributeFactory",t),t.$inject=["Restangular","API_URL","toastr"]}();
!function(){"use strict";function r(r,t,n){return{getAllCategory:function(){return r.all("categories").customGET().then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},getCategoryDetails:function(t){return r.all("categories").customGET(t).then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})}}}angular.module("POS17").factory("categoryFactory",r),r.$inject=["Restangular","API_URL","toastr"]}();
...
!function(){"use strict";function r(r,t,n){return{getAllSuppliers:function(){return r.all("supplier").customGET().then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},getAllSuppliersDetails:function(t){return r.all("supplier").customGET(t).then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})}}}angular.module("POS17").factory("supplierFctry",r),r.$inject=["Restangular","API_URL","toastr"]}();
...
!function(){"use strict";function r(r,n,t){return{getAllPerson:function(){return r.all("persons").customGET().then(function(r){return r},function(r){var n=t.error(r.data.response.msg,"Error");return n})},getAllPersonDetail:function(n){return r.all("persons").customGET(n).then(function(r){return r},function(r){var n=t.error(r.data.response.msg,"Error");return n})}}}angular.module("POS17").factory("personFactory",r),r.$inject=["Restangular","API_URL","toastr"]}();
...
!function(){"use strict";function r(r,t,e,n){return{authenticate:function(t){return r.all("session").customPOST(t).then(function(r){return r},function(r){var t=toastr.error(r.data.response.msg,"Error");return t})},logout:function(){return r.all("session").customDELETE().then(function(r){return r},function(r){var t=toastr.error(r.data.response.msg,"Error");return t})},userprofile:function(){return r.all("session").customGET().then(function(r){return r},function(r){var t=toastr.error(r.data.response.msg,"Error");return t})},setUserToken:function(r){n.set("token",r)},getUserToken:function(){return n.get("token")},setCurrentUser:function(r){n.set("user",r)},getCurrentUser:function(){return n.get("user")}}}function t(r,t,e,n,o){return{request:function(r){if(r.headers=r.headers||{},o.get("token")){var t=o.get("token");r.headers.Authorization="Bearer "+t}return r},responseError:function(t){return 401===t.status&&r.$broadcast("unauthorized"),t}}}angular.module("POS17").factory("AuthFctry",r).factory("authInterceptor",t),r.$inject=["Restangular","API_URL","API_VERSION","localStorageService"],t.$inject=["$rootScope","$q","$location","$injector","localStorageService"]}();
...
!function(){"use strict";function r(){return function(r,t){var e=[];return angular.isArray(r)?r.forEach(function(r){for(var n=!1,o=Object.keys(t),a=0;a<o.length;a++){var i=o[a],u=t[i].toLowerCase();if(-1!==r[i].toString().toLowerCase().indexOf(u)){n=!0;break}}n&&e.push(r)}):e=r,e}}angular.module("POS17").filter("propsFilter",r)}();
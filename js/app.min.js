!function(){"use strict";angular.module("POS17",["ngSanitize","ngAnimate","ui.router","chart.js","angular-flot","ui.bootstrap","textAngular","ngFileUpload","ui.footable","restangular","toastr","angularMoment","angularSpinner","ngDialog","ui.select","mgcrea.ngStrap","LocalStorageModule","dibari.angular-ellipsis","angular-jwt"]).constant("API_URL","http://localhost:3000").constant("API_VERSION","/api/1.0/").config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","API_URL","API_VERSION","$provide","localStorageServiceProvider",function(r,t,n,e,o,a,i,s,u){n.html5Mode(!1),t.otherwise("/login"),r.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),e.interceptors.push("httpInterceptor"),e.interceptors.push("authInterceptor"),s.value("baseURL",a),o.setBaseUrl(a+i)}]).run(["$state","$rootScope","usSpinnerService","AuthFctry",function(r,t,n,e){t.currentUser={},t.$state=r,t.$on("loading:progress",function(){n.spin("spinner-1")}),t.$on("loading:finish",function(){n.stop("spinner-1")}),t.$on("unauthorized",function(){e.setCurrentUser(null),e.setUserToken(null),r.go("login")}),t.$on("$stateChangeSuccess",function(r,n,o,a,i){t.currentUser=e.getCurrentUser()})}]).factory("httpInterceptor",["$q","$rootScope",function(r,t){var n=0;return{request:function(e){return 1===++n&&t.$broadcast("loading:progress"),e||r.when(e)},response:function(e){return 0===--n&&t.$broadcast("loading:finish"),e||r.when(e)},responseError:function(e){return 0===--n&&t.$broadcast("loading:finish"),r.reject(e)}}}])}();
...
!function(){"use strict";function s(s,e,t,r,o,a,n,d,i,u,l,c,p){s.suppliers=[],s.ptypes=[],s.attributes=[],s.details={},s.details.start_date=new Date,s.details.end_date=new Date,s.details.is_published=!1,s.details.is_archived=!1,d.getAllSuppliers().then(function(e){200==e.statusCode&&e.response.success?s.suppliers=e.response.result:r.error(e.response.msg,"Error")}),n.getAllProdType().then(function(e){200==e.statusCode&&e.response.success?(s.ptypes=e.response.result,s.details.ptype_id=s.ptypes[0].ptype_id):r.error(e.response.msg,"Error")}),_.isEmpty(o.p_id)?(s.showPublish=!1,s.showArchive=!1,s.tabprod={product:!0,store:!1,price:!1,category:!1,attribute:!1,variation:!1},console.log("$scope.tabprod: ",s.tabprod)):a.getProductDetails(o.p_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result,s.showPublish=1!=s.details.is_published,s.showArchive=0==s.details.is_archived,s.tabprod={product:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0},s.details.start_date=new Date(s.details.start_date),s.details.end_date=new Date(s.details.end_date),s.details.ptype_id=e.response.result.productType_id,s.details.is_published=s.IntToBoolean(s.details.is_published),s.details.is_archived=s.IntToBoolean(s.details.is_archived))}),s.IntToBoolean=function(s){return 1===s},s.BooleanToInt=function(s){return s===!0?1:0},s.removethumb=function(){s.details.img_default=null,s.details.img_default_url="http://placehold.it/250x250"},s.upload=function(e){s.details.img_default_url=null},s.archiveProduct=function(s){a.archiveProduct(s).then(function(s){200==s.statusCode&&s.response.success?(r.success(s.response.msg,"Success"),e.go(e.current,null,{reload:!0})):r.error(s.response.msg,"Error")})},s.publishProduct=function(s){a.publishProduct(s).then(function(s){200==s.statusCode&&s.response.success?(r.success(s.response.msg,"Success"),e.go(e.current,null,{reload:!0})):r.error(s.response.msg,"Error")})},s.addProduct=function(){o.p_id?p.upload({url:l+c+"product/"+o.p_id,fields:s.details,product_img:s.details.img_default,method:"PUT"}).then(function(s){if(200===s.data.statusCode&&s.data.response.success)r.success(s.data.response.msg,"Success"),e.go("main.products",null,{reload:!0});else{if(400!==s.data.statusCode||s.data.response.success||!_.isArray(s.data.response.result))return void r.error(s.data.response.msg,"Error");_.each(s.data.response.result,function(s){r.warning(s.msg,"Warning")})}},function(s){console.log("Error status: "+s.status)},function(s){parseInt(100*s.loaded/s.total)}):p.upload({url:l+c+"product",fields:s.details,product_img:s.details.img_default}).then(function(s){if(200===s.data.statusCode&&s.data.response.success)r.success(s.data.response.msg,"Success"),e.go("main.products",null,{reload:!0});else{if(400!==s.data.statusCode||s.data.response.success||!_.isArray(s.data.response.result))return void r.error(s.data.response.msg,"Error");_.each(s.data.response.result,function(s){r.warning(s.msg,"Warning")})}},function(s){console.log("Error status: "+s.status)},function(s){parseInt(100*s.loaded/s.total)})}}angular.module("POS17").controller("productsAEController",s),s.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","API_URL","API_VERSION","Upload"]}();
...
!function(){"use strict";function t(t,e,n,o,r,i,c,l,u){t.attributes=[],u.getAllAttribute().then(function(e){200==e.statusCode&&e.response.success?t.attributes=e.response.result:o.error(e.response.msg,"Error")}),t.openAttributeModal=function(){var n=c.open({animation:!0,templateUrl:"modules/products/product.attributes.modal.html",controller:"productAttributeModalCtrl",backdrop:"static",size:"modal-md",resolve:{attributes:function(){return t.attributes}}});n.result.then(function(){e.reload()},function(){console.info("Modal dismissed")}),n.opened.then(function(){r(function(){$(".my-colorpicker2").colorpicker()},1e3)})}}function e(t,e,n){t.attrib={},t.attributes=n,t.infiniteScrollContacts={},t.infiniteScrollContacts.numToAdd=10,t.infiniteScrollContacts.currentItems=10,t.resetInfScroll=function(){t.infiniteScrollContacts.currentItems=t.infiniteScrollContacts.numToAdd},t.addMoreItems=function(){t.infiniteScrollContacts.currentItems+=t.infiniteScrollContacts.numToAdd},t.removethumb=function(){t.attrib.value_image=null},t.removeFile=function(){t.attrib.document=null},t.cancel=function(){e.dismiss("cancel")}}angular.module("POS17").controller("productAttributeCtrl",t).controller("productAttributeModalCtrl",e),t.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","$uibModal","productFactory","attributeFactory"],e.$inject=["$scope","$uibModalInstance","attributes"]}();
!function(){"use strict";function t(t,e,r,c,o,s){t.selectDeselectAll=!1,t.applicationStatus="All",t.displayModel="List",t.viewby=25,t.currentPage=1,t.itemsPerPage=t.viewby,t.maxSize=5;var u=function(){t.products=[],t.productscopy=[],s.getAllProduct().then(function(e){200==e.statusCode&&e.response.success?(t.products=e.response.result,t.productscopy=angular.copy(t.products),t.totalItems=t.products.length):toastr.error(e.response.msg,"Error")})};t.setPage=function(e){t.currentPage=e},t.setItemsPerPage=function(e){t.itemsPerPage=e,t.currentPage=1},t.edit=function(t){c.go("main.products-add",{p_id:t})},t.searchData=function(){t.products=r("filter")(t.productscopy,t.txtSearch)},t.refresh=function(){u()},t.updateStatus=function(e){t.applicationStatus=e;var c=[];"All"==e?c=t.productscopy:"Publish"==e?c=r("filter")(t.productscopy,{is_published:1}):"Archived"==e?c=r("filter")(t.productscopy,{is_archived:1}):"Draft"==e&&(c=r("filter")(t.productscopy,{is_published:0})),o(function(){t.$apply(function(){t.products=c}),$(".table").trigger("footable_redraw")},100)},t.paginate=function(){$(".table").trigger("footable_redraw")},t.changeSelectDeselectAll=function(){_.each(t.products,function(e){e.selected=t.selectDeselectAll})},t.refresh()}angular.module("POS17").controller("productsController",t),t.$inject=["$scope","$http","$filter","$state","$timeout","productFactory"]}();
...
!function(){"use strict";function t(t,e,s,i){t.details={},s.att_id&&i.getAllAttributeDetails(s.att_id).then(function(e){200==e.statusCode&&e.response.success&&(t.details=e.response.result,t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable)}),t.saveAttribute=function(){s.att_id?i.updateAttribute(s.att_id,t.details).then(function(t){200==t.statusCode&&t.response.success&&console.log("Update:",t.response.result)}):i.saveAttribute(t.details).then(function(t){200==t.statusCode&&t.response.success&&console.log("Update:",t.response.result)})}}angular.module("POS17").controller("attributeDetailsController",t),t.$inject=["$scope","$http","$stateParams","attributeFactory"]}();
...
!function(){"use strict";function r(r,t,n){return{getAllAttribute:function(){return r.all("attributes").customGET().then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},getAllAttributeDetails:function(t){return r.all("attributes").customGET(t).then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},getAllAttributeGroupDetails:function(t){return r.all("attributegroup").customGET(t).then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},getAllAttributeGroup:function(){return r.all("attributegroup").customGET().then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},getAllAttributeTypes:function(){return r.all("attributeTypes").customGET().then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},saveAttribute:function(t){return r.all("attributes").customPOST(t).then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},updateAttribute:function(t,e){return r.all("attributes/"+t).customPUT(e).then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})},deleteAttributeGroup:function(t){return r.all("attributegroup").customGET(t).then(function(r){return r},function(r){var t=n.error(r.data.response.msg,"Error");return t})}}}angular.module("POS17").factory("attributeFactory",r),r.$inject=["Restangular","API_URL","toastr"]}();
...
!function(){"use strict";function r(r,e,t,n){return{authenticate:function(e){return r.all("session").customPOST(e).then(function(r){return r},function(r){var e=toastr.error(r.data.response.msg,"Error");return e})},logout:function(){return r.all("session").customDELETE().then(function(r){return r},function(r){var e=toastr.error(r.data.response.msg,"Error");return e})},userprofile:function(){return r.all("session").customGET().then(function(r){return r},function(r){var e=toastr.error(r.data.response.msg,"Error");return e})},setUserToken:function(r){n.set("token",r)},getUserToken:function(){return n.get("token")},setCurrentUser:function(r){n.set("user",r)},getCurrentUser:function(){return n.get("user")}}}function e(r,e,t,n,o,u){return{request:function(r){if(r.headers=r.headers||{},u.get("token")){var e=u.get("token");r.headers.Authorization="Bearer "+e;var t=o.decodeToken(e);t&&(r.headers.accesskey=t.subscriptionKey)}return r},responseError:function(e){return 401===e.status&&r.$broadcast("unauthorized"),e}}}angular.module("POS17").factory("AuthFctry",r).factory("authInterceptor",e),r.$inject=["Restangular","API_URL","API_VERSION","localStorageService"],e.$inject=["$rootScope","$q","$location","$injector","jwtHelper","localStorageService"]}();

!function(){"use strict";angular.module("POS17",["ngSanitize","ngAnimate","ui.router","chart.js","angular-flot","ui.bootstrap","textAngular","ngFileUpload","ui.footable","restangular","toastr","angularMoment","angularSpinner","ngDialog","ui.select","mgcrea.ngStrap","LocalStorageModule","dibari.angular-ellipsis","angular-jwt","color.picker","ja.qr","angularTreeview","angularFileUpload"]).constant("API_URL","http://52.64.27.145:5001").constant("API_VERSION","/api/1.0/").config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","API_URL","API_VERSION","$provide","localStorageServiceProvider",function(e,r,t,n,o,a,i,s,u){t.html5Mode(!1),r.otherwise("/login"),e.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),n.interceptors.push("httpInterceptor"),n.interceptors.push("authInterceptor"),s.value("baseURL",a),o.setBaseUrl(a+i)}]).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location",function(e,r,t,n,o,a,i,s){r.currentUser={},r.$state=e,r.previousState,r.currentState,r.$on("loading:progress",function(){t.spin("spinner-1"),r.productIsLoading=!0}),r.$on("loading:finish",function(){t.stop("spinner-1"),r.productIsLoading=!1}),r.$on("unauthorized",function(){n.setCurrentUser(null),n.setUserToken(null),e.go("login")}),r.goBack=function(){o.history.back()},r.$on("$stateChangeStart",function(e,r,t,o,u){if(n.getCurrentUser()){var l=n.getUserToken();a.isTokenExpired(l)&&(i.remove("user"),i.remove("token"),s.path("/login"))}}),r.$on("$stateChangeSuccess",function(e,t,o,a,i){r.previousState=a.name,r.currentState=t.name,r.currentUser=n.getCurrentUser()})}]).factory("httpInterceptor",["$q","$rootScope",function(e,r){var t=0;return{request:function(n){return 1===++t&&r.$broadcast("loading:progress"),n||e.when(n)},response:function(n){return 0===--t&&r.$broadcast("loading:finish"),n||e.when(n)},responseError:function(n){return 0===--t&&r.$broadcast("loading:finish"),e.reject(n)}}}])}();
...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(t,r){r.state("main.products",{url:"/products/overview",templateUrl:"modules/products/products.html",controller:"productsController"}).state("main.products-add",{url:"/products/:p_id",templateUrl:"modules/products/product.details.html",controller:"productsAEController"}).state("main.products-bundle-add",{url:"/products-bundle/:p_id",templateUrl:"modules/products/product.bundle.html",controller:"productsBundleController"})}])}();
!function(){"use strict";function e(e,s,t,r,o,a,n,u,i,c,d,l,p){e.suppliers=[],e.ptypes=[],e.attributes=[],e.details={},e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,u.getAllSuppliers().then(function(s){200==s.statusCode&&s.response.success?e.suppliers=s.response.result:r.error(s.response.msg,"Error")}),n.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?(e.ptypes=s.response.result,e.details.ptype_id=e.ptypes[0].ptype_id):r.error(s.response.msg,"Error")}),_.isEmpty(o.p_id)?(e.showPublish=!1,e.showArchive=!1,e.tabprod={product:!0,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},console.log("$scope.tabprod: ",e.tabprod)):a.getProductDetails(o.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.tabprod={product:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!0,related:!0},e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived))}),e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.removethumb=function(){e.details.img_default=null},e.upload=function(s){e.isImageNew=!0},e.archiveProduct=function(e){a.archiveProduct(e).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.publishProduct=function(e){a.publishProduct(e).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.addProduct=function(){async.waterfall([function(s){o.p_id?a.updateProduct(o.p_id,e.details).then(function(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),s(null,o.p_id),console.log("UPDATE"))}):a.saveProduct(e.details).then(function(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),s(null,e.response.result),console.log("SUCCESS"))})},function(t,o){p.upload({url:d+l+"product/"+t+"/upload-image",data:{product_img:e.details.img_default},method:"PUT"}).then(function(o){if(200===o.data.statusCode&&o.data.response.success)e.isImageNew&&r.success("Image successfully uploaded","Success"),s.go(s.current,{p_id:t},{reload:!0});else{if(400!==o.data.statusCode||o.data.response.success||!_.isArray(o.data.response.result))return void r.error(o.data.response.msg,"Error");_.each(o.data.response.result,function(e){r.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])}}angular.module("POS17").controller("productsAEController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","API_URL","API_VERSION","Upload"]}();
!function(){"use strict";function e(e,s,t,o,r,n,i,a,c,u,d,l){e.ptypes=[],e.attributes=[],e.details={},e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1;var p=e.uploader=new l({url:u+d+"product/"+r.p_id+"/upload-image"});p.filters.push({name:"imageFilter",fn:function(e,s){var t="|"+e.type.slice(e.type.lastIndexOf("/")+1)+"|";return-1!=="|jpg|png|jpeg|bmp|gif|".indexOf(t)}}),i.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?(e.ptypes=s.response.result,e.details.ptype_id=e.ptypes[0].ptype_id):o.error(s.response.msg,"Error")}),_.isEmpty(r.p_id)?(e.showPublish=!1,e.showArchive=!1):n.getProductDetails(r.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived))}),e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.archiveProduct=function(e){n.archiveProduct(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.publishProduct=function(e){n.publishProduct(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.addProduct=function(){async.waterfall([function(s){r.p_id?n.updateProduct(r.p_id,e.details).then(function(e){200==e.statusCode&&e.response.success&&(o.success(e.response.msg,"Success"),s(null,r.p_id),console.log("UPDATE"))}):n.saveProduct(e.details).then(function(e){200==e.statusCode&&e.response.success&&(o.success(e.response.msg,"Success"),s(null,e.response.result),console.log("SUCCESS"))})},function(e,s){}])}}angular.module("POS17").controller("productsBundleController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","storeFactory","priceHistoryFactory","API_URL","API_VERSION","FileUploader"]}();
...
!function(){"use strict";function s(s,e,t,r,o,n,c,i){s.details={},r.store_id&&i.getStoreDetails(r.store_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)}),s.saveStore=function(){r.store_id?i.updateStore(r.store_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)c.success(s.response.msg,"Success"),o(function(){n.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void c.error(s.response.msg,"Error");_.each(s.response.result,function(s){c.warning(s.msg,"Warning")})}}):i.saveStore(s.details).then(function(s){if(console.log("data:",s),200==s.statusCode&&s.response.success)c.success(s.response.msg,"Success"),o(function(){n.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void c.error(s.response.msg,"Error");_.each(s.response.result,function(s){c.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("storesDetailController",s),s.$inject=["$scope","$http","$filter","$stateParams","$timeout","$state","toastr","storeFactory"]}();
...
!function(){"use strict";function e(e,t,s,a,n,o,r,c){function i(){a.getAllCategory().then(function(t){if(200==t.statusCode&&t.response.success){for(var s=t.response.result,a=0;a<s.length;a++){var n=s[a],o=n.name,r=n.parent_id,c=n.c_id;u[r]?(n={parentid:r,label:o,item:n},null!=n&&(u[r].items||(u[r].items=[]),u[r].items[u[r].items.length]=n,u[c]=n)):(u[c]={parentid:r,label:o,item:n},l[c]=u[c])}e.categoryData=_(l).omit(_.isUndefined).omit(_.isNull).value(),console.log("categoryData: ",e.categoryData)}})}e.details={},e.newImage=!1;var l=[],u=[];s.c_id&&a.getCategoryDetails(s.c_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result)}),i(),e.toplevelCategory=function(){e.TPchecked?e.mytree.currentNode={}:i()},e.changeItem=function(t){e.selectedItem=t},e.removethumb=function(){e.details.c_image=null,e.newImage=!1},e.upload=function(t){e.newImage=!0},e.saveCategory=function(){e.mytree&&angular.isObject(e.mytree.currentNode)&&!_.isEmpty(e.mytree.currentNode)?(console.log("$scope.mytree.currentNode: ",e.mytree.currentNode),e.details.parent_id=e.mytree.currentNode.item.c_id):e.details.parent_id=null,async.waterfall([function(t){s.c_id?a.updateCategory(s.c_id,e.details).then(function(e){200==e.statusCode&&e.response.success&&(console.log("UPDATE"),c.success(e.response.msg,"Success"),t(null,s.c_id))}):a.saveCategory(e.details).then(function(e){200==e.statusCode&&e.response.success&&(console.log("SUCCESS"),c.success(e.response.msg,"Success"),t(null,e.response.result))})},function(s,a){e.details.c_image&&n.upload({url:o+r+"categories/"+s+"/upload-image",data:{c_image:e.details.c_image},method:"PUT"}).then(function(a){if(200===a.data.statusCode&&a.data.response.success)e.newImage&&c.success("Image successfully uploaded","Success"),t.go(t.current,{c_id:s},{reload:!0});else{if(400!==a.data.statusCode||a.data.response.success||!_.isArray(a.data.response.result))return void c.error(a.data.response.msg,"Error");_.each(a.data.response.result,function(e){c.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])}}angular.module("POS17").controller("categoryDetailsController",e),e.$inject=["$scope","$state","$stateParams","categoryFactory","Upload","API_URL","API_VERSION","toastr"]}();
...
!function(){"use strict";function e(e,s,t,a,o,n,u,c){e.details={},e.newImage=!1,t.ptype_id&&a.getAllProdTypeDetails(t.ptype_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,console.log("$scope.details:",e.details))}),e.removethumb=function(){e.details.c_image=null,e.newImage=!1},e.upload=function(s){e.newImage=!0},e.saveProductType=function(){async.waterfall([function(s){t.ptype_id?a.updateProductType(t.ptype_id,e.details).then(function(e){200==e.statusCode&&e.response.success&&(s(null,t.ptype_id),console.log("UPDATE"))}):a.saveProductType(e.details).then(function(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),s(null,e.response.result),console.log("SUCCESS"))})},function(s,t){e.details.ptype_image&&o.upload({url:u+c+"producttype/"+s+"/upload-image",data:{ptype_image:e.details.ptype_image},method:"PUT"}).then(function(t){if(200===t.data.statusCode&&t.data.response.success)e.newImage&&n.success("Image successfully uploaded","Success"),$state.go($state.current,{ptype_id:s},{reload:!0});else{if(400!==t.data.statusCode||t.data.response.success||!_.isArray(t.data.response.result))return void n.error(t.data.response.msg,"Error");_.each(t.data.response.result,function(e){n.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])}}angular.module("POS17").controller("producttypeDetailController",e),e.$inject=["$scope","$http","$stateParams","ptypeFactory","Upload","toastr","API_URL","API_VERSION"]}();
...
!function(){"use strict";function s(s,e,r,t,n,u,o){s.details={},r.s_id&&t.getAllSuppliersDetails(r.s_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)}),s.saveSupplier=function(){r.s_id?t.updateSupplier(r.s_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)o(function(){n.success("Successfully Update","Success"),u.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void n.error(s.response.msg,"Error");_.each(s.response.result,function(s){n.warning(s.msg,"Warning")})}}):t.saveSupplier(s.details).then(function(s){if(200==s.statusCode&&s.response.success)o(function(){n.success("Successfully Added","Success"),u.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void n.error(s.response.msg,"Error");_.each(s.response.result,function(s){n.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("suppliersDetailsController",s),s.$inject=["$scope","$http","$stateParams","supplierFctry","toastr","$state","$timeout"]}();
...
!function(){"use strict";function s(s,e,t,n,o,r,a,u,c){s.stores=[],s.persons=[],s.details={},n.getPersonType().then(function(e){200==e.statusCode&&e.response.success&&(console.log("data:",e.response.success),s.persons=e.response.result)}),async.waterfall([function(s){o.getAllStore().then(function(e){200==e.statusCode&&e.response.success&&s(null,e.response.result)})},function(s,e){n.getTimeZone().then(function(t){200==t.statusCode&&t.response.success&&e(null,s,t.response.result)})},function(e,o,r){s.stores=e,s.timezone=o,t.id&&n.getAllPersonDetail(t.id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result,s.details.isActive=1==s.details.isActive,s.details.person_img=s.details.image)})}]),s.removethumb=function(){s.details.person_img=null},s.upload=function(s){},s.savePersonel=function(){async.waterfall([function(e){t.id?n.updatePersonel(t.id,s.details).then(function(s){200==s.statusCode&&s.response.success&&(c.success(s.response.msg,"Success"),e(null,t.id))}):n.savePersonel(s.details).then(function(s){200==s.statusCode&&s.response.success&&(c.success(s.response.msg,"Success"),e(null,s.response.result))})},function(t,n){s.details.person_img&&r.upload({url:a+u+"persons/"+t+"/upload-image",data:{person_img:s.details.person_img},method:"PUT"}).then(function(s){if(200===s.data.statusCode&&s.data.response.success)c.success("Image successfully uploaded","Success"),e.go(e.current,{id:t},{reload:!0});else{if(400!==s.data.statusCode||s.data.response.success||!_.isArray(s.data.response.result))return void c.error(s.data.response.msg,"Error");_.each(s.data.response.result,function(s){c.warning(s.msg,"Warning")})}},function(s){console.log("Error status: "+s.status)},function(s){parseInt(100*s.loaded/s.total)})}])}}angular.module("POS17").controller("personDetailController",s),s.$inject=["$scope","$state","$stateParams","personFactory","storeFactory","Upload","API_URL","API_VERSION","toastr"]}();

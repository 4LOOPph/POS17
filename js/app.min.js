!function(){"use strict";angular.module("POS17",["ngSanitize","ngAnimate","ui.router","chart.js","angular-flot","ui.bootstrap","textAngular","ngFileUpload","ui.footable","restangular","toastr","angularMoment","angularSpinner","ngDialog","ui.select","mgcrea.ngStrap","LocalStorageModule","dibari.angular-ellipsis","angular-jwt","color.picker","ja.qr","jcs-autoValidate","angularTreeview","angularFileUpload","dndLists"]).constant("API_URL","http://localhost:3000").constant("API_VERSION","/api/1.0/").config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","API_URL","API_VERSION","$provide","localStorageServiceProvider",function(t,e,r,n,o,a,i,s,u){r.html5Mode(!1),e.otherwise("/login"),t.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),n.interceptors.push("httpInterceptor"),n.interceptors.push("authInterceptor"),s.value("baseURL",a),o.setBaseUrl(a+i)}]).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location",function(t,e,r,n,o,a,i,s){e.currentUser={},e.$state=t,e.previousState,e.currentState,e.$on("loading:progress",function(){e.productIsLoading=!0}),e.$on("loading:finish",function(){e.productIsLoading=!1}),e.$on("unauthorized",function(){n.setCurrentUser(null),n.setUserToken(null),t.go("login")}),e.goBack=function(){o.history.back()},e.$on("$stateChangeStart",function(t,e,r,o,u){if(n.getCurrentUser()){var l=n.getUserToken();a.isTokenExpired(l)&&(i.remove("user"),i.remove("token"),s.path("/login"))}}),e.$on("$stateChangeSuccess",function(t,r,o,a,i){e.previousState=a.name,e.currentState=r.name,e.currentUser=n.getCurrentUser()})}]).factory("httpInterceptor",["$q","$rootScope",function(t,e){var r=0;return{request:function(n){return 1===++r&&e.$broadcast("loading:progress"),n||t.when(n)},response:function(n){return 0===--r&&e.$broadcast("loading:finish"),n||t.when(n)},responseError:function(n){return 0===--r&&e.$broadcast("loading:finish"),t.reject(n)}}}])}();

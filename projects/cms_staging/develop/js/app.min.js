...
!function(){"use strict";function e(e,s,o,t,n,r,a,i,c,u,l){e.profile={},e.activeSub="",s.chatMessage="";var p=JSON.parse(a.get("user"));console.log("MainCtrl:",p);var g=firebase.database().ref().child("messages"),d=l(g);console.log("ref:",g),d.$loaded().then(function(){s.sample=d,console.log("$scope.sample:",s.sample),angular.forEach(d,function(e,s){console.log("asd",s,e)})}),s.sendMessage=function(){console.log("Send:",s.chatMessage);var e={to_id:p.sub_id,value:s.chatMessage,date:(new Date).getTime(),user:p};console.log("Send11:",e),d.$add(e),s.chatMessage=" "},s.logoutApp=function(){r.logout().then(function(e){if(200==e.statusCode&&e.response.success){var s=JSON.parse(a.get("user"));u.logTransaction("User Logout","LOGOUT",s.username,"User Logout USERNAME:="+s.username).then(function(){r.setCurrentUser(null),r.setUserToken(null),c.logout()}),o.go("login")}})},s.getCurrentUser=function(){r.userprofile().then(function(s){if(200==s.statusCode&&s.response.success){e.profile=s.response.result;var o=JSON.parse(a.get("user"));e.activeSub=o.company_name}else if(400==s.statusCode&&!s.response.success)return void t.error(s.response.msg,"Error")})},s.openSubscription=function(){var e=n.open({animation:!0,templateUrl:"./modules/templates/header.subscription.html",controller:"ModalSubscriptionCtrl",size:"sm"}),s=JSON.parse(a.get("user"));u.logTransaction("Active Subscription","DASHBOARD","N/A","User:="+s.username+" Views Active Subscription"),e.result.then(function(e){var s=JSON.parse(a.get("user"));s.sub_id=e.sub_id,s.company_name=e.company_name,s.subscriptionKey=e.subscriptionKey,a.set("user",JSON.stringify(s)),i(function(){o.go("main.dashboard",null,{reload:!0})},1e3)})},s.getCurrentUser()}function s(e,s,o){e.switchSubscription=function(e){o(function(){s.close(e)},300)},e.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("MainCtrl",e).controller("ModalSubscriptionCtrl",s),e.$inject=["$rootScope","$scope","$state","toastr","$uibModal","AuthFctry","localStorageService","$timeout","$auth","transLogFctry","$firebaseArray"],s.$inject=["$scope","$uibModalInstance","$timeout"]}();

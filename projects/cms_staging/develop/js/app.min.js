!function(){"use strict";angular.module("POS17",["ngSanitize","ngAnimate","ui.router","chart.js","angular-flot","ui.bootstrap","textAngular","ngFileUpload","ui.footable","restangular","toastr","angularMoment","angularSpinner","ngDialog","ui.select","mgcrea.ngStrap","LocalStorageModule","dibari.angular-ellipsis","angular-jwt","color.picker","ja.qr","angularTreeview","angularFileUpload","dndLists","ngTable","kk.timepicker","angularjs-dropdown-multiselect","bootstrapLightbox","videosharing-embed","com.2fdevs.videogular","com.2fdevs.videogular.plugins.controls","com.2fdevs.videogular.plugins.overlayplay","com.2fdevs.videogular.plugins.buffering","info.vietnamcode.nampnq.videogular.plugins.flash","pdf","io.dennis.contextmenu","satellizer","frapontillo.bootstrap-switch","angularRipple","barcode","angular-progress-button-styles","angularPromiseButtons","ngRoute","angular-loading-bar","firebase","nvd3","ngLetterAvatar","daterangepicker","ngJsonExportExcel","luegg.directives"]).constant("API_URL","http://localhost:3000").constant("API_VERSION","/api/1.0/").constant("API_URL_2","http://54.206.38.223:5005").constant("API_VERSION_2","/api/1.0/").constant("FACEBOOK_API","218087938610404").constant("GOOGLE_API","608675325087-lsbmqc0m5hm6rtosar8bt99agvfce8dh.apps.googleusercontent.com").constant("TWITTER_API","04gzA1YhW0oAm2Aj36J2tcNH3").constant("LINKEDIN_API","81j8xuo5umqyqn")}();
!function(){"use strict";angular.module("POS17").config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","$uibTooltipProvider","API_URL","API_VERSION","$provide","localStorageServiceProvider","uiSelectConfig","LightboxProvider","$authProvider","FACEBOOK_API","GOOGLE_API","TWITTER_API","LINKEDIN_API",function(e,r,i,o,t,a,l,n,c,s,p,d,u,h,m,P,I){i.html5Mode({enabled:!1,requireBase:!1}),i.hashPrefix(""),r.otherwise("/login"),p.resetSearchInput=!0,e.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),o.interceptors.push("httpInterceptor"),o.interceptors.push("authInterceptor"),c.value("baseURL",l),t.setBaseUrl(l+n),u.facebook({clientId:h,url:l+"/auth/facebook",redirectUri:window.location.origin+"/",requiredUrlParams:["display","scope"],scope:["email"],scopeDelimiter:",",oauthType:"2.0"}),u.google({clientId:m,url:l+"/auth/google",redirectUri:window.location.origin,requiredUrlParams:["scope"],scope:["profile","email"],scopePrefix:"openid",scopeDelimiter:" ",oauthType:"2.0"}),u.linkedin({clientId:I,url:l+"/auth/linkedin",redirectUri:window.location.origin,requiredUrlParams:["state"],scope:["r_emailaddress"],scopeDelimiter:" ",oauthType:"2.0",state:"STATE"}),u.twitter({clientId:P,url:l+"/auth/twitter",redirectUri:window.location.origin+"/",oauthType:"1.0"}),d.fullScreenMode=!0;var g={apiKey:"AIzaSyBiopDJ0LclH1H_FxUjBgLTjPFjlRlfk-E",authDomain:"symphony-2a04c.firebaseapp.com",databaseURL:"https://symphony-2a04c.firebaseio.com",projectId:"symphony-2a04c",storageBucket:"symphony-2a04c.appspot.com",messagingSenderId:"579565622268"};firebase.initializeApp(g)}])}();
!function(){"use strict";angular.module("POS17").run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location","ngDialog","$browser",function(e,n,o,t,s,i,r,a,u,c){n.currentUser={},n.$state=e,n.previousState,n.currentState,n.changesOccur=0,c.baseHref=function(){return"/"},s.user_timezone=moment.tz.guess(),s.user_timezone2=moment().format("Z"),n.$on("loading:progress",function(){n.productIsLoading=!0}),n.$on("loading:finish",function(){n.productIsLoading=!1}),n.$on("unauthorized",function(){t.setCurrentUser(null),t.setUserToken(null),e.go("login")}),n.goBack=function(){s.history.back()},n.$on("$stateChangeStart",function(o,s,c,l,g){if(t.getCurrentUser()){var p=t.getUserToken();i.isTokenExpired(p)&&(r.remove("user"),r.remove("token"),a.path("/login"))}n.changesOccur>2&&(o.preventDefault(),n.modal={title:"Changes Detected?",message:"Are you sure to proceed without saving or updating?"},u.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:n,className:"ngdialog-theme-default"}).then(function(){n.changesOccur=0,e.go(s.name)},function(){console.log("NO")}))}),n.$on("$stateChangeSuccess",function(e,o,s,i,r){n.previousState=i.name,n.currentState=o.name,n.currentUser=t.getCurrentUser()});var l=JSON.parse(r.get("user"));if(l){var g=s.OneSignal||[];g.push(["init",{appId:l.one_signal_appID,autoRegister:!1,subdomainName:"http://symphony"+l.subscriptionCode+".onesignal.com",httpPermissionRequest:{enable:!0},notifyButton:{enable:!0}}]),g.push(function(){var e=g.isPushNotificationsSupported();e?console.log("Push notifications are supported"):console.log("Push notifications are not supported"),g.isPushNotificationsEnabled().then(function(e){e?console.log("Push notifications are enabled!"):console.log("Push notifications are not enabled yet.")})})}}])}();
!function(){"use strict";function e(e,s,a,t,n,i,r,o,c,u,d,l,p,f){function g(){var e=b.$getAuth();_.isNull(e)&&async.waterfall([function(e){b.$createUserWithEmailAndPassword(s.accountUser.email,h._id).then(function(a){var t=firebase.database().ref().child("Users/"+a.uid),n={uid:a.uid,_id:h._id,person_id:h.person_id,sub_id:h.sub_id,uc_id:h.uc_id,username:h.username,displayName:h.displayName,company_name:h.company_name,email_address:s.accountUser.email,type:"user"};t.set(n),e()})["catch"](function(e){b.$signInWithEmailAndPassword(s.accountUser.email,h._id).then(function(e){})["catch"](function(e){})})},function(e){b.$signInWithEmailAndPassword(s.accountUser.email,h._id).then(function(e){})["catch"](function(e){})}]),b.$onAuthStateChanged(m)}function m(e){if(e&&!_.isNull(e)){s.authid=e.uid,s.ref=firebase.database().ref().child("messages/"+e.uid);var a=firebase.database().ref().child("messages");s.sendM=firebase.database().ref().child("messages/"+e.uid+"/messages"),s.getmessage=l(s.sendM),s.getmessage.$loaded().then(function(){}),s.obj=l(s.sendM),s.checkexist=l(a)}}e.profile={},e.activeSub="",s.chatMessage="",s.accountUser={},s.glued=!0;var h=JSON.parse(o.get("user"));s.chatbox=!1;var b=p();s.showChat=function(){s.chatbox=!s.chatbox},h&&r.getAllPersonDetail(h.person_id).then(function(e){200==e.statusCode&&e.response.success&&(s.accountUser=e.response.result,g())}),s.sendMessage=function(){s.checkexist.$loaded(function(){var e=_.find(s.checkexist,{$id:s.authid});s.chatMessage&&!_.isEmpty(s.chatMessage)&&(_.isEmpty(e)?async.waterfall([function(e){s.ref.set({sender_id:h.sub_id,sender_name:h.displayName,created_at:firebase.database.ServerValue.TIMESTAMP}),e()},function(e){s.obj.$add({p_type:1,value:s.chatMessage,send_at:firebase.database.ServerValue.TIMESTAMP}),s.chatMessage=""}]):(s.obj.$add({p_type:1,value:s.chatMessage,send_at:firebase.database.ServerValue.TIMESTAMP}),s.chatMessage=""))})},s.logoutApp=function(){b.$signOut(),i.logout().then(function(e){if(200==e.statusCode&&e.response.success){var s=JSON.parse(o.get("user"));d.logTransaction("User Logout","LOGOUT",s.username,"User Logout USERNAME:="+s.username).then(function(){i.setCurrentUser(null),i.setUserToken(null),u.logout()}),a.go("login")}})},s.getCurrentUser=function(){i.userprofile().then(function(s){if(200==s.statusCode&&s.response.success){e.profile=s.response.result;var a=JSON.parse(o.get("user"));e.activeSub=a.company_name}else if(400==s.statusCode&&!s.response.success)return void t.error(s.response.msg,"Error")})},s.openSubscription=function(){var e=n.open({animation:!0,templateUrl:"./modules/templates/header.subscription.html",controller:"ModalSubscriptionCtrl",size:"sm"}),s=JSON.parse(o.get("user"));d.logTransaction("Active Subscription","DASHBOARD","N/A","User:="+s.username+" Views Active Subscription"),e.result.then(function(e){var s=JSON.parse(o.get("user"));s.sub_id=e.sub_id,s.company_name=e.company_name,s.subscriptionKey=e.subscriptionKey,s.subscriptionCode=e.subscriptionCode,s.one_signal_apiKey=e.one_signal_apiKey,s.one_signal_appID=e.one_signal_appID,o.set("user",JSON.stringify(s)),c(function(){a.go("main.dashboard",null,{reload:!0})},1e3)})},s.getCurrentUser()}function s(e,s,a){e.switchSubscription=function(e){a(function(){s.close(e)},300)},e.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("MainCtrl",e).controller("ModalSubscriptionCtrl",s),e.$inject=["$rootScope","$scope","$state","toastr","$uibModal","AuthFctry","humanFactory","localStorageService","$timeout","$auth","transLogFctry","$firebaseArray","$firebaseAuth","$firebaseObject"],s.$inject=["$scope","$uibModalInstance","$timeout"]}();
...
!function(){"use strict";function e(e,r,s,t,n,o,u){e.user={},e.login=function(){t.authenticate(e.user).then(function(e){e.success?(t.setUserToken(e.result.token),t.setCurrentUser(JSON.stringify(e.result.user)),u.logTransaction("User Logged In","LOGIN",e.result.user.username,"User Login for USERNAME:="+e.result.user.username),setTimeout(function(){s.info("Welcome back "+e.result.user.displayName)},2500),setTimeout(function(){r.go("main.dashboard")},3e3)):400===e.statusCode&&!e.response.success&&_.isArray(e.response.result)?(_.each(data.response.result,function(e){s.warning(e.msg,"Warning")}),setTimeout(function(){r.go("login")},2500)):(setTimeout(function(){s.error(e.msg,"Error")},3e3),setTimeout(function(){location=""},4e3))})},e.authenticate=function(e){n.authenticate(e).then(function(n){if(n){var i=n.data;console.log("resp: ",i),i.success?(t.setUserToken(i.result.token),t.setCurrentUser(JSON.stringify(i.result.user)),u.logTransaction("Social Media Logged In","LOGIN",i.result.user.username,"User Login for USERNAME:="+i.result.user.username+" TYPE:="+e),s.success("Login successfully with "+e.toUpperCase()+"!"),o(function(){r.go("main.dashboard")},100)):400===i.statusCode&&!i.response.success&&_.isArray(i.response.result)?_.each(i.response.result,function(e){s.warning(e.msg,"Warning")}):s.error(i.msg,"Error")}})["catch"](function(e){e.message?s.error(e.message):e.data?s.error(e.data.message,e.status):s.error(e)})}}angular.module("POS17").config(["$stateProvider","$routeProvider",function(e,r){var s=["$q","$auth",function(e,r){var s=e.defer();return r.isAuthenticated()?s.reject():s.resolve(),s.promise}];e.state("login",{url:"/login",templateUrl:"modules/login/login.html",controller:"LoginCtrl",resolve:{skipIfLoggedIn:s}}),r.when("/login",{templateUrl:"modules/login/login.html",controller:"LoginCtrl"})}]).controller("LoginCtrl",e),e.$inject=["$scope","$state","toastr","AuthFctry","$auth","$timeout","transLogFctry"]}();
...
!function(){"use strict";function e(e,s,t,r,o,i,a,n,c,d,l,u,p,g,h,m,f,v,y,T,b){e.loading1=!1,e.saveText="Save Entry",e.ptypes=[],e.attributes=[],e.tags=[],e.tagsArr=[],e.product_image=[],e.details={},e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.stockTrack=!1,e._stores={},e._stores.list=[],e._stores.selected=[],e._store={},e._store.selected={},e.inv={},e.inv.stockTrackQty=[],e.inv.stockTrackLevel=[],e.inv.unit={},e.inv.unit.selected={},e.inv.unit.list=[],e.inv_stockTrackDets=[],e.isEnabledstockTrack=!1,e.selectedUnit="",e.isImageNew=!1,e.tabprod={product:!0,media:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!0,related:!0},e.barcodeoptions={width:2,height:100,quite:10,displayValue:!0,font:"monospace",textAlign:"center",fontSize:12,backgroundColor:"",lineColor:"#000"},e.barcodesType=[{type:"ean",code:"EAN"},{type:"upc",code:"UPC"},{type:"code39",code:"Code39"},{type:"code128b",code:"Code128B"},{type:"code128c",code:"Code128c"},{type:"itf",code:"ITF"},{type:"itf14",code:"ITF14"}],e.mycode={},e.mycode.type="code128b",e.producttagsSettings={showCheckAll:!0,showUncheckAll:!0,enableSearch:!0,scrollable:!0};var P=JSON.parse(T.get("user"));o.p_id?b.logTransaction("View Product Details","PRODUCTS",o.p_id,"User:="+P.username+" View products details: ="+o.p_id):b.logTransaction("Add New Product","PRODUCTS","N/A","User:="+P.username+" Add new product entry"),l.getAllTags().then(function(s){s&&200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:r.error(s.response.msg,"Error")}),c.getAllStore().then(function(s){s&&200==s.statusCode&&s.response.success&&s&&s.response&&s.response.result&&_.each(s.response.result,function(s){e._stores.list.push({id:s.store_id,label:s.name,_id:s._id,address:s.address,isChecked:!1})})}),e.changeBarcodeType=function(s){y(function(){e.$apply(function(){e.mycode.type=s})},10)},_.isEmpty(o.p_id)?(e.showPublish=!1,e.showArchive=!1,e.tabprod={product:!0,media:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},a.getAllProdType().then(function(s){s&&200==s.statusCode&&s.response.success&&(e.ptypes=s.response.result)})):async.waterfall([function(s){a.getAllProdType().then(function(t){t&&200==t.statusCode&&t.response.success?(e.ptypes=t.response.result,s()):r.error(t&&t.response&&t.response.msg?t.response.msg:"Error","Error")})},function(s){i.getProductDetails(o.p_id).then(function(s){if(s&&200==s.statusCode&&s.response.success){e.details=s.response.result;var t=e.details.purchase_price;e.details.retail_price=e.details.purchase_price*e.details.markup/100+t,e.details.sell_price=e.details.retail_price,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.tabprod={product:!0,media:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!0,related:!0},e.product_image=e.details.product_images,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),l.getAllProductTags(o.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)})}})}]),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.removethumb=function(){e.details.img_default=null},e.upload=function(s){e.isImageNew=!0},e.archiveProduct=function(e){i.archiveProduct(e).then(function(e){e&&200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.publishProduct=function(e){i.publishProduct(e).then(function(e){e&&200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.deleteProductTags=function(e){o.p_id&&l.deleteProductTag(o.p_id,e.tags_id).then(function(e){return e&&200==e.statusCode&&e.response.success?void r.success(e.response.msg,"Success"):void r.error(e.response.msg,"Error")})},e.openUploader=function(){var e=h.open({animation:!0,templateUrl:"./modules/products/details/product.upload.modal.html",controller:"productUploaderModalCtrl",size:"lg",resolve:{product_id:function(){return o.p_id}}});e.result.then(function(e){s.reload()})},e.openLightboxModal=function(e){var s=[];s.push({url:e.image_path,thumbUrl:e.image_path}),m.openModal(s,0)},e.copyURLLink=function(e){return f.supported?(console.log("files.media_path: ",e.image_path),void f.copyText(e.image_path)):void r.warning("Sorry, copy to clipboard is not supported","Warning")},e.setAsThumbNail=function(t){console.log("files: ",t),e.modal={title:"Set as product thumbnail",message:"Are you sure to set this image?"},v.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){i.setProductImage(o.p_id,t._id).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.reload()):r.warning(e.response.msg,"Warning")})})},e.deleteAllMedia=function(){v.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.p_id&&i.deleteAllProductImage(o.p_id).then(function(e){return e&&200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s.reload()):void r.error(e.response.msg,"Error")})})},e.deleteSelected=function(t){v.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.p_id&&i.deleteProductImageFile(o.p_id,t._id).then(function(e){return e&&200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s.reload()):void r.error(e.response.msg,"Error")})})},e.pushToStockTrack=function(s,t,r,i,a){var n={store_id:t,stock_qty:r||0,stock_level:i||0,p_id:o.p_id,stock_unit:a};e.inv_stockTrackDets[s]=n},e.addProduct=function(){var t=e.inv.unit.selected._id;e.loading1=!0,e.saveText="Saving..",e.validate=[],e.details.item_description="",e.details.selectedUnit=e.selectedUnit,e.details.sales_unit_id=t,e.details.purchase_unit_id=null,e.details.qty_convert=null,e.details.inv_id=e.inv.inv_id,async.waterfall([function(s){o.p_id?i.updateProduct(o.p_id,e.details).then(function(t){t&&200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),e.loading1=!1,e.saveText="Save Entry",s(null,o.p_id)):(e.validate=t.response.result,_.each(e.validate,function(e){r.warning(t.response.msg,"Error - "+e.msg)}),e.loading1=!1,e.saveText="Save Entry")}):i.saveProduct(e.details).then(function(t){t&&200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),s(null,t.response.result.productid),e.loading1=!1,e.saveText="Save Entry"):(e.validate=t.response.result,_.each(e.validate,function(e){r.warning(t.response.msg,"Error - "+e.msg)}),e.loading1=!1,e.saveText="Save Entry")})},function(s,t){var o=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(i,a){i.isTag?l.saveTags(i).then(function(e){return e&&200==e.statusCode&&e.response.success?void l.saveProductTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void a()):void r.error(e.response.msg,"Error")}):void r.error(e.response.msg,"Error")}):l.saveProductTags(s,{tags_id:i.tags_id}).then(function(e){return e&&200==e.statusCode&&e.response.success?(o++,void a()):void r.error(e.response.msg,"Error")}),o>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,t){s.go(s.current,{p_id:e},{reload:!0})}])},e.calculateRetailPrice=function(s,t,r){if(isNaN(s))e.details.purchase_price="",e.details.markup="",e.details.retail_price="";else if(s&&t){var o=e.details.purchase_price;e.details.retail_price=e.details.purchase_price*e.details.markup/100+o}else e.details.retail_price=0},e.changeOf_PP=function(s,t,r){if(isNaN(e.details.purchase_price))e.details.purchase_price="",e.details.markup="";else{var o=e.details.purchase_price;e.details.retail_price=e.details.purchase_price*e.details.markup/100+o,e.details.sell_price=e.details.retail_price}},e.changeOf_MU=function(s,t,r){var o=e.details.purchase_price;e.details.retail_price=e.details.purchase_price*e.details.markup/100+o,e.details.sell_price=e.details.retail_price},e.changeOf_RP=function(s,t,r){e.details.markup=(e.details.retail_price-e.details.purchase_price)/e.details.purchase_price*100}}angular.module("POS17").controller("productsAEController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","tagsFactory","API_URL","API_VERSION","Upload","$uibModal","Lightbox","clipboard","ngDialog","$timeout","localStorageService","transLogFctry"]}();
...
!function(){"use strict";function e(e,t,s,l,a,r,d,n,c,i,o,u,p,h){e.search={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.filterStatus="Relevance",e.txtSearch="",e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.selectedArchivedDatas=[],e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0},e.reportFields={pb_id:"Bunble ID",bundle_name:"Name",bundle_overview:"Overview",bundle_description:"Description",bundle_code:"Product Code",barcode:"Barcode",bundle_brand:"Product Brand",product_type:"Product Type",product_type_id:"Product TypeID",sell_price:"Selling Price",start_date:"Start Date",end_date:"End Date",is_archived:"IsArchived",is_published:"IsPublished",_id:"UUID"};var b=JSON.parse(u.get("user"));o.logTransaction("View Product Bundles","PRODUCT BUNDLES","ALL","User:="+b.username+" View ALL List of product bundles");var f=function(){e.productIsLoading=!0,e.bundles=[],e.bundlecopy=[],e.productBundleTable=new i({page:1,count:10},{counts:[10,25,50,100],getData:function(t,l){d.getAllProductBundle().then(function(a){if(200==a.statusCode&&a.response.success){var d=a.response.result;if(_.each(d,function(e){e.date_created=moment(e.date_created).format("YYYY-MM-DD")}),e.bundlecopy=angular.copy(d),e.txtSearch&&"All"==e.applicationStatus?e.bundles=s("filter")(d,e.txtSearch):e.txtSearch&&"Publish"==e.applicationStatus?(e.bundles=s("filter")(d,{is_published:1}),e.bundles=s("filter")(e.bundles,e.txtSearch)):e.txtSearch&&"Archived"==e.applicationStatus?(e.bundles=s("filter")(d,{is_archived:1}),e.bundles=s("filter")(e.bundles,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus?(e.bundles=s("filter")(d,{is_published:0}),e.bundles=s("filter")(e.bundles,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.bundles=d:_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus?e.bundles=s("filter")(d,{is_published:1}):_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus?e.bundles=s("filter")(d,{is_archived:1}):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?e.bundles=s("filter")(d,{is_published:0}):e.bundles=d,"Most Viewed"==e.filterStatus?(e.bundles=s("orderBy")(e.bundles,"product_bundle_views",!0),e.bundles=_.filter(e.bundles,function(e){return parseInt(e.product_bundle_views)>0})):"Price: High to Low"==e.filterStatus?e.bundles=s("orderBy")(e.bundles,"sell_price",!0):"Price: Low to High"==e.filterStatus&&(e.bundles=s("orderBy")(e.bundles,"sell_price",!1)),e.tagsFilter&&e.tagsFilter.length>0){var n=[];_.each(e.tagsFilter,function(t){_.each(e.bundles,function(e){var s=_.find(e.tags,{tags_id:t.id});s&&n.push(e)})}),e.bundles=n}l.total(e.bundles.length);var c=e.bundles.slice((l.page()-1)*l.count(),l.page()*l.count());t.resolve(c),e.productIsLoading=!1}else e.productIsLoading=!1,r.error(a.response.msg,"Error")})}})};h.getAllTags().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){e.tagsArr.push({id:t.tags_id,label:t.tags,_id:t._id})})}else r.error(t.response.msg,"Error")}),e.selectEvents={onItemSelect:function(t){e.productBundleTable.reload()},onItemDeselect:function(t){e.productBundleTable.reload()}},e.edit=function(e){l.go("main.products-add",{p_id:e})},e.searchData=function(){e.productBundleTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productBundleTable.reload()},e.updateStatus=function(t){e.applicationStatus=t,e.productBundleTable.reload()},e.updateFilterStatus=function(t){e.filterStatus=t,e.productBundleTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.bundles,function(t){t.selected=e.selectDeselectAll,e.selectSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){console.log(t),t.selected?_.find(e.selectedDatas,{pb_id:t.pb_id})||(e.selectedDatas.push(t),1==t.is_published&&0==t.is_archived&&e.selectedPublishedDatas.push(t),0==t.is_published&&0==t.is_archived&&e.selectedDraftedDatas.push(t),1==t.is_archived&&0==t.is_published&&e.selectedArchivedDatas.push(t)):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pb_id!==t.pb_id}),e.selectedPublishedDatas=_.filter(e.selectedPublishedDatas,function(e){return e.pb_id!==product.pb_id}),e.selectedDraftedDatas=_.filter(e.selectedDraftedDatas,function(e){return e.pb_id!==product.pb_id}),e.selectedArchivedDatas=_.filter(e.selectedArchivedDatas,function(e){return e.pb_id!==product.pb_id})),e.deleteSomeData=e.selectedDatas.length>0},e.updateHistory=function(e){p.open({animation:!0,backdrop:"static",templateUrl:"./modules/products/bundles/bundle.auditlog.modal.html",controller:"productBundleAuditLogModalCtrl",size:"md",resolve:{pb_id:function(){return e}}})},e.toggleModal=function(t){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){d.archiveBundle(t).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void l.reload()):void r.error(e.response.msg,"Error")})})},e.archiveSelected=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1,s=e.selectedDraftedDatas.concat(e.selectedPublishedDatas);return s.length>0?void async.each(s,function(e,a){e.selected&&d.archiveBundle(e.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),t++,a(),void 0):void r.error(e.response.msg,"Error")}),t==s.length&&l.reload()}):void r.warning("Unable to Archive selected Bundle..Selected bundle are either archived","Warning")})},e.draftSelected=function(){e.modal={title:"Draft Product?",message:"Are you sure to Draft this selected bundle?"},c.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;e.selectedDatas.length>0&&async.eachSeries(e.selectedDatas,function(s,a){s.selected&&d.draftBundle(s.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),t++,a(),void 0):void r.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&l.reload()})})},e.publishSelected=function(t){e.modal={title:"Publish Product?",message:"Are you sure to Publish this selected bundle?"},c.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1,s=e.selectedDraftedDatas.concat(e.selectedArchivedDatas);s.length>0&&async.eachSeries(s,function(e,a){e.selected&&d.publishBundle(e.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),t++,a(),void 0):void r.error(e.response.msg,"Error")}),t==s.length&&l.reload()})})},f()}angular.module("POS17").controller("productBundlesController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","supplierFctry","ngDialog","ngTableParams","transLogFctry","localStorageService","$uibModal","tagsFactory"]}();
...
!function(){"use strict";function e(e,t,s,o,a,c,r,l,n,i,g){e.selectDeselectAll=!1,e.selectedDatas=[],e.reportFields={c_id:"ID",name:"Name",label:"Label",description:"Description",c_image:"Image",parent_id:"Parent Category"};var d=JSON.parse(i.get("user"));g.logTransaction("View Categories","CATEGORIES","ALL","User:="+d.username+" View all list of categories");var u=function(){e.categoryIsLoading=!0,e.categories=[],e.categoriescopy=[],e.categoryTable=new n({page:1,count:10},{counts:[10,25,50,100],getData:function(t,o){r.getAllCategory().then(function(a){if(200==a.statusCode&&a.response.success){var r=a.response.result;e.categoriescopy=angular.copy(e.categories),e.txtSearch?e.categories=s("filter")(r,e.txtSearch):e.categories=r,o.total(e.categories.length);var l=e.categories.slice((o.page()-1)*o.count(),o.page()*o.count());t.resolve(l),e.categoryIsLoading=!1}else e.categoryIsLoading=!1,c.error(a.response.msg,"Error")})}})};e.refresh=function(){e.categoryIsLoading=!0,e.categoryTable.reload()},e.edit=function(e){o.go("main.settings-categories-add",{c_id:e})},e.searchData=function(){e.categoryTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.categories,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.c_id===t.c_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.c_id!==t.c_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(t){a.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.deleteCategory(t).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void o.reload()):void c.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){a.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,a){s.selected&&(console.log("category: ",s),r.deleteCategory(s.c_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(c.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&o.reload(),a(),void 0):void c.error(s.response.msg,"Error")}))})})},u()}angular.module("POS17").controller("categoryController",e),e.$inject=["$scope","$http","$filter","$state","ngDialog","toastr","categoryFactory","$timeout","ngTableParams","localStorageService","transLogFctry"]}();
...
!function(){"use strict";function e(e,t,s,o,a,n,r,i,l,c,p,d){console.log("personController"),e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.selectedDatas=[],e.reportFields={person_id:"ID",firstname:"First Name",middlename:"Middle Name",lastname:"Last Name",thumbnail_media:"Thumbnail Media",displayName:"Display Name",mobile:"Mobile No.",email:"Email Address",address:"Address 1",address2:"Address 2",country:"country",city:"City",state:"State",zipcode:"Zip Code",timeZone:"Time Zone",company_id:"Company ID",company_name:"Company Name",company_username:"Company Username",locale:"Locale",tin:"TIN",per_type_id:"Type ID",person_type:"Type",date_start:"Valid From",date_end:"Valid Until",image:"Image Path",image_etag:"Image eTag",image_key:"Image Key",image_mimetype:"Image MimeType",image_originalname:"Image Original Name",image_size:"Image Size",store_id:"Store ID",isActive:"isActive",isActiveAcnt:"isActiveAcnt",isSubscriber:"isSubscriber",date_created:"Date Created",_id:"UUID"};var m=function(){e.personisLoading=!0,e.persons=[],e.personscopy=[],e.personsTable=new c({page:1,count:10},{counts:[10,25,50,100],getData:function(t,s){r.getAllPerson().then(function(a){if(200==a.statusCode&&a.response.success){var n=a.response.result;e.personscopy=angular.copy(e.persons),_.each(n,function(e){if(_.isNull(e.date_end))e.isActiveAcnt=!0;else{var t=new Date,s=new Date(e.date_end),o=moment(t),a=moment(s),n=moment.duration(o.diff(a)),r=n.asDays();r>=1?e.isActiveAcnt=!1:e.isActiveAcnt=!0}}),e.txtSearch&&"All"==e.applicationStatus?e.persons=o("filter")(n,e.txtSearch):e.txtSearch&&"Employee"==e.applicationStatus?(e.persons=o("filter")(n,{per_type_id:1}),e.persons=o("filter")(e.persons,e.txtSearch)):e.txtSearch&&"Customer"==e.applicationStatus?(e.persons=o("filter")(n,{per_type_id:2}),e.persons=o("filter")(e.persons,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.persons=n:_.isUndefined(e.txtSearch)&&"Employee"==e.applicationStatus?e.persons=o("filter")(n,{per_type_id:1}):_.isUndefined(e.txtSearch)&&"Customer"==e.applicationStatus?e.persons=o("filter")(n,{per_type_id:2}):e.persons=n,e.persons=_.filter(e.persons,function(e){return"Employee"==e.person_type?e:1==e.isSubscriber?e:void 0}),console.log("persons: ",e.persons),s.total(e.persons.length);var r=e.persons.slice((s.page()-1)*s.count(),s.page()*s.count());t.resolve(r),e.personisLoading=!1}else e.personisLoading=!1,i.error(a.response.msg,"Error")})}})};m(),e.refresh=function(){e.personsTable.reload()},e.updateStatus=function(t){e.applicationStatus=t,e.personsTable.reload()},e.searchData=function(){e.personsTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.persons,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.person_id===t.person_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.person_id!==t.person_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(t){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.deletePersonel(t).then(function(e){return 200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),void a.reload()):void i.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,o){s.selected&&(console.log("person: ",s),r.deletePersonel(s.person_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(i.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&a.reload(),o(),void 0):void i.error(s.response.msg,"Error")}))})})}}angular.module("POS17").controller("personController",e),e.$inject=["$scope","$rootScope","$http","$filter","$state","ngDialog","humanFactory","toastr","$timeout","ngTableParams","localStorageService","transLogFctry"]}();
...
!function(){"use strict";function e(e,t,a,r,s,o,n,l,u,c,d,i){function p(){e.trace1=e.default_trace_format(),e.trace2=e.default_trace_format(),e.trace3=e.default_trace_format(),e.trace4=e.default_trace_format(),e.trace5=e.default_trace_format(),e.trace6=e.default_trace_format(),e.trace7=e.default_trace_format(),e.trace8=e.default_trace_format(),e.trace9={x:e.trace7.x,y:e.trace7.y,type:"bar",fill:"tonexty",mode:"lines+markers",marker:{color:"#247571"},showlegend:!0,name:"Discount"},e.trace10={x:e.trace1.x,y:e.trace1.y,type:"bar",fill:"tonexty",mode:"lines+markers",marker:{color:"#35aaa6"},showlegend:!0,name:"Revenue"},e.trace11={x:e.trace3.x,y:e.trace3.y,type:"line",fill:"tonexty",mode:"lines+markers",marker:{color:"#09211f"},showlegend:!0,name:"Item Sold"}}function m(){e.prod_sales_s1={x:[],y:[],name:"",type:""}}function y(){e.prod_user_1={x:[],y:[],showlegend:!0,name:"Users",type:"bar"},e.prod_user_sales={x:[],y:[],type:"line",fill:"tonexty",mode:"lines",marker:{color:"orange"},showlegend:!0,name:"Sales"},e.prod_user_discount={x:[],y:[],type:"line",fill:"tonexty",mode:"lines",marker:{color:"red"},showlegend:!0,name:"Discount"},e.prod_user_itemsold={x:[],y:[],type:"line",fill:"tonexty",mode:"lines",marker:{color:"green"},showlegend:!0,name:"Item Sold"},e.prod_user_transaction={x:[],y:[],type:"line",fill:"tonexty",mode:"lines",marker:{color:"blue"},showlegend:!0,name:"Transactions"}}function f(){e.prod_performance=[{y:[],x:[],type:"bar",orientation:"h"}]}console.log("reportDashboardController.."),e.isloadingGraphs=!1,e.selectedParam1="User",e.selectedParam2="Revenue",e.selectedParam3="Stock On Hand",e.data2=[],e.cssPre="",e.prevDay=moment().subtract(1,"days").format("YYYY-MM-DD"),e.currDate=moment().format("YYYY-MM-DD");var g=JSON.parse(s.get("user")),h=(new Date).toString().match(/([-\+][0-9]+)\s/)[1];e.statsOfPrevDay={},e.statsOfCurrDay={},String.prototype.insert=function(e,t){return e>0?this.substring(0,e)+t+this.substring(e,this.length):t+this},e.date={startDate:moment().subtract(1,"days"),endDate:moment()},e.opts={locale:{applyClass:"btn-green",applyLabel:"Apply",fromLabel:"Start Date:",toLabel:"End Date:",cancelLabel:"Cancel",customRangeLabel:"Custom Range",firstDay:1},ranges:{Today:[moment().subtract("days"),moment()],Yesterday:[moment().subtract(1,"days"),moment()],"Last 7 Days":[moment().subtract(6,"days"),moment()],"Last 30 Days":[moment().subtract(29,"days"),moment()]}},e.filterBy="day",e.sub_id=g.sub_id,e.dateTo=moment().format("YYYY-MM-DD"),e.timezone=h.insert(3,":"),e.arg=1,e.filterBy_2="user",e.sub_id_2=g.sub_id,e.rs_dateTo=moment().format("YYYY-MM-DD"),e.rs_dateFrom=moment(e.rs_dateTo).subtract(7,"days").format("YYYY-MM-DD"),e.timezone_2=h.insert(3,":"),e.arg_2=1,e.changeOf_revenue_Stat={},e.changeOf_items_sold_Stat={},e.changeOf_customers_Stat={},e.changeOf_discount_Stat={},e.changeOf_discount_percent_Stat={},e.changeOf_basket_value_Stat={},e.changeOf_basket_size_Stat={},e.changeOf_gross_profit_Stat={},e.formatoDouble=function(e){return e&&e!=1/0?i("number")(e,2)+"%":"previous value is 0"},e.checkFiltered=function(){return"day"==e.filterBy?(console.log("checkFiltered : day"),"date"):(console.log("checkFiltered : not day"),"linear")},e.checkKey=function(){return"day"==e.filterBy?(console.log("checkKey : day"),"x"):(console.log("checkKey : not day"),"_label")},e.pickAcolor=function(e){return Math.sign(e)==-1?"red":1==Math.sign(e)?"green":"dark-gray"},e.pickAnArrow=function(e){return Math.sign(e)==-1?"zmdi zmdi-trending-down":1==Math.sign(e)?"zmdi zmdi-trending-up":""},e.layout={autosize:!0,width:300,height:180,xaxis:{title:"",autorange:!0,showgrid:!1,zeroline:!1,showline:!1,autotick:!0,ticks:"",tickfont:{size:10,color:"gray"},nticks:7,showticklabels:!0},yaxis:{title:"",tickfont:{size:10,color:"gray"},autorange:!0,showgrid:!1,zeroline:!1,showline:!1,autotick:!0,ticks:"",showticklabels:!0},margin:{l:50,r:20,t:5,b:50,autoexpand:!0}};var b=moment().startOf("year").format("YYYY-MM-DD");e.getDateFrom=function(){return"day"==e.filterBy?moment(e.dateTo).subtract(7,"days").format("YYYY-MM-DD")<b?b:moment(e.dateTo).subtract(7,"days").format("YYYY-MM-DD"):"week"==e.filterBy?moment(e.dateTo).subtract(49,"days").format("YYYY-MM-DD")<b?b:moment(e.dateTo).subtract(49,"days").format("YYYY-MM-DD"):"month"==e.filterBy?moment(e.dateTo).subtract(212,"days").format("YYYY-MM-DD")<b?b:moment(e.dateTo).subtract(212,"days").format("YYYY-MM-DD"):"year"==e.filterBy?moment(e.dateTo).subtract(2555,"days").format("YYYY-MM-DD")<b?b:moment(e.dateTo).subtract(2555,"days").format("YYYY-MM-DD"):void 0},e.getDashboardReports=function(){e.isloadingGraphs=!0,e.paramobj={sub_id:e.sub_id,filterBy:e.filterBy,dateFrom:e.getDateFrom(),dateTo:moment(e.dateTo).format("YYYY-MM-DD"),timezone:e.timezone,arg:1},d.getDashboardReport(e.paramobj).then(function(t){e.data1=t.response,e.getOverall_Revenue=e.data1&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].revenue?e.data1[t.response.length-1].revenue-e.data1[t.response.length-1].discount:null,e.getOverall_Salecount=e.data1&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].items_sold?e.data1[t.response.length-1].items_sold:null,e.getOverall_Customercount=e.data1&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].customers?e.data1[t.response.length-1].customers:null,e.getOverall_Grossprofit=e.data1&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].gross_profit?e.data1[t.response.length-1].gross_profit:null,e.getOverall_Discount=e.data1&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].discount?e.data1[t.response.length-1].discount:null,e.getOverall_Discountpercent=e.data1&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].discount_percent?e.data1[t.response.length-1].discount_percent:null,e.getOverall_Basketsize=e.data1&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].basket_size?e.data1[t.response.length-1].basket_size:null,e.getOverall_Basketvalue=e.data1&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].basket_value?e.data1[t.response.length-1].basket_value:null,_.each(t.response,function(a,r){e.trace1.x.push(a.label),e.trace1.y.push(a.revenue),e.trace2.x.push(a.label),e.trace2.y.push(a.gross_profit),e.trace3.x.push(a.label),e.trace3.y.push(a.items_sold),e.trace4.x.push(a.label),e.trace4.y.push(a.customers),e.trace5.x.push(a.label),e.trace5.y.push(a.basket_size),e.trace6.x.push(a.label),e.trace6.y.push(a.basket_value),e.trace7.x.push(a.label),e.trace7.y.push(a.discount),e.trace8.x.push(a.label),e.trace8.y.push(a.discount_percent),a&&a.transaction_date&&e.data1[t.response.length-2]&&e.data1[t.response.length-2].transaction_date&&e.data1[t.response.length-1]&&e.data1[t.response.length-1].transaction_date&&(moment(a.transaction_date).format("YYYY-MM-DD")==e.data1[t.response.length-2].transaction_date&&(a.prev_revenue_Stat=a.revenue,a.prev_items_sold_Stat=a.items_sold,a.prev_customers_Stat=a.customers,a.prev_discount_Stat=a.discount,a.prev_discount_percent_Stat=a.discount_percent,a.prev_basket_value_Stat=a.basket_value,a.prev_basket_size_Stat=a.basket_size,a.prev_gross_profit_Stat=a.gross_profit,e.statsOfPrevDay=a),moment(a.transaction_date).format("YYYY-MM-DD")==e.data1[t.response.length-1].transaction_date&&(a.prev_revenue_Stat=e.statsOfPrevDay.revenue,a.prev_items_sold_Stat=e.statsOfPrevDay.items_sold,a.prev_customers_Stat=e.statsOfPrevDay.customers,a.prev_discount_Stat=e.statsOfPrevDay.discount,a.prev_discount_percent_Stat=e.statsOfPrevDay.discount_percent,a.prev_basket_value_Stat=e.statsOfPrevDay.basket_value,a.prev_basket_size_Stat=e.statsOfPrevDay.basket_size,a.prev_gross_profit_Stat=e.statsOfPrevDay.gross_profit,e.changeOf_revenue_Stat=(a.revenue-a.prev_revenue_Stat)/a.prev_revenue_Stat*100,e.changeOf_items_sold_Stat=(a.items_sold-a.prev_items_sold_Stat)/a.prev_items_sold_Stat*100,e.changeOf_customers_Stat=(a.customers-a.prev_customers_Stat)/a.prev_customers_Stat*100,e.changeOf_discount_Stat=(a.discount-a.prev_discount_Stat)/a.prev_discount_Stat*100,e.changeOf_discount_percent_Stat=(a.discount_percent-a.prev_discount_percent_Stat)/a.prev_discount_percent_Stat*100,e.changeOf_basket_value_Stat=(a.basket_value-a.prev_basket_value_Stat)/a.prev_basket_value_Stat*100,e.changeOf_basket_size_Stat=(a.basket_size-a.prev_basket_size_Stat)/a.prev_basket_size_Stat*100,e.changeOf_gross_profit_Stat=(a.gross_profit-a.prev_gross_profit_Stat)/a.prev_gross_profit_Stat*100))}),"main.reports-dashboard"==a.current.name&&(e.isloadingGraphs=!1,e.t1_data=[e.trace1],Plotly.newPlot("myDiv1",e.t1_data,e.layout),e.t2_data=[e.trace2],Plotly.newPlot("myDiv2",e.t2_data,e.layout),e.t3_data=[e.trace3],Plotly.newPlot("myDiv3",e.t3_data,e.layout),e.t4_data=[e.trace4],Plotly.newPlot("myDiv4",e.t4_data,e.layout),e.t5_data=[e.trace5],Plotly.newPlot("myDiv5",e.t5_data,e.layout),e.t6_data=[e.trace6],Plotly.newPlot("myDiv6",e.t6_data,e.layout),e.t7_data=[e.trace7],Plotly.newPlot("myDiv7",e.t7_data,e.layout),e.t8_data=[e.trace8],Plotly.newPlot("myDiv8",e.t8_data,e.layout),e.loadSummaryReports())})},e.getDashboardReportsByStore=function(){e.paramobj={sub_id:e.sub_id,filterBy:e.filterBy,dateFrom:e.getDateFrom(),dateTo:moment(e.dateTo).format("YYYY-MM-DD"),timezone:e.timezone,arg:2},d.getDashboardReport(e.paramobj).then(function(t){e.data2=t.response,e.getOverall_Revenue_byStore=_.sumBy(e.data2,"revenue"),e.getOverall_Salecount_byStore=_.sumBy(e.data2,"items_sold"),e.getOverall_Customercount_byStore=_.sumBy(e.data2,"customers"),e.getOverall_Grossprofit_byStore=_.sumBy(e.data2,"gross_profit"),e.getOverall_Discount_byStore=_.sumBy(e.data2,"discount"),e.getOverall_Discountpercent_byStore=_.sumBy(e.data2,"discount_percent"),e.getOverall_Basketsize_byStore=_.sumBy(e.data2,"basket_size"),e.getOverall_Basketvalue_byStore=_.sumBy(e.data2,"basket_value"),_.each(e.data2,function(t,a){t.percent_revenue_by_store=t.revenue/e.getOverall_Revenue_byStore*100,t.percent_items_sold_by_store=t.items_sold/e.getOverall_Salecount_byStore*100,t.percent_customers_by_store=t.customers/e.getOverall_Customercount_byStore*100,t.percent_gross_profit_by_store=t.gross_profit/e.getOverall_Grossprofit_byStore*100,t.percent_discount_by_store=t.discount/e.getOverall_Discount_byStore*100,t.percent_discount_percent_by_store=t.discount_percent/e.getOverall_Discountpercent_byStore*100,t.percent_basket_size_by_store=t.basket_size/e.getOverall_Basketsize_byStore*100,t.percent_basket_value_by_store=t.basket_value/e.getOverall_Basketvalue_byStore*100})})},e.getDashboardSalesReports=function(t){e.paramobj2={sub_id:e.sub_id_2,filterBy:t,dateFrom:moment(e.rs_dateFrom).format("YYYY-MM-DD"),dateTo:moment(e.dateTo).format("YYYY-MM-DD"),timezone:e.timezone_2,arg:1},d.getDashboardSalesAndInventoryReport(e.paramobj2).then(function(a){switch(t){case"product":e.productPerformance(a.response),e.productSalesByDate(a.response);break;case"customer":_.each(a.response,function(e,t){});break;case"user":e.getsatbsp_div(a.response),e.calculateUserStats(a.response);break;default:console.log("case not defined, return nothing")}})},e.getDashboardInventoryReports=function(){e.selectedParam3="Stock on hand",e.paramobj2={sub_id:e.sub_id_2,arg:2,filterBy:"on hand"},d.getDashboardSalesAndInventoryReport(e.paramobj2).then(function(t){e.invProducts=_.filter(t.response,function(e){return"on hand"==e.stock_status})})},e.updateInventoryReportType=function(t){e.selectedParam3="Low in stocks",e.paramobj2={sub_id:e.sub_id_2,arg:2,filterBy:"out of stock"},d.getDashboardSalesAndInventoryReport(e.paramobj2).then(function(t){e.invProducts=_.filter(t.response,function(e){return"out of stock"==e.stock_status})})},e.productSalesByDate=function(t){e.arr=[];var r=_.groupBy(t,"transaction_date"),s=0;_.each(r,function(t,r){s++;var o={x:[],y:[],name:"",type:"bar"};_.each(t,function(e,t){o.x.push(r),o.y.push(e.total_sales),o.name=e.product_name}),e.arr.push(o),s==t.length-1&&(e.srlayout={height:200,margin:{l:50,r:20,t:5,b:50,autoexpand:!0},barmode:"stack",xaxis:{title:""}},"main.reports-dashboard"==a.current.name)})},e.productPerformance=function(t){var r=_.groupBy(t,"product_name");e.groupedbyproductname=[],_.each(r,function(t,a){var r={discount:_.sumBy(t,"discount"),product_name:t[0].product_name,product_type:t[0].product_type,quantity:_.sumBy(t,"quantity"),store_name:t[0].store_name,total_sales:_.sumBy(t,"total_sales")-_.sumBy(t,"discount")};e.groupedbyproductname.push(r)}),e.productPerformance_data=i("limitTo")(_.orderBy(e.groupedbyproductname,["quantity"],["desc"]),5),e.pp={height:500,margin:{l:200,r:0,t:5,b:50,autoexpand:!0},xaxis:{title:""}},_.each(e.groupedbyproductname,function(t,r){e.prod_performance[0].y.push(t.product_name),e.prod_performance[0].x.push(t.total_sales),e.groupedbyproductname.length-1==r&&"main.reports-dashboard"==a.current.name})},e.getsatbsp_div=function(t){e.arr2=[],e.user_sblayout={height:220,margin:{l:50,r:20,t:5,b:50,autoexpand:!0},xaxis:{title:""}},_.each(t,function(r,s){e.prod_user_1.x.push(r.sales_person),e.prod_user_1.y.push(r.total_sales),e.prod_user_sales.x.push(r.sales_person),e.prod_user_sales.y.push(r.total_sales),e.prod_user_discount.x.push(r.sales_person),e.prod_user_discount.y.push(r.discount),e.prod_user_itemsold.x.push(r.sales_person),e.prod_user_itemsold.y.push(r.total_items),e.prod_user_transaction.x.push(r.sales_person),e.prod_user_transaction.y.push(r.transactions),e.arr2=[e.prod_user_1,e.prod_user_sales,e.prod_user_discount,e.prod_user_itemsold,e.prod_user_transaction],s==t.length-1&&"main.reports-dashboard"==a.current.name})},e.calculateUserStats=function(t){e.copyOfFilteredSalesPerson=[],e.groupedBy_sales_person=_.groupBy(t,"sales_person"),console.log("groupedBy_sales_person ",e.groupedBy_sales_person),e.filteredSalesPerson=i("limitTo")(_.orderBy(e.groupedBy_sales_person,["total_sales"],["desc"]),5),_.each(e.filteredSalesPerson,function(t,a){var r={sales_person:t[a].sales_person,total_sales:_.sumBy(t,"total_sales")-_.sumBy(t,"discount"),total_transactions:_.sumBy(t,"transactions")};e.copyOfFilteredSalesPerson.push(r)})},e.formatSalesReport=function(t,a){if(e.formattedSalesReport=[],"product_name"==a){var r=_.groupBy(t,a);_.each(r,function(t,a){var r={summary:a,revenue:_.sumBy(t,"total_sales")-_.sumBy(t,"discount"),costofgoods:"0.00",gross:"0.00"};e.formattedSalesReport.push(r)})}else if("customer"==a){var r=_.groupBy(t,a);_.each(r,function(t,a){var r={summary:a,revenue:_.sumBy(t,"revenue")-_.sumBy(t,"discount"),costofgoods:"0.00",gross:"0.00"};e.formattedSalesReport.push(r)})}else if("sales_person"==a){var r=_.groupBy(t,a);_.each(r,function(t,a){var r={summary:a,revenue:_.sumBy(t,"total_sales")-_.sumBy(t,"discount"),costofgoods:"0.00",gross:"0.00"};e.formattedSalesReport.push(r)})}},e.updateSalesSummary=function(t){e.paramobj2={sub_id:e.sub_id_2,filterBy:t,dateTo:moment(e.rs_dateTo).format("YYYY-MM-DD"),dateFrom:moment(e.rs_dateFrom).format("YYYY-MM-DD"),timezone:e.timezone_2,arg:1},d.getDashboardSalesAndInventoryReport(e.paramobj2).then(function(a){switch(t.toLowerCase()){case"product":e.filteredSalesRep=a.response,e.selectedParam1="Product",e.formatSalesReport(a.response,"product_name");break;case"customer":e.filteredSalesRep=a.response,e.selectedParam1="Customer",e.formatSalesReport(a.response,"customer");break;case"user":e.filteredSalesRep=a.response,e.selectedParam1="User",e.formatSalesReport(a.response,"sales_person");break;default:console.log("case not defined, return nothing")}})},e.updateSalesMeasures=function(e){},e.dashboardreportChangeDate=function(){e.rs_dateFrom=e.getDateFrom(),e.refresh()},e.getSalesReportsByStore=function(t,a,r){e.paramobj={sub_id:e.sub_id,filterBy:t,dateFrom:a,dateTo:moment(e.dateTo).format("YYYY-MM-DD"),timezone:e.timezone,arg:2}},e.default_trace_format=function(){return{x:[],y:[],type:"line",fill:"tonexty",mode:"lines+markers",marker:{color:"#34a8a5"}}};e.loadSummaryReports=function(){e.srlayout={height:200,margin:{l:50,r:20,t:5,b:50,autoexpand:!0},barmode:"stack",xaxis:{title:""}},e.summary_data=[e.trace9,e.trace10,e.trace11]},e.refresh=function(){p(),m(),y(),f(),e.getDashboardReports(),e.getDashboardReportsByStore(),e.getDashboardSalesReports("product"),e.getDashboardSalesReports("user"),e.getDashboardSalesReports("customer")},e.setActive=function(t){switch(e.filterBy="",t){case"day":e.filterBy=t,e.refresh();break;case"week":e.filterBy=t,e.refresh();break;case"month":e.filterBy=t,e.refresh();break;case"year":e.filterBy=t,e.refresh();break;default:e.filterBy="day",e.refresh()}},e.init=function(){"main.reports-inventory"==a.current.name?e.getDashboardInventoryReports():"main.reports-sales"==a.current.name?e.updateSalesSummary(e.selectedParam1):e.setActive("")},e.init()}angular.module("POS17").controller("reportDashboardController",e),e.$inject=["$scope","$timeout","$state","$stateParams","localStorageService","toastr","productFactory","humanFactory","useraccountsFctry","usergroupsFctry","dashboardReportsFctry","$filter"]}();
...
!function(){"use strict";function e(e,t,o,s,a,i,l,n,c,u,r,d){e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[],e.reportFields={quote_id:"Quotation ID",quote_number:"Quote Number",quote_status:"Status",quote_date:"Quote Date",customer_id:"Customer ID",company_id:"Company ID",currency_id:"Currency ID",comments:"Quote Memo",terms:"Quote Terms",other_fee:"Other Fee",tax:"Tax",sub_total:"Sub-Total",total_fee:"Total Fee",bill_to_name:"Bill To",bill_to_address:"Billing Address",bill_to_city:"Billing City",bill_to_state:"Billing State",bill_to_zipcode:"Billing Zip Code",bill_to_country:"Billing Country",ship_to:"Ship To Customer ID",ship_to_name:"Ship To",ship_to_address:"Shipping Address",ship_to_city:"Shipping City",ship_to_state:"Shipping State",ship_to_zipcode:"Shippping Zip Code",ship_to_country:"Shipping Country",sp_id:"SP_ID",sub_id:"Subscription ID",store_id:"Store ID",staff_id:"Created By",valid_until:"Valid Quote Until",date_created:"Date Created",quote_item_list:"Items",_id:"UUID"};var p=JSON.parse(u.get("user"));r.logTransaction("View Quotes","QUOTES","ALL","User:="+p.username+" View all list of Quotes");var h=function(){e.quotes=[],e.quoteTable=new l({page:1,count:10},{counts:[10,25,50,100],getData:function(t,a){c.getAllQuotes().then(function(i){if(200==i.statusCode&&i.response.success){var l=i.response.result;e.txtSearch&&"All"==e.applicationStatus?e.quotes=o("filter")(l,e.txtSearch):e.txtSearch&&"Active"==e.applicationStatus?(e.quotes=o("filter")(l,{is_active:1}),e.quotes=o("filter")(e.quotes,e.txtSearch)):e.txtSearch&&"Inactive"==e.applicationStatus?(e.quotes=o("filter")(l,{is_active:0}),e.quotes=o("filter")(e.quotes,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.quotes=l:_.isUndefined(e.txtSearch)&&"Active"==e.applicationStatus?e.quotes=o("filter")(l,{is_active:1}):_.isUndefined(e.txtSearch)&&"Inactive"==e.applicationStatus?e.quotes=o("filter")(l,{is_active:0}):e.quotes=l,a.total(e.quotes.length);var n=e.quotes.slice((a.page()-1)*a.count(),a.page()*a.count());t.resolve(n)}else s.error(i.response.msg,"Error")})}})};h(),e.refresh=function(){e.quoteTable.reload()},e.edit=function(e){t.go("main.quotes-detail",{quote_id:e})},e.updateStatus=function(t){e.applicationStatus=t,e.quoteTable.reload()},e.searchData=function(){e.quoteTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.quotes,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.quote_id===t.quote_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.quote_id!==t.quote_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var o=0;async.each(e.selectedDatas,function(a,i){a.selected&&c.deleteQuoteInfo(a.quote_id).then(function(a){return 200==a.statusCode&&a.response.success?(s.success(a.response.msg,"Success"),++o,o==e.selectedDatas.length&&t.reload(),i(),void 0):void s.error(a.response.msg,"Error")})})})}}angular.module("POS17").controller("quotesController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","ngTableParams","ngDialog","quoteFactory","localStorageService","transLogFctry","$uibModal"]}();
...
!function(){"use strict";function e(e,t,a,s,l,i,r,c,o,n,d,u,f){e.selectDeselectAll=!1,e.applicationStatus="All",e.filterStatus="Relevance",e.txtSearch="",e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0},e.reportFields={article_id:"Article ID",title:"Article Title",article:"Overview",description:"Description",thumbnail_media:"Thumbnail Media",date_implemented:"Date Implemented",date_created:"Date Created",sp_id:"SP_ID",sub_id:"Subscription ID",is_active:"IsActive",_id:"UUID"};var g=JSON.parse(d.get("user"));n.logTransaction("View Articles","ARTICLES","ALL","User:="+g.username+" View all list of articles");var h=function(){e.articleisLoading=!0,e.articles=[],e.articleTable=new c({page:1,count:10},{counts:[10,25,50,100],getData:function(t,l){r.getArticle().then(function(i){if(200==i.statusCode&&i.response.success){var r=i.response.result;if(e.txtSearch&&"All"==e.applicationStatus?e.articles=a("filter")(r,e.txtSearch):e.txtSearch&&"Published"==e.applicationStatus?(e.articles=a("filter")(r,{is_active:1}),e.articles=a("filter")(e.articles,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus?(e.articles=a("filter")(r,{is_active:0}),e.articles=a("filter")(e.articles,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.articles=r:_.isUndefined(e.txtSearch)&&"Published"==e.applicationStatus?e.articles=a("filter")(r,{is_active:1}):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?e.articles=a("filter")(r,{is_active:0}):e.articles=r,"Most Viewed"==e.filterStatus&&(e.articles=a("orderBy")(e.articles,"article_views",!0),e.articles=_.filter(e.articles,function(e){return parseInt(e.article_views)>0})),e.tagsFilter&&e.tagsFilter.length>0){var c=[];_.each(e.tagsFilter,function(t){_.each(e.articles,function(e){var a=_.find(e.tags,{tags_id:t.id});a&&c.push(e)})}),e.articles=c}l.total(e.articles.length);var o=e.articles.slice((l.page()-1)*l.count(),l.page()*l.count());t.resolve(o),e.articleisLoading=!1}else s.error(i.response.msg,"Error"),e.articleisLoading=!1})}})};f.getAllTags().then(function(t){if(200==t.statusCode&&t.response.success){var a=t.response.result;_.each(a,function(t){e.tagsArr.push({id:t.tags_id,label:t.tags,_id:t._id})})}else s.error(t.response.msg,"Error")}),e.selectEvents={onItemSelect:function(t){e.articleTable.reload()},onItemDeselect:function(t){e.articleTable.reload()}},e.refresh=function(){e.articleisLoading=!0,e.articleTable.reload()},e.edit=function(e){t.go("main.articles-detail",{article_id:e})},e.updateStatus=function(t){e.applicationStatus=t,e.articleTable.reload()},e.updateFilterStatus=function(t){e.filterStatus=t,e.articleTable.reload()},e.searchData=function(){e.articleTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.articles,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.article_id===t.article_id})||(e.selectedDatas.push(t),1==t.is_active&&e.selectedPublishedDatas.push(t),0==t.is_active&&e.selectedDraftedDatas.push(t)):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.article_id!==t.article_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(a){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.deleteArticle(a).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void t.reload()):void s.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.updateHistory=function(e){u.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/audit.log.modal.html",controller:"articleAuditLogModalCtrl",size:"md",resolve:{article_id:function(){return e}}})},e.deleteSelected=function(){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=0;async.each(e.selectedDatas,function(l,i){l.selected&&r.deleteArticle(l.article_id).then(function(l){return 200==l.statusCode&&l.response.success?(s.success(l.response.msg,"Success"),++a,a==e.selectedDatas.length&&t.reload(),i(),void 0):void s.error(l.response.msg,"Error")})})})},e.draftSelected=function(){e.modal={title:"Draft Article?",message:"Are you sure to Draft this selected article?"},o.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=1;return e.selectedPublishedDatas.length>0?void async.eachSeries(e.selectedPublishedDatas,function(l,i){l.selected&&1==l.is_active&&r.draftArticle(l.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),a++,i(),void 0):void s.error(e.response.msg,"Error")}),console.log("dataCountToDelete: ",a),a==e.selectedPublishedDatas.length&&t.reload()}):void s.warning("Unable to Draft selected Articles..Selected articles are either archived or already drafted","Warning")})},e.publishSelected=function(a){e.modal={title:"Publish Article?",message:"Are you sure to Publish this selected article?"},o.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=1;return e.selectedDraftedDatas.length>0?void async.eachSeries(e.selectedDraftedDatas,function(l,i){l.selected&&0==l.is_active&&r.publishArticle(l.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),a++,i(),void 0):void s.error(e.response.msg,"Error")}),console.log("dataCountToDelete: ",a),a==e.selectedDraftedDatas.length&&t.reload()}):void s.warning("Unable to Publish selected Articles..Selected articles are either archived or already published","Warning")})},h()}angular.module("POS17").controller("articleController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","articleFctry","ngTableParams","ngDialog","transLogFctry","localStorageService","$uibModal","tagsFactory"]}();
...
!function(){"use strict";function e(e,t,s,o,i,r,l,a,c,p,n,d,u){e.name="-Type-",e.status="All",e.txtSearch="",e.type={},e.selectDeselectAll=!1,e.selectedDatas=[],e.selectedToPublish=[],e.pricebooktype=[],e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0},e.reportFields={pricebook_id:"ID",name:"Name",description:"Description",valid_from:"Valid From",valid_until:"Valid Until",date_approved:"Date Approved",approved_by:"Approved By",created_by:"Created By",date_created:"Date Created",notify_me:"Notify",pricebook_type_id:"Type ID","pricebook_type_info.name":"Type Name","pricebook_type_info.description":"Type Description","pricebook_type_info._id":"Type UUID",_id:"UUID"};var g=l.getCurrentUser(),h=JSON.parse(g);c.logTransaction("View Pricebooks","PRICEBOOKS","ALL","User:="+h.username+" View all list of pricebooks"),t.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)}),p.getAllTags().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){e.tagsArr.push({id:t.tags_id,label:t.tags,_id:t._id})})}else r.error(t.response.msg,"Error")});var b=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.name="-Type-",e.status="All",e.txtSearch="",e.type={},e.pricebooksTable=new s({page:1,count:10},{counts:[10,25,50,100],getData:function(s,i){t.getAllPricebook().then(function(t){if(200==t.statusCode&&t.response.success){var l=t.response.result;if(e.pricebookscopy=angular.copy(t.response.result),e.txtSearch&&"All"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("1"),e.pricebooks=o("filter")(l,e.txtSearch);else if(e.txtSearch&&"Published"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter)){console.log("2");var a=o("filter")(l,e.txtSearch);e.pricebooks=_.reject(a,{date_approved:null})}else if(e.txtSearch&&"Unpublished"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter)){console.log("3");var a=o("filter")(l,e.txtSearch);e.pricebooks=_.filter(a,{date_approved:null})}else if(e.txtSearch&&"All"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("4");var a=o("filter")(l,e.txtSearch);e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Published"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("5");var a=o("filter")(l,e.txtSearch),c=_.reject(a,{date_approved:null});e.pricebooks=_.filter(c,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Unpublished"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("6");var a=o("filter")(l,e.txtSearch),c=_.filter(a,{date_approved:null});e.pricebooks=_.filter(c,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"All"==e.status&&e.type&&e.tagsFilter){console.log("7");var a=o("filter")(l,e.txtSearch),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("8"),e.pricebooks=l;else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("9"),e.pricebooks=_.reject(l,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("10"),e.pricebooks=_.filter(l,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&e.type&&_.isEmpty(e.tagsFilter))console.log("11"),e.pricebooks=_.filter(l,{pricebook_type_id:e.type.pt_id});else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("12");var a=_.reject(l,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("13");var a=_.filter(l,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("14");var n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(l,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("15");var a=_.reject(l,{date_approved:null}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("16");var a=_.filter(l,{date_approved:null}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&e.type&&e.tagsFilter){console.log("17");var a=_.filter(l,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&e.type&&e.tagsFilter){console.log("18");var a=_.reject(l,{date_approved:null}),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&e.type&&e.tagsFilter){console.log("19");var a=_.filter(l,{date_approved:null}),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else console.log("else"),e.pricebooks=l;i.total(e.pricebooks.length);var d=e.pricebooks.slice((i.page()-1)*i.count(),i.page()*i.count());e.pricebookLoading=!1,s.resolve(d)}else r.error(t.response.msg,"Error"),e.pricebookLoading=!1})}})};b(),e.selectEvents={onItemSelect:function(t){e.pricebooksTable.reload()},onItemDeselect:function(t){e.pricebooksTable.reload()}},e.refresh=function(){b()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.pricebooks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?(_.find(e.selectedDatas,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedDatas.push(t),_.isNull(t.date_approved)&&(_.find(e.selectedToPublish,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedToPublish.push(t))):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pricebook_id!==t.pricebook_id}),e.selectedToPublish=_.filter(e.selectedToPublish,function(e){return e.pricebook_id!==t.pricebook_id})),e.deleteSomeData=e.selectedDatas.length>0,e.pusblishSomeData=e.selectedToPublish.length>0},e.updateStatus=function(t){console.log("updateStatus"),e.status=t,e.pricebooksTable.reload()},e.updateType=function(t){"-Type-"!==t?(e.type=t,e.name=t.name):(e.name="-Type-",e.type={}),e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()},e.copyDuplicatePricebook=function(s){e.modal={title:"Copy/Duplicate Pricebook?",message:"Are you sure to Copy/Duplicate Pricebook?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.pricebook_id&&t.duplicatePriceBook(s.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void d(function(){u.reload()},1e3)):void r.error(e.response.msg,"Error")})})},e.publishSelectedItem=function(s){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebook?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){t.approvedPriceBook(s.pricebook_id,{approved_by:h.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void d(function(){u.reload()},1e3)):void r.error(e.response.msg,"Error")})})},e.publishSelected=function(){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebooks?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("$scope.selectedDatas: ",e.selectedDatas);var s=1;async.eachSeries(e.selectedDatas,function(o,i){o.selected&&t.approvedPriceBook(o.pricebook_id,{approved_by:h.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s++,i(),void 0):void r.error(e.response.msg,"Error")}),s==e.selectedDatas.length&&d(function(){u.reload()},1e3)})})},e.deleteSelected=function(){e.modal={title:"Delete Pricebook?",message:"Are you sure to Delete this selected pricebooks?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=1;async.eachSeries(e.selectedDatas,function(o,i){o.selected&&t.deletePriceBook(o.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s++,i(),void 0):void r.error(e.response.msg,"Error")}),s==e.selectedDatas.length&&d(function(){u.reload()},1e3)})})},e.updateHistory=function(e){n.open({animation:!0,backdrop:"static",templateUrl:"./modules/pricebook/pricebook.auditlog.modal.html",controller:"pricebookAuditLogModalCtrl",size:"md",resolve:{pricebook_id:function(){return e}}})}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter","ngDialog","toastr","AuthFctry","localStorageService","transLogFctry","tagsFactory","$uibModal","$timeout","$state"]}();
...
!function(){"use strict";function e(e,t,o,a,l,n,s,c,i,r,p,d){console.log("companyController"),e.details=[],e.selectDeselectAll=!1,e.selectedDatas=[],e.reportFields={company_id:"ID",name:"Name",email_address:"Email Address",contact_number:"Contact Number",ABN:"ABN",address:"Address",city:"City",state:"State",zipcode:"Zip Code",country:"Country",bill_name:"Bill To",bill_address:"Billing Address",bill_city:"Billing City",bill_state:"Billing State",bill_zipcode:"Billing Zip Code",bill_country:"Billing Country",ship_name:"Ship To",ship_address:"Shipping Address",ship_city:"Shippping City",ship_state:"Shipping State",ship_zipcode:"Shipping Zip Code",ship_country:"Shipping Country",parent_id:"Parent ID",_id:"UUID"};var m=JSON.parse(p.get("user"));d.logTransaction("View Companies","COMPANIES","ALL","User:="+m.username+" View all list of companies");var u=function(){e.company={},e.companycopy=[],e.companyTable=new c({page:1,count:20},{counts:[20,35,50,100],getData:function(t,a){s.getAllCompany().then(function(l){if(200==l.statusCode&&l.response.success){console.log("data:",l.response.result);var s=l.response.result;if(e.companycopy=angular.copy(e.company),e.txtSearch){e.company=o("filter")(s,e.txtSearch),a.total(e.company.length);var c=e.company.slice((a.page()-1)*a.count(),a.page()*a.count());t.resolve(c)}else{e.company=s,a.total(e.company.length);var c=e.company.slice((a.page()-1)*a.count(),a.page()*a.count());t.resolve(c)}}else n.error(l.response.msg,"Error")})}})};e.searchData=function(){e.companyTable.reload()},e.refresh=function(){e.companyTable.reload(),e.txtSearch=""},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.company,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.company_id===t.company_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.company_id!==t.company_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){r.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(o,l){o.selected&&(console.log("company: ",o),s.deleteCompany(o.company_id).then(function(o){return console.log("data: ",o.response),200==o.statusCode&&o.response.success?(n.success(o.response.msg,"Success"),++t,t==e.selectedDatas.length&&a.reload(),l(),void 0):void n.error(o.response.msg,"Error")}))})})},e.importCompanies=function(e){"excel"==e?r.open({animation:!0,backdrop:"static",size:"lg",templateUrl:"modules/dialog/import.modal.html",controller:"ImportInstanceCtrl"}):"csv"==e&&r.open({animation:!0,backdrop:"static",size:"lg",templateUrl:"modules/dialog/importcsv.modal.html",controller:"ImportCSVInstanceCtrl",windowClass:"my-modal-popup"})},u()}angular.module("POS17").controller("companyController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","companyFactory","ngTableParams","ngDialog","$uibModal","localStorageService","transLogFctry"]}();
!function(){"use strict";function e(e,t,s,a,o,n,r,i,l,c){e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.selectedDatas=[],e.reportFields={person_id:"ID",firstname:"First Name",middlename:"Middle Name",lastname:"Last Name",email:"Email Address",displayName:"Display Name",mobile:"Mobile No.",timeZone:"Time Zone",image:"Image URL",image_etag:"Image Etag",image_key:"Image Key",image_mimetype:"Image MimeType",image_originalname:"Image Name",image_size:"Image Size",company_id:"Company ID",company_name:"Company Name",company_username:"Company Username",per_type_id:"Type ID",person_type:"Type",address:"Address",address2:"Address 2",city:"City",state:"State / Province",zipcode:"Zip Code",country:"Country",locale:"Locale",date_start:"Date Start",date_end:"Date End",store_id:"Store ID",isActive:"isActive",isActiveAcnt:"isActiveAcnt",isSubscriber:"isSubscriber",_id:"UUID"};var p=function(){e.personisLoading=!0,e.persons=[],e.personscopy=[],e.personsTable=new c({page:1,count:20},{counts:[20,35,50,100],getData:function(t,s){r.getAllPerson().then(function(o){if(200==o.statusCode&&o.response.success){var n=o.response.result;_.each(n,function(e){if(_.isNull(e.date_end))e.isActiveAcnt=!0;else{var t=new Date(e.date_start),s=new Date(e.date_end);t<=s?e.isActiveAcnt=!0:e.isActiveAcnt=!1}}),n=_.filter(n,function(e){if("Customer"==e.person_type&&0==e.isSubscriber)return e}),e.personscopy=angular.copy(n),e.txtSearch&&"All"==e.applicationStatus?e.persons=a("filter")(n,e.txtSearch):e.txtSearch&&"Employee"==e.applicationStatus?(e.persons=a("filter")(n,{per_type_id:1}),e.persons=a("filter")(e.persons,e.txtSearch)):e.txtSearch&&"Customer"==e.applicationStatus?(e.persons=a("filter")(n,{per_type_id:2}),e.persons=a("filter")(e.persons,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.persons=n:_.isUndefined(e.txtSearch)&&"Employee"==e.applicationStatus?e.persons=a("filter")(n,{per_type_id:1}):_.isUndefined(e.txtSearch)&&"Customer"==e.applicationStatus?e.persons=a("filter")(n,{per_type_id:2}):e.persons=n,s.total(e.persons.length);var r=e.persons.slice((s.page()-1)*s.count(),s.page()*s.count());t.resolve(r),e.personisLoading=!1}else e.personisLoading=!1,i.error(o.response.msg,"Error")})}})};p(),e.refresh=function(){e.personsTable.reload()},e.updateStatus=function(t){e.applicationStatus=t,e.personsTable.reload()},e.searchData=function(){e.personsTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.persons,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.person_id===t.person_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.person_id!==t.person_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(t){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.deletePersonel(t).then(function(e){return 200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),void o.reload()):void i.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,a){s.selected&&(console.log("person: ",s),r.deletePersonel(s.person_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(i.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&o.reload(),a(),void 0):void i.error(s.response.msg,"Error")}))})})},e.exportCustomerData=function(e){}}angular.module("POS17").controller("customerController",e),e.$inject=["$scope","$rootScope","$http","$filter","$state","ngDialog","humanFactory","toastr","$timeout","ngTableParams"]}();
!function(){"use strict";function e(e,s,n,o,t,r,a,c,i,l,u,p,d){e.details={},e.main=[],e.enable=!1,e.countries=[];var m=JSON.parse(p.get("user"));l.article_id?d.logTransaction("View Company Details","COMPANIES",l.company_id,"User:="+m.username+" View company details:="+l.company_id):d.logTransaction("Add New Company","COMPANIES","N/A","User:="+m.username+" Add new company entry"),async.waterfall([function(s){a.getAllCompany().then(function(n){200==n.statusCode&&n.response.success&&(e.main=n.response.result,e.main=_.filter(n.response.result,function(e){return e.company_id!=l.company_id}),s(null,n.response.result))})},function(s,n){u.getAllCountries().then(function(o){200==o.statusCode&&o.response.success&&(e.countries=o.response.result,n(null,s,o.response.result))})},function(s,n,o){l.company_id&&a.getCompanyInfo(l.company_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,o(null,s.response.result))})}]),e.enabledMainEvent=function(s){0==s&&(e.office=void 0,e.details.parent_id=0)},e.select=function(s){console.log("value:",s),e.details.parent_id=s.company_id},e.saveCompany=function(){console.log("$scope.details:",e.details),l.company_id?a.updateCompany(l.company_id,e.details).then(function(e){if(200==e.statusCode&&e.response.result)r.success(e.response.msg,"Success"),console.log("data:",e.response),o.go(o.current,{company_id:l.company_id},{reload:!0});else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void r.error(e.response.msg,"Error");_.each(e.response.result,function(e){r.warning(e.msg,"Warning")})}}):(console.log("$scope.details:",e.details),a.saveCompany(e.details).then(function(e){if(200==e.statusCode&&e.response.result)console.log("data:",e),r.success(e.response.msg,"Success"),o.go(o.current,{company_id:e.response.result},{reload:!0});else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void r.error(e.response.msg,"Error");_.each(e.response.result,function(e){r.warning(e.msg,"Warning")})}}))}}angular.module("POS17").controller("companyDetailController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","companyFactory","ngTableParams","ngDialog","$stateParams","countryFactory","localStorageService","transLogFctry"]}();

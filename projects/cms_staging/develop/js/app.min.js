...
!function(){"use strict";function e(e,o,s,n,t,a,r,i,c,u,l,d,g,p){function f(){var e=b.$getAuth();console.log("current:",e),_.isNull(e)&&(console.log("diri"),async.waterfall([function(e){b.$createUserWithEmailAndPassword(o.accountUser.email,h._id).then(function(s){console.log("User "+s.uid+" created successfully!");var n=firebase.database().ref().child("Users/"+s.uid),t=d(n);console.log("arr:",t);var a={uid:s.uid,_id:h._id,person_id:h.person_id,sub_id:h.sub_id,uc_id:h.uc_id,username:h.username,displayName:h.displayName,company_name:h.company_name,email_address:o.accountUser.email};console.log("newUser:",a),t.$add(a),e()})["catch"](function(e){console.error("Error: ",e),b.$signInWithEmailAndPassword(o.accountUser.email,h._id).then(function(e){console.log("Signed in as:",e.uid)})["catch"](function(e){console.error("Authentication failed:",e)})})},function(e){console.log("diri nsad"),b.$signInWithEmailAndPassword(o.accountUser.email,h._id).then(function(e){console.log("Signed in as:",e.uid)})["catch"](function(e){console.error("Authentication failed:",e)})}])),b.$onAuthStateChanged(m)}function m(e){console.log("authData:",e),console.log("authData:",h),e&&!_.isNull(e)?(console.log("authData.uid:",e.uid),o.ref=firebase.database().ref().child("messages/"+e.uid),o.obj=d(o.ref),console.log("$scope.ref:",o.ref)):console.log("not")}e.profile={},e.activeSub="",o.chatMessage="",o.accountUser={};var h=JSON.parse(i.get("user"));o.chatbox=!1,console.log("MainCtrl:",h);var b=g();o.showChat=function(){o.chatbox=!o.chatbox,console.log("$rootScope.chatbox:",e.chatbox)},r.getAllPersonDetail(h.person_id).then(function(e){200==e.statusCode&&e.response.success&&(o.accountUser=e.response.result,console.log("$scope.accountUser:",o.accountUser),f())}),o.create=function(){},o.sendMessage=function(){console.log("Send:",o.chatMessage),console.log("$scope.obj:",o.obj);var e={p_type:1,from_id:h.sub_id,value:o.chatMessage,date:(new Date).getTime(),user:{_id:h._id,person_id:h.person_id,sub_id:h.sub_id,uc_id:h.uc_id,username:h.username,displayName:h.displayName,company_name:h.company_name}};console.log("Send11:",e),o.obj.$add(e),o.chatMessage=" "},o.logoutApp=function(){console.log("diri:",b),b.$signOut(),a.logout().then(function(e){if(200==e.statusCode&&e.response.success){var o=JSON.parse(i.get("user"));l.logTransaction("User Logout","LOGOUT",o.username,"User Logout USERNAME:="+o.username).then(function(){a.setCurrentUser(null),a.setUserToken(null),u.logout()}),s.go("login")}})},o.getCurrentUser=function(){a.userprofile().then(function(o){if(200==o.statusCode&&o.response.success){e.profile=o.response.result;var s=JSON.parse(i.get("user"));e.activeSub=s.company_name}else if(400==o.statusCode&&!o.response.success)return void n.error(o.response.msg,"Error")})},o.openSubscription=function(){var e=t.open({animation:!0,templateUrl:"./modules/templates/header.subscription.html",controller:"ModalSubscriptionCtrl",size:"sm"}),o=JSON.parse(i.get("user"));l.logTransaction("Active Subscription","DASHBOARD","N/A","User:="+o.username+" Views Active Subscription"),e.result.then(function(e){var o=JSON.parse(i.get("user"));o.sub_id=e.sub_id,o.company_name=e.company_name,o.subscriptionKey=e.subscriptionKey,i.set("user",JSON.stringify(o)),c(function(){s.go("main.dashboard",null,{reload:!0})},1e3)})},o.getCurrentUser()}function o(e,o,s){e.switchSubscription=function(e){s(function(){o.close(e)},300)},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("MainCtrl",e).controller("ModalSubscriptionCtrl",o),e.$inject=["$rootScope","$scope","$state","toastr","$uibModal","AuthFctry","humanFactory","localStorageService","$timeout","$auth","transLogFctry","$firebaseArray","$firebaseAuth","$firebaseObject"],o.$inject=["$scope","$uibModalInstance","$timeout"]}();
...
!function(){"use strict";function e(e,s,t,r,o,a,i,n,c,d,l,u,p,g,h,m,f,v,y,T,b){e.loading1=!1,e.saveText="Save Entry",e.ptypes=[],e.attributes=[],e.tags=[],e.tagsArr=[],e.product_image=[],e.details={},e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.stockTrack=!1,e._stores={},e._stores.list=[],e._stores.selected=[],e._store={},e._store.selected={},e.inv={},e.inv.stockTrackQty=[],e.inv.stockTrackLevel=[],e.inv.unit={},e.inv.unit.selected={},e.inv.unit.list=[],e.inv_stockTrackDets=[],e.isEnabledstockTrack=!1,e.selectedUnit="",e.isImageNew=!1,e.tabprod={product:!0,media:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!0,related:!0},e.barcodeoptions={width:2,height:100,quite:10,displayValue:!0,font:"monospace",textAlign:"center",fontSize:12,backgroundColor:"",lineColor:"#000"},e.barcodesType=[{type:"ean",code:"EAN"},{type:"upc",code:"UPC"},{type:"code39",code:"Code39"},{type:"code128b",code:"Code128B"},{type:"code128c",code:"Code128c"},{type:"itf",code:"ITF"},{type:"itf14",code:"ITF14"}],e.mycode={},e.mycode.type="code128b",e.producttagsSettings={showCheckAll:!0,showUncheckAll:!0,enableSearch:!0,scrollable:!0};var P=JSON.parse(T.get("user"));o.p_id?b.logTransaction("View Product Details","PRODUCTS",o.p_id,"User:="+P.username+" View products details: ="+o.p_id):b.logTransaction("Add New Product","PRODUCTS","N/A","User:="+P.username+" Add new product entry"),l.getAllTags().then(function(s){s&&200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:r.error(s.response.msg,"Error")}),c.getAllStore().then(function(s){s&&200==s.statusCode&&s.response.success&&s&&s.response&&s.response.result&&_.each(s.response.result,function(s){e._stores.list.push({id:s.store_id,label:s.name,_id:s._id,address:s.address,isChecked:!1})})}),e.changeBarcodeType=function(s){y(function(){e.$apply(function(){e.mycode.type=s})},10)},_.isEmpty(o.p_id)?(e.showPublish=!1,e.showArchive=!1,e.tabprod={product:!0,media:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},i.getAllProdType().then(function(s){s&&200==s.statusCode&&s.response.success&&(e.ptypes=s.response.result)})):async.waterfall([function(s){i.getAllProdType().then(function(t){t&&200==t.statusCode&&t.response.success?(e.ptypes=t.response.result,s()):r.error(t&&t.response&&t.response.msg?t.response.msg:"Error","Error")})},function(s){a.getProductDetails(o.p_id).then(function(s){if(s&&200==s.statusCode&&s.response.success){e.details=s.response.result;var t=e.details.purchase_price;e.details.retail_price=e.details.purchase_price*e.details.markup/100+t,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.tabprod={product:!0,media:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!0,related:!0},e.product_image=e.details.product_images,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),l.getAllProductTags(o.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)})}})}]),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.removethumb=function(){e.details.img_default=null},e.upload=function(s){e.isImageNew=!0},e.archiveProduct=function(e){a.archiveProduct(e).then(function(e){e&&200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.publishProduct=function(e){a.publishProduct(e).then(function(e){e&&200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.deleteProductTags=function(e){o.p_id&&l.deleteProductTag(o.p_id,e.tags_id).then(function(e){return e&&200==e.statusCode&&e.response.success?void r.success(e.response.msg,"Success"):void r.error(e.response.msg,"Error")})},e.openUploader=function(){var e=h.open({animation:!0,templateUrl:"./modules/products/details/product.upload.modal.html",controller:"productUploaderModalCtrl",size:"lg",resolve:{product_id:function(){return o.p_id}}});e.result.then(function(e){s.reload()})},e.openLightboxModal=function(e){var s=[];s.push({url:e.image_path,thumbUrl:e.image_path}),m.openModal(s,0)},e.copyURLLink=function(e){return f.supported?(console.log("files.media_path: ",e.image_path),void f.copyText(e.image_path)):void r.warning("Sorry, copy to clipboard is not supported","Warning")},e.setAsThumbNail=function(t){console.log("files: ",t),e.modal={title:"Set as product thumbnail",message:"Are you sure to set this image?"},v.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){a.setProductImage(o.p_id,t._id).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.reload()):r.warning(e.response.msg,"Warning")})})},e.deleteAllMedia=function(){v.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.p_id&&a.deleteAllProductImage(o.p_id).then(function(e){return e&&200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s.reload()):void r.error(e.response.msg,"Error")})})},e.deleteSelected=function(t){v.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.p_id&&a.deleteProductImageFile(o.p_id,t._id).then(function(e){return e&&200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s.reload()):void r.error(e.response.msg,"Error")})})},e.pushToStockTrack=function(s,t,r,a,i){var n={store_id:t,stock_qty:r||0,stock_level:a||0,p_id:o.p_id,stock_unit:i};e.inv_stockTrackDets[s]=n},e.addProduct=function(){var t=e.inv.unit.selected._id;e.loading1=!0,e.saveText="Saving..",e.validate=[],e.details.item_description="",e.details.selectedUnit=e.selectedUnit,e.details.sales_unit_id=t,e.details.purchase_unit_id=null,e.details.qty_convert=null,e.details.inv_id=e.inv.inv_id,async.waterfall([function(s){o.p_id?a.updateProduct(o.p_id,e.details).then(function(t){t&&200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),e.loading1=!1,e.saveText="Save Entry",s(null,o.p_id)):(e.validate=t.response.result,_.each(e.validate,function(e){r.warning(t.response.msg,"Error - "+e.msg)}),e.loading1=!1,e.saveText="Save Entry")}):a.saveProduct(e.details).then(function(t){t&&200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),s(null,t.response.result.productid),e.loading1=!1,e.saveText="Save Entry"):(e.validate=t.response.result,_.each(e.validate,function(e){r.warning(t.response.msg,"Error - "+e.msg)}),e.loading1=!1,e.saveText="Save Entry")})},function(s,t){var o=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(a,i){a.isTag?l.saveTags(a).then(function(e){return e&&200==e.statusCode&&e.response.success?void l.saveProductTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void i()):void r.error(e.response.msg,"Error")}):void r.error(e.response.msg,"Error")}):l.saveProductTags(s,{tags_id:a.tags_id}).then(function(e){return e&&200==e.statusCode&&e.response.success?(o++,void i()):void r.error(e.response.msg,"Error")}),o>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,t){s.go(s.current,{p_id:e},{reload:!0})}])},e.calculateRetailPrice=function(s,t,r){if(isNaN(s))e.details.purchase_price="",e.details.markup="",e.details.retail_price="";else if(s&&t){var o=e.details.purchase_price;e.details.retail_price=e.details.purchase_price*e.details.markup/100+o}else e.details.retail_price=0},e.changeOf_PP=function(s,t,r){if(isNaN(e.details.purchase_price))e.details.purchase_price="",e.details.markup="";else{var o=e.details.purchase_price;e.details.retail_price=e.details.purchase_price*e.details.markup/100+o}},e.changeOf_MU=function(s,t,r){var o=e.details.purchase_price;e.details.retail_price=e.details.purchase_price*e.details.markup/100+o},e.changeOf_RP=function(s,t,r){e.details.markup=(e.details.retail_price-e.details.purchase_price)/e.details.purchase_price*100}}angular.module("POS17").controller("productsAEController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","tagsFactory","API_URL","API_VERSION","Upload","$uibModal","Lightbox","clipboard","ngDialog","$timeout","localStorageService","transLogFctry"]}();

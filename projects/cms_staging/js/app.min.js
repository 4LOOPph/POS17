...
!function(){"use strict";angular.module("POS17").factory("jQuery",["$window",function(e){return e.jQuery}]).factory("_",["$window",function(e){return e.jQuery}]).factory("PDFJS",["$window",function(e){return e.PDFJS}]).factory("async",["$window",function(e){return e.async}]).constant("ONESIGNAL",{appID:"b4a5359b-0427-4e97-a1e8-db8af8ebfb3b",domain:"https://4loopph.onesignal.com"}).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location","ONESIGNAL","ngDialog",function(e,n,t,o,r,a,u,i,c,s){n.currentUser={},n.$state=e,n.previousState,n.currentState,n.changesOccur=0,r.user_timezone=moment.tz.guess(),r.user_timezone2=moment().format("Z"),n.$on("loading:progress",function(){n.productIsLoading=!0}),n.$on("loading:finish",function(){n.productIsLoading=!1}),n.$on("unauthorized",function(){o.setCurrentUser(null),o.setUserToken(null),e.go("login")}),n.goBack=function(){r.history.back()},n.$on("$stateChangeStart",function(t,r,c,g,l){if(o.getCurrentUser()){var d=o.getUserToken();a.isTokenExpired(d)&&(u.remove("user"),u.remove("token"),i.path("/login"))}n.changesOccur>2&&(t.preventDefault(),n.modal={title:"Changes Detected?",message:"Are you sure to proceed without saving or updating?"},s.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:n,className:"ngdialog-theme-default"}).then(function(){n.changesOccur=0,e.go(r.name)},function(){console.log("NO")}))}),n.$on("$stateChangeSuccess",function(e,t,r,a,u){n.previousState=a.name,n.currentState=t.name,n.currentUser=o.getCurrentUser()});var g=r.OneSignal||[];g.push(["init",{appId:c.appID,autoRegister:!1,subdomainName:c.domain,notifyButton:{enable:!0}}])}])}();

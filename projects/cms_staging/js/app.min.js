...
!function(){"use strict";angular.module("POS17").factory("jQuery",["$window",function(n){return n.jQuery}]).factory("_",["$window",function(n){return n.jQuery}]).factory("PDFJS",["$window",function(n){return n.PDFJS}]).factory("async",["$window",function(n){return n.async}]).constant("ONESIGNAL",{appID:"b4a5359b-0427-4e97-a1e8-db8af8ebfb3b",domain:"https://4loopph.onesignal.com"}).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location","ONESIGNAL",function(n,e,t,o,r,a,i,u,s){e.currentUser={},e.$state=n,e.previousState,e.currentState,r.user_timezone=moment.tz.guess(),r.user_timezone2=moment().format("Z"),e.$on("loading:progress",function(){e.productIsLoading=!0}),e.$on("loading:finish",function(){e.productIsLoading=!1}),e.$on("unauthorized",function(){o.setCurrentUser(null),o.setUserToken(null),n.go("login")}),e.goBack=function(){r.history.back()},e.$on("$stateChangeStart",function(n,e,t,r,s){if(o.getCurrentUser()){var c=o.getUserToken();a.isTokenExpired(c)&&(i.remove("user"),i.remove("token"),u.path("/login"))}}),e.$on("$stateChangeSuccess",function(n,t,r,a,i){e.previousState=a.name,e.currentState=t.name,e.currentUser=o.getCurrentUser()});var c=window.OneSignal||[];c.push(["init",{appId:s.appID,autoRegister:!1,subdomainName:s.domain,notifyButton:{enable:!0}}])}])}();
...
!function(){"use strict";function e(e,s,r,t,n,o,u){e.user={},e.login=function(){t.authenticate(e.user).then(function(e){e.success?(t.setUserToken(e.result.token),t.setCurrentUser(JSON.stringify(e.result.user)),u.logTransaction("User Logged In","LOGIN",e.result.user.username,"User Login for USERNAME:="+e.result.user.username),r.info("Welcome back "+e.result.user.displayName),s.go("main.dashboard")):400===e.statusCode&&!e.response.success&&_.isArray(e.response.result)?_.each(e.response.result,function(e){r.warning(e.msg,"Warning")}):r.error(e.msg,"Error")})},e.authenticate=function(e){n.authenticate(e).then(function(n){if(n){var a=n.data;console.log("resp: ",a),a.success?(t.setUserToken(a.result.token),t.setCurrentUser(JSON.stringify(a.result.user)),u.logTransaction("Social Media Logged In","LOGIN",a.result.user.username,"User Login for USERNAME:="+a.result.user.username+" TYPE:="+e),r.success("Login successfully with "+e.toUpperCase()+"!"),o(function(){s.go("main.dashboard")},100)):400===a.statusCode&&!a.response.success&&_.isArray(a.response.result)?_.each(a.response.result,function(e){r.warning(e.msg,"Warning")}):r.error(a.msg,"Error")}})["catch"](function(e){e.message?r.error(e.message):e.data?r.error(e.data.message,e.status):r.error(e)})}}angular.module("POS17").config(["$stateProvider",function(e){var s=["$q","$auth",function(e,s){var r=e.defer();return s.isAuthenticated()?r.reject():r.resolve(),r.promise}];e.state("login",{url:"/login",templateUrl:"modules/login/login.html",controller:"LoginCtrl",resolve:{skipIfLoggedIn:s}})}]).controller("LoginCtrl",e),e.$inject=["$scope","$state","toastr","AuthFctry","$auth","$timeout","transLogFctry"]}();
...
!function(){"use strict";function e(e,t,s,i,o,r,u,n,a,l,c,d){e.attributes=[],e.attribute_values=[],e.$watch(function(){return e.details},function(t){e.getAllProductAttributes()}),e.getAllProductAttributes=function(){e.details.doc=d.get("visibility"),async.waterfall([function(t){l.getAttributeMapping(e.details.product_type_id).then(function(e){if(200==e.statusCode&&e.response.success){var s=e.response.result;console.log("attributes: ",s),t(null,s)}else i.error(e.response.msg,"Error")})},function(e,t){n.getProductBundleAttributes(r.pb_id).then(function(s){if(200==s.statusCode&&s.response.success){var o=s.response.result;console.log("attribute_values: ",o),t(null,e,o)}else i.error(s.response.msg,"Error")})},function(e,t,s){c.getAllCategory().then(function(o){if(200==o.statusCode&&o.response.success){var r=o.response.result;console.log("categories: ",r),s(null,e,t,r)}else i.error(o.response.msg,"Error")})},function(e,t,s,o){n.getProductBundleCategory(r.pb_id).then(function(r){if(200==r.statusCode&&r.response.success){var u=r.response.result;console.log("prodCategories: ",u);var n=[];_.each(s,function(e){var t=_.find(u,function(t){return e.c_id===t.fk_category_id});t&&n.push(e)}),o(null,e,t,n)}else i.error(r.response.msg,"Error")})},function(t,s,i,o){var r=[];if(_.each(t,function(e){var t=_.filter(i,{c_id:e.fk_c_id});t&&t.length>0&&r.push(e)}),r&&r.length>0){var u=_.map(r,function(e){return e.attributes});_.each(u,function(e){var t=_.find(s.attribute_values,{att_id:e.att_id});console.log("result: ",t);var i=_.find(s.attribute_value_list,{att_id:e.att_id});t?(e.unique_id=t._id,e.value=t.value):(e.value=null,e.unique_id=null),i?e.attribute_list_value=i.attribute_list:e.attribute_list_value=[]}),e.attributes=u}else{var u=_.map(t,function(e){return e.attributes});_.each(u,function(e){var t=_.find(s.attribute_values,{att_id:e.att_id}),i=_.find(s.attribute_value_list,{att_id:e.att_id});t?(e.unique_id=t._id,e.value=t.value):(e.value=null,e.unique_id=null),i?e.attribute_list_value=i.attribute_list:e.attribute_list_value=[]}),e.attributes=u}console.log("$scope.attributes:",e.attributes),_.each(e.attributes,function(e){"Checkbox"==e.attribute_type&&(console.log("row:",e),"1"==e.value?e.checked=!0:e.checked=!1)})}])},e.deleteAttributeValue=function(s){console.log("attribute: ",s),_.isUndefined(s.value)?i.warning("Unable to save no attribute value","Warning"):u.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("Delete"),a.deleteAttributeValues(s.att_id,s.unique_id).then(function(e){200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),t.reload()):i.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.saveShow=function(){if(e.details.doc){var s={product_id:r.p_id,is_show:1};d.set("visibility",!0),a.updateAttributeVisibility(s).then(function(e){200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),t.reload()):i.error(e.response.msg,"Error")})}else{var o={product_id:r.p_id,is_show:0};d.set("visibility",!1),a.updateAttributeVisibility(o).then(function(e){200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),t.reload()):i.error(e.response.msg,"Error")})}},e.saveAttributeValue=function(s){if(console.log("attribute: ",s),e.modal={title:"Confirm attribute",message:"Are you sure to save attribute?"},"Checkbox"==s.attribute_type){console.log("diri:",s.checked);var o={product_id:null,bundle_id:r.pb_id,attribute_id:s.att_id,article_id:null,value:s.checked,value_image:null,name:s.name,description:"",is_single:0,is_image:0,is_video:0,is_audio:0}}else{console.log("diri:");var o={product_id:null,bundle_id:r.pb_id,attribute_id:s.att_id,article_id:null,value:s.value,value_image:null,name:s.name,description:"",is_single:0,is_image:0,is_video:0,is_audio:0}}_.isUndefined(s.value)?i.warning("Unable to save no attribute value","Warning"):u.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){_.isNull(s.unique_id)?(console.log("Save New"),console.log("value1s",o),a.saveAttributeValues(s.att_id,o).then(function(e){200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),t.reload()):i.error(e.response.msg,"Error")})):(console.log("Updated"),console.log("values",o),a.updateAttributeValues(s.att_id,s.unique_id,o).then(function(e){200==e.statusCode&&e.response.success?(i.success(e.response.msg,"Success"),t.reload()):i.error(e.response.msg,"Error")}))},function(e){console.log("Modal promise close: ")})}}angular.module("POS17").controller("productBundleAttributesCtrl",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","ngDialog","productFactory","attributeFactory","ptypeFactory","categoryFactory","localStorageService"]}();
...
!function(){"use strict";function e(e,s,r,o,n){var t=JSON.parse(o.get("user"));n.logTransaction("View User Profile","USER PROFILE",t.username,"User:="+t.username+" View user profile information")}function s(e,s,r,o,n,t,a,i,l,u,c,p,d,f){var m=r.getCurrentUser(),g=JSON.parse(m);e.inputType="password",e.pw1="password",e.user=g,e.details={},e.social={},e.showFacebook=!0,e.showGoogle=!0,e.showTwitter=!0,e.showLinkedin=!0,e.showUpload=!1,e.timezone=[],e.newImage=!1,f.logTransaction("View User Profile","USER PROFILE",g.username,"User:="+g.username+" View user profile for modification"),g.person_id&&async.waterfall([function(s){t.getAllPersonDetail(g.person_id).then(function(r){200==r.statusCode&r.response.success&&(e.details=r.response.result,s())})},function(s){t.getUserSocial().then(function(r){200==r.statusCode&r.response.success&&(e.social=r.response.result,e.showFacebook=!_.isEmpty(e.social.facebook_uuid),e.showGoogle=!_.isEmpty(e.social.google_uuid),e.showTwitter=!_.isEmpty(e.social.twitter_uuid),e.showLinkedin=!_.isEmpty(e.social.linkedin_uuid),s())})},function(s){t.getUserPIN().then(function(r){200==r.statusCode&r.response.success&&(e.details.pos_pin=r.response.result.pos_pin,s())})}]),t.getTimeZone().then(function(s){200==s.statusCode&&s.response.success&&(e.timezone=s.response.result)}),e.hideShowPassword=function(){"password"==e.inputType?e.inputType="text":e.inputType="password"},e.upload=function(s){console.log("file",s),e.newImage=!0,e.showUpload=!0},e.removethumb=function(){e.showUpload=!1,e.details.image=null,e.newImage=!1},e.savePersonDetail=function(){async.waterfall([function(s){f.logTransaction("Update User Profile","USER PROFILE",JSON.stringify(e.details),"User:="+g.username+" Update user profile"),g.person_id?t.updatePersonel(g.person_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)a.success(e.response.msg,"Success"),s(null,g.person_id),o.reload();else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void a.error(e.response.msg,"Error");_.each(e.response.result,function(e){a.warning(e.msg,"Warning")})}}):t.savePersonel(e.details).then(function(e){if(200==e.statusCode&&e.response.success)a.success(e.response.msg,"Success"),s(null,e.response.result),o.reload();else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void a.error(e.response.msg,"Error");_.each(e.response.result,function(e){a.warning(e.msg,"Warning")})}})},function(s,r){console.log("user:",s),e.newImage&&e.details.image&&(f.logTransaction("Update User Profile: Image Upload","USER PROFILE",e.details.image,"User:="+g.username+" Update user profile - Upload Image"),i.upload({url:l+u+"persons/"+s+"/upload-image",data:{person_img:e.details.image},method:"PUT"}).then(function(e){if(200===e.data.statusCode&&e.data.response.success)a.success("Image successfully uploaded","Success"),o.reload();else{if(400!==e.data.statusCode||e.data.response.success||!_.isArray(e.data.response.result))return void a.error(e.data.response.msg,"Error");_.each(e.data.response.result,function(e){a.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)}))}])},e.saveUsername=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){f.logTransaction("Update User Profile: USERNAME","USER PROFILE",JSON.stringify(s.profile),"User:="+g.username+" Update user profile - USERNAME"),t.updateUsername(s.profile).then(function(e){if(200==e.statusCode&&e.response.success)a.success("Successfully Update","Success"),n(function(){o.reload()},1e3);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void a.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){a.warning(e.msg,"Warning")})}})})},e.savePassword=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){f.logTransaction("Update User Profile: USER PASSWORD","USER PROFILE",JSON.stringify(e.details),"User:="+g.username+" Update user profile - USER PASSWORD"),t.updatePassword(e.details).then(function(e){if(200==e.statusCode&&e.response.success)a.success("Successfully Update Password","Success"),n(function(){o.reload()},1e3);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void a.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){a.warning(e.msg,"Warning")})}})})},e.addRecoveryEmail=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){f.logTransaction("Update User Profile: EMAIL RECOVERY","USER PROFILE",e.details.recovery_email,"User:="+g.username+" Update user profile - EMAIL RECOVERY"),t.addRecoveryPassword({email_recovery:e.details.recovery_email}).then(function(e){if(200==e.statusCode&&e.response.success)a.success("Successfully Update","Success"),n(function(){o.reload()},1e3);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void a.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){a.warning(e.msg,"Warning")})}})})},e.addPOSPIN=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){f.logTransaction("Update User Profile: PERSONAL IDENTIFICATION NUMBER","USER PROFILE",e.details.pos_pin,"User:="+g.username+" Update user profile - PERSONAL IDENTIFICATION NUMBER"),t.addUserPIN({pin:e.details.pos_pin}).then(function(e){if(200==e.statusCode&&e.response.success)a.success(e.response.msg,"Success"),n(function(){o.reload()},1e3);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void a.error(e.response.msg,"Error");_.each(e.response.result,function(e){a.warning(e.msg,"Warning")})}})})},e.unlinkAccount=function(e){f.logTransaction("Update User Profile: SOCIAL MEDIA="+e,"USER PROFILE",e,"User:="+g.username+" Update user profile - SOCIAL MEDIA="+e),p.unlink(e,{method:"POST",url:l+"/auth/unlink"}).then(function(s){a.success("You have successfully unlinked "+e+" to your profile!"),n(function(){o.reload()},400)})["catch"](function(e){error.message?a.error(error.message):error.data?a.error(error.data.message,error.status):a.error(error)})},e.viewProfile=function(e,s){if(f.logTransaction("View Social Media Profile:="+e,"USER PROFILE",e,"User:="+g.username+" View social media profile:="+e),"facebook"==e){var r=d.open("https://www.facebook.com/app_scoped_user_id/"+s+"/","_blank");r.focus()}else if("google"==e){var r=d.open("https://plus.google.com/"+s,"_blank");r.focus()}else if("linkedin"==e){var r=d.open("http://www.linkedin.com/profile/view?id="+s,"_blank");r.focus()}else if("twitter"==e){var r=d.open("https://twitter.com/intent/user?user_id="+s,"_blank");r.focus()}},e.authenticate=function(e){f.logTransaction("Link Social Media Profile:="+e,"USER PROFILE",e,"User:="+g.username+" Link social media profile:="+e),p.link(e).then(function(s){a.success("You have successfully linked your profile with "+e+"!"),n(function(){o.reload()},400)})["catch"](function(e){e.message?a.error(e.message):e.data?a.error(e.data.message,e.status):a.error(e)})}}angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(e,s){s.state("main.settings-profile",{url:"/settings/profile",templateUrl:"modules/profile/profile.html",controller:"ProfileCtrl"}).state("main.settings-profile-details",{url:"/settings/profile/details/",templateUrl:"modules/profile/profile.details.html",controller:"ProfileDetailCtrl"})}]).controller("ProfileCtrl",e).controller("ProfileDetailCtrl",s),e.$inject=["$scope","$state","AuthFctry","localStorageService","transLogFctry"],s.$inject=["$scope","$rootScope","AuthFctry","$state","$timeout","humanFactory","toastr","Upload","API_URL","API_VERSION","ngDialog","$auth","$window","transLogFctry"]}();
...
!function(){"use strict";function e(e,r,s,t,a){e.puchaseorders=[];var o=JSON.parse(t.get("user"));a.logTransaction("View Purchase Orders","PURCHASE ORDER","ALL","User:="+o.username+" View all list of Inventory - Purchase Order");var c=function(){e.puchaseordersisLoading=!0,e.puchaseorders=[],e.puchaseordersTable=new s({page:1,count:10},{counts:[10,25,50,100],getData:function(s,t){r.getAllPurchaseOrder().then(function(r){if(200==r.statusCode&&r.response.success){var a=r.response.result;console.log("puchaseorders:",a),e.txtSearch&&"All"==e.applicationStatus?e.puchaseorders=$filter("filter")(a,e.txtSearch):e.txtSearch&&"Published"==e.applicationStatus?(e.puchaseorders=$filter("filter")(a,{status:1}),e.puchaseorders=$filter("filter")(e.puchaseorders,e.txtSearch)):e.txtSearch&&"Unpublished"==e.applicationStatus?(e.puchaseorders=$filter("filter")(a,{status:0}),e.puchaseorders=$filter("filter")(e.puchaseorders,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.puchaseorders=a:_.isUndefined(e.txtSearch)&&"Published"==e.applicationStatus?e.puchaseorders=$filter("filter")(a,{status:1}):_.isUndefined(e.txtSearch)&&"Unpublished"==e.applicationStatus?e.puchaseorders=$filter("filter")(a,{status:0}):e.puchaseorders=a,t.total(e.puchaseorders.length);var o=e.puchaseorders.slice((t.page()-1)*t.count(),t.page()*t.count());s.resolve(o),e.puchaseordersisLoading=!1}else toastr.error(r.response.msg,"Error")})}})};c()}angular.module("POS17").controller("purchaseOrderController",e),e.$inject=["$scope","purchaseOrderFactory","ngTableParams","localStorageService","transLogFctry"]}();
...
!function(){"use strict";function e(e,t,o,s,l,c,r,i,a){e.name="Type",e.status="All",e.txtSearch="",e.type={},e.selectDeselectAll=!1,e.selectedDatas=[],e.selectedToPublish=[],e.pricebooktype=[],e.example8model=[],e.example8data=[{id:1,label:"Telstra"},{id:2,label:"Proximity"},{id:3,label:"Christmas"},{id:4,label:"Women"}];var p=r.getCurrentUser(),n=JSON.parse(p);a.logTransaction("View Pricebooks","PRICEBOOKS","ALL","User:="+n.username+" View all list of pricebooks"),t.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)});var u=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.name="Type",e.status="All",e.txtSearch="",e.type={},e.pricebooksTable=new o({page:1,count:10},{counts:[10,25,50,100],getData:function(o,l){t.getAllPricebook().then(function(t){if(200==t.statusCode&&t.response.success){var r=t.response.result;if(e.pricebookscopy=angular.copy(t.response.result),console.log("$scope.txtSearch: ",e.txtSearch),console.log("$scope.type: ",e.type),console.log("$scope.txtSearch: ",_.isEmpty(e.txtSearch)),console.log("$scope.type: ",_.isEmpty(e.type)),_.isEmpty(e.txtSearch)&&"Published"==e.status&&_.isEmpty(e.type))console.log("Published: "),e.pricebooks=_.reject(r,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&_.isEmpty(e.type))console.log("Unpublished: "),e.pricebooks=_.filter(r,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&_.isEmpty(e.type))console.log("All: "),e.pricebooks=r;else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&e.type)console.log("1"),e.pricebooks=_.filter(r,{pricebook_type_id:e.type.pt_id});else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&e.type){console.log("2");var i=_.reject(r,{date_approved:null});e.pricebooks=_.filter(i,{pricebook_type_id:e.type.pt_id})}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&e.type){console.log("3");var i=_.filter(r,{date_approved:null});e.pricebooks=_.filter(i,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"All"==e.status&&_.isEmpty(e.type))console.log("4"),e.pricebooks=s("filter")(r,e.txtSearch);else if(e.txtSearch&&"Published"==e.status&&_.isEmpty(e.type)){console.log("5");var i=s("filter")(r,e.txtSearch);e.pricebooks=_.reject(i,{date_approved:null})}else if(e.txtSearch&&"Unpublished"==e.status&&_.isEmpty(e.type)){console.log("6");var i=s("filter")(r,e.txtSearch);e.pricebooks=_.filter(i,{date_approved:null})}else if(e.txtSearch&&"All"==e.status&&e.type){console.log("7");var i=s("filter")(r,e.txtSearch);e.pricebooks=_.filter(i,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Published"==e.status&&e.type){console.log("8");var i=s("filter")(r,e.txtSearch),a=_.reject(i,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Unpublished"==e.status&&e.type){console.log("9");var i=s("filter")(r,e.txtSearch),a=_.filter(i,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else console.log("else"),e.pricebooks=r;l.total(e.pricebooks.length);var p=e.pricebooks.slice((l.page()-1)*l.count(),l.page()*l.count());e.pricebookLoading=!1,o.resolve(p)}else c.error(t.response.msg,"Error"),e.pricebookLoading=!1})}})};u(),e.refresh=function(){u()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.pricebooks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?(_.find(e.selectedDatas,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedDatas.push(t),_.isNull(t.date_approved)&&(_.find(e.selectedToPublish,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedToPublish.push(t))):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pricebook_id!==t.pricebook_id}),e.selectedToPublish=_.filter(e.selectedToPublish,function(e){return e.pricebook_id!==t.pricebook_id})),e.deleteSomeData=e.selectedDatas.length>0,e.pusblishSomeData=e.selectedToPublish.length>0},e.updateStatus=function(t){console.log("updateStatus"),e.status=t,e.pricebooksTable.reload()},e.updateType=function(t){e.type=t,e.name=t.name,e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()},e.copyDuplicatePricebook=function(o){e.modal={title:"Copy/Duplicate Pricebook?",message:"Are you sure to Copy/Duplicate Pricebook?"},l.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.pricebook_id&&t.duplicatePriceBook(o.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void $timeout(function(){$state.reload()},1e3)):void c.error(e.response.msg,"Error")})})},e.publishSelectedItem=function(o){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebook?"},l.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){t.approvedPriceBook(o.pricebook_id,{approved_by:n.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void $timeout(function(){$state.reload()},1e3)):void c.error(e.response.msg,"Error")})})},e.publishSelected=function(){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebooks?"},l.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("$scope.selectedDatas: ",e.selectedDatas);var o=1;async.eachSeries(e.selectedDatas,function(s,l){s.selected&&t.approvedPriceBook(s.pricebook_id,{approved_by:n.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),o++,l(),void 0):void c.error(e.response.msg,"Error")}),o==e.selectedDatas.length&&$timeout(function(){$state.reload()},1e3)})})},e.deleteSelected=function(){e.modal={title:"Delete Pricebook?",message:"Are you sure to Delete this selected pricebooks?"},l.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var o=1;async.eachSeries(e.selectedDatas,function(s,l){s.selected&&t.deletePriceBook(s.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),o++,l(),void 0):void c.error(e.response.msg,"Error")}),o==e.selectedDatas.length&&$timeout(function(){$state.reload()},1e3)})})}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter","ngDialog","toastr","AuthFctry","localStorageService","transLogFctry"]}();
!function(){"use strict";function e(e,t,s,o,r,c,a,i,n,l,d,g,u){console.log("pricebookDetailController");var p=o.getCurrentUser(),k=JSON.parse(p);e.tagselected=[],e.tags=[],e.tagsArr=[],e.tagschecked=[],e.details={},e.details.isActive=1,e.details.created_by=k.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.item={},e.selectDeselectAll2=!1,e.selectedDatas2=[];var p=JSON.parse(g.get("user"));a.pricebook_id?u.logTransaction("View Pricebook Details","PRICEBOOKS",a.pricebook_id,"User:="+p.username+" View pricebook details: ="+a.pricebook_id):u.logTransaction("Add New Pricebook","PRICEBOOKS","N/A","User:="+p.username+" Add new pricebook entry"),s.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)}),l.getAllTags().then(function(t){200==t.statusCode&&t.response.success?e.tagsArr=t.response.result:r.error(t.response.msg,"Error")}),a.pricebook_id&&(e.displayTab=!0,s.getPricebookDetail(a.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result)})),e.toggleSelectedTag=function(t){e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=_.filter(e.tagselected,function(e){return e.tags_id!=t.tags_id}),console.log("$scope.tagselected:",e.tagselected)},e.isOnSelectedTag=function(){return function(t){if(!(e.tagselected.length>0))return!0;var s=!1,o=_.map(e.tagselected,"tags_id");_.forEach(t.tags,function(e){o.indexOf(e.tags_id)!==-1&&(s=!0)});return console.log("tagselectedIDs:",o),s}},e.changeSelectDeselectAll2=function(){e.selectDeselectAll2=!e.selectDeselectAll2,_.each(e.tagsArr,function(t){t.checked=e.selectDeselectAll2,e.checkDataChanges2(t)})},e.checkDataChanges2=function(t){t.checked?_.find(e.tagselected,function(e){return e.tags_id===t.tags_id})||e.tagselected.push(t):e.tagselected=_.filter(e.selectedDatas,function(e){return e.tags_id!==t.tags_id})},e.savePricebook=function(){a.pricebook_id?s.updatePriceBook(a.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void c.go(c.current,{pricebook_id:a.pricebook_id},{reload:!0})):void r.error(e.response.msg,"Error")}):s.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("data:",e),r.success(e.response.msg,"Success"),c.go(c.current,{pricebook_id:e.response.result},{reload:!0}),void 0):void r.error(e.response.msg,"Error")})}}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams","$filter","ngDialog","tagsFactory","$uibModal","localStorageService","transLogFctry"]}();
...
!function(){"use strict";function s(s,e,o,c,n,t,i){s.group={};var u=JSON.parse(i.get("user"));_.isNull(n)?transLogFctry.logTransaction("Add New Pricebook Association Type","PRICEBOOK ASSOCIATION","N/A","User:="+u.username+" Add new Pricebook Association Type entry"):transLogFctry.logTransaction("View Pricebook Association Type Details","PRICEBOOK ASSOCIATION",n,"User:="+u.username+" View Pricebook Association Type details:="+n),_.isNull(n)||t.getPriceBookAssociation(n).then(function(e){200==e.statusCode&&e.response.success&&(s.group=e.response.result)}),s.savePriceBookAssocType=function(){_.isNull(n)?t.savePriceBookAssociation(s.group).then(function(n){200==n.statusCode&&n.response.success&&(c.success("Successfully Added","Success"),o(function(){s.$apply(function(){e.close("save")})},100))}):t.updatePriceBookAssociation(n,s.group).then(function(n){200==n.statusCode&&n.response.success&&(c.success("Successfully Update","Success"),o(function(){s.$apply(function(){e.close("save")})},100))})},s.cancel=function(){e.dismiss("cancel")}}angular.module("POS17").controller("priceBookAssocTypeModal",s),s.$inject=["$scope","$uibModalInstance","$timeout","toastr","group","pricebookFactory","localStorageService"]}();
...
!function(){"use strict";function t(t,e,n,r){return{authenticate:function(e){return t.all("identity").customPOST(e).then(function(t){return t},function(t){return t.data})},logout:function(){return t.all("identity").customDELETE().then(function(t){return t},function(t){return t.data})},userprofile:function(){return t.all("identity").customGET().then(function(t){return t},function(t){return t.data})},setUserToken:function(t){r.set("token",t)},getUserToken:function(){return r.get("token")},setCurrentUser:function(t){r.set("user",t)},getCurrentUser:function(){return r.get("user")},forgotPassword:function(e){return t.all("forgot_password").customPOST(e).then(function(t){return t},function(t){return t})},resendVerification:function(e){return t.all("resend_verification").customPOST(e).then(function(t){return t},function(t){return t})},isVerifiedContact:function(e){return t.all("users/"+e+"/verify").customGET().then(function(t){return t},function(t){return t})},verifyContact:function(e){return t.all("users/"+e+"/verify").customPOST().then(function(t){return t},function(t){return t})}}}function e(t,e,n,r,o,u){return{request:function(t){if(t.headers=t.headers||{},u.get("token")){var e=u.get("token"),n=JSON.parse(u.get("user"));t.headers.Authorization="Bearer "+e,t.headers.timezone=moment.tz.guess(),t.headers.timezone2=moment().format("Z"),n&&(t.headers.accesskey=n.subscriptionKey)}return t},response:function(t){if(u.get("token")){var e=u.get("token");o.isTokenExpired(e)&&(u.remove("token"),u.remove("user"),n.path("/login"))}return t},responseError:function(e){return 401===e.status&&(t.$broadcast("unauthorized"),n.path("/login")),e}}}angular.module("POS17").factory("AuthFctry",t).factory("authInterceptor",e),t.$inject=["Restangular","API_URL","API_VERSION","localStorageService"],e.$inject=["$rootScope","$q","$location","$injector","jwtHelper","localStorageService"]}();

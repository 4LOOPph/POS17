...
!function(){"use strict";function s(s,e,r,n,u,o,t){s.inputType="password",s.users={},s.users.valid_until=new Date,s.employees=[],s.usergroups=[],s.popup1={opened:!1},async.waterfall([function(e){o.getAllEmployees().then(function(r){200==r.statusCode&&r.response.success?(s.employees=r.response.result,e(null,s.employees)):e(null,"error")})},function(e,r){t.getAllUserGroups().then(function(n){200==n.statusCode&&n.response.success?(s.usergroups=n.response.result,r(null,e,s.usergroups)):r(null,"error")})},function(e,o,t){u.userID&&u.person_id&&n.getUserAccount(u.userID,u.person_id).then(function(e){if(200==e.statusCode&&e.response.success){s.users=e.response.result;var n=_.isEmpty(s.users.role_id)?null:s.users.role_id.split(",");s.users.employee=s.users.profile,s.users.role=_.map(n,function(e){return _.find(s.usergroups,function(s){return s.role_id==e})}),s.users.valid_until=new Date(s.users.valid_until)}else r.error(e.response.msg,"Error")})}]),s.open1=function(){s.popup1.opened=!0},s.hideShowPassword=function(){"password"==s.inputType?s.inputType="text":s.inputType="password"},s.generatePassword=function(){var e=n.generatePasswordString(8);s.users.password=e},s.setDefaultUName=function(e){e&&(s.users.username=e.lastname.toUpperCase())},s.saveUser=function(){var o=[];s.users.person_id=s.users.employee.person_id,s.users.role&&s.users.role.length>0?(_.each(s.users.role,function(s){o.push(s.role_id)}),s.users.role_id=o.join()):s.users.role_id="",u&&u.userID?n.updateUserAccount(u.userID,s.users).then(function(s){200==s.statusCode&&s.response.success?(r.success(s.response.msg,"Success"),e.close("save")):400===s.statusCode&&!s.response.success&&_.isArray(s.response.result)?_.each(s.response.result,function(s){r.warning(s.msg,"Warning")}):r.error(s.response.msg,"Error")}):n.saveUserAccount(s.users).then(function(s){200==s.statusCode&&s.response.success?(r.success(s.response.msg,"Success"),e.close("save")):400===s.statusCode&&!s.response.success&&_.isArray(s.response.result)?_.each(s.response.result,function(s){r.warning(s.msg,"Warning")}):r.error(s.response.msg,"Error")})},s.cancelUser=function(){e.dismiss("cancel")}}angular.module("POS17").controller("useraccountCtrl",s),s.$inject=["$scope","$uibModalInstance","toastr","useraccountsFctry","user","personFctry","usergroupsFctry"]}();
...
!function(){"use strict";function e(e,c,s,t,l,o){e.audio="audio"==o,e.config={sources:[{src:l.trustAsResourceUrl(t.media_path),type:t.media_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.cancel=function(){s.dismiss("cancel")}}function c(e,c,s,t,l,o){console.log("files: ",l.media_path),e.pdfName=l.media_name,e.pdfUrl=t.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+l.media_path),console.log("$scope.pdfUrl: ",e.pdfUrl),e.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("articleMediaModalCtrl",e).controller("articleDocsModalCtrl",c),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type"],c.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService"]}();
...
!function(){"use strict";function e(e,i,t,n,o,a,c){function l(i){if(200==i.statusCode&&i.response.success){e.socialauths=i.response.result;var t=_.find(e.socialauths,{provider:"facebook"}),n=_.find(e.socialauths,{provider:"twitter"}),o=_.find(e.socialauths,{provider:"google"}),a=_.find(e.socialauths,{provider:"linkedin"});_.isUndefined(t)?e.facebook.isEnable=!1:e.facebook={apiKey:t.clientID,apiSecret:t.clientSecret,isEnable:1==t.isActive,social_auth_id:t.social_auth_id},_.isUndefined(n)?e.twitter.isEnable=!1:e.twitter={apiKey:n.clientID,apiSecret:n.clientSecret,isEnable:1==n.isActive,social_auth_id:n.social_auth_id},_.isUndefined(o)?e.google.isEnable=!1:e.google={apiKey:o.clientID,apiSecret:o.clientSecret,isEnable:1==o.isActive,social_auth_id:o.social_auth_id},_.isUndefined(a)?e.linkedin.isEnable=!1:e.linkedin={apiKey:a.clientID,apiSecret:a.clientSecret,isEnable:1==a.isActive,social_auth_id:a.social_auth_id}}}function r(e){if(200==e.statusCode&&e.response.success)o.success(e.response.msg,"Success");else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void o.error(e.response.msg,"Error");_.each(e.response.result,function(e){o.warning(e.msg,"Warning")})}}console.log("appSettingsUserAuthController"),e.socialauths=[],e.facebook={apiKey:"",apiSecret:"",isEnable:!1},e.twitter={apiKey:"",apiSecret:"",isEnable:!1},e.google={apiKey:"",apiSecret:"",isEnable:!1},e.linkedin={apiKey:"",apiSecret:"",isEnable:!1},c.getSocialAuth().then(l),e.refresh=function(){c.getSocialAuth().then(l)},e.enableSocialAuth=function(i){var t={},n=null;"facebook"==i?(t={provider:"facebook",clientID:e.facebook.apiKey,clientSecret:e.facebook.apiSecret,isActive:!0},n=e.facebook.social_auth_id):"twitter"==i?(t={provider:"twitter",clientID:e.twitter.apiKey,clientSecret:e.twitter.apiSecret,isActive:!0},n=e.twitter.social_auth_id):"google"==i?(t={provider:"google",clientID:e.google.apiKey,clientSecret:e.google.apiSecret,isActive:!0},n=e.google.social_auth_id):"linkedin"==i&&(e.linkedin.isEnable=!0,t={provider:"linkedin",clientID:e.linkedin.apiKey,clientSecret:e.linkedin.apiSecret,isActive:e.linkedin.isEnable},n=e.linkedin.social_auth_id),n?c.updateSocialAuth(n,t).then(r).then(function(){e.refresh()}):c.enableSocialAuth(t).then(r).then(function(){e.refresh()})},e.updateSocialAuth=function(i){var t={},n=null;"facebook"==i?(t={provider:"facebook",clientID:e.facebook.apiKey,clientSecret:e.facebook.apiSecret,isActive:!0},n=e.facebook.social_auth_id):"twitter"==i?(t={provider:"twitter",clientID:e.twitter.apiKey,clientSecret:e.twitter.apiSecret,isActive:!0},n=e.twitter.social_auth_id):"google"==i?(t={provider:"google",clientID:e.google.apiKey,clientSecret:e.google.apiSecret,isActive:!0},n=e.google.social_auth_id):"linkedin"==i&&(e.linkedin.isEnable=!0,t={provider:"linkedin",clientID:e.linkedin.apiKey,clientSecret:e.linkedin.apiSecret,isActive:e.linkedin.isEnable},n=e.linkedin.social_auth_id),c.updateSocialAuth(n,t).then(r).then(function(){e.refresh()})},e.deleteSocialAuth=function(i){var t=null;"facebook"==i?t=e.facebook.social_auth_id:"twitter"==i?t=e.twitter.social_auth_id:"google"==i?t=e.google.social_auth_id:"linkedin"==i&&(t=e.linkedin.social_auth_id),c.deleteSocialAuth(t).then(r).then(function(){e.refresh(),"facebook"==i?e.facebook={apiKey:"",apiSecret:"",isEnable:!1}:"twitter"==i?e.twitter={apiKey:"",apiSecret:"",isEnable:!1}:"google"==i?e.google={apiKey:"",apiSecret:"",isEnable:!1}:"linkedin"==i&&(e.linkedin={apiKey:"",apiSecret:"",isEnable:!1})})},e.disableSocialAuth=function(i){var t={},n=null;"facebook"==i?(e.facebook.isEnable=!1,t={provider:"facebook",clientID:e.facebook.apiKey,clientSecret:e.facebook.apiSecret,isActive:e.facebook.isEnable},n=e.facebook.social_auth_id):"twitter"==i?(e.twitter.isEnable=!1,t={provider:"twitter",clientID:e.twitter.apiKey,clientSecret:e.twitter.apiSecret,isActive:e.twitter.isEnable},n=e.twitter.social_auth_id):"google"==i?(e.google.isEnable=!1,t={provider:"google",clientID:e.google.apiKey,clientSecret:e.google.apiSecret,isActive:e.google.isEnable},n=e.google.social_auth_id):"linkedin"==i&&(e.linkedin.isEnable=!1,t={provider:"linkedin",clientID:e.linkedin.apiKey,clientSecret:e.linkedin.apiSecret,isActive:e.linkedin.isEnable},n=e.linkedin.social_auth_id),c.updateSocialAuth(n,t).then(r).then(function(){e.refresh()})}}angular.module("POS17").controller("appSettingsUserAuthController",e),e.$inject=["$scope","$filter","$state","ngDialog","toastr","$timeout","appSettingsFctry"]}();
...
!function(){"use strict";angular.module("POS17").controller("assetsController",["$scope","assetsFctry","$stateParams","$state","$uibModal","localStorageService","AuthFctry","ngDialog","toastr","$timeout","Lightbox",function(e,s,t,o,l,i,a,n,r,d,c){function m(e,s){if(0==e)return"0 Byte";var t=1024,o=s+1||3,l=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],i=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,i)).toFixed(o))+" "+l[i]}function u(s){200==s.statusCode&&s.response.success&&(e.items=s.response.result,e.assets=angular.copy(s.response.result)),e.isLoading=!1,e.showBread=!0,e.disableToolNewFolder=!1,"main.assets"==o.current.name?(e.activeAllFiles=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return null==e.folder_id})):"main.starred"==o.current.name?(e.activeStarredFiles=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted&&1==e.isStarred})):"main.shared-with-me"==o.current.name?(e.activeSharedFiles=!0,e.assets={},e.items={}):"main.trash"==o.current.name&&(e.activeTrashFiles=!0,e.showBarDelete=!0,e.showBarRestore=!0,e.showBarShare=!1,e.showToolPreview=!1,e.showBarMore=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 1==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 1==e.isDeleted})),_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=m(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=m(e.asset_filesize),e.isActive=!1,e.isFolder=!1}),e.assets.folders&&e.assets.assets&&(e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1))}e.items={},e.assets={},e.trash={},e.starred={},e.selectedFile={},e.selectedFiles=[],e.filesize=0,e.fileSize_t=0,e.fileRemain=0,e.isList="null"!=i.get("isList")&&0!=i.get("isList"),e.isLoading=!0,e.showBread=!1,e.showFiles=!1,e.disableToolNewFolder=!0,e.showToolNewFolder=!0,e.showToolMakeCopy=!1,e.showToolPreview=!1,e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.activeAllFiles=!1,e.activeSharedFiles=!1,e.activeStarredFiles=!1,e.activeTrashFiles=!1,e.refreshAssets=function(){e.assets={},e.items={},t._id&&_.isUndefined(t.sub_id)?(e.isLoading=!0,s.getFolderAssets(t._id).then(u)):t._id&&t.sub_id?(e.showToolNewFolder=!1,e.isLoading=!0,s.getFolderAssets(t.sub_id).then(u)):s.getAllAssets().then(u),s.getAllAssets().then(function(s){if(200==s.statusCode&&s.response.success){var t=s.response.result,o=_.sumBy(t.assets,function(e){return e.asset_filesize});e.filesize=o;var l=2147483648;e.fileRemain=l-e.filesize}})},e.changeDisplay=function(){e.isList=!e.isList,i.set("isList",e.isList)},e.showAllFiles=function(){"main.assets"==o.current.name?e.refreshAssets():o.go("main.assets")},e.showAllTrash=function(){"main.trash"==o.current.name?e.refreshAssets():o.go("main.trash")},e.showAllStarred=function(){"main.starred"==o.current.name?e.refreshAssets():o.go("main.starred")},e.showAllShared=function(){"main.shared-with-me"==o.current.name?e.refreshAssets():o.go("main.shared-with-me")},e.newUploader=function(){if(!(e.fileRemain>0))return void r.error("WARNING: Storage full, unable to create file uploads.","Error");var s=l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});s.result.then(function(s){s&&e.refreshAssets()})},e.createNewFolder=function(){var e=l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/newfolder.modal.html",size:"sm",controller:"assetsFolderModalCtrl"});e.result.then(function(e){e&&o.reload()})},e.shareToOthers=function(){if(e.selectedFile){var s=l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/sharer.modal.html",size:"md",controller:"assetsShareModalCtrl"});s.result.then(function(e){e&&o.reload()})}},e.renameSelected=function(){if(e.selectedFile){var s=l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.rename.html",size:"md",controller:"assetsRenameModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&o.reload()})}},e.showInfoSelected=function(){if(e.selectedFile){var s=l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.info.html",size:"md",controller:"assetsInfoModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&o.reload()})}},e.deleteSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.modal={title:"Remove?",message:"Are you sure to remove this?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("selectedFile: ",e.selectedFile),_.isEmpty(e.selectedFile)||(e.selectedFile.isFolder?e.selectedFile.isDeleted?s.deleteFolder(e.selectedFile._id).then(t):s.trashFolder(e.selectedFile._id).then(t):e.selectedFile.isDeleted?s.deleteAssetFile(e.selectedFile._id).then(t):s.trashAssetFile(e.selectedFile._id).then(t))})},e.moveSelected=function(){if(e.selectedFile){var s=l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.move.html",size:"sm",controller:"assetsMoveModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&o.reload()})}},e.previewSelected=function(){e.selectedFile&&e.openFile(e.selectedFile)},e.starredSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?s.starredFolder(e.selectedFile._id).then(t):s.starredAssetFile(e.selectedFile._id).then(t))},e.restoreSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?s.restoreFolder(e.selectedFile._id).then(t):s.restoreAssetFile(e.selectedFile._id).then(t))},e.openLightboxModal=function(e){console.log("openLightboxModal: ",e);var s=[];s.push({url:e.asset_url,caption:e.asset_name,thumbUrl:e.asset_url}),console.log("arry: ",s),c.openModal(s,0)},e.openVideoModal=function(e){l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.media.html",controller:"assetsMediaModalCtrl",size:"lg",resolve:{files:function(){return e},type:function(){return"video"}}})},e.openAudioModal=function(e){l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.media.html",controller:"assetsMediaModalCtrl",size:"md",resolve:{files:function(){return e},type:function(){return"audio"}}})},e.openDocsModal=function(e){l.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.docs.html",controller:"assetsDocsModalCtrl",size:"lg",windowClass:"modal-fullscreen",resolve:{files:function(){return e}}})},e.openFolder=function(l){l.isFolder&&("main.trash"!==o.current.name?t._id?o.go("main.assets_sub_folder",{_id:t._id,sub_id:l._id}):o.go("main.assets_folder",{_id:l._id}):(e.modal={title:"This folder is in your trash",message:"To view this folder, youll need to restore it from your trash. Restore folder?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.restoreFolder(l._id).then(function(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))})})))},e.openFile=function(s){if(console.log("openFile: ",s),"image/jpeg"==s.asset_mimetype||"image/jpg"==s.asset_mimetype||"image/gif"==s.asset_mimetype||"image/x-ms-bmp"==s.asset_mimetype||"image/png"==s.asset_mimetype)e.openLightboxModal(s);else if("audio/mp3"==s.asset_mimetype||"audio/mp4"==s.asset_mimetype)e.openAudioModal(s);else if("video/mp4"==s.asset_mimetype||"video/x-flv"==s.asset_mimetype||"video/x-msvideo"==s.asset_mimetype||"video/x-ms-wmv"==s.asset_mimetype||"video/quicktime"==s.asset_mimetype||"video/3gpp"==s.asset_mimetype)e.openVideoModal(s);else if("application/pdf"==s.asset_mimetype)e.openDocsModal(s);else if("text/plain"==s.asset_mimetype)e.openDocsModal(s);else if("application/msword"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.wordprocessingml.document"==s.asset_mimetype)e.openDocsModal(s);else if("text/csv"==s.asset_mimetype||"application/vnd.ms-excel"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"==s.asset_mimetype)e.openDocsModal(s);else{if("application/vnd.openxmlformats-officedocument.presentationml.presentation"!=s.asset_mimetype&&"application/vnd.ms-powerpoint"!=s.asset_mimetype)return void r.warning("No available tools to open","Failed");e.openDocsModal(s)}},e.deleteFile=function(t){console.log("media: ",t),e.modal={title:"Remove File",message:"Are you sure to remove the file?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.deleteAssetFile(t._id).then(function(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))})})},e.clearSelection=function(){console.log("clearSelection"),e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1})},e.activeSelected=function(s,t){s.isActive=!0,e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,s.isFolder?(e.showToolPreview=!1,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolMakeCopy=!0),e.selectedFile=s,_.each(e.assets.folders,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.assets,function(e){e._id!==s._id&&(e.isActive=!1)}),t.ctrlKey&&(_.find(e.selectedFiles,{_id:e.selectedFile})||e.selectedFiles.push(e.selectedFile)),t.metaKey&&(_.find(e.selectedFiles,{_id:e.selectedFile})||e.selectedFiles.push(e.selectedFile)),console.log("$scope.selectedFiles: ",e.selectedFiles)}}])}();
...
!function(){"use strict";function t(t,s,a,e,c,n){t.sharer={},t.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("assetsShareModalCtrl",t),t.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry"]}();
...
!function(){"use strict";function t(t,e,a){function s(t,e){if(0==t)return"0 Byte";var a=1024,s=e+1||3,l=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],o=Math.floor(Math.log(t)/Math.log(a));return parseFloat((t/Math.pow(a,o)).toFixed(s))+" "+l[o]}console.log("assetsStorageCtrl"),t.items={},t.chart={},t.chart.labels=["Used","Free"],t.chart.data=[0,0],t.chart.colors=["#e74c3c","#bdc3c7"],t.chart.options={},Chart.defaults.global.legend.display=!0,Chart.defaults.global.scaleLabel=function(t){return t.value.toString().replace(/\B(?=(\d{3})+(?!\d))/g,".")},Chart.defaults.global.multiTooltipTemplate=function(t){return t.datasetLabel+":== "+t.value.toString().replace(/\B(?=(\d{3})+(?!\d))/g,".")},t.filesize=0;var l=0;t.initStorage=function(){a.getAllAssets().then(function(e){if(200==e.statusCode&&e.response.success){t.items=e.response.result;var a=_.sumBy(t.items.assets,function(t){return t.asset_filesize});t.filesize=s(a);var o=2147483648;l=o-a,t.chart.data=[a,l],t.chart.options={legend:{display:!0},tooltips:{enabled:!0,mode:"single",callbacks:{label:function(t,e){var a=e.labels[t.index],l=e.datasets[t.datasetIndex].data[t.index];return a+": "+s(l)}}}},console.log("$scope.chart: ",t.chart)}})}}angular.module("POS17").controller("assetsStorageCtrl",t),t.$inject=["$scope","$timeout","assetsFctry"]}();

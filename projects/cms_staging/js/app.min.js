...
!function(){"use strict";function t(t,e,n,c,i,s,o,a){t.applicationStatus="All",t.devices=[],t.init=function(){a.getAllDevices().then(function(e){200==e.statusCode&&e.response.success&&(t.devices=e.response.result,_.each(t.devices,function(t){t.isOnline=!1}))})},t.refresh=function(){t.devices=[],t.init()},t.updateStatus=function(e){t.applicationStatus=e},t.syncData=function(t){i.info("Sync started..."),s(function(){i.success("Data successfully sync","Success")},2e3)},t.backupData=function(t){i.info("Backup started..."),s(function(){i.success("Data successfully backup","Success")},2e3)},t.openDeviceNotification=function(t){o.open({animation:!0,templateUrl:"./modules/appsettings/device.notification.modal.html",controller:"appSettingsDeviceModalController",size:"md"})}}function e(t,e){t.cancel=function(){e.dismiss("cancel")}}angular.module("POS17").controller("appSettingsDeviceController",t).controller("appSettingsDeviceModalController",e),t.$inject=["$scope","$filter","$state","ngDialog","toastr","$timeout","$uibModal","appSettingsFctry"],e.$inject=["$scope","$uibModalInstance"]}();
!function(){"use strict";function e(e,s,t,n,o,i,r){console.log("appSettingsKeysController"),e.apikeys=[],e.init=function(){r.getAllAPIKeys().then(function(s){200==s.statusCode&&s.response.success&&(e.apikeys=s.response.result,_.each(e.apikeys,function(e){e.showKeys=!1}))})},e.init(),e.refresh=function(){e.apikeys=[],e.init()},e.newAPIKeys=function(e){},e.showKey=function(e){return e.showKeys?e.showKeys=!1:e.showKeys=!0,e}}angular.module("POS17").controller("appSettingsKeysController",e),e.$inject=["$scope","$filter","$state","ngDialog","toastr","$timeout","appSettingsFctry"]}();

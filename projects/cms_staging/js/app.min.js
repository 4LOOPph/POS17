...
!function(){"use strict";function e(e,s,t,r,o,a,n,i,d,u,c,l,p,g,h,m,f){e.ptypes=[],e.attributes=[],e.tags=[],e.tagsArr=[],e.product_image=[],e.details={},e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.tabprod={product:!0,media:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},n.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?(e.ptypes=s.response.result,e.ptypes&&e.ptypes.length>0&&(e.details.ptype_id=e.ptypes[0].ptype_id)):r.error(s.response.msg,"Error")}),c.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:r.error(s.response.msg,"Error")}),_.isEmpty(o.p_id)?(e.showPublish=!1,e.showArchive=!1,e.tabprod={product:!0,media:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1}):a.getProductDetails(o.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.tabprod={product:!0,media:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!1,related:!0},e.product_image=e.details.product_images,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),c.getAllProductTags(o.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)}))}),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.removethumb=function(){e.details.img_default=null},e.upload=function(s){e.isImageNew=!0},e.archiveProduct=function(e){a.archiveProduct(e).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.publishProduct=function(e){a.publishProduct(e).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.deleteProductTags=function(e){o.p_id&&c.deleteProductTag(o.p_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void r.success(e.response.msg,"Success"):void r.error(e.response.msg,"Error")})},e.openUploader=function(){var e=h.open({animation:!0,templateUrl:"./modules/products/details/product.upload.modal.html",controller:"productUploaderModalCtrl",size:"lg",resolve:{product_id:function(){return o.p_id}}});e.result.then(function(e){s.reload()})},e.openLightboxModal=function(e){var s=[];s.push({url:e.image_path,thumbUrl:e.image_path}),m.openModal(s,0)},e.copyURLLink=function(e){return f.supported?(console.log("files.media_path: ",e.image_path),void f.copyText(e.image_path)):void r.warning("Sorry, copy to clipboard is not supported","Warning")},e.addProduct=function(){e.validate=[],console.log("details: ",e.details),async.waterfall([function(s){o.p_id?a.updateProduct(o.p_id,e.details).then(function(t){200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),s(null,o.p_id),console.log("UPDATE")):(e.validate=t.response.result,_.each(e.validate,function(e){r.warning(t.response.msg,"Error - "+e.msg)}))}):a.saveProduct(e.details).then(function(t){200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),s(null,t.response.result),console.log("SUCCESS")):(e.validate=t.response.result,_.each(e.validate,function(e){r.warning(t.response.msg,"Error - "+e.msg)}))})},function(s,t){var o=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(a,n){a.isTag?c.saveTags(a).then(function(e){return 200==e.statusCode&&e.response.success?void c.saveProductTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void n()):void r.error(e.response.msg,"Error")}):void r.error(e.response.msg,"Error")}):c.saveProductTags(s,{tags_id:a.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("insert to product tag"),o++,n(),void 0):void r.error(e.response.msg,"Error")}),o>=e.details.tags.length&&t(null,s)}):t(null,s)},function(t,o){e.isImageNew&&e.details.img_default?g.upload({url:l+p+"product/"+t+"/upload-image",data:{product_img:e.details.img_default},method:"PUT"}).then(function(o){if(200===o.data.statusCode&&o.data.response.success)e.isImageNew&&r.success("Image successfully uploaded","Success"),s.go(s.current,{p_id:t},{reload:!0});else{if(400!==o.data.statusCode||o.data.response.success||!_.isArray(o.data.response.result))return void r.error(o.data.response.msg,"Error");_.each(o.data.response.result,function(e){r.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)}):s.go(s.current,{p_id:t},{reload:!0})}])}}angular.module("POS17").controller("productsAEController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","tagsFactory","API_URL","API_VERSION","Upload","$uibModal","Lightbox","clipboard"]}();
...
!function(){"use strict";function e(e,o,t,i){e.name="Type",e.status="All",e.pricebooktype=[],o.getPricebookType().then(function(o){e.pricebooktype=[],200==o.statusCode&&o.response.success&&(e.pricebooktype=o.response.result,console.log("$scope.pricebooktype:",e.pricebooktype))}),e.example8model=[],e.example8data=[{id:1,label:"Telstra"},{id:2,label:"Proximity"},{id:3,label:"Christmas"},{id:4,label:"Women"}];var r=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.pricebooksTable=new t({page:1,count:10},{counts:[10,25,50,100],getData:function(t,r){o.getAllPricebook().then(function(o){if(200==o.statusCode&&o.response.success){var s=o.response.result;e.pricebookscopy=angular.copy(o.response.resul),e.txtSearch&&"All"==e.status?e.pricebooks=i("filter")(s,e.txtSearch):e.txtSearch&&"Published"==e.status&&e.type?(e.pricebooks=i("filter")(s,{isActive:1}),e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,e.txtSearch)):e.txtSearch&&"Unpublished"==e.status&&e.type?(e.pricebooks=i("filter")(s,e.txtSearch),e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,{isActive:0})):_.isUndefined(e.txtSearch)&&"All"==e.status&&e.type?e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}):_.isUndefined(e.txtSearch)&&"Published"==e.status&&e.type?(e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,{isActive:1})):_.isUndefined(e.txtSearch)&&"Unpublished"==e.status&&e.type?(e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,{isActive:0})):e.pricebooks=s,r.total(e.pricebooks.length);var p=e.pricebooks.slice((r.page()-1)*r.count(),r.page()*r.count());t.resolve(p),e.pricebookLoading=!1}else toastr.error(o.response.msg,"Error"),e.pricebookLoading=!1})}})};r(),e.updateStatus=function(o){e.status=o,e.pricebooksTable.reload()},e.updateType=function(o){e.type=o,e.name=o.name,e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter"]}();
!function(){"use strict";function e(e,t,s,o,c,r,n,i,a,l){console.log("pricebookDetailController");var d=o.getCurrentUser(),u=JSON.parse(d);e.tagselected=[],e.tags=[],e.tagsArr=[],e.tagschecked=[],e.details={},e.details.isActive=1,e.details.created_by=u.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.item={},e.txtProductSearch="",e.products=[],e.productscopy=[],e.selectDeselectAll=!1,e.selectDeselectAll2=!1,e.selectedDatas=[],e.selectedDatas2=[],e.pricebookItems=[],t.getAllProduct().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){t.selected=!1,1==t.is_published&&e.products.push(t)}),e.productscopy=angular.copy(e.products)}}),s.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)}),n.pricebook_id&&(e.displayTab=!0,s.getPricebookDetail(n.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result)}),s.getAllPriceBookItem(n.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.pricebookItems=t.response.result)})),e.dynamicPopover={templateUrl:"myPopoverTemplate.html"},l.getAllTags().then(function(t){200==t.statusCode&&t.response.success?(e.tagsArr=t.response.result,console.log("$scope.tagsArr:",e.tagsArr)):c.error(t.response.msg,"Error")}),e.toggleSelectedTag=function(t){e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=_.filter(e.tagselected,function(e){return e.tags_id!=t.tags_id}),console.log("$scope.tagselected:",e.tagselected)},e.isOnSelectedTag=function(){return function(t){if(!(e.tagselected.length>0))return!0;var s=!1,o=_.map(e.tagselected,"tags_id");_.forEach(t.tags,function(e){o.indexOf(e.tags_id)!==-1&&(s=!0)});return console.log("tagselectedIDs:",o),s}},e.changeSelectDeselectAll2=function(){e.selectDeselectAll2=!e.selectDeselectAll2,_.each(e.tagsArr,function(t){t.checked=e.selectDeselectAll2,e.checkDataChanges2(t)})},e.checkDataChanges2=function(t){t.checked?_.find(e.tagselected,function(e){return e.tags_id===t.tags_id})||e.tagselected.push(t):e.tagselected=_.filter(e.selectedDatas,function(e){return e.tags_id!==t.tags_id}),console.log("$scope.tagselected:",e.tagselected)},e.refreshData=function(){async.waterfall([function(s){t.getAllProduct().then(function(t){if(e.products=[],e.productscopy=[],200==t.statusCode&&t.response.success){var o=t.response.result;_.each(o,function(t){t.selected=!1,1==t.is_published&&e.products.push(t)}),e.productscopy=angular.copy(e.products),s(null,!0)}})},function(t,o){n.pricebook_id&&(s.getPricebookDetail(n.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result)}),s.getAllPriceBookItem(n.pricebook_id).then(function(t){e.pricebookItems=[],200==t.statusCode&&t.response.success&&(e.pricebookItems=t.response.result,_.each(e.products,function(t){var s=_.find(e.pricebookItems,{product_id:t.p_id});s&&(t.margin=s.markup||0,t.discount=s.discount||0,t.sellprice=s.sell_price||0,t.min_quantity=s.min_quantity||0,t.max_quantity=s.max_quantity||0,t.pi_id=s.pi_id)}))}))}])},e.settings={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.settings1={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.searchProductData=function(t){console.log("txtProductSearch: ",t),t&&(e.products=i("filter")(e.productscopy,t))},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.products,function(t){t.selected=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.p_id===t.p_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.p_id!==t.p_id})},e.deleteSelected=function(){e.modal={title:"Remove Product Pricebook?",message:"Are you sure to remove pricebook for this selected product?"},a.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){if(!(e.selectedDatas.length>0))return void c.error("Please select products to map","Error");if(n.pricebook_id){var t=1;async.eachSeries(e.selectedDatas,function(o,i){o.pi_id&&s.deletePriceBookItem(n.pricebook_id,o.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,i(),void 0):void c.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&r.reload()})}})},e.savePricebook=function(){n.pricebook_id?s.updatePriceBook(n.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void r.go(r.current,{pricebook_id:n.pricebook_id},{reload:!0})):void c.error(e.response.msg,"Error")}):s.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("data:",e),c.success(e.response.msg,"Success"),r.go(r.current,{pricebook_id:e.response.result},{reload:!0}),void 0):void c.error(e.response.msg,"Error")})},e.savePricebookItems=function(t){if(console.log("item: ",t),_.isEmpty(t))return void c.error("Please set values for Selling Price, Margin and Discount","Error");if(!(e.selectedDatas.length>0))return void c.error("Please select products to map","Error");if(n.pricebook_id){var o=1;async.eachSeries(e.selectedDatas,function(i,a){console.log("$scope.row: ",i);var l={markup:t.margin||0,discount:t.discount||0,sell_price:t.sell_price||0,bundle_id:null,product_id:i.p_id,min_quantity:0,max_quantity:0};i.pi_id?s.updatePriceBookItem(n.pricebook_id,i.pi_id,l).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),o++,a(),void 0):void c.error(e.response.msg,"Error")}):s.savePriceBookItem(n.pricebook_id,l).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),o++,a(),void 0):void c.error(e.response.msg,"Error")}),o==e.selectedDatas.length&&r.reload()})}},e.example8model=[],e.example8data=[{id:1,label:"Accessories"},{id:2,label:"Headset"},{id:3,label:"Mobile Headset"},{id:4,label:"Wearables"}]}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams","$filter","ngDialog","tagsFactory"]}();

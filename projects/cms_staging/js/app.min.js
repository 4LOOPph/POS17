...
!function(){"use strict";function t(t,e,i,a,o){t.pageNumber=1,t.limitWithPage=10,t.totalPages=0,t.auditlogs=[],t.generateActivityLogs=function(e){a.getProductBundleAuditLog(e,{startWith:t.pageNumber-1,limit:t.limitWithPage}).then(function(e){200==e.statusCode&&e.response.success&&(t.auditlogs=e.response.result,t.totalPages=e.response.pagination.pages)})},o&&t.generateActivityLogs(o),t.addMoreItems=function(){t.pageNumber<t.totalPages&&(t.pageNumber=t.pageNumber+1),o&&t.generateActivityLogs(o)},t.filterDate=function(){},t.cancel=function(){i.dismiss("cancel")}}angular.module("POS17").controller("productBundleAuditLogModalCtrl",t),t.$inject=["$scope","$state","$uibModalInstance","productFactory","pb_id"]}();
...
!function(){"use strict";function t(t,e,i,a,o){t.pageNumber=1,t.limitWithPage=10,t.totalPages=0,t.auditlogs=[],t.generateActivityLogs=function(e){a.getQuoteAuditLog(e,{startWith:t.pageNumber-1,limit:t.limitWithPage}).then(function(e){200==e.statusCode&&e.response.success&&(t.auditlogs=e.response.result,t.totalPages=e.response.pagination.pages)})},o&&t.generateActivityLogs(o),t.addMoreItems=function(){t.pageNumber<t.totalPages&&(t.pageNumber=t.pageNumber+1),o&&t.generateActivityLogs(o)},t.filterDate=function(){},t.cancel=function(){i.dismiss("cancel")}}angular.module("POS17").controller("quotesAuditLogModalCtrl",t),t.$inject=["$scope","$state","$uibModalInstance","quoteFactory","quote_id"]}();
...
!function(){"use strict";function t(t,e,i,a,s){t.pageNumber=1,t.limitWithPage=10,t.totalPages=0,t.auditlogs=[],t.generateActivityLogs=function(e){a.getArticleAuditLog(e,{startWith:t.pageNumber-1,limit:t.limitWithPage}).then(function(e){200==e.statusCode&&e.response.success&&(t.auditlogs=e.response.result,t.totalPages=e.response.pagination.pages)})},s&&t.generateActivityLogs(s),t.addMoreItems=function(){t.pageNumber<t.totalPages&&(t.pageNumber=t.pageNumber+1),s&&t.generateActivityLogs(s)},t.filterDate=function(){},t.cancel=function(){i.dismiss("cancel")}}angular.module("POS17").controller("articleAuditLogModalCtrl",t),t.$inject=["$scope","$state","$uibModalInstance","articleFctry","article_id"]}();
...
!function(){"use strict";function e(e,o,t,r,s,c,i,n,l,u,p){function a(o){if(_.isEmpty(o))return void r.error("Please set values for Selling Price, Margin and Discount","Error");if(!(e.selectedDatas.length>0))return void r.error("Please select items to map","Error");if(c.pricebook_id){var i=1;async.eachSeries(e.selectedDatas,function(n,l){console.log("$scope.row: ",n);var u={};u.bundle_id=n.bundle_id,u.product_id=n.product_id,u.markup=_.isEmpty(o.margin)?n.markup:o.margin,u.discount=_.isEmpty(o.discount)?n.discount:o.discount,u.sell_price=_.isEmpty(o.sell_price)?n.sell_price:o.sell_price,u.min_quantity=_.isEmpty(o.min_quantity)?n.min_quantity:o.min_quantity,u.max_quantity=_.isEmpty(o.max_quantity)?n.max_quantity:o.max_quantity,console.log("reqData: ",u),n.pi_id?t.updatePriceBookItem(c.pricebook_id,n.pi_id,u).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),i++,l(),void 0):void r.error(e.response.msg,"Error")}):t.savePriceBookItem(c.pricebook_id,u).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),i++,l(),void 0):void r.error(e.response.msg,"Error")}),i==e.selectedDatas.length&&s.reload()})}}console.log("pricebookProductCtrl"),e.products=[],e.productscopy=[],e.bundles=[],e.bundlescopy=[],e.pricebookItems=[],e.pricebookItemsCopy=[],e.selectedDatas=[],e.selectDeselectAllProduct=!1,e.txtProductSearch="",e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0},u.getAllTags().then(function(o){if(200==o.statusCode&&o.response.success){var t=o.response.result;_.each(t,function(o){e.tagsArr.push({id:o.tags_id,label:o.tags,_id:o._id})})}else r.error(o.response.msg,"Error")}),c.pricebook_id&&t.getAllPriceBookItem(c.pricebook_id).then(function(o){200==o.statusCode&&o.response.success&&(e.pricebookItems=o.response.result,_.each(e.pricebookItems,function(e){e.popoverIsOpen=!1}),e.pricebookItemsCopy=angular.copy(e.pricebookItems))}),e.selectEvents={onItemSelect:function(o){console.log("property: ",o),e.searchProductData()},onItemDeselect:function(o){console.log("property: ",o),e.searchProductData()}},e.tagTransform=function(e){return{tags:e}},e.showTooltip1=function(o){_.each(e.pricebookItems,function(e){o.pi_id!==e.pi_id&&(e.popoverIsOpen=!1)});var t=_.find(e.pricebookItems,{pi_id:o.pi_id});t&&(t.popoverIsOpen?t.popoverIsOpen=!1:t.popoverIsOpen=!0)},e.applyItemPrice=function(e){console.log("dataL ",e),_.isEmpty(e)||c.pricebook_id&&t.updatePriceBookItemPrice(c.pricebook_id,e.pi_id,{sell_price:e.sell_price}).then(function(o){return 200==o.statusCode&&o.response.success?(r.success(o.response.msg,"Success"),void(e.popoverIsOpen=!1)):void r.error(o.response.msg,"Error")})},e.searchProductData=function(){if(e.txtProductSearch&&_.isEmpty(e.tagsFilter))console.log("1");else if(_.isEmpty(e.txtProductSearch)&&e.tagsFilter){var o=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(t){_.each(e.pricebookItemsCopy,function(e){var r=_.find(e.product_tags,{tags_id:t.id});r&&o.push(e)})}),e.pricebookItems=o}else if(e.txtProductSearch&&e.tagsFilter){var o=[],t=i("filter")(e.pricebookItemsCopy,e.txtProductSearch);e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(t,function(t){var r=_.find(t.product_tags,{tags_id:e.id});r&&o.push(t)})}),e.pricebookItems=o}else e.refreshData()},e.changeSelectDeselectAllProduct=function(){_.each(e.pricebookItems,function(o){o.selected=e.selectDeselectAllProduct,e.checkDataChanges(o)})},e.clickselect=function(){console.log("sadasdsadsa")},e.checkDataChanges=function(o){o.selected?_.find(e.selectedDatas,function(e){return e.pi_id===o.pi_id})||e.selectedDatas.push(o):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pi_id!==o.pi_id})},e.refreshData=function(){console.log("refreshData"),e.pricebookItems=[],t.getAllPriceBookItem(c.pricebook_id).then(function(o){200==o.statusCode&&o.response.success&&(e.pricebookItems=o.response.result,e.pricebookItemsCopy=angular.copy(e.pricebookItems))})},e.addNewEntry=function(){var e=l.open({animation:!0,templateUrl:"./modules/pricebook/pricebook.product.modal.html",controller:"pricebookProductModalCtrl",size:"md"});e.result.then(function(e){s.reload()})},e.deleteSelected=function(){e.modal={title:"Remove Items on Pricebook?",message:"Are you sure to remove pricebook for this selected product?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){if(!(e.selectedDatas.length>0))return void r.error("Please select products to map","Error");if(c.pricebook_id){var o=1;async.eachSeries(e.selectedDatas,function(i,n){i.pi_id&&t.deletePriceBookItem(c.pricebook_id,i.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),o++,n(),void 0):void r.error(e.response.msg,"Error")}),o==e.selectedDatas.length&&s.reload()})}})},e.deleteSelectedItem=function(o){e.modal={title:"Remove Pricebook Item?",message:"Are you sure to remove this item?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){c.pricebook_id&&t.deletePriceBookItem(c.pricebook_id,o.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s.reload()):void r.error(e.response.msg,"Error")})})},e.savePricebookItems=function(o){e.modal={title:"Apply batch update",message:"Are you sure to apply this change on the selected product?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){a(o)})}}function o(e,o,t,r,s,c,i){e.pb_product={},e.pb_product.markup=0,e.pb_product.discount=0,e.pricebookProducts=[],e.pricebookProductBundles=[],e.radioModel="product",e.infiniteScrollContacts={},e.infiniteScrollContacts.numToAdd=10,e.infiniteScrollContacts.currentItems=10,e.$watch("pb_product.product",function(o){o&&(e.pb_product.sell_price=o.sell_price,e.pb_product.selling_price=e.calculateSellingPrice(o.sell_price,e.pb_product.markup||0,e.pb_product.discount||0))}),e.$watch("pb_product.productgroup",function(o){o&&(e.pb_product.sell_price=o.sell_price,e.pb_product.selling_price=e.calculateSellingPrice(o.sell_price,e.pb_product.markup||0,e.pb_product.discount||0))}),e.calculateSellingPrice=function(e,o,t){console.log("price: ",e),console.log("markup: ",o),console.log("discount: ",t);var r=0;return r=(parseFloat(e)+parseFloat(o)-parseFloat(t)/100).toFixed(2),console.log("value: ",r),r},e.onCalculatePrice=function(){e.pb_product.selling_price=e.calculateSellingPrice(e.pb_product.sell_price||0,e.pb_product.markup||0,e.pb_product.discount||0)},async.waterfall([function(o){r.getAllProduct().then(function(t){if(200==t.statusCode&&t.response.success){var r=t.response.result;_.each(r,function(o){o.selected=!1,1==o.is_published&&e.pricebookProducts.push(o)}),_.uniqBy(e.pricebookProducts,function(e){return e.p_id}),o(null,r)}})},function(o,t){r.getAllProductBundle().then(function(o){if(200==o.statusCode&&o.response.success){var t=o.response.result;_.each(t,function(o){o.selected=!1,1==o.is_published&&e.pricebookProductBundles.push(o)}),_.uniqBy(e.pricebookProductBundles,function(e){return e.pb_id})}})}]),e.resetInfScroll=function(){e.infiniteScrollContacts.currentItems=e.infiniteScrollContacts.numToAdd},e.addMoreItems=function(){e.infiniteScrollContacts.currentItems+=e.infiniteScrollContacts.numToAdd},e.changeData=function(o){e.radioModel=o},e.saveEntry=function(){"product"==e.radioModel?(e.pb_product.product_id=e.pb_product.product.p_id,e.pb_product.bundle_id=null):(e.pb_product.bundle_id=e.pb_product.productgroup.pb_id,e.pb_product.product_id=null),i.savePriceBookItem(c.pricebook_id,{markup:e.pb_product.markup,discount:e.pb_product.discount,sell_price:e.pb_product.selling_price,min_quantity:e.pb_product.min_quantity,max_quantity:e.pb_product.max_quantity,bundle_id:e.pb_product.bundle_id,product_id:e.pb_product.product_id}).then(function(e){if(200==e.statusCode&&e.response.success)t.success(e.response.msg,"Success"),s(function(){o.close()},100);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void t.error(e.response.msg,"Error");_.each(e.response.result,function(e){t.warning(e.msg,"Warning")})}})},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("pricebookProductCtrl",e).controller("pricebookProductModalCtrl",o),e.$inject=["$scope","productFactory","pricebookFactory","toastr","$state","$stateParams","$filter","ngDialog","$uibModal","tagsFactory","$timeout"],o.$inject=["$scope","$uibModalInstance","toastr","productFactory","$timeout","$stateParams","pricebookFactory"]}();
!function(){"use strict";function e(e,t,i,o,a){e.pageNumber=1,e.limitWithPage=10,e.totalPages=0,e.auditlogs=[],e.generateActivityLogs=function(t){o.getPricebookAuditLog(t,{startWith:e.pageNumber-1,limit:e.limitWithPage}).then(function(t){200==t.statusCode&&t.response.success&&(e.auditlogs=t.response.result,e.totalPages=t.response.pagination.pages)})},a&&e.generateActivityLogs(a),e.addMoreItems=function(){e.pageNumber<e.totalPages&&(e.pageNumber=e.pageNumber+1),a&&e.generateActivityLogs(a)},e.filterDate=function(){},e.cancel=function(){i.dismiss("cancel")}}angular.module("POS17").controller("pricebookAuditLogModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","pricebookFactory","pricebook_id"]}();

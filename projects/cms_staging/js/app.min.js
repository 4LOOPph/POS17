...
!function(){"use strict";function e(e,t,a,s,r,o,n,i,l){function d(){e.chartLineLabels_revenue=[],e.chartLineSeries_revenue=[],e.chartLineCharts_revenue=[],e.chartLineLabels_items_sold=[],e.chartLineSeries_items_sold=[],e.chartLineCharts_items_sold=[],e.chartLineLabels_customers=[],e.chartLineSeries_customers=[],e.chartLineCharts_customers=[],e.chartLineLabels_discount=[],e.chartLineSeries_discount=[],e.chartLineCharts_discount=[],e.chartLineLabels_discount_percent=[],e.chartLineSeries_discount_percent=[],e.chartLineCharts_discount_percent=[],e.chartLineLabels_basket_value=[],e.chartLineSeries_basket_value=[],e.chartLineCharts_basket_value=[],e.chartLineLabels_basket_size=[],e.chartLineSeries_basket_size=[],e.chartLineCharts_basket_size=[],e.chartLineLabels_gross_profit=[],e.chartLineSeries_gross_profit=[],e.chartLineCharts_gross_profit=[]}console.log("reportDashboardController.."),e.isloadingGraphs=!1,e.data2=[],e.sevenDaysPrev=moment().subtract(7,"days").format("YYYY-MM-DD"),e.prevDay=moment().subtract(1,"days").format("YYYY-MM-DD"),e.currDate=moment().format("YYYY-MM-DD");var c=JSON.parse(a.get("user")),u=(new Date).toString().match(/([-\+][0-9]+)\s/)[1];e.statsOfPrevDay={},e.statsOfCurrDay={},String.prototype.insert=function(e,t){return e>0?this.substring(0,e)+t+this.substring(e,this.length):t+this},e.filterBy="day",e.sub_id=c.sub_id,e.dateFrom=e.sevenDaysPrev,e.dateTo=moment().format("YYYY-MM-DD"),e.timezone=u.insert(3,":"),e.arg=1,e.changeOf_revenue_Stat={},e.changeOf_items_sold_Stat={},e.changeOf_customers_Stat={},e.changeOf_discount_Stat={},e.changeOf_discount_percent_Stat={},e.changeOf_basket_value_Stat={},e.changeOf_basket_size_Stat={},e.changeOf_gross_profit_Stat={},e.labels=["Aim Global","Robinsons"],e.series=["Series A"],e.data=[[65,34]],e.__data0={dataset0:[]},e.__options0={margin:{top:30},tooltip:{mode:"scrubber"},series:[{axis:"y",dataset:"dataset0",key:"val_0",label:"A line series",color:"hsla(88, 48%, 48%, 1)",type:["line","dot"],id:"mySeries0"}],axes:{x:{key:"x",type:"date"}}},e.__data1={dataset1:[]},e.__options1={margin:{top:30},tooltip:{mode:"scrubber"},series:[{axis:"y",dataset:"dataset1",key:"val_1",label:"A line series",color:"hsla(88, 48%, 48%, 1)",type:["line","dot"],id:"mySeries1"}],axes:{x:{key:"x",type:"date"}}},e.__data2={dataset2:[]},e.__options2={margin:{top:30},tooltip:{mode:"scrubber"},series:[{axis:"y",dataset:"dataset2",key:"val_2",label:"A line series",color:"hsla(88, 48%, 48%, 1)",type:["line","dot"],id:"mySeries2"}],axes:{x:{key:"x",type:"date"}}},e.__data3={dataset3:[]},e.__options3={margin:{top:30},tooltip:{mode:"scrubber"},series:[{axis:"y",dataset:"dataset3",key:"val_3",label:"A line series",color:"hsla(88, 48%, 48%, 1)",type:["line","dot"],id:"mySeries3"}],axes:{x:{key:"x",type:"date"}}},e.__data4={dataset4:[]},e.__options4={margin:{top:30},tooltip:{mode:"scrubber"},series:[{axis:"y",dataset:"dataset4",key:"val_4",label:"A line series",color:"hsla(88, 48%, 48%, 1)",type:["line","dot"],id:"mySeries4"}],axes:{x:{key:"x",type:"date"}}},e.__data5={dataset5:[]},e.__options5={margin:{top:30},tooltip:{mode:"scrubber"},series:[{axis:"y",dataset:"dataset5",key:"val_5",label:"A line series",color:"hsla(88, 48%, 48%, 1)",type:["line","dot"],id:"mySeries5"}],axes:{x:{key:"x",type:"date"}}},e.__data6={dataset6:[]},e.__options6={margin:{top:30},tooltip:{mode:"scrubber"},series:[{axis:"y",dataset:"dataset6",key:"val_6",label:"A line series",color:"hsla(88, 48%, 48%, 1)",type:["line","dot"],id:"mySeries6"}],axes:{x:{key:"x",type:"date"}}},e.__data7={dataset7:[]},e.__options7={margin:{top:30},tooltip:{mode:"scrubber"},series:[{axis:"y",dataset:"dataset7",key:"val_7",label:"A line series",color:"hsla(88, 48%, 48%, 1)",type:["line","dot"],id:"mySeries7"}],axes:{x:{key:"x",type:"date"}}},e.pickAcolor=function(e){return Math.sign(e)==-1?"red":1==Math.sign(e)?"green":"dark-gray"},e.pickAnArrow=function(e){return Math.sign(e)==-1?"fa fa-arrow-down":1==Math.sign(e)?"fa fa-arrow-up":""},e.getDashboardReports=function(){e.isloadingGraphs=!0,d(),e.paramobj={sub_id:e.sub_id,filterBy:e.filterBy,dateFrom:e.dateFrom,dateTo:e.dateTo,timezone:e.timezone,arg:1},l.getDashboardReport(e.paramobj).then(function(t){e.data1=t.response,e.getOverall_Revenue=e.data1[t.response.length-1].revenue,e.getOverall_Salecount=e.data1[t.response.length-1].items_sold,e.getOverall_Customercount=e.data1[t.response.length-1].customers,e.getOverall_Grossprofit=e.data1[t.response.length-1].gross_profit,e.getOverall_Discount=e.data1[t.response.length-1].discount,e.getOverall_Discountpercent=e.data1[t.response.length-1].discount_percent,e.getOverall_Basketsize=e.data1[t.response.length-1].basket_size,e.getOverall_Basketvalue=e.data1[t.response.length-1].basket_value,_.each(t.response,function(a,s){e.__data0.dataset0.push({x:new Date(a.transaction_date),val_0:a.revenue}),e.__data1.dataset1.push({x:new Date(a.transaction_date),val_1:a.items_sold}),e.__data2.dataset2.push({x:new Date(a.transaction_date),val_2:a.customers}),e.__data3.dataset3.push({x:new Date(a.transaction_date),val_3:a.discount}),e.__data4.dataset4.push({x:new Date(a.transaction_date),val_4:a.discount_percent}),e.__data5.dataset5.push({x:new Date(a.transaction_date),val_5:a.basket_value}),e.__data6.dataset6.push({x:new Date(a.transaction_date),val_6:a.basket_size}),e.__data7.dataset7.push({x:new Date(a.transaction_date),val_7:a.gross_profit}),moment(a.transaction_date).format("YYYY-MM-DD")==e.data1[t.response.length-2].transaction_date&&(a.prev_revenue_Stat=a.revenue,a.prev_items_sold_Stat=a.items_sold,a.prev_customers_Stat=a.customers,a.prev_discount_Stat=a.discount,a.prev_discount_percent_Stat=a.discount_percent,a.prev_basket_value_Stat=a.basket_value,a.prev_basket_size_Stat=a.basket_size,a.prev_gross_profit_Stat=a.gross_profit,e.statsOfPrevDay=a),moment(a.transaction_date).format("YYYY-MM-DD")==e.data1[t.response.length-1].transaction_date&&(a.prev_revenue_Stat=e.statsOfPrevDay.revenue,a.prev_items_sold_Stat=e.statsOfPrevDay.items_sold,a.prev_customers_Stat=e.statsOfPrevDay.customers,a.prev_discount_Stat=e.statsOfPrevDay.discount,a.prev_discount_percent_Stat=e.statsOfPrevDay.discount_percent,a.prev_basket_value_Stat=e.statsOfPrevDay.basket_value,a.prev_basket_size_Stat=e.statsOfPrevDay.basket_size,a.prev_gross_profit_Stat=e.statsOfPrevDay.gross_profit,e.changeOf_revenue_Stat=(a.revenue-a.prev_revenue_Stat)/a.prev_revenue_Stat*100,e.changeOf_items_sold_Stat=(a.items_sold-a.prev_items_sold_Stat)/a.prev_items_sold_Stat*100,e.changeOf_customers_Stat=(a.customers-a.prev_customers_Stat)/a.prev_customers_Stat*100,e.changeOf_discount_Stat=(a.discount-a.prev_discount_Stat)/a.prev_discount_Stat*100,e.changeOf_discount_percent_Stat=(a.discount_percent-a.prev_discount_percent_Stat)/a.prev_discount_percent_Stat*100,e.changeOf_basket_value_Stat=(a.basket_value-a.prev_basket_value_Stat)/a.prev_basket_value_Stat*100,e.changeOf_basket_size_Stat=(a.basket_size-a.prev_basket_size_Stat)/a.prev_basket_size_Stat*100,e.changeOf_gross_profit_Stat=(a.gross_profit-a.prev_gross_profit_Stat)/a.prev_gross_profit_Stat*100)}),e.isloadingGraphs=!1})},e.getDashboardReportsByStore=function(){e.paramobj={sub_id:e.sub_id,filterBy:e.filterBy,dateFrom:e.dateFrom,dateTo:e.dateTo,timezone:e.timezone,arg:2},l.getDashboardReport(e.paramobj).then(function(t){e.data2=t.response,e.getOverall_Revenue_byStore=_.sumBy(e.data2,"revenue"),e.getOverall_Salecount_byStore=_.sumBy(e.data2,"items_sold"),e.getOverall_Customercount_byStore=_.sumBy(e.data2,"customers"),e.getOverall_Grossprofit_byStore=_.sumBy(e.data2,"gross_profit"),e.getOverall_Discount_byStore=_.sumBy(e.data2,"discount"),e.getOverall_Discountpercent_byStore=_.sumBy(e.data2,"discount_percent"),e.getOverall_Basketsize_byStore=_.sumBy(e.data2,"basket_size"),e.getOverall_Basketvalue_byStore=_.sumBy(e.data2,"basket_value"),_.each(e.data2,function(t,a){t.percent_revenue_by_store=t.revenue/e.getOverall_Revenue_byStore*100,t.percent_items_sold_by_store=t.items_sold/e.getOverall_Salecount_byStore*100,t.percent_customers_by_store=t.customers/e.getOverall_Customercount_byStore*100,t.percent_gross_profit_by_store=t.gross_profit/e.getOverall_Grossprofit_byStore*100,t.percent_discount_by_store=t.discount/e.getOverall_Discount_byStore*100,t.percent_discount_percent_by_store=t.discount_percent/e.getOverall_Discountpercent_byStore*100,t.percent_basket_size_by_store=t.basket_size/e.getOverall_Basketsize_byStore*100,t.percent_basket_value_by_store=t.basket_value/e.getOverall_Basketvalue_byStore*100})})},e.setActive=function(t){e.filterBy="",e.filterBy=t,e.getDashboardReports()},e.init=function(){e.getDashboardReports(),e.getDashboardReportsByStore()},e.init()}angular.module("POS17").controller("reportDashboardController",e),e.$inject=["$scope","$timeout","localStorageService","toastr","productFactory","humanFactory","useraccountsFctry","usergroupsFctry","dashboardReportsFctry"]}();

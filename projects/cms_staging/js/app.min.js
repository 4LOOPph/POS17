...
!function(){"use strict";function e(e,t,c,l,s,o){e.audio="audio"==o,e.config={sources:[{src:s.trustAsResourceUrl(l.media_path),type:l.media_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.cancel=function(){c.dismiss("cancel")}}function t(e,t,c,l,s,o){console.log("files: ",s.media_path),e.pdfName=s.media_name,e.pdfUrl=l.trustAsResourceUrl("https://docs.google.com/gview?url="+s.media_path+"&embedded=true"),console.log("$scope.pdfUrl: ",e.pdfUrl),e.cancel=function(){c.dismiss("cancel")}}angular.module("POS17").controller("articleMediaModalCtrl",e).controller("articleDocsModalCtrl",t),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type"],t.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService"]}();
...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(s,e){e.state("main.assets",{url:"/assets/overview",templateUrl:"modules/assets/assets.html"})}])}();

...
!function(){"use strict";angular.module("POS17").run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location",function(e,n,t,r,o,u,i,s){n.currentUser={},n.$state=e,n.previousState,n.currentState,n.$on("loading:progress",function(){n.productIsLoading=!0}),n.$on("loading:finish",function(){n.productIsLoading=!1}),n.$on("unauthorized",function(){r.setCurrentUser(null),r.setUserToken(null),e.go("login")}),n.goBack=function(){o.history.back()},n.$on("$stateChangeStart",function(e,n,t,o,a){if(r.getCurrentUser()){var c=r.getUserToken();u.isTokenExpired(c)&&(i.remove("user"),i.remove("token"),s.path("/login"))}}),n.$on("$stateChangeSuccess",function(e,t,o,u,i){n.previousState=u.name,n.currentState=t.name,n.currentUser=r.getCurrentUser()})}])}();

...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(s,e){e.state("main.assets",{url:"/assets",templateUrl:"modules/assets/assets.html",controller:"assetsController"}).state("main.assets_folder",{url:"/assets/folders/:_id",templateUrl:"modules/assets/assets.html",controller:"assetsController"}).state("main.assets_sub_folder",{url:"/assets/folders/:_id/s/:sub_id",templateUrl:"modules/assets/assets.html",controller:"assetsController"})}])}();
!function(){"use strict";angular.module("POS17").controller("assetsController",["$scope","assetsFctry","$stateParams","$state","$uibModal","localStorageService","AuthFctry","ngDialog","toastr","$timeout","Lightbox",function(e,s,t,o,i,l,a,n,r,d,c){function m(s){200==s.statusCode&&s.response.success&&(e.items=s.response.result,e.assets=angular.copy(s.response.result)),e.isLoading=!1,e.showBread=!0,_.each(e.assets.folders,function(e){e.folder_filesize=_.sumBy(e.files,function(e){return e.asset_filesize}),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.isActive=!1,e.isFolder=!1}),e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted}),e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1)}e.items={},e.assets={},e.trash={},e.starred={},e.selectedFile={},e.isList="null"!=l.get("isList")&&0!=l.get("isList"),e.isLoading=!0,e.showBread=!1,e.showFiles=!1,e.showToolNewFolder=!0,e.showToolMakeCopy=!1,e.showToolPreview=!1,e.changeDisplay=function(){e.isList=!e.isList,l.set("isList",e.isList)},e.refreshAssets=function(){e.assets={},e.items={},t._id&&_.isUndefined(t.sub_id)?(e.isLoading=!0,s.getFolderAssets(t._id).then(m)):t._id&&t.sub_id?(e.showToolNewFolder=!1,e.isLoading=!0,s.getFolderAssets(t.sub_id).then(m)):s.getAllAssets().then(m)},e.showAllFiles=function(){"main.assets"==o.current.name?e.refreshAssets():o.go("main.assets")},e.showAllTrash=function(){e.assets=angular.copy(e.items),e.assets.folders=_.filter(e.assets.folders,function(e){return 1==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 1==e.isDeleted})},e.showAllStarred=function(){e.assets=angular.copy(e.items),e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted&&1==e.isStarred})},e.showAllShared=function(){e.assets={}},e.newUploader=function(){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});s.result.then(function(s){s&&e.refreshAssets()})},e.createNewFolder=function(){var e=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/newfolder.modal.html",size:"sm",controller:"assetsFolderModalCtrl"});e.result.then(function(e){e&&o.reload()})},e.shareToOthers=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/sharer.modal.html",size:"md",controller:"assetsShareModalCtrl"});s.result.then(function(e){e&&o.reload()})}},e.deleteSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))}console.log("selectedFile: ",e.selectedFile),e.modal={title:"Remove?",message:"Are you sure to remove this?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){e.selectedFile&&(e.selectedFile.isFolder?s.trashFolder(e.selectedFile._id).then(t):s.trashAssetFile(e.selectedFile._id).then(t))})},e.previewSelected=function(){e.selectedFile&&e.openFile(e.selectedFile)},e.starredSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?s.starredFolder(e.selectedFile._id).then(t):s.starredAssetFile(e.selectedFile._id).then(t))},e.openLightboxModal=function(e){var s=[];s.push({url:e.asset_url,caption:e.asset_name,thumbUrl:e.asset_url}),c.openModal(s,0)},e.openVideoModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.media.modal.html",controller:"articleMediaModalCtrl",size:"lg",resolve:{files:function(){return e},type:function(){return"video"}}})},e.openAudioModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.media.modal.html",controller:"articleMediaModalCtrl",size:"md",resolve:{files:function(){return e},type:function(){return"audio"}}})},e.openDocsModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.docs.modal.html",controller:"articleDocsModalCtrl",size:"lg",windowClass:"presentation-modal-popup",resolve:{files:function(){return e}}})},e.openFolder=function(e){t._id?o.go("main.assets_sub_folder",{_id:t._id,sub_id:e._id}):o.go("main.assets_folder",{_id:e._id})},e.openFile=function(s){console.log("openFile: ",s),"image/jpeg"==s.asset_mimetype||"image/jpg"==s.asset_mimetype||"image/gif"==s.asset_mimetype||"image/x-ms-bmp"==s.asset_mimetype||"image/png"==s.asset_mimetype?e.openLightboxModal(s):"audio/mp3"==s.asset_mimetype||"audio/mp4"==s.asset_mimetype?e.openAudioModal(s):"video/mp4"==s.asset_mimetype||"video/x-flv"==s.asset_mimetype||"video/x-msvideo"==s.asset_mimetype||"video/x-ms-wmv"==s.asset_mimetype||"video/quicktime"==s.asset_mimetype?e.openVideoModal(s):"application/pdf"==s.asset_mimetype?e.openDocsModal(s):"text/plain"==s.asset_mimetype?e.openDocsModal(s):"application/msword"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.wordprocessingml.document"==s.asset_mimetype?e.openDocsModal(s):"text/csv"==s.asset_mimetype||"application/vnd.ms-excel"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"==s.asset_mimetype?e.openDocsModal(s):"application/vnd.openxmlformats-officedocument.presentationml.presentation"!=s.asset_mimetype&&"application/vnd.ms-powerpoint"!=s.asset_mimetype||e.openDocsModal(s)},e.deleteFile=function(t){e.modal={title:"Remove File",message:"Are you sure to remove the file?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.deleteAssetFile(t._id).then(function(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))})})},e.clearSelection=function(){e.selectedFile={},_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1})},e.activeSelected=function(s){s.isActive=!0,s.isFolder?(e.showToolPreview=!1,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolMakeCopy=!0),e.selectedFile=s,console.log("folder: ",s),_.each(e.assets.folders,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.assets,function(e){e._id!==s._id&&(e.isActive=!1)})}}])}();

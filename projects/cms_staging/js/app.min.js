...
!function(){"use strict";function e(e,s,t,o,r,a,n,i,u,d,c,l,p,g,h,m,f,v){e.ptypes=[],e.attributes=[],e.tags=[],e.tagsArr=[],e.product_image=[],e.details={},e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.tabprod={product:!0,media:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},n.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?(e.ptypes=s.response.result,e.ptypes&&e.ptypes.length>0&&(e.details.ptype_id=e.ptypes[0].ptype_id)):o.error(s.response.msg,"Error")}),c.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:o.error(s.response.msg,"Error")}),_.isEmpty(r.p_id)?(e.showPublish=!1,e.showArchive=!1,e.tabprod={product:!0,media:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1}):a.getProductDetails(r.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.tabprod={product:!0,media:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!1,related:!0},e.product_image=e.details.product_images,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),c.getAllProductTags(r.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)}))}),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.removethumb=function(){e.details.img_default=null},e.upload=function(s){e.isImageNew=!0},e.archiveProduct=function(e){a.archiveProduct(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.publishProduct=function(e){a.publishProduct(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.deleteProductTags=function(e){r.p_id&&c.deleteProductTag(r.p_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void o.success(e.response.msg,"Success"):void o.error(e.response.msg,"Error")})},e.openUploader=function(){var e=h.open({animation:!0,templateUrl:"./modules/products/details/product.upload.modal.html",controller:"productUploaderModalCtrl",size:"lg",resolve:{product_id:function(){return r.p_id}}});e.result.then(function(e){s.reload()})},e.openLightboxModal=function(e){var s=[];s.push({url:e.image_path,thumbUrl:e.image_path}),m.openModal(s,0)},e.copyURLLink=function(e){return f.supported?(console.log("files.media_path: ",e.image_path),void f.copyText(e.image_path)):void o.warning("Sorry, copy to clipboard is not supported","Warning")},e.setAsThumbNail=function(t){console.log("files: ",t),e.modal={title:"Set as product thumbnail",message:"Are you sure to set this image?"},v.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){a.setProductImage(r.p_id,t._id).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.reload()):o.warning(e.response.msg,"Warning")})})},e.addProduct=function(){e.validate=[],console.log("details: ",e.details),async.waterfall([function(s){r.p_id?a.updateProduct(r.p_id,e.details).then(function(t){200==t.statusCode&&t.response.success?(o.success(t.response.msg,"Success"),s(null,r.p_id),console.log("UPDATE")):(e.validate=t.response.result,_.each(e.validate,function(e){o.warning(t.response.msg,"Error - "+e.msg)}))}):a.saveProduct(e.details).then(function(t){200==t.statusCode&&t.response.success?(o.success(t.response.msg,"Success"),s(null,t.response.result),console.log("SUCCESS")):(e.validate=t.response.result,_.each(e.validate,function(e){o.warning(t.response.msg,"Error - "+e.msg)}))})},function(s,t){var r=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(a,n){a.isTag?c.saveTags(a).then(function(e){return 200==e.statusCode&&e.response.success?void c.saveProductTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void n()):void o.error(e.response.msg,"Error")}):void o.error(e.response.msg,"Error")}):c.saveProductTags(s,{tags_id:a.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("insert to product tag"),r++,n(),void 0):void o.error(e.response.msg,"Error")}),r>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,t){s.go(s.current,{p_id:e},{reload:!0})}])}}angular.module("POS17").controller("productsAEController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","tagsFactory","API_URL","API_VERSION","Upload","$uibModal","Lightbox","clipboard","ngDialog"]}();

...
!function(){"use strict";function e(e,t,o,s){e.name="Type",e.status="All",e.pricebooktype=[],e.selectDeselectAll=!1,e.selectedDatas=[],e.example8model=[],e.example8data=[{id:1,label:"Telstra"},{id:2,label:"Proximity"},{id:3,label:"Christmas"},{id:4,label:"Women"}],t.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)});var i=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.pricebooksTable=new o({page:1,count:10},{counts:[10,25,50,100],getData:function(o,i){t.getAllPricebook().then(function(t){if(200==t.statusCode&&t.response.success){var c=t.response.result;e.pricebookscopy=angular.copy(t.response.resul),e.txtSearch&&"All"==e.status?e.pricebooks=s("filter")(c,e.txtSearch):e.txtSearch&&"Published"==e.status&&e.type?(e.pricebooks=s("filter")(c,{isActive:1}),e.pricebooks=s("filter")(c,{pricebook_type_id:e.type.pt_id}),e.pricebooks=s("filter")(c,e.txtSearch)):e.txtSearch&&"Unpublished"==e.status&&e.type?(e.pricebooks=s("filter")(c,e.txtSearch),e.pricebooks=s("filter")(c,{pricebook_type_id:e.type.pt_id}),e.pricebooks=s("filter")(c,{isActive:0})):_.isUndefined(e.txtSearch)&&"All"==e.status&&e.type?e.pricebooks=s("filter")(c,{pricebook_type_id:e.type.pt_id}):_.isUndefined(e.txtSearch)&&"Published"==e.status&&e.type?(e.pricebooks=s("filter")(c,{pricebook_type_id:e.type.pt_id}),e.pricebooks=s("filter")(c,{isActive:1})):_.isUndefined(e.txtSearch)&&"Unpublished"==e.status&&e.type?(e.pricebooks=s("filter")(c,{pricebook_type_id:e.type.pt_id}),e.pricebooks=s("filter")(c,{isActive:0})):e.pricebooks=c,i.total(e.pricebooks.length);var r=e.pricebooks.slice((i.page()-1)*i.count(),i.page()*i.count());e.pricebookLoading=!1,o.resolve(r)}else toastr.error(t.response.msg,"Error"),e.pricebookLoading=!1})}})};i(),e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.pricebooks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pricebook_id!==t.pricebook_id}),e.deleteSomeData=e.selectedDatas.length>0},e.updateStatus=function(t){e.status=t,e.pricebooksTable.reload()},e.updateType=function(t){e.type=t,e.name=t.name,e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter"]}();
!function(){"use strict";function e(e,t,s,o,c,r,a,n,l,i,d){console.log("pricebookDetailController");var g=o.getCurrentUser(),u=JSON.parse(g);e.tagselected=[],e.tags=[],e.tagsArr=[],e.tagschecked=[],e.details={},e.details.isActive=1,e.details.created_by=u.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.item={},e.selectDeselectAll2=!1,e.selectedDatas2=[],s.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)}),i.getAllTags().then(function(t){200==t.statusCode&&t.response.success?e.tagsArr=t.response.result:c.error(t.response.msg,"Error")}),a.pricebook_id&&(e.displayTab=!0,s.getPricebookDetail(a.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result)})),e.toggleSelectedTag=function(t){e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=_.filter(e.tagselected,function(e){return e.tags_id!=t.tags_id}),console.log("$scope.tagselected:",e.tagselected)},e.isOnSelectedTag=function(){return function(t){if(!(e.tagselected.length>0))return!0;var s=!1,o=_.map(e.tagselected,"tags_id");_.forEach(t.tags,function(e){o.indexOf(e.tags_id)!==-1&&(s=!0)});return console.log("tagselectedIDs:",o),s}},e.changeSelectDeselectAll2=function(){e.selectDeselectAll2=!e.selectDeselectAll2,_.each(e.tagsArr,function(t){t.checked=e.selectDeselectAll2,e.checkDataChanges2(t)})},e.checkDataChanges2=function(t){t.checked?_.find(e.tagselected,function(e){return e.tags_id===t.tags_id})||e.tagselected.push(t):e.tagselected=_.filter(e.selectedDatas,function(e){return e.tags_id!==t.tags_id}),console.log("$scope.tagselected:",e.tagselected)},e.savePricebook=function(){a.pricebook_id?s.updatePriceBook(a.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void r.go(r.current,{pricebook_id:a.pricebook_id},{reload:!0})):void c.error(e.response.msg,"Error")}):s.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("data:",e),c.success(e.response.msg,"Success"),r.go(r.current,{pricebook_id:e.response.result},{reload:!0}),void 0):void c.error(e.response.msg,"Error")})}}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams","$filter","ngDialog","tagsFactory","$uibModal"]}();
...
!function(){"use strict";function e(e,t,c,s,o,i,n,a,l){e.selectDeselectAll=!1,e.selectedDatas=[];var r=function(){e.deviceisLoading=!0,e.devices=[],e.devicescopy=[],e.storeTable=new l({page:1,count:10},{counts:[10,25,50,100],getData:function(t,s){n.getDeviceSelected().then(function(i){if(200==i.statusCode&&i.response.success){var n=i.response.result;if(console.log(n),e.devicescopy=angular.copy(e.devices),e.txtSearch){e.devices=c("filter")(n,e.txtSearch),s.total(e.devices.length);var a=e.devices.slice((s.page()-1)*s.count(),s.page()*s.count());t.resolve(a)}else{e.devices=n,s.total(e.devices.length);var a=e.devices.slice((s.page()-1)*s.count(),s.page()*s.count());t.resolve(a)}e.deviceisLoading=!1}else e.deviceisLoading=!1,o.error(i.response.msg,"Error")})}})};r()}angular.module("POS17").controller("deviceController",e),e.$inject=["$scope","$http","$filter","$state","toastr","ngDialog","deviceFactory","$timeout","ngTableParams"]}();
...
!function(){"use strict";function e(e,t,n){return{getAllDevice:function(){return e.all("devices").customGET().then(function(e){return e},function(e){return e.data})},getDeviceSelected:function(){return e.all("devicesselected").customGET().then(function(e){return console.log(e),e},function(e){return e.data})},getUnSelectedDevice:function(){return e.all("devicesnotselected").customGET().then(function(e){return e},function(e){return e.data})},assigndevice:function(t){return e.all("assigndevice").customPOST(t).then(function(e){return e},function(e){return e.data})}}}angular.module("POS17").factory("deviceFactory",e),e.$inject=["Restangular","API_URL","toastr"]}();

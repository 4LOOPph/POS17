...
!function(){"use strict";angular.module("POS17").config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","$uibTooltipProvider","API_URL","API_VERSION","$provide","localStorageServiceProvider","uiSelectConfig","LightboxProvider","$authProvider","FACEBOOK_API","GOOGLE_API","TWITTER_API","LINKEDIN_API",function(e,r,i,t,o,l,a,n,c,d,u,s,p,P,h,m,I){i.html5Mode(!1),r.otherwise("/login"),u.resetSearchInput=!0,e.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),t.interceptors.push("httpInterceptor"),t.interceptors.push("authInterceptor"),c.value("baseURL",a),o.setBaseUrl(a+n),p.facebook({clientId:P,url:a+"/auth/facebook",redirectUri:window.location.origin+"/",requiredUrlParams:["display","scope"],scope:["email"],scopeDelimiter:",",oauthType:"2.0"}),p.google({clientId:h,url:a+"/auth/google",redirectUri:window.location.origin,requiredUrlParams:["scope"],scope:["profile","email"],scopePrefix:"openid",scopeDelimiter:" ",oauthType:"2.0"}),p.linkedin({clientId:I,url:a+"/auth/linkedin",redirectUri:window.location.origin,requiredUrlParams:["state"],scope:["r_emailaddress"],scopeDelimiter:" ",oauthType:"2.0",state:"STATE"}),p.twitter({clientId:m,url:a+"/auth/twitter",redirectUri:window.location.origin+"/",oauthType:"1.0"}),s.fullScreenMode=!0}])}();
...
!function(){"use strict";function e(e,s,o,r,t,i,n,c,a,u,l,d,p,g,m,f,b){console.log("pricebookDetailController");var h=r.getCurrentUser(),k=JSON.parse(h);e.tagselected=[],e.tags=[],e.tagsArr=[],e.tagschecked=[],e.customergroups=[],e.storesArr=[],e.details={},e.details.isActive=1,e.details.published=!1,e.details.stores=[],e.details.customergroups=[],e.details.created_by=k.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.uniquePricebookName=!1,e.item={},e.selectDeselectAll2=!1,e.selectedDatas2=[];var h=JSON.parse(d.get("user"));n.pricebook_id?p.logTransaction("View Pricebook Details","PRICEBOOKS",n.pricebook_id,"User:="+h.username+" View pricebook details: ="+n.pricebook_id):p.logTransaction("Add New Pricebook","PRICEBOOKS","N/A","User:="+h.username+" Add new pricebook entry"),o.getPricebookType().then(function(s){e.pricebooktype=[],200==s.statusCode&&s.response.success&&(e.pricebooktype=s.response.result)}),u.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:t.error(s.response.msg,"Error")}),m.getCustomerGroup().then(function(s){200==s.statusCode&&s.response.success?e.customergroups=s.response.result:t.error(s.response.msg,"Error")}),b.getAllStore().then(function(s){200==s.statusCode&&s.response.success?e.storesArr=s.response.result:t.error(s.response.msg,"Error")}),async.waterfall([function(e){m.getAllPerson().then(function(s){if(200==s.statusCode&&s.response.success){var o=s.response.result,r=_.filter(o,function(e){if("Customer"==e.person_type&&0==e.isSubscriber)return e});e(null,r)}else t.error(s.response.msg,"Error")})},function(e,s){f.getAllCompany().then(function(o){if(200==o.statusCode&&o.response.success){var r=o.response.result;s(null,e,r)}else t.error(o.response.msg,"Error")})},function(s,o,r){var t=[];s&&s.length>0&&_.each(s,function(e){t.push({_id:e._id,email:e.email,id:e.person_id,type:"customer",name:e.displayName,pricebook_id:n.pricebook_id})}),o&&o.length>0&&_.each(o,function(e){t.push({_id:e._id,email:e.email,id:e.company_id,type:"company",name:e.name,pricebook_id:n.pricebook_id})}),e.customersData=t}]),n.pricebook_id&&(e.displayTab=!0,o.getPricebookDetail(n.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.details.published=1==e.details.isActive,e.details.customergroups=e.details.customergroup,u.getAllPricebookTags(n.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)}))})),e.validatePricebookName=function(s){s&&o.validatePricebookName({name:s,pricebook_id:n.pricebook_id}).then(function(s){return 200!=s.statusCode||s.response.success?void(e.uniquePricebookName=!1):(e.uniquePricebookName=!0,void t.warning(s.response.msg,"Warning"))})},e.tagTransform=function(e){return console.log(e),{tags:e}},e.clearInput=function(e){e.search=""},e.changeSelectDeselectAll2=function(){e.selectDeselectAll2=!e.selectDeselectAll2,_.each(e.tagsArr,function(s){s.checked=e.selectDeselectAll2,e.checkDataChanges2(s)})},e.checkDataChanges2=function(s){s.checked?_.find(e.tagselected,function(e){return e.tags_id===s.tags_id})||e.tagselected.push(s):e.tagselected=_.filter(e.selectedDatas,function(e){return e.tags_id!==s.tags_id})},e.deleteProductTags=function(e){n.pricebook_id&&u.deleteArticleTag(n.pricebook_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void t.success(e.response.msg,"Success"):void t.error(e.response.msg,"Error")})},e.savePricebook=function(){e.details.isActive=1==e.details.published?1:0,e.details.customergroup=[],_.each(e.details.customergroups,function(s){e.details.customergroup.push({customer_group_id:s.cg_id})});var s=[];_.each(e.details.customers,function(e){s.push({customer_id:e.id,type:e.type})}),e.details.customers=s;var r=[];_.each(e.details.stores,function(e){r.push({store_id:e.store_id})}),e.details.stores=r,async.waterfall([function(s){n.pricebook_id?o.updatePriceBook(n.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(t.success(e.response.msg,"Success"),void s(null,n.pricebook_id)):void t.error(e.response.msg,"Error")}):o.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(t.success(e.response.msg,"Success"),void s(null,e.response.result)):void t.error(e.response.msg,"Error")})},function(s,o){var r=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(i,n){i.isTag?u.saveTags(i).then(function(e){return 200==e.statusCode&&e.response.success?void u.savePricebookTags(s,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void n()):void t.error(e.response.msg,"Error")}):void t.error(e.response.msg,"Error")}):u.savePricebookTags(s,{tag_id:i.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void n()):void t.error(e.response.msg,"Error")}),r>=e.details.tags.length&&o(null,s)}):o(null,s)},function(e,s){g(function(){i.go(i.current,{pricebook_id:e},{reload:!0})},300)}])}}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams","$filter","ngDialog","tagsFactory","$uibModal","localStorageService","transLogFctry","$timeout","humanFactory","companyFactory","storeFactory"]}();
...
!function(){"use strict";function e(e,o,t,s,r,c,i,n,u,l,a){function d(o){if(_.isEmpty(o))return void s.error("Please set values for Selling Price, Margin and Discount","Error");if(!(e.selectedDatas.length>0))return void s.error("Please select items to map","Error");if(c.pricebook_id){var i=1;async.eachSeries(e.selectedDatas,function(n,u){console.log("$scope.row: ",n);var l={markup:o.margin||0,discount:o.discount||0,sell_price:o.sell_price||0,bundle_id:n.bundle_id,product_id:n.product_id,min_quantity:o.min_quantity||0,max_quantity:o.max_quantity||0};console.log("reqData: ",l),n.pi_id?t.updatePriceBookItem(c.pricebook_id,n.pi_id,l).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),i++,u(),void 0):void s.error(e.response.msg,"Error")}):t.savePriceBookItem(c.pricebook_id,l).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),i++,u(),void 0):void s.error(e.response.msg,"Error")}),i==e.selectedDatas.length&&r.reload()})}}console.log("pricebookProductCtrl"),e.products=[],e.productscopy=[],e.bundles=[],e.bundlescopy=[],e.pricebookItems=[],e.pricebookItemsCopy=[],e.selectedDatas=[],e.selectDeselectAllProduct=!1,e.txtProductSearch="",e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0},l.getAllTags().then(function(o){if(200==o.statusCode&&o.response.success){var t=o.response.result;_.each(t,function(o){e.tagsArr.push({id:o.tags_id,label:o.tags,_id:o._id})})}else s.error(o.response.msg,"Error")}),c.pricebook_id&&t.getAllPriceBookItem(c.pricebook_id).then(function(o){200==o.statusCode&&o.response.success&&(e.pricebookItems=o.response.result,_.each(e.pricebookItems,function(e){e.popoverIsOpen=!1}),e.pricebookItemsCopy=angular.copy(e.pricebookItems))}),e.selectEvents={onItemSelect:function(o){console.log("property: ",o),e.searchProductData()},onItemDeselect:function(o){console.log("property: ",o),e.searchProductData()}},e.tagTransform=function(e){return{tags:e}},e.showTooltip1=function(o){_.each(e.pricebookItems,function(e){o.pi_id!==e.pi_id&&(e.popoverIsOpen=!1)});var t=_.find(e.pricebookItems,{pi_id:o.pi_id});t&&(t.popoverIsOpen?t.popoverIsOpen=!1:t.popoverIsOpen=!0)},e.applyItemPrice=function(e){console.log("dataL ",e),_.isEmpty(e)||c.pricebook_id&&t.updatePriceBookItemPrice(c.pricebook_id,e.pi_id,{sell_price:e.sell_price}).then(function(o){return 200==o.statusCode&&o.response.success?(s.success(o.response.msg,"Success"),void(e.popoverIsOpen=!1)):void s.error(o.response.msg,"Error")})},e.searchProductData=function(){if(e.txtProductSearch&&_.isEmpty(e.tagsFilter))console.log("1");else if(_.isEmpty(e.txtProductSearch)&&e.tagsFilter){var o=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(t){_.each(e.pricebookItemsCopy,function(e){var s=_.find(e.product_tags,{tags_id:t.id});s&&o.push(e)})}),e.pricebookItems=o}else if(e.txtProductSearch&&e.tagsFilter){var o=[],t=i("filter")(e.pricebookItemsCopy,e.txtProductSearch);e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(t,function(t){var s=_.find(t.product_tags,{tags_id:e.id});s&&o.push(t)})}),e.pricebookItems=o}else e.refreshData()},e.changeSelectDeselectAllProduct=function(){console.log("changeSelectDeselectAllProduct"),_.each(e.pricebookItems,function(o){o.selected=e.selectDeselectAllProduct,e.checkDataChanges(o)})},e.clickselect=function(){console.log("sadasdsadsa")},e.checkDataChanges=function(o){o.selected?_.find(e.selectedDatas,function(e){return e.pi_id===o.pi_id})||e.selectedDatas.push(o):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pi_id!==o.pi_id})},e.refreshData=function(){console.log("refreshData"),e.pricebookItems=[],t.getAllPriceBookItem(c.pricebook_id).then(function(o){200==o.statusCode&&o.response.success&&(e.pricebookItems=o.response.result,e.pricebookItemsCopy=angular.copy(e.pricebookItems))})},e.addNewEntry=function(){var e=u.open({animation:!0,templateUrl:"./modules/pricebook/pricebook.product.modal.html",controller:"pricebookProductModalCtrl",size:"md"});e.result.then(function(e){r.reload()})},e.deleteSelected=function(){e.modal={title:"Remove Items on Pricebook?",message:"Are you sure to remove pricebook for this selected product?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){if(!(e.selectedDatas.length>0))return void s.error("Please select products to map","Error");if(c.pricebook_id){var o=1;async.eachSeries(e.selectedDatas,function(i,n){i.pi_id&&t.deletePriceBookItem(c.pricebook_id,i.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),o++,n(),void 0):void s.error(e.response.msg,"Error")}),o==e.selectedDatas.length&&r.reload()})}})},e.deleteSelectedItem=function(o){e.modal={title:"Remove Pricebook Item?",message:"Are you sure to remove this item?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){c.pricebook_id&&t.deletePriceBookItem(c.pricebook_id,o.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void r.reload()):void s.error(e.response.msg,"Error")})})},e.savePricebookItems=function(o){e.modal={title:"Apply batch update",message:"Are you sure to apply this change on the selected product?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){d(o)})}}function o(e,o,t,s,r,c,i){e.pb_product={},e.pricebookProducts=[],e.pricebookProductBundles=[],e.radioModel="product",e.infiniteScrollContacts={},e.infiniteScrollContacts.numToAdd=10,e.infiniteScrollContacts.currentItems=10,async.waterfall([function(o){s.getAllProduct().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(o){o.selected=!1,1==o.is_published&&e.pricebookProducts.push(o)}),_.uniqBy(e.pricebookProducts,function(e){return e.p_id}),o(null,s)}})},function(o,t){s.getAllProductBundle().then(function(o){if(200==o.statusCode&&o.response.success){var t=o.response.result;_.each(t,function(o){o.selected=!1,1==o.is_published&&e.pricebookProductBundles.push(o)}),_.uniqBy(e.pricebookProductBundles,function(e){return e.pb_id})}})}]),e.resetInfScroll=function(){e.infiniteScrollContacts.currentItems=e.infiniteScrollContacts.numToAdd},e.addMoreItems=function(){e.infiniteScrollContacts.currentItems+=e.infiniteScrollContacts.numToAdd},e.changeData=function(o){e.radioModel=o},e.saveEntry=function(){"product"==e.radioModel?(e.pb_product.product_id=e.pb_product.product.p_id,e.pb_product.bundle_id=null):(e.pb_product.bundle_id=e.pb_product.productgroup.pb_id,e.pb_product.product_id=null),i.savePriceBookItem(c.pricebook_id,{markup:e.pb_product.markup,discount:e.pb_product.discount,sell_price:e.pb_product.sell_price,min_quantity:e.pb_product.min_quantity,max_quantity:e.pb_product.max_quantity,bundle_id:e.pb_product.bundle_id,product_id:e.pb_product.product_id}).then(function(e){if(200==e.statusCode&&e.response.success)t.success(e.response.msg,"Success"),r(function(){o.close()},100);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void t.error(e.response.msg,"Error");_.each(e.response.result,function(e){t.warning(e.msg,"Warning")})}})},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("pricebookProductCtrl",e).controller("pricebookProductModalCtrl",o),e.$inject=["$scope","productFactory","pricebookFactory","toastr","$state","$stateParams","$filter","ngDialog","$uibModal","tagsFactory","$timeout"],o.$inject=["$scope","$uibModalInstance","toastr","productFactory","$timeout","$stateParams","pricebookFactory"]}();

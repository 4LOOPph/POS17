...
!function(){"use strict";function e(e,t,s,r,o,c,i,a,d,n,l,u,p){function f(){a.getAllCategory().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){var r=t.label,o=t.name,c=t.description,i=t.parent_id,a=t.c_id,d=_.filter(s,{parent_id:a.toString()});_.isNull(i)&&e.categoryData.push({parentid:i,description:c,label:r,name:o,c_id:a,item:{parentid:i,description:c,label:r,name:o,c_id:a},items:d})}),e.categoryDataCopy=angular.copy(e.categoryData)}})}e.search={},e.currentNode={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.isList=!1,e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.categories=[],e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.selectedArchivedDatas=[],e.categoryData=[],e.categoryDataCopy=[],e.productsToFilter=[];e.side=!1;var h=JSON.parse(l.get("user"));u.logTransaction("View Products","PRODUCTS","ALL","User:="+h.username+" View ALL List of products");var g=function(){e.productTable=new d({page:1,count:20},{counts:[20,45,60,100],getData:function(t,r){e.productIsLoading=!0,e.products=[],e.productscopy=[],i.getAllProduct().then(function(o){if(200==o.statusCode&&o.response.success){var i=o.response.result;if(e.totalItems=i.length,e.productscopy=angular.copy(o.response.result),e.txtSearch&&"All"==e.applicationStatus&&e.currentNode)console.log("1"),e.products=s("filter")(i,e.txtSearch);else if(e.txtSearch&&"Publish"==e.applicationStatus&&e.currentNode)console.log("2"),e.products=s("filter")(i,{is_published:1}),e.products=s("filter")(e.products,e.txtSearch);else if(e.txtSearch&&"Archived"==e.applicationStatus&&e.currentNode)console.log("3"),e.products=s("filter")(i,{is_archived:1}),e.products=s("filter")(e.products,e.txtSearch);else if(e.txtSearch&&"Draft"==e.applicationStatus&&e.currentNode)console.log("4"),e.products=s("filter")(i,{is_published:0}),e.products=s("filter")(e.products,e.txtSearch);else if(_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus)_.isEmpty(e.currentNode)?e.products=i:_.each(e.productsToFilter,function(t){var s=_.find(i,{p_id:t.p_id});s&&e.products.push(s)});else if(_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus)if(console.log("6"),_.isEmpty(e.currentNode))e.products=s("filter")(i,{is_published:1});else{var a=s("filter")(i,{is_published:1});_.each(e.productsToFilter,function(t){var s=_.find(a,{p_id:t.p_id});s&&e.products.push(s)})}else if(_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus)if(console.log("7"),_.isEmpty(e.currentNode))e.products=s("filter")(i,{is_archived:1});else{var a=s("filter")(i,{is_archived:1});_.each(e.productsToFilter,function(t){var s=_.find(a,{p_id:t.p_id});s&&e.products.push(s)})}else if(_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus)if(console.log("8"),_.isEmpty(e.currentNode))e.products=s("filter")(i,{is_published:0});else{var a=s("filter")(i,{is_published:0});_.each(e.productsToFilter,function(t){var s=_.find(a,{p_id:t.p_id});s&&e.products.push(s)})}else e.products=i;r.total(e.products.length);var d=e.products.slice((r.page()-1)*r.count(),r.page()*r.count());t.resolve(d),e.productIsLoading=!1}else e.productIsLoading=!1,c.error(o.response.msg,"Error")})}})};e.changeDisplay=function(){e.isList=!e.isList},e.filterByCategory=function(t){var s=[],r={},o={},c=[];if(e.currentNode=t,e.currentNode&&angular.isObject(e.currentNode)){var i=_.find(e.categoryDataCopy,{parentid:t.c_id});if(_.isUndefined(i)){var a=_.map(e.productscopy,function(t){var s=_.filter(t.product_category,{category_id:e.currentNode.c_id});if(s.length>0)return _.find(s,function(e){return e})});o=_.filter(a,function(e){if(!_.isUndefined(e))return e}),r=_.map(_.uniqBy(o,"product_id"),function(e){return e.product_id}),_.forEach(r,function(t){s.push(_.find(e.productscopy,{p_id:t}))})}else{var d=_.map(i.items,function(e){return{c_id:e.item.c_id}});_.each(e.productscopy,function(e){_.each(d,function(t){var s=_.filter(e.product_category,{category_id:t.c_id});s&&s.length>0&&c.push(s[0])})});var n=_.map(_.uniqBy(c,"product_id"),function(e){return e.product_id});_.forEach(n,function(t){s.push(_.find(e.productscopy,{p_id:t}))})}}e.productsToFilter=s,e.productTable.reload()},f(),g(),a.getAllCategory().then(function(t){200==t.statusCode&&t.response.success&&(e.categories=t.response.result)}),e.setPage=function(t){e.currentPage=t},e.setItemsPerPage=function(t){e.itemsPerPage=t,e.currentPage=1},e.edit=function(e){r.go("main.products-add",{p_id:e})},e.searchData=function(){e.productTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productTable.reload()},e.updateStatus=function(t){e.applicationStatus=t,e.productTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.products,function(t){t.selected=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){console.log("product:",t),t.selected?_.find(e.selectedDatas,{p_id:t.p_id})||(e.selectedDatas.push(t),1==t.is_published&&0==t.is_archived&&e.selectedPublishedDatas.push(t),0==t.is_published&&0==t.is_archived&&e.selectedDraftedDatas.push(t),1==t.is_archived&&0==t.is_published&&e.selectedArchivedDatas.push(t)):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.p_id!==t.p_id}),e.selectedPublishedDatas=_.filter(e.selectedPublishedDatas,function(e){return e.p_id!==t.p_id}),e.selectedDraftedDatas=_.filter(e.selectedDraftedDatas,function(e){return e.p_id!==t.p_id}),e.selectedArchivedDatas=_.filter(e.selectedArchivedDatas,function(e){return e.p_id!==t.p_id})),console.log("$scope.selectedDatas:",e.selectedDatas),e.deleteSomeData=e.selectedDatas.length>0},e.updateHistory=function(e){p.open({animation:!0,backdrop:"static",templateUrl:"./modules/products/product.auditlog.modal.html",controller:"productAuditLogModalCtrl",size:"md",resolve:{product_id:function(){return e}}})},e.toggleModal=function(t){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){i.archiveProduct(t).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void r.reload()):void c.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){e.modal={title:"Archive Product?",message:"Are you sure to archive this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1,s=e.selectedDraftedDatas.concat(e.selectedPublishedDatas);s.length>0&&async.eachSeries(e.selectedPublishedDatas,function(e,o){e.selected&&i.archiveProduct(e.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,o(),void 0):void c.error(e.response.msg,"Error")}),t==s.length&&r.reload()})})},e.draftSelected=function(){e.modal={title:"Draft Product?",message:"Are you sure to Draft this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;e.selectedDatas.length>0&&async.eachSeries(e.selectedDatas,function(s,o){s.selected&&i.draftProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,o(),void 0):void c.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&r.reload()})})},e.publishSelected=function(t){e.modal={title:"Publish Product?",message:"Are you sure to Publish this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1,s=e.selectedDraftedDatas.concat(e.selectedArchivedDatas);s.length>0&&async.eachSeries(s,function(e,o){e.selected&&i.publishProduct(e.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,o(),void 0):void c.error(e.response.msg,"Error")}),t==s.length&&r.reload()})})}}angular.module("POS17").controller("productsController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","categoryFactory","ngTableParams","ngDialog","localStorageService","transLogFctry","$uibModal"]}();
!function(){"use strict";function t(t,e,a,i,o){function n(t){var e=new Date(t),a=6e4*(new Date).getTimezoneOffset(),i=new Date(e.getTime()+a),o=i.getHours(),n=i.getMinutes(),s=o>=12?"pm":"am";o%=12,o=o?o:12,n=n<10?"0"+n:n;var g=o+":"+n+" "+s;return i.getMonth()+1+"/"+i.getDate()+"/"+i.getFullYear()+"  "+g}t.pageNumber=1,t.limitWithPage=10,t.totalPages=0,t.auditlogs=[],t.generateActivityLogs=function(e){i.getProductAuditLog(e,{startWith:t.pageNumber-1,limit:t.limitWithPage}).then(function(e){200==e.statusCode&&e.response.success&&(t.auditlogs=e.response.result,_.each(t.auditlogs,function(t){t.log_date=n(t.log_date)}),t.totalPages=e.response.pagination.pages)})},o&&t.generateActivityLogs(o),t.addMoreItems=function(){t.pageNumber<t.totalPages&&(t.pageNumber=t.pageNumber+1),article_id&&t.generateActivityLogs(article_id)},t.filterDate=function(){},t.cancel=function(){a.dismiss("cancel")}}angular.module("POS17").controller("productAuditLogModalCtrl",t),t.$inject=["$scope","$state","$uibModalInstance","productFactory","product_id"]}();
!function(){"use strict";function e(e,t,s,l,a,c,n,d,r,i,o,u,p){e.search={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.selectedArchivedDatas=[],e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0;var h=JSON.parse(u.get("user"));o.logTransaction("View Product Bundles","PRODUCT BUNDLES","ALL","User:="+h.username+" View ALL List of product bundles");var f=function(){e.productIsLoading=!0,e.bundles=[],e.bundlecopy=[],e.productBundleTable=new i({page:1,count:10},{counts:[10,25,50,100],getData:function(t,l){n.getAllProductBundle().then(function(a){if(200==a.statusCode&&a.response.success){var n=a.response.result;_.each(n,function(e){e.date_created=moment(e.date_created).format("YYYY-MM-DD")}),e.bundlecopy=angular.copy(n),e.txtSearch&&"All"==e.applicationStatus?e.bundles=s("filter")(n,e.txtSearch):e.txtSearch&&"Publish"==e.applicationStatus?(e.bundles=s("filter")(n,{is_published:1}),e.bundles=s("filter")(e.bundles,e.txtSearch)):e.txtSearch&&"Archived"==e.applicationStatus?(e.bundles=s("filter")(n,{is_archived:1}),e.bundles=s("filter")(e.bundles,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus?(e.bundles=s("filter")(n,{is_published:0}),e.bundles=s("filter")(e.bundles,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.bundles=n:_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus?e.bundles=s("filter")(n,{is_published:1}):_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus?e.bundles=s("filter")(n,{is_archived:1}):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?e.bundles=s("filter")(n,{is_published:0}):e.bundles=n,l.total(e.bundles.length);var d=e.bundles.slice((l.page()-1)*l.count(),l.page()*l.count());t.resolve(d),e.productIsLoading=!1}else e.productIsLoading=!1,c.error(a.response.msg,"Error")})}})};e.edit=function(e){l.go("main.products-add",{p_id:e})},e.searchData=function(){e.productBundleTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productBundleTable.reload()},e.updateStatus=function(t){console.log("status: ",t),e.applicationStatus=t,e.productBundleTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.bundles,function(t){t.selected=e.selectDeselectAll,e.selectSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){console.log(t),t.selected?_.find(e.selectedDatas,{pb_id:t.pb_id})||(e.selectedDatas.push(t),1==t.is_published&&0==t.is_archived&&e.selectedPublishedDatas.push(t),0==t.is_published&&0==t.is_archived&&e.selectedDraftedDatas.push(t),1==t.is_archived&&0==t.is_published&&e.selectedArchivedDatas.push(t)):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pb_id!==t.pb_id}),e.selectedPublishedDatas=_.filter(e.selectedPublishedDatas,function(e){return e.pb_id!==product.pb_id}),e.selectedDraftedDatas=_.filter(e.selectedDraftedDatas,function(e){return e.pb_id!==product.pb_id}),e.selectedArchivedDatas=_.filter(e.selectedArchivedDatas,function(e){return e.pb_id!==product.pb_id})),e.deleteSomeData=e.selectedDatas.length>0},e.updateHistory=function(e){p.open({animation:!0,backdrop:"static",templateUrl:"./modules/products/bundles/bundle.auditlog.modal.html",controller:"productBundleAuditLogModalCtrl",size:"md",resolve:{pb_id:function(){return e}}})},e.toggleModal=function(t){r.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){n.archiveBundle(t).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void l.reload()):void c.error(e.response.msg,"Error")})})},e.archiveSelected=function(){r.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1,s=e.selectedDraftedDatas.concat(e.selectedPublishedDatas);return s.length>0?void async.each(s,function(e,a){e.selected&&n.archiveBundle(e.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,a(),void 0):void c.error(e.response.msg,"Error")}),t==s.length&&l.reload()}):void c.warning("Unable to Archive selected Bundle..Selected bundle are either archived","Warning")})},e.draftSelected=function(){e.modal={title:"Draft Product?",message:"Are you sure to Draft this selected bundle?"},r.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;e.selectedDatas.length>0&&async.eachSeries(e.selectedDatas,function(s,a){s.selected&&n.draftBundle(s.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,a(),void 0):void c.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&l.reload()})})},e.publishSelected=function(t){e.modal={title:"Publish Product?",message:"Are you sure to Publish this selected bundle?"},r.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1,s=e.selectedDraftedDatas.concat(e.selectedArchivedDatas);s.length>0&&async.eachSeries(s,function(e,a){e.selected&&n.publishBundle(e.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,a(),void 0):void c.error(e.response.msg,"Error")}),t==s.length&&l.reload()})})},f()}angular.module("POS17").controller("productBundlesController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","supplierFctry","ngDialog","ngTableParams","transLogFctry","localStorageService","$uibModal"]}();
...
!function(){"use strict";function e(e,t,a,n,i){function o(e){var t=new Date(e),a=6e4*(new Date).getTimezoneOffset(),n=new Date(t.getTime()+a),i=n.getHours(),o=n.getMinutes(),s=i>=12?"pm":"am";i%=12,i=i?i:12,o=o<10?"0"+o:o;var u=i+":"+o+" "+s;return n.getMonth()+1+"/"+n.getDate()+"/"+n.getFullYear()+"  "+u}e.pageNumber=1,e.limitWithPage=10,e.totalPages=0,e.auditlogs=[],e.generateActivityLogs=function(t){n.getProductBundleAuditLog(t,{startWith:e.pageNumber-1,limit:e.limitWithPage}).then(function(t){200==t.statusCode&&t.response.success&&(e.auditlogs=t.response.result,_.each(e.auditlogs,function(e){e.log_date=o(e.log_date)}),e.totalPages=t.response.pagination.pages)})},i&&e.generateActivityLogs(i),e.addMoreItems=function(){e.pageNumber<e.totalPages&&(e.pageNumber=e.pageNumber+1),i&&e.generateActivityLogs(i)},e.filterDate=function(){},e.cancel=function(){a.dismiss("cancel")}}angular.module("POS17").controller("productBundleAuditLogModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","productFactory","pb_id"]}();
...
!function(){"use strict";function e(e,t,a,s,l,i,c,r,o,n,d,u){e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[];var f=JSON.parse(d.get("user"));n.logTransaction("View Articles","ARTICLES","ALL","User:="+f.username+" View all list of articles");var h=function(){e.articleisLoading=!0,e.articles=[],e.articleTable=new r({page:1,count:10},{counts:[10,25,50,100],getData:function(t,l){c.getArticle().then(function(i){if(200==i.statusCode&&i.response.success){var c=i.response.result;e.txtSearch&&"All"==e.applicationStatus?e.articles=a("filter")(c,e.txtSearch):e.txtSearch&&"Published"==e.applicationStatus?(e.articles=a("filter")(c,{is_active:1}),e.articles=a("filter")(e.articles,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus?(e.articles=a("filter")(c,{is_active:0}),e.articles=a("filter")(e.articles,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.articles=c:_.isUndefined(e.txtSearch)&&"Published"==e.applicationStatus?e.articles=a("filter")(c,{is_active:1}):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?e.articles=a("filter")(c,{is_active:0}):e.articles=c,l.total(e.articles.length);var r=e.articles.slice((l.page()-1)*l.count(),l.page()*l.count());t.resolve(r),e.articleisLoading=!1}else s.error(i.response.msg,"Error"),e.articleisLoading=!1})}})};e.refresh=function(){e.articleisLoading=!0,e.articleTable.reload()},e.edit=function(e){t.go("main.articles-detail",{article_id:e})},e.updateStatus=function(t){e.applicationStatus=t,e.articleTable.reload()},e.searchData=function(){e.articleTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.articles,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.article_id===t.article_id})||(e.selectedDatas.push(t),1==t.is_active&&e.selectedPublishedDatas.push(t),0==t.is_active&&e.selectedDraftedDatas.push(t)):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.article_id!==t.article_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(a){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){c.deleteArticle(a).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void t.reload()):void s.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.updateHistory=function(e){u.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/audit.log.modal.html",controller:"articleAuditLogModalCtrl",size:"md",resolve:{article_id:function(){return e}}})},e.deleteSelected=function(){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=0;async.each(e.selectedDatas,function(l,i){l.selected&&c.deleteArticle(l.article_id).then(function(l){return 200==l.statusCode&&l.response.success?(s.success(l.response.msg,"Success"),++a,a==e.selectedDatas.length&&t.reload(),i(),void 0):void s.error(l.response.msg,"Error")})})})},e.draftSelected=function(){e.modal={title:"Draft Article?",message:"Are you sure to Draft this selected article?"},o.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=1;return e.selectedPublishedDatas.length>0?void async.eachSeries(e.selectedPublishedDatas,function(l,i){l.selected&&1==l.is_active&&c.draftArticle(l.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),a++,i(),void 0):void s.error(e.response.msg,"Error")}),console.log("dataCountToDelete: ",a),a==e.selectedPublishedDatas.length&&t.reload()}):void s.warning("Unable to Draft selected Articles..Selected articles are either archived or already drafted","Warning")})},e.publishSelected=function(a){e.modal={title:"Publish Article?",message:"Are you sure to Publish this selected article?"},o.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=1;return e.selectedDraftedDatas.length>0?void async.eachSeries(e.selectedDraftedDatas,function(l,i){l.selected&&0==l.is_active&&c.publishArticle(l.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),a++,i(),void 0):void s.error(e.response.msg,"Error")}),console.log("dataCountToDelete: ",a),a==e.selectedDraftedDatas.length&&t.reload()}):void s.warning("Unable to Publish selected Articles..Selected articles are either archived or already published","Warning")})},h()}angular.module("POS17").controller("articleController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","articleFctry","ngTableParams","ngDialog","transLogFctry","localStorageService","$uibModal"]}();
...
!function(){"use strict";function e(e,t,a,i,n){function o(e){var t=new Date(e),a=6e4*(new Date).getTimezoneOffset(),i=new Date(t.getTime()+a),n=i.getHours(),o=i.getMinutes(),s=n>=12?"pm":"am";n%=12,n=n?n:12,o=o<10?"0"+o:o;var g=n+":"+o+" "+s;return i.getMonth()+1+"/"+i.getDate()+"/"+i.getFullYear()+"  "+g}e.pageNumber=1,e.limitWithPage=10,e.totalPages=0,e.auditlogs=[],e.generateActivityLogs=function(t){i.getArticleAuditLog(t,{startWith:e.pageNumber-1,limit:e.limitWithPage}).then(function(t){200==t.statusCode&&t.response.success&&(e.auditlogs=t.response.result,_.each(e.auditlogs,function(e){e.log_date=o(e.log_date)}),e.totalPages=t.response.pagination.pages)})},n&&e.generateActivityLogs(n),e.addMoreItems=function(){e.pageNumber<e.totalPages&&(e.pageNumber=e.pageNumber+1),n&&e.generateActivityLogs(n)},e.filterDate=function(){},e.cancel=function(){a.dismiss("cancel")}}angular.module("POS17").controller("articleAuditLogModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","articleFctry","article_id"]}();
...
!function(){"use strict";function e(e,t,s,o,i,l,r,a,c,p,n){e.name="-Type-",e.status="All",e.txtSearch="",e.type={},e.selectDeselectAll=!1,e.selectedDatas=[],e.selectedToPublish=[],e.pricebooktype=[],e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0};var u=r.getCurrentUser(),d=JSON.parse(u);c.logTransaction("View Pricebooks","PRICEBOOKS","ALL","User:="+d.username+" View all list of pricebooks"),t.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)}),p.getAllTags().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){e.tagsArr.push({id:t.tags_id,label:t.tags,_id:t._id})})}else l.error(t.response.msg,"Error")});var g=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.name="-Type-",e.status="All",e.txtSearch="",e.type={},e.pricebooksTable=new s({page:1,count:10},{counts:[10,25,50,100],getData:function(s,i){t.getAllPricebook().then(function(t){if(200==t.statusCode&&t.response.success){var r=t.response.result;if(e.pricebookscopy=angular.copy(t.response.result),e.txtSearch&&"All"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("1"),e.pricebooks=o("filter")(r,e.txtSearch);else if(e.txtSearch&&"Published"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter)){console.log("2");var a=o("filter")(r,e.txtSearch);e.pricebooks=_.reject(a,{date_approved:null})}else if(e.txtSearch&&"Unpublished"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter)){console.log("3");var a=o("filter")(r,e.txtSearch);e.pricebooks=_.filter(a,{date_approved:null})}else if(e.txtSearch&&"All"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("4");var a=o("filter")(r,e.txtSearch);e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Published"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("5");var a=o("filter")(r,e.txtSearch),c=_.reject(a,{date_approved:null});e.pricebooks=_.filter(c,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Unpublished"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("6");var a=o("filter")(r,e.txtSearch),c=_.filter(a,{date_approved:null});e.pricebooks=_.filter(c,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"All"==e.status&&e.type&&e.tagsFilter){console.log("7");var a=o("filter")(r,e.txtSearch),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("8"),e.pricebooks=r;else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("9"),e.pricebooks=_.reject(r,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("10"),e.pricebooks=_.filter(r,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&e.type&&_.isEmpty(e.tagsFilter))console.log("11"),e.pricebooks=_.filter(r,{pricebook_type_id:e.type.pt_id});else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("12");var a=_.reject(r,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("13");var a=_.filter(r,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("14");var n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(r,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("15");var a=_.reject(r,{date_approved:null}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("16");var a=_.filter(r,{date_approved:null}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&e.type&&e.tagsFilter){console.log("17");var a=_.filter(r,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&e.type&&e.tagsFilter){console.log("18");var a=_.reject(r,{date_approved:null}),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&e.type&&e.tagsFilter){console.log("19");var a=_.filter(r,{date_approved:null}),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else console.log("else"),e.pricebooks=r;i.total(e.pricebooks.length);var u=e.pricebooks.slice((i.page()-1)*i.count(),i.page()*i.count());e.pricebookLoading=!1,s.resolve(u)}else l.error(t.response.msg,"Error"),e.pricebookLoading=!1})}})};g(),e.selectEvents={onItemSelect:function(t){e.pricebooksTable.reload()},onItemDeselect:function(t){e.pricebooksTable.reload()}},e.refresh=function(){g()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.pricebooks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?(_.find(e.selectedDatas,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedDatas.push(t),_.isNull(t.date_approved)&&(_.find(e.selectedToPublish,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedToPublish.push(t))):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pricebook_id!==t.pricebook_id}),e.selectedToPublish=_.filter(e.selectedToPublish,function(e){return e.pricebook_id!==t.pricebook_id})),e.deleteSomeData=e.selectedDatas.length>0,e.pusblishSomeData=e.selectedToPublish.length>0},e.updateStatus=function(t){console.log("updateStatus"),e.status=t,e.pricebooksTable.reload()},e.updateType=function(t){"-Type-"!==t?(e.type=t,e.name=t.name):(e.name="-Type-",e.type={}),e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()},e.copyDuplicatePricebook=function(s){e.modal={title:"Copy/Duplicate Pricebook?",message:"Are you sure to Copy/Duplicate Pricebook?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.pricebook_id&&t.duplicatePriceBook(s.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),void $timeout(function(){$state.reload()},1e3)):void l.error(e.response.msg,"Error")})})},e.publishSelectedItem=function(s){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebook?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){t.approvedPriceBook(s.pricebook_id,{approved_by:d.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),void $timeout(function(){$state.reload()},1e3)):void l.error(e.response.msg,"Error")})})},e.publishSelected=function(){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebooks?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("$scope.selectedDatas: ",e.selectedDatas);var s=1;async.eachSeries(e.selectedDatas,function(o,i){o.selected&&t.approvedPriceBook(o.pricebook_id,{approved_by:d.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),s++,i(),void 0):void l.error(e.response.msg,"Error")}),s==e.selectedDatas.length&&$timeout(function(){$state.reload()},1e3)})})},e.deleteSelected=function(){e.modal={title:"Delete Pricebook?",message:"Are you sure to Delete this selected pricebooks?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=1;async.eachSeries(e.selectedDatas,function(o,i){o.selected&&t.deletePriceBook(o.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),s++,i(),void 0):void l.error(e.response.msg,"Error")}),s==e.selectedDatas.length&&$timeout(function(){$state.reload()},1e3)})})},e.updateHistory=function(e){n.open({animation:!0,backdrop:"static",templateUrl:"./modules/pricebook/pricebook.auditlog.modal.html",controller:"pricebookAuditLogModalCtrl",size:"md",resolve:{pricebook_id:function(){return e}}})}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter","ngDialog","toastr","AuthFctry","localStorageService","transLogFctry","tagsFactory","$uibModal"]}();
!function(){"use strict";function e(e,s,o,r,t,n,c,i,a,u,l,d,p,g,f,m){console.log("pricebookDetailController");var h=r.getCurrentUser(),b=JSON.parse(h);e.tagselected=[],e.tags=[],e.tagsArr=[],e.tagschecked=[],e.customergroups=[],e.details={},e.details.isActive=1,e.details.created_by=b.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.item={},e.selectDeselectAll2=!1,e.selectedDatas2=[];var h=JSON.parse(d.get("user"));c.pricebook_id?p.logTransaction("View Pricebook Details","PRICEBOOKS",c.pricebook_id,"User:="+h.username+" View pricebook details: ="+c.pricebook_id):p.logTransaction("Add New Pricebook","PRICEBOOKS","N/A","User:="+h.username+" Add new pricebook entry"),o.getPricebookType().then(function(s){e.pricebooktype=[],200==s.statusCode&&s.response.success&&(e.pricebooktype=s.response.result)}),u.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:t.error(s.response.msg,"Error")}),f.getCustomerGroup().then(function(s){200==s.statusCode&&s.response.success?e.customergroups=s.response.result:(e.personisLoading=!1,t.error(s.response.msg,"Error"))}),async.waterfall([function(e){f.getAllPerson().then(function(s){if(200==s.statusCode&&s.response.success){var o=s.response.result,r=_.filter(o,function(e){if("Customer"==e.person_type&&0==e.isSubscriber)return e});e(null,r)}else t.error(s.response.msg,"Error")})},function(e,s){m.getAllCompany().then(function(o){if(200==o.statusCode&&o.response.success){var r=o.response.result;s(null,e,r)}else t.error(o.response.msg,"Error")})},function(s,o,r){console.log("customers: ",s),console.log("companies: ",o);var t=[];s&&s.length>0&&_.each(s,function(e){t.push({_id:e._id,email:e.email,id:e.person_id,type:"customer",name:e.displayName})}),o&&o.length>0&&_.each(o,function(e){t.push({_id:e._id,email:e.email,id:e.company_id,type:"company",name:e.name})}),e.customersData=t}]),c.pricebook_id&&(e.displayTab=!0,o.getPricebookDetail(c.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,u.getAllPricebookTags(c.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)}))})),e.tagTransform=function(e){return console.log(e),{tags:e}},e.clearInput=function(e){e.search=""},e.changeSelectDeselectAll2=function(){e.selectDeselectAll2=!e.selectDeselectAll2,_.each(e.tagsArr,function(s){s.checked=e.selectDeselectAll2,e.checkDataChanges2(s)})},e.checkDataChanges2=function(s){s.checked?_.find(e.tagselected,function(e){return e.tags_id===s.tags_id})||e.tagselected.push(s):e.tagselected=_.filter(e.selectedDatas,function(e){return e.tags_id!==s.tags_id})},e.deleteProductTags=function(e){c.pricebook_id&&u.deleteArticleTag(c.pricebook_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void t.success(e.response.msg,"Success"):void t.error(e.response.msg,"Error")})},e.savePricebook=function(){async.waterfall([function(s){c.pricebook_id?o.updatePriceBook(c.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(t.success(e.response.msg,"Success"),void s(null,c.pricebook_id)):void t.error(e.response.msg,"Error")}):o.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(t.success(e.response.msg,"Success"),void s(null,e.response.result)):void t.error(e.response.msg,"Error")})},function(s,o){var r=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(n,c){n.isTag?u.saveTags(n).then(function(e){return 200==e.statusCode&&e.response.success?void u.savePricebookTags(s,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void c()):void t.error(e.response.msg,"Error")}):void t.error(e.response.msg,"Error")}):u.savePricebookTags(s,{tag_id:n.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void c()):void t.error(e.response.msg,"Error")}),r>=e.details.tags.length&&o(null,s)}):o(null,s)},function(e,s){g(function(){n.go(n.current,{pricebook_id:e},{reload:!0})},300)}])}}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams","$filter","ngDialog","tagsFactory","$uibModal","localStorageService","transLogFctry","$timeout","humanFactory","companyFactory"]}();
...
!function(){"use strict";function e(e,t,o,s,r,c,n,i,l,u){function a(t){if(_.isEmpty(t))return void s.error("Please set values for Selling Price, Margin and Discount","Error");if(!(e.selectedDatas.length>0))return void s.error("Please select items to map","Error");if(c.pricebook_id){var n=1;async.eachSeries(e.selectedDatas,function(i,l){console.log("$scope.row: ",i);var u={markup:t.margin||0,discount:t.discount||0,sell_price:t.sell_price||0,bundle_id:i.bundle_id,product_id:i.product_id,min_quantity:t.min_quantity||0,max_quantity:t.max_quantity||0};console.log("reqData: ",u),i.pi_id?o.updatePriceBookItem(c.pricebook_id,i.pi_id,u).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),n++,l(),void 0):void s.error(e.response.msg,"Error")}):o.savePriceBookItem(c.pricebook_id,u).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),n++,l(),void 0):void s.error(e.response.msg,"Error")}),n==e.selectedDatas.length&&r.reload()})}}e.products=[],e.productscopy=[],e.bundles=[],e.bundlescopy=[],e.pricebookItems=[],e.pricebookItemsCopy=[],e.selectedDatas=[],e.selectDeselectAllProduct=!1,e.txtProductSearch="",e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0},u.getAllTags().then(function(t){if(200==t.statusCode&&t.response.success){var o=t.response.result;_.each(o,function(t){e.tagsArr.push({id:t.tags_id,label:t.tags,_id:t._id})})}else s.error(t.response.msg,"Error")}),c.pricebook_id&&o.getAllPriceBookItem(c.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.pricebookItems=t.response.result,e.pricebookItemsCopy=angular.copy(e.pricebookItems))}),e.selectEvents={onItemSelect:function(t){console.log("property: ",t),e.searchProductData()},onItemDeselect:function(t){console.log("property: ",t),e.searchProductData()}},e.tagTransform=function(e){return{tags:e}},e.searchProductData=function(){if(e.txtProductSearch&&_.isEmpty(e.tagsFilter))console.log("1");else if(_.isEmpty(e.txtProductSearch)&&e.tagsFilter){console.log("2");var t=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(o){_.each(e.pricebookItemsCopy,function(e){console.log("row2: ",e.product_tags);var s=_.find(e.product_tags,{tags_id:o.id});s&&t.push(e)})}),e.pricebookItems=t}else if(e.txtProductSearch&&e.tagsFilter){console.log("3");var t=[],o=n("filter")(e.pricebookItemsCopy,e.txtProductSearch);e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(o,function(o){console.log("row2: ",o.product_tags);var s=_.find(o.product_tags,{tags_id:e.id});s&&t.push(o)})}),e.pricebookItems=t}else e.refreshData()},e.changeSelectDeselectAllProduct=function(){console.log("changeSelectDeselectAllProduct"),_.each(e.pricebookItems,function(t){t.selected=e.selectDeselectAllProduct,e.checkDataChanges(t)})},e.clickselect=function(){console.log("sadasdsadsa")},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.pi_id===t.pi_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pi_id!==t.pi_id})},e.refreshData=function(){console.log("refreshData"),e.pricebookItems=[],o.getAllPriceBookItem(c.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.pricebookItems=t.response.result,e.pricebookItemsCopy=angular.copy(e.pricebookItems))})},e.addNewEntry=function(){var e=l.open({animation:!0,templateUrl:"./modules/pricebook/pricebook.product.modal.html",controller:"pricebookProductModalCtrl",size:"md"});e.result.then(function(e){r.reload()})},e.deleteSelected=function(){e.modal={title:"Remove Items on Pricebook?",message:"Are you sure to remove pricebook for this selected product?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){if(!(e.selectedDatas.length>0))return void s.error("Please select products to map","Error");if(c.pricebook_id){var t=1;async.eachSeries(e.selectedDatas,function(n,i){n.pi_id&&o.deletePriceBookItem(c.pricebook_id,n.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),t++,i(),void 0):void s.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&r.reload()})}})},e.deleteSelectedItem=function(t){e.modal={title:"Remove Pricebook Item?",message:"Are you sure to remove this item?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){c.pricebook_id&&o.deletePriceBookItem(c.pricebook_id,t.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void r.reload()):void s.error(e.response.msg,"Error")})})},e.savePricebookItems=function(t){e.modal={title:"Apply batch update",message:"Are you sure to apply this change on the selected product?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){a(t)})}}function t(e,t,o,s,r,c,n){e.pb_product={},e.pricebookProducts=[],e.pricebookProductBundles=[],e.radioModel="product",e.infiniteScrollContacts={},e.infiniteScrollContacts.numToAdd=10,e.infiniteScrollContacts.currentItems=10,async.waterfall([function(t){s.getAllProduct().then(function(o){if(200==o.statusCode&&o.response.success){var s=o.response.result;_.each(s,function(t){t.selected=!1,1==t.is_published&&e.pricebookProducts.push(t)}),_.uniqBy(e.pricebookProducts,function(e){return e.p_id}),t(null,s)}})},function(t,o){s.getAllProductBundle().then(function(t){if(200==t.statusCode&&t.response.success){var o=t.response.result;_.each(o,function(t){t.selected=!1,1==t.is_published&&e.pricebookProductBundles.push(t)}),_.uniqBy(e.pricebookProductBundles,function(e){return e.pb_id})}})}]),e.resetInfScroll=function(){e.infiniteScrollContacts.currentItems=e.infiniteScrollContacts.numToAdd},e.addMoreItems=function(){e.infiniteScrollContacts.currentItems+=e.infiniteScrollContacts.numToAdd},e.changeData=function(t){e.radioModel=t},e.saveEntry=function(){"product"==e.radioModel?(e.pb_product.product_id=e.pb_product.product.p_id,e.pb_product.bundle_id=null):(e.pb_product.bundle_id=e.pb_product.productgroup.pb_id,e.pb_product.product_id=null),n.savePriceBookItem(c.pricebook_id,{markup:e.pb_product.markup,discount:e.pb_product.discount,sell_price:e.pb_product.sell_price,min_quantity:e.pb_product.min_quantity,max_quantity:e.pb_product.max_quantity,bundle_id:e.pb_product.bundle_id,product_id:e.pb_product.product_id}).then(function(e){if(200==e.statusCode&&e.response.success)o.success(e.response.msg,"Success"),r(function(){t.close()},100);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void o.error(e.response.msg,"Error");_.each(e.response.result,function(e){o.warning(e.msg,"Warning")})}})},e.cancel=function(){t.dismiss("cancel")}}angular.module("POS17").controller("pricebookProductCtrl",e).controller("pricebookProductModalCtrl",t),e.$inject=["$scope","productFactory","pricebookFactory","toastr","$state","$stateParams","$filter","ngDialog","$uibModal","tagsFactory"],t.$inject=["$scope","$uibModalInstance","toastr","productFactory","$timeout","$stateParams","pricebookFactory"]}();
!function(){"use strict";function e(e,t,a,o,i){function n(e){var t=new Date(e),a=6e4*(new Date).getTimezoneOffset(),o=new Date(t.getTime()+a),i=o.getHours(),n=o.getMinutes(),s=i>=12?"pm":"am";i%=12,i=i?i:12,n=n<10?"0"+n:n;var g=i+":"+n+" "+s;return o.getMonth()+1+"/"+o.getDate()+"/"+o.getFullYear()+"  "+g}e.pageNumber=1,e.limitWithPage=10,e.totalPages=0,e.auditlogs=[],e.generateActivityLogs=function(t){o.getPricebookAuditLog(t,{startWith:e.pageNumber-1,limit:e.limitWithPage}).then(function(t){200==t.statusCode&&t.response.success&&(e.auditlogs=t.response.result,_.each(e.auditlogs,function(e){e.log_date=n(e.log_date)}),e.totalPages=t.response.pagination.pages)})},i&&e.generateActivityLogs(i),e.addMoreItems=function(){e.pageNumber<e.totalPages&&(e.pageNumber=e.pageNumber+1),i&&e.generateActivityLogs(i)},e.filterDate=function(){},e.cancel=function(){a.dismiss("cancel")}}angular.module("POS17").controller("pricebookAuditLogModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","pricebookFactory","pricebook_id"]}();

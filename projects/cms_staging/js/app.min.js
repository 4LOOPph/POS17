...
!function(){"use strict";function e(e,s,t,o,n,r,l,a,c,i){e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.selectedDatas=[];var p=function(){e.personisLoading=!0,e.persons=[],e.personscopy=[],e.personsTable=new i({page:1,count:10},{counts:[10,25,50,100],getData:function(s,t){l.getAllPerson().then(function(n){if(200==n.statusCode&&n.response.success){var r=n.response.result;e.personscopy=angular.copy(e.persons),_.each(r,function(e){if(_.isNull(e.date_end))e.isActiveAcnt=!0;else{var s=new Date(e.date_start),t=new Date(e.date_end);t>=s?e.isActiveAcnt=!0:e.isActiveAcnt=!1}}),e.txtSearch&&"All"==e.applicationStatus?e.persons=o("filter")(r,e.txtSearch):e.txtSearch&&"Employee"==e.applicationStatus?(e.persons=o("filter")(r,{per_type_id:1}),e.persons=o("filter")(e.persons,e.txtSearch)):e.txtSearch&&"Customer"==e.applicationStatus?(e.persons=o("filter")(r,{per_type_id:2}),e.persons=o("filter")(e.persons,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.persons=r:_.isUndefined(e.txtSearch)&&"Employee"==e.applicationStatus?e.persons=o("filter")(r,{per_type_id:1}):_.isUndefined(e.txtSearch)&&"Customer"==e.applicationStatus?e.persons=o("filter")(r,{per_type_id:2}):e.persons=r,e.persons=_.filter(e.persons,function(e){return"Customer"==e.person_type&&0==e.isSubscriber?e:void 0}),console.log("persons: ",e.persons),t.total(e.persons.length);var l=e.persons.slice((t.page()-1)*t.count(),t.page()*t.count());s.resolve(l),e.personisLoading=!1}else e.personisLoading=!1,a.error(n.response.msg,"Error")})}})};p(),e.refresh=function(){e.personsTable.reload()},e.updateStatus=function(s){e.applicationStatus=s,e.personsTable.reload()},e.searchData=function(){e.personsTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.persons,function(s){s.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(s)})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.person_id===s.person_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.person_id!==s.person_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(s){r.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){l.deletePersonel(s).then(function(e){return 200==e.statusCode&&e.response.success?(a.success(e.response.msg,"Success"),void n.reload()):void a.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){r.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=0;async.each(e.selectedDatas,function(t,o){t.selected&&(console.log("person: ",t),l.deletePersonel(t.person_id).then(function(t){return console.log("data: ",t.response),200==t.statusCode&&t.response.success?(a.success(t.response.msg,"Success"),++s,s==e.selectedDatas.length&&n.reload(),o(),void 0):void a.error(t.response.msg,"Error")}))})})}}angular.module("POS17").controller("customerController",e),e.$inject=["$scope","$rootScope","$http","$filter","$state","ngDialog","humanFactory","toastr","$timeout","ngTableParams"]}();
...
!function(){"use strict";angular.module("POS17").controller("assetsController",["$scope","assetsFctry","$stateParams","$state","$uibModal","localStorageService","AuthFctry","ngDialog","toastr","$timeout","Lightbox",function(e,s,t,o,i,l,a,r,n,d,c){function m(e,s){if(0==e)return"0 Byte";var t=1024,o=s+1||3,i=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],l=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,l)).toFixed(o))+" "+i[l]}function u(e,s){if(0==e)return"0 Byte";var t=1024,o=s+1||3,i=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,i)).toFixed(o))}function f(s){200==s.statusCode&&s.response.success&&(e.items=s.response.result,e.assets=angular.copy(s.response.result)),e.isLoading=!1,e.showBread=!0,e.disableToolNewFolder=!1,"main.assets"==o.current.name?(e.activeAllFiles=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted})):"main.starred"==o.current.name?(e.activeStarredFiles=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted&&1==e.isStarred})):"main.shared-with-me"==o.current.name?(e.activeSharedFiles=!0,e.assets={},e.items={}):"main.trash"==o.current.name&&(e.activeTrashFiles=!0,e.showBarDelete=!0,e.showBarRestore=!0,e.showBarShare=!1,e.showToolPreview=!1,e.showBarMore=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 1==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 1==e.isDeleted})),_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=m(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=m(e.asset_filesize),e.isActive=!1,e.isFolder=!1});var t=_.sumBy(e.assets.assets,function(e){return e.asset_filesize});e.filesize=u(t),e.assets.folders&&e.assets.assets&&(e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1))}e.items={},e.assets={},e.trash={},e.starred={},e.selectedFile={},e.filesize=0,e.fileSize_t=0,e.fileRemain=0,e.isList="null"!=l.get("isList")&&0!=l.get("isList"),e.isLoading=!0,e.showBread=!1,e.showFiles=!1,e.disableToolNewFolder=!0,e.showToolNewFolder=!0,e.showToolMakeCopy=!1,e.showToolPreview=!1,e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.activeAllFiles=!1,e.activeSharedFiles=!1,e.activeStarredFiles=!1,e.activeTrashFiles=!1,e.changeDisplay=function(){e.isList=!e.isList,l.set("isList",e.isList)},e.refreshAssets=function(){e.assets={},e.items={},t._id&&_.isUndefined(t.sub_id)?(e.isLoading=!0,s.getFolderAssets(t._id).then(f)):t._id&&t.sub_id?(e.showToolNewFolder=!1,e.isLoading=!0,s.getFolderAssets(t.sub_id).then(f)):s.getAllAssets().then(f)},e.showAllFiles=function(){"main.assets"==o.current.name?e.refreshAssets():o.go("main.assets")},e.showAllTrash=function(){"main.trash"==o.current.name?e.refreshAssets():o.go("main.trash")},e.showAllStarred=function(){"main.starred"==o.current.name?e.refreshAssets():o.go("main.starred")},e.showAllShared=function(){"main.shared-with-me"==o.current.name?e.refreshAssets():o.go("main.shared-with-me")},e.newUploader=function(){if(e.fileRemain=2048-e.filesize,!(e.fileRemain>0))return void n.error("WARNING: Storage full, unable to create file uploads.","Error");var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});s.result.then(function(s){s&&e.refreshAssets()})},e.createNewFolder=function(){var e=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/newfolder.modal.html",size:"sm",controller:"assetsFolderModalCtrl"});e.result.then(function(e){e&&o.reload()})},e.shareToOthers=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/sharer.modal.html",size:"md",controller:"assetsShareModalCtrl"});s.result.then(function(e){e&&o.reload()})}},e.renameSelected=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.rename.html",size:"md",controller:"assetsRenameModalCtrl"});s.result.then(function(e){e&&o.reload()})}},e.showInfoSelected=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.info.html",size:"md",controller:"assetsInfoModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&o.reload()})}},e.deleteSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.modal={title:"Remove?",message:"Are you sure to remove this?"},r.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("selectedFile: ",e.selectedFile),_.isEmpty(e.selectedFile)||(e.selectedFile.isFolder?e.selectedFile.isDeleted?s.deleteFolder(e.selectedFile._id).then(t):s.trashFolder(e.selectedFile._id).then(t):e.selectedFile.isDeleted?s.deleteAssetFile(e.selectedFile._id).then(t):s.trashAssetFile(e.selectedFile._id).then(t))})},e.moveSelected=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.move.html",size:"sm",controller:"assetsMoveModalCtrl",resolve:{asset_file:function(){return e.items}}});s.result.then(function(e){e&&o.reload()})}},e.previewSelected=function(){e.selectedFile&&e.openFile(e.selectedFile)},e.starredSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?s.starredFolder(e.selectedFile._id).then(t):s.starredAssetFile(e.selectedFile._id).then(t))},e.restoreSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?s.restoreFolder(e.selectedFile._id).then(t):s.restoreAssetFile(e.selectedFile._id).then(t))},e.openLightboxModal=function(e){console.log("openLightboxModal: ",e);var s=[];s.push({url:e.asset_url,caption:e.asset_name,thumbUrl:e.asset_url}),console.log("arry: ",s),c.openModal(s,0)},e.openVideoModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.media.html",controller:"assetsMediaModalCtrl",size:"lg",resolve:{files:function(){return e},type:function(){return"video"}}})},e.openAudioModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.media.html",controller:"assetsMediaModalCtrl",size:"md",resolve:{files:function(){return e},type:function(){return"audio"}}})},e.openDocsModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.docs.html",controller:"assetsDocsModalCtrl",size:"lg",windowClass:"modal-fullscreen",resolve:{files:function(){return e}}})},e.openFolder=function(i){i.isFolder&&("main.trash"!==o.current.name?t._id?o.go("main.assets_sub_folder",{_id:t._id,sub_id:i._id}):o.go("main.assets_folder",{_id:i._id}):(e.modal={title:"This folder is in your trash",message:"To view this folder, youll need to restore it from your trash. Restore folder?"},r.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.restoreFolder(i._id).then(function(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),d(function(){o.reload()},200))})})))},e.openFile=function(s){console.log("openFile: ",s),"image/jpeg"==s.asset_mimetype||"image/jpg"==s.asset_mimetype||"image/gif"==s.asset_mimetype||"image/x-ms-bmp"==s.asset_mimetype||"image/png"==s.asset_mimetype?e.openLightboxModal(s):"audio/mp3"==s.asset_mimetype||"audio/mp4"==s.asset_mimetype?e.openAudioModal(s):"video/mp4"==s.asset_mimetype||"video/x-flv"==s.asset_mimetype||"video/x-msvideo"==s.asset_mimetype||"video/x-ms-wmv"==s.asset_mimetype||"video/quicktime"==s.asset_mimetype||"video/3gpp"==s.asset_mimetype?e.openVideoModal(s):"application/pdf"==s.asset_mimetype?e.openDocsModal(s):"text/plain"==s.asset_mimetype?e.openDocsModal(s):"application/msword"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.wordprocessingml.document"==s.asset_mimetype?e.openDocsModal(s):"text/csv"==s.asset_mimetype||"application/vnd.ms-excel"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"==s.asset_mimetype?e.openDocsModal(s):"application/vnd.openxmlformats-officedocument.presentationml.presentation"==s.asset_mimetype||"application/vnd.ms-powerpoint"==s.asset_mimetype?e.openDocsModal(s):n.warning("No available tools to open","Failed")},e.deleteFile=function(t){console.log("media: ",t),e.modal={title:"Remove File",message:"Are you sure to remove the file?"},r.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.deleteAssetFile(t._id).then(function(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),d(function(){o.reload()},200))})})},e.clearSelection=function(){console.log("clearSelection"),e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1})},e.activeSelected=function(s){console.log("folder:",s),s.isActive=!0,e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,s.isFolder?(e.showToolPreview=!1,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolMakeCopy=!0),e.selectedFile=s,_.each(e.assets.folders,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.assets,function(e){e._id!==s._id&&(e.isActive=!1)})}}])}();
...
!function(){"use strict";function e(e,s,t,o,r,c){e.folder={},e.create=function(){o._id&&(e.folder.parent_id=o._id),c.createFolder(e.folder).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),t(function(){s.close(e.response.result)},300)):r.error(e.response.msg,"Error")})},e.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("assetsFolderModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry"]}();
...
!function(){"use strict";function e(e,s,t,l,o,c){e.audio="audio"==c,e.config={sources:[{src:o.trustAsResourceUrl(l.asset_url),type:l.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.cancel=function(){t.dismiss("cancel")}}function s(e,s,t,l,o,c){console.log("files: ",o.asset_url),e.pdfName=o.media_name,"application/pdf"==o.asset_mimetype?e.pdfUrl=l.trustAsResourceUrl("https://docs.google.com/gview?url="+o.asset_url+"&embedded=true"):"text/plain"==o.asset_mimetype?e.pdfUrl=l.trustAsResourceUrl("https://docs.google.com/gview?url="+o.asset_url+"&embedded=true"):e.pdfUrl=l.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+o.asset_url),console.log("$scope.pdfUrl: ",e.pdfUrl),e.cancel=function(){t.dismiss("cancel")}}angular.module("POS17").controller("assetsMediaModalCtrl",e).controller("assetsDocsModalCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type"],s.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService"]}();
!function(){"use strict";function t(t,s,a,e,n,c){t.sharer={},t.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("assetsRenameModalCtrl",t),t.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry"]}();
!function(){"use strict";function t(t,e,s){function a(t,e){if(0==t)return"0 Byte";var s=1024,a=e+1||3,o=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],c=Math.floor(Math.log(t)/Math.log(s));return r=parseFloat((t/Math.pow(s,c)).toFixed(a)),parseFloat((t/Math.pow(s,c)).toFixed(a))+" "+o[c]}t.items={},t.chart={},t.chart.labels=["Used","Free"],t.chart.data=[0,0],t.chart.colors=["#e74c3c","#bdc3c7"],t.filesize=0;var r=0,o=0;s.getAllAssets().then(function(e){if(200==e.statusCode&&e.response.success){t.items=e.response.result;var s=_.sumBy(t.items.assets,function(t){return t.asset_filesize});t.filesize=a(s),o=2048-r,t.chart.data=[r,o]}})}angular.module("POS17").controller("assetsStorageCtrl",t),t.$inject=["$scope","$timeout","assetsFctry"]}();
...
!function(){"use strict";function e(e,a,c,t,l,n){e.files={},e.files=n,e.treedata=[],_.each(e.files.folders,function(a){var c={label:a.folder_name,id:a._id,children:[]};_.each(a.sub_folders,function(e){c.children.push({label:e.folder_name,id:e._id})}),e.treedata.push(c)}),e.$watch("abc.currentNode",function(a,c){e.abc&&angular.isObject(e.abc.currentNode)&&(console.log("Node Selected!!"),console.log(e.abc.currentNode))},!1),e.cancel=function(){a.dismiss("cancel")}}angular.module("POS17").controller("assetsMoveModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","asset_file"]}();

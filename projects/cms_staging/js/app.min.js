...
!function(){"use strict";function e(e,r,s,t,a,o,n,c){e.puchaseorders=[];var l=JSON.parse(t.get("user"));a.logTransaction("View Purchase Orders","PURCHASE ORDER","ALL","User:="+l.username+" View all list of Inventory - Purchase Order"),e.datenow=moment(new Date).format("MMM Do YYYY, h:mm:ss a"),e.updatePurchaseOrder=function(e,r){console.log("id",e),console.log("data",r)},e.parseDate=function(e){if(e)return moment(new Date(e)).format("MMM Do YYYY, h:mm:ss a")},e.toggleModal=function(s){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.deletePurchaseOrder(s).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void o.reload()):(console.log("data.response;",e),void n.error(e.response.msg,"Error"))})},function(e){console.log("Modal promise close: ")})};var i=function(){e.puchaseordersisLoading=!0,e.puchaseorders=[],e.paginate={offset:0,limit:10},e.puchaseordersTable=new s({page:1,count:10},{counts:[10,25,50,100],getData:function(s,t){r.getAllPurchaseOrder(e.paginate).then(function(r){if(200==r.statusCode&&r.response.success){var a=r.response.result;e.txtSearch&&"All"==e.applicationStatus?e.puchaseorders=$filter("filter")(a,e.txtSearch):e.txtSearch&&"Published"==e.applicationStatus?(e.puchaseorders=$filter("filter")(a,{status:1}),e.puchaseorders=$filter("filter")(e.puchaseorders,e.txtSearch)):e.txtSearch&&"Unpublished"==e.applicationStatus?(e.puchaseorders=$filter("filter")(a,{status:0}),e.puchaseorders=$filter("filter")(e.puchaseorders,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.puchaseorders=a:_.isUndefined(e.txtSearch)&&"Published"==e.applicationStatus?e.puchaseorders=$filter("filter")(a,{status:1}):_.isUndefined(e.txtSearch)&&"Unpublished"==e.applicationStatus?e.puchaseorders=$filter("filter")(a,{status:0}):e.puchaseorders=a,t.total(e.puchaseorders.length);var o=e.puchaseorders.slice((t.page()-1)*t.count(),t.page()*t.count());s.resolve(o),e.puchaseordersisLoading=!1}else n.error(r.response.msg,"Error")})}})};i()}angular.module("POS17").controller("purchaseOrderController",e),e.$inject=["$scope","purchaseOrderFactory","ngTableParams","localStorageService","transLogFctry","$state","toastr","ngDialog"]}();
!function(){"use strict";function e(e,s,t,o,n,r,i,a,l,u,d,c,p,f,m,g,h){function v(s){if(s)return _.find(e.suppliers,function(e){return e.s_id==s})}function M(){e.items.quantity=null,e.items.price=null,e.items.total=null}e.isColl=!1,e.radioModel="product",e.products=[],e.productBundles=[],e.items={},e.suppliers=[],e.customers=[],e.stores=[],e.details={},e.details.products_list=[],e.details.details=[];var P=!1,y=5e3;e.showMessage=!1,e.showsecondMessage=!1,e.showExportMessage=!1,e.enAbleToSendForm,e.profile={},e.datenow=h(new Date).format("MMMM Do YYYY, h:mm:ss a"),e.doGreeting=function(){P&&a.cancel(P),e.showMessage=!0,P=a(function(){e.showMessage=!1,e.showsecondMessage=!0,P=a(function(){e.showsecondMessage=!1},2e3)},y)},e.doExport=function(){P&&a.cancel(P),e.showExportMessage=!0,P=a(function(){e.showExportMessage=!1,e.showsecondExportMessage=!0,P=a(function(){e.showsecondExportMessage=!1},2e3)},y)},e.changeData=function(s){e.radioModel=s},e.getoveralltotal=function(s){e.overalltotal=_.sumBy(s,function(e){return e.price*e.quantity})},e.getGeneratedPOId=function(){f.generatepoid().then(function(s){e.details.po_number=s.response.result})},e.loadpo=function(){f.getAllPurchaseOrderDetail(r.selected_id).then(function(s){s&&200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.details.emailsubject="PO Number "+e.details.po_number,e.getoveralltotal(e.details.details))})},d.getAllSuppliers().then(function(s){s&&200==s.statusCode&&s.response.success&&(e.suppliers=s.response.result)}),p.getAllPerson().then(function(s){s&&200==s.statusCode&&s.response.success&&(e.customers=_.filter(s.response.result,function(e){return 2==e.per_type_id}))}),u.getAllProduct().then(function(s){if(s&&200==s.statusCode&&s.response.success){var t=s.response.result;_.each(t,function(s){0==s.is_archived&&null!=s.store_name&&e.products.push(s)})}}),m.getAllStore().then(function(s){s&&200==s.statusCode&&s.response.success&&(e.stores=s.response.result)}),u.getAllProductBundle().then(function(s){if(s&&200==s.statusCode&&s.response.success){var t=s.response.result;_.each(t,function(s){1!==s.is_archived&&e.productBundles.push(s)})}}),e.calculateItem=function(e){var s=0,t=0,t=e.price*e.quantity;return s+=parseFloat(t),e.total=s,e.total},e.parseDate=function(e){if(e)return h(new Date(e)).format("MMMM Do YYYY, h:mm:ss a")},e.getCurrentUser=function(){s.userprofile().then(function(s){if(200==s.statusCode&&s.response.success)e.profile=s.response.result,e.currentemail=e.profile.profile.email,e.details.currentemail=e.profile.profile.email,e.details.store_id=e.profile.profile.store_id;else if(400==s.statusCode&&!s.response.success)return void l.error(s.response.msg,"Error")})},e.toast_emailnotifs=function(e){"Sent"==e||"sent"==e?l.success("Email Sent","Success"):l.warning("Email not Sent","Warning")},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.addToList=function(s){_.isEmpty(s)?l.warning("Product list could not empty","Warning"):"product"==e.radioModel?_.isUndefined(s)||(e.details.details.push({item_name:s.product.item_name,quantity:s.quantity,price:s.price,discount:s.discount,total:s.total,product_id:s.product.p_id,bundle_id:null}),e.getoveralltotal(e.details.details),M()):"productgroup"==e.radioModel&&(_.isUndefined(s.productgroup)||(e.details.details.push({item_name:s.productgroup.bundle_name,quantity:s.quantity,price:s.price,discount:s.discount,total:s.total,product_id:null,bundle_id:s.productgroup.pb_id}),e.getoveralltotal(e.details.details),M()))},e.approvedPO=function(){var e={approved_by:r.selected_id};f.approvedPurchasedOrder(r.selected_id,e).then(function(e){e&&200==e.statusCode&&e.response.success?l.success(e.response.msg,"Success"):l.error(e?e.response.msg:"Error Found","Eror")})},e.savePO=function(s){var o=JSON.parse(t.get("user"));e.details.created_by=o.uc_id,e.details.emailmessage="",e.details.suppliername=v(e.details.supplier_id).name,e.details.toSend=s,e.details.products_list=e.details.details,e.details.supplier_id&&e.details.deliver_to&&e.details.po_number?r.selected_id?(console.log("updating PO."),f.updatePurchaseOrder(r.selected_id,e.details).then(function(t){if(t&&200==t.statusCode&&t.response.success){l.success(t.response.msg,"Success");r.selected_id;s&&e.approvedPO(),i.go("main.view_savepo",{selected_id:r.selected_id})}else l.error(t?t.response.msg:"Error Found","Eror");s?e.toast_emailnotifs(t&&t.response.email?t.response.email:"Error Found"):""})):(console.log("saving PO."),f.savePurchaseOrder(e.details).then(function(t){if(t&&200==t.statusCode&&t.response.success){l.success(t.response.msg,"Success");var o=t.response.result.inserted_po_id;s&&e.approvedPO(),i.go("main.view_savepo",{selected_id:o})}else l.error(t?t.response.msg:"Error Found","Eror");s?e.toast_emailnotifs(t&&t.response.email?t.response.email:"Error Found"):""})):l.warning("Fill in all the required fields in the first tab","Warning")},e.toggleModal=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log(".."),e.backto_fstpasge()},function(e){console.log("reason ",e)})},e.calculateItems=function(s){var t=0,o=0;_.each(e.details.products_list,function(e){var s=e.price-e.discount;t=s*e.quantity,o+=parseFloat(t)}),e.details.sub_total=o,e.calculateBilling()},e.calculateBilling=function(){e.total=parseFloat(e.details.sub_total||0)+parseFloat(e.details.tax||0)+parseFloat(e.details.shipping_fee||0)},e.removeProduct=function(s){e.products_list.splice(s,1)},e.edit=function(e){i.go("main.products-add",{p_id:e})},e.openPOUpdateModal=function(s){e.enAbleToSendForm=s,s?e.details.po_status="Sent":e.details.po_status="Open",g.openConfirm({templateUrl:"./modules/purchase_order/po.update.modal.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){e.savePO(s)},function(e){console.log("Modal promise close: ")})},e.open_scndpage=function(){e.fstpasge=!1,e.scndpage=!0},e.init=function(){e.getCurrentUser(),r.selected_id?e.loadpo():e.getGeneratedPOId()},e.init()}angular.module("POS17").controller("addOrderController",e),e.$inject=["$scope","AuthFctry","localStorageService","$http","$filter","$stateParams","$state","$timeout","toastr","productFactory","supplierFctry","ngTableParams","humanFactory","purchaseOrderFactory","storeFactory","ngDialog","moment"]}();
...
!function(){"use strict";function e(e,s,t,r,a,n,o,i,l,d,c,p,u,m,f,g,h,v){function S(s){var t=[];_.each(e.details,function(e){t.push({product_id:e.p_id,price:e.splycst,quantity:e.qtyrecv,quantity_ordered:e.quantity,stock_onhand:e.stock_onhand})});return t}e.datenow=h(new Date).format("MMMM Do YYYY, h:mm:ss a"),e.parent_details={},e.details=[],e.po_status="",e.po_id="",e.enAbleToSendForm,e.params={},e.params.arrOfPOIds=[],e.details2=[],e.specialVar1=[],e.specialVar2=[],n.selected_id&&(e.po_id=n.selected_id,m.getAllPurchaseOrderDetail(e.po_id).then(function(s){if(s&&200==s.statusCode&&s.response.success){e.parent_details=s.response.result,e.details=s.response.result.details,e.parent_details.products_list=e.details,e.parent_details.emailsubject="PO Number "+e.parent_details.po_number,e.fstpasge=!1,e.scndpage=!0,e.getoveralltotal(e.details);var t=e.parent_details.po_status;"Open"==t||"open"==t||"OPEN"==t?e.po_status="Saved":"Sent"==t||"sent"==t||"SENT"==t?e.po_status="Sent":e.po_status=t}else console.log("no data fetched !")}),e.getoveralltotal=function(s){e.overalltotal=_.sumBy(s,function(e){return e.price*e.quantity})},e.parseDate=function(e){if(e)return h(new Date(e)).format("MMMM Do YYYY, h:mm:ss a")},e.backto_fstpasge=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){e.fstpasge=!0,e.scndpage=!1;n.selected_id;o.go("main.purchase_order")},function(e){console.log("reason ",e)})},e.getCurrentUser=function(){s.userprofile().then(function(s){if(200==s.statusCode&&s.response.success)e.profile=s.response.result,e.currentemail=e.profile.profile.email,e.parent_details.currentemail=e.profile.profile.email,e.parent_details.store_id=e.profile.profile.store_id;else if(400==s.statusCode&&!s.response.success)return void l.error(s.response.msg,"Error")})},e.toast_emailnotifs=function(e){"Sent"==e||"sent"==e?l.success("Email Sent","Success"):l.warning("Email not Sent","Warning")},e.cancelPO=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=JSON.parse(t.get("user"));e.parent_details.created_by=s.uc_id,e.parent_details.suppliername=e.parent_details.supplier.name,e.parent_details.po_status="Cancelled",e.parent_details.products_list=e.details,e.parent_details.supplier_id&&e.parent_details.deliver_to&&e.parent_details.po_number?n.selected_id?m.updatePurchaseOrder(n.selected_id,e.parent_details).then(function(e){e&&200==e.statusCode&&e.response.success?(l.success("PO status Cancelled","Success"),o.reload()):l.error(e?e.response.msg:"Error Found","Eror")}):m.savePurchaseOrder(e.parent_details).then(function(e){e&&200==e.statusCode&&e.response.success?l.success("PO status Cancelled","Success"):l.error(e?e.response.msg:"Error Found","Eror")}):l.warning("Fill in all the required fields in the first tab","Warning")},function(e){console.log("reason ",e)})},e.approvedPO=function(){var e={approved_by:n.selected_id};m.approvedPurchasedOrder(n.selected_id,e).then(function(e){e&&200==e.statusCode&&e.response.success?l.success(e.response.msg,"Success"):l.error(e?e.response.msg:"Error Found","Eror")})},e.savePO2=function(s){var r=JSON.parse(t.get("user"));e.parent_details.created_by=r.uc_id,e.parent_details.suppliername=e.parent_details.supplier.name,e.parent_details.po_status="Sent",e.parent_details.toSend=s,e.parent_details.products_list=e.details,e.parent_details.supplier_id&&e.parent_details.deliver_to&&e.parent_details.po_number?n.selected_id&&m.updatePurchaseOrder(n.selected_id,e.parent_details).then(function(t){if(t&&200==t.statusCode&&t.response.success){l.success(t.response.msg,"Success");n.selected_id;s&&(e.approvedPO(),o.reload())}else l.error(t?t.response.msg:"Error Found","Eror");s?e.toast_emailnotifs(t&&t.response.email?t.response.email:"Error Found"):""}):l.warning("Fill in all the required fields in the first tab","Warning")},e.openPOUpdateModal2=function(s){e.enAbleToSendForm=s,e.parent_details.po_status="",g.openConfirm({templateUrl:"./modules/purchase_order/po.sendsaved.modal.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){e.savePO2(s)},function(e){console.log("Modal promise close: ")})},e.updateReceiveItemScope=function(s,t){e.details[t].qtyrecv=e.specialVar1[t]},e.updateSupplyCostScope=function(s,t){e.details[t].splycst=e.specialVar2[t]},e.promptMsg1=function(s){e.specialVar1[s]="",l.warning("Receive count must be less than or equal to number of items ordered","Warning")},e.checkSpecialVar1=function(){var s=_.find(e.specialVar1,"");return s},e.receivePO=function(){e.obj={po_id:n.selected_id,receive_number:1029384,receive_date:h(new Date).format("MMMM Do YYYY, h:mm:ss a"),received_by:33,supplier_id:e.parent_details.supplier_id,products_list:S()},m.receivePurchasedOrder(e.obj).then(function(e){e&&200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),o.reload()):l.error(e?e.response.msg:"Error Found","Eror")})},e.init=function(){e.getCurrentUser()},e.init())}angular.module("POS17").controller("viewSavedPOController",e),e.$inject=["$scope","AuthFctry","localStorageService","$http","$filter","$stateParams","$state","$timeout","toastr","productFactory","supplierFctry","ngTableParams","humanFactory","purchaseOrderFactory","storeFactory","ngDialog","moment"]}();
...
!function(){"use strict";function t(t,a){t.today=function(){t.today=a("date")(new Date,"dd MMM yyyy")},t.today(),t.is_disable=!1}angular.module("POS17").controller("aimTabCtrl",t),t.$inject=["$scope","$filter"]}();

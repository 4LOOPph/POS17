...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(e,r){r.state("main.settings-humanresource",{url:"/settings/humanresource",templateUrl:"modules/humanresource/humanresource.html",controller:"personController"}).state("main.settings-humanresource-detail",{url:"/settings/humanresource/:person_id",templateUrl:"modules/humanresource/humanresource.detail.html",controller:"personDetailController"}).state("main.settings-customergroup",{url:"/settings/customergroup",templateUrl:"modules/humanresource/customer.groups.html",controller:"customerGroupController"}).state("main.settings-customergroup-detail",{url:"/settings/customergroup/:customergroup_id",templateUrl:"modules/humanresource/customer.group.html",controller:"customerGroupDetailController"})}])}();
!function(){"use strict";function e(e,s,t,o,n,l,a,r,c,i){e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.selectedDatas=[];var p=function(){e.personisLoading=!0,e.persons=[],e.personscopy=[],e.personsTable=new i({page:1,count:10},{counts:[10,25,50,100],getData:function(s,t){a.getAllPerson().then(function(n){if(200==n.statusCode&&n.response.success){var l=n.response.result;e.personscopy=angular.copy(e.persons),_.each(l,function(e){if(_.isNull(e.date_end))e.isActiveAcnt=!0;else{var s=new Date(e.date_start),t=new Date(e.date_end);s<=t?e.isActiveAcnt=!0:e.isActiveAcnt=!1}}),console.log("persons: ",l),e.txtSearch&&"All"==e.applicationStatus?e.persons=o("filter")(l,e.txtSearch):e.txtSearch&&"Employee"==e.applicationStatus?(e.persons=o("filter")(l,{per_type_id:1}),e.persons=o("filter")(e.persons,e.txtSearch)):e.txtSearch&&"Customer"==e.applicationStatus?(e.persons=o("filter")(l,{per_type_id:2}),e.persons=o("filter")(e.persons,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.persons=l:_.isUndefined(e.txtSearch)&&"Employee"==e.applicationStatus?e.persons=o("filter")(l,{per_type_id:1}):_.isUndefined(e.txtSearch)&&"Customer"==e.applicationStatus?e.persons=o("filter")(l,{per_type_id:2}):e.persons=l,t.total(e.persons.length);var a=e.persons.slice((t.page()-1)*t.count(),t.page()*t.count());s.resolve(a),e.personisLoading=!1}else e.personisLoading=!1,r.error(n.response.msg,"Error")})}})};e.refresh=function(){e.personsTable.reload()},e.updateStatus=function(s){e.applicationStatus=s,e.personsTable.reload()},e.searchData=function(){e.personsTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.persons,function(s){s.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(s)})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.person_id===s.person_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.person_id!==s.person_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(s){l.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){a.deletePersonel(s).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void n.reload()):void r.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){l.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=0;async.each(e.selectedDatas,function(t,o){t.selected&&(console.log("person: ",t),a.deletePersonel(t.person_id).then(function(t){return console.log("data: ",t.response),200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),++s,s==e.selectedDatas.length&&n.reload(),o(),void 0):void r.error(t.response.msg,"Error")}))})})},p()}angular.module("POS17").controller("personController",e),e.$inject=["$scope","$rootScope","$http","$filter","$state","ngDialog","humanFactory","toastr","$timeout","ngTableParams"]}();
...
!function(){"use strict";function e(e,s,o,t,r,c,n,l,a,u){console.log("customerGroupController"),e.selectDeselectAll=!1,e.selectedDatas=[],e.txtSearch2="";var i=function(){e.groups=[],e.groupscopy=[],e.customers=[],e.customerscopy=[],n.getAllPerson().then(function(s){200==s.statusCode&&s.response.success&&(console.log("data:",s.response.result),_.map(s.response.result,function(s){2==s.per_type_id&&e.customers.push(s)}),_.each(e.customers,function(e){if(_.isNull(e.date_end))e.isActiveAcnt=!0;else{var s=new Date(e.date_start),o=new Date(e.date_end);s<=o?e.isActiveAcnt=!0:e.isActiveAcnt=!1}}),e.customerscopy=angular.copy(e.customers),console.log("$scope.customerscopy:",e.customerscopy))}),e.attributeGroupTable=new u({page:1,count:10},{counts:[10,25,50,100],getData:function(s,o){n.getCustomerGroup().then(function(r){if(200==r.statusCode&&r.response.success){var c=r.response.result;e.groupscopy=angular.copy(r.response.result),e.txtSearch?e.groups=t("filter")(c,e.txtSearch):e.groups=c,o.total(e.groups.length);var n=e.groups.slice((o.page()-1)*o.count(),o.page()*o.count());s.resolve(n),e.personisLoading=!1}else e.personisLoading=!1,l.error(r.response.msg,"Error")})}})};i(),e.searchCustomer=function(){console.log("$scope.textsearch:",e.txtSearch2),e.customers=t("filter")(e.customerscopy,e.txtSearch2)},e.refresh=function(){e.attributeGroupTable.reload()},e.searchData=function(){e.attributeGroupTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.groups,function(s){s.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(s)})},e.addGroups=function(s){var t=o.open({animation:!0,templateUrl:"./modules/humanresource/customer.groups.modal.html",controller:"customerGroupModalController",size:"md",resolve:{selected:function(){return s}}});t.result.then(function(s){e.selected=s},function(){console.info("Modal dismissed at: "+new Date)})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.cg_id===s.cg_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.cg_id!==s.cg_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(s){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){n.deleteCustomerGroup(s).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),void r.reload()):void l.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=0;async.each(e.selectedDatas,function(o,t){o.selected&&(console.log("group: ",o),n.deleteCustomerGroup(o.cg_id).then(function(o){return console.log("data: ",o.response),200==o.statusCode&&o.response.success?(l.success(o.response.msg,"Success"),++s,s==e.selectedDatas.length&&r.reload(),t(),void 0):void l.error(o.response.msg,"Error")}))})})}}function s(e,s,o,t,r,c,n,l){console.log("selected:",c),e.details=c,e.stores=[],l.getAllStore().then(function(s){console.log("data:",s),200==s.statusCode&&s.response.success&&(e.stores=s.response.result,console.log("data:",s.response.result))}),e.saveGroup=function(){c?n.updateCustomerGroup(c.cg_id,e.details).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),o.dismiss("cancel"),s.reload(),void 0):400===e.statusCode&&!e.response.success&&_.isArray(e.response.result)?void _.each(e.response.result,function(e){r.warning(e.msg,"Warning")}):void r.error(e.response.msg,"Error")}):n.saveCustomerGroup(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),o.dismiss("cancel"),s.reload(),void 0):400===e.statusCode&&!e.response.success&&_.isArray(e.response.result)?void _.each(e.response.result,function(e){r.warning(e.msg,"Warning")}):void r.error(e.response.msg,"Error")})},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("customerGroupController",e).controller("customerGroupModalController",s),e.$inject=["$scope","$rootScope","$uibModal","$filter","$state","ngDialog","humanFactory","toastr","$timeout","ngTableParams"],s.$inject=["$scope","$state","$uibModalInstance","$timeout","toastr","selected","humanFactory","storeFactory"]}();
!function(){"use strict";function e(e,s,t,o,n,r,u,c){console.log("$stateParams:",t.customergroup_id),e.details={},e.customers=[],async.waterfall([function(s){n.getAllStore().then(function(t){200==t.statusCode&&t.response.success&&(e.stores=t.response.result,s(null,t.response.result))})},function(s,t){o.getAllPerson().then(function(s){200==s.statusCode&&s.response.success&&(e.customers=s.response.result,e.customers=_.filter(s.response.result,function(e){return e.person_type="Customer"}),_.each(e.customers,function(e){if(_.isNull(e.date_end))e.isActiveAcnt=!0;else{var s=new Date(e.date_start),t=new Date(e.date_end);s<=t?e.isActiveAcnt=!0:e.isActiveAcnt=!1}}),console.log("customers:",e.customers))})},function(s,n){o.getCustomerGroupDetail(t.customergroup_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,console.log("data:",t.response.result),n(null,s,t.response.result))})},function(e,s,n){o.getCustomerGroupMapping(t.customergroup_id).then(function(t){200==t.statusCode&&t.response.success&&(console.log("data1:",t.response.result),n(null,e,s,t.response.result))})}])}angular.module("POS17").controller("customerGroupDetailController",e),e.$inject=["$scope","$state","$stateParams","humanFactory","storeFactory","API_URL","API_VERSION","toastr"]}();
...
!function(){"use strict";function e(e,o,t,n,s,c){e.audio="audio"==c,e.config={sources:[{src:s.trustAsResourceUrl(n.media_path),type:n.media_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.cancel=function(){t.dismiss("cancel")}}function o(e,o,t,n,s,c){if(console.log("files: ",s),e.pdfName=s.media_name,e.pdfUrl=s.media_path,e.scroll=0,e.loading='<i class="fa fa-spinner fa-spin fa-3x"></i>',c.get("token")){var a=c.get("token"),i=JSON.parse(c.get("user"));e.httpHeaders={Authorization:"Bearer "+a,accesskey:i.subscriptionKey}}e.getNavStyle=function(e){return e>100?"pdf-controls fixed":"pdf-controls"},e.onError=function(e){console.log(e)},e.onLoad=function(){e.loading=""},e.onProgress=function(e){console.log(e)},e.cancel=function(){t.dismiss("cancel")}}angular.module("POS17").controller("articleMediaModalCtrl",e).controller("articleDocsModalCtrl",o),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type"],o.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService"]}();
...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(t,o){o.state("main.settings-company",{url:"/settings/company",templateUrl:"modules/company/company.html",controller:"companyController"}).state("main.settings-company-detail",{url:"/settings/company/:company_id",templateUrl:"modules/company/company.detail.html",controller:"companyDetailController"})}])}();
!function(){"use strict";function e(e,t,a,o,c,n,l,s,r){console.log("companyController"),e.details=[],e.selectDeselectAll=!1,e.selectedDatas=[];var p=function(){e.company={},e.companycopy=[],e.companyTable=new s({page:1,count:10},{counts:[10,25,50,100],getData:function(t,o){l.getAllCompany().then(function(c){if(200==c.statusCode&&c.response.success){console.log("data:",c.response.result);var l=c.response.result;if(e.companycopy=angular.copy(e.company),e.txtSearch){e.company=a("filter")(l,e.txtSearch),o.total(e.company.length);var s=e.company.slice((o.page()-1)*o.count(),o.page()*o.count());t.resolve(s)}else{e.company=l,o.total(e.company.length);var s=e.company.slice((o.page()-1)*o.count(),o.page()*o.count());t.resolve(s)}}else n.error(c.response.msg,"Error")})}})};e.searchData=function(){e.companyTable.reload()},e.refresh=function(){e.companyTable.reload(),e.txtSearch=""},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.company,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.company_id===t.company_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.company_id!==t.company_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){r.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(a,c){a.selected&&(console.log("company: ",a),l.deleteCompany(a.company_id).then(function(a){return console.log("data: ",a.response),200==a.statusCode&&a.response.success?(n.success(a.response.msg,"Success"),++t,t==e.selectedDatas.length&&o.reload(),c(),void 0):void n.error(a.response.msg,"Error")}))})})},p()}angular.module("POS17").controller("companyController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","companyFactory","ngTableParams","ngDialog"]}();
!function(){"use strict";function e(e,s,n,o,t,a,c,l,r,u,i){console.log("asdasd"),e.details={},e.main=[],e.enable=!1,e.countries=[],async.waterfall([function(s){c.getAllCompany().then(function(n){200==n.statusCode&&n.response.success&&(e.main=n.response.result,s(null,n.response.result),e.main=_.filter(n.response.result,function(e){return e.company_id!=u.company_id}))})},function(s,n){i.getAllCountries().then(function(o){200==o.statusCode&&o.response.success&&(e.countries=o.response.result,console.log("$scope.countries:",e.countries),n(null,s,o.response.result))})},function(s,n,o){u.company_id&&c.getCompanyInfo(u.company_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,console.log("data.response.result:",s.response.result),o(null,s.response.result))})}]),e.enabledMainEvent=function(s){0==s&&(e.office=void 0,e.details.parent_id=0)},e.select=function(s){console.log("value:",s),e.details.parent_id=s.company_id},e.saveCompany=function(){console.log("$scope.details:",e.details),u.company_id?c.updateCompany(u.company_id,e.details).then(function(e){200==e.statusCode&&e.response.result&&(a.success(e.response.msg,"Success"),console.log("data:",e.response),o.go(o.current,{company_id:u.company_id},{reload:!0}))}):(console.log("$scope.details:",e.details),c.saveCompany(e.details).then(function(e){200==e.statusCode&&e.response.result&&(console.log("data:",e),a.success(e.response.msg,"Success"),o.go(o.current,{company_id:e.response.result},{reload:!0}))}))}}angular.module("POS17").controller("companyDetailController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","companyFactory","ngTableParams","ngDialog","$stateParams","countryFactory"]}();

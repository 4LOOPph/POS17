...
!function(){"use strict";function t(t,e,n,i,s,o,c){console.log("appSettingsDeviceController"),t.applicationStatus="All",t.devices=[],t.init=function(){c.getAllDevices().then(function(e){200==e.statusCode&&e.response.success&&(t.devices=e.response.result,_.each(t.devices,function(t){t.isOnline=!1}))})},t.refresh=function(){t.init()},t.updateStatus=function(e){t.applicationStatus=e}}angular.module("POS17").controller("appSettingsDeviceController",t),t.$inject=["$scope","$filter","$state","ngDialog","toastr","$timeout","appSettingsFctry"]}();
...
!function(){function t(t,n,e){return{getAllDevices:function(){return t.all("devices").customGET().then(function(t){return t},function(t){return t.data})}}}angular.module("POS17").factory("appSettingsFctry",t),t.$inject=["Restangular","API_URL","toastr"]}();

...
!function(){"use strict";function t(t,n,a){t.today=function(){t.today=n("date")(new Date,"dd MMM yyyy")},t.today(),t.is_disable=!1,t.startSync=function(){a.getSyncData().then(function(t){console.log("data ",t.response.result)})},t.init=function(){t.startSync()},t.init()}angular.module("POS17").controller("aimTabCtrl",t),t.$inject=["$scope","$filter","aimFctry"]}();
...
!function(){"use strict";function t(t){return{getSyncData:function(){return t.all("receiving").customGET().then(function(t){return t},function(t){return t.data})}}}angular.module("POS17").factory("aimFctry",t).factory("syncDataFactory",["Restangular","API_URL_2","API_VERSION_2",function(t,n,r){return t.withConfig(function(t){t.setBaseUrl(n+r)})}]),t.$inject=["syncDataFactory"]}();

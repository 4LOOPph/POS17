...
!function(){"use strict";function e(e,t,s,r,a,n,o,i,c){function u(){e.chartLineLabels_revenue=[],e.chartLineSeries_revenue=[],e.chartLineCharts_revenue=[],e.chartLineLabels_items_sold=[],e.chartLineSeries_items_sold=[],e.chartLineCharts_items_sold=[],e.chartLineLabels_customers=[],e.chartLineSeries_customers=[],e.chartLineCharts_customers=[],e.chartLineLabels_discount=[],e.chartLineSeries_discount=[],e.chartLineCharts_discount=[],e.chartLineLabels_discount_percent=[],e.chartLineSeries_discount_percent=[],e.chartLineCharts_discount_percent=[],e.chartLineLabels_basket_value=[],e.chartLineSeries_basket_value=[],e.chartLineCharts_basket_value=[],e.chartLineLabels_basket_size=[],e.chartLineSeries_basket_size=[],e.chartLineCharts_basket_size=[],e.chartLineLabels_gross_profit=[],e.chartLineSeries_gross_profit=[],e.chartLineCharts_gross_profit=[]}e.currentPage=1,e.itemsPerPage=4,e.isloadingGraphs=!1,e.data2=[],e.sevenDaysPrev=moment().subtract(7,"days").format("YYYY-MM-DD"),e.prevDay=moment().subtract(1,"days").format("YYYY-MM-DD"),e.currDate=moment().format("YYYY-MM-DD");var p=JSON.parse(s.get("user")),l=(new Date).toString().match(/([-\+][0-9]+)\s/)[1];e.statsOfPrevDay={},e.statsOfCurrDay={},String.prototype.insert=function(e,t){return e>0?this.substring(0,e)+t+this.substring(e,this.length):t+this},e.filterBy="day",e.sub_id=p.sub_id,e.dateFrom=e.sevenDaysPrev,e.dateTo=moment().format("YYYY-MM-DD"),e.timezone=l.insert(3,":"),e.arg=1,e.changeOf_revenue_Stat={},e.changeOf_items_sold_Stat={},e.changeOf_customers_Stat={},e.changeOf_discount_Stat={},e.changeOf_discount_percent_Stat={},e.changeOf_basket_value_Stat={},e.changeOf_basket_size_Stat={},e.changeOf_gross_profit_Stat={},e.labels=["Aim Global","Robinsons"],e.series=["Series A"],e.data=[[65,34]],e.chartLineLabels_revenue=[],e.chartLineSeries_revenue=[],e.chartLineCharts_revenue=[],e.chartLineColours_revenue=["#10de80"],e.chartLineOptions_revenue={maintainAspectRatio:!1,responsive:!1},e.chartLineLabels_items_sold=[],e.chartLineSeries_items_sold=[],e.chartLineCharts_items_sold=[],e.chartLineColours_items_sold=["#10de80"],e.chartLineOptions_items_sold={maintainAspectRatio:!1,responsive:!1},e.chartLineLabels_customers=[],e.chartLineSeries_customers=[],e.chartLineCharts_customers=[],e.chartLineColours_customers=["#10de80"],e.chartLineOptions_customers={maintainAspectRatio:!1,responsive:!1},e.chartLineLabels_discount=[],e.chartLineSeries_discount=[],e.chartLineCharts_discount=[],e.chartLineColours_discount=["#10de80"],e.chartLineOptions_discount={maintainAspectRatio:!1,responsive:!1},e.chartLineLabels_discount_percent=[],e.chartLineSeries_discount_percent=[],e.chartLineCharts_discount_percent=[],e.chartLineColours_discount_percent=["#10de80"],e.chartLineOptions_discount_percent={maintainAspectRatio:!1,responsive:!1},e.chartLineLabels_basket_value=[],e.chartLineSeries_basket_value=[],e.chartLineCharts_basket_value=[],e.chartLineColours_basket_value=["#10de80"],e.chartLineOptions_basket_value={maintainAspectRatio:!1,responsive:!1},e.chartLineLabels_basket_size=[],e.chartLineSeries_basket_size=[],e.chartLineCharts_basket_size=[],e.chartLineColours_basket_size=["#10de80"],e.chartLineOptions_basket_size={maintainAspectRatio:!1,responsive:!1},e.chartLineLabels_gross_profit=[],e.chartLineSeries_gross_profit=[],e.chartLineCharts_gross_profit=[],e.chartLineColours_gross_profit=["#10de80"],e.chartLineOptions_gross_profit={maintainAspectRatio:!1,responsive:!1},e.getDashboardReports=function(){e.isloadingGraphs=!0,u(),e.paramobj={sub_id:e.sub_id,filterBy:e.filterBy,dateFrom:e.dateFrom,dateTo:e.dateTo,timezone:e.timezone,arg:1},c.getDashboardReport(e.paramobj).then(function(t){_.each(t.response,function(s,r){e.chartLineLabels_revenue.push(s.label),e.chartLineCharts_revenue.push(s.revenue),e.chartLineLabels_items_sold.push(s.label),e.chartLineCharts_items_sold.push(s.items_sold),e.chartLineLabels_customers.push(s.label),e.chartLineCharts_customers.push(s.customers),e.chartLineLabels_discount.push(s.label),e.chartLineCharts_discount.push(s.discount),e.chartLineLabels_discount_percent.push(s.label),e.chartLineCharts_discount_percent.push(s.discount_percent),e.chartLineLabels_basket_value.push(s.label),e.chartLineCharts_basket_value.push(s.basket_value),e.chartLineLabels_basket_size.push(s.label),e.chartLineCharts_basket_size.push(s.basket_size),e.chartLineLabels_gross_profit.push(s.label),e.chartLineCharts_gross_profit.push(s.gross_profit),moment(s.transaction_date).format("YYYY-MM-DD")==e.prevDay&&(s.prev_revenue_Stat=s.revenue/_.sumBy(t.response,"revenue")*100,s.prev_items_sold_Stat=s.items_sold/_.sumBy(t.response,"items_sold")*100,s.prev_customers_Stat=s.customers/_.sumBy(t.response,"customers")*100,s.prev_discount_Stat=s.discount/_.sumBy(t.response,"discount")*100,s.prev_discount_percent_Stat=s.discount_percent/_.sumBy(t.response,"discount_percent")*100,s.prev_basket_value_Stat=s.basket_value/_.sumBy(t.response,"basket_value")*100,s.prev_basket_size_Stat=s.basket_size/_.sumBy(t.response,"basket_size")*100,s.prev_gross_profit_Stat=s.gross_profit/_.sumBy(t.response,"gross_profit")*100,e.statsOfPrevDay=s),moment(s.transaction_date).format("YYYY-MM-DD")==e.currDate&&(s.prev_revenue_Stat=e.statsOfPrevDay.revenue/_.sumBy(t.response,"revenue")*100,s.prev_items_sold_Stat=e.statsOfPrevDay.items_sold/_.sumBy(t.response,"items_sold")*100,s.prev_customers_Stat=e.statsOfPrevDay.customers/_.sumBy(t.response,"customers")*100,s.prev_discount_Stat=e.statsOfPrevDay.discount/_.sumBy(t.response,"discount")*100,s.prev_discount_percent_Stat=e.statsOfPrevDay.discount_percent/_.sumBy(t.response,"discount_percent")*100,s.prev_basket_value_Stat=e.statsOfPrevDay.basket_value/_.sumBy(t.response,"basket_value")*100,s.prev_basket_size_Stat=e.statsOfPrevDay.basket_size/_.sumBy(t.response,"basket_size")*100,s.prev_gross_profit_Stat=e.statsOfPrevDay.gross_profit/_.sumBy(t.response,"gross_profit")*100,e.changeOf_revenue_Stat=Math.round(s.revenue/_.sumBy(t.response,"revenue")*100-s.prev_revenue_Stat),e.changeOf_items_sold_Stat=Math.round(s.items_sold/_.sumBy(t.response,"items_sold")*100-s.prev_items_sold_Stat),e.changeOf_customers_Stat=Math.round(s.customers/_.sumBy(t.response,"customers")*100-s.prev_customers_Stat),e.changeOf_discount_Stat=Math.round(s.discount/_.sumBy(t.response,"discount")*100-s.prev_discount_Stat),e.changeOf_discount_percent_Stat=Math.round(s.discount_percent/_.sumBy(t.response,"discount_percent")*100-s.prev_discount_percent_Stat),e.changeOf_basket_value_Stat=Math.round(s.basket_value/_.sumBy(t.response,"basket_value")*100-s.prev_basket_value_Stat),e.changeOf_basket_size_Stat=Math.round(s.basket_size/_.sumBy(t.response,"basket_size")*100-s.prev_basket_size_Stat),e.changeOf_gross_profit_Stat=Math.round(s.gross_profit/_.sumBy(t.response,"gross_profit")*100-s.prev_gross_profit_Stat))}),e.isloadingGraphs=!1})},e.getDashboardReportsByStore=function(){e.paramobj={sub_id:e.sub_id,filterBy:e.filterBy,dateFrom:e.dateFrom,dateTo:e.dateTo,timezone:e.timezone,arg:2},c.getDashboardReport(e.paramobj).then(function(t){e.data2=t.response,e.getOverall_Revenue=_.sumBy(e.data2,"revenue"),e.getOverall_Salecount=_.sumBy(e.data2,"items_sold"),e.getOverall_Customercount=_.sumBy(e.data2,"customers"),e.getOverall_Grossprofit=_.sumBy(e.data2,"gross_profit"),e.getOverall_Discount=_.sumBy(e.data2,"discount"),e.getOverall_Discountpercent=_.sumBy(e.data2,"discount_percent"),e.getOverall_Basketsize=_.sumBy(e.data2,"basket_size"),e.getOverall_Basketvalue=_.sumBy(e.data2,"basket_value"),_.each(e.data2,function(t,s){t.percent_revenue_by_store=t.revenue/e.getOverall_Revenue*100,t.percent_items_sold_by_store=t.items_sold/e.getOverall_Salecount*100,t.percent_customers_by_store=t.customers/e.getOverall_Customercount*100,t.percent_gross_profit_by_store=t.gross_profit/e.getOverall_Grossprofit*100,t.percent_discount_by_store=t.discount/e.getOverall_Discount*100,t.percent_discount_percent_by_store=t.discount_percent/e.getOverall_Discountpercent*100,t.percent_basket_size_by_store=t.basket_size/e.getOverall_Basketsize*100,t.percent_basket_value_by_store=t.basket_value/e.getOverall_Basketvalue*100})})},e.setActive=function(t){e.filterBy="",e.filterBy=t,e.getDashboardReports()},a.getAllProduct().then(function(s){if(e.products=[],200==s.statusCode&s.response.success){var r=s.response.result;t(function(){e.$apply(function(){e.products=r}),e.totalItems=e.products.length,t(function(){e.productIsLoading=!1},2e3)},100)}}),n.getAllPerson().then(function(s){if(e.persons=[],200==s.statusCode&&s.response.result){e.totalPersonel=s.response.result.length;var r=s.response.result;t(function(){e.$apply(function(){e.persons=r}),t(function(){e.productIsLoading=!1},2e3)},100)}}),async.waterfall([function(e){i.getAllUserGroups().then(function(t){200==t.statusCode&&t.response.success?e(null,t.response.result):(r.error(t.response.msg,"Error"),e(null,"error"))})},function(s,r){o.getAllUserAccounts().then(function(r){if(e.useraccounts=[],200==r.statusCode&&r.response.success){var a=r.response.result;_.each(a,function(e){e.role_id&&(e.userRoles=_.map(e.role_id.split(","),function(e){return _.find(s,function(t){return t.role_id==e})}))}),t(function(){e.$apply(function(){e.useraccounts=a}),t(function(){e.productIsLoading=!1},2e3)},100)}})}]),e.init=function(){e.getDashboardReports(),e.getDashboardReportsByStore()},e.init()}angular.module("POS17").config(["$stateProvider",function(e){e.state("main.dashboard",{url:"/dashboard",templateUrl:"modules/dashboard/dashboard1.html",controller:"DashboardCtrl"})}]).controller("DashboardCtrl",e),e.$inject=["$scope","$timeout","localStorageService","toastr","productFactory","humanFactory","useraccountsFctry","usergroupsFctry","dashboardReportsFctry"]}();

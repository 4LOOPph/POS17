...
!function(){"use strict";angular.module("POS17").constant("ONESIGNAL",{appID:"04721b32-cbbe-48b0-816f-7856fefb0919",domain:"https://symphony-staging.onesignal.com"}).config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","API_URL","API_VERSION","$provide","localStorageServiceProvider","uiSelectConfig","LightboxProvider","$authProvider","FACEBOOK_API","GOOGLE_API","TWITTER_API","LINKEDIN_API","ONESIGNAL",function(e,i,r,t,o,a,n,l,c,s,d,u,p,m,h,I,g){r.html5Mode(!1),i.otherwise("/login"),s.resetSearchInput=!0,e.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),t.interceptors.push("httpInterceptor"),t.interceptors.push("authInterceptor"),l.value("baseURL",a),o.setBaseUrl(a+n),u.facebook({clientId:p,url:a+"/auth/facebook",redirectUri:window.location.origin+"/",requiredUrlParams:["display","scope"],scope:["email"],scopeDelimiter:",",oauthType:"2.0"}),u.google({clientId:m,url:a+"/auth/google",redirectUri:window.location.origin,requiredUrlParams:["scope"],scope:["profile","email"],scopePrefix:"openid",scopeDelimiter:" ",oauthType:"2.0"}),u.linkedin({clientId:I,url:a+"/auth/linkedin",redirectUri:window.location.origin,requiredUrlParams:["state"],scope:["r_emailaddress"],scopeDelimiter:" ",oauthType:"2.0",state:"STATE"}),u.twitter({clientId:h,url:a+"/auth/twitter",redirectUri:window.location.origin+"/",oauthType:"1.0"}),d.fullScreenMode=!0;var P=window.OneSignal||[];P.push(["init",{appId:g.appID,autoRegister:!1,subdomainName:g.domain,notifyButton:{enable:!0}}])}])}();
...
!function(){"use strict";function e(e,t,s,u,r,i,n,a,o,l,c){e.attributes=[],e.attribute_values=[],e.getAllProductAttributes=function(){async.waterfall([function(t){l.getAttributeMapping(e.details.ptype_id).then(function(e){if(200==e.statusCode&&e.response.success){var s=e.response.result;t(null,s)}else u.error(e.response.msg,"Error")})},function(e,t){a.getProductAttributes(i.p_id).then(function(s){if(200==s.statusCode&&s.response.success){var r=s.response.result;t(null,e,r)}else u.error(s.response.msg,"Error")})},function(e,t,s){c.getAllCategory().then(function(r){if(200==r.statusCode&&r.response.success){var i=r.response.result;s(null,e,t,i)}else u.error(r.response.msg,"Error")})},function(e,t,s,r){a.getProductsCategory(i.p_id).then(function(i){if(200==i.statusCode&&i.response.success){var n=i.response.result,a=[];_.each(s,function(e){var t=_.find(n,function(t){return e.c_id===t.fk_category_id});t&&a.push(e)}),r(null,e,t,a)}else u.error(i.response.msg,"Error")})},function(t,s,u,r){var i=[];if(_.each(t,function(e){var t=_.filter(u,{c_id:e.fk_c_id});t&&t.length>0&&i.push(e)}),i&&i.length>0){var n=_.map(i,function(e){return e.attributes});_.each(n,function(e){var t=_.find(s.attribute_values,{att_id:e.att_id}),u=_.find(s.attribute_value_list,{att_id:e.att_id});t?(e.unique_id=t._id,e.value=t.value):(e.value=null,e.unique_id=null),u?e.attribute_list_value=u.attribute_list:e.attribute_list_value=[]}),e.attributes=n}else{var n=_.map(t,function(e){return e.attributes});_.each(n,function(e){var t=_.find(s.attribute_values,{att_id:e.att_id}),u=_.find(s.attribute_value_list,{att_id:e.att_id});t?(e.unique_id=t._id,e.value=t.value):(e.value=null,e.unique_id=null),u?e.attribute_list_value=u.attribute_list:e.attribute_list_value=[]}),e.attributes=n}}])},e.getAllProductAttributes(),e.deleteAttributeValue=function(s){console.log("attribute: ",s),_.isUndefined(s.value)?u.warning("Unable to save no attribute value","Warning"):n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("Delete"),o.deleteAttributeValues(s.att_id,s.unique_id).then(function(e){200==e.statusCode&&e.response.success?(u.success(e.response.msg,"Success"),t.reload()):u.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.saveAttributeValue=function(s){console.log("attribute: ",s),e.modal={title:"Confirm attribute",message:"Are you sure to save attribute?"};var r={product_id:i.p_id,bundle_id:null,attribute_id:s.att_id,article_id:null,value:s.value,value_image:null,name:s.name,description:"",is_single:0,is_image:0,is_video:0,is_audio:0};_.isUndefined(s.value)?u.warning("Unable to save no attribute value","Warning"):n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){_.isNull(s.unique_id)?(console.log("Save New"),o.saveAttributeValues(s.att_id,r).then(function(e){200==e.statusCode&&e.response.success?(u.success(e.response.msg,"Success"),t.reload()):u.error(e.response.msg,"Error")})):(console.log("Updated"),console.log("values",r),o.updateAttributeValues(s.att_id,s.unique_id,r).then(function(e){200==e.statusCode&&e.response.success?(u.success(e.response.msg,"Success"),t.reload()):u.error(e.response.msg,"Error")}))},function(e){console.log("Modal promise close: ")})}}angular.module("POS17").controller("productAttributeCtrl",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","ngDialog","productFactory","attributeFactory","ptypeFactory","categoryFactory"]}();
...
!function(){"use strict";function s(s,e,r,t,o,i,n,c,a){s.sharer={},s.users=[],s.items=[],s.asset={},s.asset=a,s.owner={},0==s.asset.isPublic?s.sharer.isPublic=!1:null==s.asset.isPublic?s.sharer.isPublic=!1:1==s.asset.isPublic&&(s.sharer.isPublic=!0),console.log("$scope.asset: ",s.asset),async.waterfall([function(s){c.getAllUserAccounts().then(function(e){if(200==e.statusCode&&e.response.success){var r=e.response.result;s(null,r)}else s(null,[])})},function(r,t){s.users=angular.copy(r),_.remove(s.users,function(s){return s.uc_id==e.profile.uc_id}),_.each(s.users,function(e){var r=e.profile;s.items.push({displayName:r.displayName,email:r.email||"",_id:r._id,id:e.uc_id,type:"user"})})}]),n.getSharedAssetFile(s.asset.asset_id).then(function(e){if(200!=e.statusCode||!e.response.success)return void i.error(e.response.msg,"Error");var r=e.response.result;s.sharer.email=_.map(r,function(s){if(s.info){var e=s.info;return{displayName:e.displayName,email:e.email||"",_id:e._id,id:e.uc_id,type:"user"}}})}),s.tagTransform=function(s){return{displayName:s}},s.clearInput=function(s){s.search=""},s.deleteEmail=function(s){console.log("deleteEmail: ",s)},s.sendMail=function(){var e=_.map(s.sharer.email,function(s){return{id:s.id,type:s.type}});s.asset.isFolder?s.sharer.isPublic?n.publicSharedFolder(s.asset._id,"public").then(function(s){return 200==s.statusCode&&s.response.success?(i.success(s.response.msg,"Success"),void r.close("save")):void i.error(s.response.msg,"Error")}):e&&e.length>0||n.publicSharedFolder(s.asset._id,"private").then(function(s){return 200==s.statusCode&&s.response.success?(i.success(s.response.msg,"Success"),void r.close("save")):void i.error(s.response.msg,"Error")}):s.sharer.isPublic?n.publicSharedAssetFile(s.asset._id,"public").then(function(s){return 200==s.statusCode&&s.response.success?(i.success(s.response.msg,"Success"),void r.close("save")):void i.error(s.response.msg,"Error")}):e&&e.length>0?n.removeSharedAssetFile(s.asset.asset_id).then(function(t){if(200!=t.statusCode||!t.response.success)return void i.error(t.response.msg,"Error");var o=1;async.eachSeries(e,function(t,c){n.shareAssetFile(s.asset._id,{shared_to:t.id,share_type:t.type}).then(function(s){return 200==s.statusCode&&s.response.success?(i.success(s.response.msg,"Success"),o++,c(),void 0):400===s.statusCode&&!s.response.success&&_.isArray(s.response.result)?void _.each(s.response.result,function(s){i.warning(s.msg,"Warning")}):void i.error(s.response.msg,"Error")}),o==e.length&&r.close("save")})}):n.publicSharedAssetFile(s.asset._id,"private").then(function(s){return 200==s.statusCode&&s.response.success?(i.success(s.response.msg,"Success"),void r.close("save")):void i.error(s.response.msg,"Error")})},s.cancel=function(){r.dismiss("cancel")}}angular.module("POS17").controller("assetsShareModalCtrl",s),s.$inject=["$scope","$rootScope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","useraccountsFctry","asset_file"]}();

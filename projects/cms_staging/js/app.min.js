...
!function(){"use strict";function e(e,t,s,a,l,r,i,c,o,n,d,u,f){e.selectDeselectAll=!1,e.applicationStatus="All",e.filterStatus="Relevance",e.txtSearch="",e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0};var g=JSON.parse(d.get("user"));n.logTransaction("View Articles","ARTICLES","ALL","User:="+g.username+" View all list of articles");var h=function(){e.articleisLoading=!0,e.articles=[],e.articleTable=new c({page:1,count:10},{counts:[10,25,50,100],getData:function(t,l){i.getArticle().then(function(r){if(200==r.statusCode&&r.response.success){var i=r.response.result;e.txtSearch&&"All"==e.applicationStatus?e.articles=s("filter")(i,e.txtSearch):e.txtSearch&&"Published"==e.applicationStatus?(e.articles=s("filter")(i,{is_active:1}),e.articles=s("filter")(e.articles,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus?(e.articles=s("filter")(i,{is_active:0}),e.articles=s("filter")(e.articles,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.articles=i:_.isUndefined(e.txtSearch)&&"Published"==e.applicationStatus?e.articles=s("filter")(i,{is_active:1}):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?e.articles=s("filter")(i,{is_active:0}):e.articles=i,"Most Viewed"==e.filterStatus&&(e.articles=s("orderBy")(e.articles,"article_views",!0),e.articles=_.filter(e.articles,function(e){return parseInt(e.article_views)>0})),l.total(e.articles.length);var c=e.articles.slice((l.page()-1)*l.count(),l.page()*l.count());t.resolve(c),e.articleisLoading=!1}else a.error(r.response.msg,"Error"),e.articleisLoading=!1})}})};f.getAllTags().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){e.tagsArr.push({id:t.tags_id,label:t.tags,_id:t._id})})}else a.error(t.response.msg,"Error")}),e.refresh=function(){e.articleisLoading=!0,e.articleTable.reload()},e.edit=function(e){t.go("main.articles-detail",{article_id:e})},e.updateStatus=function(t){e.applicationStatus=t,e.articleTable.reload()},e.updateFilterStatus=function(t){e.filterStatus=t,e.articleTable.reload()},e.searchData=function(){e.articleTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.articles,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.article_id===t.article_id})||(e.selectedDatas.push(t),1==t.is_active&&e.selectedPublishedDatas.push(t),0==t.is_active&&e.selectedDraftedDatas.push(t)):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.article_id!==t.article_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(s){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){i.deleteArticle(s).then(function(e){return 200==e.statusCode&&e.response.success?(a.success(e.response.msg,"Success"),void t.reload()):void a.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.updateHistory=function(e){u.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/audit.log.modal.html",controller:"articleAuditLogModalCtrl",size:"md",resolve:{article_id:function(){return e}}})},e.deleteSelected=function(){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=0;async.each(e.selectedDatas,function(l,r){l.selected&&i.deleteArticle(l.article_id).then(function(l){return 200==l.statusCode&&l.response.success?(a.success(l.response.msg,"Success"),++s,s==e.selectedDatas.length&&t.reload(),r(),void 0):void a.error(l.response.msg,"Error")})})})},e.draftSelected=function(){e.modal={title:"Draft Article?",message:"Are you sure to Draft this selected article?"},o.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=1;return e.selectedPublishedDatas.length>0?void async.eachSeries(e.selectedPublishedDatas,function(l,r){l.selected&&1==l.is_active&&i.draftArticle(l.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(a.success(e.response.msg,"Success"),s++,r(),void 0):void a.error(e.response.msg,"Error")}),console.log("dataCountToDelete: ",s),s==e.selectedPublishedDatas.length&&t.reload()}):void a.warning("Unable to Draft selected Articles..Selected articles are either archived or already drafted","Warning")})},e.publishSelected=function(s){e.modal={title:"Publish Article?",message:"Are you sure to Publish this selected article?"},o.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=1;return e.selectedDraftedDatas.length>0?void async.eachSeries(e.selectedDraftedDatas,function(l,r){l.selected&&0==l.is_active&&i.publishArticle(l.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(a.success(e.response.msg,"Success"),s++,r(),void 0):void a.error(e.response.msg,"Error")}),console.log("dataCountToDelete: ",s),s==e.selectedDraftedDatas.length&&t.reload()}):void a.warning("Unable to Publish selected Articles..Selected articles are either archived or already published","Warning")})},h()}angular.module("POS17").controller("articleController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","articleFctry","ngTableParams","ngDialog","transLogFctry","localStorageService","$uibModal","tagsFactory"]}();

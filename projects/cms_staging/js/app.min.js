...
!function(){"use strict";function e(e,l,s,i,a,n,t){if(e.file={},e.file=t,console.log("$scope.file: ",e.file),e.file.isFolder)e.file.foldername=e.file.folder_name;else{var o=e.file.asset_name.split("_")[0];e.file.filename=o}e.Rename=function(){},e.cancel=function(){l.dismiss("cancel")}}angular.module("POS17").controller("assetsRenameModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","asset_file"]}();

...
!function(){"use strict";function e(e,s,o){}function s(e,s,o,n,r,t,i,a,u,l,c,d,p){var f=o.getCurrentUser(),m=JSON.parse(f);e.inputType="password",e.pw1="password",e.user=m,e.details={},e.social={},e.showFacebook=!0,e.showGoogle=!0,e.showTwitter=!0,e.showLinkedin=!0,e.showUpload=!1,e.timezone=[],e.newImage=!1,m.person_id&&async.waterfall([function(s){t.getAllPersonDetail(m.person_id).then(function(o){200==o.statusCode&o.response.success&&(e.details=o.response.result,s())})},function(s){t.getUserSocial().then(function(o){200==o.statusCode&o.response.success&&(e.social=o.response.result,e.showFacebook=!_.isEmpty(e.social.facebook_uuid),e.showGoogle=!_.isEmpty(e.social.google_uuid),e.showTwitter=!_.isEmpty(e.social.twitter_uuid),e.showLinkedin=!_.isEmpty(e.social.linkedin_uuid),s())})},function(s){t.getUserPIN().then(function(o){200==o.statusCode&o.response.success&&(e.details.pos_pin=o.response.result.pos_pin,s())})}]),t.getTimeZone().then(function(s){200==s.statusCode&&s.response.success&&(e.timezone=s.response.result)}),e.hideShowPassword=function(){"password"==e.inputType?e.inputType="text":e.inputType="password"},e.upload=function(s){console.log("file",s),e.newImage=!0,e.showUpload=!0},e.removethumb=function(){e.showUpload=!1,e.details.image=null,e.newImage=!1},e.savePersonDetail=function(){async.waterfall([function(s){m.person_id?t.updatePersonel(m.person_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)i.success(e.response.msg,"Success"),s(null,m.person_id),n.reload();else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void i.error(e.response.msg,"Error");_.each(e.response.result,function(e){i.warning(e.msg,"Warning")})}}):t.savePersonel(e.details).then(function(e){if(200==e.statusCode&&e.response.success)i.success(e.response.msg,"Success"),s(null,e.response.result),n.reload();else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void i.error(e.response.msg,"Error");_.each(e.response.result,function(e){i.warning(e.msg,"Warning")})}})},function(s,o){console.log("user:",s),e.newImage&&e.details.image&&a.upload({url:u+l+"persons/"+s+"/upload-image",data:{person_img:e.details.image},method:"PUT"}).then(function(e){if(200===e.data.statusCode&&e.data.response.success)i.success("Image successfully uploaded","Success"),n.reload();else{if(400!==e.data.statusCode||e.data.response.success||!_.isArray(e.data.response.result))return void i.error(e.data.response.msg,"Error");_.each(e.data.response.result,function(e){i.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])},e.saveUsername=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){t.updateUsername(s.profile).then(function(e){if(200==e.statusCode&&e.response.success)i.success("Successfully Update","Success"),r(function(){n.reload()},1e3);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void i.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){i.warning(e.msg,"Warning")})}})})},e.savePassword=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){t.updatePassword(e.details).then(function(e){if(200==e.statusCode&&e.response.success)i.success("Successfully Update Password","Success"),r(function(){n.reload()},1e3);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void i.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){i.warning(e.msg,"Warning")})}})})},e.addRecoveryEmail=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){t.addRecoveryPassword({email_recovery:e.details.recovery_email}).then(function(e){if(200==e.statusCode&&e.response.success)i.success("Successfully Update","Success"),r(function(){n.reload()},1e3);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void i.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){i.warning(e.msg,"Warning")})}})})},e.addPOSPIN=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){t.addUserPIN({pin:e.details.pos_pin}).then(function(e){if(200==e.statusCode&&e.response.success)i.success(e.response.msg,"Success"),r(function(){n.reload()},1e3);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void i.error(e.response.msg,"Error");_.each(e.response.result,function(e){i.warning(e.msg,"Warning")})}})})},e.unlinkAccount=function(e){d.unlink(e,{method:"POST",url:u+"/auth/unlink"}).then(function(s){i.success("You have successfully unlinked "+e+" to your profile!"),r(function(){n.reload()},400)})["catch"](function(e){error.message?i.error(error.message):error.data?i.error(error.data.message,error.status):i.error(error)})},e.viewProfile=function(e,s){if("facebook"==e){var o=p.open("https://www.facebook.com/app_scoped_user_id/"+s+"/","_blank");o.focus()}else if("google"==e){var o=p.open("https://plus.google.com/"+s,"_blank");o.focus()}else if("linkedin"==e){var o=p.open("http://www.linkedin.com/profile/view?id="+s,"_blank");o.focus()}else if("twitter"==e){var o=p.open("https://twitter.com/intent/user?user_id="+s,"_blank");o.focus()}},e.authenticate=function(e){d.link(e).then(function(s){i.success("You have successfully linked your profile with "+e+"!"),r(function(){n.reload()},400)})["catch"](function(e){})}}angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(e,s){s.state("main.settings-profile",{url:"/settings/profile",templateUrl:"modules/profile/profile.html",controller:"ProfileCtrl"}).state("main.settings-profile-details",{url:"/settings/profile/details/",templateUrl:"modules/profile/profile.details.html",controller:"ProfileDetailCtrl"})}]).controller("ProfileCtrl",e).controller("ProfileDetailCtrl",s),e.$inject=["$scope","$state","AuthFctry"],s.$inject=["$scope","$rootScope","AuthFctry","$state","$timeout","humanFactory","toastr","Upload","API_URL","API_VERSION","ngDialog","$auth","$window"]}();

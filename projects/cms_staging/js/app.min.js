...
!function(){"use strict";function e(e,t,a,s,o,l,c,n,i,u,r,d){e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[];var f=JSON.parse(u.get("user"));r.logTransaction("View Quotes","QUOTES","ALL","User:="+f.username+" View all list of Quotes");var p=function(){e.quotes=[],e.quoteTable=new c({page:1,count:10},{counts:[10,25,50,100],getData:function(t,o){i.getAllQuotes().then(function(l){if(200==l.statusCode&&l.response.success){var c=l.response.result;e.txtSearch&&"All"==e.applicationStatus?e.quotes=a("filter")(c,e.txtSearch):e.txtSearch&&"Active"==e.applicationStatus?(e.quotes=a("filter")(c,{is_active:1}),e.quotes=a("filter")(e.quotes,e.txtSearch)):e.txtSearch&&"Inactive"==e.applicationStatus?(e.quotes=a("filter")(c,{is_active:0}),e.quotes=a("filter")(e.quotes,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.quotes=c:_.isUndefined(e.txtSearch)&&"Active"==e.applicationStatus?e.quotes=a("filter")(c,{is_active:1}):_.isUndefined(e.txtSearch)&&"Inactive"==e.applicationStatus?e.quotes=a("filter")(c,{is_active:0}):e.quotes=c,o.total(e.quotes.length);var n=e.quotes.slice((o.page()-1)*o.count(),o.page()*o.count());t.resolve(n)}else s.error(l.response.msg,"Error")})}})};p(),e.refresh=function(){e.quoteTable.reload()},e.edit=function(e){t.go("main.quotes-detail",{quote_id:e})},e.updateStatus=function(t){e.applicationStatus=t,e.quoteTable.reload()},e.searchData=function(){e.quoteTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.quotes,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.quote_id===t.quote_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.quote_id!==t.quote_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=0;async.each(e.selectedDatas,function(o,l){o.selected&&i.deleteQuoteInfo(o.quote_id).then(function(o){return 200==o.statusCode&&o.response.success?(s.success(o.response.msg,"Success"),++a,a==e.selectedDatas.length&&t.reload(),l(),void 0):void s.error(o.response.msg,"Error")})})})},e.updateHistory=function(e){d.open({animation:!0,backdrop:"static",templateUrl:"./modules/quotes/quote.auditlog.modal.html",controller:"quotesAuditLogModalCtrl",size:"md",resolve:{quote_id:function(){return e}}})}}angular.module("POS17").controller("quotesController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","ngTableParams","ngDialog","quoteFactory","localStorageService","transLogFctry","$uibModal"]}();
...
!function(){"use strict";function e(e,t,a,o,i){function n(e){var t=new Date(e),a=6e4*(new Date).getTimezoneOffset(),o=new Date(t.getTime()+a),i=o.getHours(),n=o.getMinutes(),s=i>=12?"pm":"am";i%=12,i=i?i:12,n=n<10?"0"+n:n;var g=i+":"+n+" "+s;return o.getMonth()+1+"/"+o.getDate()+"/"+o.getFullYear()+"  "+g}e.pageNumber=1,e.limitWithPage=10,e.totalPages=0,e.auditlogs=[],e.generateActivityLogs=function(t){o.getQuoteAuditLog(t,{startWith:e.pageNumber-1,limit:e.limitWithPage}).then(function(t){200==t.statusCode&&t.response.success&&(e.auditlogs=t.response.result,_.each(e.auditlogs,function(e){e.log_date=n(e.log_date)}),e.totalPages=t.response.pagination.pages)})},i&&e.generateActivityLogs(i),e.addMoreItems=function(){e.pageNumber<e.totalPages&&(e.pageNumber=e.pageNumber+1),i&&e.generateActivityLogs(i)},e.filterDate=function(){},e.cancel=function(){a.dismiss("cancel")}}angular.module("POS17").controller("quotesAuditLogModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","quoteFactory","quote_id"]}();
...
!function(){"use strict";function e(e,s,t,o,r,n,i,c,a,u,l,d,p,g,m,f,b){console.log("pricebookDetailController");var h=o.getCurrentUser(),k=JSON.parse(h);e.tagselected=[],e.tags=[],e.tagsArr=[],e.tagschecked=[],e.customergroups=[],e.storesArr=[],e.details={},e.details.isActive=1,e.details.published=!1,e.details.stores=[],e.details.customergroups=[],e.details.tags=[],e.details.created_by=k.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.uniquePricebookName=!1,e.uniquePricebookType=!1,e.item={},e.selectDeselectAll2=!1,e.selectedDatas2=[],e.infiniteScrollContacts={},e.infiniteScrollContacts.numToAdd=20,e.infiniteScrollContacts.currentItems=20;var h=JSON.parse(d.get("user"));i.pricebook_id?p.logTransaction("View Pricebook Details","PRICEBOOKS",i.pricebook_id,"User:="+h.username+" View pricebook details: ="+i.pricebook_id):p.logTransaction("Add New Pricebook","PRICEBOOKS","N/A","User:="+h.username+" Add new pricebook entry"),t.getPricebookType().then(function(s){e.pricebooktype=[],200==s.statusCode&&s.response.success&&(e.pricebooktype=s.response.result)}),u.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:r.error(s.response.msg,"Error")}),m.getCustomerGroup().then(function(s){200==s.statusCode&&s.response.success?e.customergroups=s.response.result:r.error(s.response.msg,"Error")}),b.getAllStore().then(function(s){200==s.statusCode&&s.response.success?e.storesArr=s.response.result:r.error(s.response.msg,"Error")}),async.waterfall([function(e){m.getAllPerson().then(function(s){if(200==s.statusCode&&s.response.success){var t=s.response.result,o=_.filter(t,function(e){if("Customer"==e.person_type&&0==e.isSubscriber)return e});e(null,o)}else r.error(s.response.msg,"Error")})},function(e,s){f.getAllCompany().then(function(t){if(200==t.statusCode&&t.response.success){var o=t.response.result;s(null,e,o)}else r.error(t.response.msg,"Error")})},function(s,t,o){var r=[];s&&s.length>0&&_.each(s,function(e){r.push({_id:e._id,email:e.email,id:e.person_id,type:"customer",name:e.displayName,pricebook_id:i.pricebook_id})}),t&&t.length>0&&_.each(t,function(e){r.push({_id:e._id,email:e.email,id:e.company_id,type:"company",name:e.name,pricebook_id:i.pricebook_id})}),e.customersData=r}]),i.pricebook_id&&(e.displayTab=!0,t.getPricebookDetail(i.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.details.published=1==e.details.isActive,e.details.customergroups=e.details.customergroup,u.getAllPricebookTags(i.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)}))})),e.resetInfScroll=function(){e.infiniteScrollContacts.currentItems=e.infiniteScrollContacts.numToAdd},e.addMoreItems=function(){e.infiniteScrollContacts.currentItems+=e.infiniteScrollContacts.numToAdd},e.validatePricebookName=function(s){s&&t.validatePricebookName({name:s,pricebook_id:i.pricebook_id}).then(function(s){return 200!=s.statusCode||s.response.success?void(e.uniquePricebookName=!1):(e.uniquePricebookName=!0,void r.warning(s.response.msg,"Warning"))})},e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.changeSelectDeselectAll2=function(){e.selectDeselectAll2=!e.selectDeselectAll2,_.each(e.tagsArr,function(s){s.checked=e.selectDeselectAll2,e.checkDataChanges2(s)})},e.checkDataChanges2=function(s){s.checked?_.find(e.tagselected,function(e){return e.tags_id===s.tags_id})||e.tagselected.push(s):e.tagselected=_.filter(e.selectedDatas,function(e){return e.tags_id!==s.tags_id})},e.deleteProductTags=function(e){i.pricebook_id&&u.deleteArticleTag(i.pricebook_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void r.success(e.response.msg,"Success"):void r.error(e.response.msg,"Error")})},e.savePricebook=function(){e.details.isActive=1==e.details.published?1:0,e.details.customergroup=[],_.each(e.details.customergroups,function(s){e.details.customergroup.push({customer_group_id:s.cg_id})});var s=[];_.each(e.details.customers,function(e){s.push({customer_id:e.id,type:e.type})}),e.details.customers=s;var o=[];_.each(e.details.stores,function(e){o.push({store_id:e.store_id})}),e.details.stores=o,async.waterfall([function(s){i.pricebook_id?t.updatePriceBook(i.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s(null,i.pricebook_id)):void r.error(e.response.msg,"Error")}):t.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s(null,e.response.result)):void r.error(e.response.msg,"Error")})},function(s,t){var o=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(n,i){n.isTag?u.saveTags(n).then(function(e){return 200==e.statusCode&&e.response.success?void u.savePricebookTags(s,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void i()):void r.error(e.response.msg,"Error")}):void r.error(e.response.msg,"Error")}):u.savePricebookTags(s,{tag_id:n.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void i()):void r.error(e.response.msg,"Error")}),o>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,s){g(function(){n.go(n.current,{pricebook_id:e},{reload:!0})},300)}])}}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams","$filter","ngDialog","tagsFactory","$uibModal","localStorageService","transLogFctry","$timeout","humanFactory","companyFactory","storeFactory"]}();

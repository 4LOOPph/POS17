...
!function(){"use strict";function o(o,t,c,r,u,e,p){o.pb_product={},o.pb_product.markup=0,o.pb_product.discount=0,o.pb_product.min_quantity=0,o.pb_product.max_quantity=0,o.discountchoose=!1,o.pricebookProducts=[],o.pricebookProductBundles=[],o.radioModel="product",o.DiscountModel="Amount",o.infiniteScrollContacts={},o.infiniteScrollContacts.numToAdd=10,o.infiniteScrollContacts.currentItems=10,o.$watch("pb_product.product",function(t){t&&(o.pb_product.sell_price=t.sell_price,o.pb_product.selling_price=o.calculateSellingPrice(t.sell_price,o.pb_product.markup||0,o.pb_product.discount||0))}),o.$watch("pb_product.productgroup",function(t){t&&(o.pb_product.sell_price=t.sell_price,o.pb_product.selling_price=o.calculateSellingPrice(t.sell_price,o.pb_product.markup||0,o.pb_product.discount||0))}),o.calculateSellingPrice=function(t,c,r){var u=0;return u="Amount"==o.DiscountModel?(parseFloat(t)+parseFloat(c)-parseFloat(r)).toFixed(2):(parseFloat(t)+parseFloat(c)-parseFloat(r)/100).toFixed(2)},o.discountOpt=function(){o.onCalculatePrice()},o.onCalculatePrice=function(){o.pb_product.selling_price=o.calculateSellingPrice(o.pb_product.sell_price||0,o.pb_product.markup||0,o.pb_product.discount||0)},async.waterfall([function(t){r.getAllProduct().then(function(c){if(200==c.statusCode&&c.response.success){var r=c.response.result;_.each(r,function(t){t.selected=!1,1==t.is_published&&o.pricebookProducts.push(t)}),_.uniqBy(o.pricebookProducts,function(o){return o.p_id}),t(null,r)}})},function(t,c){r.getAllProductBundle().then(function(t){if(200==t.statusCode&&t.response.success){var c=t.response.result;_.each(c,function(t){t.selected=!1,1==t.is_published&&o.pricebookProductBundles.push(t)}),_.uniqBy(o.pricebookProductBundles,function(o){return o.pb_id})}})}]),o.resetInfScroll=function(){o.infiniteScrollContacts.currentItems=o.infiniteScrollContacts.numToAdd},o.addMoreItems=function(){o.infiniteScrollContacts.currentItems+=o.infiniteScrollContacts.numToAdd},o.changeData=function(t){o.radioModel=t,"product"==t?(o.pb_product.product=void 0,o.pb_product.productgroup=void 0):(o.pb_product.product=void 0,o.pb_product.productgroup=void 0),o.pb_product.sell_price=0,o.pb_product.markup=0,o.pb_product.discount=0,o.pb_product.min_quantity=0,o.pb_product.max_quantity=0,o.pb_product.selling_price=""},o.saveEntry=function(){console.log("$scope.pb_product:",o.pb_product),_.isUndefined(o.pb_product.product)&&_.isUndefined(o.pb_product.product)?"product"==o.radioModel?c.error("Please Provide Products","Error"):c.error("Please Provide Products Group","Error"):("product"==o.radioModel?(o.pb_product.product_id=o.pb_product.product.p_id,o.pb_product.bundle_id=null):(o.pb_product.bundle_id=o.pb_product.productgroup.pb_id,o.pb_product.product_id=null),p.savePriceBookItem(e.pricebook_id,{markup:o.pb_product.markup,discount:o.pb_product.discount,sell_price:o.pb_product.sell_price,min_quantity:o.pb_product.min_quantity,max_quantity:o.pb_product.max_quantity,bundle_id:o.pb_product.bundle_id,product_id:o.pb_product.product_id}).then(function(o){if(200==o.statusCode&&o.response.success)c.success(o.response.msg,"Success"),u(function(){t.close()},100);else{if(400!==o.statusCode||o.response.success||!_.isArray(o.response.result))return void c.error(o.response.msg,"Error");_.each(o.response.result,function(o){c.warning(o.msg,"Warning")})}}))},o.cancel=function(){t.dismiss("cancel")}}angular.module("POS17").controller("pricebookProductModalCtrl",o),o.$inject=["$scope","$uibModalInstance","toastr","productFactory","$timeout","$stateParams","pricebookFactory"]}();

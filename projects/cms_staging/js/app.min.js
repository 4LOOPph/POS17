...
!function(){"use strict";angular.module("POS17").factory("jQuery",["$window",function(n){return n.jQuery}]).factory("_",["$window",function(n){return n.jQuery}]).factory("PDFJS",["$window",function(n){return n.PDFJS}]).factory("async",["$window",function(n){return n.async}]).constant("ONESIGNAL",{appID:"04721b32-cbbe-48b0-816f-7856fefb0919",domain:"https://symphony-staging.onesignal.com"}).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location","ONESIGNAL",function(n,e,t,o,r,i,a,u,c){e.currentUser={},e.$state=n,e.previousState,e.currentState,e.$on("loading:progress",function(){e.productIsLoading=!0}),e.$on("loading:finish",function(){e.productIsLoading=!1}),e.$on("unauthorized",function(){o.setCurrentUser(null),o.setUserToken(null),n.go("login")}),e.goBack=function(){r.history.back()},e.$on("$stateChangeStart",function(n,e,t,r,c){if(o.getCurrentUser()){var s=o.getUserToken();i.isTokenExpired(s)&&(a.remove("user"),a.remove("token"),u.path("/login"))}}),e.$on("$stateChangeSuccess",function(n,t,r,i,a){e.previousState=i.name,e.currentState=t.name,e.currentUser=o.getCurrentUser()});var s=window.OneSignal||[];s.push(["init",{appId:c.appID,autoRegister:!1,subdomainName:c.domain,notifyButton:{enable:!0}}]),console.log("OneSignal: ",s)}])}();

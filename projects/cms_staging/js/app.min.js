...
!function(){"use strict";function t(t,e,i,a,o){t.pageNumber=1,t.limitWithPage=10,t.totalPages=0,t.auditlogs=[],t.generateActivityLogs=function(e){a.getProductAuditLog(e,{startWith:t.pageNumber-1,limit:t.limitWithPage}).then(function(e){200==e.statusCode&&e.response.success&&(t.auditlogs=e.response.result,t.totalPages=e.response.pagination.pages)})},o&&t.generateActivityLogs(o),t.addMoreItems=function(){t.pageNumber<t.totalPages&&(t.pageNumber=t.pageNumber+1),article_id&&t.generateActivityLogs(article_id)},t.filterDate=function(){},t.cancel=function(){i.dismiss("cancel")}}angular.module("POS17").controller("productAuditLogModalCtrl",t),t.$inject=["$scope","$state","$uibModalInstance","productFactory","product_id"]}();

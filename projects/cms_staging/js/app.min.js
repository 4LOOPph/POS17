...
!function(){"use strict";function e(e,s,l,i,n,t,a){e.file={},e.file=a,console.log("$scope.file: ",e.file),e.file.isFolder?e.file.foldername=e.file.folder_name:e.file.filename=e.file.asset_name,e.Rename=function(){function i(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),l(function(){s.close("save")},100))}e.file.isFolder?t.updateFolder(e.file._id,{folder_name:e.file.foldername}).then(i):t.updateAssetFile(e.file._id,{file_name:e.file.filename}).then(i)},e.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("assetsRenameModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","asset_file"]}();
!function(){"use strict";function t(t,e,s){function a(t,e){if(0==t)return"0 Byte";var s=1024,a=e+1||3,r=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],c=Math.floor(Math.log(t)/Math.log(s));return o=parseFloat((t/Math.pow(s,c)).toFixed(a)),parseFloat((t/Math.pow(s,c)).toFixed(a))+" "+r[c]}console.log("assetsStorageCtrl"),t.items={},t.chart={},t.chart.labels=["Used","Free"],t.chart.data=[0,0],t.chart.colors=["#e74c3c","#bdc3c7"],t.filesize=0;var o=0,r=0;t.initStorage=function(){s.getAllAssets().then(function(e){if(200==e.statusCode&&e.response.success){t.items=e.response.result;var s=_.sumBy(t.items.assets,function(t){return t.asset_filesize});t.filesize=a(s),r=2048-o,t.chart.data=[o,r]}})}}angular.module("POS17").controller("assetsStorageCtrl",t),t.$inject=["$scope","$timeout","assetsFctry"]}();

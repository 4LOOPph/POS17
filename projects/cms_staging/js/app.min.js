...
!function(){"use strict";function e(e,t,s,o,i,l,r,a,c,p){e.name="-Type-",e.status="All",e.txtSearch="",e.type={},e.selectDeselectAll=!1,e.selectedDatas=[],e.selectedToPublish=[],e.pricebooktype=[],e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0};var n=r.getCurrentUser(),u=JSON.parse(n);c.logTransaction("View Pricebooks","PRICEBOOKS","ALL","User:="+u.username+" View all list of pricebooks"),t.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)}),p.getAllTags().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){e.tagsArr.push({id:t.tags_id,label:t.tags,_id:t._id})})}else l.error(t.response.msg,"Error")});var d=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.name="-Type-",e.status="All",e.txtSearch="",e.type={},e.pricebooksTable=new s({page:1,count:10},{counts:[10,25,50,100],getData:function(s,i){t.getAllPricebook().then(function(t){if(200==t.statusCode&&t.response.success){var r=t.response.result;if(e.pricebookscopy=angular.copy(t.response.result),console.log("$scope.txtSearch: ",e.txtSearch),console.log("$scope.type: ",e.type),console.log("$scope.tagsFilter: ",e.tagsFilter),e.txtSearch&&"All"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("1"),e.pricebooks=o("filter")(r,e.txtSearch);else if(e.txtSearch&&"Published"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter)){console.log("2");var a=o("filter")(r,e.txtSearch);e.pricebooks=_.reject(a,{date_approved:null})}else if(e.txtSearch&&"Unpublished"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter)){console.log("3");var a=o("filter")(r,e.txtSearch);e.pricebooks=_.filter(a,{date_approved:null})}else if(e.txtSearch&&"All"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("4");var a=o("filter")(r,e.txtSearch);e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Published"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("5");var a=o("filter")(r,e.txtSearch),c=_.reject(a,{date_approved:null});e.pricebooks=_.filter(c,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Unpublished"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("6");var a=o("filter")(r,e.txtSearch),c=_.filter(a,{date_approved:null});e.pricebooks=_.filter(c,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"All"==e.status&&e.type&&e.tagsFilter){console.log("7");var a=o("filter")(r,e.txtSearch),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("8"),e.pricebooks=r;else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("9"),e.pricebooks=_.reject(r,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&_.isEmpty(e.type)&&_.isEmpty(e.tagsFilter))console.log("10"),e.pricebooks=_.filter(r,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&e.type&&_.isEmpty(e.tagsFilter))console.log("11"),e.pricebooks=_.filter(r,{pricebook_type_id:e.type.pt_id});else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("12");var a=_.reject(r,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&e.type&&_.isEmpty(e.tagsFilter)){console.log("13");var a=_.filter(r,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("14");var n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(r,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("15");var a=_.reject(r,{date_approved:null}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&_.isEmpty(e.type)&&e.tagsFilter){console.log("16");var a=_.filter(r,{date_approved:null}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&e.type&&e.tagsFilter){console.log("17");var a=_.filter(r,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(a,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&e.type&&e.tagsFilter){console.log("18");var a=_.reject(r,{date_approved:null}),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&e.type&&e.tagsFilter){console.log("19");var a=_.filter(r,{date_approved:null}),p=_.filter(a,{pricebook_type_id:e.type.pt_id}),n=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(p,function(t){var s=_.find(t.tags,{tags_id:e.id});s&&n.push(t)})}),e.pricebooks=n}else console.log("else"),e.pricebooks=r;i.total(e.pricebooks.length);var u=e.pricebooks.slice((i.page()-1)*i.count(),i.page()*i.count());e.pricebookLoading=!1,s.resolve(u)}else l.error(t.response.msg,"Error"),e.pricebookLoading=!1})}})};d(),e.selectEvents={onItemSelect:function(t){e.pricebooksTable.reload()},onItemDeselect:function(t){e.pricebooksTable.reload()}},e.refresh=function(){d()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.pricebooks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?(_.find(e.selectedDatas,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedDatas.push(t),_.isNull(t.date_approved)&&(_.find(e.selectedToPublish,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedToPublish.push(t))):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pricebook_id!==t.pricebook_id}),e.selectedToPublish=_.filter(e.selectedToPublish,function(e){return e.pricebook_id!==t.pricebook_id})),e.deleteSomeData=e.selectedDatas.length>0,e.pusblishSomeData=e.selectedToPublish.length>0},e.updateStatus=function(t){console.log("updateStatus"),e.status=t,e.pricebooksTable.reload()},e.updateType=function(t){"-Type-"!==t?(e.type=t,e.name=t.name):(e.name="-Type-",e.type={}),e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()},e.copyDuplicatePricebook=function(s){e.modal={title:"Copy/Duplicate Pricebook?",message:"Are you sure to Copy/Duplicate Pricebook?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.pricebook_id&&t.duplicatePriceBook(s.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),void $timeout(function(){$state.reload()},1e3)):void l.error(e.response.msg,"Error")})})},e.publishSelectedItem=function(s){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebook?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){t.approvedPriceBook(s.pricebook_id,{approved_by:u.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),void $timeout(function(){$state.reload()},1e3)):void l.error(e.response.msg,"Error")})})},e.publishSelected=function(){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebooks?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("$scope.selectedDatas: ",e.selectedDatas);var s=1;async.eachSeries(e.selectedDatas,function(o,i){o.selected&&t.approvedPriceBook(o.pricebook_id,{approved_by:u.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),s++,i(),void 0):void l.error(e.response.msg,"Error")}),s==e.selectedDatas.length&&$timeout(function(){$state.reload()},1e3)})})},e.deleteSelected=function(){e.modal={title:"Delete Pricebook?",message:"Are you sure to Delete this selected pricebooks?"},i.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=1;async.eachSeries(e.selectedDatas,function(o,i){o.selected&&t.deletePriceBook(o.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),s++,i(),void 0):void l.error(e.response.msg,"Error")}),s==e.selectedDatas.length&&$timeout(function(){$state.reload()},1e3)})})}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter","ngDialog","toastr","AuthFctry","localStorageService","transLogFctry","tagsFactory"]}();
!function(){"use strict";function e(e,s,t,o,r,c,n,i,a,l,u,d,g,p){console.log("pricebookDetailController");var k=o.getCurrentUser(),b=JSON.parse(k);e.tagselected=[],e.tags=[],e.tagsArr=[],e.tagschecked=[],e.details={},e.details.isActive=1,e.details.created_by=b.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.item={},e.selectDeselectAll2=!1,e.selectedDatas2=[];var k=JSON.parse(d.get("user"));n.pricebook_id?g.logTransaction("View Pricebook Details","PRICEBOOKS",n.pricebook_id,"User:="+k.username+" View pricebook details: ="+n.pricebook_id):g.logTransaction("Add New Pricebook","PRICEBOOKS","N/A","User:="+k.username+" Add new pricebook entry"),t.getPricebookType().then(function(s){e.pricebooktype=[],200==s.statusCode&&s.response.success&&(e.pricebooktype=s.response.result)}),l.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:r.error(s.response.msg,"Error")}),n.pricebook_id&&(e.displayTab=!0,t.getPricebookDetail(n.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,l.getAllPricebookTags(n.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)}))})),e.tagTransform=function(e){return console.log(e),{tags:e}},e.clearInput=function(e){e.search=""},e.changeSelectDeselectAll2=function(){e.selectDeselectAll2=!e.selectDeselectAll2,_.each(e.tagsArr,function(s){s.checked=e.selectDeselectAll2,e.checkDataChanges2(s)})},e.checkDataChanges2=function(s){s.checked?_.find(e.tagselected,function(e){return e.tags_id===s.tags_id})||e.tagselected.push(s):e.tagselected=_.filter(e.selectedDatas,function(e){return e.tags_id!==s.tags_id})},e.deleteProductTags=function(e){n.pricebook_id&&l.deleteArticleTag(n.pricebook_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void r.success(e.response.msg,"Success"):void r.error(e.response.msg,"Error")})},e.savePricebook=function(){async.waterfall([function(s){n.pricebook_id?t.updatePriceBook(n.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s(null,n.pricebook_id)):void r.error(e.response.msg,"Error")}):t.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void s(null,e.response.result)):void r.error(e.response.msg,"Error")})},function(s,t){var o=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(c,n){c.isTag?l.saveTags(c).then(function(e){return 200==e.statusCode&&e.response.success?void l.savePricebookTags(s,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void n()):void r.error(e.response.msg,"Error")}):void r.error(e.response.msg,"Error")}):l.savePricebookTags(s,{tag_id:c.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void n()):void r.error(e.response.msg,"Error")}),o>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,s){p(function(){c.go(c.current,{pricebook_id:e},{reload:!0})},300)}])}}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams","$filter","ngDialog","tagsFactory","$uibModal","localStorageService","transLogFctry","$timeout"]}();

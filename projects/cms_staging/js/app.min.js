...
=======
!function(){"use strict";angular.module("POS17",["ngSanitize","ngAnimate","ui.router","chart.js","angular-flot","ui.bootstrap","textAngular","ngFileUpload","ui.footable","restangular","toastr","angularMoment","angularSpinner","ngDialog","ui.select","mgcrea.ngStrap","LocalStorageModule","dibari.angular-ellipsis","angular-jwt","color.picker","ja.qr","angularTreeview","angularFileUpload","dndLists","ngTable","kk.timepicker","angularjs-dropdown-multiselect","bootstrapLightbox","videosharing-embed","com.2fdevs.videogular","com.2fdevs.videogular.plugins.controls","com.2fdevs.videogular.plugins.overlayplay","com.2fdevs.videogular.plugins.buffering","info.vietnamcode.nampnq.videogular.plugins.flash","pdf","io.dennis.contextmenu","satellizer","frapontillo.bootstrap-switch","angularRipple","barcode","angular-progress-button-styles","angularPromiseButtons"]).constant("API_URL","http://54.206.38.223:5002").constant("API_VERSION","/api/1.0/").constant("API_URL_2","http://localhost:5004").constant("API_VERSION_2","/api/1.0/").constant("FACEBOOK_API","218087938610404").constant("GOOGLE_API","608675325087-lsbmqc0m5hm6rtosar8bt99agvfce8dh.apps.googleusercontent.com").constant("TWITTER_API","04gzA1YhW0oAm2Aj36J2tcNH3").constant("LINKEDIN_API","81j8xuo5umqyqn").constant("ONESIGNAL",{appID:"b4a5359b-0427-4e97-a1e8-db8af8ebfb3b",domain:"https://4loopph.onesignal.com"})}();
...
>>>>>>> e0dc898e0c31c1d7f00218752a32b442eaadd83c
...
!function(){"use strict";function e(e,s,t,r,n,o,u){e.user={},e.login=function(){r.authenticate(e.user).then(function(e){e.success?(r.setUserToken(e.result.token),r.setCurrentUser(JSON.stringify(e.result.user)),u.logTransaction("User Logged In","LOGIN",e.result.user.username,"User Login for USERNAME:="+e.result.user.username),setTimeout(function(){t.info("Welcome back "+e.result.user.displayName)},2500),setTimeout(function(){s.go("main.dashboard")},3e3)):400===e.statusCode&&!e.response.success&&_.isArray(e.response.result)?_.each(e.response.result,function(e){setTimeout(function(){s.go("login")},2e3)}):(setTimeout(function(){t.error(e.msg,"Error")},3e3),setTimeout(function(){location=""},4e3))})},e.authenticate=function(e){n.authenticate(e).then(function(n){if(n){var i=n.data;console.log("resp: ",i),i.success?(r.setUserToken(i.result.token),r.setCurrentUser(JSON.stringify(i.result.user)),u.logTransaction("Social Media Logged In","LOGIN",i.result.user.username,"User Login for USERNAME:="+i.result.user.username+" TYPE:="+e),t.success("Login successfully with "+e.toUpperCase()+"!"),o(function(){s.go("main.dashboard")},100)):400===i.statusCode&&!i.response.success&&_.isArray(i.response.result)?_.each(i.response.result,function(e){t.warning(e.msg,"Warning")}):t.error(i.msg,"Error")}})["catch"](function(e){e.message?t.error(e.message):e.data?t.error(e.data.message,e.status):t.error(e)})}}angular.module("POS17").config(["$stateProvider",function(e){var s=["$q","$auth",function(e,s){var t=e.defer();return s.isAuthenticated()?t.reject():t.resolve(),t.promise}];e.state("login",{url:"/login",templateUrl:"modules/login/login.html",controller:"LoginCtrl",resolve:{skipIfLoggedIn:s}})}]).controller("LoginCtrl",e),e.$inject=["$scope","$state","toastr","AuthFctry","$auth","$timeout","transLogFctry"]}();
...
!function(){"use strict";function e(e,s,t,o,r,n,i,a,d,c,l,u,p,g,m,h,v,f,y,T,b){e.loading1=!1,e.saveText="Save Entry",e.ptypes=[],e.attributes=[],e.tags=[],e.tagsArr=[],e.product_image=[],e.details={},e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.stockTrack=!1,e._stores={},e._stores.list=[],e._stores.selected=[],e._store={},e._store.selected={},e.inv={},e.inv.stockTrackQty=0,e.inv.stockTrackLevel=0,e.inv.unit={},e.inv.unit.selected={},e.inv.unit.list=[],e.isEnabledstockTrack=!1,e.selectedUnit="",e.isImageNew=!1,e.tabprod={product:!0,media:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},e.barcodeoptions={width:2,height:100,quite:10,displayValue:!0,font:"monospace",textAlign:"center",fontSize:12,backgroundColor:"",lineColor:"#000"},e.barcodesType=[{type:"ean",code:"EAN"},{type:"upc",code:"UPC"},{type:"code39",code:"Code39"},{type:"code128b",code:"Code128B"},{type:"code128c",code:"Code128c"},{type:"itf",code:"ITF"},{type:"itf14",code:"ITF14"}],e.mycode={},e.mycode.type="code128b",e.producttagsSettings={showCheckAll:!0,showUncheckAll:!0,enableSearch:!0,scrollable:!0},d.getAllStore().then(function(s){s&&200==s.statusCode&&s.response.success&&s&&s.response&&s.response.result&&_.each(s.response.result,function(s){e._stores.list.push({id:s.store_id,label:s.name,_id:s._id,address:s.address,isChecked:!1})})}),e.getAllProductUnits=function(){n.getAllProductUnits().then(function(s){s&&200==s.statusCode&&s.response.success?s&&s.response&&s.response.result&&_.each(s.response.result,function(s){e.inv.unit.list.push({_id:s.iu_id,label:s.unit_name,unit_symbol:s.unit_symbol,selected:!1})}):console.log("at else ",s)})},e.getAllStoresByProduct=function(){n.getProductAndStores(r.p_id).then(function(s){if(s&&s.response&&s.response.result&&s.response.result[0]){var t=s.response.result[0];e.inv.inv_id=t?t.inv_id:null,e.inv.stockTrackQty=t?t.stock_onhand:0,e.inv.stockTrackLevel=t?t.reorder_level:0,e.details.conversion_id=t?t.conversion_id:null,e.stockTrack=1==t.is_enable_tracking,e._store.selected={store_id:t.fk_store_id,label:t.name,_id:t._id,address:t.address,inv_id:t.inv_id,deleted:t.deleted}}})},e.getUnitsByProduct=function(){n.getAllProductUnitsByPID(r.p_id).then(function(s){if(s&&s.response&&s.response.result&&s.response.result[0]){var t=s.response.result[0];e.inv.unit.selected={_id:t.iu_id,label:t.unit_name}}})},e.changestockTrack=function(s){e.stockTrack=s},e.changeBarcodeType=function(s){y(function(){e.$apply(function(){e.mycode.type=s})},10)};var P=JSON.parse(T.get("user"));r.p_id?b.logTransaction("View Product Details","PRODUCTS",r.p_id,"User:="+P.username+" View products details: ="+r.p_id):b.logTransaction("Add New Product","PRODUCTS","N/A","User:="+P.username+" Add new product entry"),l.getAllTags().then(function(s){s&&200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:o.error(s.response.msg,"Error")}),_.isEmpty(r.p_id)?(e.showPublish=!1,e.showArchive=!1,e.tabprod={product:!0,media:!1,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},i.getAllProdType().then(function(s){s&&200==s.statusCode&&s.response.success&&(e.ptypes=s.response.result)})):async.waterfall([function(s){i.getAllProdType().then(function(t){t&&200==t.statusCode&&t.response.success?(e.ptypes=t.response.result,s()):o.error(t&&t.response&&t.response.msg?t.response.msg:"Error","Error")})},function(s){n.getProductDetails(r.p_id).then(function(s){s&&200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.tabprod={product:!0,media:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!1,related:!0},e.product_image=e.details.product_images,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),l.getAllProductTags(r.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)}))})}]),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.removethumb=function(){e.details.img_default=null},e.upload=function(s){e.isImageNew=!0},e.archiveProduct=function(e){n.archiveProduct(e).then(function(e){e&&200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.publishProduct=function(e){n.publishProduct(e).then(function(e){e&&200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.deleteProductTags=function(e){r.p_id&&l.deleteProductTag(r.p_id,e.tags_id).then(function(e){return e&&200==e.statusCode&&e.response.success?void o.success(e.response.msg,"Success"):void o.error(e.response.msg,"Error")})},e.openUploader=function(){var e=m.open({animation:!0,templateUrl:"./modules/products/details/product.upload.modal.html",controller:"productUploaderModalCtrl",size:"lg",resolve:{product_id:function(){return r.p_id}}});e.result.then(function(e){s.reload()})},e.openLightboxModal=function(e){var s=[];s.push({url:e.image_path,thumbUrl:e.image_path}),h.openModal(s,0)},e.copyURLLink=function(e){return v.supported?(console.log("files.media_path: ",e.image_path),void v.copyText(e.image_path)):void o.warning("Sorry, copy to clipboard is not supported","Warning")},e.setAsThumbNail=function(t){console.log("files: ",t),e.modal={title:"Set as product thumbnail",message:"Are you sure to set this image?"},f.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){n.setProductImage(r.p_id,t._id).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.reload()):o.warning(e.response.msg,"Warning")})})},e.deleteAllMedia=function(){f.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.p_id&&n.deleteAllProductImage(r.p_id).then(function(e){return e&&200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),void s.reload()):void o.error(e.response.msg,"Error")})})},e.deleteSelected=function(t){console.log("deleteSelected: ",t),f.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("media: ",t),r.p_id&&n.deleteProductImageFile(r.p_id,t._id).then(function(e){return e&&200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),void s.reload()):void o.error(e.response.msg,"Error")})})},e.addProduct=function(){var t=e.inv.unit.selected._id;e.loading1=!0,e.saveText="Saving..",e.validate=[],e.details.item_description="",e.details.selectedUnit=e.selectedUnit,e.details.store_name=e._store.selected.label||null,e.details.stockTrack=e.stockTrack,e.details.store_id=e._store.selected.store_id||e._store.selected.id||null,e.details.stockTrackQty=e.inv.stockTrackQty,e.details.stockTrackLevel=e.inv.stockTrackLevel,e.details.sales_unit_id=t,e.details.purchase_unit_id=null,e.details.qty_convert=null,e.details.inv_id=e.inv.inv_id,async.waterfall([function(s){r.p_id?n.updateProduct(r.p_id,e.details).then(function(t){t&&200==t.statusCode&&t.response.success?(o.success(t.response.msg,"Success"),s(null,r.p_id),console.log("UPDATE"),e.loading1=!1,e.saveText="Save Entry"):(e.validate=t.response.result,_.each(e.validate,function(e){o.warning(t.response.msg,"Error - "+e.msg)}),e.loading1=!1,e.saveText="Save Entry")}):n.saveProduct(e.details).then(function(t){t&&200==t.statusCode&&t.response.success?(o.success(t.response.msg,"Success"),s(null,t.response.result),console.log("SUCCESS"),e.loading1=!1,e.saveText="Save Entry"):(e.validate=t.response.result,_.each(e.validate,function(e){o.warning(t.response.msg,"Error - "+e.msg)}),e.loading1=!1,e.saveText="Save Entry")})},function(s,t){var r=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(n,i){n.isTag?l.saveTags(n).then(function(e){return e&&200==e.statusCode&&e.response.success?void l.saveProductTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void i()):void o.error(e.response.msg,"Error")}):void o.error(e.response.msg,"Error")}):l.saveProductTags(s,{tags_id:n.tags_id}).then(function(e){return e&&200==e.statusCode&&e.response.success?(console.log("insert to product tag"),r++,i(),void 0):void o.error(e.response.msg,"Error")}),r>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,t){s.reload()}])},e.init=function(){e.getAllStoresByProduct(),e.getAllProductUnits(),e.getUnitsByProduct()},e.init()}angular.module("POS17").controller("productsAEController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","tagsFactory","API_URL","API_VERSION","Upload","$uibModal","Lightbox","clipboard","ngDialog","$timeout","localStorageService","transLogFctry"]}();
...
!function(){"use strict";function e(e,t,s,o,n,r,i,a,l,u,d,c,p,f,m,g,h){function v(t){if(t)return _.find(e.suppliers,function(e){return e.s_id==t})}function y(){e.items.quantity=null,e.items.price=null,e.items.total=null,e.items.product={}}e.isColl=!1,e.radioModel="product",e.products=[],e.productBundles=[],e.items={},e.suppliers=[],e.customers=[],e.stores=[],e.details={},e.details.products_list=[],e.details.details=[];var P=!1,M=5e3;e.showMessage=!1,e.showsecondMessage=!1,e.showExportMessage=!1,e.enAbleToSendForm,e.profile={},e.stores.selected={},e.datenow=h(new Date).format("MMMM Do YYYY"),e.doGreeting=function(){P&&a.cancel(P),e.showMessage=!0,P=a(function(){e.showMessage=!1,e.showsecondMessage=!0,P=a(function(){e.showsecondMessage=!1},2e3)},M)},e.doExport=function(){P&&a.cancel(P),e.showExportMessage=!0,P=a(function(){e.showExportMessage=!1,e.showsecondExportMessage=!0,P=a(function(){e.showsecondExportMessage=!1},2e3)},M)},e.changeData=function(t){e.radioModel=t},e.getoveralltotal=function(t){e.overalltotal=_.sumBy(t,function(e){return e.price*e.quantity})},e.getGeneratedPOId=function(){f.generatepoid().then(function(t){e.details.po_number=t.response.result})},e.loadpo=function(){f.getAllPurchaseOrderDetail(r.selected_id).then(function(t){t&&200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.details.emailsubject="PO Number "+e.details.po_number,e.getoveralltotal(e.details.details))})},d.getAllSuppliers().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.suppliers=t.response.result)}),p.getAllPerson().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.customers=_.filter(t.response.result,function(e){return 2==e.per_type_id}))}),u.getAllProduct().then(function(t){if(t&&200==t.statusCode&&t.response.success){var s=t.response.result,o=_.filter(s,function(e){if("Aim Global"==e.store_name)return e});_.each(o,function(t){0==t.is_archived&&null!=t.store_name&&e.products.push(t)})}}),m.getAllStore().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.stores=t.response.result,e.details.store_id=e.stores[0].store_id)}),u.getAllProductBundle().then(function(t){if(t&&200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){1!==t.is_archived&&e.productBundles.push(t)})}}),e.setSelectedStore=function(t){e.stores.selected=t},e.calculateItem=function(e){var t=0,s=0,s=e.price*e.quantity;return t+=parseFloat(s),e.total=t,e.total},e.parseDate=function(e){if(e)return h(new Date(e)).format("MMMM Do YYYY")},e.getCurrentUser=function(){t.userprofile().then(function(t){if(200==t.statusCode&&t.response.success)e.profile=t.response.result,e.currentemail=e.profile.profile.email,e.details.currentemail=e.profile.profile.email;else if(400==t.statusCode&&!t.response.success)return void l.error(t.response.msg,"Error")})},e.toast_emailnotifs=function(e){"Sent"==e||"sent"==e?l.success("Email Sent","Success"):l.warning("Email not Sent","Warning")},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.addToList=function(t){_.isEmpty(t)?l.warning("Product list could not empty","Warning"):"product"==e.radioModel?_.isUndefined(t)||(e.details.details.push({item_name:t.product.item_name,quantity_ordered:t.quantity,quantity:t.quantity,price:t.price,discount:t.discount,total:t.total,product_id:t.product.p_id,bundle_id:null,total_cost:t.quantity*t.price,direct_sending:!0}),e.getoveralltotal(e.details.details),y()):"productgroup"==e.radioModel&&(_.isUndefined(t.productgroup)||(e.details.details.push({item_name:t.productgroup.bundle_name,quantity:t.quantity,quantity_ordered:t.quantity,price:t.price,discount:t.discount,total:t.total,product_id:null,bundle_id:t.productgroup.pb_id,total_cost:t.quantity*t.price,direct_sending:!0}),e.getoveralltotal(e.details.details),y()))},e.approvedPO=function(){var e={approved_by:r.selected_id};f.approvedPurchasedOrder(r.selected_id,e).then(function(e){e&&200==e.statusCode&&e.response.success?l.success(e.response.msg,"Success"):l.error(e?e.response.msg:"Error Found","Eror")})},e.savePO=function(t){var o=JSON.parse(s.get("user"));e.details.created_by=o.uc_id,e.details.emailmessage="",e.details.toSend=t,e.details.products_list=e.details.details,e.details.supplier_id&&e.details.deliver_to&&e.details.po_number?(e.details.suppliername=v(e.details.supplier_id).name,r.selected_id?(console.log("updating PO."),f.updatePurchaseOrder(r.selected_id,e.details).then(function(s){if(s&&200==s.statusCode&&s.response.success){l.success(s.response.msg,"Success");r.selected_id;t&&e.approvedPO(),i.go("main.view_savepo",{selected_id:r.selected_id})}else l.error(s?s.response.msg:"Error Found","Eror");t?e.toast_emailnotifs(s&&s.response.email?s.response.email:"Error Found"):""})):(console.log("saving PO."),f.savePurchaseOrder(e.details).then(function(s){if(s&&200==s.statusCode&&s.response.success){l.success(s.response.msg,"Success");var o=s.response.result.inserted_po_id;t&&e.approvedPO(),i.go("main.view_savepo",{selected_id:o})}else l.error(s?s.response.msg:"Error Found","Eror");t?e.toast_emailnotifs(s&&s.response.email?s.response.email:"Error Found"):""}))):l.warning("Fill in all the required fields in the first tab","Warning")},e.toggleModal=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log(".."),e.backto_fstpasge()},function(e){console.log("reason ",e)})},e.calculateItems=function(t){var s=0,o=0;_.each(e.details.products_list,function(e){var t=e.price-e.discount;s=t*e.quantity,o+=parseFloat(s)}),e.details.sub_total=o,e.calculateBilling()},e.calculateBilling=function(){e.total=parseFloat(e.details.sub_total||0)+parseFloat(e.details.tax||0)+parseFloat(e.details.shipping_fee||0)},e.removeProduct=function(t){e.details.details.splice(t,1)},e.edit=function(e){i.go("main.products-add",{p_id:e})},e.openPOUpdateModal=function(t){e.enAbleToSendForm=t,t?e.details.po_status="Sent":e.details.po_status="Open",e.details.emailsubject="PO Number "+e.details.po_number,g.openConfirm({templateUrl:"./modules/purchase_order/po.update.modal.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){e.savePO(t)},function(e){console.log("Modal promise close: ")})},e.open_scndpage=function(){e.fstpasge=!1,e.scndpage=!0},e.onSelectedProduct=function(t){e.items.price=t.sell_price},e.goback=function(){i.go("main.purchase_order")},e.init=function(){e.getCurrentUser(),r.selected_id?e.loadpo():e.getGeneratedPOId()},e.init()}angular.module("POS17").controller("addOrderController",e),e.$inject=["$scope","AuthFctry","localStorageService","$http","$filter","$stateParams","$state","$timeout","toastr","productFactory","supplierFctry","ngTableParams","humanFactory","purchaseOrderFactory","storeFactory","ngDialog","moment"]}();
...
!function(){"use strict";function e(e,s,t,r,a,n,o,i,l,d,c,p,u,m,f,g,h,v){function S(s){var t=[];_.each(e.details,function(e){console.log("innerval ",e),t.push({product_id:e.product_id,price:e.splycst,quantity:e.qtyrecv,quantity_ordered:e.quantity_ordered,stock_onhand:e.stock_onhand,fk_store_id:100})});return t}e.datenow=h(new Date).format("MMMM Do YYYY"),e.parent_details={},e.details=[],e.po_status="",e.po_id="",e.enAbleToSendForm,e.params={},e.params.arrOfPOIds=[],e.details2=[],e.specialVar1=[],e.specialVar2=[],n.selected_id&&(e.po_id=n.selected_id,m.getAllPurchaseOrderDetail(e.po_id).then(function(s){if(s&&200==s.statusCode&&s.response.success){e.parent_details=s.response.result,e.details=s.response.result.details,e.parent_details.products_list=e.details,e.parent_details.emailsubject="PO Number "+e.parent_details.po_number,e.fstpasge=!1,e.scndpage=!0,e.getoveralltotal(e.details);var t=e.parent_details.po_status;"Open"==t||"open"==t||"OPEN"==t?e.po_status="Saved":"Sent"==t||"sent"==t||"SENT"==t?e.po_status="Sent":e.po_status=t,_.each(e.details,function(s,t){e.details[t].splycst=s.price})}else console.log("no data fetched !")}),e.getoveralltotal=function(s){e.overalltotal=_.sumBy(s,function(e){return e.price*e.quantity_ordered})},e.parseDate=function(e){if(e)return h(new Date(e)).format("MMMM Do YYYY")},e.backto_fstpasge=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){e.fstpasge=!0,e.scndpage=!1;n.selected_id;o.go("main.purchase_order")},function(e){console.log("reason ",e)})},e.getCurrentUser=function(){s.userprofile().then(function(s){if(200==s.statusCode&&s.response.success)e.profile=s.response.result,e.currentemail=e.profile.profile.email,e.parent_details.currentemail=e.profile.profile.email;else if(400==s.statusCode&&!s.response.success)return void l.error(s.response.msg,"Error")})},e.toast_emailnotifs=function(e){"Sent"==e||"sent"==e?l.success("Email Sent","Success"):l.warning("Email not Sent","Warning")},e.cancelPO=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=JSON.parse(t.get("user"));e.parent_details.created_by=s.uc_id,e.parent_details.suppliername=e.parent_details.supplier.name,e.parent_details.po_status="Cancelled",e.parent_details.products_list=e.details,e.parent_details.supplier_id&&e.parent_details.deliver_to&&e.parent_details.po_number?n.selected_id?m.updatePurchaseOrder(n.selected_id,e.parent_details).then(function(e){e&&200==e.statusCode&&e.response.success?(l.success("PO status Cancelled","Success"),o.reload()):l.error(e?e.response.msg:"Error Found","Eror")}):m.savePurchaseOrder(e.parent_details).then(function(e){e&&200==e.statusCode&&e.response.success?l.success("PO status Cancelled","Success"):l.error(e?e.response.msg:"Error Found","Eror")}):l.warning("Fill in all the required fields in the first tab","Warning")},function(e){console.log("reason ",e)})},e.approvedPO=function(){var e={approved_by:n.selected_id};m.approvedPurchasedOrder(n.selected_id,e).then(function(e){e&&200==e.statusCode&&e.response.success?l.success(e.response.msg,"Success"):l.error(e?e.response.msg:"Error Found","Eror")})},e.savePO2=function(s){var r=JSON.parse(t.get("user"));e.parent_details.created_by=r.uc_id,e.parent_details.po_status="Sent",e.parent_details.toSend=s,e.parent_details.products_list=e.details,e.parent_details.supplier_id&&e.parent_details.deliver_to&&e.parent_details.po_number?(e.parent_details.suppliername=e.parent_details.supplier.name,n.selected_id&&m.updatePurchaseOrder(n.selected_id,e.parent_details).then(function(t){if(t&&200==t.statusCode&&t.response.success){l.success(t.response.msg,"Success");n.selected_id;s&&(e.approvedPO(),o.reload())}else l.error(t?t.response.msg:"Error Found","Eror");s?e.toast_emailnotifs(t&&t.response.email?t.response.email:"Error Found"):""})):l.warning("Fill in all the required fields in the first tab","Warning")},e.openPOUpdateModal2=function(s){e.enAbleToSendForm=s,e.parent_details.po_status="",g.openConfirm({templateUrl:"./modules/purchase_order/po.sendsaved.modal.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){e.savePO2(s)},function(e){console.log("Modal promise close: ")})},e.updateReceiveItemScope=function(s,t){e.details[t].qtyrecv=e.specialVar1[t]},e.updateSupplyCostScope=function(s,t){e.details[t].splycst=e.specialVar2[t]},e.promptMsg1=function(s){e.specialVar1[s]="",l.warning("Receive count must be less than or equal to number of items ordered","Warning")},e.checkSpecialVar1=function(){var s=_.find(e.specialVar1,"");return s},e.receivePO=function(){e.obj={po_id:n.selected_id,receive_number:"",receive_date:h(new Date).format("MMMM Do YYYY, h:mm:ss a"),received_by:e.profile.profile.person_id,supplier_id:e.parent_details.supplier_id,products_list:S(),store_id:100},m.receivePurchasedOrder(e.obj).then(function(e){e&&200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),o.reload()):l.error(e?e.response.msg:"Error Found","Eror")})},e.reactivatePO=function(){l.warning("This Feature is not yet implemented..","Warning")},e.init=function(){e.getCurrentUser()},e.init())}angular.module("POS17").controller("viewSavedPOController",e),e.$inject=["$scope","AuthFctry","localStorageService","$http","$filter","$stateParams","$state","$timeout","toastr","productFactory","supplierFctry","ngTableParams","humanFactory","purchaseOrderFactory","storeFactory","ngDialog","moment"]}();
...
!function(){"use strict";function e(e,o,t,i,s,c,r,n){function d(e){var o={};return o.price_sched_day_id=e.selectedDay.id,o.time_start=e.time_from,o.time_end=e.time_to,o.notify_me=e.isnotifyme,o.is_active=e.isactive,o}function a(e){var o={};return o.price_sched_day_id=e.selectedDay.id,o.time_start=e.time_start,o.time_end=e.time_end,o.notify_me=e.notify_me,o.is_active=e.is_active,o.price_sched_id=e.price_sched_id,o}e.settings={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.settings1={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.example8model=[],e.example8data=[{id:1,label:"Accessories"},{id:2,label:"Headset"},{id:3,label:"Mobile Headset"},{id:4,label:"Wearables"}],e.days=[],e.isnotifyme=!1,e.startWith=0,e.limit=10,e.queryparams={startWith:e.startWith,limit:e.limit},e.pricebook_publish={},e.details=[],e.isToUpdate=!1,e.selectedSchedule={},e.pricebook={},e.pricebook.days=[{id:1,label:"Monday"},{id:2,label:"Tuesday"},{id:3,label:"Wednesday"},{id:4,label:"Thursday"},{id:5,label:"Friday"},{id:6,label:"Saturday"},{id:7,label:"Sunday"},{id:8,label:"Everyday"}],e.filterDaysSelected=function(o){var t=_.filter(e.pricebook.days,function(e){return o===e.label});e.pricebook.days.selected=t[0]},e.getPricebookSched=function(){n.getPricebookSchedule(i.pricebook_id,e.queryparams).then(function(o){e.listOfSchedules=o.response.result})},e.getPriceBookDetails=function(){n.getPricebookDetail(i.pricebook_id).then(function(o){e.pricebook_details=o.response.result})},e.openScheduleModal=function(t){c.openConfirm({templateUrl:"./modules/pricebook/pricebook.schedule.modal.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){e.pricebook.selectedDay=e.pricebook.days.selected,e.pricebook._id=i.pricebook_id;var t=d(e.pricebook);n.createPricebookSchedule(e.pricebook._id,t).then(function(t){t.response&&t.response.success?(o.success(t.response.msg,"Success"),e.getPricebookSched()):(o.error(t.response.msg,"Error"),e.getPricebookSched())})},function(e){console.log("Modal promise close: ")})},e.openScheduleModalForEdit=function(t){e.filterDaysSelected(t.day_name),e.selectedSchedule=t,c.openConfirm({templateUrl:"./modules/pricebook/pricebook.schedule.modalEdit.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){t.selectedDay=e.pricebook.days.selected;var s=a(t);n.updatepricebookSchedule(i.pricebook_id,s.price_sched_id,s).then(function(t){t.response&&t.response.success?(o.success(t.response.msg,"Success"),e.getPricebookSched()):(o.error(t.response.msg,"Error"),e.getPricebookSched())})},function(e){console.log("Modal promise close: ")})},e.deletePriceBookSched=function(t){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){n.deletepricebookSchedule(i.pricebook_id,t).then(function(t){t.response&&t.response.success?(o.success(t.response.msg,"Success"),e.getPricebookSched()):(o.error(t.response.msg,"Error"),e.getPricebookSched())})},function(e){console.log("Modal promise close: ")})},e.toogle_notifyme=function(){1!=e.isnotifyme},e.toggle_active=function(t){e.filterDaysSelected(t.day_name),t.selectedDay=e.pricebook.days.selected;var s=a(t);n.updatepricebookSchedule(i.pricebook_id,s.price_sched_id,s).then(function(t){t.response&&t.response.success?(o.success(t.response.msg,"Success"),e.getPricebookSched()):(o.error(t.response.msg,"Error"),e.getPricebookSched())})},e.parseDateFormat=function(e){return moment(e).format("YYYY MMM DD")},e.init=function(){e.getPricebookSched(),e.getPriceBookDetails()},e.init()}angular.module("POS17").controller("pricebookAssignCtrl",e),e.$inject=["$scope","toastr","$state","$stateParams","$filter","ngDialog","$uibModal","pricebookFactory"]}();
!function(){"use strict";function e(e,t,o,s,r,i,c,n,a,l,p){function u(e,t,o){var s=0;return s=(parseFloat(e)+parseFloat(t)-parseFloat(o)/100).toFixed(2)}function d(t){if(_.isEmpty(t))return void s.error("Please set values for Selling Price, Margin and Discount","Error");if(!(e.selectedDatas.length>0))return void s.error("Please select items to map","Error");if(i.pricebook_id){var r=1;async.eachSeries(e.selectedDatas,function(c,n){var a={};a.bundle_id=c.bundle_id,a.product_id=c.product_id,a.min_quantity=_.isEmpty(t.min_quantity)?c.min_quantity:t.min_quantity,a.max_quantity=_.isEmpty(t.max_quantity)?c.max_quantity:t.max_quantity,a.markup=_.isEmpty(t.margin)?c.markup:t.margin,a.discount=_.isEmpty(t.discount)?c.discount:t.discount,a.sell_price=c.sell_price,console.log("reqData: ",a),c.pi_id?o.updatePriceBookItem(i.pricebook_id,c.pi_id,a).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),r++,n(),void 0):void s.error(e.response.msg,"Error")}):o.savePriceBookItem(i.pricebook_id,a).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),r++,n(),void 0):void s.error(e.response.msg,"Error")}),r==e.selectedDatas.length&&e.refreshData()})}}console.log("pricebookProductCtrl"),e.products=[],e.productscopy=[],e.bundles=[],e.bundlescopy=[],e.pricebookItems=[],e.pricebookItemsCopy=[],e.selectedDatas=[],e.selectDeselectAllProduct=!1,e.txtProductSearch="",e.tagsArr=[],e.tagsFilter=[],e.example8settings={showCheckAll:!1,showUncheckAll:!1,enableSearch:!0,scrollableHeight:"300px",scrollable:!0},l.getAllTags().then(function(t){if(200==t.statusCode&&t.response.success){var o=t.response.result;_.each(o,function(t){e.tagsArr.push({id:t.tags_id,label:t.tags,_id:t._id})})}else s.error(t.response.msg,"Error")}),i.pricebook_id&&(e.pricebookItems=[],e.pricebookItemsCopy=[],o.getAllPriceBookItem(i.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.pricebookItems=t.response.result,_.each(e.pricebookItems,function(e){e.popoverIsOpen=!1,e.selling_price=u(e.sell_price||0,e.markup||0,e.discount||0)}),e.pricebookItemsCopy=angular.copy(e.pricebookItems))})),e.selectEvents={onItemSelect:function(t){console.log("property: ",t),e.searchProductData()},onItemDeselect:function(t){console.log("property: ",t),e.searchProductData()}},e.tagTransform=function(e){return{tags:e}},e.showTooltip1=function(t){_.each(e.pricebookItems,function(e){t.pi_id!==e.pi_id?e.popoverIsOpen=!1:e.selling_price=u(e.sell_price||0,e.markup||0,e.discount||0)});var o=_.find(e.pricebookItems,{pi_id:t.pi_id});o&&(o.popoverIsOpen?o.popoverIsOpen=!1:o.popoverIsOpen=!0)},e.onCalculateRowPrice=function(t){_.each(e.pricebookItems,function(e){t.pi_id==e.pi_id&&(e.selling_price=u(e.sell_price||0,e.markup||0,e.discount||0))})},e.onCalculatePrice=function(){e.product.selling_price=u(e.product.sell_price||0,e.product.markup||0,e.product.discount||0)},e.applyItemPrice=function(e){_.isEmpty(e)||i.pricebook_id&&o.updatePriceBookItemPrice(i.pricebook_id,e.pi_id,{sell_price:e.sell_price,markup:e.markup,discount:e.discount,min_quantity:e.min_quantity,max_quantity:e.max_quantity}).then(function(t){return 200==t.statusCode&&t.response.success?(s.success(t.response.msg,"Success"),void(e.popoverIsOpen=!1)):void s.error(t.response.msg,"Error")})},e.searchProductData=function(){if(e.txtProductSearch&&_.isEmpty(e.tagsFilter))console.log("1");else if(_.isEmpty(e.txtProductSearch)&&e.tagsFilter){var t=[];e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(o){_.each(e.pricebookItemsCopy,function(e){var s=_.find(e.product_tags,{tags_id:o.id});s&&t.push(e)})}),e.pricebookItems=t}else if(e.txtProductSearch&&e.tagsFilter){var t=[],o=c("filter")(e.pricebookItemsCopy,e.txtProductSearch);e.tagsFilter&&e.tagsFilter.length>0&&_.each(e.tagsFilter,function(e){_.each(o,function(o){var s=_.find(o.product_tags,{tags_id:e.id});s&&t.push(o)})}),e.pricebookItems=t}else e.refreshData()},e.changeSelectDeselectAllProduct=function(){_.each(e.pricebookItems,function(t){t.selected=e.selectDeselectAllProduct,e.checkDataChanges(t)})},e.clickselect=function(){console.log("sadasdsadsa")},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.pi_id===t.pi_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pi_id!==t.pi_id})},e.refreshData=function(){console.log("refreshData"),e.pricebookItems=[],e.pricebookItemsCopy=[],o.getAllPriceBookItem(i.pricebook_id).then(function(t){200==t.statusCode&&t.response.success&&(e.pricebookItems=t.response.result,_.each(e.pricebookItems,function(e){e.popoverIsOpen=!1,e.selling_price=u(e.sell_price||0,e.markup||0,e.discount||0)}),e.pricebookItemsCopy=angular.copy(e.pricebookItems))})},e.addNewEntry=function(){var t=a.open({animation:!0,templateUrl:"./modules/pricebook/pricebook.product.modal.html",controller:"pricebookProductModalCtrl",size:"md"});t.result.then(function(t){e.refreshData()})},e.deleteSelected=function(){e.modal={title:"Remove Items on Pricebook?",message:"Are you sure to remove pricebook for this selected product?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){if(!(e.selectedDatas.length>0))return void s.error("Please select products to map","Error");if(i.pricebook_id){var t=1;async.eachSeries(e.selectedDatas,function(r,c){r.pi_id&&o.deletePriceBookItem(i.pricebook_id,r.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),t++,c(),void 0):void s.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&e.refreshData()})}})},e.deleteSelectedItem=function(t){e.modal={title:"Remove Pricebook Item?",message:"Are you sure to remove this item?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){i.pricebook_id&&o.deletePriceBookItem(i.pricebook_id,t.pi_id).then(function(t){return 200==t.statusCode&&t.response.success?(s.success(t.response.msg,"Success"),void e.refreshData()):void s.error(t.response.msg,"Error")})})},e.savePricebookItems=function(t){e.modal={title:"Apply batch update",message:"Are you sure to apply this change on the selected product?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){d(t)})}}angular.module("POS17").controller("pricebookProductCtrl",e),e.$inject=["$scope","productFactory","pricebookFactory","toastr","$state","$stateParams","$filter","ngDialog","$uibModal","tagsFactory","$timeout"]}();
!function(){"use strict";function t(t,c,o,e,r,u,n){t.pb_product={},t.pb_product.markup=0,t.pb_product.discount=0,t.pricebookProducts=[],t.pricebookProductBundles=[],t.radioModel="product",t.infiniteScrollContacts={},t.infiniteScrollContacts.numToAdd=10,t.infiniteScrollContacts.currentItems=10,t.$watch("pb_product.product",function(c){c&&(t.pb_product.sell_price=c.sell_price,t.pb_product.selling_price=t.calculateSellingPrice(c.sell_price,t.pb_product.markup||0,t.pb_product.discount||0))}),t.$watch("pb_product.productgroup",function(c){c&&(t.pb_product.sell_price=c.sell_price,t.pb_product.selling_price=t.calculateSellingPrice(c.sell_price,t.pb_product.markup||0,t.pb_product.discount||0))}),t.calculateSellingPrice=function(t,c,o){var e=0;return e=(parseFloat(t)+parseFloat(c)-parseFloat(o)/100).toFixed(2),console.log("value: ",e),e},t.onCalculatePrice=function(){t.pb_product.selling_price=t.calculateSellingPrice(t.pb_product.sell_price||0,t.pb_product.markup||0,t.pb_product.discount||0)},async.waterfall([function(c){e.getAllProduct().then(function(o){if(200==o.statusCode&&o.response.success){var e=o.response.result;_.each(e,function(c){c.selected=!1,1==c.is_published&&t.pricebookProducts.push(c)}),_.uniqBy(t.pricebookProducts,function(t){return t.p_id}),c(null,e)}})},function(c,o){e.getAllProductBundle().then(function(c){if(200==c.statusCode&&c.response.success){var o=c.response.result;_.each(o,function(c){c.selected=!1,1==c.is_published&&t.pricebookProductBundles.push(c)}),_.uniqBy(t.pricebookProductBundles,function(t){return t.pb_id})}})}]),t.resetInfScroll=function(){t.infiniteScrollContacts.currentItems=t.infiniteScrollContacts.numToAdd},t.addMoreItems=function(){t.infiniteScrollContacts.currentItems+=t.infiniteScrollContacts.numToAdd},t.changeData=function(c){t.radioModel=c},t.saveEntry=function(){"product"==t.radioModel?(t.pb_product.product_id=t.pb_product.product.p_id,t.pb_product.bundle_id=null):(t.pb_product.bundle_id=t.pb_product.productgroup.pb_id,t.pb_product.product_id=null),n.savePriceBookItem(u.pricebook_id,{markup:t.pb_product.markup,discount:t.pb_product.discount,sell_price:t.pb_product.sell_price,min_quantity:t.pb_product.min_quantity,max_quantity:t.pb_product.max_quantity,bundle_id:t.pb_product.bundle_id,product_id:t.pb_product.product_id}).then(function(t){if(200==t.statusCode&&t.response.success)o.success(t.response.msg,"Success"),r(function(){c.close()},100);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void o.error(t.response.msg,"Error");_.each(t.response.result,function(t){o.warning(t.msg,"Warning")})}})},t.cancel=function(){c.dismiss("cancel")}}angular.module("POS17").controller("pricebookProductModalCtrl",t),t.$inject=["$scope","$uibModalInstance","toastr","productFactory","$timeout","$stateParams","pricebookFactory"]}();
...
!function(){"use strict";function t(t,e,a){function s(t,e){if(0==t)return"0 Byte";var a=1024,s=e+1||3,l=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],r=Math.floor(Math.log(t)/Math.log(a));return parseFloat((t/Math.pow(a,r)).toFixed(s))+" "+l[r]}t.items={},t.chart={},t.chart.labels=["Used","Free"],t.chart.data=[0,0],t.chart.colors=["#1a5350","#ffffff"],t.chart.options={},Chart.defaults.global.legend.display=!0,Chart.defaults.global.scaleLabel=function(t){return t.value.toString().replace(/\B(?=(\d{3})+(?!\d))/g,".")},Chart.defaults.global.multiTooltipTemplate=function(t){return t.datasetLabel+":== "+t.value.toString().replace(/\B(?=(\d{3})+(?!\d))/g,".")},t.filesize=0;var l=0;t.initStorage=function(){a.getAllAssets().then(function(e){if(200==e.statusCode&&e.response.success){t.items=e.response.result;var a=_.sumBy(t.items.assets,function(t){return t.asset_filesize});t.filesize=s(a);var r=2147483648;l=r-a,t.chart.data=[a,l],t.chart.options={legend:{display:!0},tooltips:{enabled:!0,mode:"single",callbacks:{label:function(t,e){var a=e.labels[t.index],l=e.datasets[t.datasetIndex].data[t.index];return a+": "+s(l)}}}}}})}}angular.module("POS17").controller("assetsStorageCtrl",t),t.$inject=["$scope","$timeout","assetsFctry"]}();

...
!function(){"use strict";function t(t,c,o,r,u,e,p){t.pb_product={},t.pb_product.markup=0,t.pb_product.discount=0,t.pb_product.min_quantity=0,t.pb_product.max_quantity=0,t.pricebookProducts=[],t.pricebookProductBundles=[],t.radioModel="product",t.infiniteScrollContacts={},t.infiniteScrollContacts.numToAdd=10,t.infiniteScrollContacts.currentItems=10,t.$watch("pb_product.product",function(c){c&&(t.pb_product.sell_price=c.sell_price,t.pb_product.selling_price=t.calculateSellingPrice(c.sell_price,t.pb_product.markup||0,t.pb_product.discount||0))}),t.$watch("pb_product.productgroup",function(c){c&&(t.pb_product.sell_price=c.sell_price,t.pb_product.selling_price=t.calculateSellingPrice(c.sell_price,t.pb_product.markup||0,t.pb_product.discount||0))}),t.calculateSellingPrice=function(t,c,o){var r=0;return r=(parseFloat(t)+parseFloat(c)-parseFloat(o)/100).toFixed(2),console.log("value: ",r),r},t.onCalculatePrice=function(){t.pb_product.selling_price=t.calculateSellingPrice(t.pb_product.sell_price||0,t.pb_product.markup||0,t.pb_product.discount||0)},async.waterfall([function(c){r.getAllProduct().then(function(o){if(200==o.statusCode&&o.response.success){var r=o.response.result;_.each(r,function(c){c.selected=!1,1==c.is_published&&t.pricebookProducts.push(c)}),_.uniqBy(t.pricebookProducts,function(t){return t.p_id}),c(null,r)}})},function(c,o){r.getAllProductBundle().then(function(c){if(200==c.statusCode&&c.response.success){var o=c.response.result;_.each(o,function(c){c.selected=!1,1==c.is_published&&t.pricebookProductBundles.push(c)}),_.uniqBy(t.pricebookProductBundles,function(t){return t.pb_id})}})}]),t.resetInfScroll=function(){t.infiniteScrollContacts.currentItems=t.infiniteScrollContacts.numToAdd},t.addMoreItems=function(){t.infiniteScrollContacts.currentItems+=t.infiniteScrollContacts.numToAdd},t.changeData=function(c){t.radioModel=c,"product"==c?t.pb_product.product=void 0:t.pb_product.productgroup=void 0,t.pb_product.selling_price="",t.pb_product.markup=0,t.pb_product.discount=0,t.pb_product.min_quantity=0,t.pb_product.max_quantity=0},t.saveEntry=function(){"product"==t.radioModel?(t.pb_product.product_id=t.pb_product.product.p_id,t.pb_product.bundle_id=null):(t.pb_product.bundle_id=t.pb_product.productgroup.pb_id,t.pb_product.product_id=null),p.savePriceBookItem(e.pricebook_id,{markup:t.pb_product.markup,discount:t.pb_product.discount,sell_price:t.pb_product.sell_price,min_quantity:t.pb_product.min_quantity,max_quantity:t.pb_product.max_quantity,bundle_id:t.pb_product.bundle_id,product_id:t.pb_product.product_id}).then(function(t){if(200==t.statusCode&&t.response.success)o.success(t.response.msg,"Success"),u(function(){c.close()},100);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void o.error(t.response.msg,"Error");_.each(t.response.result,function(t){o.warning(t.msg,"Warning")})}})},t.cancel=function(){c.dismiss("cancel")}}angular.module("POS17").controller("pricebookProductModalCtrl",t),t.$inject=["$scope","$uibModalInstance","toastr","productFactory","$timeout","$stateParams","pricebookFactory"]}();
...
!function(){"use strict";function e(e,s,o,c,t,n,r,i,u){e.group={};var a=JSON.parse(i.get("user"));s.article_id?u.logTransaction("View Pricebook Type Details","PRICEBOOK TYPES",s.article_id,"User:="+a.username+" View Pricebook Type details:="+s.article_id):u.logTransaction("Add New Pricebook Type","PRICEBOOK TYPES","N/A","User:="+a.username+" Add new Pricebook Type entry"),_.isNull(n)||r.getPriceBookType(n).then(function(s){200==s.statusCode&&s.response.success&&(e.group=s.response.result)}),e.savePriceBook=function(){_.isNull(n)?r.savePriceBookType(e.group).then(function(s){200==s.statusCode&&s.response.success&&(t.success("Successfully Added","Success"),c(function(){e.$apply(function(){o.close("save")})},100))}):r.updatePriceBookType(n,e.group).then(function(s){200==s.statusCode&&s.response.success&&(t.success("Successfully Update","Success"),c(function(){e.$apply(function(){o.close("save")})},100))})},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("priceBookTypeModal",e),e.$inject=["$scope","$stateParams","$uibModalInstance","$timeout","toastr","group","pricebookFactory","localStorageService","transLogFctry"]}();

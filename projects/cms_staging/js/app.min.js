...
!function(){"use strict";angular.module("POS17").factory("jQuery",["$window",function(n){return n.jQuery}]).factory("_",["$window",function(n){return n.jQuery}]).factory("PDFJS",["$window",function(n){return n.PDFJS}]).factory("async",["$window",function(n){return n.async}]).constant("ONESIGNAL",{appID:"b4a5359b-0427-4e97-a1e8-db8af8ebfb3b",domain:"https://4loopph.onesignal.com"}).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location","ONESIGNAL",function(n,e,t,o,r,a,i,u,c){e.currentUser={},e.$state=n,e.previousState,e.currentState,e.$on("loading:progress",function(){e.productIsLoading=!0}),e.$on("loading:finish",function(){e.productIsLoading=!1}),e.$on("unauthorized",function(){o.setCurrentUser(null),o.setUserToken(null),n.go("login")}),e.goBack=function(){r.history.back()},e.$on("$stateChangeStart",function(n,e,t,r,c){if(o.getCurrentUser()){var s=o.getUserToken();a.isTokenExpired(s)&&(i.remove("user"),i.remove("token"),u.path("/login"))}}),e.$on("$stateChangeSuccess",function(n,t,r,a,i){e.previousState=a.name,e.currentState=t.name,e.currentUser=o.getCurrentUser()});var s=window.OneSignal||[];s.push(["init",{appId:c.appID,autoRegister:!1,subdomainName:c.domain,notifyButton:{enable:!0}}])}])}();
...
!function(){"use strict";function e(e,t,s,c,r,o,i,a,d,n){function l(){a.getAllCategory().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){var c=t.label,r=t.name,o=t.description,i=t.parent_id,a=t.c_id,d=_.filter(s,{parent_id:a.toString()});_.isNull(i)&&e.categoryData.push({parentid:i,description:o,label:c,name:r,c_id:a,item:{parentid:i,description:o,label:c,name:r,c_id:a},items:d})}),e.categoryDataCopy=angular.copy(e.categoryData)}})}e.search={},e.currentNode={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.isList=!1,e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.categories=[],e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.selectedArchivedDatas=[],e.categoryData=[],e.categoryDataCopy=[],e.productsToFilter=[];e.side=!1;var u=function(){e.productTable=new d({page:1,count:20},{counts:[20,45,60,100],getData:function(t,c){e.productIsLoading=!0,e.products=[],e.productscopy=[],i.getAllProduct().then(function(r){if(200==r.statusCode&&r.response.success){var i=r.response.result;if(e.totalItems=i.length,e.productscopy=angular.copy(r.response.result),e.txtSearch&&"All"==e.applicationStatus&&e.currentNode)console.log("1"),e.products=s("filter")(i,e.txtSearch);else if(e.txtSearch&&"Publish"==e.applicationStatus&&e.currentNode)console.log("2"),e.products=s("filter")(i,{is_published:1}),e.products=s("filter")(e.products,e.txtSearch);else if(e.txtSearch&&"Archived"==e.applicationStatus&&e.currentNode)console.log("3"),e.products=s("filter")(i,{is_archived:1}),e.products=s("filter")(e.products,e.txtSearch);else if(e.txtSearch&&"Draft"==e.applicationStatus&&e.currentNode)console.log("4"),e.products=s("filter")(i,{is_published:0}),e.products=s("filter")(e.products,e.txtSearch);else if(_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus)_.isEmpty(e.currentNode)?e.products=i:_.each(e.productsToFilter,function(t){var s=_.find(i,{p_id:t.p_id});s&&e.products.push(s)});else if(_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus)if(console.log("6"),_.isEmpty(e.currentNode))e.products=s("filter")(i,{is_published:1});else{var a=s("filter")(i,{is_published:1});_.each(e.productsToFilter,function(t){var s=_.find(a,{p_id:t.p_id});s&&e.products.push(s)})}else if(_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus)if(console.log("7"),_.isEmpty(e.currentNode))e.products=s("filter")(i,{is_archived:1});else{var a=s("filter")(i,{is_archived:1});_.each(e.productsToFilter,function(t){var s=_.find(a,{p_id:t.p_id});s&&e.products.push(s)})}else if(_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus)if(console.log("8"),_.isEmpty(e.currentNode))e.products=s("filter")(i,{is_published:0});else{var a=s("filter")(i,{is_published:0});_.each(e.productsToFilter,function(t){var s=_.find(a,{p_id:t.p_id});s&&e.products.push(s)})}else e.products=i;c.total(e.products.length);var d=e.products.slice((c.page()-1)*c.count(),c.page()*c.count());t.resolve(d),e.productIsLoading=!1}else e.productIsLoading=!1,o.error(r.response.msg,"Error")})}})};e.changeDisplay=function(){e.isList=!e.isList},e.filterByCategory=function(t){var s=[],c={},r={},o=[];if(e.currentNode=t,e.currentNode&&angular.isObject(e.currentNode)){var i=_.find(e.categoryDataCopy,{parentid:t.c_id});if(_.isUndefined(i)){var a=_.map(e.productscopy,function(t){var s=_.filter(t.product_category,{category_id:e.currentNode.c_id});if(s.length>0)return _.find(s,function(e){return e})});r=_.filter(a,function(e){if(!_.isUndefined(e))return e}),c=_.map(_.uniqBy(r,"product_id"),function(e){return e.product_id}),_.forEach(c,function(t){s.push(_.find(e.productscopy,{p_id:t}))})}else{var d=_.map(i.items,function(e){return{c_id:e.item.c_id}});_.each(e.productscopy,function(e){_.each(d,function(t){var s=_.filter(e.product_category,{category_id:t.c_id});s&&s.length>0&&o.push(s[0])})});var n=_.map(_.uniqBy(o,"product_id"),function(e){return e.product_id});_.forEach(n,function(t){s.push(_.find(e.productscopy,{p_id:t}))})}}e.productsToFilter=s,e.productTable.reload()},l(),u(),a.getAllCategory().then(function(t){200==t.statusCode&&t.response.success&&(e.categories=t.response.result)}),e.setPage=function(t){e.currentPage=t},e.setItemsPerPage=function(t){e.itemsPerPage=t,e.currentPage=1},e.edit=function(e){c.go("main.products-add",{p_id:e})},e.searchData=function(){e.productTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productTable.reload()},e.updateStatus=function(t){e.applicationStatus=t,e.productTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.products,function(t){t.selected=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){console.log("product:",t),t.selected?_.find(e.selectedDatas,{p_id:t.p_id})||(e.selectedDatas.push(t),1==t.is_published&&0==t.is_archived&&e.selectedPublishedDatas.push(t),0==t.is_published&&0==t.is_archived&&e.selectedDraftedDatas.push(t),1==t.is_archived&&0==t.is_published&&e.selectedArchivedDatas.push(t)):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.p_id!==t.p_id}),e.selectedPublishedDatas=_.filter(e.selectedPublishedDatas,function(e){return e.p_id!==t.p_id}),e.selectedDraftedDatas=_.filter(e.selectedDraftedDatas,function(e){return e.p_id!==t.p_id}),e.selectedArchivedDatas=_.filter(e.selectedArchivedDatas,function(e){return e.p_id!==t.p_id})),console.log("$scope.selectedDatas:",e.selectedDatas),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){e.modal={title:"Archive Product?",message:"Are you sure to archive this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1,s=e.selectedDraftedDatas.concat(e.selectedPublishedDatas);s.length>0&&async.eachSeries(e.selectedPublishedDatas,function(e,r){e.selected&&i.archiveProduct(e.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),t++,r(),void 0):void o.error(e.response.msg,"Error")}),t==s.length&&c.reload()})})},e.draftSelected=function(){e.modal={title:"Draft Product?",message:"Are you sure to Draft this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;e.selectedDatas.length>0&&async.eachSeries(e.selectedDatas,function(s,r){s.selected&&i.draftProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),t++,r(),void 0):void o.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&c.reload()})})},e.publishSelected=function(t){e.modal={title:"Publish Product?",message:"Are you sure to Publish this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1,s=e.selectedDraftedDatas.concat(e.selectedArchivedDatas);s.length>0&&async.eachSeries(s,function(e,r){e.selected&&i.publishProduct(e.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),t++,r(),void 0):void o.error(e.response.msg,"Error")}),t==s.length&&c.reload()})})}}angular.module("POS17").controller("productsController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","categoryFactory","ngTableParams","ngDialog"]}();
...
!function(){"use strict";function e(e,s,n,t,o,r,a,i,u){console.log("$stateParams:",n.person_id),e.stores=[],e.persons=[],e.details={},e.enableEndTerm=!1,e.newImage=!1,t.getPersonType().then(function(s){200==s.statusCode&&s.response.success&&(e.persons=s.response.result)}),async.waterfall([function(e){o.getAllCountries().then(function(s){200==s.statusCode&&s.response.success&&e(null,s.response.result)})},function(e,s){t.getTimeZone().then(function(n){200==n.statusCode&&n.response.success&&s(null,e,n.response.result)})},function(s,o,r){e.timezone=o,e.countries=s,n.person_id&&t.getAllPersonDetail(n.person_id).then(function(s){if(200==s.statusCode&&s.response.success)if(e.details=s.response.result,e.details.isActive=1==e.details.isActive,e.details.person_img=e.details.image,_.isNull(e.details.date_end))e.details.isActiveAcnt=!0;else{var n=new Date,t=new Date(e.details.date_end),o=moment(n),r=moment(t),a=moment.duration(o.diff(r)),i=a.asDays();i>=1?e.details.isActiveAcnt=!1:e.details.isActiveAcnt=!0}})}]),e.$watch("enableEndTerm",function(s){1==s?e.details.date_end=new Date:e.details.date_end=null}),e.removethumb=function(){e.details.person_img=null,e.newImage=!1},e.upload=function(s){e.newImage=!0},e.savePersonel=function(){async.waterfall([function(s){n.person_id?t.updatePersonel(n.person_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)u.success(e.response.msg,"Success"),s(null,n.person_id);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void u.error(e.response.msg,"Error");_.each(e.response.result,function(e){u.warning(e.msg,"Warning")})}}):t.savePersonel(e.details).then(function(e){if(200==e.statusCode&&e.response.success)u.success(e.response.msg,"Success"),s(null,e.response.result);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void u.error(e.response.msg,"Error");_.each(e.response.result,function(e){u.warning(e.msg,"Warning")})}})},function(s,n){console.log("$scope.newImage: ",e.newImage),e.newImage&&e.details.image?r.upload({url:a+i+"persons/"+s+"/upload-image",data:{person_img:e.details.image},method:"PUT"}).then(function(e){if(200===e.data.statusCode&&e.data.response.success)u.success("Image successfully uploaded","Success"),n(null,s);else{if(400!==e.data.statusCode||e.data.response.success||!_.isArray(e.data.response.result))return void u.error(e.data.response.msg,"Error");_.each(e.data.response.result,function(e){u.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)}):n(null,s)},function(e,n){console.log("personel: ",e),s.go(s.current,{person_id:e},{reload:!0})}])}}angular.module("POS17").controller("personDetailController",e),e.$inject=["$scope","$state","$stateParams","humanFactory","countryFactory","Upload","API_URL","API_VERSION","toastr"]}();
...
!function(){"use strict";function e(e,s,o,r,t,n,u,l,c){e.selectDeselectAll=!1,e.selectDeselectAll2=!1,e.usergroups=[],e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.users,function(s){s.selected=e.selectDeselectAll})},e.showUserRoles=function(s){e.useraccountRoles=_.map(e.usergroups,function(e){return e.role_id==s})},async.waterfall([function(s){e.usersGroupTable=new c({page:1,count:10},{counts:[10,25,50,100],getData:function(o,r){l.getAllUserGroups().then(function(n){if(200==n.statusCode&&n.response.success){var u=n.response.result;e.usersgroupcopy=angular.copy(n.response.result),e.txtSearch?e.usergroups=$filter("filter")(u,e.txtSearch):e.usergroups=u,r.total(e.usergroups.length);var l=e.usergroups.slice((r.page()-1)*r.count(),r.page()*r.count());o.resolve(l),s(null,l)}else t.error(n.response.msg,"Error"),s(null,"error")})}})},function(s,o){e.users=[],e.usersTable=new c({page:1,count:10},{counts:[10,25,50,100],getData:function(s,r){u.getAllUserAccounts().then(function(n){if(200==n.statusCode&&n.response.success){var u=n.response.result;_.each(u,function(s){s.role_id&&(s.userRoles=_.map(s.role_id.split(","),function(s){return _.find(e.usersgroupcopy,function(e){return e.role_id==s})}))}),e.txtSearch2?e.users=$filter("filter")(u,e.txtSearch2):e.users=u,r.total(e.users.length);var l=e.users.slice((r.page()-1)*r.count(),r.page()*r.count());s.resolve(l)}else t.error(n.response.msg,"Error"),$activityIndicator.stopAnimating(),o(null,"error")})}})}]),e.newUserAccount=function(e,r){var t=o.open({animation:!0,templateUrl:"modules/useraccess/users.modal.html",controller:"useraccountCtrl",backdrop:"static",size:"lg",resolve:{user:function(){return{userID:e,person_id:r}}}});t.result.then(function(){s.reload()},function(){console.info("Modal dismissed")})},e.newUserGroup=function(e){console.log("groupID: ",e);var r=o.open({animation:!0,templateUrl:"modules/useraccess/usergroups.modal.html",controller:"usergroupCtrl",backdrop:"static",size:"lg",resolve:{userGroup:function(){return e}}});r.result.then(function(e){console.log("response: ",e),"save"===e&&s.reload()},function(){console.info("Modal dismissed")})},e.toggleModal=function(s,o,r){console.log(r),n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){"users"===r?e.removeUser(s):e.removeUserGroup(s)},function(e){console.log("Modal promise close: ")})},e.removeUserGroup=function(e){console.log("id: ",e),l.deleteUserGroup(e).then(function(e){console.log("data: ",e),200==e.statusCode&&e.response.success?(t.success(e.response.msg,"Success"),r(function(){s.reload()},300)):t.error(e.response.msg,"Error")})},e.removeUser=function(e){u.deleteUserAccount(e).then(function(e){200==e.statusCode&&e.response.success?(t.success(e.response.msg,"Success"),r(function(){s.reload()},300)):t.error(e.response.msg,"Error")})},e.setUsersSubscription=function(e){var r=o.open({animation:!0,templateUrl:"modules/useraccess/subscription.modal.html",controller:"usersubscriptionCtrl",backdrop:"static",size:"sm",resolve:{user:function(){return e}}});r.result.then(function(){s.reload()},function(){console.info("Modal dismissed")})},e.refreshUser=function(){e.usersTable.reload()},e.refreshUserGroup=function(){e.usersGroupTable.reload()},e.searchData=function(){e.usersGroupTable.reload()},e.searchData2=function(){e.usersTable.reload()}}angular.module("POS17").controller("useraccountsCtrl",e),e.$inject=["$scope","$state","$uibModal","$timeout","toastr","ngDialog","useraccountsFctry","usergroupsFctry","ngTableParams"]}();
!function(){"use strict";function s(s,e,r,n,o,u,t,c,i,a){s.inputType="password",s.inputType2="password",s.activeTab="info",s.users={},s.users.valid_until=new Date,s.employees=[],s.usergroups=[],s.popup1={opened:!1},async.waterfall([function(e){u.getAllEmployees().then(function(r){200==r.statusCode&&r.response.success?(s.employees=r.response.result,s.employees=_.filter(s.employees,function(s){return"Employee"==s.person_type?s:1==s.isSubscriber?s:void 0}),e(null,s.employees)):e(null,"error")})},function(e,r){t.getAllUserGroups().then(function(n){200==n.statusCode&&n.response.success?(s.usergroups=n.response.result,r(null,e,s.usergroups)):r(null,"error")})},function(e,u,t){o.userID&&o.person_id&&n.getUserAccount(o.userID,o.person_id).then(function(e){if(200==e.statusCode&&e.response.success){s.users=e.response.result;var n=_.isEmpty(s.users.role_id)?null:s.users.role_id.split(",");s.users.employee=s.users.profile,s.users.role=_.map(n,function(e){return _.find(s.usergroups,function(s){return s.role_id==e})}),s.users.valid_until=new Date(s.users.valid_until),t()}else r.error(e.response.msg,"Error")})},function(e){n.getUserEmailRecovery(o.userID).then(function(n){200==n.statusCode&&n.response.success?(s.users.recovery_email=n.response.result.recovery_email,e()):r.error(n.response.msg,"Error")})},function(e){n.getUserPIN(o.userID).then(function(n){200==n.statusCode&&n.response.success?(s.users.pos_pin=n.response.result.pos_pin,e()):r.error(n.response.msg,"Error")})}]),s.open1=function(){s.popup1.opened=!0},s.hideShowPassword=function(){"password"==s.inputType?s.inputType="text":s.inputType="password"},s.hideShowPassword2=function(){"password"==s.inputType2?s.inputType2="text":s.inputType2="password"},s.generatePassword=function(){var e=n.generatePasswordString(8);s.users.password=e},s.setDefaultUName=function(e){e&&(s.users.username=e.lastname.toUpperCase())},s.setActiveTab=function(e){s.activeTab=e,console.log("tab: ",e),console.log("activeTab: ",s.activeTab)},s.saveUser=function(){var u=[];s.users.person_id=s.users.employee.person_id,s.users.role&&s.users.role.length>0?(_.each(s.users.role,function(s){u.push(s.role_id)}),s.users.role_id=u.join()):s.users.role_id="",o&&o.userID?n.updateUserAccount(o.userID,s.users).then(function(s){200==s.statusCode&&s.response.success?(r.success(s.response.msg,"Success"),e.close("save")):400===s.statusCode&&!s.response.success&&_.isArray(s.response.result)?_.each(s.response.result,function(s){r.warning(s.msg,"Warning")}):r.error(s.response.msg,"Error")}):n.saveUserAccount(s.users).then(function(s){200==s.statusCode&&s.response.success?(r.success(s.response.msg,"Success"),e.close("save")):400===s.statusCode&&!s.response.success&&_.isArray(s.response.result)?_.each(s.response.result,function(s){r.warning(s.msg,"Warning")}):r.error(s.response.msg,"Error")})},s.saveUserName=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){o&&o.userID&&n.updateUserUsername(o.userID,{username:s.users.username}).then(function(s){if(200==s.statusCode&&s.response.success)r.success("Successfully Update","Success"),i(function(){e.dismiss("cancel"),a.reload()},1e3);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void r.error(resp.data.response.msg,"Error");_.each(s.response.result,function(s){r.warning(s.msg,"Warning")})}})})},s.saveUserPassword=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){if(o&&o.userID){if(s.users.password!==s.users.confirm_password)return void r.warning("Password and Confirm Password do not match");n.updateUserPassword(o.userID,{password:s.users.password,confirm_password:s.users.confirm_password}).then(function(s){if(200==s.statusCode&&s.response.success)r.success("Successfully Update","Success"),i(function(){e.dismiss("cancel"),a.reload()},1e3);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void r.error(resp.data.response.msg,"Error");_.each(s.response.result,function(s){r.warning(s.msg,"Warning")})}})}})},s.saveUserEmailRecovery=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){o&&o.userID&&n.updateUserEmailRecovery(o.userID,{email_recovery:s.users.recovery_email,person_id:s.users.employee.person_id}).then(function(s){if(200==s.statusCode&&s.response.success)r.success("Successfully Update","Success"),i(function(){e.dismiss("cancel"),a.reload()},1e3);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void r.error(s.response.msg,"Error");_.each(s.response.result,function(s){r.warning(s.msg,"Warning")})}})})},s.saveUserPIN=function(){c.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){o&&o.userID&&n.updateUserPIN(o.userID,{pin:s.users.pos_pin}).then(function(s){if(200==s.statusCode&&s.response.success)r.success("Successfully Update","Success"),i(function(){e.dismiss("cancel"),a.reload()},1e3);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void r.error(s.response.msg,"Error");_.each(s.response.result,function(s){r.warning(s.msg,"Warning")})}})})},s.cancelUser=function(){e.dismiss("cancel")}}angular.module("POS17").controller("useraccountCtrl",s),s.$inject=["$scope","$uibModalInstance","toastr","useraccountsFctry","user","personFctry","usergroupsFctry","ngDialog","$timeout","$state"]}();
...
!function(){"use strict";function e(e,s,n,t,o,r,i,u){e.permissions=[],e.Groups=[],e.usergroups=[],e.isReset=!0,e.isUpdate=!0,_.isUndefined(n.groupId)?(console.log("sadasda"),o.getAllModulesPermissions().then(function(s){if(200==s.statusCode&&s.response.success){var n=s.response.result;n.length>0&&(e.permissions=n,_.each(e.permissions,function(e){e.DefaultReadDisable=!0,e.DefaultWriteDisable=!0,e.DefaultDeleteDisable=!0,e.DefaultPrintDisable=!0}))}})):(console.log("sadasda 111"),async.waterfall([function(s){o.getAllModulesPermissions().then(function(n){if(200==n.statusCode&&n.response.success){var t=n.response.result;t.length>0?(e.permissions=t,s()):s()}})},function(s){console.log("sadasda"),r.getUserGroupById(n.groupId).then(function(n){if(200==n.statusCode&&n.response.success){var o=n.response.result;o&&o.length>0&&(e.usergroup=n.response.result[0],e.usergroupSelected=n.response.result[0],e.generateAccessPermission(e.usergroup.role_id),s())}else t.error(n.response.msg,"Error")})}])),e.generateAccessPermission=function(n){s(function(){_.isUndefined(n)?e.clear():o.generateAccessPermission(n).then(function(s){if(200==s.statusCode&&s.response.success){e.isUpdate=!1,e.isReset=!1;var n=s.response.result;n.length>0&&_.each(e.permissions,function(e){var s=_.find(n,{mf_id:e.mf_id});s&&(e.DefaultDelete=s.DefaultDelete,e.DefaultPrint=s.DefaultPrint,e.DefaultRead=s.DefaultRead,e.DefaultWrite=s.DefaultWrite)})}})},300)},e.clear=function(){e.isUpdate=!0,e.isReset=!0,e.usergroupSelected=void 0,e.permissions=[],o.getAllModulesPermissions().then(function(s){if(200==s.statusCode&&s.response.success){var n=s.response.result;n.length>0&&(e.permissions=n,_.each(e.permissions,function(e){e.DefaultRead=!1,e.DefaultReadDisable=!0,e.DefaultWrite=!1,e.DefaultWriteDisable=!0,e.DefaultDelete=!1,e.DefaultDeleteDisable=!0,e.DefaultPrint=!1,e.DefaultPrintDisable=!0}))}})},e.reloadData=function(){_.isUndefined(e.usergroup)?e.clear():e.generateAccessPermission(e.usergroup.role_id)},e.resetPermission=function(){i.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){async.waterfall([function(s){o.resetGroupPrivilege(e.usergroupSelected.role_id).then(function(e){200==e.statusCode&&e.response.success?(t.success(e.response.msg,"Success"),s()):t.error(e.response.msg,"Error")})},function(s){o.getAllModulesPermissions().then(function(s){if(200==s.statusCode&&s.response.success){var n=s.response.result;n.length>0&&(e.permissions=n)}})}])})},e.UpdatePermission=function(){i.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){e.newPermission=angular.copy(e.permissions),console.log("$scope.newPermission: ",e.newPermission),o.setGroupPrivilege(e.usergroupSelected.role_id,e.newPermission).then(function(e){200==e.statusCode&&e.response.success?(t.success(e.response.msg,"Success"),s(function(){u.reload()},1e3)):t.error(e.response.msg,"Error")})})},e.IntToBoolean=function(e){return 1==e},e.BooleanToInt=function(e){return e===!0?1:0},e.myFunction=function(){console.log("myFunction"),s(function(){angular.element(document).ready(function(){$("#myTable").each(function(){var e=1,s=null,n=1;$("tbody",this).find("tr").each(function(){var t=$(this).find("td:nth-child("+e+")");null==s?(s=t,n=1):t.text()==s.text()?(t.remove(),s.attr("rowspan",n+1),n+=1):(s=t,n=1)})})})},100)}}angular.module("POS17").controller("permissionCtrl",e),e.$inject=["$scope","$timeout","$stateParams","toastr","permissionFctry","usergroupsFctry","ngDialog","$state"]}();
...
!function(){"use strict";function e(e,r,t,o){e.applicationStatus="All";var a=function(){e.receivedorderisLoading=!0,e.receivedorder=[],e.receivedorderTable=new t({page:1,count:10},{counts:[10,25,50,100],getData:function(t,a){r.getAllPurchaseOrder().then(function(r){if(200==r.statusCode&&r.response.success){var i=r.response.result;console.log("receivedorder:",i),e.txtSearch&&"All"==e.applicationStatus?e.receivedorder=o("filter")(i,e.txtSearch):e.txtSearch&&"Approved"==e.applicationStatus?(e.receivedorder=o("filter")(i,{po_status:"Open"}),e.receivedorder=o("filter")(e.receivedorder,e.txtSearch)):e.txtSearch&&"Unapproved"==e.applicationStatus?(e.receivedorder=o("filter")(i,{po_status:"Closed"}),e.receivedorder=o("filter")(e.receivedorder,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.receivedorder=i:_.isUndefined(e.txtSearch)&&"Approved"==e.applicationStatus?e.receivedorder=o("filter")(i,{po_status:"Open"}):_.isUndefined(e.txtSearch)&&"Unapproved"==e.applicationStatus?e.receivedorder=o("filter")(i,{po_status:"Closed"}):e.receivedorder=i,a.total(e.receivedorder.length);var d=e.receivedorder.slice((a.page()-1)*a.count(),a.page()*a.count());t.resolve(d),e.receivedorderisLoading=!1}else toastr.error(r.response.msg,"Error")})}})};e.updateStatus=function(r){e.applicationStatus=r,e.receivedorderTable.reload()},e.searchData=function(){e.receivedorderTable.reload()},a()}angular.module("POS17").controller("receivedOrderController",e),e.$inject=["$scope","purchaseOrderFactory","ngTableParams","$filter"]}();
...
!function(){"use strict";function e(e,t,i,s,l,r,d,a,o,n,u,c,p,m){function f(e){_.each($rootScope.cartItems,function(t){t.pb_id==e.pb_id&&(t.quantity=e.quantity)}),localStorageService.set("Cart",JSON.stringify($rootScope.cartItems))}e.details={},e.details.tags=[],e.details.article_feature=[],e.details.article_features_list=[],e.details.is_published=!1,e.details.is_archived=!1,e.mediaSource={},e.radioModel="product",e.products=[],e.productBundles=[],e.mediafile=[],e.types=[],e.tags=[],e.tagsArr=[],e.infiniteScroll={},e.infiniteScroll.numToAdd=10,e.infiniteScroll.currentItems=10,e.resetInfScroll=function(){e.infiniteScroll.currentItems=e.infiniteScroll.numToAdd},e.addMoreItems=function(){e.infiniteScroll.currentItems+=e.infiniteScroll.numToAdd},c.getAllTags().then(function(t){200==t.statusCode&&t.response.success?e.tagsArr=t.response.result:s.error(t.response.msg,"Error")}),r.article_id&&(e.details.article_feature=[],e.details.article_features_list=[],d.getDetailArticle(r.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.showPublish=1!=e.details.is_active,console.log("$scope.showPublish: ",e.showPublish),e.details.article_features_list=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{item_name:e.product_details.item_name,item_code:e.product_details.product_code,item_brand:e.product_details.brand,item_id:e.product_details.p_id}:null!==e.bundle_id&&null==e.product_id?{item_name:e.bundle_details.bundle_name,item_code:e.bundle_details.bundle_code,item_brand:e.bundle_details.bundle_brand,item_id:e.bundle_details.pb_id}:void 0}),e.details.article_feature=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{product_id:e.product_details.p_id,bundle_id:null,article_id:r.article_id}:null!==e.bundle_id&&null==e.product_id?{product_id:null,bundle_id:e.bundle_details.pb_id,article_id:r.article_id}:void 0}),e.details.media=e.details.article_thumbnail,e.showArticleMedia(),e.mediafile=t.response.result.mediafiles,c.getAllArticleTags(r.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details.tags=t.response.result)}))}),u.getAllProduct().then(function(t){if(200==t.statusCode&&t.response.success){var i=t.response.result;_.each(i,function(t){0==t.is_archived&&e.products.push(t)})}}),u.getAllProductBundle().then(function(t){if(200==t.statusCode&&t.response.success){var i=t.response.result;_.each(i,function(t){1!==t.is_archived&&e.productBundles.push(t)})}})),e.changeData=function(t){e.radioModel=t},e.reloadMediaFiles=function(){r.article_id&&(e.mediafile=[],e.imagesFile=[],d.getDetailArticle(r.article_id).then(function(t){200==t.statusCode&&t.response.success&&l(function(){e.$apply(function(){e.mediafile=t.response.result.mediafiles})},100)}))},e.reloadArticle=function(){r.article_id&&(e.details.article_feature=[],e.details.article_features_list=[],d.getDetailArticle(r.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.details.article_features_list=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{item_name:e.product_details.item_name,item_code:e.product_details.product_code,item_brand:e.product_details.brand,item_id:e.product_details.p_id}:null!==e.bundle_id&&null==e.product_id?{item_name:e.bundle_details.bundle_name,item_code:e.bundle_details.bundle_code,item_brand:e.bundle_details.bundle_brand,item_id:e.bundle_details.pb_id}:void 0}),e.details.article_feature=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{product_id:e.product_details.p_id,bundle_id:null,article_id:r.article_id}:null!==e.bundle_id&&null==e.product_id?{product_id:null,bundle_id:e.bundle_details.pb_id,article_id:r.article_id}:void 0}))}))},e.addToList=function(){"product"==e.radioModel?_.isUndefined(e.details.product)||_.isEmpty(e.details.product)||(_.find(e.details.article_features_list,{item_id:e.details.product.p_id})?s.warning("Product Item already existed","Warning"):(e.details.article_features_list.push({item_name:e.details.product.item_name,item_quantity:1,item_code:e.details.product.product_code,item_brand:e.details.product.brand,item_id:e.details.product.p_id}),e.details.article_feature.push({product_id:e.details.product.p_id,bundle_id:null,quantity:1,article_id:r.article_id}))):"productgroup"==e.radioModel&&(_.isUndefined(e.details.productgroup)||_.isEmpty(e.details.productgroup)||(_.find(e.details.article_features_list,{item_id:e.details.productgroup.pb_id})?s.warning("Bundle Item already existed","Warning"):(e.details.article_features_list.push({item_name:e.details.productgroup.bundle_name,item_quantity:1,item_code:e.details.productgroup.bundle_code,item_brand:e.details.productgroup.bundle_brand,item_id:e.details.productgroup.pb_id}),e.details.article_feature.push({bundle_id:e.details.productgroup.pb_id,product_id:null,quantity:1,article_id:r.article_id})))),e.details.product={},e.details.productgroup={}},e.minusbutton=function(e){e.quantity<1?(e.quantity=0,f(e)):(e.quantity--,f(e))},e.addbutton=function(e){e.quantity++,f(e)},e.removeOnList=function(t){e.details.article_features_list.splice(t,1),e.details.article_feature.splice(t,1)},e.deleteAllMedia=function(){o.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.article_id&&d.deleteAllArticleMedia(r.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void t.reload()):void s.error(e.response.msg,"Error")})})},e.deleteSelected=function(i){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("media: ",i),r.article_id&&d.deleteArticleMediaFile(r.article_id,i._id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void t.reload()):void s.error(e.response.msg,"Error")})})},e.saveArticle=function(){async.waterfall([function(t){r.article_id?d.updateArticle(r.article_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)s.success(e.response.msg,"Success"),t(null,r.article_id);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void s.error(e.response.msg,"Error");_.each(e.response.result,function(e){s.warning(e.msg,"Warning")})}}):d.saveArticle(e.details).then(function(e){if(200==e.statusCode&&e.response.success)s.success(e.response.msg,"Success"),t(null,e.response.result);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void s.error(e.response.msg,"Error");_.each(e.response.result,function(e){s.warning(e.msg,"Warning")})}})},function(t,i){var l=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(r,d){r.isTag?c.saveTags(r).then(function(e){return 200==e.statusCode&&e.response.success?void c.saveArticleTags(t,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(l++,void d()):void s.error(e.response.msg,"Error")}):void s.error(e.response.msg,"Error")}):c.saveArticleTags(t,{tag_id:r.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(l++,void d()):void s.error(e.response.msg,"Error")}),l>=e.details.tags.length&&i(null,t)}):i(null,t)},function(e,i){l(function(){t.go(t.current,{article_id:e},{reload:!0})},300)}])},e.tagTransform=function(e){return console.log(e),{tags:e}},e.clearInput=function(e){e.search=""},e.deleteProductTags=function(e){r.article_id&&c.deleteArticleTag(r.article_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void s.success(e.response.msg,"Success"):void s.error(e.response.msg,"Error")})},e.publishArticle=function(i){o.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){d.publishArticle(i).then(function(e){200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),l(function(){t.reload()},1e3)):s.error(e.response.msg,"Error")})})},e.openUploader=function(){var e=n.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.upload.modal.html",controller:"articleUploadModalCtrl",size:"lg",resolve:{article_id:function(){return r.article_id}}});e.result.then(function(e){t.reload()},function(){})},e.showArticleMedia=function(){var t=e.details.media;t&&("image/jpeg"==t.media_mimetype?t.media=!1:"image/jpg"==t.media_mimetype?t.media=!1:"image/gif"==t.media_mimetype?t.media=!1:"image/x-ms-bmp"==t.media_mimetype?t.media=!1:"image/png"==t.media_mimetype?t.media=!1:"video/mp4"==t.media_mimetype?(t.media=!0,t.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"):"video/x-flv"==t.media_mimetype?(t.media=!0,t.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"):"video/x-msvideo"==t.media_mimetype?(t.media=!0,t.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"):"video/x-ms-wmv"==t.media_mimetype?(t.media=!0,t.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"):"video/quicktime"==t.media_mimetype&&(t.media=!0,t.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"),console.log("showArticleMedia: ",t),l(function(){e.$apply(function(){e.mediaSource=t,e.details.thumbnail_media=t._id})},10))},e.openLightboxModal=function(e){var t=[];t.push({url:e.media_path,caption:e.media_name,thumbUrl:e.media_path}),p.openModal(t,0)},e.openVideoModal=function(e){n.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.media.modal.html",controller:"articleMediaModalCtrl",size:"lg",resolve:{files:function(){return e},type:function(){return"video"}}})},e.openAudioModal=function(e){n.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.media.modal.html",controller:"articleMediaModalCtrl",size:"md",resolve:{files:function(){return e},type:function(){return"audio"}}})},e.openDocsModal=function(e){n.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.docs.modal.html",controller:"articleDocsModalCtrl",size:"lg",windowClass:"presentation-modal-popup",resolve:{files:function(){return e}}})},e.copyURLLink=function(e){return m.supported?(console.log("files.media_path: ",e.media_path),void m.copyText(e.media_path)):void s.warning("Sorry, copy to clipboard is not supported","Warning")}}angular.module("POS17").controller("articleDetailController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","articleFctry","ngTableParams","ngDialog","$uibModal","productFactory","tagsFactory","Lightbox","clipboard"]}();
...
!function(){"use strict";function e(e,t,o,s,l,c,i){e.name="Type",e.status="All",e.txtSearch="",e.type={},e.selectDeselectAll=!1,e.selectedDatas=[],e.selectedToPublish=[],e.pricebooktype=[],e.example8model=[],e.example8data=[{id:1,label:"Telstra"},{id:2,label:"Proximity"},{id:3,label:"Christmas"},{id:4,label:"Women"}];var r=i.getCurrentUser(),a=JSON.parse(r);t.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)});var p=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.name="Type",e.status="All",e.txtSearch="",e.type={},e.pricebooksTable=new o({page:1,count:10},{counts:[10,25,50,100],getData:function(o,l){t.getAllPricebook().then(function(t){if(200==t.statusCode&&t.response.success){var i=t.response.result;if(e.pricebookscopy=angular.copy(t.response.result),console.log("$scope.txtSearch: ",e.txtSearch),console.log("$scope.type: ",e.type),console.log("$scope.txtSearch: ",_.isEmpty(e.txtSearch)),console.log("$scope.type: ",_.isEmpty(e.type)),_.isEmpty(e.txtSearch)&&"Published"==e.status&&_.isEmpty(e.type))console.log("Published: "),e.pricebooks=_.reject(i,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&_.isEmpty(e.type))console.log("Unpublished: "),e.pricebooks=_.filter(i,{date_approved:null});else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&_.isEmpty(e.type))console.log("All: "),e.pricebooks=i;else if(_.isEmpty(e.txtSearch)&&"All"==e.status&&e.type)console.log("1"),e.pricebooks=_.filter(i,{pricebook_type_id:e.type.pt_id});else if(_.isEmpty(e.txtSearch)&&"Published"==e.status&&e.type){console.log("2");var r=_.reject(i,{date_approved:null});e.pricebooks=_.filter(r,{pricebook_type_id:e.type.pt_id})}else if(_.isEmpty(e.txtSearch)&&"Unpublished"==e.status&&e.type){console.log("3");var r=_.filter(i,{date_approved:null});e.pricebooks=_.filter(r,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"All"==e.status&&_.isEmpty(e.type))console.log("4"),e.pricebooks=s("filter")(i,e.txtSearch);else if(e.txtSearch&&"Published"==e.status&&_.isEmpty(e.type)){console.log("5");var r=s("filter")(i,e.txtSearch);e.pricebooks=_.reject(r,{date_approved:null})}else if(e.txtSearch&&"Unpublished"==e.status&&_.isEmpty(e.type)){console.log("6");var r=s("filter")(i,e.txtSearch);e.pricebooks=_.filter(r,{date_approved:null})}else if(e.txtSearch&&"All"==e.status&&e.type){console.log("7");var r=s("filter")(i,e.txtSearch);e.pricebooks=_.filter(r,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Published"==e.status&&e.type){console.log("8");var r=s("filter")(i,e.txtSearch),a=_.reject(r,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else if(e.txtSearch&&"Unpublished"==e.status&&e.type){console.log("9");var r=s("filter")(i,e.txtSearch),a=_.filter(r,{date_approved:null});e.pricebooks=_.filter(a,{pricebook_type_id:e.type.pt_id})}else console.log("else"),e.pricebooks=i;l.total(e.pricebooks.length);var p=e.pricebooks.slice((l.page()-1)*l.count(),l.page()*l.count());e.pricebookLoading=!1,o.resolve(p)}else c.error(t.response.msg,"Error"),e.pricebookLoading=!1})}})};p(),e.refresh=function(){p()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.pricebooks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?(_.find(e.selectedDatas,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedDatas.push(t),_.isNull(t.date_approved)&&(_.find(e.selectedToPublish,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedToPublish.push(t))):(e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pricebook_id!==t.pricebook_id}),e.selectedToPublish=_.filter(e.selectedToPublish,function(e){return e.pricebook_id!==t.pricebook_id})),e.deleteSomeData=e.selectedDatas.length>0,e.pusblishSomeData=e.selectedToPublish.length>0},e.updateStatus=function(t){console.log("updateStatus"),e.status=t,e.pricebooksTable.reload()},e.updateType=function(t){e.type=t,e.name=t.name,e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()},e.copyDuplicatePricebook=function(o){e.modal={title:"Copy/Duplicate Pricebook?",message:"Are you sure to Copy/Duplicate Pricebook?"},l.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.pricebook_id&&t.duplicatePriceBook(o.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void $timeout(function(){$state.reload()},1e3)):void c.error(e.response.msg,"Error")})})},e.publishSelectedItem=function(o){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebook?"},l.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){t.approvedPriceBook(o.pricebook_id,{approved_by:a.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void $timeout(function(){$state.reload()},1e3)):void c.error(e.response.msg,"Error")})})},e.publishSelected=function(){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebooks?"},l.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("$scope.selectedDatas: ",e.selectedDatas);var o=1;async.eachSeries(e.selectedDatas,function(s,l){s.selected&&t.approvedPriceBook(s.pricebook_id,{approved_by:a.person_id}).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),o++,l(),void 0):void c.error(e.response.msg,"Error")}),o==e.selectedDatas.length&&$timeout(function(){$state.reload()},1e3)})})},e.deleteSelected=function(){e.modal={title:"Delete Pricebook?",message:"Are you sure to Delete this selected pricebooks?"},l.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var o=1;async.eachSeries(e.selectedDatas,function(s,l){s.selected&&t.deletePriceBook(s.pricebook_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),o++,l(),void 0):void c.error(e.response.msg,"Error")}),o==e.selectedDatas.length&&$timeout(function(){$state.reload()},1e3)})})}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter","ngDialog","toastr","AuthFctry"]}();

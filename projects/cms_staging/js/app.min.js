...
!function(){"use strict";function e(e,t,s,o,r,i,u,n,d,l,a,c,p,g,f,m,h,q){console.log("quotesDetailController:"),e.persons=[],e.store=[],e.products=[],e.countries=[],e.currencies=[],e.productBundles=[],e.items={},e.tags=[],e.tagsArr=[],e.details={},e.details.subtotal=0,e.details.other_fee=0,e.details.tax=0,e.details.quoteproduct_list=[],e.details.tags=[],e.itemList=[],e.radioModel="product",e.billingAddress=!1,e.shippingAddress=!1,q.getAllCountries().then(function(t){200==t.statusCode&&t.response.success&&(e.countries=t.response.result)}),h.getAllCurrencies().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;e.currencies=s}else o.error(t.response.msg,"Error")}),l.getAllPerson().then(function(t){200==t.statusCode&&t.response.success?(e.persons=t.response.result,e.details.person_id=e.persons[0].person_id):o.error(t.response.msg,"Error")}),a.getAllStore().then(function(t){200==t.statusCode&&t.response.success?e.store=t.response.result:o.error(t.response.msg,"Error")}),c.getAllProduct().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){0==t.is_archived&&e.products.push(t)})}}),c.getAllProductBundle().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){1!==t.is_archived&&e.productBundles.push(t)})}}),m.getAllTags().then(function(t){200==t.statusCode&&t.response.success?e.tagsArr=t.response.result:o.error(t.response.msg,"Error")}),i.quote_id&&g.getDetailQuote(i.quote_id).then(function(t){if(200==t.statusCode&&t.response.success){e.details=t.response.result,e.details.customer=e.details.bill_qoute_info,e.details.quoteproduct_list=[];var s=e.details.quote_item_list;_.each(s,function(t){_.isNull(t.product_id)||e.details.quoteproduct_list.push({item_name:t.product_details.item_name,quantity:t.quantity,price:t.price,discount:t.discount,total:(t.price-t.discount)*t.quantity,product_id:t.product_id,bundle_id:null}),_.isNull(t.bundle_id)||e.details.quoteproduct_list.push({item_name:t.bundle_details.bundle_name,quantity:t.quantity,price:t.price,discount:t.discount,total:(t.price-t.discount)*t.quantity,product_id:null,bundle_id:t.bundle_id})}),console.log("$scope.details: ",e.details)}m.getAllQuoteTags(i.quote_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details.tags=t.response.result)})}),e.changeData=function(t){e.radioModel=t},e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.addToList=function(t){console.log("$scope.radioModel:",e.radioModel),"product"==e.radioModel?_.isUndefined(t.product)||_.isEmpty(t.product)||(_.find(e.details.quoteproduct_list,{product_id:t.product.p_id})?o.warning("Product Item already existed","Warning"):e.details.quoteproduct_list.push({item_name:t.product.item_name,quantity:t.quantity,price:t.price,discount:t.discount,total:t.total,product_id:t.product.p_id,bundle_id:null})):"productgroup"==e.radioModel&&(console.log("SURE"),_.isUndefined(t.productgroup)||_.isEmpty(t.productgroup)||(_.find(e.details.quoteproduct_list,{product_id:t.productgroup.p_id})?o.warning("Bundle Item already existed","Warning"):e.details.quoteproduct_list.push({item_name:t.productgroup.bundle_name,quantity:t.quantity,price:t.price,discount:t.discount,total:t.total,product_id:null,bundle_id:t.productgroup.pb_id}))),t.product=null,t.productgroup=null,t.quantity=0,t.price=0,t.discount=0,t.total=0,console.log("$scope.details.quoteproduct_list: ",e.details.quoteproduct_list),e.calculateItems()},e.calculateItem=function(e){var t=0,s=0,o=e.price-e.discount;return s=o*e.quantity,t+=parseFloat(s),e.total=t,e.total},e.calculateItems=function(){var t=0,s=0;_.each(e.details.quoteproduct_list,function(e){var o=e.price-e.discount;t=o*e.quantity,s+=parseFloat(t)}),e.details.sub_total=s,e.calculateBilling()},e.calculateBilling=function(){e.details.total_fee=parseFloat(e.details.sub_total||0)+parseFloat(e.details.tax||0)+parseFloat(e.details.other_fee||0)},e.removeItem=function(t){e.details.quoteproduct_list.splice(t,1),e.calculateItems()},e.deleteQuoteTag=function(e){i.quote_id&&m.deleteQuoteTag(i.quote_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void o.success(e.response.msg,"Success"):void o.error(e.response.msg,"Error")})},e.useBillingAddress=function(t){t?(e.details.ship_to_address=e.details.bill_to_address,e.details.ship_to_state=e.details.bill_to_state,e.details.ship_to_zipcode=e.details.bill_to_zipcode,e.details.ship_to_country=e.details.bill_to_country):(e.details.ship_to_address="",e.details.ship_to_state="",e.details.ship_to_zipcode="",e.details.ship_to_country="")},e.useCustomerAddress=function(t){t&&e.details.customer?(e.details.bill_to_address=e.details.customer.address,e.details.bill_to_state=e.details.customer.state,e.details.bill_to_zipcode=e.details.customer.zipcode,e.details.bill_to_country=e.details.customer.country):(e.details.bill_to_address="",e.details.bill_to_state="",e.details.bill_to_zipcode="",e.details.bill_to_country="")},e.saveQuoteInfo=function(){var s=JSON.parse(f.get("user"));e.details.staff_id=s.uc_id,e.details.store_id=e.details.store.store_id,e.details.customer_id=e.details.customer.person_id,e.details.ship_to=e.details.customer.person_id,e.details.currency_id=e.details.currency_id,e.details.quote_status="P",e.details.quote_date=new Date,console.log("$scope.details: ",e.details),async.waterfall([function(s){i.quote_id?(console.log("DIRI?"),g.updateQuoteInfo(i.quote_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)o.success(e.response.msg,"Success"),s(null,i.quote_id),t.go(t.current,{quote_id:i.quote_id},{reload:!0});else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void o.error(e.response.msg,"Error");_.each(e.response.result,function(e){o.warning(e.msg,"Warning")})}})):(console.log("DIRI SYA"),g.saveQuoteInfo(e.details).then(function(e){if(200==e.statusCode&&e.response.success)o.success(e.response.msg,"Success"),s(null,e.response.result);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void o.error(e.response.msg,"Error");_.each(e.response.result,function(e){o.warning(e.msg,"Warning")})}}))},function(t,s){console.log("dri bai");var r=0;e.details.tags.length>0?async.eachSeries(e.details.tags,function(i,u){i.isTag?m.saveTags(i).then(function(e){return 200==e.statusCode&&e.response.success?void m.saveQuoteTags(t,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void u()):void o.error(e.response.msg,"Error")}):void o.error(e.response.msg,"Error")}):m.saveQuoteTags(t,{tag_id:i.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void u()):void o.error(e.response.msg,"Error")}),r>=e.details.tags.length&&s(null,t)}):s(null,t)},function(e,s){r(function(){t.go(t.current,{quote_id:e},{reload:!0})},300)}])}}angular.module("POS17").controller("quotesDetailController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","ngTableParams","ngDialog","$uibModal","humanFactory","storeFactory","productFactory","categoryFactory","quoteFactory","localStorageService","tagsFactory","currencyFactory","countryFactory"]}();

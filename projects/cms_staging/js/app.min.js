...
!function(){"use strict";function e(e,t,o,i,s){e.name="Type",e.status="All",e.pricebooktype=[],e.selectDeselectAll=!1,e.selectedDatas=[],e.example8model=[],e.example8data=[{id:1,label:"Telstra"},{id:2,label:"Proximity"},{id:3,label:"Christmas"},{id:4,label:"Women"}],t.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result)});var c=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.pricebooksTable=new o({page:1,count:10},{counts:[10,25,50,100],getData:function(o,s){t.getAllPricebook().then(function(t){if(200==t.statusCode&&t.response.success){var c=t.response.result;e.pricebookscopy=angular.copy(t.response.resul),e.txtSearch&&"All"==e.status?e.pricebooks=i("filter")(c,e.txtSearch):e.txtSearch&&"Published"==e.status&&e.type?(e.pricebooks=i("filter")(c,{isActive:1}),e.pricebooks=i("filter")(c,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(c,e.txtSearch)):e.txtSearch&&"Unpublished"==e.status&&e.type?(e.pricebooks=i("filter")(c,e.txtSearch),e.pricebooks=i("filter")(c,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(c,{isActive:0})):_.isUndefined(e.txtSearch)&&"All"==e.status&&e.type?e.pricebooks=i("filter")(c,{pricebook_type_id:e.type.pt_id}):_.isUndefined(e.txtSearch)&&"Published"==e.status&&e.type?(e.pricebooks=i("filter")(c,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(c,{isActive:1})):_.isUndefined(e.txtSearch)&&"Unpublished"==e.status&&e.type?(e.pricebooks=i("filter")(c,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(c,{isActive:0})):e.pricebooks=c,s.total(e.pricebooks.length);var l=e.pricebooks.slice((s.page()-1)*s.count(),s.page()*s.count());e.pricebookLoading=!1,o.resolve(l)}else toastr.error(t.response.msg,"Error"),e.pricebookLoading=!1})}})};c(),e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.pricebooks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.pricebook_id===t.pricebook_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pricebook_id!==t.pricebook_id}),e.deleteSomeData=e.selectedDatas.length>0},e.updateStatus=function(t){e.status=t,e.pricebooksTable.reload()},e.updateType=function(t){e.type=t,e.name=t.name,e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()},e.copyDuplicatePricebook=function(t){e.modal={title:"Copy/Duplicate Pricebook?",message:"Are you sure to Copy/Duplicate Pricebook?"},s.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){$stateParams.pricebook_id})},e.publishSelectedItem=function(t){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebook?"},s.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){})},e.publishSelected=function(){e.modal={title:"Publish Pricebook?",message:"Are you sure to Publish this selected pricebooks?"},s.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){})}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter","ngDialog"]}();

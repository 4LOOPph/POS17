...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(s,t){t.state("main.assets",{url:"/assets",templateUrl:"modules/assets/assets.html",controller:"assetsController"}).state("main.assets_folder",{url:"/assets/folders/:_id",templateUrl:"modules/assets/assets.html",controller:"assetsController"})}])}();
!function(){"use strict";angular.module("POS17").controller("assetsController",["$scope","assetsFctry","$stateParams","$state",function(s,e,o,t){s.isList=!1,s.assets={},s.isLoading=!0,s.showBread=!1,s.changeDisplay=function(){s.isList=!s.isList},o._id?(s.isLoading=!0,e.getFolderAssets(o._id).then(function(e){200==e.statusCode&&e.response.success&&(s.assets=e.response.result),s.isLoading=!1,s.showBread=!0,console.log("$scope.assets: ",s.assets)})):e.getAllAssets().then(function(e){200==e.statusCode&&e.response.success&&(s.assets=e.response.result),_.each(s.assets.folders,function(s){s.folder_filesize=_.sumBy(s.files,function(s){return s.asset_filesize})}),s.isLoading=!1,console.log("$scope.assets: ",s.assets)}),s.showAllFiles=function(){o._id?(s.isLoading=!0,e.getFolderAssets(folder._id).then(function(e){200==e.statusCode&&e.response.success&&(s.assets=e.response.result),s.isLoading=!1,s.showBread=!0,console.log("$scope.assets: ",s.assets)})):e.getAllAssets().then(function(e){200==e.statusCode&&e.response.success&&(s.assets=e.response.result),_.each(s.assets.folders,function(s){s.folder_filesize=_.sumBy(s.files,function(s){return s.asset_filesize})}),s.isLoading=!1,console.log("$scope.assets: ",s.assets)})},s.openFolder=function(s){console.log("openFolder: ",s._id),t.go("main.assets_folder",{_id:s._id})}}])}();

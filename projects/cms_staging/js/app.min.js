...
!function(){"use strict";function e(e,t,r,s,n,o,u){e.currentPage=1,e.itemsPerPage=4,e.chartLineLabels=["January","February","March","April","May","June","July"],e.chartLineSeries=["New Users","Global Quizz Results in %"],e.chartLineCharts=[];var a=[99,73,30,85,38,71,85];e.chartLineCharts.push(a),e.chartLineColours=["#1a5350"],e.chartLineOptions={maintainAspectRatio:!1,responsive:!1},e.productIsLoading=!0,s.getAllProduct().then(function(r){if(e.products=[],200==r.statusCode&r.response.success){var s=r.response.result;t(function(){e.$apply(function(){e.products=s}),e.totalItems=e.products.length,t(function(){e.productIsLoading=!1},2e3)},100)}}),n.getAllPerson().then(function(r){if(e.persons=[],200==r.statusCode&&r.response.result){e.totalPersonel=r.response.result.length;var s=r.response.result;t(function(){e.$apply(function(){e.persons=s}),t(function(){e.productIsLoading=!1},2e3)},100)}}),async.waterfall([function(e){u.getAllUserGroups().then(function(t){200==t.statusCode&&t.response.success?e(null,t.response.result):(r.error(t.response.msg,"Error"),e(null,"error"))})},function(r,s){o.getAllUserAccounts().then(function(s){if(e.useraccounts=[],200==s.statusCode&&s.response.success){var n=s.response.result;_.each(n,function(e){e.role_id&&(e.userRoles=_.map(e.role_id.split(","),function(e){return _.find(r,function(t){return t.role_id==e})}))}),t(function(){e.$apply(function(){e.useraccounts=n}),t(function(){e.productIsLoading=!1},2e3)},100)}})}])}angular.module("POS17").config(["$stateProvider",function(e){e.state("main.dashboard",{url:"/dashboard",templateUrl:"modules/dashboard/dashboard1.html",controller:"DashboardCtrl"})}]).controller("DashboardCtrl",e),e.$inject=["$scope","$timeout","toastr","productFactory","humanFactory","useraccountsFctry","usergroupsFctry"]}();

...
!function(){"use strict";angular.module("POS17").controller("assetsController",["$scope","assetsFctry","$stateParams","$state","$uibModal","localStorageService","AuthFctry","ngDialog","toastr","$timeout","Lightbox",function(e,s,t,o,i,l,a,n,r,d,c){function m(s){200==s.statusCode&&s.response.success&&(e.items=s.response.result,e.assets=angular.copy(s.response.result)),e.isLoading=!1,e.showBread=!0,"main.assets"==o.current.name?(e.activeAllFiles=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted})):"main.starred"==o.current.name?(e.activeStarredFiles=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted&&1==e.isStarred})):"main.shared-with-me"==o.current.name?(e.activeSharedFiles=!0,e.assets={},e.items={}):"main.trash"==o.current.name&&(e.activeTrashFiles=!0,e.showBarDelete=!0,e.showBarRestore=!0,e.showBarShare=!1,e.showToolPreview=!1,e.showBarMore=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 1==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 1==e.isDeleted})),_.each(e.assets.folders,function(e){e.folder_filesize=_.sumBy(e.files,function(e){return e.asset_filesize}),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.isActive=!1,e.isFolder=!1}),e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1)}e.items={},e.assets={},e.trash={},e.starred={},e.selectedFile={},e.isList="null"!=l.get("isList")&&0!=l.get("isList"),e.isLoading=!0,e.showBread=!1,e.showFiles=!1,e.showToolNewFolder=!0,e.showToolMakeCopy=!1,e.showToolPreview=!1,e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.activeAllFiles=!1,e.activeSharedFiles=!1,e.activeStarredFiles=!1,e.activeTrashFiles=!1,e.changeDisplay=function(){e.isList=!e.isList,l.set("isList",e.isList)},e.refreshAssets=function(){e.assets={},e.items={},t._id&&_.isUndefined(t.sub_id)?(e.isLoading=!0,s.getFolderAssets(t._id).then(m)):t._id&&t.sub_id?(e.showToolNewFolder=!1,e.isLoading=!0,s.getFolderAssets(t.sub_id).then(m)):s.getAllAssets().then(m)},e.showAllFiles=function(){"main.assets"==o.current.name?e.refreshAssets():o.go("main.assets")},e.showAllTrash=function(){"main.trash"==o.current.name?e.refreshAssets():o.go("main.trash")},e.showAllStarred=function(){"main.starred"==o.current.name?e.refreshAssets():o.go("main.starred")},e.showAllShared=function(){"main.shared-with-me"==o.current.name?e.refreshAssets():o.go("main.shared-with-me")},e.newUploader=function(){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});s.result.then(function(s){s&&e.refreshAssets()})},e.createNewFolder=function(){var e=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/newfolder.modal.html",size:"sm",controller:"assetsFolderModalCtrl"});e.result.then(function(e){e&&o.reload()})},e.shareToOthers=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/sharer.modal.html",size:"md",controller:"assetsShareModalCtrl"});s.result.then(function(e){e&&o.reload()})}},e.renameSelected=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.rename.html",size:"md",controller:"assetsRenameModalCtrl"});s.result.then(function(e){e&&o.reload()})}},e.showInfoSelected=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.info.html",size:"md",controller:"assetsInfoModalCtrl"});s.result.then(function(e){e&&o.reload()})}},e.deleteSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.modal={title:"Remove?",message:"Are you sure to remove this?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("selectedFile: ",e.selectedFile),_.isEmpty(e.selectedFile)||(e.selectedFile.isFolder?e.selectedFile.isDeleted?s.deleteFolder(e.selectedFile._id).then(t):s.trashFolder(e.selectedFile._id).then(t):e.selectedFile.isDeleted?s.deleteAssetFile(e.selectedFile._id).then(t):s.trashAssetFile(e.selectedFile._id).then(t))})},e.moveSelected=function(){if(e.selectedFile){var s=i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.move.html",size:"sm",controller:"assetsMoveModalCtrl"});s.result.then(function(e){e&&o.reload()})}},e.previewSelected=function(){e.selectedFile&&e.openFile(e.selectedFile)},e.starredSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?s.starredFolder(e.selectedFile._id).then(t):s.starredAssetFile(e.selectedFile._id).then(t))},e.restoreSelected=function(){function t(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?s.restoreFolder(e.selectedFile._id).then(t):s.restoreAssetFile(e.selectedFile._id).then(t))},e.openLightboxModal=function(e){console.log("openLightboxModal: ",e);var s=[];s.push({url:e.asset_url,caption:e.asset_name,thumbUrl:e.asset_url}),console.log("arry: ",s),c.openModal(s,0)},e.openVideoModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.media.html",controller:"assetsMediaModalCtrl",size:"lg",resolve:{files:function(){return e},type:function(){return"video"}}})},e.openAudioModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.media.html",controller:"assetsMediaModalCtrl",size:"md",resolve:{files:function(){return e},type:function(){return"audio"}}})},e.openDocsModal=function(e){i.open({animation:!0,backdrop:"static",templateUrl:"./modules/assets/assets.docs.html",controller:"assetsDocsModalCtrl",size:"lg",windowClass:"modal-fullscreen",resolve:{files:function(){return e}}})},e.openFolder=function(i){i.isFolder&&("main.trash"!==o.current.name?t._id?o.go("main.assets_sub_folder",{_id:t._id,sub_id:i._id}):o.go("main.assets_folder",{_id:i._id}):(e.modal={title:"This folder is in your trash",message:"To view this folder, youll need to restore it from your trash. Restore folder?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.restoreFolder(i._id).then(function(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))})})))},e.openFile=function(s){console.log("openFile: ",s),"image/jpeg"==s.asset_mimetype||"image/jpg"==s.asset_mimetype||"image/gif"==s.asset_mimetype||"image/x-ms-bmp"==s.asset_mimetype||"image/png"==s.asset_mimetype?e.openLightboxModal(s):"audio/mp3"==s.asset_mimetype||"audio/mp4"==s.asset_mimetype?e.openAudioModal(s):"video/mp4"==s.asset_mimetype||"video/x-flv"==s.asset_mimetype||"video/x-msvideo"==s.asset_mimetype||"video/x-ms-wmv"==s.asset_mimetype||"video/quicktime"==s.asset_mimetype||"video/3gpp"==s.asset_mimetype?e.openVideoModal(s):"application/pdf"==s.asset_mimetype?e.openDocsModal(s):"text/plain"==s.asset_mimetype?e.openDocsModal(s):"application/msword"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.wordprocessingml.document"==s.asset_mimetype?e.openDocsModal(s):"text/csv"==s.asset_mimetype||"application/vnd.ms-excel"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"==s.asset_mimetype?e.openDocsModal(s):"application/vnd.openxmlformats-officedocument.presentationml.presentation"==s.asset_mimetype||"application/vnd.ms-powerpoint"==s.asset_mimetype?e.openDocsModal(s):r.warning("No available tools to open","Failed")},e.deleteFile=function(t){console.log("media: ",t),e.modal={title:"Remove File",message:"Are you sure to remove the file?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.deleteAssetFile(t._id).then(function(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),d(function(){o.reload()},200))})})},e.clearSelection=function(){_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1})},e.activeSelected=function(s){s.isActive=!0,e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,s.isFolder?(e.showToolPreview=!1,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolMakeCopy=!0),e.selectedFile=s,_.each(e.assets.folders,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.assets,function(e){e._id!==s._id&&(e.isActive=!1)})}}])}();
!function(){"use strict";function e(e,s,o,t,n,i,a,c,l,r,u){console.log("assetsUploadModalCtrl: ",l),e.item={};var d={},f=JSON.parse(r.get("user"));d=l._id&&_.isUndefined(l.sub_id)?{url:n+i+"assets",method:"POST",headers:{Authorization:"Bearer "+c.getUserToken(),accesskey:f.subscriptionKey},formData:[{parent_id:l.sub_id}]}:l._id&&l.sub_id?{url:n+i+"assets",method:"POST",headers:{Authorization:"Bearer "+c.getUserToken(),accesskey:f.subscriptionKey},formData:[{parent_id:l.sub_id}]}:{url:n+i+"assets",method:"POST",headers:{Authorization:"Bearer "+c.getUserToken(),accesskey:f.subscriptionKey}};var m=e.uploader=new t(d);m.filters.push({name:"customFilter",fn:function(e,s){return this.queue.length<10}}),m.onBeforeUploadItem=function(e){e.alias="files",console.log("item:",e)},m.onSuccessItem=function(e,s,o,t){u.success(s.response.msg,"Success")},m.onWhenAddingFileFailed=function(e,s,o){console.log("item:",e),console.log("filter:",s),console.log("options:",o)},m.onAfterAddingFile=function(e){console.log("onAfterAddingFile:",e)},m.onCompleteAll=function(e){u.success("Media / File upload complete","Success"),a(function(){o.close("success")},1300)},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("assetsUploadModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","FileUploader","API_URL","API_VERSION","$timeout","AuthFctry","$stateParams","localStorageService","toastr"]}();
...
!function(){"use strict";function e(e,s,t,l,o,c){e.audio="audio"==c,e.config={sources:[{src:o.trustAsResourceUrl(l.asset_url),type:l.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.cancel=function(){t.dismiss("cancel")}}function s(e,s,t,l,o,c){console.log("files: ",o.asset_url),e.pdfName=o.media_name,"application/pdf"==o.asset_mimetype?e.pdfUrl=l.trustAsResourceUrl("https://docs.google.com/gview?url="+o.media_path+"&embedded=true"):"text/plain"==o.asset_mimetype?e.pdfUrl=l.trustAsResourceUrl("https://docs.google.com/gview?url="+o.media_path+"&embedded=true"):e.pdfUrl=l.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+o.asset_url),console.log("$scope.pdfUrl: ",e.pdfUrl),e.cancel=function(){t.dismiss("cancel")}}angular.module("POS17").controller("assetsMediaModalCtrl",e).controller("assetsDocsModalCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type"],s.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService"]}();
...
!function(){"use strict";function t(t,e){console.log("assetsStorageCtrl"),t.labels=["Videos","Free","Files"],t.data=[0,0,0],e(function(){t.data=[350,450,100]},500)}angular.module("POS17").controller("assetsStorageCtrl",t),t.$inject=["$scope","$timeout"]}();
!function(){"use strict";function t(t,s,a,n,c,e){t.sharer={},t.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("assetsInfoModalCtrl",t),t.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry"]}();
!function(){"use strict";function e(e,l,r,s,i,a){e.treedata=[{label:"User",id:"role1",children:[{label:"subUser1",id:"role11",children:[]},{label:"subUser2",id:"role12",children:[{label:"subUser2-1",id:"role121",children:[{label:"subUser2-1-1",id:"role1211",children:[]},{label:"subUser2-1-2",id:"role1212",children:[]}]}]}]},{label:"Admin",id:"role2",children:[]},{label:"Guest",id:"role3",children:[]}],e.cancel=function(){l.dismiss("cancel")}}angular.module("POS17").controller("assetsMoveModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry"]}();

...
!function(){"use strict";angular.module("POS17").factory("jQuery",["$window",function(e){return e.jQuery}]).factory("_",["$window",function(e){return e.jQuery}]).factory("PDFJS",["$window",function(e){return e.PDFJS}]).factory("async",["$window",function(e){return e.async}]).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location","ONESIGNAL","ngDialog","$browser",function(e,n,o,t,r,a,u,i,s,c,g){n.currentUser={},n.$state=e,n.previousState,n.currentState,n.changesOccur=0,g.baseHref=function(){return"/"},r.user_timezone=moment.tz.guess(),r.user_timezone2=moment().format("Z"),n.$on("loading:progress",function(){console.log("loading:progress"),n.productIsLoading=!0}),n.$on("loading:finish",function(){console.log("loading:finish"),n.productIsLoading=!1}),n.$on("unauthorized",function(){t.setCurrentUser(null),t.setUserToken(null),e.go("login")}),n.goBack=function(){r.history.back()},n.$on("$stateChangeStart",function(o,r,s,g,l){if(t.getCurrentUser()){var f=t.getUserToken();a.isTokenExpired(f)&&(u.remove("user"),u.remove("token"),i.path("/login"))}n.changesOccur>2&&(o.preventDefault(),n.modal={title:"Changes Detected?",message:"Are you sure to proceed without saving or updating?"},c.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:n,className:"ngdialog-theme-default"}).then(function(){n.changesOccur=0,e.go(r.name)},function(){console.log("NO")}))}),n.$on("$stateChangeSuccess",function(e,o,r,a,u){n.previousState=a.name,n.currentState=o.name,n.currentUser=t.getCurrentUser()});var l=r.OneSignal||[];l.push(["init",{appId:s.appID,autoRegister:!1,subdomainName:s.domain,notifyButton:{enable:!0}}])}])}();
=======
...
!function(){"use strict";function e(e,t,s,o,r,n,i,a,l,d,u,c,p,f,g,m,h){function v(t){if(t)return _.find(e.suppliers,function(e){return e.s_id==t})}function y(){e.items.quantity=null,e.items.price=null,e.items.total=null}e.isColl=!1,e.radioModel="product",e.products=[],e.productBundles=[],e.items={},e.suppliers=[],e.customers=[],e.stores=[],e.details={},e.details.details=[],e.details.products_list=[],e.details.emailsubject;var P=!1,M=5e3;e.showMessage=!1,e.showsecondMessage=!1,e.showExportMessage=!1,e.enAbleToSendForm,e.profile={},e.stores.selected={},e.datenow=h(new Date).format("MMMM Do YYYY"),e.doGreeting=function(){P&&a.cancel(P),e.showMessage=!0,P=a(function(){e.showMessage=!1,e.showsecondMessage=!0,P=a(function(){e.showsecondMessage=!1},2e3)},M)},e.doExport=function(){P&&a.cancel(P),e.showExportMessage=!0,P=a(function(){e.showExportMessage=!1,e.showsecondExportMessage=!0,P=a(function(){e.showsecondExportMessage=!1},2e3)},M)},e.changeData=function(t){e.radioModel=t},e.getoveralltotal=function(t){e.overalltotal=_.sumBy(t,function(e){return e.price*(e.quantity_ordered||e.quantity)})},e.getGeneratedPOId=function(){f.generatepoid().then(function(t){e.details.po_number=t.response.result})},e.getGeneratedPOId(),e.loadpo=function(){f.getAllPurchaseOrderDetail(n.selected_id).then(function(t){t&&200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.details.emailsubject="PO Number "+e.details.po_number,e.getoveralltotal(e.details.details))})},e.getCurrentUser=function(){t.userprofile().then(function(t){if(200==t.statusCode&&t.response.success)e.profile=t.response.result,e.currentemail=t.response.result.profile.email,e.details.currentemail=t.response.result.profile.email,e.details.store_id=t.response.result.profile.store_id,e.details.store_name=t.response.result.profile.StoreInfo,d.getAllProduct().then(function(s){if(s&&200==s.statusCode&&s.response.success){var o=s.response.result,r=_.filter(o,function(e){if(e.store_id==t.response.result.profile.store_id)return e});_.each(r,function(t){0==t.is_archived&&null!=t.store_name&&e.products.push(t)})}});else if(400==t.statusCode&&!t.response.success)return void l.error(t.response.msg,"Error")})},u.getAllSuppliers().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.suppliers=t.response.result)}),p.getAllPerson().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.customers=_.filter(t.response.result,function(e){return 2==e.per_type_id}))}),g.getAllStore().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.stores=t.response.result,e.stores[0].store_id=e.details.store_id)}),d.getAllProductBundle().then(function(t){if(t&&200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){1!==t.is_archived&&e.productBundles.push(t)})}}),e.setSelectedStore=function(t){e.stores.selected=t},e.calculateItem=function(e){var t=0,s=0,s=e.price*e.quantity;return t+=parseFloat(s),e.total=t,e.total},e.parseDate=function(e){if(e)return h(new Date(e)).format("MMMM Do YYYY")},e.toast_emailnotifs=function(e){"Sent"==e||"sent"==e?l.success("Email Sent","Success"):l.warning("Email not Sent","Warning")},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.addToList=function(t){_.isEmpty(t)?l.warning("Product list could not empty","Warning"):"product"==e.radioModel?_.isUndefined(t)||(e.details.details.push({item_name:t.product.item_name,quantity_ordered:t.quantity,quantity:t.quantity,price:t.price,discount:t.discount,total:t.total,product_id:t.product.p_id,bundle_id:null,total_cost:t.quantity*t.price,direct_sending:!0}),e.getoveralltotal(e.details.details),y()):"productgroup"==e.radioModel&&(_.isUndefined(t.productgroup)||(e.details.details.push({item_name:t.productgroup.bundle_name,quantity:t.quantity,quantity_ordered:t.quantity,price:t.price,discount:t.discount,total:t.total,product_id:null,bundle_id:t.productgroup.pb_id,total_cost:t.quantity*t.price,direct_sending:!0}),e.getoveralltotal(e.details.details),y()))},e.approvedPO=function(){var e={approved_by:n.selected_id};f.approvedPurchasedOrder(n.selected_id,e).then(function(e){e&&200==e.statusCode&&e.response.success?l.success(e.response.msg,"Success"):l.error(e?e.response.msg:"Error Found","Eror")})},e.savePO=function(t){var o=JSON.parse(s.get("user"));e.details.created_by=o.uc_id,e.details.emailmessage="",e.details.toSend=t,e.details.products_list=e.details.details,e.details.supplier_id&&e.details.deliver_to&&e.details.po_number?(e.details.suppliername=v(e.details.supplier_id).name,n.selected_id?(console.log("updating PO."),f.updatePurchaseOrder(n.selected_id,e.details).then(function(s){if(s&&200==s.statusCode&&s.response.success){l.success(s.response.msg,"Success");n.selected_id;t&&e.approvedPO(),i.go("main.view_savepo",{selected_id:n.selected_id})}else l.error(s?s.response.msg:"Error Found","Eror");t?e.toast_emailnotifs(s&&s.response.email?s.response.email:"Error Found"):""})):(console.log("saving PO."),f.savePurchaseOrder(e.details).then(function(s){if(s&&200==s.statusCode&&s.response.success){l.success(s.response.msg,"Success");var o=s.response.result.inserted_po_id;t&&e.approvedPO(),i.go("main.view_savepo",{selected_id:o})}else l.error(s?s.response.msg:"Error Found","Eror");t?e.toast_emailnotifs(s&&s.response.email?s.response.email:"Error Found"):""}))):l.warning("Fill in all the required fields in the first tab","Warning")},e.toggleModal=function(){m.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log(".."),e.backto_fstpasge()},function(e){console.log("reason ",e)})},e.calculateItems=function(t){var s=0,o=0;_.each(e.details.products_list,function(e){var t=e.price-e.discount;s=t*e.quantity,o+=parseFloat(s)}),e.details.sub_total=o,e.calculateBilling()},e.calculateBilling=function(){e.total=parseFloat(e.details.sub_total||0)+parseFloat(e.details.tax||0)+parseFloat(e.details.shipping_fee||0)},e.removeProduct=function(t){e.details.details.splice(t,1)},e.edit=function(e){i.go("main.products-add",{p_id:e})},e.openPOUpdateModal=function(t){e.enAbleToSendForm=t,t?e.details.po_status="Sent":e.details.po_status="Open",e.details.emailsubject="PO Number "+e.details.po_number,m.openConfirm({templateUrl:"./modules/purchase_order/po.update.modal.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){e.savePO(t)},function(e){console.log("Modal promise close: ")})},e.open_scndpage=function(){e.fstpasge=!1,e.scndpage=!0},e.onSelectedProduct=function(t){e.items.price=t.sell_price},e.goback=function(){i.go("main.purchase_order")},e.init=function(){e.getCurrentUser(),n.selected_id&&e.loadpo(),e.getGeneratedPOId()},e.init()}angular.module("POS17").controller("addOrderController",e),e.$inject=["$scope","AuthFctry","localStorageService","$http","$filter","$stateParams","$state","$timeout","toastr","productFactory","supplierFctry","ngTableParams","humanFactory","purchaseOrderFactory","storeFactory","ngDialog","moment"]}();

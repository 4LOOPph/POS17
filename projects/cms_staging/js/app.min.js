...
!function(){"use strict";function s(s,e,r,t,a,n,o,i,c){s.sharer={},s.users=[],s.items=[],s.asset={},s.asset=c,s.owner={},s.sharer.isPublic=0!=s.asset.isPublic,async.waterfall([function(s){i.getAllUserAccounts().then(function(e){if(200==e.statusCode&&e.response.success){var r=e.response.result;s(null,r)}else s(null,[])})},function(r,t){s.users=angular.copy(r),_.remove(s.users,function(s){return s.uc_id==e.profile.uc_id}),_.each(s.users,function(e){var r=e.profile;s.items.push({displayName:r.displayName,email:r.email||"",_id:r._id,id:e.uc_id,type:"user"})})}]),o.getSharedAssetFile(s.asset.asset_id).then(function(e){return 200==e.statusCode&&e.response.success?void(s.sharer.email=_.map(e.response.result,function(s){return{displayName:rowdata.displayName,email:rowdata.email||"",_id:rowdata._id,id:rowdata.uc_id,type:"user"}})):void n.error(e.response.msg,"Error")}),s.tagTransform=function(s){return{displayName:s}},s.clearInput=function(s){s.search=""},s.deleteEmail=function(s){console.log("deleteEmail: ",s)},s.sendMail=function(){var e=_.map(s.sharer.email,function(s){return{id:s.id,type:s.type}});s.sharer.isPublic?o.publicSharedAssetFile(s.asset.asset_id,"public").then(function(s){return 200==s.statusCode&&s.response.success?(n.success(s.response.msg,"Success"),void r.close("save")):void n.error(s.response.msg,"Error")}):e&&e.length>0?o.removeSharedAssetFile(s.asset.asset_id).then(function(t){if(200!=t.statusCode||!t.response.success)return void n.error(t.response.msg,"Error");var a=1;async.eachSeries(e,function(t,i){o.shareAssetFile(s.asset.asset_id,{shared_to:t.id,share_type:t.type}).then(function(s){return 200==s.statusCode&&s.response.success?(n.success(s.response.msg,"Success"),a++,i(),void 0):400===s.statusCode&&!s.response.success&&_.isArray(s.response.result)?void _.each(s.response.result,function(s){n.warning(s.msg,"Warning")}):void n.error(s.response.msg,"Error")}),a==e.length&&r.close("save")})}):o.publicSharedAssetFile(s.asset.asset_id,"private").then(function(s){return 200==s.statusCode&&s.response.success?(n.success(s.response.msg,"Success"),void r.close("save")):void n.error(s.response.msg,"Error")})},s.cancel=function(){r.dismiss("cancel")}}angular.module("POS17").controller("assetsShareModalCtrl",s),s.$inject=["$scope","$rootScope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","useraccountsFctry","asset_file"]}();

...
!function(){"use strict";function e(e,s,o,n,t,r,i,u,c,a){console.log("MainCtrl"),e.profile={},e.activeSub="",e.appPermissions={},s.logoutApp=function(){r.logout().then(function(e){if(200==e.statusCode&&e.response.success){var s=JSON.parse(i.get("user"));a.logTransaction("User Logout","LOGOUT",s.username,"User Logout USERNAME:="+s.username).then(function(){r.setCurrentUser(null),r.setUserToken(null),c.logout()}),o.go("login")}})},s.getCurrentUser=function(){async.waterfall([function(s){r.userprofile().then(function(o){if(200==o.statusCode&&o.response.success){e.profile=o.response.result;var t=JSON.parse(i.get("user"));e.activeSub=t.company_name,s()}else if(400==o.statusCode&&!o.response.success)return void n.error(o.response.msg,"Error")})},function(s){r.getAppPermission().then(function(s){if(200!=s.statusCode||!s.response.success)return void n.error(s.response.msg,"Error");var o=s.response.result;_.isEmpty(o)||(e.appPermissions=o,console.log("$rootScope.appPermissions: ",e.appPermissions))})}])},s.openSubscription=function(){var e=t.open({animation:!0,templateUrl:"./modules/templates/header.subscription.html",controller:"ModalSubscriptionCtrl",size:"sm"}),s=JSON.parse(i.get("user"));a.logTransaction("Active Subscription","DASHBOARD","N/A","User:="+s.username+" Views Active Subscription"),e.result.then(function(e){var s=JSON.parse(i.get("user"));s.sub_id=e.sub_id,s.company_name=e.company_name,s.subscriptionKey=e.subscriptionKey,i.set("user",JSON.stringify(s)),u(function(){o.go("main.dashboard",null,{reload:!0})},1e3)})},s.getCurrentUser()}function s(e,s,o){e.switchSubscription=function(e){o(function(){s.close(e)},300)},e.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("MainCtrl",e).controller("ModalSubscriptionCtrl",s),e.$inject=["$rootScope","$scope","$state","toastr","$uibModal","AuthFctry","localStorageService","$timeout","$auth","transLogFctry"],s.$inject=["$scope","$uibModalInstance","$timeout"]}();
...
!function(){"use strict";angular.module("POS17").directive("errSrc",function(){return{link:function(e,t,i){e.$watch(function(){return i.ngSrc},function(e){e||t.attr("src",i.errSrc)}),t.bind("error",function(){t.attr("src",i.errSrc)})}}}).directive("sidebar",function(){return{restrict:"C",compile:function(e,t,i){$.AdminLTE.tree(e)}}}).directive("header",function(){return{restrict:"E",templateUrl:"./modules/templates/header.html",compile:function(e,t,i){$.AdminLTE.pushMenu($(e).find(".sidebar-toggle"))}}}).directive("knob",function(){return{restrict:"C",compile:function(e,t,i){e.knob({draw:function(){if("tron"==this.$.data("skin")){var e,t=this.angle(this.cv),i=this.startAngle,n=this.startAngle,r=n+t,a=!0;return this.g.lineWidth=this.lineWidth,this.o.cursor&&(n=r-.3)&&(r+=.3),this.o.displayPrevious&&(e=this.startAngle+this.angle(this.value),this.o.cursor&&(i=e-.3)&&(e+=.3),this.g.beginPath(),this.g.strokeStyle=this.previousColor,this.g.arc(this.xy,this.xy,this.radius-this.lineWidth,i,e,!1),this.g.stroke()),this.g.beginPath(),this.g.strokeStyle=a?this.o.fgColor:this.fgColor,this.g.arc(this.xy,this.xy,this.radius-this.lineWidth,n,r,!1),this.g.stroke(),this.g.lineWidth=2,this.g.beginPath(),this.g.strokeStyle=this.o.fgColor,this.g.arc(this.xy,this.xy,this.radius-this.lineWidth+1+2*this.lineWidth/3,0,2*Math.PI,!1),this.g.stroke(),!1}}})}}}).directive("sparkline",function(){return{restrict:"C",compile:function(e,t,i){e.each(function(){var e=$(this);e.sparkline("html",e.data())})}}}).directive("box",function(){return{restrict:"C",compile:function(e,t,i){var n=this;$(e).find(this.boxWidgetOptions.boxWidgetSelectors.collapse).click(function(e){e.preventDefault(),n.collapse($(this))}),$(e).find(this.boxWidgetOptions.boxWidgetSelectors.remove).click(function(e){e.preventDefault(),n.remove($(this))})},collapse:function(e){var t=e.parents(".box").first(),i=t.find(".box-body, .box-footer");t.hasClass("collapsed-box")?(e.children(".fa-plus").removeClass("fa-plus").addClass("fa-minus"),i.slideDown(300,function(){t.removeClass("collapsed-box")})):(e.children(".fa-minus").removeClass("fa-minus").addClass("fa-plus"),i.slideUp(300,function(){t.addClass("collapsed-box")}))},remove:function(e){var t=e.parents(".box").first();t.slideUp()},boxWidgetOptions:{boxWidgetIcons:{collapse:"fa fa-minus",open:"fa fa-plus",remove:"fa fa-times"},boxWidgetSelectors:{remove:'[data-widget="remove"]',collapse:'[data-widget="collapse"]'}}}}).directive("chat",function(){return{restrict:"E",templateUrl:"./modules/templates/direct-chat.html",scope:{type:"@",title:"@",count:"@count",messages:"=messages"},replace:!0,compile:function(e,t){return e.find("[data-widget='chat-pane-toggle']").click(function(){$(this).parents(".direct-chat").first().toggleClass("direct-chat-contacts-open")}),{pre:function(e,t,i){},post:function(e,t,i){}}}}}).directive("repeatEnd",function(){return{restrict:"A",link:function(e,t,i){e.$last&&e.$eval(i.repeatEnd)}}}).directive("ngRepeatEndWatch",function(){return{restrict:"A",scope:{},link:function(e,t,i){if(!i.ngRepeat)throw"ngRepeatEndWatch: `ngRepeat` Directive required to use this Directive";e.$parent.$last&&(""!==i.ngRepeatEndWatch?"function"==typeof e.$parent.$parent[i.ngRepeatEndWatch]?e.$parent.$parent[i.ngRepeatEndWatch]():e.$parent.$parent[i.ngRepeatEndWatch]=!0:e.$parent.$parent.ngRepeatEnd=!0)}}}).directive("dateNow",["$filter",function(e){return{link:function(t,i,n){i.text(e("date")(new Date,n.dateNow))}}}]).directive("infiniteScroll",["$rootScope","$window","$timeout",function(e,t,i){return{link:function(n,r,a){var s,o,l,c;return t=angular.element(t),r.css("overflow-y","auto"),r.css("overflow-x","hidden"),r.css("height","inherit"),l=0,null!=a.infiniteScrollDistance&&n.$watch(a.infiniteScrollDistance,function(e){return l=parseInt(e,10)}),c=!0,s=!1,null!=a.infiniteScrollDisabled&&n.$watch(a.infiniteScrollDisabled,function(e){if(c=!e,c&&s)return s=!1,o()}),e.$on("refreshStart",function(){r.animate({scrollTop:"0"})}),o=function(){var t,i,o,d,u;return t=$(r.children()[0]),i=r.offset().top+r.height(),u=t.offset().top+t.height(),o=u-i,d=o<=r.height()*l,d&&c?e.$$phase?n.$eval(a.infiniteScroll):n.$apply(a.infiniteScroll):d?s=!0:void 0},r.on("scroll",o),n.$on("$destroy",function(){return t.off("scroll",o)}),i(function(){return a.infiniteScrollImmediateCheck?n.$eval(a.infiniteScrollImmediateCheck)?o():void 0:o()},0)}}}]).directive("starRating",function(){return{restrict:"EA",template:'<ul class="star-rating" ng-class="{readonly: readonly}">  <li ng-repeat="star in stars" class="star" ng-class="{filled: star.filled}" ng-click="toggle($index)">    <i class="fa fa-star"></i>  </li></ul>',scope:{ratingValue:"=ngModel",max:"=?",onRatingSelect:"&?",readonly:"=?"},link:function(e,t,i){function n(){e.stars=[];for(var t=0;t<e.max;t++)e.stars.push({filled:t<e.ratingValue})}void 0==e.max&&(e.max=5),e.toggle=function(t){void 0!=e.readonly&&e.readonly!==!1||(e.ratingValue=t+1,e.onRatingSelect({rating:t+1}))},e.$watch("ratingValue",function(e,t){t&&n()})}}}).directive("ngThumb",["$window",function(e){var t={support:!(!e.FileReader||!e.CanvasRenderingContext2D),isFile:function(t){return angular.isObject(t)&&t instanceof e.File},isImage:function(e){var t="|"+e.type.slice(e.type.lastIndexOf("/")+1)+"|";return"|jpg|png|jpeg|bmp|gif|".indexOf(t)!==-1}};return{restrict:"A",template:"<canvas/>",link:function(e,i,n){function r(e){var t=new Image;t.onload=a,t.src=e.target.result}function a(){var e=s.width||this.width/this.height*s.height,t=s.height||this.height/this.width*s.width;o.attr({width:e,height:t}),o[0].getContext("2d").drawImage(this,0,0,e,t)}if(t.support){var s=e.$eval(n.ngThumb);if(t.isFile(s.file)&&t.isImage(s.file)){var o=i.find("canvas"),l=new FileReader;l.onload=r,l.readAsDataURL(s.file)}}}}}]).directive("numbersOnly",function(){return{require:"ngModel",link:function(e,t,i,n){function r(e){if(e){var t=e.replace(/[^0-9-]/g,"");return t!==e&&(n.$setViewValue(t),n.$render()),t}}n.$parsers.push(r)}}}).directive("compareTo",function(){return{require:"ngModel",scope:{otherModelValue:"=compareTo"},link:function(e,t,i,n){n.$validators.compareTo=function(t){return t==e.otherModelValue},e.$watch("otherModelValue",function(){n.$validate()})}}}).directive("validPasswordC",function(){return{require:"ngModel",link:function(e,t,i,n){n.$setValidity("noMatch",!0),i.$observe("validPasswordC",function(e){console.log("newVal: ",e),"true"==e?n.$setValidity("noMatch",!0):1==e?n.$setValidity("noMatch",!0):n.$setValidity("noMatch",!1)})}}}).directive("validNumber",function(){return{require:"?ngModel",link:function(e,t,i,n){n&&(n.$parsers.push(function(e){if(angular.isUndefined(e))var e="";var t=e.replace(/[^-0-9\.]/g,""),i=t.split("-"),r=t.split(".");return angular.isUndefined(i[1])||(i[1]=i[1].slice(0,i[1].length),t=i[0]+"-"+i[1],i[0].length>0&&(t=i[0])),angular.isUndefined(r[1])||(r[1]=r[1].slice(0,2),t=r[0]+"."+r[1]),e!==t&&(n.$setViewValue(t),n.$render()),t}),t.bind("keypress",function(e){32===e.keyCode&&e.preventDefault()}))}}}).directive("ngBooleanRadio",function(){return{require:"ngModel",link:function(e,t,i,n){n.$formatters.push(function(e){return e===!0?"true":e===!1?"false":void 0}),n.$parsers.push(function(e){return"true"===e||"false"!==e&&void 0})}}}).directive("treeview",function(){return $.fn.tree=function(){return this.each(function(){var e=$(this).children("a").first(),t=$(this).children(".treeview-menu").first(),i=$(this).hasClass("active");i&&(t.show(),e.children(".fa-angle-left").first().removeClass("fa-angle-left").addClass("fa-angle-down")),e.click(function(n){n.preventDefault(),i?(t.slideUp(),i=!1,e.children(".fa-angle-down").first().removeClass("fa-angle-down").addClass("fa-angle-left"),e.parent("li").removeClass("active")):(t.slideDown(),i=!0,e.children(".fa-angle-left").first().removeClass("fa-angle-left").addClass("fa-angle-down"),e.parent("li").addClass("active"))}),t.find("li > a").each(function(){var e=parseInt($(this).css("margin-left"))+10;$(this).css({"margin-left":e+"px"})})})},{restrict:"C",link:function(e,t,i){t.tree()}}}).directive("barsChart",function(e){var t={restrict:"E",replace:!1,scope:{data:"=chartData"},link:function(e,t,i){var n=d3.select(t[0]);n.append("div").attr("class","chart").selectAll("div").data(e.data).enter().append("div").transition().ease("elastic").style("width",function(e){return e+"%"}).text(function(e){return e+"%"})}};return t})}();
...
!function(){"use strict";function t(t,r,n){return{getDashboardReport:function(r){return t.all("report/reports").customGET("",r).then(function(t){return t},function(t){return t.data})}}}angular.module("POS17").factory("dashboardReportsFctry",t),t.$inject=["Restangular","API_URL","toastr"]}();

...
!function(){"use strict";function e(e,o,n,t,c,s){e.audio="audio"==s,e.config={sources:[{src:c.trustAsResourceUrl(t.media_path),type:t.media_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.cancel=function(){n.dismiss("cancel")}}function o(e,o,n,t,c){console.log("files: ",c),e.pdfName=c.media_name,e.pdfUrl=c.media_path,e.scroll=0,e.loading='<i class="fa fa-spinner fa-spin fa-3x"></i>',e.getNavStyle=function(e){return e>100?"pdf-controls fixed":"pdf-controls"},e.onError=function(e){console.log(e)},e.onLoad=function(){e.loading=""},e.onProgress=function(e){console.log(e)},e.cancel=function(){n.dismiss("cancel")}}angular.module("POS17").controller("articleMediaModalCtrl",e).controller("articleDocsModalCtrl",o),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type"],o.$inject=["$scope","$state","$uibModalInstance","$sce","files"]}();

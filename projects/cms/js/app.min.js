...
!function(){"use strict";function e(e,t,s,o,r,c,a,i,n,d){function l(){i.getAllCategory().then(function(t){if(200==t.statusCode&&t.response.success){for(var s=t.response.result,o=0;o<s.length;o++){var r=s[o],c=r.name,a=r.parent_id,i=r.c_id;p[a]?(r={parentid:a,label:c,item:r},null!=r&&(p[a].items||(p[a].items=[]),p[a].items[p[a].items.length]=r,p[i]=r)):(p[i]={parentid:a,label:c,item:r},u[i]=p[i])}e.categoryData=_(u).omit(_.isUndefined).omit(_.isNull).value(),e.categorycopy=angular.copy(e.categoryData)}})}e.search={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.categories=[],e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.selectedArchivedDatas=[];var u=[],p=[];e.side=!1;var h=function(){e.productTable=new n({page:1,count:20},{counts:[20,45,60,100],getData:function(t,o){e.productIsLoading=!0,e.products=[],e.productscopy=[],a.getAllProduct().then(function(r){if(200==r.statusCode&&r.response.success){var a=r.response.result;e.totalItems=a.length,e.productscopy=angular.copy(r.response.result),e.txtSearch&&"All"==e.applicationStatus&&e.currentNode?(console.log("1"),e.products=s("filter")(a,e.txtSearch)):e.txtSearch&&"Publish"==e.applicationStatus&&e.currentNode?(console.log("2"),e.products=s("filter")(a,{is_published:1}),e.products=s("filter")(e.products,e.txtSearch)):e.txtSearch&&"Archived"==e.applicationStatus&&e.currentNode?(console.log("3"),e.products=s("filter")(a,{is_archived:1}),e.products=s("filter")(e.products,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus&&e.currentNode?(console.log("4"),e.products=s("filter")(a,{is_published:0}),e.products=s("filter")(e.products,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?(console.log("5"),e.products=a):_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus?(console.log("6"),e.products=s("filter")(a,{is_published:1})):_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus?(console.log("7"),e.products=s("filter")(a,{is_archived:1})):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?(console.log("8"),e.products=s("filter")(a,{is_published:0})):_.isUndefined(e.txtSearch)&&_.isUndefined("All"==e.applicationStatus)&&e.currentNode?console.log("9"):_.isUndefined(e.txtSearch)&&_.isUndefined("Publish"==e.applicationStatus)&&e.currentNode?console.log("10"):_.isUndefined(e.txtSearch)&&_.isUndefined("Archived"==e.applicationStatus)&&e.currentNode?console.log("11"):_.isUndefined(e.txtSearch)&&_.isUndefined("Draft"==e.applicationStatus)&&e.currentNode?console.log("12"):e.products=a,o.total(e.products.length);var i=e.products.slice((o.page()-1)*o.count(),o.page()*o.count());t.resolve(i),e.productIsLoading=!1}else e.productIsLoading=!1,c.error(r.response.msg,"Error")})}})},f=function(){e.get=[],e.$watch("mytree.currentNode",function(t,s){var o=[],r={},c={};e.category=[],e.tree=[],e.currentNode=[];var a=[];if(e.mytree&&angular.isObject(e.mytree.currentNode)){e.currentNode=e.mytree.currentNode.item,console.log("$scope.productscopy:",e.productscopy),console.log("$scope.categorycopy:",e.categorycopy);var i=_.find(e.categorycopy,{parentid:e.currentNode.c_id});if(console.log("sample2:",i),_.isUndefined(i)){var n=_.map(e.productscopy,function(t){var s=_.filter(t.product_category,{category_id:e.currentNode.c_id});return s.length>0?_.find(s,function(e){return e}):void 0});console.log("product_categories:",n),c=_.filter(n,function(e){return _.isUndefined(e)?void 0:e}),console.log("product_categories2:",c),r=_.map(_.uniqBy(c,"product_id"),function(e){return e.product_id}),_.forEach(r,function(t){o.push(_.find(e.productscopy,{p_id:t}))})}else{var d=_.map(i.items,function(e){return{c_id:e.item.c_id}});_.each(e.productscopy,function(e){_.each(d,function(t){var s=_.filter(e.product_category,{category_id:t.c_id});s&&s.length>0&&a.push(s[0])})});var l=_.map(_.uniqBy(a,"product_id"),function(e){return e.product_id});_.forEach(l,function(t){o.push(_.find(e.productscopy,{p_id:t}))})}return o}},!1)};l(),f(),h(),i.getAllCategory().then(function(t){200==t.statusCode&&t.response.success&&(e.categories=t.response.result)}),e.setPage=function(t){e.currentPage=t},e.setItemsPerPage=function(t){e.itemsPerPage=t,e.currentPage=1},e.edit=function(e){o.go("main.products-add",{p_id:e})},e.searchData=function(){e.productTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productTable.reload()},e.updateStatus=function(t){e.applicationStatus=t,e.productTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.products,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.p_id===t.p_id})||(e.selectedDatas.push(t),1==t.is_published&&e.selectedPublishedDatas.push(t),0==t.is_published&&e.selectedDraftedDatas.push(t),1==t.is_archived&&e.selectedArchivedDatas.push(t)):(console.log("filter"),e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.p_id!==t.p_id})),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){e.modal={title:"Archive Product?",message:"Are you sure to archive this selected products?"},d.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;async.eachSeries(e.selectedDatas,function(s,r){s.selected&&a.archiveProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,r(),void 0):void c.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&o.reload()})})},e.draftSelected=function(){e.modal={title:"Draft Product?",message:"Are you sure to Draft this selected products?"},d.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedPublishedDatas.length>0?void async.eachSeries(e.selectedPublishedDatas,function(s,r){s.selected&&1==s.is_published&&a.draftProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,r(),void 0):void c.error(e.response.msg,"Error")}),t==e.selectedPublishedDatas.length&&o.reload()}):void c.warning("Unable to Draft selected Products..Selected products are either archived or already drafted","Warning")})},e.publishSelected=function(t){e.modal={title:"Publish Product?",message:"Are you sure to Publish this selected products?"},d.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedDraftedDatas.length>0?void async.eachSeries(e.selectedDraftedDatas,function(s,r){s.selected&&0==s.is_published&&a.publishProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),t++,r(),void 0):void c.error(e.response.msg,"Error")}),t==e.selectedDraftedDatas.length&&o.reload()}):void c.warning("Unable to Publish selected Products..Selected products are either archived or already published","Warning")})}}angular.module("POS17").controller("productsController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","categoryFactory","ngTableParams","ngDialog"]}();

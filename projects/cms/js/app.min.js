!function(){"use strict";angular.module("POS17",["ngSanitize","ngAnimate","ui.router","chart.js","angular-flot","ui.bootstrap","textAngular","ngFileUpload","ui.footable","restangular","toastr","angularMoment","angularSpinner","ngDialog","ui.select","mgcrea.ngStrap","LocalStorageModule","dibari.angular-ellipsis","angular-jwt","color.picker","ja.qr","angularTreeview","angularFileUpload","dndLists","ngTable","kk.timepicker","angularjs-dropdown-multiselect"]).constant("API_URL","http://54.206.38.223:5001").constant("API_VERSION","/api/1.0/").config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","API_URL","API_VERSION","$provide","localStorageServiceProvider","uiSelectConfig",function(e,t,r,n,o,a,i,u,s,l){r.html5Mode(!1),t.otherwise("/login"),l.resetSearchInput=!0,e.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),n.interceptors.push("httpInterceptor"),n.interceptors.push("authInterceptor"),u.value("baseURL",a),o.setBaseUrl(a+i)}]).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location",function(e,t,r,n,o,a,i,u){t.currentUser={},t.$state=e,t.previousState,t.currentState,t.$on("loading:progress",function(){t.productIsLoading=!0}),t.$on("loading:finish",function(){t.productIsLoading=!1}),t.$on("unauthorized",function(){n.setCurrentUser(null),n.setUserToken(null),e.go("login")}),t.goBack=function(){o.history.back()},t.$on("$stateChangeStart",function(e,t,r,o,s){if(n.getCurrentUser()){var l=n.getUserToken();a.isTokenExpired(l)&&(i.remove("user"),i.remove("token"),u.path("/login"))}}),t.$on("$stateChangeSuccess",function(e,r,o,a,i){t.previousState=a.name,t.currentState=r.name,t.currentUser=n.getCurrentUser()})}]).factory("httpInterceptor",["$q","$rootScope",function(e,t){var r=0;return{request:function(n){return 1===++r&&t.$broadcast("loading:progress"),n||e.when(n)},response:function(n){return 0===--r&&t.$broadcast("loading:finish"),n||e.when(n)},responseError:function(n){return 0===--r&&t.$broadcast("loading:finish"),e.reject(n)}}}])}();
...
!function(){"use strict";function e(e,t,a,s,l,c,i,r,n){e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[];var o=function(){e.articleisLoading=!0,e.articles=[],e.articleTable=new r({page:1,count:10},{counts:[10,25,50,100],getData:function(t,l){i.getArticle().then(function(c){if(console.log("asdasdasd"),200==c.statusCode&&c.response.success){var i=c.response.result;console.log("articles:",i),e.txtSearch&&"All"==e.applicationStatus?e.articles=a("filter")(i,e.txtSearch):e.txtSearch&&"Active"==e.applicationStatus?(e.articles=a("filter")(i,{is_active:1}),e.articles=a("filter")(e.articles,e.txtSearch)):e.txtSearch&&"Inactive"==e.applicationStatus?(e.articles=a("filter")(i,{is_active:0}),e.articles=a("filter")(e.articles,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.articles=i:_.isUndefined(e.txtSearch)&&"Active"==e.applicationStatus?e.articles=a("filter")(i,{is_active:1}):_.isUndefined(e.txtSearch)&&"Inactive"==e.applicationStatus?e.articles=a("filter")(i,{is_active:0}):e.articles=i,l.total(e.articles.length);var r=e.articles.slice((l.page()-1)*l.count(),l.page()*l.count());t.resolve(r),e.articleisLoading=!1}else s.error(c.response.msg,"Error"),e.articleisLoading=!1})}})};e.refresh=function(){e.articleisLoading=!0,e.articleTable.reload()},e.edit=function(e){t.go("main.articles-detail",{article_id:e})},e.updateStatus=function(t){e.applicationStatus=t,e.articleTable.reload()},e.searchData=function(){e.articleTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.articles,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.article_id===t.article_id})||(e.selectedDatas.push(t),1==t.is_active&&e.selectedPublishedDatas.push(t),0==t.is_active&&e.selectedDraftedDatas.push(t)):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.article_id!==t.article_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=0;async.each(e.selectedDatas,function(l,c){l.selected&&i.deleteArticle(l.article_id).then(function(l){return 200==l.statusCode&&l.response.success?(s.success(l.response.msg,"Success"),++a,a==e.selectedDatas.length&&t.reload(),c(),void 0):void s.error(l.response.msg,"Error")})})})},e.draftSelected=function(){e.modal={title:"Draft Article?",message:"Are you sure to Draft this selected article?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=1;return e.selectedPublishedDatas.length>0?void async.eachSeries(e.selectedPublishedDatas,function(l,c){l.selected&&1==l.is_active&&i.draftArticle(l.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),a++,c(),void 0):void s.error(e.response.msg,"Error")}),console.log("dataCountToDelete: ",a),a==e.selectedPublishedDatas.length&&t.reload()}):void s.warning("Unable to Draft selected Articles..Selected articles are either archived or already drafted","Warning")})},e.publishSelected=function(a){e.modal={title:"Publish Article?",message:"Are you sure to Publish this selected article?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var a=1;return e.selectedDraftedDatas.length>0?void async.eachSeries(e.selectedDraftedDatas,function(l,c){l.selected&&0==l.is_active&&i.publishArticle(l.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),a++,c(),void 0):void s.error(e.response.msg,"Error")}),console.log("dataCountToDelete: ",a),a==e.selectedDraftedDatas.length&&t.reload()}):void s.warning("Unable to Publish selected Articles..Selected articles are either archived or already published","Warning")})},o()}angular.module("POS17").controller("articleController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","articleFctry","ngTableParams","ngDialog"]}();
!function(){"use strict";function e(e,t,i,s,r,d,l,n,a,u,o,c){function p(e){_.each($rootScope.cartItems,function(t){t.pb_id==e.pb_id&&(t.quantity=e.quantity)}),localStorageService.set("Cart",JSON.stringify($rootScope.cartItems))}e.details={},e.details.tags=[],e.details.article_feature=[],e.details.article_features_list=[],e.details.is_published=!1,e.details.is_archived=!1,e.radioModel="product",e.products=[],e.productBundles=[],e.mediafile=[],e.types=[],e.tags=[],e.tagsArr=[],e.infiniteScroll={},e.infiniteScroll.numToAdd=10,e.infiniteScroll.currentItems=10,e.resetInfScroll=function(){e.infiniteScroll.currentItems=e.infiniteScroll.numToAdd},e.addMoreItems=function(){e.infiniteScroll.currentItems+=e.infiniteScroll.numToAdd},c.getAllTags().then(function(t){200==t.statusCode&&t.response.success?e.tagsArr=t.response.result:s.error(t.response.msg,"Error")}),d.article_id&&(e.details.article_feature=[],e.details.article_features_list=[],l.getDetailArticle(d.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.showPublish=1!=e.details.is_active,e.details.article_features_list=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{item_name:e.product_details.item_name,item_code:e.product_details.product_code,item_brand:e.product_details.brand,item_id:e.product_details.p_id}:null!==e.bundle_id&&null==e.product_id?{item_name:e.bundle_details.bundle_name,item_code:e.bundle_details.bundle_code,item_brand:e.bundle_details.bundle_brand,item_id:e.bundle_details.pb_id}:void 0}),e.details.article_feature=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{product_id:e.product_details.p_id,bundle_id:null,article_id:d.article_id}:null!==e.bundle_id&&null==e.product_id?{product_id:null,bundle_id:e.bundle_details.pb_id,article_id:d.article_id}:void 0}),e.mediafile=t.response.result.mediafiles,c.getAllArticleTags(d.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details.tags=t.response.result)}))}),o.getAllProduct().then(function(t){if(200==t.statusCode&&t.response.success){var i=t.response.result;_.each(i,function(t){0==t.is_archived&&e.products.push(t)})}}),o.getAllProductBundle().then(function(t){if(200==t.statusCode&&t.response.success){var i=t.response.result;_.each(i,function(t){1!==t.is_archived&&e.productBundles.push(t)})}})),e.changeData=function(t){e.radioModel=t},e.reloadMediaFiles=function(){d.article_id&&(e.mediafile=[],l.getDetailArticle(d.article_id).then(function(t){200==t.statusCode&&t.response.success&&r(function(){e.$apply(function(){e.mediafile=t.response.result.mediafiles})},100)}))},e.reloadArticle=function(){d.article_id&&(e.details.article_feature=[],e.details.article_features_list=[],l.getDetailArticle(d.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.details.article_features_list=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{item_name:e.product_details.item_name,item_code:e.product_details.product_code,item_brand:e.product_details.brand,item_id:e.product_details.p_id}:null!==e.bundle_id&&null==e.product_id?{item_name:e.bundle_details.bundle_name,item_code:e.bundle_details.bundle_code,item_brand:e.bundle_details.bundle_brand,item_id:e.bundle_details.pb_id}:void 0}),e.details.article_feature=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{product_id:e.product_details.p_id,bundle_id:null,article_id:d.article_id}:null!==e.bundle_id&&null==e.product_id?{product_id:null,bundle_id:e.bundle_details.pb_id,article_id:d.article_id}:void 0}))}))},e.addToList=function(){"product"==e.radioModel?_.isUndefined(e.details.product)||_.isEmpty(e.details.product)||(_.find(e.details.article_features_list,{item_id:e.details.product.p_id})?s.warning("Product Item already existed","Warning"):(e.details.article_features_list.push({item_name:e.details.product.item_name,item_quantity:1,item_code:e.details.product.product_code,item_brand:e.details.product.brand,item_id:e.details.product.p_id}),e.details.article_feature.push({product_id:e.details.product.p_id,bundle_id:null,quantity:1,article_id:d.article_id}))):"productgroup"==e.radioModel&&(_.isUndefined(e.details.productgroup)||_.isEmpty(e.details.productgroup)||(_.find(e.details.article_features_list,{item_id:e.details.productgroup.pb_id})?s.warning("Bundle Item already existed","Warning"):(e.details.article_features_list.push({item_name:e.details.productgroup.bundle_name,item_quantity:1,item_code:e.details.productgroup.bundle_code,item_brand:e.details.productgroup.bundle_brand,item_id:e.details.productgroup.pb_id}),e.details.article_feature.push({bundle_id:e.details.productgroup.pb_id,product_id:null,quantity:1,article_id:d.article_id})))),e.details.product={},e.details.productgroup={}},e.minusbutton=function(e){e.quantity<1?(e.quantity=0,p(e)):(e.quantity--,p(e))},e.addbutton=function(e){e.quantity++,p(e)},e.removeOnList=function(t){e.details.article_features_list.splice(t,1),e.details.article_feature.splice(t,1)},e.deleteAllMedia=function(){a.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){d.article_id&&l.deleteAllArticleMedia(d.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void t.reload()):void s.error(e.response.msg,"Error")})})},e.deleteSelected=function(i){a.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("media: ",i),d.article_id&&l.deleteArticleMediaFile(d.article_id,i._id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void t.reload()):void s.error(e.response.msg,"Error")})})},e.saveArticle=function(){async.waterfall([function(t){d.article_id?l.updateArticle(d.article_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)s.success(e.response.msg,"Success"),t(null,d.article_id);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void s.error(e.response.msg,"Error");_.each(e.response.result,function(e){s.warning(e.msg,"Warning")})}}):l.saveArticle(e.details).then(function(e){if(200==e.statusCode&&e.response.success)s.success(e.response.msg,"Success"),t(null,e.response.result);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void s.error(e.response.msg,"Error");_.each(e.response.result,function(e){s.warning(e.msg,"Warning")})}})},function(t,i){var r=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(d,l){d.isTag?c.saveTags(d).then(function(e){return 200==e.statusCode&&e.response.success?void c.saveArticleTags(t,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void l()):void s.error(e.response.msg,"Error")}):void s.error(e.response.msg,"Error")}):c.saveArticleTags(t,{tag_id:d.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void l()):void s.error(e.response.msg,"Error")}),r>=e.details.tags.length&&i(null,t)}):i(null,t)},function(e,i){r(function(){t.go(t.current,{article_id:e},{reload:!0})},300)}])},e.tagTransform=function(e){return console.log(e),{tags:e}},e.clearInput=function(e){e.search=""},e.deleteProductTags=function(e){d.article_id&&c.deleteArticleTag(d.article_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void s.success(e.response.msg,"Success"):void s.error(e.response.msg,"Error")})},e.publishArticle=function(e){l.publishArticle(e).then(function(e){200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),t.go(t.current,null,{reload:!0})):s.error(e.response.msg,"Error")})},e.openUploader=function(){var e=u.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.upload.modal.html",controller:"articleUploadModalCtrl",size:"lg",resolve:{article_id:function(){return d.article_id}}});e.result.then(function(e){t.reload()},function(){})}}angular.module("POS17").controller("articleDetailController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","articleFctry","ngTableParams","ngDialog","$uibModal","productFactory","tagsFactory"]}();
!function(){"use strict";function e(e,o,t,l,n,s,c,i,a,r,u,d){console.log("articleUploadModalCtrl"),console.log("$stateParams:",c),e.item={};var m=JSON.parse(u.get("user")),f=e.uploader=new l({url:n+s+"articlemedia/"+c,method:"PUT",headers:{Authorization:"Bearer "+a.getUserToken(),accesskey:m.subscriptionKey}});f.filters.push({name:"customFilter",fn:function(e,o){return this.queue.length<10}}),f.onBeforeUploadItem=function(e){e.alias="media",console.log("item:",e)},f.onSuccessItem=function(e,o,t,l){d.success(o.response.msg,"Success")},f.onWhenAddingFileFailed=function(e,o,t){console.log("item:",e),console.log("filter:",o),console.log("options:",t)},f.onAfterAddingFile=function(e){console.log("item:",e)},f.onCompleteAll=function(e){d.success("Media / File upload complete","Success"),i(function(){t.close(c)},1300)},e.cancel=function(){t.dismiss("cancel")}}angular.module("POS17").controller("articleUploadModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","FileUploader","API_URL","API_VERSION","article_id","$timeout","AuthFctry","$stateParams","localStorageService","toastr"]}();
...
!function(){"use strict";function e(e,s,t,a,i,p){e.app={device:!0,apikeys:!1,user:!1,logs:!1},e.applicationStatus="All",e.showTab=function(s){"device"==s?e.app={device:!0,apikeys:!1,user:!1,logs:!1}:"apikeys"==s?e.app={device:!1,apikeys:!0,user:!1,logs:!1}:"user"==s?e.app={device:!1,apikeys:!1,user:!0,logs:!1}:"logs"==s&&(e.app={device:!1,apikeys:!1,user:!1,logs:!0})},e.updateStatus=function(s){e.applicationStatus=s}}angular.module("POS17").controller("appSettingsController",e),e.$inject=["$scope","$filter","$state","ngDialog","toastr","$timeout"]}();

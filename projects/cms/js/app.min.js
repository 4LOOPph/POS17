!function(){"use strict";angular.module("POS17",["ngSanitize","ngAnimate","ui.router","chart.js","angular-flot","ui.bootstrap","textAngular","ngFileUpload","ui.footable","restangular","toastr","angularMoment","angularSpinner","ngDialog","ui.select","mgcrea.ngStrap","LocalStorageModule","dibari.angular-ellipsis","angular-jwt","color.picker","ja.qr","jcs-autoValidate","angularTreeview","angularFileUpload","dndLists"]).constant("API_URL","http://52.64.27.145:5001").constant("API_VERSION","/api/1.0/").config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","RestangularProvider","API_URL","API_VERSION","$provide","localStorageServiceProvider",function(t,e,r,n,o,a,i,u,s){r.html5Mode(!1),e.otherwise("/login"),t.state("main",{url:"/main","abstract":!0,templateUrl:"modules/main.html",controller:"MainCtrl"}),n.interceptors.push("httpInterceptor"),n.interceptors.push("authInterceptor"),u.value("baseURL",a),o.setBaseUrl(a+i)}]).run(["$state","$rootScope","usSpinnerService","AuthFctry","$window","jwtHelper","localStorageService","$location",function(t,e,r,n,o,a,i,u){e.currentUser={},e.$state=t,e.previousState,e.currentState,e.$on("loading:progress",function(){e.productIsLoading=!0}),e.$on("loading:finish",function(){e.productIsLoading=!1}),e.$on("unauthorized",function(){n.setCurrentUser(null),n.setUserToken(null),t.go("login")}),e.goBack=function(){o.history.back()},e.$on("$stateChangeStart",function(t,e,r,o,s){if(n.getCurrentUser()){var l=n.getUserToken();a.isTokenExpired(l)&&(i.remove("user"),i.remove("token"),u.path("/login"))}}),e.$on("$stateChangeSuccess",function(t,r,o,a,i){e.previousState=a.name,e.currentState=r.name,e.currentUser=n.getCurrentUser()})}]).factory("httpInterceptor",["$q","$rootScope",function(t,e){var r=0;return{request:function(n){return 1===++r&&e.$broadcast("loading:progress"),n||t.when(n)},response:function(n){return 0===--r&&e.$broadcast("loading:finish"),n||t.when(n)},responseError:function(n){return 0===--r&&e.$broadcast("loading:finish"),t.reject(n)}}}])}();
!function(){"use strict";function e(e,s,o,r,t){e.profile={},s.logoutApp=function(){t.logout().then(function(e){200==e.statusCode&&e.response.success&&o.go("login")})},s.getCurrentUser=function(){t.userprofile().then(function(s){if(200==s.statusCode&&s.response.success)console.log("resp: ",s.response),e.profile=s.response.result;else if(400==s.statusCode&&!s.response.success)return void r.error(s.response.msg,"Error")})},s.getCurrentUser()}angular.module("POS17").controller("MainCtrl",e),e.$inject=["$rootScope","$scope","$state","toastr","AuthFctry"]}();
...
!function(){"use strict";function t(t,e,n,o,r){r.enableValidationStateIcons(!0),t.user={},t.login=function(){o.authenticate(t.user).then(function(t){t.success?(o.setUserToken(t.result.token),o.setCurrentUser(JSON.stringify(t.result.user)),n.success(t.msg,"Success"),e.go("main.dashboard")):n.error(t.msg,"Error")})}}angular.module("POS17").config(["$stateProvider",function(t){t.state("login",{url:"/login",templateUrl:"modules/login/login.html",controller:"LoginCtrl"})}]).controller("LoginCtrl",t),t.$inject=["$scope","$state","toastr","AuthFctry","bootstrap3ElementModifier"]}();
!function(){"use strict";function s(s,o,e,t,r){t.enableValidationStateIcons(!0),s.detail={},s.forgotpass=function(){e.getEmail({email:s.detail.email}).then(function(s){if(200==s.statusCode&&s.response.success)r.success(s.response.msg,"Success"),o.reload();else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void r.error(s.response.msg,"Error");_.each(s.response.result,function(s){r.warning(s.msg,"Warning")})}})}}angular.module("POS17").config(["$stateProvider",function(s){s.state("forgot",{url:"/forgotpassword",templateUrl:"modules/forgotpassword/forgotpassword.html",controller:"ForgotPasswordCtrl"})}]).controller("ForgotPasswordCtrl",s),s.$inject=["$scope","$state","AuthFctry","bootstrap3ElementModifier","toastr"]}();
...
!function(){"use strict";function e(e,s,t,o,r,a,n,i,d,c,u,l,p,g){g.enableValidationStateIcons(!0),e.ptypes=[],e.attributes=[],e.details={},e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,n.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?(e.ptypes=s.response.result,e.details.ptype_id=e.ptypes[0].ptype_id):o.error(s.response.msg,"Error")}),_.isEmpty(r.p_id)?(e.showPublish=!1,e.showArchive=!1,e.tabprod={product:!0,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},console.log("$scope.tabprod: ",e.tabprod)):a.getProductDetails(r.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.tabprod={product:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!0,related:!0},e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived))}),e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.removethumb=function(){e.details.img_default=null},e.upload=function(s){e.isImageNew=!0},e.archiveProduct=function(e){a.archiveProduct(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.publishProduct=function(e){a.publishProduct(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.addProduct=function(){async.waterfall([function(s){r.p_id?a.updateProduct(r.p_id,e.details).then(function(e){200==e.statusCode&&e.response.success&&(o.success(e.response.msg,"Success"),s(null,r.p_id),console.log("UPDATE"))}):a.saveProduct(e.details).then(function(e){200==e.statusCode&&e.response.success&&(o.success(e.response.msg,"Success"),s(null,e.response.result),console.log("SUCCESS"))})},function(t,r){p.upload({url:u+l+"product/"+t+"/upload-image",data:{product_img:e.details.img_default},method:"PUT"}).then(function(r){if(200===r.data.statusCode&&r.data.response.success)e.isImageNew&&o.success("Image successfully uploaded","Success"),s.go(s.current,{p_id:t},{reload:!0});else{if(400!==r.data.statusCode||r.data.response.success||!_.isArray(r.data.response.result))return void o.error(r.data.response.msg,"Error");_.each(r.data.response.result,function(e){o.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])}}angular.module("POS17").controller("productsAEController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","API_URL","API_VERSION","Upload","bootstrap3ElementModifier"]}();
!function(){"use strict";function e(e,t,s,n,l,c,o,a,r){e.search={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[],e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.products=[],e.bundles=[];var i=function(){o.getAllProductBundle().then(function(t){return 200==t.statusCode&&t.response.success?(e.bundles=t.response.result,void(e.bundlecopy=angular.copy(t.response.result))):void c.error(t.response.msg,"Error")})};e.edit=function(e){n.go("main.products-add",{p_id:e})},e.searchData=function(){l(function(){e.$apply(function(){e.bundles=s("filter")(e.bundlecopy,e.txtSearch)}),$(".table").trigger("footable_redraw")},200)},e.refresh=function(){i()},e.updateStatus=function(t){console.log("updateStatus: ",t),e.applicationStatus=t;var n=[];"All"==t?n=e.bundlecopy:"Publish"==t?n=s("filter")(e.bundlecopy,{is_published:1}):"Archived"==t?n=s("filter")(e.bundlecopy,{is_archived:1}):"Draft"==t&&(n=s("filter")(e.bundlecopy,{is_published:0})),l(function(){e.$apply(function(){e.bundles=n}),$(".table").trigger("footable_redraw")},100)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.bundles,function(t){t.selected=e.selectDeselectAll,e.selectSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.pb_id===t.pb_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pb_id!==t.pb_id}),e.selectSomeData=e.selectedDatas.length>0},e.archiveSelected=function(){r.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,l){s.selected&&o.archiveBundle(s.pb_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(c.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&n.reload(),l(),void 0):void c.error(s.response.msg,"Error")})})})},e.publishSelected=function(){r.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,l){s.selected&&o.publishBundle(s.pb_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(c.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&n.reload(),l(),void 0):void c.error(s.response.msg,"Error")})})})},e.refresh()}angular.module("POS17").controller("productBundlesController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","supplierFctry","ngDialog"]}();
!function(){"use strict";function e(e,s,t,o,r,i,n,l,d,a,c,u,p){p.enableValidationStateIcons(!0),e.details={},e.ptypes={},e["package"]={},e.items={},e.list1=[],e.list2=[],e.attributes=[],e.product_image=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.add=!1,e.displayComposite=!1,e.displayImage=!1,e.txtSearch="";var g=function(){n.getAllProduct().then(function(s){200==s.statusCode&&s.response.success&&(e.list1=s.response.result,e.copy=angular.copy(s.response.result),_.each(e.list1,function(e){e.selected=!1})),e.models={selected:null,lists:{Package:e.list2,Products:e.list1}}})};e.refresh=function(){g()},e.searchData=function(s){e.list1=t("filter")(e.copy,s)},l.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?e.ptypes=s.response.result:o.error(s.response.msg,"Error")}),_.isEmpty(r.pb_id)?(e.showPublish=!1,e.showArchive=!1):(e.displayComposite=!0,e.displayImage=!0,n.getProductBundleDetails(r.pb_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,console.log("data.response.result:",s.response.result),e.product_image=e.details.product_images,console.log("$scope.product_image:",e.product_image),e.items=s.response.result,e.list2=_.map(_.each(e.items.products,"product_detail"),function(e){return e.product_detail}),e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived))})),e.$watch("models",function(s){e.modelAsJson=s},!0),e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.store_id===s.store_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.store_id!==s.store_id}),e.deleteSomeData=e.selectedDatas.length>0},e.dropCallback=function(s,t,o){if(console.log("dropCallback: "),!_.isUndefined(e.modelAsJson.lists.Package)){var r=_.filter(e.modelAsJson.lists.Package,{p_id:o.p_id}),i=_.filter(e.modelAsJson.lists.Products,{p_id:o.p_id});if(r.length>1)for(var n=e.modelAsJson.lists.Package,l=0;l<n.length;l++){var d=n[l];if(d.p_id==o.p_id)return n.splice(l,1)}if(i.length>1)for(var n=e.modelAsJson.lists.Products,l=0;l<n.length;l++){var d=n[l];d.p_id==o.p_id&&n.splice(l,1)}e.items.products=e.modelAsJson.lists.Package,e.items.products=_.map(e.items.products,function(e){return{product_id:e.p_id}}),console.log("$scope.items.products: ",e.items.products),console.log("$scope.modelAsJson.lists.Package: ",e.modelAsJson.lists.Package)}},e.remove=function(s){e.list2.splice(s,1),e.items.products.splice(s,1)},e.removeAll=function(s){e.list2=s,_.each(e.list2,function(t){return e.list2.splice(s,1)}),_.each(e.items.products,function(t){return e.items.products.splice(s,1)})},e.openUploader=function(){var e=u.open({animation:!0,templateUrl:"./modules/products/product-bundle.upload.modal.html",controller:"productBundleUploaderModalCtrl",size:"lg",resolve:{product_bundle_id:function(){return r.pb_id}}});e.result.then(function(e){s.reload()})},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.archiveProduct=function(e){n.archiveBundle(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.publishProduct=function(e){n.publishBundle(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.onDragstart=function(e,s){if(e.dragging=!0,s.dataTransfer.setDragImage){var t=new Image;t.src="./images/cargo-128.png",s.dataTransfer.setDragImage(t,0,0)}},e.addProductBundle=function(){r.pb_id&&n.updateProductBundle(r.pb_id,e.items).then(function(e){200==e.statusCode&&e.response.success&&(o.success(e.response.msg,"Success"),s.go(s.current,{pb_id:r.pb_id},{reload:!0}))})},e.addProduct=function(){r.pb_id?n.updateProductBundle(r.pb_id,e.details).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,o.success(t.response.msg,"Success"),console.log("UPDATE"),e.items=e.details,s.go(s.current,{},{reload:!0}))}):n.saveProductBundle(e.details).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,s.go(s.current,{pb_id:e.details.pb_id},{reload:!0}),o.success(t.response.msg,"Success"),console.log("SUCCESS"),e.items=e.details)})},e.refresh()}angular.module("POS17").controller("productsBundleController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","ngDialog","productFactory","ptypeFactory","storeFactory","priceHistoryFactory","supplierFctry","$uibModal","bootstrap3ElementModifier"]}();
!function(){"use strict";function e(e,o,n,l,t,r,a,d,c){console.log("productBundleUploaderModalCtrl"),e.item={};var i=c.decodeToken(d.getUserToken()),u=e.uploader=new n({url:l+t+"product-bundle/"+r+"/upload-image",method:"PUT",headers:{Authorization:"Bearer "+d.getUserToken(),accesskey:i.subscriptionKey}});console.log("uploader:",u),u.filters.push({name:"imageFilter",fn:function(e,o){var n="|"+e.type.slice(e.type.lastIndexOf("/")+1)+"|";return-1!=="|jpg|png|jpeg|bmp|gif|".indexOf(n)}}),u.onBeforeUploadItem=function(e){e.alias="pb_image"},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("productBundleUploaderModalCtrl",e),e.$inject=["$scope","$uibModalInstance","FileUploader","API_URL","API_VERSION","product_bundle_id","Upload","AuthFctry","jwtHelper"]}();
...
!function(){"use strict";function t(t,e,r,o,c,n,i,a){function u(){a.getAllCategory().then(function(e){if(200==e.statusCode&&e.response.success){for(var r=e.response.result,o=0;o<r.length;o++){var c=r[o],n=c.name,i=c.parent_id,a=c.c_id;d[i]?(c={parentid:i,label:n,item:c},null!=c&&(d[i].items||(d[i].items=[]),d[i].items[d[i].items.length]=c,d[a]=c)):(d[a]={parentid:a,label:n,item:c},s[a]=d[a])}t.categoryData=_(s).omit(_.isUndefined).omit(_.isNull).value(),t.categorycopy=angular.copy(t.categoryData)}})}t.search={},t.currentPage=1,t.entryLimit=5,t.productIsLoading=!0,t.selectDeselectAll=!1,t.applicationStatus="All",t.displayModel="List",t.viewby=25,t.pageSize=t.viewby,t.currentPage=1,t.itemsPerPage=20,t.totalUsers=0,t.categories=[];var s=[],d=[];t.side=!1,u();var p=function(){t.products=[],t.productscopy=[],i.getAllProduct().then(function(e){if(200==e.statusCode&&e.response.success){var r=e.response.result;t.productscopy=angular.copy(r),c(function(){t.$apply(function(){t.products=r,t.totalItems=t.products.length,t.noOfPages=Math.ceil(t.totalItems/t.entryLimit)}),c(function(){t.productIsLoading=!1},800)},200)}else n.error(e.response.msg,"Error")})},l=function(){t.$watch("mytree.currentNode",function(e,r){var o=[],n={},i={};t.category=[],t.tree=[],t.currentNode=[];var a=[];if(t.mytree&&angular.isObject(t.mytree.currentNode)){t.currentNode=t.mytree.currentNode.item;var u=_.find(t.categorycopy,{parentid:t.currentNode.c_id});if(_.isUndefined(u)){var s=_.map(t.productscopy,function(e){var r=_.filter(e.product_category,{category_id:t.currentNode.c_id});return r.length>0?_.find(r,function(t){return t}):void 0});i=_.filter(s,function(t){return _.isUndefined(t)?void 0:t}),n=_.map(_.uniqBy(i,"product_id"),function(t){return t.product_id}),_.forEach(n,function(e){o.push(_.find(t.productscopy,{p_id:e}))})}else{var d=_.map(u.items,function(t){return{c_id:t.item.c_id}});_.each(t.productscopy,function(t){_.each(d,function(e){var r=_.filter(t.product_category,{category_id:e.c_id});r&&r.length>0&&a.push(r[0])})});var p=_.map(_.uniqBy(a,"product_id"),function(t){return t.product_id});_.forEach(p,function(e){o.push(_.find(t.productscopy,{p_id:e}))})}c(function(){t.$apply(function(){t.products=o}),$(".table").trigger("footable_redraw")},100)}},!1)};a.getAllCategory().then(function(e){200==e.statusCode&&e.response.success&&(t.categories=e.response.result)}),t.setPage=function(e){t.currentPage=e},t.setItemsPerPage=function(e){t.itemsPerPage=e,t.currentPage=1},t.edit=function(t){o.go("main.products-add",{p_id:t})},t.searchData=function(){c(function(){t.$apply(function(){t.products=r("filter")(t.productscopy,t.txtSearch)}),$(".table").trigger("footable_redraw")},200)},t.refresh=function(){t.productIsLoading=!0,p(),l()},t.updateStatus=function(e){t.applicationStatus=e;var o=[];"All"==e?o=t.productscopy:"Publish"==e?o=r("filter")(t.productscopy,{is_published:1}):"Archived"==e?o=r("filter")(t.productscopy,{is_archived:1}):"Draft"==e&&(o=r("filter")(t.productscopy,{is_published:0})),c(function(){t.$apply(function(){t.products=o}),$(".table").trigger("footable_redraw")},100)},t.paginate=function(){$(".table").trigger("footable_redraw")},t.changeSelectDeselectAll=function(){_.each(t.products,function(e){e.selected=t.selectDeselectAll})},t.refresh()}angular.module("POS17").controller("productsController",t),t.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","categoryFactory"]}();
...
!function(){"use strict";function e(e,t,s,o,n,c,r,l){e.selectDeselectAll=!1,e.selectedDatas=[],e.storeisLoading=!0;var a=function(){e.stores=[],e.storescopy=[],r.getAllStore().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;l(function(){e.$apply(function(){e.stores=s,e.storescopy=angular.copy(e.stores)}),l(function(){e.storeisLoading=!1},800)},100)}})};e.edit=function(e){o.go("main.settings-stores-add",{store_id:e})},e.searchData=function(){e.stores=s("filter")(e.storescopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.stores,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.refresh=function(){a()},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.store_id===t.store_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.store_id!==t.store_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(t){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.deleteStore(t).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void o.reload()):void n.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.onDrop=function(e,t,s){return angular.forEach(t,function(e){e.selected=!1}),e.items=e.items.slice(0,s).concat(t).concat(e.items.slice(s)),!0},e.onMoved=function(e){e=e.items.filter(function(e){return!e.selected})},e.deleteSelected=function(){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,c){s.selected&&(console.log("store: ",s),r.deleteStore(s.store_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(n.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&o.reload(),c(),void 0):void n.error(s.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("storesController",e),e.$inject=["$scope","$http","$filter","$state","toastr","ngDialog","storeFactory","$timeout"]}();
!function(){"use strict";function s(s,e,t,r,o,n,i,a,c){c.enableValidationStateIcons(!0),s.details={},r.store_id&&a.getStoreDetails(r.store_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)}),s.saveStore=function(){r.store_id?a.updateStore(r.store_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)i.success(s.response.msg,"Success"),o(function(){n.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void i.error(s.response.msg,"Error");_.each(s.response.result,function(s){i.warning(s.msg,"Warning")})}}):a.saveStore(s.details).then(function(s){if(console.log("data:",s),200==s.statusCode&&s.response.success)i.success(s.response.msg,"Success"),o(function(){n.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void i.error(s.response.msg,"Error");_.each(s.response.result,function(s){i.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("storesDetailController",s),s.$inject=["$scope","$http","$filter","$stateParams","$timeout","$state","toastr","storeFactory","bootstrap3ElementModifier"]}();
...
!function(){"use strict";function e(e,t,n,s,a,c,l,o){e.bankisLoading=!0,e.selectDeselectAll=!1,e.selectedDatas=[];var i=function(){e.banks={},e.bankscopy=[],l.getAllBanks().then(function(t){if(200==t.statusCode&&t.response.success){var n=t.response.result;o(function(){e.$apply(function(){e.banks=n,e.bankscopy=angular.copy(e.banks)}),o(function(){e.bankisLoading=!1},800)},100)}})};e.refresh=function(){i()},e.edit=function(e){s.go("main.settings-banks-add",{bk_id:e})},e.searchData=function(){e.banks=n("filter")(e.bankscopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.banks,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.bk_id===t.bk_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.bk_id!==t.bk_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){a.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(n,a){n.selected&&(console.log("bank: ",n),l.deleteBank(n.bk_id).then(function(n){return console.log("data: ",n.response),200==n.statusCode&&n.response.success?(c.success(n.response.msg,"Success"),++t,t==e.selectedDatas.length&&s.reload(),a(),void 0):void c.error(n.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("banksController",e),e.$inject=["$scope","$http","$filter","$state","ngDialog","toastr","bankFctry","$timeout"]}();
!function(){"use strict";function s(s,e,t,n,r,o,a,c){c.enableValidationStateIcons(!0),s.details={},t.bk_id&&a.getBankDetails(t.bk_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)}),s.saveBank=function(){t.bk_id?a.updateBank(stateParams.bk_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)r(function(){o.success("Successfully Update","Success"),n.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void o.error(s.response.msg,"Error");_.each(s.response.result,function(s){o.warning(s.msg,"Warning")})}}):a.saveBank(s.details).then(function(s){if(console.log("data:",s),200==s.statusCode&&s.response.success)r(function(){o.success("Successfully Added","Success"),n.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void o.error(s.response.msg,"Error");_.each(s.response.result,function(s){o.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("bankDetailsController",s),s.$inject=["$scope","$http","$stateParams","$state","$timeout","toastr","bankFctry","bootstrap3ElementModifier"]}();
...
!function(){"use strict";function e(e,t,s,a,o,n,c,l){e.attribisLoading=!0,e.selectDeselectAll=!1,e.selectedDatas=[];var r=function(){e.attribute=[],e.attributecopy=[],c.getAllAttribute().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;l(function(){e.$apply(function(){e.attribute=s,e.attributecopy=angular.copy(e.attribute)}),l(function(){e.attribisLoading=!1},800)},100)}})};e.refresh=function(){r()},e.edit=function(e){a.go("main.settings-attributes-add",{att_id:e})},e.searchData=function(){e.attribute=s("filter")(e.attributecopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.attribute,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.att_id===t.att_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.att_id!==t.att_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(t){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){c.deleteAttribute(t).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void a.reload()):void n.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,o){s.selected&&(console.log("attribute: ",s),c.deleteAttribute(s.att_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(n.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&a.reload(),o(),void 0):void n.error(s.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("attributesController",e),e.$inject=["$scope","$http","$filter","$state","ngDialog","toastr","attributeFactory","$timeout"]}();
!function(){"use strict";function s(s,e,t,i,a,r,l,n){n.enableValidationStateIcons(!0),s.details={},s.details.is_visible=1==s.details.is_visible,s.details.is_search=1==s.details.is_search,s.details.is_required=1==s.details.is_required,s.details.is_variation=1==s.details.is_variation,s.details.is_customizable=1==s.details.is_customizable,s.details.is_unique=1==s.details.is_unique,s.details.is_comparable=1==s.details.is_comparable,async.waterfall([function(s){i.getAllAttributeTypes().then(function(e){200==e.statusCode&&e.response.success&&s(null,e.response.result)})},function(e,a){s.types=e,t.att_id&&i.getAllAttributeDetails(t.att_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result,s.details.is_visible=1==s.details.is_visible,s.details.is_search=1==s.details.is_search,s.details.is_required=1==s.details.is_required,s.details.is_variation=1==s.details.is_variation,s.details.is_customizable=1==s.details.is_customizable,s.details.is_unique=1==s.details.is_unique,s.details.is_comparable=1==s.details.is_comparable)})}]),s.saveAttribute=function(){t.att_id?i.updateAttribute(t.att_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)a(function(){r.success("Successfully Update","Success"),l.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void r.error(s.response.msg,"Error");_.each(s.response.result,function(s){r.warning(s.msg,"Warning")})}}):i.saveAttribute(s.details).then(function(s){if(200==s.statusCode&&s.response.success)a(function(){r.success("Successfully Added","Success"),l.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void r.error(s.response.msg,"Error");_.each(s.response.result,function(s){r.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("attributeDetailsController",s),s.$inject=["$scope","$http","$stateParams","attributeFactory","$timeout","toastr","$state","bootstrap3ElementModifier"]}();
!function(){"use strict";function e(e,t,s,o,n,a,r,c,l){e.selectDeselectAll=!1,e.selectedDatas=[];var u=function(){c.getAllAttributeGroup().then(function(t){if(e.groups=[],e.attributecopy=[],200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(e){e.date_created=moment(e.date_created).format("YYYY-MM-DD")}),r(function(){e.$apply(function(){e.groups=s,e.attributecopy=angular.copy(e.groups)}),$(".table").trigger("footable_redraw")},100)}})};e.refresh=function(){u()},e.searchData=function(){e.groups=s("filter")(e.attributecopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.groups,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.attgrp_id===t.attgrp_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.attgrp_id!==t.attgrp_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(t){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){c.deleteAttributeGroup(t).then(function(e){return 200==e.statusCode&&e.response.success?(a.success(e.response.msg,"Success"),void o.reload()):void a.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,n){s.selected&&(console.log("groups: ",s),c.deleteAttributeGroup(s.attgrp_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(a.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&o.reload(),n(),void 0):void a.error(s.response.msg,"Error")}))})})},e.addGroups=function(s){var o=t.open({animation:!0,templateUrl:"./modules/attributes/attribute.groups.modal.html",controller:"attributeModal",size:"md",resolve:{items:function(){return s}}});o.result.then(function(t){e.selected=t},function(){l.info("Modal dismissed at: "+new Date)})},e.refresh()}function t(e,t,s,o,n,a,r){r.enableValidationStateIcons(!0),e.items=o,e.group={},console.log("items:",e.items),e.items&&n.getAttributeGroupDetails(e.items).then(function(t){200==t.statusCode&&t.response.success&&(console.log("data:",t.response.result),e.group=t.response.result)}),e.saveGroup=function(){e.items?n.updateAttributeGroup(e.items,e.group).then(function(e){200==e.statusCode&&e.response.success&&(console.log("UPDATE"),t.reload(),s.close(e.response.success))}):n.saveAttributeGroup(e.group).then(function(o){200==o.statusCode&&o.response.success&&a(function(){e.$apply(function(){t.reload(),s.close(o.response.success)})},100)})},e.cancel=function(){s.dismiss("cancel")}}angular.module("POS17").controller("attributeGroups",e).controller("attributeModal",t),e.$inject=["$scope","$uibModal","$filter","$state","ngDialog","toastr","$timeout","attributeFactory","$log"],t.$inject=["$scope","$state","$uibModalInstance","items","attributeFactory","$timeout","bootstrap3ElementModifier"]}();
...
!function(){"use strict";function e(e,t,s,a,o,n,r,c,i){function l(){a.getAllCategory().then(function(t){if(200==t.statusCode&&t.response.success){for(var s=t.response.result,a=0;a<s.length;a++){var o=s[a],n=o.name,r=o.parent_id,c=o.c_id;d[r]?(o={parentid:r,label:n,item:o},null!=o&&(d[r].items||(d[r].items=[]),d[r].items[d[r].items.length]=o,d[c]=o)):(d[c]={parentid:r,label:n,item:o},u[c]=d[c])}e.categoryData=_(u).omit(_.isUndefined).omit(_.isNull).value(),console.log("categoryData: ",e.categoryData)}})}i.enableValidationStateIcons(!0),e.details={},e.newImage=!1;var u=[],d=[];s.c_id&&a.getCategoryDetails(s.c_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result)}),l(),e.toplevelCategory=function(){e.TPchecked?e.mytree.currentNode={}:l()},e.changeItem=function(t){e.selectedItem=t},e.removethumb=function(){e.details.c_image=null,e.newImage=!1},e.upload=function(t){e.newImage=!0},e.saveCategory=function(){e.mytree&&angular.isObject(e.mytree.currentNode)&&!_.isEmpty(e.mytree.currentNode)?(console.log("$scope.mytree.currentNode: ",e.mytree.currentNode),e.details.parent_id=e.mytree.currentNode.item.c_id):e.details.parent_id=null,async.waterfall([function(t){s.c_id?a.updateCategory(s.c_id,e.details).then(function(e){200==e.statusCode&&e.response.success&&(console.log("UPDATE"),c.success(e.response.msg,"Success"),t(null,s.c_id))}):a.saveCategory(e.details).then(function(e){200==e.statusCode&&e.response.success&&(console.log("SUCCESS"),c.success(e.response.msg,"Success"),t(null,e.response.result))})},function(s,a){e.newImage&&e.details.c_image&&o.upload({url:n+r+"categories/"+s+"/upload-image",data:{c_image:e.details.c_image},method:"PUT"}).then(function(e){if(200===e.data.statusCode&&e.data.response.success)c.success("Image successfully uploaded","Success"),t.go(t.current,{c_id:s},{reload:!0});else{if(400!==e.data.statusCode||e.data.response.success||!_.isArray(e.data.response.result))return void c.error(e.data.response.msg,"Error");_.each(e.data.response.result,function(e){c.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])}}angular.module("POS17").controller("categoryDetailsController",e),e.$inject=["$scope","$state","$stateParams","categoryFactory","Upload","API_URL","API_VERSION","toastr","bootstrap3ElementModifier"]}();
...
!function(){"use strict";function e(e,r,c,n){e.currencyisLoading=!0;var t=function(){e.currencies=[],e.currenciescopy=[],n.getAllCurrencies().then(function(r){200==r.statusCode&&r.response.success&&c(function(){e.$apply(function(){e.currencies=r.response.result,e.currenciescopy=angular.copy(e.currencies)}),c(function(){e.currencyisLoading=!1},800)},100)})};e.paginate=function(){$(".table").trigger("footable_redraw")},e.searchData=function(){e.currencies=r("filter")(e.currenciescopy,e.txtSearch)},e.refresh=function(){t()},e.refresh()}angular.module("POS17").controller("currenciesController",e),e.$inject=["$scope","$filter","$timeout","currencyFactory"]}();
...
!function(){"use strict";function e(e,t,s,o,c,n,l,a){e.typeisLoading=!0,e.selectDeselectAll=!1,e.selectedDatas=[];var r=function(){e.producttypes={},e.producttypescopy=[],l.getAllProdType().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;a(function(){e.$apply(function(){e.producttypes=s,e.producttypescopy=angular.copy(e.producttypes)}),a(function(){e.typeisLoading=!1},800)},100)}})};e.refresh=function(){r()},e.edit=function(e){s.go("main.settings-producttype-add",{ptype_id:e})},e.searchData=function(){e.producttypes=o("filter")(e.producttypescopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.producttypes,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.ptype_id===t.ptype_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.ptype_id!==t.ptype_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(t){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){l.deleteProductType(t).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void s.reload()):void n.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){c.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(o,c){o.selected&&(console.log("producttype: ",o),l.deleteProductType(o.ptype_id).then(function(o){return console.log("data: ",o.response),200==o.statusCode&&o.response.success?(n.success(o.response.msg,"Success"),++t,t==e.selectedDatas.length&&s.reload(),c(),void 0):void n.error(o.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("productTypeController",e),e.$inject=["$scope","$http","$state","$filter","ngDialog","toastr","ptypeFactory","$timeout"]}();
!function(){"use strict";function e(e,t,s,a,o,n,u,c,l){l.enableValidationStateIcons(!0),e.details={},e.newImage=!1,s.ptype_id&&a.getAllProdTypeDetails(s.ptype_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,console.log("$scope.details:",e.details))}),e.removethumb=function(){e.details.c_image=null,e.newImage=!1},e.upload=function(t){e.newImage=!0},e.saveProductType=function(){async.waterfall([function(t){s.ptype_id?a.updateProductType(s.ptype_id,e.details).then(function(e){200==e.statusCode&&e.response.success&&(t(null,s.ptype_id),console.log("UPDATE"))}):a.saveProductType(e.details).then(function(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),t(null,e.response.result),console.log("SUCCESS"))})},function(t,s){e.details.ptype_image&&o.upload({url:u+c+"producttype/"+t+"/upload-image",data:{ptype_image:e.details.ptype_image},method:"PUT"}).then(function(s){if(200===s.data.statusCode&&s.data.response.success)e.newImage&&n.success("Image successfully uploaded","Success"),$state.go($state.current,{ptype_id:t},{reload:!0});else{if(400!==s.data.statusCode||s.data.response.success||!_.isArray(s.data.response.result))return void n.error(s.data.response.msg,"Error");_.each(s.data.response.result,function(e){n.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])}}angular.module("POS17").controller("producttypeDetailController",e),e.$inject=["$scope","$http","$stateParams","ptypeFactory","Upload","toastr","API_URL","API_VERSION","bootstrap3ElementModifier"]}();
...
!function(){"use strict";function e(e,s,t,o,n,l,r,c,a){e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.selectDeselectAll=!1,e.selectedDatas=[],e.personisLoading=!0;var i=function(){e.persons=[],e.personscopy=[],r.getAllPerson().then(function(s){if(200==s.statusCode&&s.response.success){var t=s.response.result;a(function(){e.$apply(function(){e.persons=t,e.personscopy=angular.copy(e.persons)}),a(function(){e.personisLoading=!1},800)},100)}})};e.refresh=function(){i()},e.edit=function(e){n.go("main.settings-humanresource-detail",{id:e})},e.updateStatus=function(s){e.applicationStatus=s,"All"==s?e.persons=e.personscopy:"Employee"==s?e.persons=o("filter")(e.personscopy,{per_type_id:1}):"Customer"==s&&(e.persons=o("filter")(e.personscopy,{per_type_id:2}))},e.searchData=function(){e.persons=o("filter")(e.personscopy,e.txtSearch)},e.paginate=function(){$(".table").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.persons,function(s){s.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(s)})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.person_id===s.person_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.person_id!==s.person_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(s){l.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.deletePersonel(s).then(function(e){return 200==e.statusCode&&e.response.success?(c.success(e.response.msg,"Success"),void n.reload()):void c.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){l.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=0;async.each(e.selectedDatas,function(t,o){t.selected&&(console.log("person: ",t),r.deletePersonel(t.person_id).then(function(t){return console.log("data: ",t.response),200==t.statusCode&&t.response.success?(c.success(t.response.msg,"Success"),++s,s==e.selectedDatas.length&&n.reload(),o(),void 0):void c.error(t.response.msg,"Error")}))})})},e.refresh()}angular.module("POS17").controller("personController",e),e.$inject=["$scope","$rootScope","$http","$filter","$state","ngDialog","personFactory","toastr","$timeout"]}();
!function(){"use strict";function s(s,e,t,n,o,a,r,u,c,l){l.enableValidationStateIcons(!0),s.stores=[],s.persons=[],s.details={},s.newImage=!1,n.getPersonType().then(function(e){200==e.statusCode&&e.response.success&&(console.log("data:",e.response.success),s.persons=e.response.result)}),async.waterfall([function(s){o.getAllStore().then(function(e){200==e.statusCode&&e.response.success&&s(null,e.response.result)})},function(s,e){n.getTimeZone().then(function(t){200==t.statusCode&&t.response.success&&e(null,s,t.response.result)})},function(e,o,a){s.stores=e,s.timezone=o,t.id&&n.getAllPersonDetail(t.id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result,s.details.isActive=1==s.details.isActive,s.details.person_img=s.details.image)})}]),s.removethumb=function(){s.details.person_img=null,s.newImage=!1},s.upload=function(e){s.newImage=!0},s.savePersonel=function(){async.waterfall([function(e){t.id?n.updatePersonel(t.id,s.details).then(function(s){200==s.statusCode&&s.response.success&&(c.success(s.response.msg,"Success"),e(null,t.id))}):n.savePersonel(s.details).then(function(s){200==s.statusCode&&s.response.success&&(c.success(s.response.msg,"Success"),e(null,s.response.result))})},function(e,t){s.newImage&&s.details.image&&a.upload({url:r+u+"persons/"+e+"/upload-image",data:{person_img:s.details.image},method:"PUT"}).then(function(s){if(200===s.data.statusCode&&s.data.response.success)c.success("Image successfully uploaded","Success");else{if(400!==s.data.statusCode||s.data.response.success||!_.isArray(s.data.response.result))return void c.error(s.data.response.msg,"Error");_.each(s.data.response.result,function(s){c.warning(s.msg,"Warning")})}},function(s){console.log("Error status: "+s.status)},function(s){parseInt(100*s.loaded/s.total)})}])}}angular.module("POS17").controller("personDetailController",s),s.$inject=["$scope","$state","$stateParams","personFactory","storeFactory","Upload","API_URL","API_VERSION","toastr","bootstrap3ElementModifier"]}();
...
!function(){"use strict";function e(e,s,o){}function s(e,s,o,t,r,n,a,l,i,c,u,d){var p=o.getCurrentUser(),f=JSON.parse(p);a.enableValidationStateIcons(!0),e.pw1="password",e.user=f,e.details={},e.showUpload=!1,e.timezone=[],f.person_id&&n.getAllPersonDetail(f.person_id).then(function(s){200==s.statusCode&s.response.success&&(e.details=s.response.result)}),n.getTimeZone().then(function(s){200==s.statusCode&&s.response.success&&(e.timezone=s.response.result)}),e.upload=function(s){e.showUpload=!0},e.removethumb=function(){e.showUpload=!1},e.savePersonDetail=function(){async.waterfall([function(s){f.person_id&&n.updatePersonel(f.person_id,e.details).then(function(e){200==e.statusCode&&e.response.success&&(l.success("Successfully Update","Success"),s(null,f.person_id))})},function(s,o){e.details.image&&i.upload({url:c+u+"persons/"+s+"/upload-image",data:{person_img:e.details.image},method:"PUT"}).then(function(e){if(200===e.data.statusCode&&e.data.response.success)l.success("Image successfully uploaded","Success"),t.go(t.current,{id:s},{reload:!0});else{if(400!==e.data.statusCode||e.data.response.success||!_.isArray(e.data.response.result))return void l.error(e.data.response.msg,"Error");_.each(e.data.response.result,function(e){l.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])},e.saveUsername=function(){d.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){n.updateUsername(s.profile).then(function(e){if(200==e.statusCode&&e.response.success)l.success("Successfully Update","Success"),t.reload();else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void l.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){l.warning(e.msg,"Warning")})}})},function(e){console.log("Modal promise close: ")})},e.savePassword=function(){d.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:s,className:"ngdialog-theme-default"}).then(function(){n.updatePassword(e.details).then(function(e){if(200==e.statusCode&&e.response.success)l.success("Successfully Update","Success"),t.reload();else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void l.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){l.warning(e.msg,"Warning")})}})},function(e){console.log("Modal promise close: ")})},e.addRecoveryEmail=function(){d.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){n.addRecoveryPassword({email_recovery:e.details.recovery_email}).then(function(e){if(200==e.statusCode&&e.response.success)l.success("Successfully Update","Success");else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void l.error(resp.data.response.msg,"Error");_.each(e.response.result,function(e){l.warning(e.msg,"Warning")})}})},function(e){console.log("Modal promise close: ")})}}angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(e,s){s.state("main.settings-profile",{url:"/settings/profile",templateUrl:"modules/profile/profile.html",controller:"ProfileCtrl"}).state("main.settings-profile-details",{url:"/settings/profile/details/",templateUrl:"modules/profile/profile.details.html",controller:"ProfileDetailCtrl"})}]).controller("ProfileCtrl",e).controller("ProfileDetailCtrl",s),e.$inject=["$scope","$state","AuthFctry"],s.$inject=["$scope","$rootScope","AuthFctry","$state","$timeout","personFactory","bootstrap3ElementModifier","toastr","Upload","API_URL","API_VERSION","ngDialog"]}();
...
!function(){"use strict";function e(e,t,n,r){return{authenticate:function(t){return e.all("session").customPOST(t).then(function(e){return e},function(e){return e.data})},logout:function(){return e.all("session").customDELETE().then(function(e){return e},function(e){return e.data})},userprofile:function(){return e.all("session").customGET().then(function(e){return e},function(e){return e.data})},setUserToken:function(e){r.set("token",e)},getUserToken:function(){return r.get("token")},setCurrentUser:function(e){r.set("user",e)},getCurrentUser:function(){return r.get("user")},getEmail:function(t){return e.all("forgot_password").customPOST(t).then(function(e){return e},function(e){return e})}}}function t(e,t,n,r,o,u){return{request:function(e){if(e.headers=e.headers||{},u.get("token")){var t=u.get("token");e.headers.Authorization="Bearer "+t;var n=o.decodeToken(t);n&&(e.headers.accesskey=n.subscriptionKey)}return e},response:function(e){if(u.get("token")){var t=u.get("token");o.isTokenExpired(t)&&(u.remove("token"),u.remove("user"),n.path("/login"))}return e},responseError:function(t){return 401===t.status&&(e.$broadcast("unauthorized"),n.path("/login")),t}}}angular.module("POS17").factory("AuthFctry",e).factory("authInterceptor",t),e.$inject=["Restangular","API_URL","API_VERSION","localStorageService"],t.$inject=["$rootScope","$q","$location","$injector","jwtHelper","localStorageService"]}();

...
!function(){"use strict";function e(e,s,o,t,r,c,i){var a=t.getCurrentUser(),n=JSON.parse(a);e.details={},e.details.isActive=1,e.details.created_by=n.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.products=[],s.getAllProduct().then(function(s){200==s.statusCode&&s.response.success&&(e.products=s.response.result,console.log(" $scope.products:",e.products))}),i.pricebook_id&&(e.displayTab=!0,o.getPricebookDetail(i.pricebook_id).then(function(s){console.log("data:",s),200==s.statusCode&&s.response.success&&(e.details=s.response.result)})),o.getPricebookType().then(function(s){e.pricebooktype=[],200==s.statusCode&&s.response.success&&(e.pricebooktype=s.response.result,console.log("$scope.pricebooktype:",e.pricebooktype))}),e.settings={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.settings1={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.savePricebook=function(){i.pricebook_id?o.updatePriceBook(i.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void c.go(c.current,{pricebook_id:i.pricebook_id},{reload:!0})):void r.error(e.response.msg,"Error")}):o.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("data:",e),r.success(e.response.msg,"Success"),c.go(c.current,{pricebook_id:e.response.result},{reload:!0}),void 0):void r.error(e.response.msg,"Error")})},e.example8model=[],e.example8data=[{id:1,label:"Accessories"},{id:2,label:"Headset"},{id:3,label:"Mobile Headset"},{id:4,label:"Wearables"}]}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams"]}();

...
!function(){"use strict";function e(e,t,i,s,r,d,l,n,a,o,u,c,p){function m(e){_.each($rootScope.cartItems,function(t){t.pb_id==e.pb_id&&(t.quantity=e.quantity)}),localStorageService.set("Cart",JSON.stringify($rootScope.cartItems))}e.details={},e.details.tags=[],e.details.article_feature=[],e.details.article_features_list=[],e.details.is_published=!1,e.details.is_archived=!1,e.radioModel="product",e.products=[],e.productBundles=[],e.mediafile=[],e.types=[],e.tags=[],e.tagsArr=[],e.infiniteScroll={},e.infiniteScroll.numToAdd=10,e.infiniteScroll.currentItems=10,e.resetInfScroll=function(){e.infiniteScroll.currentItems=e.infiniteScroll.numToAdd},e.addMoreItems=function(){e.infiniteScroll.currentItems+=e.infiniteScroll.numToAdd},c.getAllTags().then(function(t){200==t.statusCode&&t.response.success?e.tagsArr=t.response.result:s.error(t.response.msg,"Error")}),d.article_id&&(e.details.article_feature=[],e.details.article_features_list=[],l.getDetailArticle(d.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.showPublish=1!=e.details.is_active,e.details.article_features_list=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{item_name:e.product_details.item_name,item_code:e.product_details.product_code,item_brand:e.product_details.brand,item_id:e.product_details.p_id}:null!==e.bundle_id&&null==e.product_id?{item_name:e.bundle_details.bundle_name,item_code:e.bundle_details.bundle_code,item_brand:e.bundle_details.bundle_brand,item_id:e.bundle_details.pb_id}:void 0}),e.details.article_feature=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{product_id:e.product_details.p_id,bundle_id:null,article_id:d.article_id}:null!==e.bundle_id&&null==e.product_id?{product_id:null,bundle_id:e.bundle_details.pb_id,article_id:d.article_id}:void 0}),e.mediafile=t.response.result.mediafiles,c.getAllArticleTags(d.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details.tags=t.response.result)}))}),u.getAllProduct().then(function(t){if(200==t.statusCode&&t.response.success){var i=t.response.result;_.each(i,function(t){0==t.is_archived&&e.products.push(t)})}}),u.getAllProductBundle().then(function(t){if(200==t.statusCode&&t.response.success){var i=t.response.result;_.each(i,function(t){1!==t.is_archived&&e.productBundles.push(t)})}})),e.changeData=function(t){e.radioModel=t},e.reloadMediaFiles=function(){d.article_id&&(e.mediafile=[],e.imagesFile=[],l.getDetailArticle(d.article_id).then(function(t){200==t.statusCode&&t.response.success&&r(function(){e.$apply(function(){e.mediafile=t.response.result.mediafiles})},100)}))},e.reloadArticle=function(){d.article_id&&(e.details.article_feature=[],e.details.article_features_list=[],l.getDetailArticle(d.article_id).then(function(t){200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.details.article_features_list=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{item_name:e.product_details.item_name,item_code:e.product_details.product_code,item_brand:e.product_details.brand,item_id:e.product_details.p_id}:null!==e.bundle_id&&null==e.product_id?{item_name:e.bundle_details.bundle_name,item_code:e.bundle_details.bundle_code,item_brand:e.bundle_details.bundle_brand,item_id:e.bundle_details.pb_id}:void 0}),e.details.article_feature=_.map(e.details.article_features,function(e){return null==e.bundle_id&&null!==e.product_id?{product_id:e.product_details.p_id,bundle_id:null,article_id:d.article_id}:null!==e.bundle_id&&null==e.product_id?{product_id:null,bundle_id:e.bundle_details.pb_id,article_id:d.article_id}:void 0}))}))},e.addToList=function(){"product"==e.radioModel?_.isUndefined(e.details.product)||_.isEmpty(e.details.product)||(_.find(e.details.article_features_list,{item_id:e.details.product.p_id})?s.warning("Product Item already existed","Warning"):(e.details.article_features_list.push({item_name:e.details.product.item_name,item_quantity:1,item_code:e.details.product.product_code,item_brand:e.details.product.brand,item_id:e.details.product.p_id}),e.details.article_feature.push({product_id:e.details.product.p_id,bundle_id:null,quantity:1,article_id:d.article_id}))):"productgroup"==e.radioModel&&(_.isUndefined(e.details.productgroup)||_.isEmpty(e.details.productgroup)||(_.find(e.details.article_features_list,{item_id:e.details.productgroup.pb_id})?s.warning("Bundle Item already existed","Warning"):(e.details.article_features_list.push({item_name:e.details.productgroup.bundle_name,item_quantity:1,item_code:e.details.productgroup.bundle_code,item_brand:e.details.productgroup.bundle_brand,item_id:e.details.productgroup.pb_id}),e.details.article_feature.push({bundle_id:e.details.productgroup.pb_id,product_id:null,quantity:1,article_id:d.article_id})))),e.details.product={},e.details.productgroup={}},e.minusbutton=function(e){e.quantity<1?(e.quantity=0,m(e)):(e.quantity--,m(e))},e.addbutton=function(e){e.quantity++,m(e)},e.removeOnList=function(t){e.details.article_features_list.splice(t,1),e.details.article_feature.splice(t,1)},e.deleteAllMedia=function(){a.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){d.article_id&&l.deleteAllArticleMedia(d.article_id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void t.reload()):void s.error(e.response.msg,"Error")})})},e.deleteSelected=function(i){a.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("media: ",i),d.article_id&&l.deleteArticleMediaFile(d.article_id,i._id).then(function(e){return 200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),void t.reload()):void s.error(e.response.msg,"Error")})})},e.saveArticle=function(){async.waterfall([function(t){d.article_id?l.updateArticle(d.article_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)s.success(e.response.msg,"Success"),t(null,d.article_id);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void s.error(e.response.msg,"Error");_.each(e.response.result,function(e){s.warning(e.msg,"Warning")})}}):l.saveArticle(e.details).then(function(e){if(200==e.statusCode&&e.response.success)s.success(e.response.msg,"Success"),t(null,e.response.result);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void s.error(e.response.msg,"Error");_.each(e.response.result,function(e){s.warning(e.msg,"Warning")})}})},function(t,i){var r=1;e.details.tags.length>0?async.eachSeries(e.details.tags,function(d,l){d.isTag?c.saveTags(d).then(function(e){return 200==e.statusCode&&e.response.success?void c.saveArticleTags(t,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void l()):void s.error(e.response.msg,"Error")}):void s.error(e.response.msg,"Error")}):c.saveArticleTags(t,{tag_id:d.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void l()):void s.error(e.response.msg,"Error")}),r>=e.details.tags.length&&i(null,t)}):i(null,t)},function(e,i){r(function(){t.go(t.current,{article_id:e},{reload:!0})},300)}])},e.tagTransform=function(e){return console.log(e),{tags:e}},e.clearInput=function(e){e.search=""},e.deleteProductTags=function(e){d.article_id&&c.deleteArticleTag(d.article_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void s.success(e.response.msg,"Success"):void s.error(e.response.msg,"Error")})},e.publishArticle=function(e){l.publishArticle(e).then(function(e){200==e.statusCode&&e.response.success?(s.success(e.response.msg,"Success"),t.go(t.current,null,{reload:!0})):s.error(e.response.msg,"Error")})},e.openUploader=function(){var e=o.open({animation:!0,backdrop:"static",templateUrl:"./modules/articles/article.upload.modal.html",controller:"articleUploadModalCtrl",size:"lg",resolve:{article_id:function(){return d.article_id}}});e.result.then(function(e){t.reload()},function(){})},e.openLightboxModal=function(e){var t=[];t.push({url:e.media_path,caption:e.media_name,thumbUrl:e.media_path}),p.openModal(t,0)},e.openVideoModal=function(e){var t=[];t.push({url:e.media_path,type:"video",thumbUrl:e.media_path}),p.openModal(t,0)}}angular.module("POS17").controller("articleDetailController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","articleFctry","ngTableParams","ngDialog","$uibModal","productFactory","tagsFactory","Lightbox"]}();

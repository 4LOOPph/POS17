...
!function(){"use strict";function t(t,e,s,i,a,r,n,u,l,c,o,d,p){t.productType=[],t.selectedDatas=[],t.attributeTypes=[],t.categories=[],t.articles=[],t.attribute_group=[],t.selectDeselectAll=!1,t.showAttributeValues=!1,t.details={},t.attrib_type={},t.attrib_type.attribute_list_value=[],t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable,a.getAllAttributeTypes().then(function(e){if(200==e.statusCode&&e.response.success){var s=[];s=e.response.result,r(function(){t.$apply(function(){t.attributeTypes=s})},100)}}),a.getAllAttributeGroup().then(function(e){if(200==e.statusCode&&e.response.success){var s=[];s=e.response.result,r(function(){t.$apply(function(){t.attribute_group=s})},100)}}),c.getAllCategory().then(function(e){if(200==e.statusCode&&e.response.success){var s=e.response.result;r(function(){t.$apply(function(){t.categories=s})},100)}}),o.getArticle().then(function(e){if(200==e.statusCode&&e.response.success){var s=e.response.result;r(function(){t.$apply(function(){t.articles=s})},100)}}),l.getAllProdType().then(function(e){200==e.statusCode&&e.response.success&&(t.productType=e.response.result,_.each(t.productType,function(t){t.selected=!1}))}),async.waterfall([function(t){a.getAllAttributeTypes().then(function(e){200==e.statusCode&&e.response.success&&t(null,e.response.result)})},function(e,i){t.types=e,s.att_id&&(t.showAttributeValues=!0,a.getAllAttributeDetails(s.att_id).then(function(e){200==e.statusCode&&e.response.success&&(t.details=e.response.result,t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable)}))}]),t.changeSelectDeselectAll=function(){t.selectDeselectAll=!t.selectDeselectAll,_.each(t.productType,function(e){e.selected=t.selectDeselectAll,t.deleteSomeData=t.selectDeselectAll,t.checkDataChanges(e)})},t.checkDataChanges=function(e){e.selected?_.find(t.selectedDatas,function(t){return t.ptype_id===e.ptype_id})||t.selectedDatas.push(e):t.selectedDatas=_.filter(t.selectedDatas,function(t){return t.ptype_id!==e.ptype_id}),t.deleteSomeData=t.selectedDatas.length>0},t.$watch(function(){return t.details.attrib_type_id},function(e){console.log("newValue: ",e);var s=_.find(t.attributeTypes,{attrib_type_id:e});t.details.attrib_type=s,console.log("attribute: ",s)}),t.$watch(function(){return t.attributeTypes},function(e){var s=_.find(e,{attrib_type_id:t.details.attrib_type_id});t.details.attrib_type=s,console.log("attribute: ",s)}),t.removethumb=function(){t.attrib_type.value_image=null},t.addtoList=function(){t.attrib_type.attribute_list_value.push({name:t.attrib_type.attrib_name,value:t.attrib_type.attrib_value}),t.attrib_type.attrib_name="",t.attrib_type.attrib_value=""},t.addtoList1=function(){t.attrib_type.attribute_list_value.push({name:t.attrib_type.attrib_name,value:t.attrib_type.attrib_value,description:t.attrib_type.attrib_description}),t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description=""},t.saveAttribute=function(){async.waterfall([function(e){s.att_id?a.updateAttribute(s.att_id,t.details).then(function(t){if(200==t.statusCode&&t.response.success)r(function(){n.success("Successfully Update","Success")},300),e(null,s.att_id);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void n.error(t.response.msg,"Error");_.each(t.response.result,function(t){n.warning(t.msg,"Warning")})}}):a.saveAttribute(t.details).then(function(t){if(200==t.statusCode&&t.response.success)r(function(){n.success("Successfully Added","Success")},300),e(null,t.response.result);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void n.error(t.response.msg,"Error");_.each(t.response.result,function(t){n.warning(t.msg,"Warning")})}})},function(e,i){a.updateAttribute(s.att_id,t.details).then(function(t){if(200==t.statusCode&&t.response.success)r(function(){n.success("Successfully Update","Success")},300),i(null,s.att_id);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void n.error(t.response.msg,"Error");_.each(t.response.result,function(t){n.warning(t.msg,"Warning")})}})},function(t,e){u.go(u.current,{att_id:t},{reload:!0})}])}}angular.module("POS17").controller("attributeDetailsController",t),t.$inject=["$scope","$uibModal","$stateParams","localStorageService","attributeFactory","$timeout","toastr","$state","ptypeFactory","categoryFactory","articleFctry","API_URL","API_VERSION"]}();
...
!function(){"use strict";function e(e,s,n,t,r,i){e.permissions=[],e.Groups=[],e.usergroups=[],e.isReset=!0,e.isUpdate=!0,e.generateAccessPermission=function(n){e.permissions=[],s(function(){_.isUndefined(n)?e.clear():r.generateAccessPermission(n).then(function(s){if(console.log("data: ",s.response.result),200==s.statusCode&&s.response.success){e.isUpdate=!1,e.isReset=!1;var n=s.response.result;n.length>0&&(e.permissions=n,_.each(e.permissions,function(e){e.DefaultReadDisable=!1,e.DefaultWriteDisable=!1,e.DefaultDeleteDisable=!1,e.DefaultPrintDisable=!1}))}})},300)},e.clear=function(){e.isUpdate=!0,e.isReset=!0,e.usergroupSelected=void 0,e.permissions=[],r.getAllModulesPermissions().then(function(s){if(200==s.statusCode&&s.response.success){var n=s.response.result;n.length>0&&(e.permissions=n,_.each(e.permissions,function(e){e.DefaultRead=!1,e.DefaultReadDisable=!0,e.DefaultWrite=!1,e.DefaultWriteDisable=!0,e.DefaultDelete=!1,e.DefaultDeleteDisable=!0,e.DefaultPrint=!1,e.DefaultPrintDisable=!0}))}})},e.reloadData=function(){_.isUndefined(e.usergroup)?e.clear():e.generateAccessPermission(e.usergroup.role_id)},e.UpdatePermission=function(){e.newPermission=angular.copy(e.permissions),r.setGroupPrivilege(e.usergroupSelected.role_id,e.newPermission).then(function(s){200==s.statusCode&&s.response.success?(t.success(s.response.msg,"Success"),e.reloadData()):t.error(s.response.msg,"Error")})},e.IntToBoolean=function(e){return 1==e},e.BooleanToInt=function(e){return e===!0?1:0},e.myFunction=function(){console.log("myFunction"),s(function(){angular.element(document).ready(function(){$("#myTable").each(function(){var e=1;$("tbody",this).find("tr").each(function(){var s=$(this).find("td:nth-child("+e+")");console.log("Current_td: ",$(s))})})})},1e3)},_.isUndefined(n.groupId)?r.getAllModulesPermissions().then(function(s){if(200==s.statusCode&&s.response.success){var n=s.response.result;n.length>0&&(e.permissions=n,_.each(e.permissions,function(e){e.DefaultRead=!1,e.DefaultReadDisable=!0,e.DefaultWrite=!1,e.DefaultWriteDisable=!0,e.DefaultDelete=!1,e.DefaultDeleteDisable=!0,e.DefaultPrint=!1,e.DefaultPrintDisable=!0}),callback(null,e.permissions))}}):i.getUserGroupById(n.groupId).then(function(s){200==s.statusCode&&s.response.success?_.isArray(s.response.result)&&(e.usergroup=s.response.result[0],e.generateAccessPermission(e.usergroup.role_id)):t.error(s.response.msg,"Error")})}angular.module("POS17").controller("permissionCtrl",e),e.$inject=["$scope","$timeout","$stateParams","toastr","permissionFctry","usergroupsFctry"]}();

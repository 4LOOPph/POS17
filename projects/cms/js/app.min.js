...
!function(){"use strict";function e(e,s,t,o,r,n,i,a,c,u,d,l,p,g){e.details={},e.ptypes={},e["package"]={},e.items={},e.list1=[],e.list2=[],e.productCopy=[],e.attributes=[],e.product_image=[],e.tags=[],e.tagsArr=[],e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.add=!1,e.displayComposite=!1,e.displayImage=!1,e.image=[],e.txtSearch="",e.myInterval=3e3,e.noWrapSlides=!1,e.activeSlide=0,e.thumbnailSize=5,e.thumbnailPage=1,e.slides=[];var m=function(){i.getAllProduct().then(function(s){200==s.statusCode&&s.response.success&&(e.list1=s.response.result,e.productCopy=angular.copy(s.response.result),_.each(e.list1,function(e){e.selected=!1})),e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]})};e.refresh=function(){m()},e.searchData=function(s){e.list1=t("filter")(e.productCopy,s)},a.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?e.ptypes=s.response.result:o.error(s.response.msg,"Error")}),l.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:o.error(s.response.msg,"Error")}),_.isEmpty(r.pb_id)?(e.showPublish=!1,e.showArchive=!1):(e.displayComposite=!0,e.displayImage=!0,i.getProductBundleDetails(r.pb_id).then(function(s){if(200==s.statusCode&&s.response.success){var t=0;e.details=s.response.result,e.items=s.response.result,e.product_image=e.details.product_images,_.each(e.product_image,function(s){e.slides.push({image:s.image_path,index:t}),t++}),e.list2=_.map(e.details.products,function(e){return e.product_detail}),console.log("$scope.list2: ",e.list2),e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),l.getAllProductBundleTags(r.pb_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)})}})),e.$watch("list2",function(s){e.list2=s},!0),e.$watch("models",function(s){e.modelAsJson=s,console.log("$scope.modelAsJson:",e.modelAsJson)},!0),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.deleteProductTags=function(e){console.log("deleteProductBundleTag: ",e),r.pb_id&&l.deleteProductBundleTag(r.pb_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void o.success(e.response.msg,"Success"):void o.error(e.response.msg,"Error")})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.store_id===s.store_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.store_id!==s.store_id}),e.deleteSomeData=e.selectedDatas.length>0},e.dropCallback=function(s,t,o){var r=[];_.isUndefined(e.modelAsJson)||(r=_.find(e.modelAsJson,function(e){return"Package"==e.listName}),e.items.products=_.map(r.items,function(e){return{product_id:e.p_id}}),console.log("$scope.items:",e.items))},e.remove=function(e,s){return e.items.splice(s,1)},e.removeAll=function(e,s){_.each(e.items,function(t){return e.items.splice(s,1)})},e.openUploader=function(){var e=p.open({animation:!0,templateUrl:"./modules/products/product-bundle.upload.modal.html",controller:"productBundleUploaderModalCtrl",size:"lg",resolve:{product_bundle_id:function(){return r.pb_id}}});e.result.then(function(e){s.reload()})},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.archiveProduct=function(e){i.archiveBundle(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.publishProduct=function(e){i.publishBundle(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.onDragstart=function(e,s){if(e.dragging=!0,s.dataTransfer.setDragImage){var t=new Image;t.src="./images/cargo-128.png",s.dataTransfer.setDragImage(t,0,0)}},e.addProductBundle=function(){r.pb_id&&i.updateProductBundle(r.pb_id,e.items).then(function(e){200==e.statusCode&&e.response.success&&(o.success(e.response.msg,"Success"),s.go(s.current,{pb_id:r.pb_id},{reload:!0}))})},e.addProduct=function(){async.waterfall([function(s){r.pb_id?i.updateProductBundle(r.pb_id,e.details).then(function(t){200==t.statusCode&&t.response.success?(o.success(t.response.msg,"Success"),e.items=e.details,s(null,r.pb_id)):(e.validate=t.response.result,_.each(e.validate,function(e){o.warning(t.response.msg,"Error - "+e.msg)}))}):i.saveProductBundle(e.details).then(function(t){200==t.statusCode&&t.response.success?(e.items=e.details,o.success(t.response.msg,"Success"),s(null,t.response.result)):(e.validate=t.response.result,_.each(e.validate,function(e){o.warning(t.response.msg,"Error - "+e.msg)}))})},function(s,t){var r=0;async.eachSeries(e.details.tags,function(n,i){n.isTag?l.saveTags(n).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("saveProductGroupTags bundle_id: ",s),void l.saveProductGroupTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void i()):void o.error(e.response.msg,"Error")})):void o.error(e.response.msg,"Error")}):l.saveProductGroupTags(s,{tags_id:n.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void i()):void o.error(e.response.msg,"Error")}),r>=e.details.tags.length&&t(null,s)})},function(e,t){console.log("asdasdasdas: ",e),g(function(){s.go(s.current,{pb_id:e},{reload:!0})},1e3)}])},e.getSelectedItemsIncluding=function(e,s){return s.selected=!0,e.items.filter(function(e){return e.selected})},e.onDrop=function(e,s,t){return angular.forEach(s,function(e){e.selected=!1}),e.items=e.items.slice(0,t).concat(s).concat(e.items.slice(t)),!0},e.onMoved=function(e){e.items=e.items.filter(function(e){return!e.selected})},e.refresh()}angular.module("POS17").controller("productsBundleController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","ngDialog","productFactory","ptypeFactory","storeFactory","priceHistoryFactory","supplierFctry","tagsFactory","$uibModal","$timeout"]}();

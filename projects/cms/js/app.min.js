...
!function(){"use strict";function e(e,o,t,i){e.name="Type",e.status="All",e.pricebooktype=[],o.getPricebookType().then(function(o){e.pricebooktype=[],200==o.statusCode&&o.response.success&&(e.pricebooktype=o.response.result,console.log("$scope.pricebooktype:",e.pricebooktype))}),e.example8model=[],e.example8data=[{id:1,label:"Telstra"},{id:2,label:"Proximity"},{id:3,label:"Christmas"},{id:4,label:"Women"}];var r=function(){e.pricebookLoading=!0,e.pricebooks=[],e.pricebookscopy=[],e.pricebooksTable=new t({page:1,count:10},{counts:[10,25,50,100],getData:function(t,r){o.getAllPricebook().then(function(o){if(200==o.statusCode&&o.response.success){var p=o.response.result;e.pricebookscopy=angular.copy(o.response.resul),e.txtSearch&&"All"==e.status&&e.type?(e.pricebooks=i("filter")(p,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(p,e.txtSearch)):e.txtSearch&&"Published"==e.status&&e.type?(e.pricebooks=i("filter")(p,{isActive:1}),e.pricebooks=i("filter")(p,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(p,e.txtSearch)):e.txtSearch&&"Unpublished"==e.status&&e.type?(e.pricebooks=i("filter")(p,e.txtSearch),e.pricebooks=i("filter")(p,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(p,{isActive:0})):_.isUndefined(e.txtSearch)&&"All"==e.status&&e.type?e.pricebooks=i("filter")(p,{pricebook_type_id:e.type.pt_id}):_.isUndefined(e.txtSearch)&&"Published"==e.status&&e.type.pt_id?(e.pricebooks=i("filter")(p,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(p,{isActive:1})):_.isUndefined(e.txtSearch)&&"Unpublished"==e.status&&e.type?(e.pricebooks=i("filter")(p,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(p,{isActive:0})):e.pricebooks=p,r.total(e.pricebooks.length);var s=e.pricebooks.slice((r.page()-1)*r.count(),r.page()*r.count());t.resolve(s),e.pricebookLoading=!1}else toastr.error(o.response.msg,"Error"),e.pricebookLoading=!1})}})};r(),e.updateStatus=function(o){e.status=o,e.pricebooksTable.reload()},e.updateType=function(o){e.type=o,e.name=o.name,e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter"]}();

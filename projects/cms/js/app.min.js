...
!function(){"use strict";function e(e,s,t,n,o,r,i,a,d,u,c,l,p,g){function m(s){_.each(e.list2,function(e){e.p_id==s.p_id&&(e.quantity=s.quantity)})}e.details={},e.ptypes={},e["package"]={},e.items={},e.list1=[],e.list2=[],e.productCopy=[],e.getSel=[],e.attributes=[],e.product_image=[],e.tags=[],e.tagsArr=[],e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.add=!1,e.displayComposite=!1,e.displayImage=!1,e.image=[],e.txtSearch="",e.myInterval=3e3,e.noWrapSlides=!1,e.activeSlide=0,e.thumbnailSize=5,e.thumbnailPage=1,e.slides=[];var f=function(){i.getAllProduct().then(function(s){200==s.statusCode&&s.response.success&&(e.list1=s.response.result,e.productCopy=angular.copy(s.response.result),_.each(e.list1,function(e){e.selected=!1})),e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]})};e.refresh=function(){f()},e.searchData=function(s){e.list1=t("filter")(e.productCopy,s)},a.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?e.ptypes=s.response.result:n.error(s.response.msg,"Error")}),l.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:n.error(s.response.msg,"Error")}),_.isEmpty(o.pb_id)?(e.showPublish=!1,e.showArchive=!1):(e.displayComposite=!0,e.displayImage=!0,i.getProductBundleDetails(o.pb_id).then(function(s){if(200==s.statusCode&&s.response.success){var t=0;e.details=s.response.result,e.items=s.response.result,e.product_image=e.details.product_images,_.each(e.product_image,function(s){e.slides.push({image:s.image_path,index:t}),t++}),_.each(e.details.products,function(s){var t=s.product_detail;t.quantity=_.isNull(s.quantity)?0:s.quantity,1!==t.is_archived&&e.list2.push(t)}),e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),l.getAllProductBundleTags(o.pb_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)})}})),e.$watch("list2",function(s){e.list2=s,e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]},!0),e.$watch("list1",function(s){e.list1=s,e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]},!0),e.$watch("models",function(s){e.modelAsJson=s,console.log("$scope.modelAsJson: ",e.modelAsJson[0].items)},!0),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.deleteProductTags=function(e){console.log("deleteProductBundleTag: ",e),o.pb_id&&l.deleteProductBundleTag(o.pb_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void n.success(e.response.msg,"Success"):void n.error(e.response.msg,"Error")})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.store_id===s.store_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.store_id!==s.store_id}),e.deleteSomeData=e.selectedDatas.length>0},e.remove=function(e,s){var t=_.findIndex(e.items,function(e){return e.p_id==s.p_id});return e.items.splice(t,1)},e.removeAll=function(e,s){_.each(e.items,function(s){return e.items.splice(e.items,1)})},e.openUploader=function(){var e=p.open({animation:!0,templateUrl:"./modules/products/product-bundle.upload.modal.html",controller:"productBundleUploaderModalCtrl",size:"lg",resolve:{product_bundle_id:function(){return o.pb_id}}});e.result.then(function(e){s.reload()})},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.archiveProduct=function(e){i.archiveBundle(e).then(function(e){200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):n.error(e.response.msg,"Error")})},e.publishProduct=function(e){i.publishBundle(e).then(function(e){200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):n.error(e.response.msg,"Error")})},e.addProductBundle=function(){o.pb_id&&(_.isUndefined(e.modelAsJson)||(e.items.products=_.map(e.modelAsJson[0].items,function(e){return{product_id:e.p_id,quantity:e.quantity}})),console.log(e.items),i.updateProductBundle(o.pb_id,e.items).then(function(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),s.go(s.current,{pb_id:o.pb_id},{reload:!0}))}))},e.addProduct=function(){async.waterfall([function(s){o.pb_id?i.updateProductBundle(o.pb_id,e.details).then(function(t){200==t.statusCode&&t.response.success?(n.success(t.response.msg,"Success"),e.items=e.details,s(null,o.pb_id)):(e.validate=t.response.result,_.each(e.validate,function(e){n.warning(t.response.msg,"Error - "+e.msg)}))}):i.saveProductBundle(e.details).then(function(t){200==t.statusCode&&t.response.success?(e.items=e.details,n.success(t.response.msg,"Success"),s(null,t.response.result)):(e.validate=t.response.result,_.each(e.validate,function(e){n.warning(t.response.msg,"Error - "+e.msg)}))})},function(s,t){var o=0;e.details.tags.length>0?async.eachSeries(e.details.tags,function(r,i){r.isTag?l.saveTags(r).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("saveProductGroupTags bundle_id: ",s),void l.saveProductGroupTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void i()):void n.error(e.response.msg,"Error")})):void n.error(e.response.msg,"Error")}):l.saveProductGroupTags(s,{tags_id:r.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void i()):void n.error(e.response.msg,"Error")}),o>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,t){console.log("asdasdasdas: ",e),g(function(){s.go(s.current,{pb_id:e},{reload:!0})},1e3)}])},e.getSelectedItemsIncluding=function(e,s){return s.selected=!0,e.items.filter(function(e){return e.selected})},e.onDrop=function(s,t,n){return _.each(t,function(t){t.selected=!1;var n=_.find(s.items,{p_id:t.p_id});_.isEmpty(n)&&e.list2.push(t)}),s.items=s.items.slice(0,n).concat(t).concat(s.items.slice(n)),!0},e.onMoved=function(e){e.items=e.items.filter(function(e){return!e.selected})},e.onDragstart=function(e,s){if(e.dragging=!0,s.dataTransfer.setDragImage){var t=new Image;t.src="./images/cargo-128.png",s.dataTransfer.setDragImage(t,0,0)}},e.dropCallback=function(s,t,n){_.each(e.list1,function(e){e.selected=!1})},e.deleteAllMedia=function(){r.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.pb_id&&i.deleteAllProductBundleImage(o.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void s.reload()):void n.error(e.response.msg,"Error")})})},e.deleteSelected=function(t){r.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("media: ",t),o.pb_id&&i.deleteProductBundleImageFile(o.pb_id,t._id).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void s.reload()):void n.error(e.response.msg,"Error")})})},e.minusbutton=function(e){e.quantity<1?(e.quantity=0,m(e)):(e.quantity--,m(e))},e.addbutton=function(e){e.quantity++,m(e)},e.refresh()}angular.module("POS17").controller("productsBundleController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","ngDialog","productFactory","ptypeFactory","storeFactory","priceHistoryFactory","supplierFctry","tagsFactory","$uibModal","$timeout"]}();
...
!function(){"use strict";function t(t,e,s,i,a,r,n,u,l,o,c,d,p,b,y,f){t.productType=[],t.selectedDatas=[],t.attributeTypes=[],t.categories=[],t.articles=[],t.attribute_group=[],t.selectDeselectAll=!1,t.showAttributeValues=!1,t.details={},t.attrib_type={},t.attrib_type.attribute_list_value=[],t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable,t.details.valuelist=[],r.getAllAttributeTypes().then(function(e){if(200==e.statusCode&&e.response.success){var s=[];s=e.response.result,n(function(){t.$apply(function(){t.attributeTypes=s})},100)}}),r.getAllAttributeGroup().then(function(e){if(200==e.statusCode&&e.response.success){var s=[];s=e.response.result,n(function(){t.$apply(function(){t.attribute_group=s})},100)}}),c.getAllCategory().then(function(e){if(200==e.statusCode&&e.response.success){var s=e.response.result;n(function(){t.$apply(function(){t.categories=s})},100)}}),d.getArticle().then(function(e){if(200==e.statusCode&&e.response.success){var s=e.response.result;n(function(){t.$apply(function(){t.articles=s})},100)}}),o.getAllProdType().then(function(e){200==e.statusCode&&e.response.success&&(t.productType=e.response.result,_.each(t.productType,function(t){t.selected=!1}))}),async.waterfall([function(t){r.getAllAttributeTypes().then(function(e){200==e.statusCode&&e.response.success&&t(null,e.response.result)})},function(e,s){t.types=e,i.att_id&&r.getAllAttributeDetails(i.att_id).then(function(e){200==e.statusCode&&e.response.success&&(t.showAttributeValues=!0,t.details=e.response.result,t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable,r.getAttributeValueList(i.att_id).then(function(e){if(200==e.statusCode&&e.response.success){var s=e.response.result;s&&s.length>1?(_.each(s,function(e){t.attrib_type.attribute_list_value.push({att_id:i.att_id,name:e.name,value:e.value,description:e.description,contenttype:e.contenttype,sku:e.sku,value_image:e.value_image,_id:e._id,isEdit:!1})}),n(function(){t.$apply(function(){t.details.valuelist=s})},100)):s&&s.length>0&&(s=s[0],t.attrib_type.attrib_name=s.name,t.attrib_type.attrib_value=s.value,t.attrib_type.attrib_description=s.description,t.attrib_type.contenttype=s.contenttype,t.attrib_type.sku=s.sku)}}),r.getAttibuteMapping(i.att_id).then(function(t){200==t.statusCode&&t.response.success&&console.log("data.response: ",t.response)}))})}]),t.changeSelectDeselectAll=function(){t.selectDeselectAll=!t.selectDeselectAll,_.each(t.productType,function(e){e.selected=t.selectDeselectAll,t.deleteSomeData=t.selectDeselectAll,t.checkDataChanges(e)})},t.checkDataChanges=function(e){e.selected?_.find(t.selectedDatas,function(t){return t.ptype_id===e.ptype_id})||t.selectedDatas.push(e):t.selectedDatas=_.filter(t.selectedDatas,function(t){return t.ptype_id!==e.ptype_id}),t.deleteSomeData=t.selectedDatas.length>0},t.$watch(function(){return t.details.attrib_type_id},function(e){t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description="";var s=_.find(t.attributeTypes,{attrib_type_id:e});t.details.attrib_type=s}),t.$watch(function(){return t.attributeTypes},function(e){t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description="";var s=_.find(e,{attrib_type_id:t.details.attrib_type_id});t.details.attrib_type=s}),t.getAllAttributeValues=function(){t.details.valuelist=[],t.attrib_type.attribute_list_value=[],r.getAttributeValueList(i.att_id).then(function(e){200==e.statusCode&&e.response.success&&(t.details.valuelist=e.response.result,_.each(t.details.valuelist,function(e){t.attrib_type.attribute_list_value.push({att_id:i.att_id,name:e.name,value:e.value,description:e.description,contenttype:e.contenttype,sku:e.sku,value_image:e.value_image,_id:e._id,isEdit:!1})}))})},t.removethumb=function(){t.attrib_type.value_image=null},t.addtoList=function(){i.att_id?r.saveAttributeValueList(i.att_id,{name:t.attrib_type.attrib_name,value:t.attrib_type.attrib_value,description:t.attrib_type.attrib_description,contenttype:t.attrib_type.contenttype,sku:t.attrib_type.sku}).then(function(e){if(200==e.statusCode&&e.response.success)u.success(e.response.msg,"Success"),t.clearInput(),l.reload();else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void u.error(e.response.msg,"Error");_.each(e.response.result,function(t){u.warning(t.msg,"Warning")})}}):u.warning("Please select attribute to update","Warning")},t.addtoList1=function(){i.att_id?f.upload({url:b+y+"attributes/"+i.att_id+"/valuelist",data:{name:t.attrib_type.attrib_name,value:t.attrib_type.attrib_value,description:t.attrib_type.attrib_description,contenttype:t.attrib_type.contenttype,sku:t.attrib_type.sku,value_image:t.attrib_type.value_image,_id:t.attrib_type._id,isEdit:t.attrib_type.isEdit},method:"POST"}).then(function(t){if(200===t.data.statusCode&&t.data.response.success)u.success(t.data.response.msg,"Success"),l.reload();else{if(400!==t.data.statusCode||t.data.response.success||!_.isArray(t.data.response.result))return void u.error(t.data.response.msg,"Error");_.each(t.data.response.result,function(t){u.warning(t.msg,"Warning")})}},function(t){console.log("Error status: "+t.status)}):u.warning("Please select attribute to update","Warning")},t.viewFromList=function(e){t.attrib_type.attrib_name=e.name,t.attrib_type.attrib_value=e.value,t.attrib_type.attrib_description=e.description,t.attrib_type.contenttype=e.contenttype,t.attrib_type.sku=e.sku,t.attrib_type.value_image=e.value_image,t.attrib_type._id=e._id,t.attrib_type.isEdit=!0},t.clearInput=function(){t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description="",t.attrib_type.contenttype="",t.attrib_type.sku="",t.attrib_type.value_image=null},t.deleteSelected=function(e){s.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:t,className:"ngdialog-theme-default"}).then(function(){r.deleteAttributeValueList(e.att_id,e._id).then(function(t){return 200==t.statusCode&&t.response.success?(u.success(t.response.msg,"Success"),void l.reload()):void u.error(t.response.msg,"Error")})})},t.saveAttribute=function(){t.details.values=t.attrib_type,console.log("details: ",t.details),async.waterfall([function(e){i.att_id?r.updateAttribute(i.att_id,t.details).then(function(t){if(200==t.statusCode&&t.response.success)n(function(){u.success("Successfully Update","Success")},300),e(null,i.att_id);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void u.error(t.response.msg,"Error");_.each(t.response.result,function(t){u.warning(t.msg,"Warning")})}}):r.saveAttribute(t.details).then(function(t){if(200==t.statusCode&&t.response.success)n(function(){u.success("Successfully Added","Success")},300),e(null,t.response.result);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void u.error(t.response.msg,"Error");_.each(t.response.result,function(t){u.warning(t.msg,"Warning")})}})},function(t,e){e(null,i.att_id)},function(t,e){l.go(l.current,{att_id:t},{reload:!0})}])}}angular.module("POS17").controller("attributeDetailsController",t),t.$inject=["$scope","$uibModal","ngDialog","$stateParams","localStorageService","attributeFactory","$timeout","toastr","$state","ptypeFactory","categoryFactory","articleFctry","AuthFctry","API_URL","API_VERSION","Upload"]}();

...
!function(){"use strict";function t(t,e,i,s,a,r,l,n,u,c,o,p,d){t.productType=[],t.selectedDatas=[],t.attributeTypes=[],t.categories=[],t.articles=[],t.attribute_group=[],t.selectDeselectAll=!1,t.showAttributeValues=!1,t.details={},t.attrib_type={},t.attrib_type.attribute_list_value=[],t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable,a.getAllAttributeTypes().then(function(e){if(200==e.statusCode&&e.response.success){var i=[];i=e.response.result,r(function(){t.$apply(function(){t.attributeTypes=i})},100)}}),a.getAllAttributeGroup().then(function(e){if(200==e.statusCode&&e.response.success){var i=[];i=e.response.result,r(function(){t.$apply(function(){t.attribute_group=i})},100)}}),c.getAllCategory().then(function(e){if(200==e.statusCode&&e.response.success){var i=e.response.result;r(function(){t.$apply(function(){t.categories=i})},100)}}),o.getArticle().then(function(e){if(200==e.statusCode&&e.response.success){var i=e.response.result;r(function(){t.$apply(function(){t.articles=i})},100)}}),u.getAllProdType().then(function(e){200==e.statusCode&&e.response.success&&(t.productType=e.response.result,_.each(t.productType,function(t){t.selected=!1}))}),async.waterfall([function(t){a.getAllAttributeTypes().then(function(e){200==e.statusCode&&e.response.success&&t(null,e.response.result)})},function(e,s){t.types=e,i.att_id&&(t.showAttributeValues=!0,a.getAllAttributeDetails(i.att_id).then(function(e){200==e.statusCode&&e.response.success&&(t.details=e.response.result,t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable)}))}]),t.changeSelectDeselectAll=function(){t.selectDeselectAll=!t.selectDeselectAll,_.each(t.productType,function(e){e.selected=t.selectDeselectAll,t.deleteSomeData=t.selectDeselectAll,t.checkDataChanges(e)})},t.checkDataChanges=function(e){e.selected?_.find(t.selectedDatas,function(t){return t.ptype_id===e.ptype_id})||t.selectedDatas.push(e):t.selectedDatas=_.filter(t.selectedDatas,function(t){return t.ptype_id!==e.ptype_id}),t.deleteSomeData=t.selectedDatas.length>0},t.$watch(function(){return t.details.attrib_type_id},function(e){console.log("newValue: ",e),t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description="";var i=_.find(t.attributeTypes,{attrib_type_id:e});t.details.attrib_type=i,console.log("attribute: ",i)}),t.$watch(function(){return t.attributeTypes},function(e){t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description="";var i=_.find(e,{attrib_type_id:t.details.attrib_type_id});t.details.attrib_type=i,console.log("attribute: ",i)}),t.removethumb=function(){t.attrib_type.value_image=null},t.addtoList=function(){t.attrib_type.attribute_list_value.push({name:t.attrib_type.attrib_name,value:t.attrib_type.attrib_value,description:t.attrib_type.attrib_description}),t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description=""},t.addtoList1=function(){t.attrib_type.attribute_list_value.push({name:t.attrib_type.attrib_name,value:t.attrib_type.attrib_value,description:t.attrib_type.attrib_description}),t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description=""},t.saveAttribute=function(){t.details.values=t.attrib_type,console.log("details: ",t.details)}}angular.module("POS17").controller("attributeDetailsController",t),t.$inject=["$scope","$uibModal","$stateParams","localStorageService","attributeFactory","$timeout","toastr","$state","ptypeFactory","categoryFactory","articleFctry","API_URL","API_VERSION"]}();

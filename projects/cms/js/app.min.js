...
!function(){"use strict";function e(e,s,t,r,o,a,n,i,d,u,c,l,p){e.ptypes=[],e.attributes=[],e.details={},e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,n.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?(e.ptypes=s.response.result,e.details.ptype_id=e.ptypes[0].ptype_id):r.error(s.response.msg,"Error")}),_.isEmpty(o.p_id)?(e.showPublish=!1,e.showArchive=!1,e.tabprod={product:!0,store:!1,price:!1,category:!1,attribute:!1,variation:!1,ratings:!1,related:!1},console.log("$scope.tabprod: ",e.tabprod)):a.getProductDetails(o.p_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.tabprod={product:!0,store:!0,price:!0,category:!0,attribute:!0,variation:!0,ratings:!1,related:!1},e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived))}),e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.removethumb=function(){e.details.img_default=null},e.upload=function(s){e.isImageNew=!0},e.archiveProduct=function(e){a.archiveProduct(e).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.publishProduct=function(e){a.publishProduct(e).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.addProduct=function(){e.validate=[],async.waterfall([function(s){o.p_id?a.updateProduct(o.p_id,e.details).then(function(t){200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),s(null,o.p_id),console.log("UPDATE")):(e.validate=t.response.result,_.each(e.validate,function(e){r.warning(t.response.msg,"Error - "+e.msg)}))}):a.saveProduct(e.details).then(function(t){200==t.statusCode&&t.response.success?(r.success(t.response.msg,"Success"),s(null,t.response.result),console.log("SUCCESS")):(e.validate=t.response.result,_.each(e.validate,function(e){r.warning(t.response.msg,"Error - "+e.msg)}))})},function(t,o){p.upload({url:c+l+"product/"+t+"/upload-image",data:{product_img:e.details.img_default},method:"PUT"}).then(function(o){if(200===o.data.statusCode&&o.data.response.success)e.isImageNew&&r.success("Image successfully uploaded","Success"),s.go(s.current,{p_id:t},{reload:!0});else{if(400!==o.data.statusCode||o.data.response.success||!_.isArray(o.data.response.result))return void r.error(o.data.response.msg,"Error");_.each(o.data.response.result,function(e){r.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])}}angular.module("POS17").controller("productsAEController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","productFactory","ptypeFactory","supplierFctry","storeFactory","priceHistoryFactory","API_URL","API_VERSION","Upload"]}();
!function(){"use strict";function e(e,t,s,a,l,n,c,o,r,i){e.search={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[],e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0;var u=function(){e.productIsLoading=!0,e.bundles=[],e.bundlecopy=[],e.productBundleTable=new i({page:1,count:10},{counts:[10,25,50,100],getData:function(t,a){c.getAllProductBundle().then(function(l){if(200==l.statusCode&&l.response.success){var c=l.response.result;console.log("bundles:",c),_.each(c,function(e){e.date_created=moment(e.date_created).format("YYYY-MM-DD")}),e.bundlecopy=angular.copy(e.bundles),e.txtSearch&&"All"==e.applicationStatus?e.bundles=s("filter")(c,e.txtSearch):e.txtSearch&&"Publish"==e.applicationStatus?(e.bundles=s("filter")(c,{is_published:1}),e.bundles=s("filter")(e.bundles,e.txtSearch)):e.txtSearch&&"Archived"==e.applicationStatus?(e.bundles=s("filter")(c,{is_archived:1}),e.bundles=s("filter")(e.bundles,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus?(e.bundles=s("filter")(c,{is_published:0}),e.bundles=s("filter")(e.bundles,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.bundles=c:_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus?e.bundles=s("filter")(c,{is_published:1}):_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus?e.bundles=s("filter")(c,{is_archived:1}):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?e.bundles=s("filter")(c,{is_published:0}):e.bundles=c,a.total(e.bundles.length);var o=e.bundles.slice((a.page()-1)*a.count(),a.page()*a.count());t.resolve(o),e.productIsLoading=!1}else e.productIsLoading=!1,n.error(l.response.msg,"Error")})}})};e.edit=function(e){a.go("main.products-add",{p_id:e})},e.searchData=function(){e.productBundleTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productBundleTable.reload()},e.updateStatus=function(t){console.log("status: ",t),e.applicationStatus=t,e.productBundleTable.reload()},e.changeSelectDeselectAll=function(){_.each(e.bundles,function(t){t.selected=e.selectDeselectAll,e.selectSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.pb_id===t.pb_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pb_id!==t.pb_id}),e.selectSomeData=e.selectedDatas.length>0},e.archiveSelected=function(){r.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,l){s.selected&&c.archiveBundle(s.pb_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(n.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&a.reload(),l(),void 0):void n.error(s.response.msg,"Error")})})})},e.publishSelected=function(){r.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(s,l){s.selected&&c.publishBundle(s.pb_id).then(function(s){return console.log("data: ",s.response),200==s.statusCode&&s.response.success?(n.success(s.response.msg,"Success"),++t,t==e.selectedDatas.length&&a.reload(),l(),void 0):void n.error(s.response.msg,"Error")})})})},u()}angular.module("POS17").controller("productBundlesController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","supplierFctry","ngDialog","ngTableParams"]}();
!function(){"use strict";function e(e,t,s,r,o,n,a,c,i,l,d,u,p){e.details={},e.ptypes={},e["package"]={},e.items={},e.list1=[],e.list2=[],e.attributes=[],e.product_image=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.add=!1,e.displayComposite=!1,e.displayImage=!1,e.image=[],e.txtSearch="",e.myInterval=3e3,e.noWrapSlides=!1,e.activeSlide=0,e.thumbnailSize=5,e.thumbnailPage=1,e.slides=[];var g=function(){a.getAllProduct().then(function(t){200==t.statusCode&&t.response.success&&(e.list1=t.response.result,e.copy=angular.copy(t.response.result),_.each(e.list1,function(e){e.selected=!1})),e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]})};e.refresh=function(){g()},e.searchData=function(t){e.list1=s("filter")(e.copy,t)},c.getAllProdType().then(function(t){200==t.statusCode&&t.response.success?e.ptypes=t.response.result:r.error(t.response.msg,"Error")}),_.isEmpty(o.pb_id)?(e.showPublish=!1,e.showArchive=!1):(e.displayComposite=!0,e.displayImage=!0,a.getProductBundleDetails(o.pb_id).then(function(t){if(200==t.statusCode&&t.response.success){var s=0;e.details=t.response.result,console.log("$scope.details:",e.details),e.product_image=e.details.product_images,_.each(e.product_image,function(t){e.slides.push({image:t.image_path,index:s}),s++}),e.items=t.response.result,e.list2=_.map(_.each(e.items.products,"product_detail"),function(e){return e.product_detail}),e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=t.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived)}})),e.$watch("models",function(t){e.modelAsJson=t,console.log("$scope.modelAsJson:",e.modelAsJson)},!0),e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.store_id===t.store_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.store_id!==t.store_id}),e.deleteSomeData=e.selectedDatas.length>0},e.dropCallback=function(t,s,r){var o=[];_.isUndefined(e.modelAsJson)||(o=_.find(e.modelAsJson,function(e){return"Package"==e.listName}),e.items.products=_.map(o.items,function(e){return{product_id:e.p_id}}),console.log("$scope.items:",e.items))},e.remove=function(e,t){return e.items.splice(t,1)},e.removeAll=function(e,t){_.each(e.items,function(s){return e.items.splice(t,1)})},e.openUploader=function(){var e=u.open({animation:!0,templateUrl:"./modules/products/product-bundle.upload.modal.html",controller:"productBundleUploaderModalCtrl",size:"lg",resolve:{product_bundle_id:function(){return o.pb_id}}});e.result.then(function(e){t.reload()})},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.archiveProduct=function(e){a.archiveBundle(e).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),t.go(t.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.publishProduct=function(e){a.publishBundle(e).then(function(e){200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),t.go(t.current,null,{reload:!0})):r.error(e.response.msg,"Error")})},e.onDragstart=function(e,t){if(e.dragging=!0,t.dataTransfer.setDragImage){var s=new Image;s.src="./images/cargo-128.png",t.dataTransfer.setDragImage(s,0,0)}},e.addProductBundle=function(){o.pb_id&&a.updateProductBundle(o.pb_id,e.items).then(function(e){200==e.statusCode&&e.response.success&&(r.success(e.response.msg,"Success"),t.go(t.current,{pb_id:o.pb_id},{reload:!0}))})},e.addProduct=function(){o.pb_id?a.updateProductBundle(o.pb_id,e.details).then(function(s){200==s.statusCode&&s.response.success?(e.details=s.response.result,r.success(s.response.msg,"Success"),console.log("UPDATE"),e.items=e.details,t.go(t.current,{pb_id:o.pb_id},{reload:!0})):(e.validate=s.response.result,_.each(e.validate,function(e){r.warning(s.response.msg,"Error - "+e.msg)}))}):a.saveProductBundle(e.details).then(function(s){200==s.statusCode&&s.response.success?(e.details=s.response.result,e.items=e.details,r.success(s.response.msg,"Success"),p(function(){t.go(t.current,{pb_id:s.response.result},{reload:!0})},1e3)):(e.validate=s.response.result,_.each(e.validate,function(e){r.warning(s.response.msg,"Error - "+e.msg)}))})},e.getSelectedItemsIncluding=function(e,t){return t.selected=!0,e.items.filter(function(e){return e.selected})},e.onDrop=function(e,t,s){return angular.forEach(t,function(e){e.selected=!1}),e.items=e.items.slice(0,s).concat(t).concat(e.items.slice(s)),!0},e.onMoved=function(e){e.items=e.items.filter(function(e){return!e.selected})},e.refresh()}function t(e,t,s,r,o,n,a,c,i){e.categ={repeatSelect:null,availableOptions:[]},e.categories=[],e.prodBundleCategories=[],e.itemArray=[],e.selectedCategory=[],e.store={},e.applicationStatus="",e.getAllCategory=function(){async.waterfall([function(t){c.getAllCategory().then(function(s){200==s.statusCode&&s.response.success?(e.categ.availableOptions=s.response.result,e.categories=angular.copy(e.categ.availableOptions),t(null,e.categories)):a.error(s.response.msg,"Error")})},function(t,s){o.pb_id?i.getProductBundleCategory(o.pb_id).then(function(s){200==s.statusCode&&s.response.success&&s.response.result.length>0?(e.prodBundleCategories=s.response.result,console.log("$scope.categories:",e.categories),_.each(e.categories,function(t){var s=_.find(e.prodBundleCategories,function(e){return t.c_id===e.fk_bundle_category_id});console.log("result:;",s),s&&(t.selected=!0,t.fk_bundle_category_id=s.fk_bundle_category_id,t.fk_product_bundle_id=o.pb_id,e.selectedCategory.push(t))}),e.itemArray=angular.copy(e.categories)):200==s.statusCode&&s.response.success&&0===s.response.result.length?e.itemArray=angular.copy(t):a.error(s.response.msg,"Error")}):e.itemArray=angular.copy(t)}])},e.getAllCategory(),e.paginate=function(){$("#tblCategory").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.itemArray,function(t){t.selected=e.selectDeselectAll,e.checkStoresChanges(t)})},e.checkStoresChanges=function(t){if(t.selected){var s=_.find(e.selectedCategory,function(e){return e.c_id===t.c_id});_.isUndefined(s)&&(t.fk_bundle_category_id=t.c_id,t.fk_product_bundle_id=o.p_id,e.selectedCategory.push(t)),console.log("$scope.selectedCategory:",e.selectedCategory)}else e.selectedCategory=_.filter(e.selectedCategory,function(e){return e.c_id!==t.c_id})},e.updateStatus=function(t){e.applicationStatus=t,""===t?e.itemArray=angular.copy(e.categories):(e.itemArray.splice(0,e.itemArray.length),_.each(e.categories,function(t){_.find(e.selectedCategory,function(e){return t.c_id===e.fk_bundle_category_id})&&e.itemArray.push(t)}))},e.searchStore=function(){if(e.txtSearch){e.itemArray.splice(0,e.itemArray.length);var t=n("filter")(e.categories,e.txtSearch);e.itemArray=angular.copy(t)}},e.searchStatus=function(){""===e.txtSearch&&(e.itemArray.splice(0,e.itemArray.length),e.itemArray=angular.copy(e.categories))},e.saveproductBundleCategory=function(){var t=0;o.pb_id&&(console.log("$stateParams.pb_id:",o.pb_id),async.waterfall([function(e){i.deleteProductBundleCategory(o.pb_id).then(function(t){200==t.statusCode&&t.response.success?(console.log("Na delete"),e(null,t.response.result)):e(t.response.msg,null)})},function(s,n){_.each(e.selectedCategory,function(s){console.log("selectedCategory: ",s),i.saveProductBundleCategory(o.pb_id,{category_id:s.c_id}).then(function(o){200===o.statusCode&&o.response.success?(a.success(s.name+" - "+o.response.msg,"Success"),t++,t===e.selectedCategory.length&&r.reload()):a.error(o.response.msg,"Error")})})}]))}}angular.module("POS17").controller("productsBundleController",e).controller("productBundleCategoryCtrl",t),e.$inject=["$scope","$state","$filter","toastr","$stateParams","ngDialog","productFactory","ptypeFactory","storeFactory","priceHistoryFactory","supplierFctry","$uibModal","$timeout"],t.$inject=["$scope","$rootScope","$timeout","$state","$stateParams","$filter","toastr","categoryFactory","productFactory"]}();
!function(){"use strict";function e(e,o,l,a,t,r,n,c,i,d){console.log("productBundleUploaderModalCtrl"),console.log("$stateParams:",d.pb_id),e.item={};var s=JSON.parse(localStorageService.get("user")),u=e.uploader=new l({url:a+t+"product-bundle/"+r+"/upload-image",method:"PUT",headers:{Authorization:"Bearer "+c.getUserToken(),accesskey:s.subscriptionKey}});console.log("uploader:",u),u.filters.push({name:"imageFilter",fn:function(e,o){var l="|"+e.type.slice(e.type.lastIndexOf("/")+1)+"|";return-1!=="|jpg|png|jpeg|bmp|gif|".indexOf(l)}}),u.onBeforeUploadItem=function(e){e.alias="pb_image"},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("productBundleUploaderModalCtrl",e),e.$inject=["$scope","$uibModalInstance","FileUploader","API_URL","API_VERSION","product_bundle_id","Upload","AuthFctry","jwtHelper","$stateParams"]}();
...
!function(){"use strict";function e(e,t,r,o,s,a,c,n,i){e.categ={repeatSelect:null,availableOptions:[]},e.categories=[],e.prodCategories=[],e.itemArray=[],e.selectedCategory=[],e.store={},e.applicationStatus="",e.getAllCategory=function(){async.waterfall([function(t){n.getAllCategory().then(function(r){200==r.statusCode&&r.response.success?(e.categ.availableOptions=r.response.result,e.categories=angular.copy(e.categ.availableOptions),console.log("$scope.categories:",e.categories),t(null,e.categories)):c.error(r.response.msg,"Error")})},function(t,r){s.p_id?i.getProductsCategory(s.p_id).then(function(r){200==r.statusCode&&r.response.success&&r.response.result.length>0?(e.prodCategories=r.response.result,console.log("$scope.prodCategories:",e.prodCategories),_.each(e.categories,function(t){var r=_.find(e.prodCategories,function(e){return t.c_id===e.fk_category_id});r&&(t.selected=!0,t.fk_category_id=r.fk_category_id,t.fk_product_id=s.p_id,e.selectedCategory.push(t))}),e.itemArray=angular.copy(e.categories)):200==r.statusCode&&r.response.success&&0===r.response.result.length?e.itemArray=angular.copy(t):c.error(r.response.msg,"Error")}):e.itemArray=angular.copy(t)}])},e.getAllCategory(),e.paginate=function(){$("#tblCategory").trigger("footable_redraw")},e.changeSelectDeselectAll=function(){_.each(e.itemArray,function(t){t.selected=e.selectDeselectAll,e.checkStoresChanges(t)})},e.checkStoresChanges=function(t){if(t.selected){var r=_.find(e.selectedCategory,function(e){return e.c_id===t.c_id});_.isUndefined(r)&&(t.fk_category_id=t.c_id,t.fk_product_id=s.p_id,e.selectedCategory.push(t))}else e.selectedCategory=_.filter(e.selectedCategory,function(e){return e.c_id!==t.c_id})},e.updateStatus=function(t){e.applicationStatus=t,""===t?e.itemArray=angular.copy(e.categories):(e.itemArray.splice(0,e.itemArray.length),_.each(e.categories,function(t){_.find(e.selectedCategory,function(e){return t.c_id===e.fk_category_id})&&e.itemArray.push(t)}))},e.searchStore=function(){if(e.txtSearch){e.itemArray.splice(0,e.itemArray.length);var t=a("filter")(e.categories,e.txtSearch);e.itemArray=angular.copy(t)}},e.searchStatus=function(){""===e.txtSearch&&(e.itemArray.splice(0,e.itemArray.length),e.itemArray=angular.copy(e.categories))},e.saveCategory=function(){var t=0;s.p_id&&async.waterfall([function(e){i.deleteProductCategory(s.p_id).then(function(t){200==t.statusCode&&t.response.success?e(null,t.response.result):e(t.response.msg,null)})},function(r,a){_.each(e.selectedCategory,function(r){console.log("selectedCategory: ",r),i.saveProductsCategory(s.p_id,{category_id:r.c_id}).then(function(s){200===s.statusCode&&s.response.success?(c.success(r.name+" - "+s.response.msg,"Success"),t++,t===e.selectedCategory.length&&o.reload()):c.error(s.response.msg,"Error")})})}])}}angular.module("POS17").controller("productCategoryCtrl",e),e.$inject=["$scope","$rootScope","$timeout","$state","$stateParams","$filter","toastr","categoryFactory","productFactory"]}();
...
!function(){"use strict";function t(t,e,r,c,o,s,i,n,a){function u(){n.getAllCategory().then(function(e){if(200==e.statusCode&&e.response.success){for(var r=e.response.result,c=0;c<r.length;c++){var o=r[c],s=o.name,i=o.parent_id,n=o.c_id;p[i]?(o={parentid:i,label:s,item:o},null!=o&&(p[i].items||(p[i].items=[]),p[i].items[p[i].items.length]=o,p[n]=o)):(p[n]={parentid:i,label:s,item:o},d[n]=p[n])}t.categoryData=_(d).omit(_.isUndefined).omit(_.isNull).value(),t.categorycopy=angular.copy(t.categoryData)}})}console.log("productsController"),t.search={},t.currentPage=1,t.entryLimit=5,t.selectDeselectAll=!1,t.applicationStatus="All",t.displayModel="List",t.viewby=25,t.pageSize=t.viewby,t.currentPage=1,t.itemsPerPage=20,t.totalUsers=0,t.categories=[];var d=[],p=[];t.side=!1;var l=function(){t.productIsLoading=!0,t.products=[],t.productscopy=[],t.productTable=new a({page:1,count:20},{counts:[20,45,60,100],getData:function(e,c){i.getAllProduct().then(function(o){if(200==o.statusCode&&o.response.success){var i=o.response.result;t.totalItems=i.length,t.productscopy=angular.copy(o.response.result),t.txtSearch&&"All"==t.applicationStatus&&t.currentNode?(t.products=r("filter")(i,t.txtSearch),t.products=f()):t.txtSearch&&"Publish"==t.applicationStatus&&t.currentNode?(t.products=r("filter")(i,{is_published:1}),t.products=r("filter")(t.products,t.txtSearch),t.products=f()):t.txtSearch&&"Archived"==t.applicationStatus&&t.currentNode?(t.products=r("filter")(i,{is_archived:1}),t.products=r("filter")(t.products,t.txtSearch),t.products=f()):t.txtSearch&&"Draft"==t.applicationStatus&&t.currentNode?(t.products=r("filter")(i,{is_published:0}),t.products=r("filter")(t.products,t.txtSearch),t.products=f()):_.isUndefined(t.txtSearch)&&"All"==t.applicationStatus?t.products=i:_.isUndefined(t.txtSearch)&&"Publish"==t.applicationStatus?t.products=r("filter")(i,{is_published:1}):_.isUndefined(t.txtSearch)&&"Archived"==t.applicationStatus?t.products=r("filter")(i,{is_archived:1}):_.isUndefined(t.txtSearch)&&"Draft"==t.applicationStatus?t.products=r("filter")(i,{is_published:0}):_.isUndefined(t.txtSearch)&&_.isUndefined("All"==t.applicationStatus)&&t.currentNode?t.products=f():_.isUndefined(t.txtSearch)&&_.isUndefined("Publish"==t.applicationStatus)&&t.currentNode?t.products=f():_.isUndefined(t.txtSearch)&&_.isUndefined("Archived"==t.applicationStatus)&&t.currentNode?t.products=f():_.isUndefined(t.txtSearch)&&_.isUndefined("Draft"==t.applicationStatus)&&t.currentNode?t.products=f():t.products=i,c.total(t.products.length);var n=t.products.slice((c.page()-1)*c.count(),c.page()*c.count());e.resolve(n),t.productIsLoading=!1}else t.productIsLoading=!1,s.error(o.response.msg,"Error")})}})},f=function(){t.get=[],t.$watch("mytree.currentNode",function(e,r){var c=[],o={},s={};t.category=[],t.tree=[],t.currentNode=[];var i=[];if(t.mytree&&angular.isObject(t.mytree.currentNode)){t.currentNode=t.mytree.currentNode.item,console.log("$scope.productscopy:",t.productscopy),console.log("$scope.categorycopy:",t.categorycopy);var n=_.find(t.categorycopy,{parentid:t.currentNode.c_id});if(console.log("sample2:",n),_.isUndefined(n)){var a=_.map(t.productscopy,function(e){var r=_.filter(e.product_category,{category_id:t.currentNode.c_id});return r.length>0?_.find(r,function(t){return t}):void 0});console.log("product_categories:",a),s=_.filter(a,function(t){return _.isUndefined(t)?void 0:t}),console.log("product_categories2:",s),o=_.map(_.uniqBy(s,"product_id"),function(t){return t.product_id}),_.forEach(o,function(e){c.push(_.find(t.productscopy,{p_id:e}))})}else{var u=_.map(n.items,function(t){return{c_id:t.item.c_id}});_.each(t.productscopy,function(t){_.each(u,function(e){var r=_.filter(t.product_category,{category_id:e.c_id});r&&r.length>0&&i.push(r[0])})});var d=_.map(_.uniqBy(i,"product_id"),function(t){return t.product_id});_.forEach(d,function(e){c.push(_.find(t.productscopy,{p_id:e}))})}return c}},!1)};u(),f(),l(),n.getAllCategory().then(function(e){200==e.statusCode&&e.response.success&&(t.categories=e.response.result)}),t.setPage=function(e){t.currentPage=e},t.setItemsPerPage=function(e){t.itemsPerPage=e,t.currentPage=1},t.edit=function(t){c.go("main.products-add",{p_id:t})},t.searchData=function(){t.productTable.reload()},t.refresh=function(){t.productIsLoading=!0,t.productTable.reload()},t.updateStatus=function(e){t.applicationStatus=e,t.productTable.reload()},t.changeSelectDeselectAll=function(){t.selectDeselectAll=!t.selectDeselectAll,_.each(t.products,function(e){e.selected=t.selectDeselectAll})},n.getAllCategory().then(function(e){200==e.statusCode&&e.response.success&&(t.categories=e.response.result)})}angular.module("POS17").controller("productsController",t),t.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","categoryFactory","ngTableParams"]}();
...
!function(){"use strict";function s(s,e,t,r,o,n,i,u){s.details={},r.store_id&&u.getStoreDetails(r.store_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)}),s.saveStore=function(){r.store_id?u.updateStore(r.store_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)i.success(s.response.msg,"Success"),o(function(){n.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void i.error(s.response.msg,"Error");_.each(s.response.result,function(s){i.warning(s.msg,"Warning")})}}):u.saveStore(s.details).then(function(s){if(console.log("data:",s),200==s.statusCode&&s.response.success)i.success(s.response.msg,"Success"),o(function(){n.go("main.settings-stores-add",{store_id:s.response.result},{reload:!0})},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void i.error(s.response.msg,"Error");_.each(s.response.result,function(s){i.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("storesDetailController",s),s.$inject=["$scope","$http","$filter","$stateParams","$timeout","$state","toastr","storeFactory"]}();
...
!function(){"use strict";function s(s,e,n,t,r,o,a){s.details={},n.bk_id&&a.getBankDetails(n.bk_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result)}),s.saveBank=function(){n.bk_id?a.updateBank(n.bk_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)r(function(){o.success("Successfully Update","Success"),t.reload()},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void o.error(s.response.msg,"Error");_.each(s.response.result,function(s){o.warning(s.msg,"Warning")})}}):a.saveBank(s.details).then(function(s){if(console.log("data:",s),200==s.statusCode&&s.response.success)r(function(){o.success("Successfully Added","Success"),t.go("main.settings-banks-add",{bk_id:s.response.result},{reload:!0})},300);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void o.error(s.response.msg,"Error");_.each(s.response.result,function(s){o.warning(s.msg,"Warning")})}})}}angular.module("POS17").controller("bankDetailsController",s),s.$inject=["$scope","$http","$stateParams","$state","$timeout","toastr","bankFctry"]}();
...
!function(){"use strict";function e(e,s,t,r,n,a,o,c){function i(){r.getAllCategory().then(function(s){if(200==s.statusCode&&s.response.success){for(var t=s.response.result,r=0;r<t.length;r++){var n=t[r],a=n.name,o=n.parent_id,c=n.c_id;l[o]?(n={parentid:o,label:a,item:n},null!=n&&(l[o].items||(l[o].items=[]),l[o].items[l[o].items.length]=n,l[c]=n)):(l[c]={parentid:o,label:a,item:n},u[c]=l[c])}e.categoryData=_(u).omit(_.isUndefined).omit(_.isNull).value(),console.log("categoryData: ",e.categoryData)}})}e.details={},e.newImage=!1;var u=[],l=[];t.c_id&&r.getCategoryDetails(t.c_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result)}),i(),e.toplevelCategory=function(){e.TPchecked?e.mytree.currentNode={}:i()},e.changeItem=function(s){e.selectedItem=s},e.removethumb=function(){e.details.c_image=null,e.newImage=!1},e.upload=function(s){e.newImage=!0},e.saveCategory=function(){e.mytree&&angular.isObject(e.mytree.currentNode)&&!_.isEmpty(e.mytree.currentNode)?(console.log("$scope.mytree.currentNode: ",e.mytree.currentNode),e.details.parent_id=e.mytree.currentNode.item.c_id):e.details.parent_id=null,async.waterfall([function(n){t.c_id?r.updateCategory(t.c_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)c.success(e.response.msg,"Success"),n(null,t.c_id),s.go(s.current,{c_id:t.c_id},{reload:!0});else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void c.error(e.response.msg,"Error");_.each(e.response.result,function(e){c.warning(e.msg,"Warning")})}}):r.saveCategory(e.details).then(function(e){if(200==e.statusCode&&e.response.success)console.log("SUCCESS"),c.success(e.response.msg,"Success"),n(null,e.response.result),s.go("main.settings-categories-add",{c_id:e.response.result},{reload:!0});else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void c.error(e.response.msg,"Error");_.each(e.response.result,function(e){c.warning(e.msg,"Warning")})}})},function(t,r){e.newImage&&e.details.c_image&&n.upload({url:a+o+"categories/"+t+"/upload-image",data:{c_image:e.details.c_image},method:"PUT"}).then(function(e){if(200===e.data.statusCode&&e.data.response.success)c.success("Image successfully uploaded","Success"),s.go(s.current,{c_id:t},{reload:!0});else{if(400!==e.data.statusCode||e.data.response.success||!_.isArray(e.data.response.result))return void c.error(e.data.response.msg,"Error");_.each(e.data.response.result,function(e){c.warning(e.msg,"Warning")})}},function(e){console.log("Error status: "+e.status)},function(e){parseInt(100*e.loaded/e.total)})}])}}angular.module("POS17").controller("categoryDetailsController",e),e.$inject=["$scope","$state","$stateParams","categoryFactory","Upload","API_URL","API_VERSION","toastr"]}();
...
!function(){"use strict";function s(s,e,n,o,t,r,a,u,i){console.log("$stateParams:",n.person_id),s.stores=[],s.persons=[],s.details={},s.newImage=!1,o.getPersonType().then(function(e){200==e.statusCode&&e.response.success&&(s.persons=e.response.result,console.log("$scope.persons:",s.persons))}),async.waterfall([function(s){t.getAllStore().then(function(e){200==e.statusCode&&e.response.success&&s(null,e.response.result)})},function(s,e){o.getTimeZone().then(function(n){200==n.statusCode&&n.response.success&&e(null,s,n.response.result)})},function(e,t,r){s.stores=e,s.timezone=t,n.person_id&&o.getAllPersonDetail(n.person_id).then(function(e){200==e.statusCode&&e.response.success&&(s.details=e.response.result,console.log("$scope.details:",s.details),s.details.isActive=1==s.details.isActive,s.details.person_img=s.details.image)})}]),s.removethumb=function(){s.details.person_img=null,s.newImage=!1},s.upload=function(e){s.newImage=!0},s.savePersonel=function(){async.waterfall([function(e){n.person_id?o.updatePersonel(n.person_id,s.details).then(function(s){if(200==s.statusCode&&s.response.success)i.success(s.response.msg,"Success"),e(null,n.person_id);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void i.error(s.response.msg,"Error");_.each(s.response.result,function(s){i.warning(s.msg,"Warning")})}}):o.savePersonel(s.details).then(function(s){if(200==s.statusCode&&s.response.success)i.success(s.response.msg,"Success"),e(null,s.response.result);else{if(400!==s.statusCode||s.response.success||!_.isArray(s.response.result))return void i.error(s.response.msg,"Error");_.each(s.response.result,function(s){i.warning(s.msg,"Warning")})}})},function(e,n){s.newImage&&s.details.image&&r.upload({url:a+u+"persons/"+e+"/upload-image",data:{person_img:s.details.image},method:"PUT"}).then(function(s){if(200===s.data.statusCode&&s.data.response.success)i.success("Image successfully uploaded","Success");else{if(400!==s.data.statusCode||s.data.response.success||!_.isArray(s.data.response.result))return void i.error(s.data.response.msg,"Error");_.each(s.data.response.result,function(s){i.warning(s.msg,"Warning")})}},function(s){console.log("Error status: "+s.status)},function(s){parseInt(100*s.loaded/s.total)})}])}}angular.module("POS17").controller("personDetailController",s),s.$inject=["$scope","$state","$stateParams","humanFactory","storeFactory","Upload","API_URL","API_VERSION","toastr"]}();
...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(l,t){t.state("main.articles",{url:"/articles/overview",templateUrl:"modules/articles/articles.html",controller:"articleController"}).state("main.articles-detail",{url:"/articles/:article_id",templateUrl:"modules/articles/article.detail.html",controller:"articleDetailController"})}])}();

...
!function(){"use strict";function e(e,s,o,t,r,n,c,l,a,u){e.selectDeselectAll=!1,e.selectedDatas=[];var i=function(){e.groups=[],e.groupscopy=[],e.attributeGroupTable=new u({page:1,count:10},{counts:[10,25,50,100],getData:function(s,o){c.getCustomerGroup().then(function(r){if(200==r.statusCode&&r.response.success){var n=r.response.result;e.groupscopy=angular.copy(r.response.result),e.txtSearch?e.groups=t("filter")(n,e.txtSearch):e.groups=n,o.total(e.groups.length);var c=e.groups.slice((o.page()-1)*o.count(),o.page()*o.count());s.resolve(c),e.personisLoading=!1}else e.personisLoading=!1,l.error(r.response.msg,"Error")})}})};i(),e.refresh=function(){e.attributeGroupTable.reload()},e.searchData=function(){e.attributeGroupTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.groups,function(s){s.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(s)})},e.addGroups=function(s){var t=o.open({animation:!0,templateUrl:"./modules/humanresource/customer.groups.modal.html",controller:"customerGroupModalController",size:"md",resolve:{selected:function(){return s}}});t.result.then(function(s){e.selected=s},function(){console.info("Modal dismissed at: "+new Date)})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.cg_id===s.cg_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.cg_id!==s.cg_id}),e.deleteSomeData=e.selectedDatas.length>0},e.toggleModal=function(s){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){c.deleteCustomerGroup(s).then(function(e){return 200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),void r.reload()):void l.error(e.response.msg,"Error")})},function(e){console.log("Modal promise close: ")})},e.deleteSelected=function(){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var s=0;async.each(e.selectedDatas,function(o,t){o.selected&&(console.log("group: ",o),c.deleteCustomerGroup(o.cg_id).then(function(o){return console.log("data: ",o.response),200==o.statusCode&&o.response.success?(l.success(o.response.msg,"Success"),++s,s==e.selectedDatas.length&&r.reload(),t(),void 0):void l.error(o.response.msg,"Error")}))})})}}function s(e,s,o,t,r,n,c,l){console.log("selected:",n),e.details=n,e.stores=[],l.getAllStore().then(function(s){console.log("data:",s),200==s.statusCode&&s.response.success&&(e.stores=s.response.result,console.log("data:",s.response.result))}),e.saveGroup=function(){n?c.updateCustomerGroup(n.cg_id,e.details).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),o.dismiss("cancel"),s.reload(),void 0):400===e.statusCode&&!e.response.success&&_.isArray(e.response.result)?void _.each(e.response.result,function(e){r.warning(e.msg,"Warning")}):void r.error(e.response.msg,"Error")}):c.saveCustomerGroup(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),o.dismiss("cancel"),s.reload(),void 0):400===e.statusCode&&!e.response.success&&_.isArray(e.response.result)?void _.each(e.response.result,function(e){r.warning(e.msg,"Warning")}):void r.error(e.response.msg,"Error")})},e.cancel=function(){o.dismiss("cancel")}}angular.module("POS17").controller("customerGroupController",e).controller("customerGroupModalController",s),e.$inject=["$scope","$rootScope","$uibModal","$filter","$state","ngDialog","humanFactory","toastr","$timeout","ngTableParams"],s.$inject=["$scope","$state","$uibModalInstance","$timeout","toastr","selected","humanFactory","storeFactory"]}();
...
!function(){"use strict";function e(e,s,t,o,r,c,i,n,a){var u=o.getCurrentUser(),d=JSON.parse(u);e.details={},e.details.isActive=1,e.details.created_by=d.person_id,e.details.start_date=new Date,e.details.end_date=new Date,e.displayTab=!1,e.item={},e.txtProductSearch="",e.products=[],e.productscopy=[],e.selectDeselectAll=!1,e.selectedDatas=[],e.pricebookItems=[],s.getAllProduct().then(function(s){if(200==s.statusCode&&s.response.success){var t=s.response.result;_.each(t,function(s){s.selected=!1,1==s.is_published&&e.products.push(s)}),e.productscopy=angular.copy(e.products)}}),t.getPricebookType().then(function(s){e.pricebooktype=[],200==s.statusCode&&s.response.success&&(e.pricebooktype=s.response.result)}),i.pricebook_id&&(e.displayTab=!0,t.getPricebookDetail(i.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result)}),t.getAllPriceBookItem(i.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.pricebookItems=s.response.result)})),e.refreshData=function(){async.waterfall([function(t){s.getAllProduct().then(function(s){if(e.products=[],e.productscopy=[],200==s.statusCode&&s.response.success){var o=s.response.result;_.each(o,function(s){s.selected=!1,1==s.is_published&&e.products.push(s)}),e.productscopy=angular.copy(e.products),t(null,!0)}})},function(s,o){i.pricebook_id&&(t.getPricebookDetail(i.pricebook_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result)}),t.getAllPriceBookItem(i.pricebook_id).then(function(s){e.pricebookItems=[],200==s.statusCode&&s.response.success&&(e.pricebookItems=s.response.result,_.each(e.products,function(s){var t=_.find(e.pricebookItems,{product_id:s.p_id});t&&(s.margin=t.markup||0,s.discount=t.discount||0,s.sellprice=t.sell_price||0,s.min_quantity=t.min_quantity||0,s.max_quantity=t.max_quantity||0,s.pi_id=t.pi_id)}))}))}])},e.settings={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.settings1={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.searchProductData=function(s){console.log("txtProductSearch: ",s),s&&(e.products=n("filter")(e.productscopy,s))},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.products,function(s){s.selected=e.selectDeselectAll,e.checkDataChanges(s)})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.p_id===s.p_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.p_id!==s.p_id})},e.deleteSelected=function(){e.modal={title:"Remove Product Pricebook?",message:"Are you sure to remove pricebook for this selected product?"},a.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){if(!(e.selectedDatas.length>0))return void r.error("Please select products to map","Error");if(i.pricebook_id){var s=1;async.eachSeries(e.selectedDatas,function(o,n){o.pi_id&&t.deletePriceBookItem(i.pricebook_id,o.pi_id).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),s++,n(),void 0):void r.error(e.response.msg,"Error")}),s==e.selectedDatas.length&&c.reload()})}})},e.savePricebook=function(){i.pricebook_id?t.updatePriceBook(i.pricebook_id,e.details).then(function(e){return console.log("data:",e),200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),void c.go(c.current,{pricebook_id:i.pricebook_id},{reload:!0})):void r.error(e.response.msg,"Error")}):t.savePricebook(e.details).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("data:",e),r.success(e.response.msg,"Success"),c.go(c.current,{pricebook_id:e.response.result},{reload:!0}),void 0):void r.error(e.response.msg,"Error")})},e.savePricebookItems=function(s){if(console.log("item: ",s),_.isEmpty(s))return void r.error("Please set values for Selling Price, Margin and Discount","Error");if(!(e.selectedDatas.length>0))return void r.error("Please select products to map","Error");if(i.pricebook_id){var o=1;async.eachSeries(e.selectedDatas,function(n,a){console.log("$scope.row: ",n);var u={markup:s.margin||0,discount:s.discount||0,sell_price:s.sell_price||0,bundle_id:null,product_id:n.p_id,min_quantity:0,max_quantity:0};n.pi_id?t.updatePriceBookItem(i.pricebook_id,n.pi_id,u).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),o++,a(),void 0):void r.error(e.response.msg,"Error")}):t.savePriceBookItem(i.pricebook_id,u).then(function(e){return 200==e.statusCode&&e.response.success?(r.success(e.response.msg,"Success"),o++,a(),void 0):void r.error(e.response.msg,"Error")}),o==e.selectedDatas.length&&c.reload()})}},e.example8model=[],e.example8data=[{id:1,label:"Accessories"},{id:2,label:"Headset"},{id:3,label:"Mobile Headset"},{id:4,label:"Wearables"}]}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","productFactory","pricebookFactory","AuthFctry","toastr","$state","$stateParams","$filter","ngDialog"]}();

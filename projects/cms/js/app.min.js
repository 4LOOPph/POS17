...
!function(){"use strict";function t(t,e,r,s,u,n,a,i,o,l){t.attributes=[],t.attribute_values=[],t.getAllProductAttributes=function(){async.waterfall([function(e){o.getAttributeMapping(t.details.ptype_id).then(function(t){if(200==t.statusCode&&t.response.success){var r=t.response.result;e(null,r)}else s.error(t.response.msg,"Error")})},function(t,e){a.getProductAttributes(n.p_id).then(function(r){if(200==r.statusCode&&r.response.success){var u=r.response.result;e(null,t,u)}else s.error(r.response.msg,"Error")})},function(t,e,r){l.getAllCategory().then(function(u){if(200==u.statusCode&&u.response.success){var n=u.response.result;r(null,t,e,n)}else s.error(u.response.msg,"Error")})},function(t,e,r,u){a.getProductsCategory(n.p_id).then(function(n){if(200==n.statusCode&&n.response.success){var a=n.response.result,i=[];_.each(r,function(t){var e=_.find(a,function(e){return t.c_id===e.fk_category_id});e&&i.push(t)}),u(null,t,e,i)}else s.error(n.response.msg,"Error")})},function(e,r,s,u){var n=[];if(_.each(e,function(t){var e=_.filter(s,{c_id:t.fk_c_id});e&&e.length>0&&n.push(t)}),n&&n.length>0){console.log("mapping");var a=_.map(n,function(t){return t.attributes});_.each(a,function(t){var e=_.find(r.attribute_values,{att_id:t.att_id});e&&(t.value=e.value,t.attribute_list_value=e.attribute_list_value)}),t.attributes=a}else{var a=_.map(e,function(t){return t.attributes});console.log("new_attributes: ",a),_.each(a,function(t){var e=_.find(r.attribute_values,{att_id:t.att_id}),s=_.find(r.attribute_value_list,{att_id:t.att_id});e&&(t.value=e.value),s&&(t.attribute_list_value=s.attribute_list)}),t.attributes=a}console.log("attributes: ",t.attributes)}])},t.getAllProductAttributes()}angular.module("POS17").controller("productAttributeCtrl",t),t.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","productFactory","attributeFactory","ptypeFactory","categoryFactory"]}();

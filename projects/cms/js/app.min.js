...
!function(){"use strict";function e(e,t,s,r,c,o,a,i,d,n){function l(){i.getAllCategory().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){var r=t.label,c=t.name,o=t.description,a=t.parent_id,i=t.c_id,d=_.filter(s,{parent_id:i.toString()});_.isNull(a)&&e.categoryData.push({parentid:a,description:o,label:r,name:c,c_id:i,item:{parentid:a,description:o,label:r,name:c,c_id:i},items:d})}),e.categoryDataCopy=angular.copy(e.categoryData)}})}e.search={},e.currentNode={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.categories=[],e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.selectedArchivedDatas=[],e.categoryData=[],e.categoryDataCopy=[],e.productsToFilter=[];e.side=!1;var u=function(){e.productTable=new d({page:1,count:20},{counts:[20,45,60,100],getData:function(t,r){e.productIsLoading=!0,e.products=[],e.productscopy=[],a.getAllProduct().then(function(c){if(200==c.statusCode&&c.response.success){var a=c.response.result;if(e.totalItems=a.length,e.productscopy=angular.copy(c.response.result),e.txtSearch&&"All"==e.applicationStatus&&e.currentNode)console.log("1"),e.products=s("filter")(a,e.txtSearch);else if(e.txtSearch&&"Publish"==e.applicationStatus&&e.currentNode)console.log("2"),e.products=s("filter")(a,{is_published:1}),e.products=s("filter")(e.products,e.txtSearch);else if(e.txtSearch&&"Archived"==e.applicationStatus&&e.currentNode)console.log("3"),e.products=s("filter")(a,{is_archived:1}),e.products=s("filter")(e.products,e.txtSearch);else if(e.txtSearch&&"Draft"==e.applicationStatus&&e.currentNode)console.log("4"),e.products=s("filter")(a,{is_published:0}),e.products=s("filter")(e.products,e.txtSearch);else if(_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus)_.isEmpty(e.currentNode)?e.products=a:_.each(e.productsToFilter,function(t){var s=_.find(a,{p_id:t.p_id});s&&e.products.push(s)});else if(_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus)if(console.log("6"),_.isEmpty(e.currentNode))e.products=s("filter")(a,{is_published:1});else{var i=s("filter")(a,{is_published:1});_.each(e.productsToFilter,function(t){var s=_.find(i,{p_id:t.p_id});s&&e.products.push(s)})}else if(_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus)if(console.log("7"),_.isEmpty(e.currentNode))e.products=s("filter")(a,{is_archived:1});else{var i=s("filter")(a,{is_archived:1});_.each(e.productsToFilter,function(t){var s=_.find(i,{p_id:t.p_id});s&&e.products.push(s)})}else if(_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus)if(console.log("8"),_.isEmpty(e.currentNode))e.products=s("filter")(a,{is_published:0});else{var i=s("filter")(a,{is_published:0});_.each(e.productsToFilter,function(t){var s=_.find(i,{p_id:t.p_id});s&&e.products.push(s)})}else e.products=a;r.total(e.products.length);var d=e.products.slice((r.page()-1)*r.count(),r.page()*r.count());t.resolve(d),e.productIsLoading=!1}else e.productIsLoading=!1,o.error(c.response.msg,"Error")})}})};e.filterByCategory=function(t){var s=[],r={},c={},o=[];if(e.currentNode=t,e.currentNode&&angular.isObject(e.currentNode)){var a=_.find(e.categoryDataCopy,{parentid:t.c_id});if(_.isUndefined(a)){var i=_.map(e.productscopy,function(t){var s=_.filter(t.product_category,{category_id:e.currentNode.c_id});return s.length>0?_.find(s,function(e){return e}):void 0});c=_.filter(i,function(e){return _.isUndefined(e)?void 0:e}),r=_.map(_.uniqBy(c,"product_id"),function(e){return e.product_id}),_.forEach(r,function(t){s.push(_.find(e.productscopy,{p_id:t}))})}else{var d=_.map(a.items,function(e){return{c_id:e.item.c_id}});_.each(e.productscopy,function(e){_.each(d,function(t){var s=_.filter(e.product_category,{category_id:t.c_id});s&&s.length>0&&o.push(s[0])})});var n=_.map(_.uniqBy(o,"product_id"),function(e){return e.product_id});_.forEach(n,function(t){s.push(_.find(e.productscopy,{p_id:t}))})}}e.productsToFilter=s,e.productTable.reload()},l(),u(),i.getAllCategory().then(function(t){200==t.statusCode&&t.response.success&&(e.categories=t.response.result)}),e.setPage=function(t){e.currentPage=t},e.setItemsPerPage=function(t){e.itemsPerPage=t,e.currentPage=1},e.edit=function(e){r.go("main.products-add",{p_id:e})},e.searchData=function(){e.productTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productTable.reload()},e.updateStatus=function(t){e.applicationStatus=t,e.productTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.products,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.p_id===t.p_id})||(e.selectedDatas.push(t),1==t.is_published&&e.selectedPublishedDatas.push(t),0==t.is_published&&e.selectedDraftedDatas.push(t),1==t.is_archived&&e.selectedArchivedDatas.push(t)):(console.log("filter"),e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.p_id!==t.p_id})),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){e.modal={title:"Archive Product?",message:"Are you sure to archive this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;async.eachSeries(e.selectedDatas,function(s,c){s.selected&&a.archiveProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),t++,c(),void 0):void o.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&r.reload()})})},e.draftSelected=function(){e.modal={title:"Draft Product?",message:"Are you sure to Draft this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedPublishedDatas.length>0?void async.eachSeries(e.selectedPublishedDatas,function(s,c){s.selected&&1==s.is_published&&a.draftProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),t++,c(),void 0):void o.error(e.response.msg,"Error")}),t==e.selectedPublishedDatas.length&&r.reload()}):void o.warning("Unable to Draft selected Products..Selected products are either archived or already drafted","Warning")})},e.publishSelected=function(t){e.modal={title:"Publish Product?",message:"Are you sure to Publish this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedDraftedDatas.length>0?void async.eachSeries(e.selectedDraftedDatas,function(s,c){s.selected&&0==s.is_published&&a.publishProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),t++,c(),void 0):void o.error(e.response.msg,"Error")}),t==e.selectedDraftedDatas.length&&r.reload()}):void o.warning("Unable to Publish selected Products..Selected products are either archived or already published","Warning")})}}angular.module("POS17").controller("productsController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","categoryFactory","ngTableParams","ngDialog"]}();
!function(){"use strict";function e(e,t,s,l,a,n,d,c,r,i){e.search={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.selectedArchivedDatas=[],e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0;var o=function(){e.productIsLoading=!0,e.bundles=[],e.bundlecopy=[],e.productBundleTable=new i({page:1,count:10},{counts:[10,25,50,100],getData:function(t,l){d.getAllProductBundle().then(function(a){if(200==a.statusCode&&a.response.success){var d=a.response.result;_.each(d,function(e){e.date_created=moment(e.date_created).format("YYYY-MM-DD")}),e.bundlecopy=angular.copy(d),e.txtSearch&&"All"==e.applicationStatus?e.bundles=s("filter")(d,e.txtSearch):e.txtSearch&&"Publish"==e.applicationStatus?(e.bundles=s("filter")(d,{is_published:1}),e.bundles=s("filter")(e.bundles,e.txtSearch)):e.txtSearch&&"Archived"==e.applicationStatus?(e.bundles=s("filter")(d,{is_archived:1}),e.bundles=s("filter")(e.bundles,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus?(e.bundles=s("filter")(d,{is_published:0}),e.bundles=s("filter")(e.bundles,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?e.bundles=d:_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus?e.bundles=s("filter")(d,{is_published:1}):_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus?e.bundles=s("filter")(d,{is_archived:1}):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?e.bundles=s("filter")(d,{is_published:0}):e.bundles=d,console.log("bundles:",e.bundles),l.total(e.bundles.length);var c=e.bundles.slice((l.page()-1)*l.count(),l.page()*l.count());t.resolve(c),e.productIsLoading=!1}else e.productIsLoading=!1,n.error(a.response.msg,"Error")})}})};e.edit=function(e){l.go("main.products-add",{p_id:e})},e.searchData=function(){e.productBundleTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productBundleTable.reload()},e.updateStatus=function(t){console.log("status: ",t),e.applicationStatus=t,e.productBundleTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.bundles,function(t){t.selected=e.selectDeselectAll,e.selectSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){console.log(t),t.selected?_.find(e.selectedDatas,function(e){return e.pb_id===t.pb_id})||(e.selectedDatas.push(t),1==t.is_published&&e.selectedPublishedDatas.push(t),0==t.is_published&&e.selectedDraftedDatas.push(t),1==t.is_archived&&e.selectedArchivedDatas.push(t)):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pb_id!==t.pb_id}),e.deleteSomeData=e.selectedDatas.length>0},e.archiveSelected=function(){r.openConfirm({templateUrl:"modules/dialog/confirmDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedArchivedDatas.length>0?void async.each(e.selectedArchivedDatas,function(s,a){s.selected&&0==s.is_archived&&d.archiveBundle(s.pb_id).then(function(e){return console.log("data: ",e.response),200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),t++,a(),void 0):void n.error(e.response.msg,"Error")}),t==e.selectedArchivedDatas.length&&l.reload()}):void n.warning("Unable to Archive selected Bundle..Selected bundle are either archived","Warning")})},e.draftSelected=function(){e.modal={title:"Draft Product?",message:"Are you sure to Draft this selected bundle?"},r.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedPublishedDatas.length>0?void async.eachSeries(e.selectedPublishedDatas,function(s,a){s.selected&&1==s.is_published&&d.draftBundle(s.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),t++,a(),void 0):void n.error(e.response.msg,"Error")}),t==e.selectedPublishedDatas.length&&l.reload()}):void n.warning("Unable to Draft selected Bundle..Selected bundle are either archived or already drafted","Warning")})},e.publishSelected=function(t){e.modal={title:"Publish Product?",message:"Are you sure to Publish this selected bundle?"},r.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedDraftedDatas.length>0?void async.eachSeries(e.selectedDraftedDatas,function(s,a){s.selected&&0==s.is_published&&d.publishBundle(s.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),t++,a(),void 0):void n.error(e.response.msg,"Error")}),t==e.selectedDraftedDatas.length&&l.reload()}):void n.warning("Unable to Publish selected Bundle..Selected bundle are either archived or already published","Warning")})},o()}angular.module("POS17").controller("productBundlesController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","supplierFctry","ngDialog","ngTableParams"]}();

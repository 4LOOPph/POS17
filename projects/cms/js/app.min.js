...
!function(){"use strict";function e(e,s,t,o,r,n,i,a,d,c,l,u,p,g){e.details={},e.ptypes={},e["package"]={},e.items={},e.list1=[],e.list2=[],e.productCopy=[],e.attributes=[],e.product_image=[],e.tags=[],e.tagsArr=[],e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.add=!1,e.displayComposite=!1,e.displayImage=!1,e.image=[],e.txtSearch="",e.myInterval=3e3,e.noWrapSlides=!1,e.activeSlide=0,e.thumbnailSize=5,e.thumbnailPage=1,e.slides=[];var m=function(){i.getAllProduct().then(function(s){200==s.statusCode&&s.response.success&&(e.list1=s.response.result,e.productCopy=angular.copy(s.response.result),_.each(e.list1,function(e){e.selected=!1})),e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]})};e.refresh=function(){m()},e.searchData=function(s){e.list1=t("filter")(e.productCopy,s)},a.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?e.ptypes=s.response.result:o.error(s.response.msg,"Error")}),u.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:o.error(s.response.msg,"Error")}),_.isEmpty(r.pb_id)?(e.showPublish=!1,e.showArchive=!1):(e.displayComposite=!0,e.displayImage=!0,i.getProductBundleDetails(r.pb_id).then(function(s){if(200==s.statusCode&&s.response.success){var t=0;e.details=s.response.result,e.items=s.response.result,e.product_image=e.details.product_images,_.each(e.product_image,function(s){e.slides.push({image:s.image_path,index:t}),t++}),console.log("$scope.product_image: ",e.product_image),console.log("$scope.slides: ",e.slides),e.list2=_.map(e.details.products,function(e){return e.product_detail}),e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),u.getAllProductBundleTags(r.pb_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)})}})),e.$watch("list2",function(s){e.list2=s,e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]},!0),e.$watch("list1",function(s){e.list1=s,e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]},!0),e.$watch("models",function(s){e.modelAsJson=s},!0),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.deleteProductTags=function(e){console.log("deleteProductBundleTag: ",e),r.pb_id&&u.deleteProductBundleTag(r.pb_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void o.success(e.response.msg,"Success"):void o.error(e.response.msg,"Error")})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.store_id===s.store_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.store_id!==s.store_id}),e.deleteSomeData=e.selectedDatas.length>0},e.dropCallback=function(s,t,o){var r=[];_.isUndefined(e.modelAsJson)||(r=_.find(e.modelAsJson,function(e){return"Package"==e.listName}),e.items.products=_.map(r.items,function(e){return{product_id:e.p_id}}))},e.remove=function(e,s){return e.items.splice(s,1)},e.removeAll=function(e,s){_.each(e.items,function(t){return e.items.splice(s,1)})},e.openUploader=function(){var e=p.open({animation:!0,templateUrl:"./modules/products/product-bundle.upload.modal.html",controller:"productBundleUploaderModalCtrl",size:"lg",resolve:{product_bundle_id:function(){return r.pb_id}}});e.result.then(function(e){s.reload()})},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.archiveProduct=function(e){i.archiveBundle(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.publishProduct=function(e){i.publishBundle(e).then(function(e){200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):o.error(e.response.msg,"Error")})},e.onDragstart=function(e,s){if(e.dragging=!0,s.dataTransfer.setDragImage){var t=new Image;t.src="./images/cargo-128.png",s.dataTransfer.setDragImage(t,0,0)}},e.addProductBundle=function(){r.pb_id&&i.updateProductBundle(r.pb_id,e.items).then(function(e){200==e.statusCode&&e.response.success&&(o.success(e.response.msg,"Success"),s.go(s.current,{pb_id:r.pb_id},{reload:!0}))})},e.addProduct=function(){async.waterfall([function(s){r.pb_id?i.updateProductBundle(r.pb_id,e.details).then(function(t){200==t.statusCode&&t.response.success?(o.success(t.response.msg,"Success"),e.items=e.details,s(null,r.pb_id)):(e.validate=t.response.result,_.each(e.validate,function(e){o.warning(t.response.msg,"Error - "+e.msg)}))}):i.saveProductBundle(e.details).then(function(t){200==t.statusCode&&t.response.success?(e.items=e.details,o.success(t.response.msg,"Success"),s(null,t.response.result)):(e.validate=t.response.result,_.each(e.validate,function(e){o.warning(t.response.msg,"Error - "+e.msg)}))})},function(s,t){var r=0;async.eachSeries(e.details.tags,function(n,i){n.isTag?u.saveTags(n).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("saveProductGroupTags bundle_id: ",s),void u.saveProductGroupTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void i()):void o.error(e.response.msg,"Error")})):void o.error(e.response.msg,"Error")}):u.saveProductGroupTags(s,{tags_id:n.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void i()):void o.error(e.response.msg,"Error")}),r>=e.details.tags.length&&t(null,s)})},function(e,t){console.log("asdasdasdas: ",e),g(function(){s.go(s.current,{pb_id:e},{reload:!0})},1e3)}])},e.getSelectedItemsIncluding=function(e,s){return s.selected=!0,e.items.filter(function(e){return e.selected})},e.onDrop=function(e,s,t){return console.log("onDrop: ",s),console.log("onDrop list: ",e),angular.forEach(s,function(e){e.selected=!1}),e.items=e.items.slice(0,t).concat(s).concat(e.items.slice(t)),!0},e.onMoved=function(e){e.items=e.items.filter(function(e){return!e.selected})},e.deleteAllMedia=function(){n.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){r.pb_id&&i.deleteAllProductBundleImage(r.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),void s.reload()):void o.error(e.response.msg,"Error")})})},e.deleteSelected=function(t){n.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("media: ",t),r.pb_id&&i.deleteProductBundleImageFile(r.pb_id,t._id).then(function(e){return 200==e.statusCode&&e.response.success?(o.success(e.response.msg,"Success"),void s.reload()):void o.error(e.response.msg,"Error")})})},e.refresh()}angular.module("POS17").controller("productsBundleController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","ngDialog","productFactory","ptypeFactory","storeFactory","priceHistoryFactory","supplierFctry","tagsFactory","$uibModal","$timeout"]}();
...
!function(){"use strict";function e(e,s,t,o,r,n,u,a,c,i,l,d,g,p,f,m){e.persons=[],e.store=[],e.products=[],e.details={},e.details.subtotal=0,e.details.quoteproduct_list=[],e.items={},e.tags=[],e.tagsArr=[],e.addItem=function(s){e.details.quoteproduct_list.push({quantity:s.quantity,price:s.price,discount:s.discount,product_id:s.product.p_id,product_details:{item_name:s.product.item_name}}),e.calculateItems()},e.calculateItems=function(){var s=0,t=0;_.each(e.details.quoteproduct_list,function(e){var o=e.price-e.discount;s=o*e.quantity,t+=parseFloat(s)}),e.details.sub_total=t},e.removeItem=function(s){e.details.quoteproduct_list.splice(s,1),e.calculateItems()},i.getAllPerson().then(function(s){200==s.statusCode&&s.response.success?(e.persons=s.response.result,e.details.person_id=e.persons[0].person_id):o.error(s.response.msg,"Error")}),l.getAllStore().then(function(s){200==s.statusCode&&s.response.success?e.store=s.response.result:o.error(s.response.msg,"Error")}),d.getAllProduct().then(function(s){200==s.statusCode&&s.response.success?e.products=s.response.result:o.error(s.response.msg,"Error")}),n.quote_id&&p.getDetailQuote(n.quote_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,console.log(e.details)),m.getAllQuoteTags(n.quote_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result,console.log(e.details.tags))})}),m.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:o.error(s.response.msg,"Error")}),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.deleteQuoteTag=function(e){console.log("deleteProductBundleTag: ",e),n.quote_id&&m.deleteQuoteTag(n.quote_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void o.success(e.response.msg,"Success"):void o.error(e.response.msg,"Error")})},e.saveQuoteInfo=function(){console.log(e.details),async.waterfall([function(t){var r=JSON.parse(f.get("user"));e.details.staff_id=r.uc_id,console.log(e.details),n.quote_id?p.updateQuoteInfo(n.quote_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)o.success(e.response.msg,"Success"),t(null,n.quote_id),s.go(s.current,{quote_id:n.quote_id},{reload:!0});else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void o.error(e.response.msg,"Error");_.each(e.response.result,function(e){o.warning(e.msg,"Warning")})}}):p.saveQuoteInfo(e.details).then(function(e){if(200==e.statusCode&&e.response.success)o.success(e.response.msg,"Success"),t(null,e.response.result);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void o.error(e.response.msg,"Error");_.each(e.response.result,function(e){o.warning(e.msg,"Warning")})}})},function(s,t){console.log("dri bai");var r=0;e.details.tags.length>0?async.eachSeries(e.details.tags,function(n,u){n.isTag?m.saveTags(n).then(function(e){return 200==e.statusCode&&e.response.success?void m.saveQuoteTags(s,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void u()):void o.error(e.response.msg,"Error")}):void o.error(e.response.msg,"Error")}):m.saveQuoteTags(s,{tag_id:n.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(r++,void u()):void o.error(e.response.msg,"Error")}),r>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,t){r(function(){s.go(s.current,{quote_id:e},{reload:!0})},300)}])}}angular.module("POS17").controller("quotesDetailController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","ngTableParams","ngDialog","$uibModal","humanFactory","storeFactory","productFactory","categoryFactory","quoteFactory","localStorageService","tagsFactory"]}();

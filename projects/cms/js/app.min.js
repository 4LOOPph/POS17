...
!function(){"use strict";function e(e,s,n,o,t,a,l,c,i,r){console.log("asdasd"),e.details={},e.main=[],e.enable=!1,async.waterfall([function(s){l.getAllCompany().then(function(n){200==n.statusCode&&n.response.success&&(e.main=n.response.result,s(null,n.response.result),e.main=_.filter(n.response.result,function(e){return e.company_id!=r.company_id}),console.log("$scope.main:",e.main))})},function(s,n){r.company_id&&l.getCompanyInfo(r.company_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result,console.log("data.response.result:",s.response.result),n(null,s.response.result))})}]),e.enabledMainEvent=function(s){0==s&&(e.office=void 0,e.details.parent_id=0)},e.select=function(s){console.log("value:",s),e.details.parent_id=s.company_id},e.saveCompany=function(){console.log("$scope.details:",e.details),r.company_id?l.updateCompany(r.company_id,e.details).then(function(e){200==e.statusCode&&e.response.result&&(a.success(e.response.msg,"Success"),console.log("data:",e.response),o.go(o.current,{company_id:r.company_id},{reload:!0}))}):(console.log("$scope.details:",e.details),l.saveCompany(e.details).then(function(e){200==e.statusCode&&e.response.result&&(console.log("data:",e),a.success(e.response.msg,"Success"),o.go(o.current,{company_id:e.response.result},{reload:!0}))}))}}angular.module("POS17").controller("companyDetailController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","companyFactory","ngTableParams","ngDialog","$stateParams"]}();

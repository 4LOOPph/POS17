...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(t,e){e.state("main.quotes",{url:"/quotes",templateUrl:"modules/quotes/quotes.html",controller:"quotesController"}).state("main.quotes-detail",{url:"/quotes/:quote_id",templateUrl:"modules/quotes/quotes.detail.html",controller:"quotesDetailController"})}])}();
...
!function(){"use strict";function e(e,s,t,r,o,n,u,a,c,i,l,d,p,g,f,m){e.persons=[],e.store=[],e.products=[],e.details={},e.details.subtotal=0,e.details.quoteproduct_list=[],e.items={},e.tags=[],e.tagsArr=[],e.addItem=function(s){e.details.quoteproduct_list.push({quantity:s.quantity,price:s.price,discount:s.discount,product_id:s.product.p_id,product_details:{item_name:s.product.item_name}}),e.calculateItems()},e.calculateItems=function(){var s=0,t=0;_.each(e.details.quoteproduct_list,function(e){var r=e.price-e.discount;s=r*e.quantity,t+=parseFloat(s)}),e.details.sub_total=t},e.removeItem=function(s){e.details.quoteproduct_list.splice(s,1),e.calculateItems()},i.getAllPerson().then(function(s){200==s.statusCode&&s.response.success?(e.persons=s.response.result,e.details.person_id=e.persons[0].person_id):r.error(s.response.msg,"Error")}),l.getAllStore().then(function(s){200==s.statusCode&&s.response.success?e.store=s.response.result:r.error(s.response.msg,"Error")}),d.getAllProduct().then(function(s){200==s.statusCode&&s.response.success?e.products=s.response.result:r.error(s.response.msg,"Error")}),n.quote_id&&g.getDetailQuote(n.quote_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result),m.getAllQuoteTags(n.quote_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)})}),m.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:r.error(s.response.msg,"Error")}),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.deleteQuoteTag=function(e){n.quote_id&&m.deleteQuoteTag(n.quote_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void r.success(e.response.msg,"Success"):void r.error(e.response.msg,"Error")})},e.saveQuoteInfo=function(){async.waterfall([function(t){var o=JSON.parse(f.get("user"));e.details.staff_id=o.uc_id,n.quote_id?g.updateQuoteInfo(n.quote_id,e.details).then(function(e){if(200==e.statusCode&&e.response.success)r.success(e.response.msg,"Success"),t(null,n.quote_id),s.go(s.current,{quote_id:n.quote_id},{reload:!0});else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void r.error(e.response.msg,"Error");_.each(e.response.result,function(e){r.warning(e.msg,"Warning")})}}):g.saveQuoteInfo(e.details).then(function(e){if(200==e.statusCode&&e.response.success)r.success(e.response.msg,"Success"),t(null,e.response.result);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void r.error(e.response.msg,"Error");_.each(e.response.result,function(e){r.warning(e.msg,"Warning")})}})},function(s,t){console.log("dri bai");var o=0;e.details.tags.length>0?async.eachSeries(e.details.tags,function(n,u){n.isTag?m.saveTags(n).then(function(e){return 200==e.statusCode&&e.response.success?void m.saveQuoteTags(s,{tag_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void u()):void r.error(e.response.msg,"Error")}):void r.error(e.response.msg,"Error")}):m.saveQuoteTags(s,{tag_id:n.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void u()):void r.error(e.response.msg,"Error")}),o>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,t){o(function(){s.go(s.current,{quote_id:e},{reload:!0})},300)}])}}angular.module("POS17").controller("quotesDetailController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","ngTableParams","ngDialog","$uibModal","humanFactory","storeFactory","productFactory","categoryFactory","quoteFactory","localStorageService","tagsFactory"]}();
...
!function(){"use strict";function e(e){console.log("pricebookController"),e.type="Type",e.status="All",e.updateType=function(l){e.type=l},e.updateStatus=function(l){e.status=l},e.example8model=[],e.example8data=[{id:1,label:"Telstra"},{id:2,label:"Proximity"},{id:3,label:"Christmas"},{id:4,label:"Women"}]}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope"]}();
!function(){"use strict";function e(e,t){e.details={},e.details.start_date=new Date,e.details.end_date=new Date,e.settings={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.settings1={"default":function(){var e=new Date;return e.setHours(1),e.setMinutes(2),e}},e.example8model=[],e.example8data=[{id:1,label:"Accessories"},{id:2,label:"Headset"},{id:3,label:"Mobile Headset"},{id:4,label:"Wearables"}],t.getPersonType().then(function(t){200==t.statusCode&&t.response.success&&(e.persons=t.response.result,console.log("$scope.persons:",e.persons))})}angular.module("POS17").controller("pricebookDetailController",e),e.$inject=["$scope","humanFactory"]}();

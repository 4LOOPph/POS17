...
!function(){"use strict";function e(e,s,t,o,r,n,u,c,i,a,d,l,p,m){e.persons=[],e.store=[],e.products=[],e.details={},e.details.subtotal=0,e.details.quoteproduct=[],e.items={},e.quoteproducts={items:[{qty:0,description:"",cost:0}]},e.addItem=function(s){e.details.quoteproduct.push({quantity:s.quantity,price:s.price,discount:s.discount,product_id:s.product.p_id,product_details:{item_name:s.product.item_name}}),e.calculateItems()},e.calculateItems=function(){var s=0,t=0;_.each(e.details.quoteproduct,function(e){var o=e.price-e.discount;s=o*e.quantity,t+=parseFloat(s)}),e.details.sub_total=t},e.removeItem=function(s){e.details.quoteproduct.splice(s,1),e.calculateItems()},a.getAllPerson().then(function(s){200==s.statusCode&&s.response.success?(e.persons=s.response.result,e.details.person_id=e.persons[0].person_id):o.error(s.response.msg,"Error")}),d.getAllStore().then(function(s){200==s.statusCode&&s.response.success?e.store=s.response.result:o.error(s.response.msg,"Error")}),l.getAllProduct().then(function(s){200==s.statusCode&&s.response.success?e.products=s.response.result:o.error(s.response.msg,"Error")}),n.quote_id&&m.getDetailQuote(n.quote_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details=s.response.result)}),e.saveQuoteInfo=function(){n.quote_id?m.updateQuoteInfo(n.quote_id,e.details).then(function(e){if(console.log(e),200==e.statusCode&&e.response.success)o.success(e.response.msg,"Success"),s.go(s.current,{quote_id:n.quote_id},{reload:!0});else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void o.error(e.response.msg,"Error");_.each(e.response.result,function(e){o.warning(e.msg,"Warning")})}}):m.saveQuoteInfo(e.details).then(function(e){if(200==e.statusCode&&e.response.success)o.success(e.response.msg,"Success"),r(function(){s.go("main.quotes-detail",{quote_id:e.response.result},{reload:!0})},300);else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void o.error(e.response.msg,"Error");_.each(e.response.result,function(e){o.warning(e.msg,"Warning")})}})}}angular.module("POS17").controller("quotesDetailController",e),e.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","ngTableParams","ngDialog","$uibModal","humanFactory","storeFactory","productFactory","categoryFactory","quoteFactory"]}();

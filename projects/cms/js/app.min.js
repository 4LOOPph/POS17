...
!function(){"use strict";function t(t,e,r,s,o,u,n,i,a,c){t.attributes=[],t.attribute_values=[],t.getAllProductAttributes=function(){async.waterfall([function(e){a.getAttributeMapping(t.details.ptype_id).then(function(t){if(200==t.statusCode&&t.response.success){var r=t.response.result;e(null,r)}else s.error(t.response.msg,"Error")})},function(t,e){n.getProductAttributes(u.p_id).then(function(r){if(200==r.statusCode&&r.response.success){var o=r.response.result;e(null,t,o)}else s.error(r.response.msg,"Error")})},function(t,e,r){c.getAllCategory().then(function(o){if(200==o.statusCode&&o.response.success){var u=o.response.result;r(null,t,e,u)}else s.error(o.response.msg,"Error")})},function(t,e,r,o){n.getProductsCategory(u.p_id).then(function(u){if(200==u.statusCode&&u.response.success){var n=u.response.result,i=[];_.each(r,function(t){var e=_.find(n,function(e){return t.c_id===e.fk_category_id});e&&i.push(t)}),o(null,t,e,i)}else s.error(u.response.msg,"Error")})},function(e,r,s,o){var u=[];console.log("attributesmaps: ",e),_.each(e,function(t){var e=_.filter(s,{c_id:t.fk_c_id});e&&e.length>0&&u.push(t)});var n=_.map(u,function(t){return t.attributes});_.each(n,function(t){var e=_.find(r.attributes,{att_id:t.att_id});e&&(t.value=e.value,t.attribute_list_value=e.attribute_list_value)}),t.attributes=n,console.log("attributes: ",n)}])},t.getAllProductAttributes()}angular.module("POS17").controller("productAttributeCtrl",t),t.$inject=["$scope","$state","$filter","toastr","$timeout","$stateParams","productFactory","attributeFactory","ptypeFactory","categoryFactory"]}();
...
!function(){"use strict";function t(t,e,i,a,s,r,n,l,u,p,c,d,o,f,b,y){t.productType=[],t.selectedDatas=[],t.attributeTypes=[],t.categories=[],t.articles=[],t.attribute_group=[],t.attributeMaps=[],t.attributeMapValues=[],t.selectDeselectAll=!1,t.showAttributeValues=!1,t.enableProductType=!1,t.enableGroup=!1,t.enableCategories=!1,t.enableArticles=!1,t.map={},t.details={},t.attrib_type={},t.attrib_type.attribute_list_value=[],t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable,t.details.valuelist=[],r.getAllAttributeTypes().then(function(e){if(200==e.statusCode&&e.response.success){var i=[];i=e.response.result,n(function(){t.$apply(function(){t.attributeTypes=i})},100)}}),r.getAllAttributeGroup().then(function(e){if(200==e.statusCode&&e.response.success){var i=[];i=e.response.result,n(function(){t.$apply(function(){t.attribute_group=i})},100)}}),c.getAllCategory().then(function(e){if(200==e.statusCode&&e.response.success){var i=e.response.result;n(function(){t.$apply(function(){t.categories=i})},100)}}),d.getArticle().then(function(e){if(200==e.statusCode&&e.response.success){var i=e.response.result;n(function(){t.$apply(function(){t.articles=i})},100)}}),p.getAllProdType().then(function(e){200==e.statusCode&&e.response.success&&(t.productType=e.response.result,_.each(t.productType,function(t){t.selected=!1}))}),async.waterfall([function(t){r.getAllAttributeTypes().then(function(e){200==e.statusCode&&e.response.success&&t(null,e.response.result)})},function(e,i){t.types=e,a.att_id&&r.getAllAttributeDetails(a.att_id).then(function(e){200==e.statusCode&&e.response.success&&(t.showAttributeValues=!0,t.details=e.response.result,t.details.is_visible=1==t.details.is_visible,t.details.is_search=1==t.details.is_search,t.details.is_required=1==t.details.is_required,t.details.is_variation=1==t.details.is_variation,t.details.is_customizable=1==t.details.is_customizable,t.details.is_unique=1==t.details.is_unique,t.details.is_comparable=1==t.details.is_comparable,r.getAttibuteMapping(a.att_id).then(function(e){if(200==e.statusCode&&e.response.success){var i=e.response.result;_.each(i,function(e){t.attributeMaps.push({fk_ptype_id:e.fk_ptype_id||null,fk_att_id:e.fk_att_id,fk_attgrp_id:e.fk_attgrp_id||null,fk_c_id:e.fk_c_id||null,fk_article_id:e.fk_article_id||null});var i=_.find(t.productType,{ptype_id:e.fk_ptype_id}),a=_.find(t.attribute_group,{attgrp_id:e.fk_attgrp_id}),s=_.find(t.categories,{c_id:e.fk_c_id}),r=_.find(t.articles,{article_id:e.fk_article_id});t.attributeMapValues.push({fk_ptype:_.isEmpty(i)?null:i.name,fk_attgrp:_.isEmpty(a)?null:a.name,fk_category:_.isEmpty(s)?null:s.name,fk_article:_.isEmpty(r)?null:r.title})})}}))})}]),t.$watch(function(){return t.details.attrib_type_id},function(e){t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description="";var i=_.find(t.attributeTypes,{attrib_type_id:e});t.details.attrib_type=i}),t.$watch(function(){return t.attributeTypes},function(e){t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description="";var i=_.find(e,{attrib_type_id:t.details.attrib_type_id});t.details.attrib_type=i}),t.enableProductTypeEvent=function(e){0==e&&(t.map.fk_ptype_id=void 0)},t.enableGroupEvent=function(e){0==e&&(t.map.fk_attgrp_id=void 0)},t.enableCategoriesEvent=function(e){0==e&&(t.map.fk_c_id=void 0)},t.enableArticlesEvent=function(e){0==e&&(t.map.fk_article_id=void 0)},t.changeSelectDeselectAll=function(){t.selectDeselectAll=!t.selectDeselectAll,_.each(t.productType,function(e){e.selected=t.selectDeselectAll,t.deleteSomeData=t.selectDeselectAll,t.checkDataChanges(e)})},t.checkDataChanges=function(e){e.selected?_.find(t.selectedDatas,function(t){return t.ptype_id===e.ptype_id})||t.selectedDatas.push(e):t.selectedDatas=_.filter(t.selectedDatas,function(t){return t.ptype_id!==e.ptype_id}),t.deleteSomeData=t.selectedDatas.length>0},t.removethumb=function(){t.attrib_type.value_image=null},t.addtoList=function(){a.att_id?r.saveAttributeValueList(a.att_id,{name:t.attrib_type.attrib_name,value:t.attrib_type.attrib_value,description:t.attrib_type.attrib_description,contenttype:t.attrib_type.contenttype,sku:t.attrib_type.sku}).then(function(e){if(200==e.statusCode&&e.response.success)l.success(e.response.msg,"Success"),t.clearInput(),u.reload();else{if(400!==e.statusCode||e.response.success||!_.isArray(e.response.result))return void l.error(e.response.msg,"Error");_.each(e.response.result,function(t){l.warning(t.msg,"Warning")})}}):l.warning("Please select attribute to update","Warning")},t.addtoList1=function(){a.att_id?y.upload({url:f+b+"attributes/"+a.att_id+"/valuelist",data:{name:t.attrib_type.attrib_name,value:t.attrib_type.attrib_value,description:t.attrib_type.attrib_description,contenttype:t.attrib_type.contenttype,sku:t.attrib_type.sku,value_image:t.attrib_type.value_image,_id:t.attrib_type._id,isEdit:t.attrib_type.isEdit},method:"POST"}).then(function(t){if(200===t.data.statusCode&&t.data.response.success)l.success(t.data.response.msg,"Success"),u.reload();else{if(400!==t.data.statusCode||t.data.response.success||!_.isArray(t.data.response.result))return void l.error(t.data.response.msg,"Error");_.each(t.data.response.result,function(t){l.warning(t.msg,"Warning")})}},function(t){console.log("Error status: "+t.status)}):l.warning("Please select attribute to update","Warning")},t.addtoMapping=function(e){if(_.isEmpty(e))return void l.warning("Please select some values to map attributes","Warning");var i={fk_ptype_id:null,fk_att_id:t.details.att_id,fk_attgrp_id:null,fk_c_id:null,fk_article_id:null},a={fk_ptype:null,fk_attgrp:null,fk_category:null,fk_article:null};if(_.isUndefined(e.fk_ptype_id))return void l.warning("Please select PRODUCT TYPE to map attributes","Warning");i.fk_ptype_id=e.fk_ptype_id.ptype_id,a.fk_ptype=e.fk_ptype_id.name,_.isUndefined(e.fk_attgrp_id)||(i.fk_attgrp_id=e.fk_attgrp_id.attgrp_id,a.fk_attgrp=e.fk_attgrp_id.name),_.isUndefined(e.fk_c_id)||(i.fk_c_id=e.fk_c_id.c_id,a.fk_category=e.fk_c_id.name),_.isUndefined(e.fk_article_id)||(i.fk_article_id=e.fk_article_id.article_id,a.fk_article=e.fk_article_id.title);var s=_.find(t.attributeMaps,{fk_ptype_id:i.fk_ptype_id,fk_att_id:t.details.att_id,fk_attgrp_id:i.fk_attgrp_id,fk_c_id:i.fk_c_id,fk_article_id:i.fk_article_id});return _.isEmpty(s)?(t.attributeMaps.push(i),t.attributeMapValues.push(a),t.enableProductType=!1,t.enableGroup=!1,t.enableCategories=!1,t.enableArticles=!1,t.map.fk_ptype_id=void 0,t.map.fk_attgrp_id=void 0,t.map.fk_c_id=void 0,void(t.map.fk_article_id=void 0)):void l.error("An attribute mapping already existed on the list","Warning")},t.removeFromMapping=function(e){t.attributeMaps.splice(e,1),t.attributeMapValues.splice(e,1)},t.clearMapping=function(){t.attributeMaps=[],t.attributeMapValues=[]},t.saveMapping=function(){var e=1;return t.attributeMaps.length>0?void(a.att_id&&async.waterfall([function(t){r.deleteAttributeMapping(a.att_id).then(function(e){200==e.statusCode&&e.response.success&&t(null,a.att_id)})},function(i,s){async.eachSeries(t.attributeMaps,function(i,s){r.saveAttributeMapping(a.att_id,i).then(function(t){return 200==t.statusCode&&t.response.success?(e++,void s()):void l.error(t.response.msg,"Error")}),e==t.attributeMaps.length&&(l.success("Record Successfully Saved","Success"),u.reload())})}])):void l.warning("Unable to save Attribute Mapping.. No list of mapping are available","Warning")},t.getAllAttributeMapValues=function(){t.attributeMaps=[],t.attributeMapValues=[],r.getAttibuteMapping(a.att_id).then(function(e){if(200==e.statusCode&&e.response.success){var i=e.response.result;_.each(i,function(e){t.attributeMaps.push({fk_ptype_id:e.fk_ptype_id||null,fk_att_id:e.fk_att_id,fk_attgrp_id:e.fk_attgrp_id||null,fk_c_id:e.fk_c_id||null,fk_article_id:e.fk_article_id||null});var i=_.find(t.productType,{ptype_id:e.fk_ptype_id}),a=_.find(t.attribute_group,{attgrp_id:e.fk_attgrp_id}),s=_.find(t.categories,{c_id:e.fk_c_id}),r=_.find(t.articles,{article_id:e.fk_article_id});t.attributeMapValues.push({fk_ptype:_.isEmpty(i)?null:i.name,fk_attgrp:_.isEmpty(a)?null:a.name,fk_category:_.isEmpty(s)?null:s.name,fk_article:_.isEmpty(r)?null:r.title})})}})},t.viewFromList=function(e){t.attrib_type.attrib_name=e.name,t.attrib_type.attrib_value=e.value,t.attrib_type.attrib_description=e.description,t.attrib_type.contenttype=e.contenttype,t.attrib_type.sku=e.sku,t.attrib_type.value_image=e.value_image,t.attrib_type._id=e._id,t.attrib_type.isEdit=!0},t.clearInput=function(){t.attrib_type.attrib_name="",t.attrib_type.attrib_value="",t.attrib_type.attrib_description="",t.attrib_type.contenttype="",t.attrib_type.sku="",t.attrib_type.value_image=null},t.deleteSelected=function(e){i.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:t,className:"ngdialog-theme-default"}).then(function(){r.deleteAttributeValueList(e.att_id,e._id).then(function(t){return 200==t.statusCode&&t.response.success?(l.success(t.response.msg,"Success"),void u.reload()):void l.error(t.response.msg,"Error")})})},t.saveAttribute=function(){t.details.values=t.attrib_type,async.waterfall([function(e){a.att_id?r.updateAttribute(a.att_id,t.details).then(function(t){if(200==t.statusCode&&t.response.success)n(function(){l.success("Successfully Update","Success")},300),e(null,a.att_id);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void l.error(t.response.msg,"Error");_.each(t.response.result,function(t){l.warning(t.msg,"Warning")})}}):r.saveAttribute(t.details).then(function(t){if(200==t.statusCode&&t.response.success)n(function(){l.success("Successfully Added","Success")},300),e(null,t.response.result);else{if(400!==t.statusCode||t.response.success||!_.isArray(t.response.result))return void l.error(t.response.msg,"Error");_.each(t.response.result,function(t){l.warning(t.msg,"Warning")})}})},function(t,e){u.go(u.current,{att_id:t},{reload:!0})}])}}angular.module("POS17").controller("attributeDetailsController",t),t.$inject=["$scope","$uibModal","ngDialog","$stateParams","localStorageService","attributeFactory","$timeout","toastr","$state","ptypeFactory","categoryFactory","articleFctry","AuthFctry","API_URL","API_VERSION","Upload"]}();

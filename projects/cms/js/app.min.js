...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(o,e){e.state("main.pricebook",{url:"/pricebook/overview",templateUrl:"modules/pricebook/pricebook.html"})}])}();

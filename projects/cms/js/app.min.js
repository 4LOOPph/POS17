...
!function(){"use strict";function e(e,t,s,o,c,a,r,l,i,n){function d(){l.getAllCategory().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){var o=t.name,c=t.parent_id,a=t.c_id,r=_.filter(s,{parent_id:a.toString()});_.isNull(c)&&e.categoryData.push({parentid:c,label:o,item:t,items:r})}),console.log("$scope.categoryData: ",e.categoryData)}})}e.search={},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.categories=[],e.selectedDatas=[],e.selectedPublishedDatas=[],e.selectedDraftedDatas=[],e.selectedArchivedDatas=[],e.categoryData=[];e.side=!1;var u=function(){e.productTable=new i({page:1,count:20},{counts:[20,45,60,100],getData:function(t,o){e.productIsLoading=!0,e.products=[],e.productscopy=[],r.getAllProduct().then(function(c){if(200==c.statusCode&&c.response.success){var r=c.response.result;e.totalItems=r.length,e.productscopy=angular.copy(c.response.result),e.txtSearch&&"All"==e.applicationStatus&&e.currentNode?(console.log("1"),e.products=s("filter")(r,e.txtSearch)):e.txtSearch&&"Publish"==e.applicationStatus&&e.currentNode?(console.log("2"),e.products=s("filter")(r,{is_published:1}),e.products=s("filter")(e.products,e.txtSearch)):e.txtSearch&&"Archived"==e.applicationStatus&&e.currentNode?(console.log("3"),e.products=s("filter")(r,{is_archived:1}),e.products=s("filter")(e.products,e.txtSearch)):e.txtSearch&&"Draft"==e.applicationStatus&&e.currentNode?(console.log("4"),e.products=s("filter")(r,{is_published:0}),e.products=s("filter")(e.products,e.txtSearch)):_.isUndefined(e.txtSearch)&&"All"==e.applicationStatus?(console.log("5"),e.products=r):_.isUndefined(e.txtSearch)&&"Publish"==e.applicationStatus?(console.log("6"),e.products=s("filter")(r,{is_published:1})):_.isUndefined(e.txtSearch)&&"Archived"==e.applicationStatus?(console.log("7"),e.products=s("filter")(r,{is_archived:1})):_.isUndefined(e.txtSearch)&&"Draft"==e.applicationStatus?(console.log("8"),e.products=s("filter")(r,{is_published:0})):_.isUndefined(e.txtSearch)&&_.isUndefined("All"==e.applicationStatus)&&e.currentNode?console.log("9"):_.isUndefined(e.txtSearch)&&_.isUndefined("Publish"==e.applicationStatus)&&e.currentNode?console.log("10"):_.isUndefined(e.txtSearch)&&_.isUndefined("Archived"==e.applicationStatus)&&e.currentNode?console.log("11"):_.isUndefined(e.txtSearch)&&_.isUndefined("Draft"==e.applicationStatus)&&e.currentNode?console.log("12"):e.products=r,o.total(e.products.length);var l=e.products.slice((o.page()-1)*o.count(),o.page()*o.count());t.resolve(l),e.productIsLoading=!1}else e.productIsLoading=!1,a.error(c.response.msg,"Error")})}})};e.filterByCategory=function(e){console.log("category: ",e)},d(),u(),l.getAllCategory().then(function(t){200==t.statusCode&&t.response.success&&(e.categories=t.response.result)}),e.setPage=function(t){e.currentPage=t},e.setItemsPerPage=function(t){e.itemsPerPage=t,e.currentPage=1},e.edit=function(e){o.go("main.products-add",{p_id:e})},e.searchData=function(){e.productTable.reload()},e.refresh=function(){e.productIsLoading=!0,e.productTable.reload()},e.updateStatus=function(t){e.applicationStatus=t,e.productTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.products,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.p_id===t.p_id})||(e.selectedDatas.push(t),1==t.is_published&&e.selectedPublishedDatas.push(t),0==t.is_published&&e.selectedDraftedDatas.push(t),1==t.is_archived&&e.selectedArchivedDatas.push(t)):(console.log("filter"),e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.p_id!==t.p_id})),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){e.modal={title:"Archive Product?",message:"Are you sure to archive this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;async.eachSeries(e.selectedDatas,function(s,c){s.selected&&r.archiveProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(a.success(e.response.msg,"Success"),t++,c(),void 0):void a.error(e.response.msg,"Error")}),t==e.selectedDatas.length&&o.reload()})})},e.draftSelected=function(){e.modal={title:"Draft Product?",message:"Are you sure to Draft this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedPublishedDatas.length>0?void async.eachSeries(e.selectedPublishedDatas,function(s,c){s.selected&&1==s.is_published&&r.draftProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(a.success(e.response.msg,"Success"),t++,c(),void 0):void a.error(e.response.msg,"Error")}),t==e.selectedPublishedDatas.length&&o.reload()}):void a.warning("Unable to Draft selected Products..Selected products are either archived or already drafted","Warning")})},e.publishSelected=function(t){e.modal={title:"Publish Product?",message:"Are you sure to Publish this selected products?"},n.openConfirm({templateUrl:"modules/dialog/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=1;return e.selectedDraftedDatas.length>0?void async.eachSeries(e.selectedDraftedDatas,function(s,c){s.selected&&0==s.is_published&&r.publishProduct(s.p_id).then(function(e){return 200==e.statusCode&&e.response.success?(a.success(e.response.msg,"Success"),t++,c(),void 0):void a.error(e.response.msg,"Error")}),t==e.selectedDraftedDatas.length&&o.reload()}):void a.warning("Unable to Publish selected Products..Selected products are either archived or already published","Warning")})}}angular.module("POS17").controller("productsController",e),e.$inject=["$scope","$http","$filter","$state","$timeout","toastr","productFactory","categoryFactory","ngTableParams","ngDialog"]}();

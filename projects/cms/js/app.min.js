...
!function(){"use strict";function e(e,t,o,i){e.name="Type",e.status="All",e.pricebooktype=[],t.getPricebookType().then(function(t){e.pricebooktype=[],200==t.statusCode&&t.response.success&&(e.pricebooktype=t.response.result,console.log("$scope.pricebooktype:",e.pricebooktype))}),e.example8model=[],e.example8data=[{id:1,label:"Telstra"},{id:2,label:"Proximity"},{id:3,label:"Christmas"},{id:4,label:"Women"}];var r=function(){e.pricebooks=[],e.pricebookscopy=[],e.pricebooksTable=new o({page:1,count:10},{counts:[10,25,50,100],getData:function(o,r){t.getAllPricebook().then(function(t){if(200==t.statusCode&&t.response.success){var s=t.response.result;e.pricebookscopy=angular.copy(t.response.resul),e.txtSearch&&"All"==e.status&&e.type?(e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,e.txtSearch)):e.txtSearch&&"Published"==e.status&&e.type?(e.pricebooks=i("filter")(s,{isActive:1}),e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,e.txtSearch)):e.txtSearch&&"Unpublished"==e.status&&e.type?(e.pricebooks=i("filter")(s,e.txtSearch),e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,{isActive:0})):_.isUndefined(e.txtSearch)&&"All"==e.status&&e.type?e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}):_.isUndefined(e.txtSearch)&&"Published"==e.status&&e.type.pt_id?(e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,{isActive:1})):_.isUndefined(e.txtSearch)&&"Unpublished"==e.status&&e.type?(e.pricebooks=i("filter")(s,{pricebook_type_id:e.type.pt_id}),e.pricebooks=i("filter")(s,{isActive:0})):e.pricebooks=s,r.total(e.pricebooks.length);var p=e.pricebooks.slice((r.page()-1)*r.count(),r.page()*r.count());o.resolve(p)}else toastr.error(t.response.msg,"Error")})}})};r(),e.updateStatus=function(t){e.status=t,e.pricebooksTable.reload()},e.updateType=function(t){e.type=t,e.name=t.name,e.pricebooksTable.reload()},e.searchData=function(){e.pricebooksTable.reload()}}angular.module("POS17").controller("pricebookController",e),e.$inject=["$scope","pricebookFactory","ngTableParams","$filter"]}();
...
!function(){"use strict";angular.module("POS17").config(["$urlRouterProvider","$stateProvider",function(e,o){o.state("main.pricebooktype",{url:"/pricebooktype",templateUrl:"modules/pricebook_type/pricebook_type.html",controller:"priceBookTypeController"}).state("main.pricebook_type-details",{url:"/pricebook_type/:pt_id",templateUrl:"modules/pricebook_type/pricebook_type.detail.html",controller:"priceBookTypeDetailController"})}])}();
!function(){"use strict";function e(e,t,o,s,c,a,n,l){e.selectDeselectAll=!1,e.selectedDatas=[],e.populateData=function(){e.attribisLoading=!0,e.pricebooktypes=[],e.attributecopy=[],e.priceBookTypeTable=new n({page:1,count:10},{counts:[10,25,50,100],getData:function(t,o){l.getAllPriceBookType().then(function(c){if(200==c.statusCode&&c.response.success){var a=c.response.result;if(_.each(a,function(e){e.date_created=moment(e.date_created).format("YYYY-MM-DD")}),e.attributecopy=angular.copy(a),e.txtSearch){e.pricebooktypes=$filter("filter")(a,e.txtSearch),o.total(e.pricebooktypes.length);var n=e.pricebooktypes.slice((o.page()-1)*o.count(),o.page()*o.count());t.resolve(n)}else{e.pricebooktypes=a,o.total(e.pricebooktypes.length);var n=e.pricebooktypes.slice((o.page()-1)*o.count(),o.page()*o.count());t.resolve(n)}e.attribisLoading=!1}else e.attribisLoading=!1,s.error(c.response.msg,"Error")})}})},e.refresh=function(){e.attribisLoading=!1,e.priceBookTypeTable.reload()},e.searchData=function(){e.attributeGroupTable.reload()},e.changeSelectDeselectAll=function(){e.selectDeselectAll=!e.selectDeselectAll,_.each(e.pricebooktypes,function(t){t.selected=e.selectDeselectAll,e.deleteSomeData=e.selectDeselectAll,e.checkDataChanges(t)})},e.checkDataChanges=function(t){t.selected?_.find(e.selectedDatas,function(e){return e.pt_id===t.pt_id})||e.selectedDatas.push(t):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.pt_id!==t.pt_id}),e.deleteSomeData=e.selectedDatas.length>0},e.deleteSelected=function(){console.log("$scope.selectedDatas: ",e.selectedDatas),o.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=0;async.each(e.selectedDatas,function(o,a){o.selected&&l.deletePriceBookType(o.pt_id).then(function(o){return console.log("data: ",o.response),200==o.statusCode&&o.response.success?(s.success(o.response.msg,"Success"),++t,t==e.selectedDatas.length&&c.reload(),a(),void 0):void s.error(o.response.msg,"Error")})})})},e.addNewEntry=function(e){var o=t.open({animation:!0,templateUrl:"./modules/pricebook_type/pricebook_type.modal.html",controller:"priceBookTypeModal",size:"md",resolve:{group:function(){return e}}});o.result.then(function(e){console.log("selectedItem: ",e),"save"==e&&c.reload()})}}function t(e,t,o,s,c,a){e.group={},_.isNull(c)||a.getPriceBookType(c).then(function(t){200==t.statusCode&&t.response.success&&(e.group=t.response.result)}),e.savePriceBook=function(){_.isNull(c)?a.savePriceBookType(e.group).then(function(c){200==c.statusCode&&c.response.success&&(s.success("Successfully Added","Success"),o(function(){e.$apply(function(){t.close("save")})},100))}):a.updatePriceBookType(c,e.group).then(function(c){200==c.statusCode&&c.response.success&&(s.success("Successfully Update","Success"),o(function(){e.$apply(function(){t.close("save")})},100))})},e.cancel=function(){t.dismiss("cancel")}}angular.module("POS17").controller("priceBookTypeController",e).controller("priceBookTypeModal",t),e.$inject=["$scope","$uibModal","ngDialog","toastr","$state","$timeout","ngTableParams","pricebookFactory"],t.$inject=["$scope","$uibModalInstance","$timeout","toastr","group","pricebookFactory"]}();
!function(){"use strict";function o(o){}angular.module("POS17").controller("priceBookTypeDetailController",o),o.$inject=["$scope"]}();

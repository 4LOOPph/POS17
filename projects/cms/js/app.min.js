...
!function(){"use strict";function e(e,s,t,n,o,r,i,a,d,c,l,u,p,g){e.details={},e.ptypes={},e["package"]={},e.items={},e.list1=[],e.list2=[],e.productCopy=[],e.getSel=[],e.attributes=[],e.product_image=[],e.tags=[],e.tagsArr=[],e.details.tags=[],e.details.start_date=new Date,e.details.end_date=new Date,e.details.is_published=!1,e.details.is_archived=!1,e.isImageNew=!1,e.add=!1,e.displayComposite=!1,e.displayImage=!1,e.image=[],e.txtSearch="",e.myInterval=3e3,e.noWrapSlides=!1,e.activeSlide=0,e.thumbnailSize=5,e.thumbnailPage=1,e.slides=[];var m=function(){i.getAllProduct().then(function(s){200==s.statusCode&&s.response.success&&(e.list1=s.response.result,e.productCopy=angular.copy(s.response.result),_.each(e.list1,function(e){e.selected=!1})),e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]})};e.refresh=function(){m()},e.searchData=function(s){e.list1=t("filter")(e.productCopy,s)},a.getAllProdType().then(function(s){200==s.statusCode&&s.response.success?e.ptypes=s.response.result:n.error(s.response.msg,"Error")}),u.getAllTags().then(function(s){200==s.statusCode&&s.response.success?e.tagsArr=s.response.result:n.error(s.response.msg,"Error")}),_.isEmpty(o.pb_id)?(e.showPublish=!1,e.showArchive=!1):(e.displayComposite=!0,e.displayImage=!0,i.getProductBundleDetails(o.pb_id).then(function(s){if(200==s.statusCode&&s.response.success){var t=0;e.details=s.response.result,e.items=s.response.result,e.product_image=e.details.product_images,_.each(e.product_image,function(s){e.slides.push({image:s.image_path,index:t}),t++}),_.each(e.details.products,function(s){var t=s.product_detail;1!==t.is_archived&&e.list2.push(t)}),e.showPublish=1!=e.details.is_published,e.showArchive=0==e.details.is_archived,e.details.start_date=new Date(e.details.start_date),e.details.end_date=new Date(e.details.end_date),e.details.ptype_id=s.response.result.productType_id,e.details.is_published=e.IntToBoolean(e.details.is_published),e.details.is_archived=e.IntToBoolean(e.details.is_archived),u.getAllProductBundleTags(o.pb_id).then(function(s){200==s.statusCode&&s.response.success&&(e.details.tags=s.response.result)})}})),e.$watch("list2",function(s){e.list2=s,e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]},!0),e.$watch("list1",function(s){e.list1=s,e.models=[{listName:"Package",items:e.list2,dragging:!1},{listName:"Products",items:e.list1,dragging:!1}]},!0),e.$watch("models",function(s){e.modelAsJson=s},!0),e.tagTransform=function(e){return{tags:e}},e.clearInput=function(e){e.search=""},e.deleteProductTags=function(e){console.log("deleteProductBundleTag: ",e),o.pb_id&&u.deleteProductBundleTag(o.pb_id,e.tags_id).then(function(e){return 200==e.statusCode&&e.response.success?void n.success(e.response.msg,"Success"):void n.error(e.response.msg,"Error")})},e.checkDataChanges=function(s){s.selected?_.find(e.selectedDatas,function(e){return e.store_id===s.store_id})||e.selectedDatas.push(s):e.selectedDatas=_.filter(e.selectedDatas,function(e){return e.store_id!==s.store_id}),e.deleteSomeData=e.selectedDatas.length>0},e.remove=function(e,s){var t=_.findIndex(e.items,function(e){return e.p_id==s.p_id});return e.items.splice(t,1)},e.removeAll=function(e,s){_.each(e.items,function(s){return e.items.splice(e.items,1)})},e.openUploader=function(){var e=p.open({animation:!0,templateUrl:"./modules/products/product-bundle.upload.modal.html",controller:"productBundleUploaderModalCtrl",size:"lg",resolve:{product_bundle_id:function(){return o.pb_id}}});e.result.then(function(e){s.reload()})},e.IntToBoolean=function(e){return 1===e},e.BooleanToInt=function(e){return e===!0?1:0},e.archiveProduct=function(e){i.archiveBundle(e).then(function(e){200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):n.error(e.response.msg,"Error")})},e.publishProduct=function(e){i.publishBundle(e).then(function(e){200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),s.go(s.current,null,{reload:!0})):n.error(e.response.msg,"Error")})},e.addProductBundle=function(){o.pb_id&&(_.isUndefined(e.modelAsJson)||(e.items.products=_.map(e.modelAsJson[0].items,function(e){return{product_id:e.p_id}})),console.log(e.items),i.updateProductBundle(o.pb_id,e.items).then(function(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),s.go(s.current,{pb_id:o.pb_id},{reload:!0}))}))},e.addProduct=function(){async.waterfall([function(s){o.pb_id?i.updateProductBundle(o.pb_id,e.details).then(function(t){200==t.statusCode&&t.response.success?(n.success(t.response.msg,"Success"),e.items=e.details,s(null,o.pb_id)):(e.validate=t.response.result,_.each(e.validate,function(e){n.warning(t.response.msg,"Error - "+e.msg)}))}):i.saveProductBundle(e.details).then(function(t){200==t.statusCode&&t.response.success?(e.items=e.details,n.success(t.response.msg,"Success"),s(null,t.response.result)):(e.validate=t.response.result,_.each(e.validate,function(e){n.warning(t.response.msg,"Error - "+e.msg)}))})},function(s,t){var o=0;e.details.tags.length>0?async.eachSeries(e.details.tags,function(r,i){r.isTag?u.saveTags(r).then(function(e){return 200==e.statusCode&&e.response.success?(console.log("saveProductGroupTags bundle_id: ",s),void u.saveProductGroupTags(s,{tags_id:e.response.result}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void i()):void n.error(e.response.msg,"Error")})):void n.error(e.response.msg,"Error")}):u.saveProductGroupTags(s,{tags_id:r.tags_id}).then(function(e){return 200==e.statusCode&&e.response.success?(o++,void i()):void n.error(e.response.msg,"Error")}),o>=e.details.tags.length&&t(null,s)}):t(null,s)},function(e,t){console.log("asdasdasdas: ",e),g(function(){s.go(s.current,{pb_id:e},{reload:!0})},1e3)}])},e.getSelectedItemsIncluding=function(e,s){return s.selected=!0,e.items.filter(function(e){return e.selected})},e.onDrop=function(s,t,n){return _.each(t,function(t){t.selected=!1;var n=_.find(s.items,{p_id:t.p_id});_.isEmpty(n)&&e.list2.push(t)}),s.items=s.items.slice(0,n).concat(t).concat(s.items.slice(n)),!0},e.onMoved=function(e){e.items=e.items.filter(function(e){return!e.selected})},e.onDragstart=function(e,s){if(e.dragging=!0,s.dataTransfer.setDragImage){var t=new Image;t.src="./images/cargo-128.png",s.dataTransfer.setDragImage(t,0,0)}},e.dropCallback=function(s,t,n){_.each(e.list1,function(e){e.selected=!1})},e.deleteAllMedia=function(){r.openConfirm({templateUrl:"modules/dialog/deleteAllDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.pb_id&&i.deleteAllProductBundleImage(o.pb_id).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void s.reload()):void n.error(e.response.msg,"Error")})})},e.deleteSelected=function(t){r.openConfirm({templateUrl:"modules/dialog/deleteDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log("media: ",t),o.pb_id&&i.deleteProductBundleImageFile(o.pb_id,t._id).then(function(e){return 200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),void s.reload()):void n.error(e.response.msg,"Error")})})},e.refresh()}angular.module("POS17").controller("productsBundleController",e),e.$inject=["$scope","$state","$filter","toastr","$stateParams","ngDialog","productFactory","ptypeFactory","storeFactory","priceHistoryFactory","supplierFctry","tagsFactory","$uibModal","$timeout"]}();

...
!function(){function e(e,r){angular.element(r).bind("resize",function(){e.$emit("resizeMsg")})}angular.module("googlechart",[]).run(e),e.$inject=["$rootScope","$window"]}(),function(){function e(){function e(e){function r(e,r){var t,n;for(n in e)if(e.hasOwnProperty(n))for(t=0;t<i.iFormats[n].length;t++)e[n][t].columnNum<r.getNumberOfColumns()&&i.iFormats[n][t].format(r,e[n][t].columnNum)}function t(e,r,t){var n;if(angular.isArray(t[e])&&!angular.equals(t[e],c[e]))if(c[e]=t[e],i.iFormats[e]=[],"color"===e)o(t);else for(n=0;n<t[e].length;n++)i.iFormats[e].push(new r(t[e][n]))}function n(e,n,o){var i,c,u=!1;if(!angular.isDefined(n)||!angular.isDefined(e))return{requiresHtml:!1};for(i in n)if(n.hasOwnProperty(i)){if(c=a(i,o),!angular.isFunction(c))continue;t(i,c,n),("arrow"===i||"bar"===i||"color"===i)&&(u=!0)}return r(n,e),{requiresHtml:u}}function o(r){var t,n,o,a,c="color";for(t=0;t<r[c].length;t++){for(n=new e.visualization.ColorFormat,o=0;o<r[c][t].formats.length;o++)a=r[c][t].formats[o],"undefined"!=typeof a.fromBgColor&&"undefined"!=typeof a.toBgColor?n.addGradientRange(a.from,a.to,a.color,a.fromBgColor,a.toBgColor):n.addRange(a.from,a.to,a.color,a.bgcolor);i.iFormats[c].push(n)}}function a(r,t){var n=r.charAt(0).toUpperCase()+r.slice(1).toLowerCase()+"Format";return e.visualization.hasOwnProperty(n)?google.visualization[n]:angular.isDefined(t)&&t.hasOwnProperty(r)?t[r]:void 0}var i=this,c={};i.iFormats={},i.applyFormats=n}return e}angular.module("googlechart").factory("FormatManager",e)}(),function(){function e(e,r,t,n,o,a,i,c){function u(){m()}function l(){l.triggered||void 0===y.chart?void 0!==y.chart&&(o.cancel(l.recallTimeout),l.recallTimeout=o(l,10)):(l.triggered=!0,o(p,0,!0))}function s(){v.getReadyPromise().then(l)}function g(){v.draw(),l.triggered=!1}function f(){v=new c,y.registerChartListener=v.registerChartListener,y.registerWrapperListener=v.registerWrapperListener,y.registerServiceListener=v.registerServiceListener,e.$watch(d,h,!0),m=i.$on("resizeMsg",s),e.$on("$destroy",u)}function p(){v.setup(r,y.chart.type,y.chart.data,y.chart.view,y.chart.options,y.chart.formatters,y.chart.customFormatters),o(g)}function h(){y.chart=e.$eval(t.chart),s()}function d(){var r=e.$eval(t.chart);return angular.isDefined(r)&&angular.isObject(r)?{customFormatters:r.customFormatters,data:r.data,formatters:r.formatters,options:r.options,type:r.type,view:r.view}:void 0}var m,v,y=this;f()}angular.module("googlechart").controller("GoogleChartController",e),e.$inject=["$scope","$element","$attrs","$injector","$timeout","$window","$rootScope","GoogleChartService"]}(),function(){function e(){return{restrict:"A",scope:!1,require:"googleChart",link:function(e,r,t,n){function o(r){e.$apply(function(){e.$eval(t.agcBeforeDraw,{chartWrapper:r})})}o.$inject=["chartWrapper"],n.registerServiceListener("beforeDraw",o,this)}}}angular.module("googlechart").directive("agcBeforeDraw",e)}(),function(){function e(){return{restrict:"A",scope:!1,require:"googleChart",link:function(e,r,t,n){function o(r,n,o){e.$apply(function(){e.$eval(t.agcOnClick,{args:r,chart:n,chartWrapper:o})})}o.$inject=["args","chart","chartWrapper"],n.registerChartListener("click",o,this)}}}angular.module("googlechart").directive("agcOnClick",e)}(),function(){function e(){return{restrict:"A",scope:!1,require:"googleChart",link:function(e,r,t,n){function o(r,n,o){var a={chartWrapper:r,chart:n,args:o,error:o[0],err:o[0],id:o[0].id,message:o[0].message};e.$apply(function(){e.$eval(t.agcOnError,a)})}o.$inject=["chartWrapper","chart","args"],n.registerWrapperListener("error",o,this)}}}angular.module("googlechart").directive("agcOnError",e)}(),function(){function e(){return{restrict:"A",scope:!1,require:"googleChart",link:function(e,r,t,n){function o(r,n,o){var a={chartWrapper:o,chart:n,args:r,column:r[0].column,row:r[0].row};e.$apply(function(){e.$eval(t.agcOnMouseout,a)})}o.$inject=["args","chart","chartWrapper"],n.registerChartListener("onmouseout",o,this)}}}angular.module("googlechart").directive("agcOnMouseout",e)}(),function(){function e(){return{restrict:"A",scope:!1,require:"googleChart",link:function(e,r,t,n){function o(r,n,o){var a={chartWrapper:o,chart:n,args:r,column:r[0].column,row:r[0].row};e.$apply(function(){e.$eval(t.agcOnMouseover,a)})}o.$inject=["args","chart","chartWrapper"],n.registerChartListener("onmouseover",o,this)}}}angular.module("googlechart").directive("agcOnMouseover",e)}(),function(){function e(){return{restrict:"A",scope:!1,require:"googleChart",link:function(e,r,t,n){function o(r){e.$apply(function(){e.$eval(t.agcOnReady,{chartWrapper:r})})}o.$inject=["chartWrapper"],n.registerWrapperListener("ready",o,this)}}}angular.module("googlechart").directive("agcOnReady",e)}(),function(){function e(){return{restrict:"A",scope:!1,require:"googleChart",link:function(e,r,t,n){function o(r,n){var o={selectedItems:n.getSelection()};o.selectedItem=o.selectedItems[0],o.chartWrapper=r,o.chart=n,e.$apply(function(){e.$eval(t.agcOnSelect,o)})}o.$inject=["chartWrapper","chart"],n.registerWrapperListener("select",o,this)}}}angular.module("googlechart").directive("agcOnSelect",e)}(),function(){function e(){return{restrict:"A",scope:!1,controller:"GoogleChartController"}}angular.module("googlechart").directive("googleChart",e),e.$inject=[]}(),function(){angular.module("googlechart").value("googleChartApiConfig",{version:"1",optionalSettings:{packages:["corechart"]}})}(),function(){function e(e,r,t,n){t.optionalSettings=t.optionalSettings||{};var o=r.defer(),a=function(){var r={callback:function(){var r=t.optionalSettings.callback;e.$apply(function(){o.resolve(google)}),angular.isFunction(r)&&r.call(this)}};r=angular.extend({},t.optionalSettings,r),window.google.load("visualization",t.version,r)},i=document.getElementsByTagName("head")[0],c=document.createElement("script");return c.setAttribute("type","text/javascript"),c.src=n,c.addEventListener?c.addEventListener("load",a,!1):c.onreadystatechange=function(){("loaded"===c.readyState||"complete"===c.readyState)&&(c.onreadystatechange=null,a())},i.appendChild(c),o.promise}angular.module("googlechart").factory("googleChartApiPromise",e),e.$inject=["$rootScope","$q","googleChartApiConfig","googleJsapiUrl"]}(),function(){function e(e,r,t,n){function o(){function o(e){var r;if(angular.isArray(K[e]))for(r=0;r<K[e].length;r++)K[e][r]()}function a(e){return e}function i(e){return z=e,P=!0,V.resolve(),e}function c(){angular.isDefined(M)?(M.setChartType(T),M.setDataTable(B),M.setView(H),M.setOptions(x)):(M=new z.visualization.ChartWrapper({chartType:T,dataTable:B,view:H,options:x,containerId:R[0]}),f(M,Q)),N||(N=new n(z)),N.applyFormats(M.getDataTable(),G,U).requiresHtml&&M.setOption("allowHtml",!0),J=!1}function u(e,r,t){for(var n=r?r.split("."):[];n.length&&e;){var o=n.shift();new RegExp("(.+)\\[([0-9]*)\\]").exec(o),t&&(void 0===e[o]&&(e[o]={}),0===n.length&&(e[o]=t)),e=e[o]}return e}function l(){I!==M.getChart()&&(I=M.getChart(),f(I,X))}function s(){P=!1,V=t.defer(),E=e.then(i)["catch"](a),A("ready",l,q)}function g(e,t,n,o){var a=function(){var e={chartWrapper:M,chart:M.getChart(),args:arguments};r.invoke(n,o||this,e)};return angular.isDefined(e)&&angular.isObject(e)?(angular.isArray(e[t])||(e[t]=[]),e[t].push(a),function(){angular.isDefined(a.googleListenerHandle)&&z.visualization.events.removeListener(a.googleListenerHandle);var r=e[t].indexOf(a);e[t].splice(r,1),0===e[t].length&&(e[t]=void 0)}):void 0}function f(e,r){for(var t in r)if(r.hasOwnProperty(t)&&angular.isArray(r[t]))for(var n=0;n<r[t].length;n++)angular.isFunction(r[t][n])&&(r[t][n].googleListenerHandle=z.visualization.events.addListener(e,t,r[t][n]))}function p(){o("beforeDraw"),M.draw()}function h(){J&&(E=E.then(c)),E=E.then(p())}function d(){return M}function m(){var e=B||{};return angular.copy(e)}function v(){return R}function y(e){var r=x||{};return u(r,e)}function $(){var e=x||{};return angular.copy(e)}function C(){return V.promise}function w(){var e=H||{};return angular.copy(e)}function O(){return P}function L(e,r,t){return g(X,e,r,t)}function W(e,r,t){return g(K,e,r,t)}function A(e,r,t){return g(Q,e,r,t)}function S(e){angular.isDefined(e)&&(B=angular.copy(e),J=!0)}function j(e){angular.isElement(e)&&R!==e&&(R=e,M=null,J=!0)}function F(e,r){x=x||{},u(x,e,angular.copy(r)),J=!0}function D(e){angular.isDefined(e)&&(x=angular.copy(e),J=!0)}function b(e,r,t,n,o,a,i){R=e||R,T=r||T,B=t||B,H=n||H,x=o||x,G=a||G,U=i||U,E=E.then(c)}function k(e){H=angular.copy(e)}var q=this;q.draw=h,q.getChartWrapper=d,q.getData=m,q.getElement=v,q.getOption=y,q.getOptions=$,q.getView=w,q.getReadyPromise=C,q.isApiReady=O,q.registerChartListener=L,q.registerServiceListener=W,q.registerWrapperListener=A,q.setData=S,q.setElement=j,q.setOption=F,q.setOptions=D,q.setup=b,q.setView=k;var z,E,P,M,R,T,B,H,x,G,I,N,U,V,J=!0,K={},Q={},X={};s()}return o}angular.module("googlechart").factory("GoogleChartService",e),e.$inject=["googleChartApiPromise","$injector","$q","FormatManager"]}(),function(){function e(){var e="https:",r="//www.google.com/jsapi";this.setProtocol=function(r){e=r},this.setUrl=function(e){r=e},this.$get=function(){return(e?e:"")+r}}angular.module("googlechart").provider("googleJsapiUrl",e)}();
(function(){var t;t=angular.module("daterangepicker",[]),t.value("dateRangePickerConfig",{separator:" - ",format:"YYYY-MM-DD"}),t.directive("dateRangePicker",["$compile","$timeout","$parse","dateRangePickerConfig",function(t,e,a,n){return{require:"ngModel",restrict:"A",scope:{dateMin:"=min",dateMax:"=max",model:"=ngModel",opts:"=options"},link:function(t,a,r,i){var o,u,m,d,s,l,c;o=$(a),u=angular.extend({},n,t.opts),s=null;var f=function(t){e(function(){var e=moment(t);s.endDate<e&&s.setEndDate(e),s.setStartDate(e)})},D=function(t){e(function(){var e=moment(t);s.startDate>e&&s.setStartDate(e),s.setEndDate(e)})};return t.$watch("model.startDate",function(t){f(t)}),t.$watch("model.endDate",function(t){D(t)}),m=function(t){var e;return e=function(t){return moment.isMoment(t)?t.format(u.format):moment(t).format(u.format)},u.singleDatePicker?e(t.startDate):[e(t.startDate),e(t.endDate)].join(u.separator)},c=function(t,e){var a;return t=moment(t),e=moment(e),a=t.isBefore(e)||t.isSame(e,"day"),i.$setValidity("min",a),a},l=function(t,e){var a;return t=moment(t),e=moment(e),a=t.isAfter(e)||t.isSame(e,"day"),i.$setValidity("max",a),a},i.$formatters.push(function(t){return t&&t.startDate&&t.endDate?(f(t.startDate),D(t.endDate),t):""}),i.$parsers.unshift(function(e){return angular.isObject(e)&&e.hasOwnProperty("startDate")&&e.hasOwnProperty("endDate")?(t.dateMin&&e.startDate?c(t.dateMin,e.startDate):i.$setValidity("min",!0),t.dateMax&&e.endDate?l(t.dateMax,e.endDate):i.$setValidity("max",!0),e):i.$modelValue}),i.$isEmpty=function(t){return!t||null===t.startDate||null===t.endDate},i.$render=function(){return o.val(i.$modelValue?null===i.$modelValue.startDate?"":m(i.$modelValue):"")},d=function(){return o.daterangepicker(u,function(t,a){return e(function(){return i.$setViewValue({startDate:t,endDate:a}),i.$render()})}),s=o.data("daterangepicker"),o},d(),o.change(function(){return""===$.trim(o.val())?e(function(){return i.$setViewValue({startDate:null,endDate:null})}):void 0}),r.min&&t.$watch("dateMin",function(t){return t?(i.$isEmpty(i.$modelValue)||c(t,i.$modelValue.startDate),u.minDate=moment(t)):u.minDate=!1,d()}),r.max&&t.$watch("dateMax",function(t){return t?(i.$isEmpty(i.$modelValue)||l(t,i.$modelValue.endDate),u.maxDate=moment(t)):u.maxDate=!1,d()}),r.options&&t.$watch("opts",function(t){return u=angular.extend(u,t),d()}),t.$on("$destroy",function(){return s.remove()})}}}])}).call(this);
...
!function(e){angular.module("ngCsv.config",[]).value("ngCsv.config",{debug:!0}).config(["$compileProvider",function(e){angular.isDefined(e.urlSanitizationWhitelist)?e.urlSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|data):/):e.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|data):/)}]),angular.module("ngCsv.directives",["ngCsv.services"]),angular.module("ngCsv.services",[]),angular.module("ngCsv",["ngCsv.config","ngCsv.services","ngCsv.directives","ngSanitize"]),"undefined"!=typeof module&&"undefined"!=typeof exports&&module.exports===exports&&(module.exports="ngCsv"),angular.module("ngCsv.services").service("CSV",["$q",function(e){var i="\r\n",a="\ufeff",n={"\\t":"\t","\\b":"\b","\\v":"\x0B","\\f":"\f","\\r":"\r"};this.stringifyField=function(e,i){return"locale"===i.decimalSep&&this.isFloat(e)?e.toLocaleString():"."!==i.decimalSep&&this.isFloat(e)?e.toString().replace(".",i.decimalSep):"string"==typeof e?(e=e.replace(/"/g,'""'),(i.quoteStrings||e.indexOf(",")>-1||e.indexOf("\n")>-1||e.indexOf("\r")>-1)&&(e=i.txtDelim+e+i.txtDelim),e):"boolean"==typeof e?e?"TRUE":"FALSE":e},this.isFloat=function(e){return+e===e&&(!isFinite(e)||Boolean(e%1))},this.stringify=function(n,t){var r=e.defer(),l=this,o="",d="",s=e.when(n).then(function(e){if(angular.isDefined(t.header)&&t.header){var n,s;n=[],angular.forEach(t.header,function(e){this.push(l.stringifyField(e,t))},n),s=n.join(t.fieldSep?t.fieldSep:","),d+=s+i}var c=[];if(angular.isArray(e)?c=e:angular.isFunction(e)&&(c=e()),angular.isDefined(t.label)&&t.label&&"boolean"==typeof t.label){var u,f;u=[],angular.forEach(c[0],function(e,i){this.push(l.stringifyField(i,t))},u),f=u.join(t.fieldSep?t.fieldSep:","),d+=f+i}angular.forEach(c,function(e,a){var n,r,o=angular.copy(c[a]);r=[];var s=t.columnOrder?t.columnOrder:o;angular.forEach(s,function(e){var i=t.columnOrder?o[e]:e;this.push(l.stringifyField(i,t))},r),n=r.join(t.fieldSep?t.fieldSep:","),d+=a<c.length?n+i:n}),t.addByteOrderMarker&&(o+=a),o+=d,r.resolve(o)});return"function"==typeof s["catch"]&&s["catch"](function(e){r.reject(e)}),r.promise},this.isSpecialChar=function(e){return void 0!==n[e]},this.getSpecialChar=function(e){return n[e]}}]),angular.module("ngCsv.directives").directive("ngCsv",["$parse","$q","CSV","$document","$timeout",function(i,a,n,t,r){return{restrict:"AC",scope:{data:"&ngCsv",filename:"@filename",header:"&csvHeader",columnOrder:"&csvColumnOrder",txtDelim:"@textDelimiter",decimalSep:"@decimalSeparator",quoteStrings:"@quoteStrings",fieldSep:"@fieldSeparator",lazyLoad:"@lazyLoad",addByteOrderMarker:"@addBom",ngClick:"&",charset:"@charset",label:"&csvLabel"},controller:["$scope","$element","$attrs","$transclude",function(e,i,t){function r(){var i={txtDelim:e.txtDelim?e.txtDelim:'"',decimalSep:e.decimalSep?e.decimalSep:".",quoteStrings:e.quoteStrings,addByteOrderMarker:e.addByteOrderMarker};return angular.isDefined(t.csvHeader)&&(i.header=e.$eval(e.header)),angular.isDefined(t.csvColumnOrder)&&(i.columnOrder=e.$eval(e.columnOrder)),angular.isDefined(t.csvLabel)&&(i.label=e.$eval(e.label)),i.fieldSep=e.fieldSep?e.fieldSep:",",i.fieldSep=n.isSpecialChar(i.fieldSep)?n.getSpecialChar(i.fieldSep):i.fieldSep,i}e.csv="",angular.isDefined(e.lazyLoad)&&"true"==e.lazyLoad||angular.isArray(e.data)&&e.$watch("data",function(){e.buildCSV()},!0),e.getFilename=function(){return e.filename||"download.csv"},e.buildCSV=function(){var l=a.defer();return i.addClass(t.ngCsvLoadingClass||"ng-csv-loading"),n.stringify(e.data(),r()).then(function(a){e.csv=a,i.removeClass(t.ngCsvLoadingClass||"ng-csv-loading"),l.resolve(a)}),e.$apply(),l.promise}}],link:function(i,a){function n(){var a=i.charset||"utf-8",n=new Blob([i.csv],{type:"text/csv;charset="+a+";"});if(e.navigator.msSaveOrOpenBlob)navigator.msSaveBlob(n,i.getFilename());else{var l=angular.element('<div data-tap-disabled="true"><a></a></div>'),o=angular.element(l.children()[0]);o.attr("href",e.URL.createObjectURL(n)),o.attr("download",i.getFilename()),o.attr("target","_blank"),t.find("body").append(l),r(function(){o[0].click(),o.remove()},null)}}a.bind("click",function(){i.buildCSV().then(function(){n()}),i.$apply()})}}}])}(window,document);

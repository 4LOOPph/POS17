...
!function(){"use strict";function e(e,t,s,o,i,n,c,l,r,a,u,m){function d(e){e.requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullScreen?e.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT):e.msRequestFullscreen&&e.msRequestFullscreen()}function p(){var e=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement,t=document.fullscreenEnabled||document.mozFullScreenEnabled||document.webkitFullscreenEnabled;t?d(document.documentElement):e&&d(document.documentElement)}function f(){document.exitFullscreen?document.exitFullscreen():document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen()}function v(){t.reload()}function w(e){console.log("Error: ",e);var t=$window.open(encodeURI("https://chrome.google.com/webstore/detail/"+m),"_blank");t.focus()}console.log("mirrorDevice:",u),e.audio="audio"==n,e.mirrorFile=a,e.mirrorDevice=u,e.onReady=function(e){e.autoPlay=!0},e.config={autoPlay:!0,sources:[{src:i.trustAsResourceUrl(o.asset_url),type:o.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.device={},e.asset_file=o,e.displayInstallPlugin=!1,e.activeDevices=[],c.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)}),DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",r(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.selectDevice=function(t){console.log("selectDevice"),e.device=t,e.device&&(e.device.connected=!0,"audio/mp3"==e.asset_file.asset_mimetype||"audio/mp4"==e.asset_file.asset_mimetype?e.asset_file.asset_type="audio":"video/mp4"==e.asset_file.asset_mimetype||"video/x-flv"==e.asset_file.asset_mimetype||"video/x-msvideo"==e.asset_file.asset_mimetype||"video/x-ms-wmv"==e.asset_file.asset_mimetype||"video/quicktime"==e.asset_file.asset_mimetype||"video/3gpp"==e.asset_file.asset_mimetype?e.asset_file.asset_type="video":e.asset_file.asset_type="none",e.asset_file.deviceUUID=e.device.deviceUUID,e.asset_file.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=e.asset_file,!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(m,{openplugin:window.location.origin+window.location.pathname},function(t){console.log("response: ",t),p(),c.emit("pair:getCode",e.device)}))},e.castScreen=function(){e.mirrorDevice&&!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(m,{openplugin:window.location.origin+window.location.pathname},function(t){console.log("response: ",t),p(),c.emit("pair:getCode",e.mirrorDevice)})},e.starredSelected=function(){function t(t){200==t.statusCode&&t.response.success&&(toastr.success(t.response.msg,"Success"),e.asset_file.isStarred=1)}e.asset_file&&(e.asset_file.isFolder?l.starredFolder(e.asset_file._id).then(t):l.starredAssetFile(e.asset_file._id).then(t))},e.cancel=function(){e.device?c.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):c.emit("pair:closePresent",{}),f(),s.dismiss("cancel")},e.installPlugin=function(){console.log("https://chrome.google.com/webstore/detail/tessa-presentation/"+m),!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/tessa-presentation/"+m,v(),w())}}angular.module("tessaApp").controller("assetsMediaModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type","socket","assetsFctry","$timeout","mirrorFile","mirrorDevice","EXT_ID"]}();
...
!function(){"use strict";function e(e,t,i,o,s,c,n,a,l,d,r,m,v){function p(){v.reload()}function u(e){console.log("Error: ",e);var t=r.open(encodeURI("https://chrome.google.com/webstore/detail/"+m),"_blank");t.focus()}e.device={},e.activeDevices=[],e.activeDevices=angular.copy(a),e.enableCasting=!0,e.displayInstallPlugin=!1,DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",i(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.installPlugin=function(){console.log("https://chrome.google.com/webstore/detail/"+m),!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/"+m,p,u)},e.selectDevice=function(t){_.each(e.activeDevices,function(e){return e.selected=!1}),e.enableCasting=!1,t.selected=!0,e.device=t},e.connectDevice=function(){e.device&&(e.device.connected=!0,"audio/mp3"==l.asset_mimetype||"audio/mp4"==l.asset_mimetype?l.asset_type="audio":"video/mp4"==l.asset_mimetype||"video/x-flv"==l.asset_mimetype||"video/x-msvideo"==l.asset_mimetype||"video/x-ms-wmv"==l.asset_mimetype||"video/quicktime"==l.asset_mimetype||"video/3gpp"==l.asset_mimetype?l.asset_type="video":l.asset_type="none",l.deviceUUID=e.device.deviceUUID,l.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=l,n.emit("pair:getCode",e.device),t.close({device:e.device,msg:"mirror"}))},e.cancel=function(){t.dismiss("cancel")},n.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)}),n.on("disconnect",function(e){console.log("disconnect: ",e)})}angular.module("tessaApp").controller("assetsMirrorModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","socket","activeDevices","asset_file","API_URL","$window","EXT_ID","$state"]}();
!function(){"use strict";function e(e,t,o,n,i,c,s,l,r,a,m,u,d){function p(e){e.requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullScreen?e.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT):e.msRequestFullscreen&&e.msRequestFullscreen()}function v(){var e=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement,t=document.fullscreenEnabled||document.mozFullScreenEnabled||document.webkitFullscreenEnabled;t?p(document.documentElement):e&&p(document.documentElement)}function w(){document.exitFullscreen?document.exitFullscreen():document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen()}function f(){t.reload()}function g(e){console.log("Error: ",e);var t=l.open(encodeURI("https://chrome.google.com/webstore/detail/"+d),"_blank");t.focus()}e.pdfName=i.media_name,e.file_type=i.asset_mimetype,e.device={},e.activeDevices=[],e.onMouseMoveResult="",e.displayInstallPlugin=!1,e.mirrorFile=m,e.mirrorDevice=u;var h,b=e.asset_file=i;if(DetectRTC.screen.getChromeExtensionStatus(function(t){console.log("status: ",t),"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",a(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),"application/pdf"==i.asset_mimetype)e.pdfUrl=n.trustAsResourceUrl(i.asset_url);else if("text/plain"==i.asset_mimetype)e.pdfUrl=n.trustAsResourceUrl("https://docs.google.com/gview?url="+i.asset_url+"&embedded=true");else{var U=encodeURI(i.asset_url);e.pdfUrl=n.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+U)}e.stop=function(){r.cancel(h)},e.selectDevice=function(t){e.device=t,e.device?(e.device.connected=!0,"audio/mp3"==b.asset_mimetype||"audio/mp4"==b.asset_mimetype?b.asset_type="audio":"video/mp4"==b.asset_mimetype||"video/x-flv"==b.asset_mimetype||"video/x-msvideo"==b.asset_mimetype||"video/x-ms-wmv"==b.asset_mimetype||"video/quicktime"==b.asset_mimetype||"video/3gpp"==b.asset_mimetype?b.asset_type="video":b.asset_type="none",b.deviceUUID=e.device.deviceUUID,b.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=b,!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(d,{openplugin:window.location.origin+window.location.pathname},function(t){v(),s.emit("pair:getCode",e.device)})):v()},e.castScreen=function(){e.mirrorDevice&&!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(d,{openplugin:window.location.origin+window.location.pathname},function(t){v(),s.emit("pair:getCode",e.mirrorDevice)})},e.cancel=function(){e.device?s.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):s.emit("pair:closePresent",{}),e.stop(),w(),o.dismiss("cancel")},e.installPlugin=function(){console.log("https://chrome.google.com/webstore/detail/"+d),!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/"+d,f,g)},s.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)})}angular.module("tessaApp").controller("assetsDocsModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService","socket","$window","$interval","$timeout","mirrorFile","mirrorDevice","EXT_ID"]}();

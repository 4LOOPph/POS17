...
!function(){"use strict";function e(e,t,i,a,s,l,r,c,n,o,u){t.seemore=!0,t.date=new Date,r.user=s.isEmpty(o.get("User"))?[]:JSON.parse(o.get("User")),t.expFilter=s.isEmpty(o.get("articlefilter"))?"all":JSON.parse(o.get("articlefilter")),t.selectedItem=[],t.articlesList=[],t.lists=[],t.tags=[],t.tagscopy=[],t.selectedTag=[],t.tagselected=[],t.infiniteScrollData={},t.infiniteScrollData.numToAdd=1,t.infiniteScrollData.currentItems=10,t.dynamicPopover={templateUrl:"myPopoverTemplate.html"},t.resetInfScroll=function(){t.infiniteScrollData.currentItems=t.infiniteScrollData.numToAdd},t.addMoreItems=function(){t.infiniteScrollData.currentItems!==t.lists.length&&(t.infiniteScrollData.currentItems+=t.infiniteScrollData.numToAdd,t.articlesList=t.lists,t.articlesList.length=t.infiniteScrollData.currentItems)},t.generateArticles=function(){t.articlesList=[],t.tags=[],t.tagscopy=[],t.lists=[],t.selectedTag=[],i.getArticles(function(e){if(200==e.statusCode&&e.response.success){s.each(e.response.result,function(e){e.name=e.title,e.type="Experience"}),s.map(e.response.result,function(e){e.tags.length>=1&&1==e.is_active&&t.articlesList.push(e)}),t.articlesList=s.map(s.orderBy(t.articlesList,"date_created")).reverse();for(var i=0;i<t.articlesList.length;i++)for(var a=0;a<t.articlesList[a].tags.length;a++)t.articlesList[i].tags[a]&&t.tags.push(t.articlesList[i].tags[a]);s.each(t.articlesList,function(e){if(e.mediafiles.length>0&&(e.image=e.mediafiles[0].media_path),!s.isNull(e.thumbnail_media)){var t=e.article_thumbnail;if(t){if("video/mp4"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}}}),t.tagscopy=angular.copy(t.tags),t.tagscopy=s.uniqBy(t.tagscopy,function(e){return e.tags}),t.tagscopy=s.filter(t.tagscopy,function(e){if("Article"!==e.tags&&"Portfolio"!==e.tags)return e}),t.lists=angular.copy(t.articlesList)}})},t.product=function(){o.remove("label"),o.remove("hardtype"),l.go("main.productCatalogue")},t.toggleSelectedTag=function(e){t.tagselected.indexOf(e)==-1?t.tagselected.push(e):t.tagselected=s.filter(t.tagselected,function(t){return t.tags_id!=e.tags_id})},t.isTagSelected=function(e){return t.tagselected.indexOf(e)!==-1},t.isOnSelectedTag=function(){return function(e){if(!(t.tagselected.length>0))return!0;var i=!1,a=s.map(t.tagselected,"tags_id");s.forEach(e.tags,function(e){a.indexOf(e.tags_id)!==-1&&(i=!0)});return i}},t.filterArticle=function(e){if(t.expFilter=e,o.set("articlefilter",JSON.stringify(t.expFilter)),"all"==e)t.articlesList=angular.copy(t.lists);else{t.articlesList=[];var i=c("filter")(t.tags,{tags:e});s.each(i,function(e){var i=s.find(t.lists,{article_id:e.article_id});t.articlesList.push(i)})}},t.$on("$stateChangeSuccess",function(e,i,a,s,l){"main.experience"==i.name&&(t.tagselected=[],t.generateArticles())})}angular.module("tessaApp").controller("expCtrl",e),e.$inject=["$http","$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$timeout"]}();
!function(e){"use strict";function s(e,s,t,o,i,r,a,l,n,c,d,f,m){function p(e,s){if(0==e)return"0 Byte";var t=1024,o=s+1||3,i=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],r=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,r)).toFixed(o))+" "+i[r]}function u(s){if(200==s.statusCode&&s.response.success){e.items=s.response.result,e.assets=angular.copy(s.response.result),e.isLoading=!1,e.showBread=!0,e.disableToolNewFolder=!1,"main.presentation"==r.current.name?(e.activeAllFiles=!0,e.showToolNewFolder=!0,e.showToolNewUpload=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return null==e.folder_id}),e.assets.folderscopy=angular.copy(e.assets.folders),e.assets.assetscopy=angular.copy(e.assets.assets)):"main.presentation_starred"==r.current.name?(e.activeStarredFiles=!0,e.showToolNewFolder=!1,e.showToolNewUpload=!1,e.showBarDelete=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.starred.folderscopy=angular.copy(e.assets.folders),e.starred.assetscopy=angular.copy(e.assets.assets)):"main.presentation_trash"==r.current.name?(e.activeTrashFiles=!0,e.showToolNewFolder=!1,e.showToolNewUpload=!1,e.showBarDelete=!1,e.showBarRestore=!0,e.showBarShare=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showBarMore=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 1==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 1==e.isDeleted}),e.trash.folderscopy=angular.copy(e.assets.folders),e.trash.assetscopy=angular.copy(e.assets.assets)):"main.openfolder"==r.current.name?(e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted})):e.showToolBar=!1,_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=p(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=p(e.asset_filesize),e.isActive=!1,e.isFolder=!1}),e.assets.folders&&e.assets.assets&&(e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1)),_.each(e.assets.folders,function(e){e.files.length>0&&_.each(e.files,function(e){if("video/mp4"==e.asset_mimetype||"video/x-flv"==e.asset_mimetype||"video/x-msvideo"==e.asset_mimetype||"video/x-ms-wmv"==e.asset_mimetype||"video/quicktime"==e.asset_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"})}),e.foldercopy=angular.copy(e.assets.folders),e.assetcopy=angular.copy(e.assets.assets),e.toppresentation=_.find(e.foldercopy,{folder_name:"Top 10 Presentations"}),e.retail=_.find(e.foldercopy,{folder_name:"Retail"});var t=_.find(e.foldercopy,{folder_name:"About Engagis"});_.each(t.files,function(e){133==e.asset_id?e.asset_description="A recognised leader for Digital Transformation in the Physical Space":e.asset_description="Engagis Deliver Digital In-Store/Venue For Improved Service & Profit Best Practice Delivery With ROI Focused ‘Test n Learn’ Approach Since 2001 We’ve Been The Agile Technology Arm For Leading Retailers"}),t&&(e.aboutengagis=_.each(t.files,function(e){"image/png"==e.asset_mimetype&&(e.asset_name=e.asset_name.slice(0,-4))}))}}console.log("presentationCtrl"),e.pdf={},e.pdf.file=[],e.items={},e.assets={},e.trash={},e.starred={},e.DeSelectAll=!1,e.selectedText="Select All",e.selectedFile={},e.isList="null"!=s.get("isList")&&0!=s.get("isList"),e.isLoading=!0,e.showBread=!1,e.showFiles=!1,e.disableToolNewFolder=!0,e.showToolNewFolder=!0,e.showToolNewUpload=!0,e.showToolMakeCopy=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showToolBar=!0,e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.activeAllFiles=!1,e.activeSharedFiles=!1,e.activeStarredFiles=!1,e.activeTrashFiles=!1,e.mirrorFile=!1,e.mirrorDevice={},e.activeDevices=[],m.on("pair:init",function(){console.log("pair:init tessa")}),m.on("pair:sendCode",function(s){_.find(e.activeDevices,{deviceUUID:s.deviceUUID})||e.activeDevices.push(s)}),e.changeDisplay=function(){e.isList=!e.isList,s.set("isList",e.isList),e.isPreso=!e.isPreso,s.set("isPreso",e.isPreso)},e.refreshAssets=function(){e.assets={},e.items={},"main.presentation"==r.current.name?e.activePage="Assets":"main.presentation_starred"==r.current.name?e.activePage="Favorites":"main.presentation_trash"==r.current.name&&(e.activePage="Trash"),i._id&&_.isUndefined(i.sub_id)?(e.isLoading=!0,o.getFolderAssets(i._id).then(u)):i._id&&i.sub_id?(e.showToolNewFolder=!1,e.isLoading=!0,o.getFolderAssets(i.sub_id).then(u)):o.getAllAssets().then(u)},e.fi=[1,2,3],e.swipe=function(e){console.log("event:",e)},e.refreshAssets(),e.showAllFiles=function(){console.log("$state.current.name:",r.current.name),"main.presentation"==r.current.name?(e.activePage="Assets",e.refreshAssets()):r.go("main.presentation")},e.showAllTrash=function(){console.log("$state.current.name:",r.current.name),"main.presentation_trash"==r.current.name?(e.activePage="Trash",e.refreshAssets()):r.go("main.presentation_trash")},e.showAllStarred=function(){"main.presentation_starred"==r.current.name?(e.activePage="Favorites",e.refreshAssets()):r.go("main.presentation_starred")},e.castModal=function(){var s=t.open({animation:!0,templateUrl:"./views/folder/cast.html",windowClass:"xd-modal",controller:"assetsMirrorModalCtrl",resolve:{activeDevices:function(){return e.activeDevices},asset_file:function(){return e.selectedFile}}});s.result.then(function(s){e.selectedFile&&("mirror"==s.msg&&(e.mirrorFile=!0,e.mirrorDevice=s.device),e.selectedFile.isFolder?e.openFolder(e.selectedFile):e.openFile(e.selectedFile))})},e.newFolder=function(){var e=t.open({animation:!0,templateUrl:"./views/folder/new-item.html",size:"sm",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"});e.result.then(function(e){e&&r.reload()})},e.newUploader=function(){var s=t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});s.result.then(function(s){s&&e.refreshAssets()})},e.copySelected=function(){var e=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/copy.html",controller:"modalpresentation"});e.result.then(function(e){},function(){console.info("Modal dismissed at: "+new Date)})},e.shareToOthers=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/share.html",controller:"assetsShareModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){},function(){console.info("Modal dismissed at: "+new Date)})},e.renameSelected=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/rename.html",controller:"assetsRenameModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&r.reload()})},e.deleteSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),l(function(){r.reload()},200))}console.log("deleteSelected"),e.modal={title:"Remove?",message:"Are you sure to remove this?"},c.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){_.isEmpty(e.selectedFile)||(e.selectedFile.isFolder?e.selectedFile.isDeleted?o.deleteFolder(e.selectedFile._id).then(s):o.trashFolder(e.selectedFile._id).then(s):e.selectedFile.isDeleted?o.deleteAssetFile(e.selectedFile._id).then(s):o.trashAssetFile(e.selectedFile._id).then(s))})},e.moveSelected=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/move.html",controller:"assetsMoveModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&r.reload()})},e.previewSelected=function(){e.selectedFile&&(e.selectedFile.isFolder?(e.openFolder(e.selectedFile),f.trackEvent("Presentation Assets","View",e.selectedFile.folder_name,e.selectedFile.folder_id)):(e.openFile(e.selectedFile),f.trackEvent("Presentation Assets","View",e.selectedFile.asset_name,e.selectedFile.asset_id)))},e.imagepreview=function(s){e.openFile(s)},e.imageCast=function(s){t.open({animation:!0,templateUrl:"./views/folder/cast.html",windowClass:"xd-modal",controller:"assetsMirrorModalCtrl",resolve:{activeDevices:function(){return e.activeDevices},asset_file:function(){return s}}})},e.starredSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),l(function(){r.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?o.starredFolder(e.selectedFile._id).then(s):o.starredAssetFile(e.selectedFile._id).then(s))},e.restoreSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),l(function(){r.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?o.restoreFolder(e.selectedFile._id).then(s):o.restoreAssetFile(e.selectedFile._id).then(s))},e.openLightboxModal=function(s){e.image_file={url:s.asset_url,caption:s.asset_name,thumbUrl:s.asset_url};var o=t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/lightbox-modal.html",windowClass:"modal-img-fullscreen xd-modal",scope:e,size:"lg",resolve:{files:function(){return s},type:function(){return"video"}}});e.cancel=function(){o.dismiss("cancel")}},e.openVideoModal=function(s){console.log("files:",s),console.log("$scope.mirrorDevice:",e.mirrorDevice),t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/media.html",controller:"assetsMediaModalCtrl",windowClass:"xd-modal",size:"lg",resolve:{files:function(){return s},type:function(){return"video"},mirrorFile:function(){return e.mirrorFile},mirrorDevice:function(){return e.mirrorDevice}}}).result.then(function(){e.mirrorFile=!1})},e.openAudioModal=function(s){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/media.html",controller:"assetsMediaModalCtrl",windowClass:"xd-modal",size:"md",resolve:{files:function(){return s},type:function(){return"audio"},mirrorFile:function(){return e.mirrorFile},mirrorDevice:function(){return e.mirrorDevice}}}).result.then(function(){e.mirrorFile=!1,e.mirrorDevice={}})},e.openDocsModal=function(s){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/preview.html",controller:"assetsDocsModalCtrl",size:"lg",windowClass:"modal-fullscreen xd-modal",resolve:{files:function(){return s},mirrorFile:function(){return e.mirrorFile},mirrorDevice:function(){return e.mirrorDevice}}}).result.then(function(){e.mirrorFile=!1,e.mirrorDevice={}})},e.openFolder=function(s){console.log("folder:",s),s.isFolder&&("main.presentation_trash"!==r.current.name?i._id?r.go("main.opensubfolder",{_id:i._id,sub_id:s._id}):(console.log("SULod"),r.go("main.openfolder",{_id:s._id})):(e.modal={title:"This folder is in your trash",message:"To view this folder, youll need to restore it from your trash. Restore folder?"},c.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.restoreFolder(s._id).then(function(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),l(function(){r.reload()},200))})})))},e.openFile=function(s){if("image/jpeg"==s.asset_mimetype||"image/jpg"==s.asset_mimetype||"image/gif"==s.asset_mimetype||"image/x-ms-bmp"==s.asset_mimetype||"image/png"==s.asset_mimetype)e.openLightboxModal(s);else if("audio/mp3"==s.asset_mimetype||"audio/mp4"==s.asset_mimetype)e.openAudioModal(s);else if("video/mp4"==s.asset_mimetype||"video/x-flv"==s.asset_mimetype||"video/x-msvideo"==s.asset_mimetype||"video/x-ms-wmv"==s.asset_mimetype||"video/quicktime"==s.asset_mimetype||"video/3gpp"==s.asset_mimetype)e.openVideoModal(s);else if("application/pdf"==s.asset_mimetype)e.openDocsModal(s);else if("text/plain"==s.asset_mimetype)e.openDocsModal(s);else if("application/msword"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.wordprocessingml.document"==s.asset_mimetype)e.openDocsModal(s);else if("text/csv"==s.asset_mimetype||"application/vnd.ms-excel"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"==s.asset_mimetype)e.openDocsModal(s);else{if("application/vnd.openxmlformats-officedocument.presentationml.presentation"!=s.asset_mimetype&&"application/vnd.ms-powerpoint"!=s.asset_mimetype)return void a.warning("No available tools to open","Failed");e.openDocsModal(s)}_.isNull(s.folder_id)?f.trackEvent("Presentation Assets","Click",s.asset_name,s.asset_id):f.trackEvent("Presentation Assets","Click",s.folder_name,s.files)},e.deleteFile=function(s){e.modal={title:"Remove File",message:"Are you sure to remove the file?"},c.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.deleteAssetFile(s._id).then(function(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),l(function(){r.reload()},200))})})},e.clearSelection=function(){e.selectedFile={},e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,e.showToolOpen=!1,_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1})},e.searchData=function(){_.isEmpty(e.txtSearch)||"main.presentation_trash"!=r.current.name?_.isEmpty(e.txtSearch)&&"main.presentation_trash"==r.current.name?(e.assets.folders=e.trash.folderscopy,e.assets.assets=e.trash.assetscopy):_.isEmpty(e.txtSearch)||"main.presentation_starred"!=r.current.name?_.isEmpty(e.txtSearch)&&"main.presentation_starred"==r.current.name?(e.assets.folders=e.starred.folderscopy,e.assets.assets=e.starred.assetscopy):_.isEmpty(e.txtSearch)||"main.presentation"!=r.current.name?_.isEmpty(e.txtSearch)&&"main.presentation"==r.current.name?(e.assets.folders=e.assets.folderscopy,e.assets.assets=e.assets.assetscopy):_.isEmpty(e.txtSearch)||"main.opensubfolder"!=r.current.name?_.isEmpty(e.txtSearch)&&"main.opensubfolder"==r.current.name?(e.assets.folders=e.foldercopy,e.assets.assets=e.assetcopy):_.isEmpty(e.txtSearch)||"main.openfolder"!=r.current.name?_.isEmpty(e.txtSearch)&&"main.openfolder"==r.current.name&&(e.assets.folders=e.foldercopy,e.assets.assets=e.assetcopy):(e.assets.folders=d("filter")(e.foldercopy,e.txtSearch),e.assets.assets=d("filter")(e.assetcopy,e.txtSearch)):(e.assets.folders=d("filter")(e.foldercopy,e.txtSearch),e.assets.assets=d("filter")(e.assetcopy,e.txtSearch)):(e.assets.folders=d("filter")(e.assets.folderscopy,e.txtSearch),e.assets.assets=d("filter")(e.assets.assetscopy,e.txtSearch)):(e.assets.folders=d("filter")(e.starred.folderscopy,e.txtSearch),e.assets.assets=d("filter")(e.starred.assetscopy,e.txtSearch)):(e.assets.folders=d("filter")(e.trash.folderscopy,e.txtSearch),e.assets.assets=d("filter")(e.trash.assetscopy,e.txtSearch)),_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=p(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=_.isInteger(e.asset_filesize)?p(e.asset_filesize):e.asset_filesize,e.isActive=!1,e.isFolder=!1}),e.assets.folders&&e.assets.assets&&(e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1))},e.selectAll=function(){0==e.DeSelectAll?(e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,_.each(e.assets.folders,function(e){e.isActive=!0}),_.each(e.assets.assets,function(e){e.isActive=!0}),e.DeSelectAll=!0,e.selectedText="Deselect All"):(e.showBarDelete=!1,e.showBarRestore=!0,e.showBarShare=!1,e.showBarMore=!1,_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1}),e.DeSelectAll=!1,e.selectedText="Select All")},e.activeSelected=function(s){e.DeSelectAll=!1,e.selectedText="Select All",s&&(s.isActive=!0,"main.presentation_trash"==r.current.name?(e.showBarDelete=!0,e.showBarRestore=!0,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showToolMakeCopy=!1):"main.presentation_starred"==r.current.name?(e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,s.isFolder?(e.showToolPreview=!1,e.showToolOpen=!0,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolOpen=!1,e.showToolMakeCopy=!0)):(e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,s.isFolder?(e.showToolPreview=!1,e.showToolOpen=!0,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolOpen=!1,e.showToolMakeCopy=!0)),e.selectedFile=s,e.foldercopy&&_.each(e.foldercopy,function(e){_.each(e.files,function(e){e._id!==s._id&&(e.isActive=!1)})}),e.toppresentation&&_.each(e.toppresentation.files,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.folders,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.assets,function(e){e._id!==s._id&&(e.isActive=!1)}))}}angular.module("tessaApp").controller("presentationCtrl",s),s.$inject=["$scope","localStorageService","$uibModal","assetsFctry","$stateParams","$state","toastr","$timeout","Lightbox","ngDialog","$filter","$frontierAnalytics","socket"]}(document);
...
!function(){"use strict";function e(e,t,s,i,o,n,c,l,r,a,u,m){function d(t){t.requestFullscreen?t.requestFullscreen():t.mozRequestFullScreen?t.mozRequestFullScreen():t.webkitRequestFullScreen?t.webkitRequestFullScreen():t.msRequestFullscreen&&t.msRequestFullscreen(),e.isFullScreen=!0}function p(){var e=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement,t=document.fullscreenEnabled||document.mozFullScreenEnabled||document.webkitFullscreenEnabled;t?d(document.documentElement):e&&d(document.documentElement)}function f(){document.exitFullscreen?document.exitFullscreen():document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen(),e.isFullScreen=!1}function w(){t.reload()}function v(e){console.log("Error: ",e);var t=$window.open(encodeURI("https://chrome.google.com/webstore/detail/"+m),"_blank");t.focus()}console.log("mirrorDevice:",u),e.audio="audio"==n,e.mirrorFile=a,e.mirrorDevice=u,e.isFullScreen=!1,e.onReady=function(e){e.autoPlay=!0},e.config={autoPlay:!0,sources:[{src:o.trustAsResourceUrl(i.asset_url),type:i.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.device={},e.asset_file=i,e.displayInstallPlugin=!1,e.activeDevices=[],c.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)}),DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",r(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),_.isEmpty(e.mirrorDevice)||r(function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(m,{openplugin:window.location.origin+window.location.pathname},function(e){})},1e3),e.enterFullScreen=function(){p()},e.exitFullScreen=function(){f()},e.selectDevice=function(t){e.device=t,e.device&&(e.device.connected=!0,"audio/mp3"==e.asset_file.asset_mimetype||"audio/mp4"==e.asset_file.asset_mimetype?e.asset_file.asset_type="audio":"video/mp4"==e.asset_file.asset_mimetype||"video/x-flv"==e.asset_file.asset_mimetype||"video/x-msvideo"==e.asset_file.asset_mimetype||"video/x-ms-wmv"==e.asset_file.asset_mimetype||"video/quicktime"==e.asset_file.asset_mimetype||"video/3gpp"==e.asset_file.asset_mimetype?e.asset_file.asset_type="video":e.asset_file.asset_type="none",e.asset_file.deviceUUID=e.device.deviceUUID,e.asset_file.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=e.asset_file,!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(m,{openplugin:window.location.origin+window.location.pathname},function(t){console.log("response: ",t),p(),c.emit("pair:getCode",e.device)}))},e.castScreen=function(){e.mirrorDevice&&!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(m,{openplugin:window.location.origin+window.location.pathname},function(t){console.log("response: ",t),p(),c.emit("pair:getCode",e.mirrorDevice)})},e.starredSelected=function(){function t(t){200==t.statusCode&&t.response.success&&(toastr.success(t.response.msg,"Success"),e.asset_file.isStarred=1)}e.asset_file&&(e.asset_file.isFolder?l.starredFolder(e.asset_file._id).then(t):l.starredAssetFile(e.asset_file._id).then(t))},e.cancel=function(){e.device?c.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):c.emit("pair:closePresent",{}),f(),s.close("cancel")},e.installPlugin=function(){console.log("https://chrome.google.com/webstore/detail/tessa-presentation/"+m),!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/tessa-presentation/"+m,w(),v())}}angular.module("tessaApp").controller("assetsMediaModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type","socket","assetsFctry","$timeout","mirrorFile","mirrorDevice","EXT_ID"]}();
...
!function(){"use strict";function e(e,t,o,i,s,n,c,a,l,r,d,m,p){function u(){p.reload()}function v(e){console.log("Error: ",e);var t=d.open(encodeURI("https://chrome.google.com/webstore/detail/"+m),"_blank");t.focus()}e.device={},e.activeDevices=[],e.activeDevices=angular.copy(a),e.enableCasting=!0,e.displayInstallPlugin=!1,DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",o(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.installPlugin=function(){console.log("https://chrome.google.com/webstore/detail/"+m),!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/"+m,u,v)},e.selectDevice=function(e){},e.connectDevice=function(){"audio/mp3"==l.asset_mimetype||"audio/mp4"==l.asset_mimetype?l.asset_type="audio":"video/mp4"==l.asset_mimetype||"video/x-flv"==l.asset_mimetype||"video/x-msvideo"==l.asset_mimetype||"video/x-ms-wmv"==l.asset_mimetype||"video/quicktime"==l.asset_mimetype||"video/3gpp"==l.asset_mimetype?l.asset_type="video":l.asset_type="none",l.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=l,c.emit("pair:getCode",e.device),t.close({device:e.device,msg:"mirror"})},e.cancel=function(){t.dismiss("cancel")},c.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)}),c.on("disconnect",function(e){console.log("disconnect: ",e)})}angular.module("tessaApp").controller("assetsMirrorModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","socket","activeDevices","asset_file","API_URL","$window","EXT_ID","$state"]}();
!function(){"use strict";function e(e,t,i,o,n,s,c,l,r,a,m,u,d){function p(t){t.requestFullscreen?t.requestFullscreen():t.mozRequestFullScreen?t.mozRequestFullScreen():t.webkitRequestFullScreen?t.webkitRequestFullScreen():t.msRequestFullscreen&&t.msRequestFullscreen(),e.isFullScreen=!0}function v(){var e=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement,t=document.fullscreenEnabled||document.mozFullScreenEnabled||document.webkitFullscreenEnabled;t?p(document.documentElement):e&&p(document.documentElement)}function w(){document.exitFullscreen?document.exitFullscreen():document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen(),e.isFullScreen=!1}function f(){t.reload()}function g(e){console.log("Error: ",e);var t=l.open(encodeURI("https://chrome.google.com/webstore/detail/"+d),"_blank");t.focus()}e.pdfName=n.media_name,e.file_type=n.asset_mimetype,e.device={},e.activeDevices=[],e.onMouseMoveResult="",e.displayInstallPlugin=!1,e.mirrorFile=m,e.mirrorDevice=u,e.isFullScreen=!1;var h,y=e.asset_file=n;if(DetectRTC.screen.getChromeExtensionStatus(function(t){console.log("status: ",t),"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",a(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),"application/pdf"==n.asset_mimetype)e.pdfUrl=o.trustAsResourceUrl(n.asset_url);else if("text/plain"==n.asset_mimetype)e.pdfUrl=o.trustAsResourceUrl("https://docs.google.com/gview?url="+n.asset_url+"&embedded=true");else{var b=encodeURI(n.asset_url);e.pdfUrl=o.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+b)}console.log(e.mirrorDevice),_.isEmpty(e.mirrorDevice)||a(function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(d,{openplugin:window.location.origin+window.location.pathname},function(e){})},1e3),e.enterFullScreen=function(){v()},e.exitFullScreen=function(){w()},e.stop=function(){r.cancel(h)},e.selectDevice=function(t){e.device=t,e.device?(e.device.connected=!0,"audio/mp3"==y.asset_mimetype||"audio/mp4"==y.asset_mimetype?y.asset_type="audio":"video/mp4"==y.asset_mimetype||"video/x-flv"==y.asset_mimetype||"video/x-msvideo"==y.asset_mimetype||"video/x-ms-wmv"==y.asset_mimetype||"video/quicktime"==y.asset_mimetype||"video/3gpp"==y.asset_mimetype?y.asset_type="video":y.asset_type="none",y.deviceUUID=e.device.deviceUUID,y.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=y,!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(d,{openplugin:window.location.origin+window.location.pathname},function(t){c.emit("pair:getCode",e.device)})):v()},e.castScreen=function(){"audio/mp3"==y.asset_mimetype||"audio/mp4"==y.asset_mimetype?y.asset_type="audio":"video/mp4"==y.asset_mimetype||"video/x-flv"==y.asset_mimetype||"video/x-msvideo"==y.asset_mimetype||"video/x-ms-wmv"==y.asset_mimetype||"video/quicktime"==y.asset_mimetype||"video/3gpp"==y.asset_mimetype?y.asset_type="video":y.asset_type="none",y.deviceUUID=e.device.deviceUUID,y.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=y,c.emit("pair:getCode",e.device),a(function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(d,{openplugin:window.location.origin+window.location.pathname},function(e){})},1e3)},e.cancel=function(){e.device?c.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):c.emit("pair:closePresent",{}),e.stop(),w(),i.close("cancel")},e.installPlugin=function(){console.log("https://chrome.google.com/webstore/detail/"+d),!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/"+d,f,g)},c.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)})}angular.module("tessaApp").controller("assetsDocsModalCtrl",e),e.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService","socket","$window","$interval","$timeout","mirrorFile","mirrorDevice","EXT_ID"]}();
...
var isChrome=!!navigator.webkitGetUserMedia,DetectRTC={};!function(){var e;DetectRTC.screen={chromeMediaSource:"screen",getSourceId:function(o){if(!o)throw'"callback" parameter is mandatory.';e=o,window.postMessage("get-sourceId","*")},isChromeExtensionAvailable:function(e){if(e){if("desktop"==DetectRTC.screen.chromeMediaSource)return e(!0);window.postMessage("are-you-there","*"),setTimeout(function(){e("screen"==DetectRTC.screen.chromeMediaSource?!1:!0)},2e3)}},onMessageCallback:function(o){if("string"==typeof o||o.sourceId){if("PermissionDeniedError"==o){if(DetectRTC.screen.chromeMediaSource="PermissionDeniedError",e)return e("PermissionDeniedError");throw new Error("PermissionDeniedError")}"rtcmulticonnection-extension-loaded"==o&&(console.log('<strong>Great!</strong> <a href="https://chrome.google.com/webstore/detail/tessa-presentation/abggimbnoanedfgibfmkilplcmehkfln" target="_blank">Google chrome extension</a> is installed.'),DetectRTC.screen.chromeMediaSource="desktop"),o.sourceId&&(DetectRTC.screen.sourceId=o.sourceId,e&&e(DetectRTC.screen.sourceId))}},getChromeExtensionStatus:function(e){if(navigator.mozGetUserMedia)return e("not-chrome");var o="abggimbnoanedfgibfmkilplcmehkfln",t=document.createElement("img");t.src="chrome-extension://"+o+"/img/desktopCapture48.png",t.onload=function(){DetectRTC.screen.chromeMediaSource="desktop",window.postMessage("are-you-there","*"),setTimeout(function(){DetectRTC.screen.notInstalled||e("installed-enabled")},2e3)},t.onerror=function(){DetectRTC.screen.notInstalled=!0,e("not-installed")}}},window.postMessage&&isChrome&&DetectRTC.screen.isChromeExtensionAvailable()}(),window.addEventListener("message",function(e){e.origin==window.location.origin&&DetectRTC.screen.onMessageCallback(e.data)});

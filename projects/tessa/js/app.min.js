...
!function(){"use strict";function e(e,t,r,a,i,c,n,o,s,l,u){function p(e){return i.map(e,function(e){if("location"==e.type){var t=e.label.replace(/[\s]/g,"");return{label:t.toLowerCase(),type:e.type,index:e.sortindex}}if("configuration"==e.type){var r=e.label.replace(/[\s]/g,"");return{label:r.toLowerCase(),type:e.type,index:e.sortindex}}return e})}function d(t,r,a,c){e.index=[];var n=[];return"Hardware"==e.prodTypeLabel?i.isEmpty(a)?t:i.isEmpty(t)?c:r>0?(i.each(a,function(e,r){return n=i.filter(t,function(t){return i.some(t.attributes,function(t){return t.value==e.value})}),a.splice(r,1),!1}),r-=1,d(n,r,a,c)):t:i.isEmpty(a)?t:i.isEmpty(t)?c:r>0?(i.each(a,function(e,r){var c=i.filter(t,function(t){return t.hardware.some(function(t){return i.some(t.attributes,function(t){return t.value==e.value})})}),o=i.filter(t,function(t){return i.some(t.tags,{tags:e.label})});return i.isEmpty(c)?i.isEmpty(o)||(n=o):n=c,a.splice(r,1),!1}),r-=1,d(n,r,a,c)):t}e.solutionTypes="EzeImpress",e.prodTypeLabel=i.isEmpty(s.get("label"))?"Solution":JSON.parse(s.get("label")),e.solutionTypes=i.isEmpty(s.get("solutiontype"))?"EzeImpress":JSON.parse(s.get("solutiontype")),e.txtSearch="",e.bundles=[],e.productDetails=[],e.seemore=!0,e.solutions=[],e.SolutionCategory=[],e.productscopy=[],e.ezewificopy=[],e.categoryWifi=[],e.screens=[],e.Screens=[],e.ScreenSize=[],e.media=[],e.MediaPlayer=[],e.Mediacopy=[],e.bundleTags=[],e.searchcopy=[],e.filtercopy=[],e.typeselected=[],e.tagselected=[],e.productsAttributesValue=[],e.hardwareType=i.isEmpty(s.get("hardtype"))?"Screens":JSON.parse(s.get("hardtype")),e.solutionTypes=i.isEmpty(s.get("solutiontype"))?"EzeImpress":JSON.parse(s.get("solutiontype")),e.location=[{_id:8,label:"Indoor",type:"location"},{_id:9,label:"Outdoor",type:"location"},{_id:10,label:"Semi Outdoor",type:"location"}],e.config=[{_id:11,label:"Wall Mounted",type:"configuration"},{_id:12,label:"Floor Mounted",type:"configuration"}],e.usages=[{_id:13,label:"24/7",type:"usages"},{_id:14,label:"16/7",type:"usages"}],e.orient=[{_id:15,label:"Landscape",type:"orientation"},{_id:16,label:"Portrait",type:"orientation"},{_id:17,label:"Custom",type:"orientation"}],e.dynamicPopover={vesa:"vesa.html",bezel:"bezel.html",usage:"usage.html",weight:"weight.html",mounting:"configuration.html",location:"location.html",dimensions:"dimensions.html",screensize:"screens.html",brightness:"brightness.html",screentype:"screentype.html",resolution:"resolution.html",orientation:"orientation.html",templateUrl7:"wifi.html",templateUrl8:"ram.html",orientation1:"ori.html",templateUrl9:"displaytechno.html",displaytechno:"displaytechno.html",displayinterface:"displayinterface.html",templateUrlStorage:"storage.html",templateUrlGraphics:"graphics.html",templateUrlResolution:"resolutions.html"},e.infiniteScrollData={},e.infiniteScrollData.numToAdd=10,e.infiniteScrollData.currentItems=10,e.resetInfScroll=function(){e.infiniteScrollData.currentItems=e.infiniteScrollData.numToAdd},e.addMoreItems=function(){e.infiniteScrollData.currentItems+=e.infiniteScrollData.numToAdd};var y=function(){async.waterfall([function(r){t.getProductBundle(function(t,c){var n=[],o=[];e.solutions=c.response.result,o=i.flattenDeep(i.map(e.solutions,function(e){return void 0!=e.product_bundle_category[0]&&n.push(e.product_bundle_category[0]),e.products.length>0||(e.weekly=0),e.products})),i.each(o,function(e){e.product_detail&&(e.productType_id=e.product_detail.productType_id,e.sell_price=e.product_detail.sell_price,e.product_detail.product_category.length>0&&(e.category_id=e.product_detail.product_category[0].category_id,e.category_label=e.product_detail.product_category[0].category_label))});var s=i.groupBy(o,"pb_id");i.map(s,function(t,r){var c=a("filter")(t,{productType_id:18}),n=a("filter")(t,{productType_id:17}),o=a("filter")(t,{productType_id:20});if(parseInt(r)==parseInt(r)){if((n.length>0||c.length>0)&&(e.resulthardwaresum=i.sum(i.map(n,function(e){return e.sell_price*e.quantity})),e.softwaresum=i.sum(i.map(c,function(e){return e.sell_price*e.quantity}))),o.length>0){var s=a("filter")(o,{category_id:87}),l=a("filter")(o,{category_id:90});(s.length>0||l.length>0)&&(e.deploymentservice=i.sum(i.map(s,function(e){return e.sell_price*e.quantity})),e.supportservice=i.sum(i.map(l,function(e){return e.sell_price*e.quantity}))),e.servicesum=i.sum(i.map(o,function(e){return e.sell_price*e.quantity}))}void 0==e.deploymentservice&&void 0==e.supportservice?(e.deploymentservice=0,e.supportservice=0):(e.deploymentservice,e.supportservice);var u=e.deploymentservice+e.softwaresum+e.resulthardwaresum;e.weekly=12*(31.111*u/1e3+e.supportservice)/52}i.each(e.solutions,function(t){t.pb_id==parseInt(r)&&(t.weekly=e.weekly,t.software=c,t.hardware=n,t.support=l,t.upfront=u,t.spPrice=i.sum(i.map(l,function(e){return e.sell_price*e.quantity})))})}),i.each(e.solutions,function(e){e.product_bundle_category.length>0&&(e.category_label=e.product_bundle_category[0].category_label,e.category_id=e.product_bundle_category[0].category_id)}),r(null,e.solutions)})},function(e,t){var r=[];i.each(e,function(e){i.each(e.hardware,function(e){r.push(e)})}),t(null,e,r)},function(e,r,a){var i=[];async.each(r,function(e,r){t.getProductAttribute(e.product_id,function(e,t){t?200==t.statusCode&&t.response.success&&(i.push(t.response.result),r()):r()})},function(t,c){a(null,e,r,i)})},function(t,r,a,c){var n=i.groupBy(a,"p_id");i.each(r,function(e){i.map(n,function(t,r){r&&i.each(t,function(t){if(t.attribute_values.length>0){var a=i.find(t.attribute_values,{is_comparable:1});i.isUndefined(a)&&r?parseInt(r)==e.product_id&&(e.comparable=0,e.attributes=t.attribute_values):parseInt(r)==e.product_id&&(e.comparable=1,e.attributes=t.attribute_values)}else parseInt(r)==e.product_id&&(e.comparable=0)})})});var o=i.groupBy(r,"pb_id");i.each(t,function(e){i.map(o,function(t,r){if(e.pb_id==r&&e.hardware){var a=i.filter(t,{comparable:1});a.length>0?e.comparable=1:e.comparable=0,e.hardware=t}})}),e.categoryWifi=i.filter(t,function(e){return 101==e.category_id}),e.EzeImpress=i.filter(t,function(e){if(1==e.is_published&&0==e.is_archived&&!i.isUndefined(e)&&"Eze Impress"==e.category_label)return e}),t=i.filter(t,function(e){if(1==e.is_published&&0==e.is_archived)return e}),e.bundlecategory=i.uniqBy(t,function(e){return e.category_label}),console.log("$scope.bundlecategory:",e.bundlecategory),console.log("$scope.EzeImpress:",e.EzeImpress),e.productscopy=angular.copy(e.EzeImpress),e.ezewificopy=angular.copy(e.categoryWifi)}]),async.waterfall([function(r){t.getProduct(function(t,c){e.allproducts=c.response.result,e.hardware=i.filter(e.allproducts,function(e){return"Hardware"===e.product_type}),e.prodCateg=[];for(var n=0;n<e.hardware.length;n++)for(var o=0;o<e.hardware[n].product_category.length;o++)e.prodCateg.push(e.hardware[n].product_category[o]);i.each(e.hardware,function(t){i.find(e.prodCateg,function(e){t.p_id==e.product_id&&(t.category_id=e.category_id)})});var s=a("filter")(e.hardware,{category_id:80}),l=a("filter")(e.hardware,{category_id:83});r(null,s,l)})},function(e,r,a){var c=[];async.each(e,function(e,r){t.getProductAttribute(e.p_id,function(t,a){if(a){if(200==a.statusCode&&a.response.success&&e.p_id==a.response.result.p_id){var i=a.response.result.attribute_values;i&&i.length>0?(e.attributes=a.response.result.attribute_values,e.type="Screens"):e.attributes=null,r()}}else r()})},function(t,n){i.each(e,function(e){var t=i.filter(e.attributes,{is_comparable:1});t.length>0?e.comparable=1:e.comparable=0,1==e.is_published&&0==e.is_archived&&c.push(e)}),a(null,e,r,c)})},function(e,r,a,c){var n=[];async.each(r,function(e,r){t.getProductAttribute(e.p_id,function(t,a){if(200==a.statusCode&&a.response.success&&e.p_id==a.response.result.p_id){var i=a.response.result.attribute_values;i&&i.length>0?(e.attributes=a.response.result.attribute_values,e.type="Media"):e.attributes=null,r()}})},function(t,o){i.each(r,function(e){var t=i.filter(e.attributes,{is_comparable:1});t.length>0?e.comparable=1:e.comparable=0,1==e.is_published&&0==e.is_archived&&n.push(e)}),c(null,e,r,a,n)})},function(t,r,c,n,o){if(c&&c.length>0){var s=[];i.each(c,function(e){i.isNull(e.attributes)||s.push(e.attributes)});var l=c;s=i.flattenDeep(s),e.attribute_values=angular.copy(s),e.ScreenSize=a("filter")(s,{attribute:"Screen Size"}),e.Brightness=a("filter")(s,{attribute:"Brightness"}),e.Bezel=a("filter")(s,{attribute:"Bezel Size"}),e.Usage=a("filter")(s,{attribute:"Usage"}),e.Displaytechno=a("filter")(s,{attribute:"Display Technology"}),e.weight=a("filter")(s,{attribute:"Weight"}),e.dimensions=a("filter")(s,{attribute:"Dimensions"}),e.orientation=a("filter")(s,{attribute:"Orientation"}),e.orientation=i.uniqBy(e.orientation,function(e){return e.value}),e.orientation=i.each(e.orientation,function(e){e.values=e.value.split(",")}),e.ori=[],i.each(e.orientation,function(t){i.map(t.values,function(t){i.each(e.orient,function(r){t==r.label&&e.ori.push(r)})})}),e.displayinterface=a("filter")(s,{attribute:"Display Interface"}),e.vesa=a("filter")(s,{attribute:"Vesa"}),e.screentype=a("filter")(s,{attribute:"Screen type"}),e.resolution=a("filter")(s,{attribute:"Resolution"})}if(n&&n.length>0){var s=[];i.each(n,function(e){i.isNull(e.attributes)||s.push(e.attributes)});var u=n;s=i.flattenDeep(s),e.Mediaattribute_values=angular.copy(s),e.Ram=a("filter")(s,{attribute:"RAM"}),e.Storage=a("filter")(s,{attribute:"Storage"}),e.Graphics=a("filter")(s,{attribute:"Graphics"}),e.Resolution=a("filter")(s,{attribute:"Maximum Resolution"})}o(null,t,r,c,n,l,u)},function(r,a,c,n,o,s,l){s&&s.length>0&&async.each(s,function(e,r){t.getRelatedProduct(e.p_id,function(t,a){if(a){if(200==a.statusCode&&a.response.success){var c=a.response.result;c.length>0&&i.each(c,function(t){t.main_id==e.p_id&&(e.relatedhardware=a.response.result)}),r()}}else r()})},function(t,r){i.each(e.productscopy,function(e){i.each(e.products,function(t){i.each(s,function(r){t.product_id==r.p_id&&(r.solution=e)})})}),e.MediaPlayer=s,e.Mediacopy=angular.copy(s)}),o&&async.each(o,function(e,r){t.getRelatedProduct(e.p_id,function(t,a){if(200==a.statusCode&&a.response.success){var c=a.response.result;c.length>0&&i.each(c,function(t){t.main_id==e.p_id&&(e.relatedhardware=a.response.result)}),r()}})},function(t,r){i.each(e.productscopy,function(e){i.each(e.products,function(t){i.each(o,function(r){t.product_id==r.p_id&&(r.solution=e)})})}),e.Screens=o,e.Screenscopy=angular.copy(e.Screens)})}])};e.activateTab=function(t){e.solutionTypes=t,e.seemore=!0,s.set("solutiontype",JSON.stringify(e.solutionTypes)),u.trackView("Product Catalogue/"+e.prodTypeLabel+"/"+t)},e.toggleSelectedType=function(t){var r=[];if("Hardware"==e.prodTypeLabel)e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),"MediaPlayer"==e.hardwareType?(r=p(e.tagselected),!i.isEmpty(e.txtSearch)&&e.searchmedia?e.MediaPlayer=d(e.searchmedia,r.length,r,e.searchmedia):e.MediaPlayer=d(e.Mediacopy,r.length,r,e.Mediacopy),e.filterMedia=angular.copy(e.MediaPlayer)):(r=p(e.tagselected),!i.isEmpty(e.txtSearch)&&e.searchscreen?e.Screens=d(e.searchscreen,r.length,r,e.searchscreen):e.Screens=d(e.Screenscopy,r.length,r,e.Screenscopy),e.filterScreens=angular.copy(e.Screens));else{var a=[],c=[];if(i.each(e.productscopy,function(e){e.hardware.length>0&&i.each(e.hardware,function(e){a.push(e)})}),i.each(e.copyscreen,function(e){i.isNull(e.attributes)||c.push(e.attributes)}),c=i.flattenDeep(c),e.ezehards=angular.copy(a),e.attrib=angular.copy(c),"EzeImpress"==e.solutionTypes){e.typeselected.indexOf(t)==-1?e.typeselected.push(t):e.typeselected=i.filter(e.typeselected,function(e){return e._id!=t._id}),i.map(e.productscopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})});e.typeselected.length;r=p(e.typeselected),i.each(e.EzeImpress,function(e){i.each(e.tags,function(e){e.tags=e.tags.replace(/[\[\](){}?*+\^$\\.|\-|\s]/g,"")})}),!i.isEmpty(e.txtSearch)&&e.searchcopy?e.EzeImpress=d(e.searchcopy,r.length,r,e.searchcopy):(e.EzeImpress=d(e.productscopy,r.length,r,e.productscopy),e.filtercopy=angular.copy(e.EzeImpress))}}},e.refresh=function(){o.$broadcast("loading:progress"),l(function(){y()},100),o.$broadcast("loading:finish")},e.uncheck=function(t,r){t.checked&&("Hardware"==e.prodTypeLabel?(i.each(e.tagselected,function(e){e._id==t._id&&(e.checked=!1)}),"MediaPlayer"==e.hardwareType?e.toggleSelectedType(t):e.toggleSelectedType(t)):(i.each(e.typeselected,function(e){e._id==t._id&&(e.checked=!1)}),e.toggleSelectedType(t)))},e.searchData=function(){if(o.$broadcast("loading:progress"),"Solution"==e.prodTypeLabel){l(function(){t(),o.$broadcast("loading:finish")},600);var t=function(){i.isEmpty(e.txtSearch)?(e.searchcopy=[],"EzeImpress"==e.solutionTypes?i.isEmpty(e.typeselected)?e.EzeImpress=angular.copy(e.productscopy):e.EzeImpress=angular.copy(e.filtercopy):e.categoryWifi=angular.copy(e.ezewificopy)):i.isEmpty(e.typeselected)&&"EzeImpress"==e.solutionTypes?l(function(){e.EzeImpress=a("filter")(e.productscopy,e.txtSearch),e.searchcopy=angular.copy(e.EzeImpress),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300):i.isEmpty(e.typeselected)&&"EzeWifi"==e.solutionTypes?l(function(){e.categoryWifi=a("filter")(e.ezewificopy,e.txtSearch),e.searchcopy=angular.copy(e.products),u.trackEvent("Category Search","search",e.txtSearch,e.categoryWifi.length)},300):i.isEmpty(e.typeselected)||"EzeImpress"!=e.solutionTypes?i.isEmpty(e.typeselected)||"EzeWifi"!=e.solutionTypes||l(function(){e.EzeImpress=a("filter")(e.filtercopy,e.txtSearch),e.searchcopy=angular.copy(e.EzeImpress),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300):l(function(){e.EzeImpress=a("filter")(e.filtercopy,e.txtSearch),e.searchcopy=angular.copy(e.EzeImpress),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300)}}else{l(function(){t(),o.$broadcast("loading:finish")},600);var t=function(){if(i.isEmpty(e.txtSearch))if("MediaPlayer"==e.hardwareType)i.isEmpty(e.tagselected)?e.MediaPlayer=e.Mediacopy:e.MediaPlayer=angular.copy(e.filterMedia);else if(i.isEmpty(e.tagselected))e.Screens=e.Screenscopy;else{var t=[],r=[];if(e.tagselected&&e.tagselected.length>0){var c=[];i.each(e.tagselected,function(n){t=a("filter")(e.attribute_values,{value:n.value}),t&&t.length>0&&i.each(t,function(t){r=i.find(e.Screenscopy,{p_id:t.p_id}),i.isUndefined(r)||c.push(r)})});var n=i.uniqBy(c,function(e){return e._id});e.Screens=n}else e.Screens=angular.copy(e.Screenscopy)}else i.isEmpty(e.tagselected)&&"Screens"==e.hardwareType?l(function(){e.Screens=a("filter")(e.Screenscopy,e.txtSearch),e.searchscreen=angular.copy(e.Screens),u.trackEvent("Category Search","search",e.txtSearch,e.Screens.length)},300):i.isEmpty(e.tagselected)&&"MediaPlayer"==e.hardwareType?l(function(){e.MediaPlayer=a("filter")(e.Mediacopy,e.txtSearch),e.searchmedia=angular.copy(e.MediaPlayer),u.trackEvent("Category Search","search",e.txtSearch,e.MediaPlayer.length)},300):i.isEmpty(e.tagselected)||"Screens"!=e.hardwareType?i.isEmpty(e.tagselected)||"MediaPlayer"!=e.hardwareType||l(function(){e.MediaPlayer=a("filter")(e.filterMedia,e.txtSearch),e.copymedia=angular.copy(e.MediaPlayer),u.trackEvent("Category Search","search",e.txtSearch,e.MediaPlayer.length)},300):l(function(){e.Screens=a("filter")(e.filterScreens,e.txtSearch),e.copyscreens=angular.copy(e.Screens),u.trackEvent("Category Search","search",e.txtSearch,e.Screens.length)},300)}}},e.clear=function(){"Solution"==e.prodTypeLabel?i.isEmpty(e.txtSearch)&&i.isEmpty(e.typeselected)||(e.txtSearch="",i.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected),e.refresh()):"MediaPlayer"==e.hardwareType?i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.refresh()):i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.refresh())},e.refresh(),e.activeProd=function(t){e.prodTypeLabel=t,"Hardware"==t?(e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.hardwareType)):(e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.solutionTypes)),s.set("label",JSON.stringify(e.prodTypeLabel))},e.activeHard=function(t){e.hardwareType=t,e.txtSearch="",s.set("hardtype",JSON.stringify(e.hardwareType)),u.trackView("Product Catalogue/",e.prodTypeLabel,"/",t)},e.solutionsEzeImpress=function(e){u.trackEvent("Productcatalogue","click","Solution",i.toString(e.pb_id))},e.solutionsEzeWifi=function(e){u.trackEvent("Productcatalogue","click","Solution",i.toString(e.pb_id))},e.hardwareScreens=function(e){console.log("value",e),u.trackEvent("Productcatalogue","click","Hardware",i.toString(e.p_id))},e.hardwareMediaplayer=function(e){u.trackEvent("Productcatalogue","click","Hardware",i.toString(e.p_id))},e.togglemodal=function(e){var t=c.open({animation:!0,templateUrl:"./views/share.modal.html",controller:"articleCtrl",size:"sm",resolve:{article:function(){return e}}});t.result.then(function(){n.reload()},function(){console.info("Modal dismissed")})}}angular.module("tessaApp").controller("productCtrl",e),e.$inject=["$scope","APIFactory","$location","$filter","_","$uibModal","$state","$rootScope","localStorageService","$timeout","$frontierAnalytics"]}();
...
!function(){"use strict";function e(e,t,i,a,l,r,s,c,n,o,u,d,g,f){t.refresh=function(){f.gallery.refresh()},t.angularGridoptions={cssGrid:!0,refreshOnImgLoad:!1,gridWidth:350,gutterSize:20},t.seemore=!0,t.date=new Date,s.user=l.isEmpty(o.get("User"))?[]:JSON.parse(o.get("User")),t.expFilter=l.isEmpty(o.get("articlefilter"))?"all":JSON.parse(o.get("articlefilter")),console.log("$scope.expFilter;",t.expFilter),t.selectedItem=[],t.articlesList=[],t.lists=[],t.tags=[],t.tagscopy=[],t.Portfolio=[],t.Article=[],t.selectedTag=[],t.tagselected=[],t.infiniteScrollData={},t.infiniteScrollData.numToAdd=1,t.infiniteScrollData.currentItems=10,t.dynamicPopover={templateUrl:"myPopoverTemplate.html",backdrop:"static",keyboard:!1},t.pdf={file:null,thumbnail:""},t.resetInfScroll=function(){t.infiniteScrollData.currentItems=t.infiniteScrollData.numToAdd},t.addMoreItems=function(){t.infiniteScrollData.currentItems!==t.lists.length&&(t.infiniteScrollData.currentItems+=t.infiniteScrollData.numToAdd,t.articlesList=t.lists,t.articlesList.length=t.infiniteScrollData.currentItems)},t.generateArticles=function(){t.articlesList=[],t.tags=[],t.tagscopy=[],t.lists=[],t.selectedTag=[],i.getArticles(function(e,i){if(200==i.statusCode&&i.response.success){l.each(i.response.result,function(e){e.name=e.title,e.type="Experience",e.tags.length>=1&&1==e.is_active&&t.articlesList.push(e)}),t.articlesList=l.map(l.orderBy(t.articlesList,"date_created")).reverse(),l.each(t.articlesList,function(e){t.tags.push(e.tags)}),t.tags=l.flattenDeep(t.tags),t.tags=l.uniqBy(t.tags,function(e){return e.tags}),l.each(t.articlesList,function(e){if(e.mediafiles.length>0&&(e.image=e.mediafiles[0].media_path),!l.isNull(e.thumbnail_media)){var t=e.article_thumbnail;if(t){if("video/mp4"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}}}),t.tagscopy=angular.copy(t.tags),t.lists=angular.copy(t.articlesList);var a=c("filter")(t.tags,{tags:"Portfolio"}),r=c("filter")(t.tags,{tags:"Article"});a&&l.each(a,function(e){var i=l.find(t.lists,{article_id:e.article_id});t.Portfolio.push(i),l.each(t.articlesList,function(t){t.article_id==e.article_id&&(t.article_type=e.tags)})}),r&&l.each(r,function(e){var i=l.find(t.lists,{article_id:e.article_id});t.Article.push(i),l.each(t.articlesList,function(t){t.article_id==e.article_id&&(t.article_type=e.tags)})}),console.log("main:",t.articlesList)}})},t.clearAll=function(){console.log("clear:",t.tagselected),l.each(t.tagselected,function(e){e.checked=!1}),t.tagselected.splice(t.tagselected)},t.product=function(){o.remove("label"),o.remove("hardtype"),r.go("main.productCatalogue")},t.toggleSelectedTag=function(e){t.event=["Filter by Industry","click",e.tags,l.toString(e.tags_id)],t.tagselected.indexOf(e)==-1?t.tagselected.push(e):t.tagselected=l.filter(t.tagselected,function(t){return t.tags_id!=e.tags_id})},t.trackExperienceArticles=function(e){d.trackEvent("Experience","View",e.title,l.toString(e.article_id))},t.trackExperiencePortfolio=function(e){d.trackEvent("Experience","View",e.title,l.toString(e.article_id))},t.trackExperienceAll=function(e){d.trackEvent(e.type,"View",e.title,l.toString(e.article_id))},t.isTagSelected=function(e){return t.tagselected.indexOf(e)!==-1},t.isOnSelectedTag=function(){return function(e){if(!(t.tagselected.length>0))return!0;var i=!1,a=l.map(t.tagselected,"tags_id");l.forEach(e.tags,function(e){a.indexOf(e.tags_id)!==-1&&(i=!0)});return i}},t.filterArticle=function(e){if(t.expFilter=e,o.set("articlefilter",JSON.stringify(t.expFilter)),"all"==t.expFilter)t.articlesList=angular.copy(t.lists);else{t.articlesList=[];var i=c("filter")(t.tags,{tags:t.expFilter});l.each(i,function(e){var i=l.find(t.lists,{article_id:e.article_id});t.articlesList.push(i)}),console.log("filter:",t.articlesList)}},t.$watch("expFilter",function(e){u(function(){if("all"==e)t.articlesList=angular.copy(t.lists);else{t.articlesList=[];var i=c("filter")(t.tagscopy,{tags:e});l.each(i,function(e){var i=l.find(t.lists,{article_id:e.article_id});t.articlesList.push(i)})}},600)}),t.$on("$stateChangeSuccess",function(e,i,a,l,r){"main.experience"==i.name&&(t.tagselected=[],t.generateArticles())})}angular.module("tessaApp").service("imageService",["$q","$http",function(e,t){this.loadImages=function(){return t.jsonp("https://api.flickr.com/services/feeds/photos_public.gne?format=json&jsoncallback=JSON_CALLBACK")}}]).controller("expCtrl",e),e.$inject=["$http","$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$timeout","$frontierAnalytics","imageService","angularGridInstance"]}();

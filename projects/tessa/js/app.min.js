...
!function(){"use strict";function e(e,t,i,o,s,c,n,a,l,d,r,m,v){function p(){v.reload()}function u(e){console.log("Error: ",e);var t=r.open(encodeURI("https://chrome.google.com/webstore/detail/"+m),"_blank");t.focus()}e.device={},e.activeDevices=[],e.activeDevices=angular.copy(a),e.enableCasting=!0,e.displayInstallPlugin=!1,DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",i(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.installPlugin=function(){console.log("https://chrome.google.com/webstore/detail/"+m),!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/"+m,p,u)},e.selectDevice=function(t){_.each(e.activeDevices,function(e){return e.selected=!1}),e.enableCasting=!1,t.selected=!0,e.device=t},e.connectDevice=function(){e.device&&(e.device.connected=!0,"audio/mp3"==l.asset_mimetype||"audio/mp4"==l.asset_mimetype?l.asset_type="audio":"video/mp4"==l.asset_mimetype||"video/x-flv"==l.asset_mimetype||"video/x-msvideo"==l.asset_mimetype||"video/x-ms-wmv"==l.asset_mimetype||"video/quicktime"==l.asset_mimetype||"video/3gpp"==l.asset_mimetype?l.asset_type="video":l.asset_type="none",l.deviceUUID=e.device.deviceUUID,l.url=window.location.origin+"/presentation.html?s=tEs$@486759",e.device.asset_file=l,n.emit("pair:getCode",e.device),t.close({device:e.device,msg:"mirror"}))},e.cancel=function(){t.dismiss("cancel")},n.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)}),n.on("disconnect",function(e){console.log("disconnect: ",e)})}angular.module("tessaApp").controller("assetsMirrorModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","socket","activeDevices","asset_file","API_URL","$window","EXT_ID","$state"]}();

...
!function(){"use strict";function e(e,t,i,s,n,o,c,l,r,a,m,u){function d(e){e.requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullScreen?e.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT):e.msRequestFullscreen&&e.msRequestFullscreen()}function p(){var e=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement,t=document.fullscreenEnabled||document.mozFullScreenEnabled||document.webkitFullscreenEnabled;t?d(document.documentElement):e&&d(document.documentElement)}function v(){document.exitFullscreen?document.exitFullscreen():document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen()}function f(){t.reload()}function w(e){console.log("Error: ",e)}console.log("mirrorDevice:",m),e.audio="audio"==o,e.mirrorFile=a,e.mirrorDevice=m,e.onReady=function(e){e.autoPlay=!0},e.config={autoPlay:!0,sources:[{src:n.trustAsResourceUrl(s.asset_url),type:s.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.device={},e.asset_file=s,e.displayInstallPlugin=!1,e.activeDevices=[],c.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)}),DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",r(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.selectDevice=function(t){console.log("selectDevice"),e.device=t,e.device&&(e.device.connected=!0,"audio/mp3"==e.asset_file.asset_mimetype||"audio/mp4"==e.asset_file.asset_mimetype?e.asset_file.asset_type="audio":"video/mp4"==e.asset_file.asset_mimetype||"video/x-flv"==e.asset_file.asset_mimetype||"video/x-msvideo"==e.asset_file.asset_mimetype||"video/x-ms-wmv"==e.asset_file.asset_mimetype||"video/quicktime"==e.asset_file.asset_mimetype||"video/3gpp"==e.asset_file.asset_mimetype?e.asset_file.asset_type="video":e.asset_file.asset_type="none",e.asset_file.deviceUUID=e.device.deviceUUID,e.asset_file.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=e.asset_file,!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(u,{openplugin:window.location.origin+window.location.pathname},function(t){console.log("response: ",t),p(),c.emit("pair:getCode",e.device)}))},e.castScreen=function(){e.mirrorDevice&&!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(u,{openplugin:window.location.origin+window.location.pathname},function(t){console.log("response: ",t),p(),c.emit("pair:getCode",e.mirrorDevice)})},e.starredSelected=function(){function t(t){200==t.statusCode&&t.response.success&&(toastr.success(t.response.msg,"Success"),e.asset_file.isStarred=1)}e.asset_file&&(e.asset_file.isFolder?l.starredFolder(e.asset_file._id).then(t):l.starredAssetFile(e.asset_file._id).then(t))},e.cancel=function(){e.device?c.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):c.emit("pair:closePresent",{}),v(),i.dismiss("cancel")},e.installPlugin=function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/tessa-presentation/klaagnfcilpkdeicdamepejjmaoahple",f,w)}}function t(e,t,i,s,n,o,c,l,r,a,m,u,d){function p(e){e.requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullScreen?e.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT):e.msRequestFullscreen&&e.msRequestFullscreen()}function v(){var e=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement,t=document.fullscreenEnabled||document.mozFullScreenEnabled||document.webkitFullscreenEnabled;t?p(document.documentElement):e&&p(document.documentElement)}function f(){document.exitFullscreen?document.exitFullscreen():document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen()}function w(){t.reload()}function g(e){console.log("Error: ",e)}e.pdfName=n.media_name,e.file_type=n.asset_mimetype,e.device={},e.activeDevices=[],e.onMouseMoveResult="",e.displayInstallPlugin=!1,e.mirrorFile=m,e.mirrorDevice=u;var h,F=e.asset_file=n;if(DetectRTC.screen.getChromeExtensionStatus(function(t){console.log("status: ",t),"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",a(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),"application/pdf"==n.asset_mimetype)e.pdfUrl=s.trustAsResourceUrl(n.asset_url);else if("text/plain"==n.asset_mimetype)e.pdfUrl=s.trustAsResourceUrl("https://docs.google.com/gview?url="+n.asset_url+"&embedded=true");else{var b=encodeURI(n.asset_url);e.pdfUrl=s.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+b)}e.stop=function(){r.cancel(h)},e.selectDevice=function(t){e.device=t,e.device?(e.device.connected=!0,"audio/mp3"==F.asset_mimetype||"audio/mp4"==F.asset_mimetype?F.asset_type="audio":"video/mp4"==F.asset_mimetype||"video/x-flv"==F.asset_mimetype||"video/x-msvideo"==F.asset_mimetype||"video/x-ms-wmv"==F.asset_mimetype||"video/quicktime"==F.asset_mimetype||"video/3gpp"==F.asset_mimetype?F.asset_type="video":F.asset_type="none",F.deviceUUID=e.device.deviceUUID,F.url=window.location.origin+window.location.pathname+"presentation.html?s=tEs$@486759",e.device.asset_file=F,!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(d,{openplugin:window.location.origin+window.location.pathname},function(t){v(),c.emit("pair:getCode",e.device)})):v()},e.castScreen=function(){e.mirrorDevice&&!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.runtime.sendMessage(d,{openplugin:window.location.origin+window.location.pathname},function(t){v(),c.emit("pair:getCode",e.mirrorDevice)})},e.cancel=function(){e.device?c.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):c.emit("pair:closePresent",{}),e.stop(),f(),i.dismiss("cancel")},e.installPlugin=function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/tessa-presentation/klaagnfcilpkdeicdamepejjmaoahple",w,g)},c.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)})}angular.module("tessaApp").controller("assetsMediaModalCtrl",e).controller("assetsDocsModalCtrl",t),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type","socket","assetsFctry","$timeout","mirrorFile","mirrorDevice","EXT_ID"],t.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService","socket","$window","$interval","$timeout","mirrorFile","mirrorDevice","EXT_ID"]}();

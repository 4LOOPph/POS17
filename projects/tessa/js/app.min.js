...
!function(){"use strict";function e(e,t,i,a,l,s,r,n,u,d){e.detail=[],e.relatedExperience=[],e.bundles=[],e.slides=[],u.selected_id&&(async.waterfall([function(e){n.getArticles(function(t){200==t.statusCode&&t.response.result&&e(null,t.response.result)})},function(t,i){n.getArticleDetail(u.selected_id,function(a){if(200==a.statusCode&&a.response.success){e.detail=a.response.result;var l=0;i(null,t,a.response.result),_.isEmpty(e.detail.mediafiles)||_.each(e.detail.mediafiles,function(e){if(e){if("video/mp4"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}return e.index=l++}),_.each(e.detail.mediafiles,function(t){"image/png"==t.media_mimetype||"image/jpeg"==t.media_mimetype?(e.slides.push({media_mimetype:t.media_mimetype,image:t.media_path,index:l}),l++):"video/mp4"==t.media_mimetype&&(e.slides.push({media_mimetype:t.media_mimetype,image:t.media_path,url:t.url,index:l}),l++)}),console.log("$scope.detail:",e.detail)}})},function(e,t,i){n.getArticleTags(t.article_id,function(a){if(200==a.statusCode&&a.response.success){var l=[];_.map(a.response.result,function(e){"Article"!=e.tags&&"Portfolio"!=e.tags&&l.push(e)}),i(null,e,t,l)}})},function(t,i,a,l){var s=[],r=_.flattenDeep(_.map(t,function(e){return e.tags}));_.map(a,function(e){_.each(r,function(t){e.tags==t.tags&&s.push(t)})}),_.each(t,function(t){_.each(s,function(i){t.article_id==i.article_id&&e.relatedExperience.push(t)})});var u=_.uniq(e.relatedExperience);e.relatedExperiences=_.filter(u,function(e){return i.article_id!=e.article_id}),_.each(e.relatedExperiences,function(e){if(e.mediafiles.length>0&&(e.image=e.mediafiles[0].media_path),!_.isNull(e.thumbnail_media)){var t=e.article_thumbnail;if(t){if("video/mp4"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}}}),n.getProductBundle(function(t){var a=t.response.result;i.article_features.length>0?_.each(i.article_features,function(t){var i=_.find(a,{pb_id:t.bundle_id});e.bundles.push(i)}):e.norelated="No related solutions"})}]),e.openShareModal=function(){var t=d.open({animation:!0,templateUrl:"./views/share.modal.html",size:"md",backdrop:!1,windowClass:"sharemodal",controller:"ShareModalInstanceCtrl",resolve:{article:function(){return e.detail},param:function(){return"article"}}});t.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})},e.select=function(e){r.hash("article_page"),t.go("main.articlePage",{selected_id:e},{reload:!0})})}angular.module("tessaApp").controller("ModalInstanceCtrl",e),e.$inject=["$scope","$state","sharerFactory","toastr","$window","$anchorScroll","$location","APIFactory","$stateParams","$uibModal"]}();
...
!function(){"use strict";function e(e,t,i,a,s,l,r,c,n,o,u){t.seemore=!0,t.date=new Date,r.user=s.isEmpty(o.get("User"))?[]:JSON.parse(o.get("User")),t.selectedItem=[],t.articlesList=[],t.lists=[],t.tags=[],t.tagscopy=[],t.selectedTag=[],t.tagselected=[],t.expFilter="all",t.infiniteScrollData={},t.infiniteScrollData.numToAdd=1,t.infiniteScrollData.currentItems=10,t.resetInfScroll=function(){t.infiniteScrollData.currentItems=t.infiniteScrollData.numToAdd},t.addMoreItems=function(){t.infiniteScrollData.currentItems!==t.lists.length&&(t.infiniteScrollData.currentItems+=t.infiniteScrollData.numToAdd,t.articlesList=t.lists,t.articlesList.length=t.infiniteScrollData.currentItems)},t.generateArticles=function(){t.articlesList=[],t.tags=[],t.tagscopy=[],t.lists=[],t.selectedTag=[],i.getArticles(function(e){if(200==e.statusCode&&e.response.success){s.each(e.response.result,function(e){e.name=e.title,e.type="Experience"}),s.map(e.response.result,function(e){e.tags.length>=1&&1==e.is_active&&t.articlesList.push(e)}),t.articlesList=s.map(s.orderBy(t.articlesList,"date_created")).reverse();for(var i=0;i<t.articlesList.length;i++)for(var a=0;a<t.articlesList[a].tags.length;a++)t.articlesList[i].tags[a]&&t.tags.push(t.articlesList[i].tags[a]);s.each(t.articlesList,function(e){if(e.mediafiles.length>0&&(e.image=e.mediafiles[0].media_path),!s.isNull(e.thumbnail_media)){var t=e.article_thumbnail;if(t){if("video/mp4"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}}}),t.tagscopy=angular.copy(t.tags),t.tagscopy=s.uniqBy(t.tagscopy,function(e){return e.tags}),t.tagscopy=s.filter(t.tagscopy,function(e){if("Article"!==e.tags&&"Portfolio"!==e.tags)return e}),t.lists=angular.copy(t.articlesList)}})},u(function(){t.generateArticles()},300),t.product=function(){o.remove("label"),o.remove("hardtype"),l.go("main.productCatalogue")},t.toggleSelectedTag=function(e){t.tagselected.indexOf(e)==-1?t.tagselected.push(e):t.tagselected=s.filter(t.tagselected,function(t){return t.tags_id!=e.tags_id})},t.isTagSelected=function(e){return t.tagselected.indexOf(e)!==-1},t.isOnSelectedTag=function(){return function(e){if(!(t.tagselected.length>0))return!0;var i=!1,a=s.map(t.tagselected,"tags_id");s.forEach(e.tags,function(e){a.indexOf(e.tags_id)!==-1&&(i=!0)});return i}},t.filterArticle=function(e){if(t.expFilter=e,"all"==e)t.articlesList=angular.copy(t.lists);else{t.articlesList=[];var i=c("filter")(t.tags,{tags:e});s.each(i,function(e){var i=s.find(t.lists,{article_id:e.article_id});t.articlesList.push(i)})}},t.$on("$stateChangeSuccess",function(e,i,a,s,l){"main.experience"==i.name&&(t.tagselected=[],t.generateArticles())})}angular.module("tessaApp").controller("expCtrl",e),e.$inject=["$http","$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$timeout"]}();
!function(){"use strict";function e(e,s,t,o,i,l,a,n,r,d){function c(e,s){if(0==e)return"0 Byte";var t=1024,o=s+1||3,i=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],l=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,l)).toFixed(o))+" "+i[l]}function m(s){200==s.statusCode&&s.response.success&&(e.items=s.response.result,e.assets=angular.copy(s.response.result),e.isLoading=!1,e.showBread=!0,e.disableToolNewFolder=!1,"main.presentation"==l.current.name?(e.activeAllFiles=!0,e.showToolNewFolder=!0,e.showToolNewUpload=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return null==e.folder_id})):"main.presentation_starred"==l.current.name?(e.activeStarredFiles=!0,e.showToolNewFolder=!1,e.showToolNewUpload=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted&&1==e.isStarred})):"main.presentation_trash"==l.current.name&&(e.activeTrashFiles=!0,e.showToolNewFolder=!1,e.showToolNewUpload=!1,e.showBarDelete=!1,e.showBarRestore=!0,e.showBarShare=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showBarMore=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 1==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 1==e.isDeleted})),_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=c(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=c(e.asset_filesize),e.isActive=!1,e.isFolder=!1}),e.assets.folders&&e.assets.assets&&(e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1)),console.log("$scope.assets: ",e.assets))}e.items={},e.assets={},e.trash={},e.starred={},e.selectedFile={},e.isList="null"!=s.get("isList")&&0!=s.get("isList"),e.isLoading=!0,e.showBread=!1,e.showFiles=!1,e.disableToolNewFolder=!0,e.showToolNewFolder=!0,e.showToolNewUpload=!0,e.showToolMakeCopy=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.activeAllFiles=!1,e.activeSharedFiles=!1,e.activeStarredFiles=!1,e.activeTrashFiles=!1,e.changeDisplay=function(){e.isList=!e.isList,s.set("isList",e.isList)},e.refreshAssets=function(){e.assets={},e.items={},"main.presentation"==l.current.name?e.activePage="Assets":"main.presentation_starred"==l.current.name?e.activePage="Favorites":"main.presentation_trash"==l.current.name&&(e.activePage="Trash"),i._id&&_.isUndefined(i.sub_id)?(e.isLoading=!0,o.getFolderAssets(i._id).then(m)):i._id&&i.sub_id?(e.showToolNewFolder=!1,e.isLoading=!0,o.getFolderAssets(i.sub_id).then(m)):o.getAllAssets().then(m)},e.refreshAssets(),e.showAllFiles=function(){"main.presentation"==l.current.name?(e.activePage="Assets",e.refreshAssets()):l.go("main.presentation")},e.showAllTrash=function(){"main.presentation_trash"==l.current.name?(e.activePage="Trash",e.refreshAssets()):l.go("main.presentation_trash")},e.showAllStarred=function(){"main.presentation_starred"==l.current.name?(e.activePage="Favorites",e.refreshAssets()):l.go("main.presentation_starred")},e.castModal=function(){var e=t.open({animation:!0,templateUrl:"./views/folder/cast.html",size:"lg",windowClass:"xd-modal",controller:"assetsMirrorModalCtrl"});e.result.then(function(){})},e.newFolder=function(){var e=t.open({animation:!0,templateUrl:"./views/folder/new-item.html",size:"sm",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"});e.result.then(function(e){e&&l.reload()})},e.newUploader=function(){var s=t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});s.result.then(function(s){s&&e.refreshAssets()})},e.copySelected=function(){var e=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/copy.html",controller:"modalpresentation"});e.result.then(function(e){},function(){console.info("Modal dismissed at: "+new Date)})},e.shareToOthers=function(){var e=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/share.html",controller:"assetsShareModalCtrl"});e.result.then(function(e){},function(){console.info("Modal dismissed at: "+new Date)})},e.renameSelected=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/rename.html",controller:"assetsRenameModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&l.reload()})},e.deleteSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),n(function(){l.reload()},200))}console.log("deleteSelected"),e.modal={title:"Remove?",message:"Are you sure to remove this?"},d.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){_.isEmpty(e.selectedFile)||(e.selectedFile.isFolder?e.selectedFile.isDeleted?o.deleteFolder(e.selectedFile._id).then(s):o.trashFolder(e.selectedFile._id).then(s):e.selectedFile.isDeleted?o.deleteAssetFile(e.selectedFile._id).then(s):o.trashAssetFile(e.selectedFile._id).then(s))})},e.moveSelected=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/move.html",controller:"assetsMoveModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&l.reload()})},e.previewSelected=function(){e.selectedFile&&(e.selectedFile.isFolder?e.openFolder(e.selectedFile):e.openFile(e.selectedFile))},e.starredSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),n(function(){l.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?o.starredFolder(e.selectedFile._id).then(s):o.starredAssetFile(e.selectedFile._id).then(s))},e.restoreSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),n(function(){l.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?o.restoreFolder(e.selectedFile._id).then(s):o.restoreAssetFile(e.selectedFile._id).then(s))},e.openLightboxModal=function(e){var s=[];s.push({url:e.asset_url,caption:e.asset_name,thumbUrl:e.asset_url}),r.openModal(s,0)},e.openVideoModal=function(e){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/media.html",controller:"assetsMediaModalCtrl",windowClass:"xd-modal",size:"lg",resolve:{files:function(){return e},type:function(){return"video"}}})},e.openAudioModal=function(e){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/media.html",controller:"assetsMediaModalCtrl",windowClass:"xd-modal",size:"md",resolve:{files:function(){return e},type:function(){return"audio"}}})},e.openDocsModal=function(e){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/preview.html",controller:"assetsDocsModalCtrl",size:"lg",windowClass:"modal-fullscreen xd-modal",resolve:{files:function(){return e}}})},e.openFolder=function(s){console.log("openFolder: ",s),s.isFolder&&("main.presentation_trash"!==l.current.name?i._id?l.go("main.opensubfolder",{_id:i._id,sub_id:s._id}):l.go("main.openfolder",{_id:s._id}):(e.modal={title:"This folder is in your trash",message:"To view this folder, youll need to restore it from your trash. Restore folder?"},d.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.restoreFolder(s._id).then(function(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),n(function(){l.reload()},200))})})))},e.openFile=function(s){if("image/jpeg"==s.asset_mimetype||"image/jpg"==s.asset_mimetype||"image/gif"==s.asset_mimetype||"image/x-ms-bmp"==s.asset_mimetype||"image/png"==s.asset_mimetype)e.openLightboxModal(s);else if("audio/mp3"==s.asset_mimetype||"audio/mp4"==s.asset_mimetype)e.openAudioModal(s);else if("video/mp4"==s.asset_mimetype||"video/x-flv"==s.asset_mimetype||"video/x-msvideo"==s.asset_mimetype||"video/x-ms-wmv"==s.asset_mimetype||"video/quicktime"==s.asset_mimetype||"video/3gpp"==s.asset_mimetype)e.openVideoModal(s);else if("application/pdf"==s.asset_mimetype)e.openDocsModal(s);else if("text/plain"==s.asset_mimetype)e.openDocsModal(s);else if("application/msword"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.wordprocessingml.document"==s.asset_mimetype)e.openDocsModal(s);else if("text/csv"==s.asset_mimetype||"application/vnd.ms-excel"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"==s.asset_mimetype)e.openDocsModal(s);else{if("application/vnd.openxmlformats-officedocument.presentationml.presentation"!=s.asset_mimetype&&"application/vnd.ms-powerpoint"!=s.asset_mimetype)return void a.warning("No available tools to open","Failed");e.openDocsModal(s)}},e.deleteFile=function(s){console.log("media: ",s),e.modal={title:"Remove File",message:"Are you sure to remove the file?"},d.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.deleteAssetFile(s._id).then(function(e){200==e.statusCode&&e.response.success&&(a.success(e.response.msg,"Success"),n(function(){l.reload()},200))})})},e.clearSelection=function(){console.log("clearSelection"),e.selectedFile={},e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,e.showToolOpen=!1,_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1})},e.selectAll=function(){e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,_.each(e.assets.folders,function(e){e.isActive=!0}),_.each(e.assets.assets,function(e){e.isActive=!0})},e.activeSelected=function(s){console.log("folder: ",s),s&&(s.isActive=!0,"main.presentation_trash"==l.current.name?(e.showBarDelete=!0,e.showBarRestore=!0,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showToolMakeCopy=!1):(e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,s.isFolder?(e.showToolPreview=!1,e.showToolOpen=!0,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolOpen=!1,e.showToolMakeCopy=!0)),e.selectedFile=s,_.each(e.assets.folders,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.assets,function(e){e._id!==s._id&&(e.isActive=!1)}))}}angular.module("tessaApp").controller("presentationCtrl",e),e.$inject=["$scope","localStorageService","$uibModal","assetsFctry","$stateParams","$state","toastr","$timeout","Lightbox","ngDialog"]}();
!function(){"use strict";function e(e,s,t,o,n,r){e.folder={},e.create=function(){o._id&&(e.folder.parent_id=o._id),r.createFolder(e.folder).then(function(e){200==e.statusCode&&e.response.success?(n.success(e.response.msg,"Success"),t(function(){s.close("save")},100)):n.error(e.response.msg,"Error")})},e.cancel=function(){s.dismiss("cancel")}}angular.module("tessaApp").controller("presentationFolderModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry"]}();
!function(){"use strict";function e(e,s,t,l,c,o){e.audio="audio"==o,e.config={sources:[{src:c.trustAsResourceUrl(l.asset_url),type:l.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.cancel=function(){t.dismiss("cancel")}}function s(e,s,t,l,c,o){console.log("files: ",c.asset_url),e.pdfName=c.media_name,e.file_type=c.asset_mimetype,"application/pdf"==c.asset_mimetype?e.pdfUrl=l.trustAsResourceUrl(c.asset_url):"text/plain"==c.asset_mimetype?e.pdfUrl=l.trustAsResourceUrl("https://docs.google.com/gview?url="+c.asset_url+"&embedded=true"):e.pdfUrl=l.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+c.asset_url),console.log("$scope.pdfUrl: ",e.pdfUrl),e.cancel=function(){t.dismiss("cancel")}}angular.module("tessaApp").controller("assetsMediaModalCtrl",e).controller("assetsDocsModalCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type"],s.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService"]}();
...
!function(){"use strict";function e(e,s,l,i,n,t,a){e.file={},e.file=a,e.file.isFolder?e.file.foldername=e.file.folder_name:e.file.filename=e.file.asset_name,e.Rename=function(){function i(e){200==e.statusCode&&e.response.success&&(n.success(e.response.msg,"Success"),l(function(){s.close("save")},100))}e.file.isFolder?t.updateFolder(e.file._id,{folder_name:e.file.foldername}).then(i):t.updateAssetFile(e.file._id,{file_name:e.file.filename}).then(i)},e.cancel=function(){s.dismiss("cancel")}}angular.module("tessaApp").controller("assetsRenameModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","asset_file"]}();
!function(){"use strict";function s(s,t,a,e,c,n){s.sharer={},s.cancel=function(){t.dismiss("cancel")}}angular.module("tessaApp").controller("assetsShareModalCtrl",s),s.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry"]}();
...
!function(){"use strict";function s(s,t,a,e,c,n){s.sharer={},s.cancel=function(){t.dismiss("cancel")}}angular.module("tessaApp").controller("assetsMirrorModalCtrl",s),s.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry"]}();
!function(){"use strict";var t=function(t){return function(r,n){return t.uniqBy(r,function(t){return t[n]})}},r=function(){return function(t,r){for(var n="test",u=0;u<t.length;u++);return n}};angular.module("tessaApp").filter("duplicates",["_",t]).filter("count",[r]).filter("ellipsis",function(){return function(t,r,n,u){if(!t)return"";if(n=parseInt(n,10),!n)return t;if(t.length<=n)return t;if(t=t.substr(0,n),r){var e=t.lastIndexOf(" ");e!=-1&&("."!=t.charAt(e-1)&&","!=t.charAt(e-1)||(e-=1),t=t.substr(0,e))}return t+(u||" …")}})}();

...
!function(){"use strict";function e(e,t,s,c,i,n,l,o,r,a){function u(e){e.requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullScreen?e.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT):e.msRequestFullscreen&&e.msRequestFullscreen()}function m(){var e=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement,t=document.fullscreenEnabled||document.mozFullScreenEnabled||document.webkitFullscreenEnabled;t?u(document.documentElement):e&&u(document.documentElement)}function d(){document.exitFullscreen?document.exitFullscreen():document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen()}function p(){t.reload()}function v(e){console.log("Error: ",e)}e.audio="audio"==n,e.mirrorFile=mirrorFile,e.mirrorDevice=a,e.onReady=function(e){e.autoPlay=!0},e.config={autoPlay:!0,sources:[{src:i.trustAsResourceUrl(c.asset_url),type:c.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.device={},e.asset_file=c,e.displayInstallPlugin=!1,e.activeDevices=[],l.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)}),DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",r(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.selectDevice=function(t){console.log("selectDevice"),e.device=t,e.device?(e.device.connected=!0,"audio/mp3"==e.asset_file.asset_mimetype||"audio/mp4"==e.asset_file.asset_mimetype?e.asset_file.asset_type="audio":"video/mp4"==e.asset_file.asset_mimetype||"video/x-flv"==e.asset_file.asset_mimetype||"video/x-msvideo"==e.asset_file.asset_mimetype||"video/x-ms-wmv"==e.asset_file.asset_mimetype||"video/quicktime"==e.asset_file.asset_mimetype||"video/3gpp"==e.asset_file.asset_mimetype?e.asset_file.asset_type="video":e.asset_file.asset_type="none",e.asset_file.deviceUUID=e.device.deviceUUID,e.asset_file.url=window.location.origin+"/presentation.html?s=tEs$@486759",e.device.asset_file=e.asset_file,screenCapture.captureDesktop(),l.emit("pair:getCode",e.device)):m()},e.castScreen=function(){e.mirrorDevice&&screenCapture.captureDesktop()},e.starredSelected=function(){function t(t){200==t.statusCode&&t.response.success&&(toastr.success(t.response.msg,"Success"),e.asset_file.isStarred=1)}e.asset_file&&(e.asset_file.isFolder?o.starredFolder(e.asset_file._id).then(t):o.starredAssetFile(e.asset_file._id).then(t))},e.cancel=function(){e.device?l.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):l.emit("pair:closePresent",{}),d(),s.dismiss("cancel")},e.installPlugin=function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/tessa-presentation/klaagnfcilpkdeicdamepejjmaoahple",p,v)}}function t(e,t,s,c,i,n,l,o,r,a,u,m,d){function p(e){e.requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullScreen?e.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT):e.msRequestFullscreen&&e.msRequestFullscreen()}function v(){var e=document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement,t=document.fullscreenEnabled||document.mozFullScreenEnabled||document.webkitFullscreenEnabled;t?p(document.documentElement):e&&p(document.documentElement)}function f(){document.exitFullscreen?document.exitFullscreen():document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen()}function F(){t.reload()}function w(e){console.log("Error: ",e)}e.pdfName=i.media_name,e.file_type=i.asset_mimetype,e.device={},e.activeDevices=[],e.onMouseMoveResult="",e.displayInstallPlugin=!1,e.mirrorFile=u,e.mirrorDevice=m;var y,D=i;if(DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",a(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),"application/pdf"==i.asset_mimetype)e.pdfUrl=c.trustAsResourceUrl(i.asset_url);else if("text/plain"==i.asset_mimetype)e.pdfUrl=c.trustAsResourceUrl("https://docs.google.com/gview?url="+i.asset_url+"&embedded=true");else{var U=encodeURI(i.asset_url);e.pdfUrl=c.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+U)}e.stop=function(){r.cancel(y)},e.selectDevice=function(t){e.device=t,e.device?(e.device.connected=!0,"audio/mp3"==D.asset_mimetype||"audio/mp4"==D.asset_mimetype?D.asset_type="audio":"video/mp4"==D.asset_mimetype||"video/x-flv"==D.asset_mimetype||"video/x-msvideo"==D.asset_mimetype||"video/x-ms-wmv"==D.asset_mimetype||"video/quicktime"==D.asset_mimetype||"video/3gpp"==D.asset_mimetype?D.asset_type="video":D.asset_type="none",D.deviceUUID=e.device.deviceUUID,D.url=window.location.origin+"/presentation.html?s=tEs$@486759",e.device.asset_file=D,d.captureDesktop(),l.emit("pair:getCode",e.device)):v()},e.castScreen=function(){e.mirrorDevice&&d.captureDesktop()},e.cancel=function(){e.device?l.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}):l.emit("pair:closePresent",{}),e.stop(),f(),s.dismiss("cancel")},e.installPlugin=function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/tessa-presentation/klaagnfcilpkdeicdamepejjmaoahple",F,w)},l.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)})}angular.module("tessaApp").controller("assetsMediaModalCtrl",e).controller("assetsDocsModalCtrl",t),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type","socket","assetsFctry","$timeout","mirrorFile","mirrorDevice"],t.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService","socket","$window","$interval","$timeout","mirrorFile","mirrorDevice","screenCapture"]}();

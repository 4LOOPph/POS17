...
!function(){"use strict";function e(e,t,i,a,l,r,s,c,n,o,u,d,g,f){t.refresh=function(){f.gallery.refresh()},t.angularGridoptions={cssGrid:!0,refreshOnImgLoad:!1,gridWidth:350,gutterSize:20},t.seemore=!0,t.date=new Date,s.user=l.isEmpty(o.get("User"))?[]:JSON.parse(o.get("User")),t.expFilter=l.isEmpty(o.get("articlefilter"))?"all":JSON.parse(o.get("articlefilter")),t.selectedItem=[],t.articlesList=[],t.lists=[],t.tags=[],t.tagscopy=[],t.Portfolio=[],t.Article=[],t.selectedTag=[],t.tagselected=[],t.infiniteScrollData={},t.infiniteScrollData.numToAdd=1,t.infiniteScrollData.currentItems=10,t.dynamicPopover={templateUrl:"myPopoverTemplate.html",backdrop:"static",keyboard:!1},t.pdf={file:null,thumbnail:""},t.resetInfScroll=function(){t.infiniteScrollData.currentItems=t.infiniteScrollData.numToAdd},t.addMoreItems=function(){t.infiniteScrollData.currentItems!==t.lists.length&&(t.infiniteScrollData.currentItems+=t.infiniteScrollData.numToAdd,t.articlesList=t.lists,t.articlesList.length=t.infiniteScrollData.currentItems)},t.generateArticles=function(){t.articlesList=[],t.tags=[],t.tagscopy=[],t.lists=[],t.selectedTag=[],i.getArticles(function(e,i){if(200==i.statusCode&&i.response.success){l.each(i.response.result,function(e){e.name=e.title,e.type="Experience",e.tags.length>=1&&1==e.is_active&&t.articlesList.push(e)}),t.articlesList=l.map(l.orderBy(t.articlesList,"date_created")).reverse(),l.each(t.articlesList,function(e){t.tags.push(e.tags)}),console.log("$scope.articlesList;",t.articlesList),t.tags=l.flattenDeep(t.tags),l.each(t.articlesList,function(e){if(e.mediafiles.length>0&&(e.image=e.mediafiles[0].media_path),!l.isNull(e.thumbnail_media)){var t=e.article_thumbnail;if(t){if("video/mp4"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}}}),t.tagscopy=angular.copy(t.tags),t.tagscopy=l.uniqBy(t.tagscopy,function(e){return e.tags}),t.tagscopy=l.filter(t.tagscopy,function(e){if("Article"!==e.tags&&"Portfolio"!==e.tags)return e}),t.lists=angular.copy(t.articlesList);var a=c("filter")(t.tags,{tags:"Portfolio"}),r=c("filter")(t.tags,{tags:"Article"});a&&l.each(a,function(e){var i=l.find(t.lists,{article_id:e.article_id});t.Portfolio.push(i),l.each(t.articlesList,function(t){t.article_id==e.article_id&&(t.article_type=e.tags)})}),r&&l.each(r,function(e){var i=l.find(t.lists,{article_id:e.article_id});t.Article.push(i),l.each(t.articlesList,function(t){t.article_id==e.article_id&&(t.article_type=e.tags)})})}})},t.clearAll=function(){console.log("clear:",t.tagselected),l.each(t.tagselected,function(e){e.checked=!1}),t.tagselected.splice(t.tagselected)},t.product=function(){o.remove("label"),o.remove("hardtype"),r.go("main.productCatalogue")},t.toggleSelectedTag=function(e){t.event=["Filter by Industry","click",e.tags,l.toString(e.tags_id)],t.tagselected.indexOf(e)==-1?t.tagselected.push(e):t.tagselected=l.filter(t.tagselected,function(t){return t.tags_id!=e.tags_id})},t.trackExperienceArticles=function(e){d.trackEvent("Experience","View",e.title,l.toString(e.article_id))},t.trackExperiencePortfolio=function(e){d.trackEvent("Experience","View",e.title,l.toString(e.article_id))},t.trackExperienceAll=function(e){d.trackEvent(e.type,"View",e.title,l.toString(e.article_id))},t.isTagSelected=function(e){return t.tagselected.indexOf(e)!==-1},t.isOnSelectedTag=function(){return function(e){if(!(t.tagselected.length>0))return!0;var i=!1,a=l.map(t.tagselected,"tags_id");l.forEach(e.tags,function(e){a.indexOf(e.tags_id)!==-1&&(i=!0)});return i}},t.filterArticle=function(e){t.expFilter=e,o.set("articlefilter",JSON.stringify(t.expFilter))},t.$watch("expFilter",function(e){u(function(){if("all"==e)t.articlesList=angular.copy(t.lists);else{t.articlesList=[];var i=c("filter")(t.tags,{tags:e});l.each(i,function(e){var i=l.find(t.lists,{article_id:e.article_id});t.articlesList.push(i)})}},600)}),t.$on("$stateChangeSuccess",function(e,i,a,l,r){"main.experience"==i.name&&(t.tagselected=[],t.generateArticles())})}angular.module("tessaApp").service("imageService",["$q","$http",function(e,t){this.loadImages=function(){return t.jsonp("https://api.flickr.com/services/feeds/photos_public.gne?format=json&jsoncallback=JSON_CALLBACK")}}]).controller("expCtrl",e),e.$inject=["$http","$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$timeout","$frontierAnalytics","imageService","angularGridInstance"]}();

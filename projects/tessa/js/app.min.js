...
!function(){"use strict";function e(e,t,a,r,i,c,n,l,o,s,u){function d(e){return i.map(e,function(e){if("location"==e.type){var t=e.label.replace(/[\s]/g,"");return{label:t.toLowerCase(),type:e.type,index:e.sortindex}}if("configuration"==e.type)return{label:e.label,type:e.type,index:e.sortindex}})}e.solutionTypes="EzeImpress",e.prodTypeLabel=i.isEmpty(o.get("label"))?"Solution":JSON.parse(o.get("label")),u.trackView("Product Catalogue/",e.prodTypeLabel,"/",e.solutionTypes),e.txtSearch="",e.bundles=[],e.productDetails=[],e.seemore=!0,e.products=[],e.productscopy=[],e.ezewificopy=[],e.categoryWifi=[],e.Screens=[],e.ScreenSize=[],e.MediaPlayer=[],e.Mediacopy=[],e.bundleTags=[],e.searchcopy=[],e.filtercopy=[],e.typeselected=[],e.tagselected=[],e.productsAttributesValue=[],e.hardwareType=i.isEmpty(o.get("hardtype"))?"Screens":JSON.parse(o.get("hardtype")),e.location=[{id:8,label:"Indoor",type:"location"},{id:9,label:"Outdoor",type:"location"},{id:10,label:"Semi Outdoor",type:"location"}],e.config=[{id:11,label:"Wall Mounted",type:"configuration"},{id:12,label:"Floor Mounted",type:"configuration"}],e.dynamicPopover={location:"location.html",mounting:"configuration.html",screensize:"screens.html",brightness:"brightness.html",bezel:"bezel.html",usage:"usage.html",displaytechno:"displaytechno.html",weight:"weight.html",dimensions:"dimensions.html",orientation:"orientation.html",displayinterface:"displayinterface.html",vesa:"vesa.html",screentype:"screentype.html",resolution:"resolution.html",templateUrl7:"wifi.html",templateUrl8:"ram.html",templateUrl9:"displaytechno.html",templateUrlStorage:"storage.html",templateUrlGraphics:"graphics.html",templateUrlResolution:"resolutions.html"},e.infiniteScrollData={},e.infiniteScrollData.numToAdd=10,e.infiniteScrollData.currentItems=10,e.resetInfScroll=function(){e.infiniteScrollData.currentItems=e.infiniteScrollData.numToAdd},e.addMoreItems=function(){e.infiniteScrollData.currentItems+=e.infiniteScrollData.numToAdd};var p=function(){async.waterfall([function(a){t.getProductBundle(function(t){var c=[],n=[];e.products=t.response.result,n=i.map(e.products,function(e){return void 0!=e.product_bundle_category[0]&&c.push(e.product_bundle_category[0]),e.products.length>0||(e.weekly=0),e.products});var l=i.flattenDeep(n),o=i.map(l,function(e){return e.product_detail});i.each(l,function(e){var t=i.find(o,{p_id:e.product_id});i.isUndefined(t)||(e.productType_id=t.productType_id,e.sell_price=t.sell_price,t.product_category.length>0&&(e.category_id=t.product_category[0].category_id))});var s=i.groupBy(l,"pb_id");if(i.map(s,function(t,a){var c=r("filter")(t,{productType_id:18}),n=r("filter")(t,{productType_id:17}),l=r("filter")(t,{productType_id:20});if(parseInt(a)==parseInt(a)){if(n.length>0&&(e.resulthardwaresum=i.sum(i.map(n,function(e){return e.sell_price*e.quantity}))),c.length>0&&(e.softwaresum=i.sum(i.map(c,function(e){return e.sell_price*e.quantity}))),l.length>0){var o=r("filter")(l,{category_id:87}),s=r("filter")(l,{category_id:90});o&&(e.deploymentservice=i.sum(i.map(o,function(e){return e.sell_price*e.quantity}))),s&&(e.supportservice=i.sum(i.map(s,function(e){return e.sell_price*e.quantity}))),e.servicesum=i.sum(i.map(l,function(e){return e.sell_price*e.quantity}))}void 0==e.deploymentservice&&void 0==e.supportservice?(e.deploymentservice=0,e.supportservice=0):(e.deploymentservice,e.supportservice);var u=e.deploymentservice+e.softwaresum+e.resulthardwaresum;e.weekly=12*(31.111*u/1e3+e.supportservice)/52}i.each(e.products,function(t){t.pb_id==parseInt(a)&&(t.weekly=e.weekly)})}),i.each(e.products,function(e){i.find(c,function(t){e.pb_id==t.bundle_id&&(e.category_label=t.category_label,e.category_id=t.category_id)})}),e.categoryWifi=i.filter(e.products,function(e){return 101==e.category_id}),e.categoryWifi&&e.categoryWifi.length>0){var u=i.map(e.categoryWifi,function(e){return e.products}),d=i.flattenDeep(u),p=i.map(d,function(e){return e.product_detail});i.each(p,function(e){i.each(e.product_category,function(t){"CMS"==t.category_label&&(e.category_label=t.category_label)})}),e.categWifi=r("filter")(p,{category_label:"CMS"})}a(null,e.products),e.productscopy=angular.copy(e.products),e.ezewificopy=angular.copy(e.categoryWifi)})},function(a,c){t.getProduct(function(t,n){e.allproducts=n.response.result,e.hardware=i.filter(e.allproducts,function(e){return"Hardware"===e.product_type}),e.prodCateg=[];for(var l=0;l<e.hardware.length;l++)for(var o=0;o<e.hardware[l].product_category.length;o++)e.prodCateg.push(e.hardware[l].product_category[o]);i.each(e.hardware,function(t){i.find(e.prodCateg,function(e){t.p_id==e.product_id&&(t.category_id=e.category_id)})});var s=r("filter")(e.hardware,{category_id:80}),u=r("filter")(e.hardware,{category_id:83});c(null,a,s,u)})},function(e,a,r,i){async.each(a,function(e,a){t.getProductAttribute(e.p_id,function(t,r){if(200==r.statusCode&&r.response.success&&e.p_id==r.response.result.p_id){var i=r.response.result.attribute_values;i&&i.length>0?e.attributes=r.response.result:e.attributes=null,a()}})},function(t,c){var n=a;i(null,e,a,r,n)})},function(e,a,r,i,c){async.each(r,function(e,a){t.getProductAttribute(e.p_id,function(t,r){if(200==r.statusCode&&r.response.success&&e.p_id==r.response.result.p_id){var i=r.response.result.attribute_values;i&&i.length>0?e.attributes=r.response.result:e.attributes=null,a()}})},function(t,n){var l=r;c(null,e,a,r,i,l)})},function(t,a,c,n,l,o){if(n&&n.length>0){e.Screens=n,e.Screenscopy=angular.copy(n);var s=[];i.each(n,function(e){i.isNull(e.attributes)||s.push(e.attributes.attribute_values)}),s=i.flattenDeep(s),e.attribute_values=angular.copy(s),e.ScreenSize=r("filter")(s,{attribute:"Screen Size"}),e.Brightness=r("filter")(s,{attribute:"Brightness"}),e.Bezel=r("filter")(s,{attribute:"Bezel Size"}),e.Usage=r("filter")(s,{attribute:"Usage"}),e.Displaytechno=r("filter")(s,{attribute:"Display Technology"}),e.weight=r("filter")(s,{attribute:"Weight"}),e.dimensions=r("filter")(s,{attribute:"Dimensions"}),e.orientation=r("filter")(s,{attribute:"Orientation"}),e.displayinterface=r("filter")(s,{attribute:"Display Interface"}),e.vesa=r("filter")(s,{attribute:"Vesa"}),e.screentype=r("filter")(s,{attribute:"Screen type"}),e.resolution=r("filter")(s,{attribute:"Resolution"})}if(l&&l.length>0){e.MediaPlayer=l,e.Mediacopy=angular.copy(l);var s=[];i.each(l,function(e){i.isNull(e.attributes)||s.push(e.attributes.attribute_values)}),s=i.flattenDeep(s),e.Mediaattribute_values=angular.copy(s),e.Ram=r("filter")(s,{attribute:"RAM"}),e.Storage=r("filter")(s,{attribute:"Storage"}),e.Graphics=r("filter")(s,{attribute:"Graphics"}),e.Resolution=r("filter")(s,{attribute:"Maximum Resolution"})}}])};e.activateTab=function(t){e.solutionTypes=t,u.trackView("Product Catalogue/",e.prodTypeLabel,"/",t)},e.toggleSelectedType=function(t){var a=[];if(l.$broadcast("loading:progress"),t.att_id)if("MediaPlayer"==e.hardwareType)if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),!i.isEmpty(e.txtSearch)&&e.searchmedia)if(console.log("searchmedia:",e.searchmedia),e.tagselected.length>0){var c=[];i.each(e.tagselected,function(t){var a=i.filter(e.Mediaattribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.searchmedia,{p_id:t.p_id});c.push(a)}),s(function(){e.MediaPlayer=c,e.filterMedia=angular.copy(e.MediaPlayer),l.$broadcast("loading:finish")},600)})}else s(function(){e.MediaPlayer=angular.copy(e.searchmedia),l.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var c=[];i.each(e.tagselected,function(t){var a=i.filter(e.Mediaattribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.Mediacopy,{p_id:t.p_id});c.push(a)}),s(function(){e.MediaPlayer=c,e.filterMedia=angular.copy(e.MediaPlayer),l.$broadcast("loading:finish")},600)})}else e.MediaPlayer=angular.copy(e.Mediacopy),s(function(){l.$broadcast("loading:finish")},600);else if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),!i.isEmpty(e.txtSearch)&&e.searchscreen)if(e.tagselected.length>0){var c=[];i.each(e.tagselected,function(t){var a=i.filter(e.attribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.searchscreen,{p_id:t.p_id});"undefined"==typeof c[a]?c=[]:c.push(a)})}),e.Screens=angular.copy(c),e.filterScreens=angular.copy(c),l.$broadcast("loading:finish")}else e.Screens=angular.copy(e.searchscreen),e.filterScreens=angular.copy(e.Screens),s(function(){l.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var c=[];i.each(e.tagselected,function(t){var a=i.filter(e.attribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.Screenscopy,{p_id:t.p_id});c.push(a)}),e.Screens=c,e.filterScreens=angular.copy(c),l.$broadcast("loading:finish")})}else e.Screens=angular.copy(e.Screenscopy),e.filterScreens=angular.copy(e.Screens),l.$broadcast("loading:finish");else{s(function(){n()},600);var n=function(){if(e.typeselected.indexOf(t)==-1?e.typeselected.push(t):e.typeselected=i.filter(e.typeselected,function(e){return e.id!=t.id}),a=d(e.typeselected),i.isEmpty(e.searchcopy)){if(a&&a.length>0){var c=[];i.map(e.productscopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})}),i.each(a,function(t){var a=[];a=r("filter")(e.bundleTags,{tags:t.label}),a.length>0&&i.each(a,function(t){var a=i.find(e.productscopy,{pb_id:t.pb_id});c.push(a)}),e.filterProduct=i.uniqBy(c,function(e){return e._id})})}else e.filterProduct=angular.copy(e.productscopy);e.products=angular.copy(e.filterProduct),e.filtercopy=angular.copy(e.filterProduct),l.$broadcast("loading:finish")}else{if(a&&a.length>0){var c=[];i.map(e.searchcopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})}),i.each(a,function(t){var a=[];a=r("filter")(e.bundleTags,{tags:t.label}),a.length>0&&i.each(a,function(t){var a=i.find(e.searchcopy,{pb_id:t.pb_id});c.push(a)}),console.log("arry:",c),e.filterProduct=i.uniqBy(c,function(e){return e._id}),s(function(){l.$broadcast("loading:finish")},600)})}else e.filterProduct=angular.copy(e.searchcopy),s(function(){l.$broadcast("loading:finish")},600);e.products=angular.copy(e.filterProduct),e.filtercopy=angular.copy(e.filterProduct)}}}},e.refresh=function(){l.$broadcast("loading:progress"),s(function(){p(),l.$broadcast("loading:finish")},600)},e.uncheck=function(t,a){var c=[];if(t.checked)if(t.att_id)if(i.each(e.tagselected,function(e){e._id==t._id&&(e.checked=!1)}),"MediaPlayer"==e.hardwareType)if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),!i.isEmpty(e.txtSearch)&&e.searchmedia)if(e.tagselected.length>0){var n=[];i.each(e.tagselected,function(t){var a=i.filter(e.Mediaattribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.searchmedia,{p_id:t.p_id});n.push(a)}),s(function(){e.MediaPlayer=n,e.filterMedia=angular.copy(e.MediaPlayer),l.$broadcast("loading:finish")},600)})}else s(function(){e.MediaPlayer=angular.copy(e.searchmedia),l.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var n=[];i.each(e.tagselected,function(t){var a=i.filter(e.Mediaattribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.Mediacopy,{p_id:t.p_id});n.push(a)}),s(function(){e.MediaPlayer=n,e.filterMedia=angular.copy(e.MediaPlayer),l.$broadcast("loading:finish")},600)})}else e.MediaPlayer=angular.copy(e.Mediacopy),s(function(){l.$broadcast("loading:finish")},600);else if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),!i.isEmpty(e.txtSearch)&&e.searchscreen)if(e.tagselected.length>0){var n=[];i.each(e.tagselected,function(t){var a=i.filter(e.attribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.searchscreen,{p_id:t.p_id});n.push(a)}),e.Screens=n,e.filterScreens=angular.copy(n),l.$broadcast("loading:finish")})}else e.Screens=angular.copy(e.searchscreen),e.filterScreens=angular.copy(e.Screens),s(function(){l.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var n=[];i.each(e.tagselected,function(t){var a=i.filter(e.attribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.Screenscopy,{p_id:t.p_id});n.push(a)}),e.Screens=n,e.filterScreens=angular.copy(n),l.$broadcast("loading:finish")})}else e.Screens=angular.copy(e.Screenscopy),e.filterScreens=angular.copy(e.Screens),l.$broadcast("loading:finish");else{if(i.each(e.typeselected,function(e){e.id==t.id&&(e.checked=!1)}),e.typeselected.splice(a,1),c=d(e.typeselected),i.isEmpty(e.searchcopy))if(c&&c.length>0){var n=[];i.map(e.productscopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})}),i.each(c,function(t){var a=[];a=r("filter")(e.bundleTags,{tags:t.label}),a.length>0&&i.each(a,function(t){var a=i.find(e.productscopy,{pb_id:t.pb_id});n.push(a)}),e.filterProduct=i.uniqBy(n,function(e){return e._id})})}else e.filterProduct=angular.copy(e.productscopy);else if(c&&c.length>0){var n=[];i.map(e.searchcopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})}),i.each(c,function(t){var a=[];a=r("filter")(e.bundleTags,{tags:t.label}),a.length>0&&i.each(a,function(t){var a=i.find(e.searchcopy,{pb_id:t.pb_id});n.push(a)}),e.filterProduct=i.uniqBy(n,function(e){return e._id})})}else e.filterProduct=angular.copy(e.searchcopy);e.products=angular.copy(e.filterProduct),e.filtercopy=angular.copy(e.filterProduct)}},e.searchData=function(){if(l.$broadcast("loading:progress"),"Solution"==e.prodTypeLabel){s(function(){t()},600);var t=function(){i.isEmpty(e.txtSearch)?(e.products=e.productscopy,l.$broadcast("loading:finish")):i.isEmpty(e.typeselected)&&"EzeImpress"==e.solutionTypes?s(function(){e.products=r("filter")(e.productscopy,e.txtSearch),e.searchcopy=angular.copy(e.products),l.$broadcast("loading:finish")},300):i.isEmpty(e.typeselected)&&"EzeWifi"==e.solutionTypes?s(function(){e.categoryWifi=r("filter")(e.ezewificopy,e.txtSearch),e.searchcopy=angular.copy(e.products),l.$broadcast("loading:finish")},300):i.isEmpty(e.typeselected)||"EzeImpress"!=e.solutionTypes?i.isEmpty(e.typeselected)||"EzeWifi"!=e.solutionTypes||s(function(){e.products=r("filter")(e.filtercopy,e.txtSearch),e.searchcopy=angular.copy(e.products),l.$broadcast("loading:finish")},300):s(function(){e.products=r("filter")(e.filtercopy,e.txtSearch),e.searchcopy=angular.copy(e.products),l.$broadcast("loading:finish")},300)}}else{s(function(){t()},600);var t=function(){i.isEmpty(e.txtSearch)?"MediaPlayer"==e.hardwareType?i.isEmpty(e.tagselected)?(e.MediaPlayer=e.Mediacopy,l.$broadcast("loading:finish")):(e.MediaPlayer=angular.copy(e.filterMedia),l.$broadcast("loading:finish")):i.isEmpty(e.tagselected)?e.Screens=e.Screenscopy:(console.log("NOT EMPTY TAG"),e.Screens=angular.copy(e.filterScreens),l.$broadcast("loading:finish")):i.isEmpty(e.tagselected)&&"Screens"==e.hardwareType?s(function(){e.Screens=r("filter")(e.Screenscopy,e.txtSearch),e.searchscreen=angular.copy(e.Screens),l.$broadcast("loading:finish")},300):i.isEmpty(e.tagselected)&&"MediaPlayer"==e.hardwareType?s(function(){e.MediaPlayer=r("filter")(e.Mediacopy,e.txtSearch),e.searchmedia=angular.copy(e.MediaPlayer),l.$broadcast("loading:finish")},300):i.isEmpty(e.tagselected)||"Screens"!=e.hardwareType?i.isEmpty(e.tagselected)||"MediaPlayer"!=e.hardwareType||s(function(){e.MediaPlayer=r("filter")(e.filterMedia,e.txtSearch),e.copymedia=angular.copy(e.MediaPlayer),l.$broadcast("loading:finish")},300):s(function(){e.Screens=r("filter")(e.filterScreens,e.txtSearch),e.copyscreens=angular.copy(e.Screens),l.$broadcast("loading:finish")},300)}}},e.clear=function(){"Solution"==e.prodTypeLabel?i.isEmpty(e.txtSearch)&&i.isEmpty(e.typeselected)||(e.txtSearch="",i.forEach(e.typeselected,function(e){e.checked=!1}),e.refresh()):"MediaPlayer"==e.hardwareType?i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.refresh()):i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected,1),e.refresh())},e.activeProd=function(t){e.prodTypeLabel=t,"Hardware"==t?(e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.hardwareType)):(e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.solutionTypes)),o.set("label",JSON.stringify(e.prodTypeLabel))},e.activeHard=function(t){e.hardwareType=t,o.set("hardtype",JSON.stringify(e.hardwareType)),u.trackView("Product Catalogue/",e.prodTypeLabel,"/",t)},e.togglemodal=function(e){var t=c.open({animation:!0,templateUrl:"./views/share.modal.html",controller:"articleCtrl",size:"sm",resolve:{article:function(){return e}}});t.result.then(function(){n.reload()},function(){console.info("Modal dismissed")})},e.refresh()}angular.module("tessaApp").controller("productCtrl",e),e.$inject=["$scope","APIFactory","$location","$filter","_","$uibModal","$state","$rootScope","localStorageService","$timeout","$frontierAnalytics"]}();
...
!function(){"use strict";function e(e,t,i,a,l,s,r,n,d,o){e.detail=[],e.relatedExperience=[],e.bundles=[],e.slides=[],d.selected_id&&(async.waterfall([function(e){n.getArticles(function(t){200==t.statusCode&&t.response.result&&e(null,t.response.result)})},function(t,i){n.getArticleDetail(d.selected_id,function(a){if(200==a.statusCode&&a.response.success){e.detail=a.response.result;var l=0;i(null,t,a.response.result),_.isEmpty(e.detail.mediafiles)||_.each(e.detail.mediafiles,function(e){if(e){if("video/mp4"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==e.media_mimetype)return e.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}return e.index=l++}),_.each(e.detail.mediafiles,function(t){"image/png"==t.media_mimetype||"image/jpeg"==t.media_mimetype?(e.slides.push({media_name:t.media_name,media_mimetype:t.media_mimetype,image:t.media_path,index:l}),l++):"video/mp4"==t.media_mimetype&&(e.slides.push({media_name:t.media_name,media_mimetype:t.media_mimetype,image:t.media_path,url:t.url,index:l}),l++)}),console.log("$scope.detail:",e.detail),console.log("$scope.slides:",e.slides)}})},function(e,t,i){n.getArticleTags(t.article_id,function(a){if(200==a.statusCode&&a.response.success){var l=[];_.map(a.response.result,function(e){"Article"!=e.tags&&"Portfolio"!=e.tags&&l.push(e)}),i(null,e,t,l)}})},function(t,i,a,l){var s=[],r=_.flattenDeep(_.map(t,function(e){return e.tags}));_.map(a,function(e){_.each(r,function(t){e.tags==t.tags&&s.push(t)})}),_.each(t,function(t){_.each(s,function(i){t.article_id==i.article_id&&e.relatedExperience.push(t)})});var d=_.uniq(e.relatedExperience);e.relatedExperiences=_.filter(d,function(e){return i.article_id!=e.article_id}),_.each(e.relatedExperiences,function(e){if(e.mediafiles.length>0&&(e.image=e.mediafiles[0].media_path),!_.isNull(e.thumbnail_media)){var t=e.article_thumbnail;if(t){if("video/mp4"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}}}),n.getProductBundle(function(t){var a=t.response.result;i.article_features.length>0?_.each(i.article_features,function(t){var i=_.find(a,{pb_id:t.bundle_id});e.bundles.push(i)}):e.norelated="No related solutions"})}]),e.openShareModal=function(){var t=o.open({animation:!0,templateUrl:"./views/share.modal.html",size:"md",backdrop:!1,windowClass:"sharemodal",controller:"ShareModalInstanceCtrl",resolve:{article:function(){return e.detail},param:function(){return"article"}}});t.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})},e.select=function(e){r.hash("article_page"),t.go("main.articlePage",{selected_id:e},{reload:!0})})}angular.module("tessaApp").controller("ModalInstanceCtrl",e),e.$inject=["$scope","$state","sharerFactory","toastr","$window","$anchorScroll","$location","APIFactory","$stateParams","$uibModal"]}();
...
!function(){"use strict";function e(e,t,a,n,o,c,r,s,l,i,u,d,p){t.seemore=!0,t.date=new Date,t.msg="hello",t.shows=!1,t.value="",r.cartItems=o.isEmpty(i.get("Cart"))?[]:JSON.parse(i.get("Cart")),r.user=o.isEmpty(i.get("User"))?[]:JSON.parse(i.get("User")),t.seemore=!t.custom,t.searchinput=u.value,angular.element(document).ready(function(){$("#trigger-sidebar").click(function(){function e(){var e=$(window).width();e<700?$("#myBar, .acc-menu li a").css({"min-width":"0"}):e>700&&$("#myBar, .acc-menu li a").css({"min-width":"56px"})}$(".collapsible").toggle(),$(".collapsible").is(":visible")?$("#myBar, .acc-menu li a").css({"min-width":"245px"}):(e(),$(window).resize(e))}),$("#trigger-close-search, #srch-pop, .exit").click(function(){$("#toolbar-search").hide()}),$("#trigger-toolbar-search,#srch-pop").click(function(){$("#toolbar-search").show()}),$(document).on("click",".btn-checkbox",function(e){e.stopPropagation(),$(this).toggleClass("btn-checkbox-active")})}),async.waterfall([function(e){a.getArticles(function(t){o.each(t.response.result,function(e){e.type="Experience"}),o.each(t.response.result,function(e){e.name=e.title,e.id=e.article_id}),e(null,t.response.result)})},function(e,t){a.getProductBundle(function(a){o.each(a.response.result,function(e){e.type="Solutions"}),o.each(a.response.result,function(e){e.name=e.bundle_name,e.id=e.pb_id}),t(null,a.response.result,e)})},function(e,t,n){var c=[];a.getProduct(function(a,r){c=o.filter(r.response.result,function(e){return"Hardware"==e.product_type}),o.each(c,function(e){e.type="Hardware"}),o.each(c,function(e){e.name=e.item_name,e.id=e.p_id}),n(null,c,e,t)})},function(e,a,n,c){var r=[];o.each(e,function(e){1==e.is_published&&0==e.is_archived&&r.push(e)}),o.each(a,function(e){1==e.is_published&&0==e.is_archived&&r.push(e)}),o.each(n,function(e){1==e.is_active&&r.push(e)}),t.allproducts=r}]),t.signout=function(){d.logout().then(function(e){200==e.statusCode&&e.response.success&&(p.success(e.response.msg,"Success"),c.reload())})},t.dynamicPopover={templateUrl:"myPopoverTemplate.html"},t.clear=function(e){e?$("#searchBar").val($("#searchBar").val().slice(0,-1)):$("#searchBar").val("")},t.resetCart=function(){for(var e=t.customers.length;e--;){var a=t.customers[e];"expired"==a.status&&t.customers.splice(e,1)}},t.refreshDelay=function(e){t.search=e,t.allSearch=[],angular.isUndefined(e)||null==e||""==e?t.allSearch=[]:a.getAll(e).then(function(a){if(200==a.statusCode&&a.response.success){o.each(a.response.result.values,function(e){return"Services"==e.type?null:void t.allSearch.push(e)}),o.each(t.allSearch,function(e){"articles"==e.self&&(e.group="Experience"),"bundles"==e.self&&(e.group="Solutions"),"products"==e.self&&(e.group="Hardware")});var n=t.allSearch.slice();return e&&n.indexOf(e)===-1&&n.unshift(e),n}})},t.cartModal=function(){var e=l.open({animation:!0,templateUrl:"./views/cart.modal.html",size:"md",controller:"CartCtrl",windowClass:"xd-modal"});e.result.then(function(e){t.selected=e},function(){console.info("Modal dismissed at: "+new Date),i.remove("Payment")})},t.compareModal=function(){var e=l.open({animation:!0,templateUrl:"./views/compare.modal.html",size:"lg",windowClass:"xd-modal"});e.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})},t.inputProductChanged=function(e){t.searchinput=e},t.dataSelected=function(e){e&&(c.go("main.search",{value:e.originalObject},{reload:!1}),e.originalObject&&c.go("main.search",{value:e.originalObject},{reload:!1}),e.title&&c.go("main.search",{value:e.title},{reload:!1}))},t.clearInput=function(e){e?t.$broadcast("angucomplete-alt:clearInput",e):t.$broadcast("angucomplete-alt:clearInput")}}function t(e,t,a,n){e.product=function(){console.log("product():"),n.remove("label"),n.remove("hardtype"),a.go("main.productCatalogue")}}angular.module("tessaApp").controller("headerCtrl",e).controller("sidebarCtrl",t),e.$inject=["$http","$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$stateParams","AuthFactory","toastr"],t.$inject=["$scope","$location","$state","localStorageService"]}();
...
!function(){"use strict";function e(e,s,t,o,a,i,l,r,n,c,d,m,f){function u(e,s){if(0==e)return"0 Byte";var t=1024,o=s+1||3,a=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],i=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,i)).toFixed(o))+" "+a[i]}function p(s){200==s.statusCode&&s.response.success&&(e.items=s.response.result,e.assets=angular.copy(s.response.result),e.isLoading=!1,e.showBread=!0,e.disableToolNewFolder=!1,"main.presentation"==i.current.name?(e.activeAllFiles=!0,e.showToolNewFolder=!0,e.showToolNewUpload=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return null==e.folder_id}),e.assets.folderscopy=angular.copy(e.assets.folders),e.assets.assetscopy=angular.copy(e.assets.assets)):"main.presentation_starred"==i.current.name?(e.activeStarredFiles=!0,e.showToolNewFolder=!1,e.showToolNewUpload=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.starred.folderscopy=angular.copy(e.assets.folders),e.starred.assetscopy=angular.copy(e.assets.assets)):"main.presentation_trash"==i.current.name&&(e.activeTrashFiles=!0,e.showToolNewFolder=!1,e.showToolNewUpload=!1,e.showBarDelete=!1,e.showBarRestore=!0,e.showBarShare=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showBarMore=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 1==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 1==e.isDeleted}),e.trash.folderscopy=angular.copy(e.assets.folders),e.trash.assetscopy=angular.copy(e.assets.assets)),_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=u(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=u(e.asset_filesize),e.isActive=!1,e.isFolder=!1}),e.assets.folders&&e.assets.assets&&(e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1)))}e.items={},e.assets={},e.trash={},e.starred={},e.DeSelectAll=!1,e.selectedText="Select All",e.selectedFile={},e.isList="null"!=s.get("isList")&&0!=s.get("isList"),e.isLoading=!0,e.showBread=!1,e.showFiles=!1,e.disableToolNewFolder=!0,e.showToolNewFolder=!0,e.showToolNewUpload=!0,e.showToolMakeCopy=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.activeAllFiles=!1,e.activeSharedFiles=!1,e.activeStarredFiles=!1,e.activeTrashFiles=!1,e.activeDevices=[],f.on("pair:init",function(){console.log("pair:init tessa")}),f.on("pair:sendCode",function(s){_.find(e.activeDevices,{deviceUUID:s.deviceUUID})||e.activeDevices.push(s)}),e.changeDisplay=function(){e.isList=!e.isList,s.set("isList",e.isList)},e.refreshAssets=function(){e.assets={},e.items={},"main.presentation"==i.current.name?e.activePage="Assets":"main.presentation_starred"==i.current.name?e.activePage="Favorites":"main.presentation_trash"==i.current.name&&(e.activePage="Trash"),a._id&&_.isUndefined(a.sub_id)?(e.isLoading=!0,o.getFolderAssets(a._id).then(p)):a._id&&a.sub_id?(e.showToolNewFolder=!1,e.isLoading=!0,o.getFolderAssets(a.sub_id).then(p)):o.getAllAssets().then(p)},e.refreshAssets(),e.showAllFiles=function(){console.log("$state.current.name:",i.current.name),"main.presentation"==i.current.name?(e.activePage="Assets",e.refreshAssets()):i.go("main.presentation")},e.showAllTrash=function(){console.log("$state.current.name:",i.current.name),"main.presentation_trash"==i.current.name?(e.activePage="Trash",e.refreshAssets()):i.go("main.presentation_trash")},e.showAllStarred=function(){"main.presentation_starred"==i.current.name?(e.activePage="Favorites",e.refreshAssets()):i.go("main.presentation_starred")},e.castModal=function(){var s=t.open({animation:!0,templateUrl:"./views/folder/cast.html",windowClass:"xd-modal",controller:"assetsMirrorModalCtrl",resolve:{activeDevices:function(){return e.activeDevices},asset_file:function(){return e.selectedFile}}});s.result.then(function(){})},e.newFolder=function(){var e=t.open({animation:!0,templateUrl:"./views/folder/new-item.html",size:"sm",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"});e.result.then(function(e){e&&i.reload()})},e.newUploader=function(){var s=t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});s.result.then(function(s){s&&e.refreshAssets()})},e.copySelected=function(){var e=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/copy.html",controller:"modalpresentation"});e.result.then(function(e){},function(){console.info("Modal dismissed at: "+new Date)})},e.shareToOthers=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/share.html",controller:"assetsShareModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){},function(){console.info("Modal dismissed at: "+new Date)})},e.renameSelected=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/rename.html",controller:"assetsRenameModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&i.reload()})},e.deleteSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))}console.log("deleteSelected"),e.modal={title:"Remove?",message:"Are you sure to remove this?"},c.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){_.isEmpty(e.selectedFile)||(e.selectedFile.isFolder?e.selectedFile.isDeleted?o.deleteFolder(e.selectedFile._id).then(s):o.trashFolder(e.selectedFile._id).then(s):e.selectedFile.isDeleted?o.deleteAssetFile(e.selectedFile._id).then(s):o.trashAssetFile(e.selectedFile._id).then(s))})},e.moveSelected=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/move.html",controller:"assetsMoveModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&i.reload()})},e.previewSelected=function(){e.selectedFile&&(e.selectedFile.isFolder?(e.openFolder(e.selectedFile),m.trackEvent("Presentation Assets","View",e.selectedFile.folder_name,e.selectedFile.folder_id)):(e.openFile(e.selectedFile),m.trackEvent("Presentation Assets","View",e.selectedFile.asset_name,e.selectedFile.asset_id)))},e.starredSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?o.starredFolder(e.selectedFile._id).then(s):o.starredAssetFile(e.selectedFile._id).then(s))},e.restoreSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?o.restoreFolder(e.selectedFile._id).then(s):o.restoreAssetFile(e.selectedFile._id).then(s))},e.openLightboxModal=function(e){var s=[];s.push({url:e.asset_url,caption:e.asset_name,thumbUrl:e.asset_url}),n.openModal(s,0)},e.openVideoModal=function(e){console.log("files:",e),t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/media.html",controller:"assetsMediaModalCtrl",windowClass:"xd-modal",size:"lg",resolve:{files:function(){return e},type:function(){return"video"}}})},e.openAudioModal=function(e){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/media.html",controller:"assetsMediaModalCtrl",windowClass:"xd-modal",size:"md",resolve:{files:function(){return e},type:function(){return"audio"}}})},e.openDocsModal=function(e){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/preview.html",controller:"assetsDocsModalCtrl",size:"lg",windowClass:"modal-fullscreen xd-modal",resolve:{files:function(){return e}}})},e.openFolder=function(s){s.isFolder&&("main.presentation_trash"!==i.current.name?a._id?i.go("main.opensubfolder",{_id:a._id,sub_id:s._id}):i.go("main.openfolder",{_id:s._id}):(e.modal={title:"This folder is in your trash",message:"To view this folder, youll need to restore it from your trash. Restore folder?"},c.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.restoreFolder(s._id).then(function(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))})})))},e.openFile=function(s){if("image/jpeg"==s.asset_mimetype||"image/jpg"==s.asset_mimetype||"image/gif"==s.asset_mimetype||"image/x-ms-bmp"==s.asset_mimetype||"image/png"==s.asset_mimetype)e.openLightboxModal(s);else if("audio/mp3"==s.asset_mimetype||"audio/mp4"==s.asset_mimetype)e.openAudioModal(s);else if("video/mp4"==s.asset_mimetype||"video/x-flv"==s.asset_mimetype||"video/x-msvideo"==s.asset_mimetype||"video/x-ms-wmv"==s.asset_mimetype||"video/quicktime"==s.asset_mimetype||"video/3gpp"==s.asset_mimetype)e.openVideoModal(s);else if("application/pdf"==s.asset_mimetype)e.openDocsModal(s);else if("text/plain"==s.asset_mimetype)e.openDocsModal(s);else if("application/msword"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.wordprocessingml.document"==s.asset_mimetype)e.openDocsModal(s);else if("text/csv"==s.asset_mimetype||"application/vnd.ms-excel"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"==s.asset_mimetype)e.openDocsModal(s);else{if("application/vnd.openxmlformats-officedocument.presentationml.presentation"!=s.asset_mimetype&&"application/vnd.ms-powerpoint"!=s.asset_mimetype)return void l.warning("No available tools to open","Failed");e.openDocsModal(s)}},e.deleteFile=function(s){console.log("media: ",s),e.modal={title:"Remove File",message:"Are you sure to remove the file?"},c.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.deleteAssetFile(s._id).then(function(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))})})},e.clearSelection=function(){console.log("clearSelection"),e.selectedFile={},e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,e.showToolOpen=!1,_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1})},e.searchData=function(){_.isEmpty(e.txtSearch)||"main.presentation_trash"!=i.current.name?_.isEmpty(e.txtSearch)&&"main.presentation_trash"==i.current.name?(e.assets.folders=e.trash.folderscopy,e.assets.assets=e.trash.assetscopy):_.isEmpty(e.txtSearch)||"main.presentation_starred"!=i.current.name?_.isEmpty(e.txtSearch)&&"main.presentation_starred"==i.current.name?(e.assets.folders=e.starred.folderscopy,e.assets.assets=e.starred.assetscopy):_.isEmpty(e.txtSearch)||"main.presentation"!=i.current.name?_.isEmpty(e.txtSearch)&&"main.presentation"==i.current.name&&(e.assets.folders=e.assets.folderscopy,e.assets.assets=e.assets.assetscopy):(e.assets.folders=d("filter")(e.assets.folderscopy,e.txtSearch),e.assets.assets=d("filter")(e.assets.assetscopy,e.txtSearch)):(e.assets.folders=d("filter")(e.starred.folderscopy,e.txtSearch),e.assets.assets=d("filter")(e.starred.assetscopy,e.txtSearch)):(e.assets.folders=d("filter")(e.trash.folderscopy,e.txtSearch),e.assets.assets=d("filter")(e.trash.assetscopy,e.txtSearch)),_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=u(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=u(e.asset_filesize),e.isActive=!1,e.isFolder=!1})},e.selectAll=function(){0==e.DeSelectAll?(e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,_.each(e.assets.folders,function(e){e.isActive=!0}),_.each(e.assets.assets,function(e){e.isActive=!0}),e.DeSelectAll=!0,e.selectedText="Deselect All"):(e.showBarDelete=!1,e.showBarRestore=!0,e.showBarShare=!1,e.showBarMore=!1,_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1}),e.DeSelectAll=!1,e.selectedText="Select All")},e.activeSelected=function(s){console.log("folder:",s),e.DeSelectAll=!1,e.selectedText="Select All",s&&(s.isActive=!0,"main.presentation_trash"==i.current.name?(e.showBarDelete=!0,e.showBarRestore=!0,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showToolMakeCopy=!1):(e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,s.isFolder?(e.showToolPreview=!1,e.showToolOpen=!0,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolOpen=!1,e.showToolMakeCopy=!0)),e.selectedFile=s,_.each(e.assets.folders,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.assets,function(e){e._id!==s._id&&(e.isActive=!1)}),_.isNull(s.folder_id)?m.trackEvent("Presentation Assets","Click",s.asset_name,s.asset_id):m.trackEvent("Presentation Assets","Click",s.folder_name,s.folder_id))}}angular.module("tessaApp").controller("presentationCtrl",e),e.$inject=["$scope","localStorageService","$uibModal","assetsFctry","$stateParams","$state","toastr","$timeout","Lightbox","ngDialog","$filter","$frontierAnalytics","socket"]}();
...
!function(){"use strict";function e(e,s,t,i,a,c,o,d){e.audio="audio"==c,e.onReady=function(e){e.autoPlay=!0},e.config={autoPlay:!0,sources:[{src:a.trustAsResourceUrl(i.asset_url),type:i.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.device={},e.asset_file=i,e.activeDevices=[],o.on("pair:sendCode",function(s){_.find(e.activeDevices,{deviceUUID:s.deviceUUID})||e.activeDevices.push(s)}),e.selectDevice=function(s){console.log("selectDevice"),e.device=s,e.device&&(e.device.connected=!0,"audio/mp3"==e.asset_file.asset_mimetype||"audio/mp4"==e.asset_file.asset_mimetype?e.asset_file.asset_type="audio":"video/mp4"==e.asset_file.asset_mimetype||"video/x-flv"==e.asset_file.asset_mimetype||"video/x-msvideo"==e.asset_file.asset_mimetype||"video/x-ms-wmv"==e.asset_file.asset_mimetype||"video/quicktime"==e.asset_file.asset_mimetype||"video/3gpp"==e.asset_file.asset_mimetype?e.asset_file.asset_type="video":e.asset_file.asset_type="none",e.asset_file.deviceUUID=e.device.deviceUUID,e.device.asset_file=e.asset_file,o.emit("pair:getCode",e.device))},e.starredSelected=function(){function s(s){200==s.statusCode&&s.response.success&&(toastr.success(s.response.msg,"Success"),e.asset_file.isStarred=1)}e.asset_file&&(e.asset_file.isFolder?d.starredFolder(e.asset_file._id).then(s):d.starredAssetFile(e.asset_file._id).then(s))},e.cancel=function(){t.dismiss("cancel")}}function s(e,s,t,i,a,c,o){e.pdfName=a.media_name,e.file_type=a.asset_mimetype,e.device={};var d=a;e.activeDevices=[],o.on("pair:sendCode",function(s){_.find(e.activeDevices,{deviceUUID:s.deviceUUID})||e.activeDevices.push(s)}),"application/pdf"==a.asset_mimetype?e.pdfUrl=i.trustAsResourceUrl(a.asset_url):"text/plain"==a.asset_mimetype?e.pdfUrl=i.trustAsResourceUrl("https://docs.google.com/gview?url="+a.asset_url+"&embedded=true"):e.pdfUrl=i.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+a.asset_url),e.selectDevice=function(s){console.log("selectDevice"),e.device=s,e.device&&(e.device.connected=!0,"audio/mp3"==d.asset_mimetype||"audio/mp4"==d.asset_mimetype?d.asset_type="audio":"video/mp4"==d.asset_mimetype||"video/x-flv"==d.asset_mimetype||"video/x-msvideo"==d.asset_mimetype||"video/x-ms-wmv"==d.asset_mimetype||"video/quicktime"==d.asset_mimetype||"video/3gpp"==d.asset_mimetype?d.asset_type="video":d.asset_type="none",d.deviceUUID=e.device.deviceUUID,e.device.asset_file=d,o.emit("pair:getCode",e.device))},e.cancel=function(){t.dismiss("cancel")}}angular.module("tessaApp").controller("assetsMediaModalCtrl",e).controller("assetsDocsModalCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type","socket","assetsFctry"],s.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService","socket"]}();
...
!function(){"use strict";function e(e,i,s,t,c,o,a,n,d){e.device={},e.activeDevices=[],e.activeDevices=angular.copy(n),console.log("assetsMirrorModalCtrl: "),a.on("pair:sendCode",function(i){_.find(e.activeDevices,{deviceUUID:i.deviceUUID})||e.activeDevices.push(i)}),a.on("disconnect",function(e){console.log("disconnect: ",e)}),e.selectDevice=function(i){e.device=i},e.connectDevice=function(){console.log("$scope.device: ",e.device),e.device&&(e.device.connected=!0,"audio/mp3"==d.asset_mimetype||"audio/mp4"==d.asset_mimetype?d.asset_type="audio":"video/mp4"==d.asset_mimetype||"video/x-flv"==d.asset_mimetype||"video/x-msvideo"==d.asset_mimetype||"video/x-ms-wmv"==d.asset_mimetype||"video/quicktime"==d.asset_mimetype||"video/3gpp"==d.asset_mimetype?d.asset_type="video":d.asset_type="none",d.deviceUUID=e.device.deviceUUID,e.device.asset_file=d,console.log("selectDevice: ",e.device),a.emit("pair:getCode",e.device))},e.cancel=function(){i.dismiss("cancel")}}angular.module("tessaApp").controller("assetsMirrorModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","socket","activeDevices","asset_file"]}();

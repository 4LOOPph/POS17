...
!function(){"use strict";function e(e,t,s,c,n,l,i,o,u){function a(){t.reload()}function m(e){console.log("Error: ",e)}e.audio="audio"==l,e.onReady=function(e){e.autoPlay=!0},e.config={autoPlay:!0,sources:[{src:n.trustAsResourceUrl(c.asset_url),type:c.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.device={},e.asset_file=c,e.displayInstallPlugin=!1,e.activeDevices=[],i.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)}),DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",u(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.selectDevice=function(t){console.log("selectDevice"),e.device=t,e.device?(e.device.connected=!0,"audio/mp3"==e.asset_file.asset_mimetype||"audio/mp4"==e.asset_file.asset_mimetype?e.asset_file.asset_type="audio":"video/mp4"==e.asset_file.asset_mimetype||"video/x-flv"==e.asset_file.asset_mimetype||"video/x-msvideo"==e.asset_file.asset_mimetype||"video/x-ms-wmv"==e.asset_file.asset_mimetype||"video/quicktime"==e.asset_file.asset_mimetype||"video/3gpp"==e.asset_file.asset_mimetype?e.asset_file.asset_type="video":e.asset_file.asset_type="none",e.asset_file.deviceUUID=e.device.deviceUUID,e.device.asset_file=e.asset_file):(console.log("container.webkitRequestFullScreen();"),(document.fullScreenElement&&null!==document.fullScreenElement||!document.mozFullScreen&&!document.webkitIsFullScreen)&&(document.documentElement.requestFullScreen?document.documentElement.requestFullScreen():document.documentElement.mozRequestFullScreen?document.documentElement.mozRequestFullScreen():document.documentElement.webkitRequestFullScreen&&document.documentElement.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT)))},e.starredSelected=function(){function t(t){200==t.statusCode&&t.response.success&&(toastr.success(t.response.msg,"Success"),e.asset_file.isStarred=1)}e.asset_file&&(e.asset_file.isFolder?o.starredFolder(e.asset_file._id).then(t):o.starredAssetFile(e.asset_file._id).then(t))},e.cancel=function(){e.device&&i.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}),document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen(),s.dismiss("cancel")},e.installPlugin=function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/your-chrome-extension-id",a,m)}}function t(e,t,s,c,n,l,i,o,u,a){function m(){t.reload()}function d(e){console.log("Error: ",e)}e.pdfName=n.media_name,e.file_type=n.asset_mimetype,e.device={},e.activeDevices=[],e.onMouseMoveResult="",e.displayInstallPlugin=!1;var r,p=n;DetectRTC.screen.getChromeExtensionStatus(function(t){"installed-enabled"!=t&&(DetectRTC.screen.chromeMediaSource="desktop",a(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),"application/pdf"==n.asset_mimetype?e.pdfUrl=c.trustAsResourceUrl(n.asset_url):"text/plain"==n.asset_mimetype?e.pdfUrl=c.trustAsResourceUrl("https://docs.google.com/gview?url="+n.asset_url+"&embedded=true"):e.pdfUrl=c.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+n.asset_url),e.stop=function(){u.cancel(r)},e.selectDevice=function(t){e.device=t,e.device?(e.device.connected=!0,"audio/mp3"==p.asset_mimetype||"audio/mp4"==p.asset_mimetype?p.asset_type="audio":"video/mp4"==p.asset_mimetype||"video/x-flv"==p.asset_mimetype||"video/x-msvideo"==p.asset_mimetype||"video/x-ms-wmv"==p.asset_mimetype||"video/quicktime"==p.asset_mimetype||"video/3gpp"==p.asset_mimetype?p.asset_type="video":p.asset_type="none",p.deviceUUID=e.device.deviceUUID,e.device.asset_file=p):(console.log("container.webkitRequestFullScreen();"),(document.fullScreenElement&&null!==document.fullScreenElement||!document.mozFullScreen&&!document.webkitIsFullScreen)&&(document.documentElement.requestFullScreen?document.documentElement.requestFullScreen():document.documentElement.mozRequestFullScreen?document.documentElement.mozRequestFullScreen():document.documentElement.webkitRequestFullScreen&&document.documentElement.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT)))},e.cancel=function(){e.device&&i.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}),e.stop(),document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen(),s.dismiss("cancel")},e.installPlugin=function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/your-chrome-extension-id",m,d)},i.on("pair:sendCode",function(t){_.find(e.activeDevices,{deviceUUID:t.deviceUUID})||e.activeDevices.push(t)})}angular.module("tessaApp").controller("assetsMediaModalCtrl",e).controller("assetsDocsModalCtrl",t),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type","socket","assetsFctry","$timeout"],t.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService","socket","$window","$interval","$timeout"]}();
...
!function(){"use strict";function e(e,i,t,s,c,o,n,a,d,v,m){e.device={},e.activeDevices=[],e.activeDevices=angular.copy(a),e.enableCasting=!0,n.on("pair:sendCode",function(i){_.find(e.activeDevices,{deviceUUID:i.deviceUUID})||e.activeDevices.push(i)}),n.on("disconnect",function(e){console.log("disconnect: ",e)}),e.selectDevice=function(i){_.each(e.activeDevices,function(e){return e.selected=!1}),e.enableCasting=!1,i.selected=!0,e.device=i},e.connectDevice=function(){console.log("$scope.device: ",e.device),e.device&&(e.device.connected=!0,"audio/mp3"==d.asset_mimetype||"audio/mp4"==d.asset_mimetype?d.asset_type="audio":"video/mp4"==d.asset_mimetype||"video/x-flv"==d.asset_mimetype||"video/x-msvideo"==d.asset_mimetype||"video/x-ms-wmv"==d.asset_mimetype||"video/quicktime"==d.asset_mimetype||"video/3gpp"==d.asset_mimetype?d.asset_type="video":d.asset_type="none",d.deviceUUID=e.device.deviceUUID,e.device.asset_file=d,n.emit("pair:getCode",e.device),i.close(e.device))},e.cancel=function(){i.dismiss("cancel")}}angular.module("tessaApp").controller("assetsMirrorModalCtrl",e),e.$inject=["$scope","$uibModalInstance","$timeout","$stateParams","toastr","assetsFctry","socket","activeDevices","asset_file","API_URL","$window"]}();

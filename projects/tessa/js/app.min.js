...
!function(){"use strict";angular.module("tessaApp").run(["$location","APIFactory","$rootScope","$window","$state","localStorageService","$frontierAnalytics","usSpinnerService","AuthFactory","jwtHelper","API_URL","EXT_ID","toastr","$filter","$timeout",function(e,t,n,r,s,i,a,c,o,u,l,d,p,g,f){n._=window._,window.API_URL=l,window.EXT_ID=d,n.compareproducts=[],n.allproducts=[],n.cartItems=[],n.cartItems=_.isEmpty(i.get("Cart"))?[]:JSON.parse(i.get("Cart")),n.compareproducts=_.isEmpty(i.get("ProductsCompare"))?[]:JSON.parse(i.get("ProductsCompare")),a.debugMode(!1),a.allowPageTracking(!0),a.allowEventTracking(!0),a.allowViewTracking(!0),a.allowAppTracking(!0),a.allowDeviceTracking(!0),a.Initialize({accessCode:"958441082755103",trackerName:"project-tessa",encoding:"utf-8"});var h=function(){async.waterfall([function(e){t.getArticles(function(t,n){_.each(n.response.result,function(e){e.type="Experience"}),_.each(n.response.result,function(e){e.name=e.title,e.id=e.article_id}),e(null,n.response.result)})},function(e,n){t.getProductBundle(function(t,r){_.each(r.response.result,function(e){e.type="Solutions"}),_.each(r.response.result,function(e){e.name=e.bundle_name,e.id=e.pb_id}),n(null,e,r.response.result)})},function(e,n,r){var s=[];t.getProductStatus("publish").then(function(t){s=_.filter(t.response.result,function(e){return"Hardware"==e.product_type}),_.each(s,function(e){e.type="Hardware"}),_.each(s,function(e){e.name=e.item_name,e.id=e.p_id}),r(null,e,n,s)})},function(e,n,r,s){var i=[];async.each(r,function(e,n){t.getProductAttribute(e.p_id,function(t,r){if(200==r.statusCode&&r.response.success&&e.p_id==r.response.result.p_id){var s=r.response.result.attribute_values;s&&s.length>0?e.attributes=r.response.result.attribute_values:e.attributes=null,n()}})},function(t,a){_.each(r,function(e){1==e.is_published&&0==e.is_archived&&i.push(e)}),s(null,e,n,r,i)})},function(e,t,r,s,i){var a=[];_.each(s,function(e){_.isNull(e.attributes)||a.push(e.attributes)}),a=_.flattenDeep(a),n.Brightness=g("filter")(a,{attribute:"Brightness"}),n.Bezel=g("filter")(a,{attribute:"Bezel Size"}),n.Usage=g("filter")(a,{attribute:"Usage"}),n.Brightness=_.uniqBy(n.Brightness,"value"),n.Bezel=_.uniqBy(n.Bezel,"value"),n.Usage=_.uniqBy(n.Usage,"value");var c=[];_.each(s,function(e){1==e.is_published&&0==e.is_archived&&c.push(e)}),_.each(t,function(e){1==e.is_published&&0==e.is_archived&&c.push(e)}),_.each(e,function(e){1==e.is_active&&c.push(e)}),i(null,s,t,e),n.allproducts=angular.copy(c)}])};if(o.getCurrentUser()){var m=JSON.parse(i.get("appuser"));h(),a.setUserId(_.toString(m.uc_id))}n.$on("InitializeData",function(){h()}),n.$on("loading:progress",function(){c.spin("spinner-1")}),n.$on("loading:finish",function(){c.stop("spinner-1")}),n.$on("app:reload",function(){f(function(){r.location.reload()},1e3)}),n.goBack=function(){r.history.back()},o.getCurrentUser()&&h(),n.$on("$stateChangeStart",function(t,r,a,c,l){if(n.compareIs=!0,_.isNull(o.getCurrentUser()))"login"!==r.name&&"forget-password"!==r.name&&"publicshare"!==r.name&&(n.requested=e.$$absUrl,t.preventDefault(),s.go("login"));else{var d=o.getUserToken();JSON.parse(i.get("appuser"));u.isTokenExpired(d)?o.logout().then(function(){n.$broadcast("app:reload"),e.path("/login")}):"login"==r.name&&(t.preventDefault(),s.go("main.experience"))}n.isHide=!1,n.toggleShow=function(){n.isHide=!n.isHide},n.width=Math.max(document.documentElement.clientWidth,window.innerWidth||0),n.height=Math.max(document.documentElement.clientHeight,window.innerHeight||0),n.hideNav=function(){n.isHide=!1},n.compare=function(e){console.log("items:",e);var t={},r=0;if(r=n.width<=500&&n.height<=975?2:n.width<=975&&n.height<=500?2:4,_.isEmpty(n.compareproducts))p.success("Successfully Added","Success"),n.compareIs=!1,n.compareproducts.push(e);else if(n.compareproducts.length>=1&&n.compareproducts.length<r){var s=_.filter(n.compareproducts,{_id:e._id});s.length>0?p.error("Oops. The selected item has already been added.","Warning"):(_.each(n.compareproducts,function(e,n){0==n&&(t=e)}),t.category_id==e.category_id?(p.success("Successfully Added","Success"),n.compareIs=!1,n.compareproducts.push(e)):p.error("Oops. The selected item is incomparable to the existing item(s).","Error"))}else p.error("Oops. You can not compare more than "+r+" items.","Error")}}),n.addToCart=function(e,t){if(console.log("type:",t),console.log("selectedItem:",e),"Solution"==t){if(a.trackEvent("Productcatalogue","click","addtocart",_.toString(e.pb_id)),0==e.upfront)p.error("Cannot add product when the values are 0","Error");else if(e.quantity=1,n.cartItems.length>=0){var r=_.filter(n.cartItems,{pb_id:e.pb_id});r.length>0?(r[0].quantity++,_.each(n.cartItems,function(e){e.pb_id==r[0].pb_id&&(e.quantity=r[0].quantity)}),p.success("Quantity Added","Success"),i.set("Cart",JSON.stringify(n.cartItems))):(p.success("Successfully Added","Success"),n.cartItems.push(e),i.set("Cart",JSON.stringify(n.cartItems)))}}else if("Hardware"==t&&(console.log("HARDWARE"),console.log("selectedItem:",e),a.trackEvent("Productcatalogue","click","addtocart",_.toString(e.p_id)),e.upfront=e.sell_price,e.quantity=1,n.cartItems.length>=0)){var r=_.filter(n.cartItems,{p_id:e.p_id});r.length>0?(r[0].quantity++,_.each(n.cartItems,function(e){e.p_id==r[0].p_id&&(e.quantity=r[0].quantity)}),p.success("Quantity Added","Success"),i.set("Cart",JSON.stringify(n.cartItems))):(p.success("Successfully Added","Success"),n.cartItems.push(e),i.set("Cart",JSON.stringify(n.cartItems)))}},n.$on("$stateChangeSuccess",function(e,t,r,s,i){n.appuser=JSON.parse(o.getCurrentUser("appuser")),n.currentUser=o.getCurrentUser(),n.label="Solutions","main.search"==t.name&&h(),a.trackPage(t.name,t.url,t.templateUrl)})}])}();
...
!function(){"use strict";function e(e,t,r,a,i,n,c,o,s,l,u){function p(e){return i.map(e,function(e){if("location"==e.type){var t=e.label.replace(/[\s]/g,"");return{label:t.toLowerCase(),type:e.type,index:e.sortindex}}if("configuration"==e.type){var r=e.label.replace(/[\s]/g,"");return{label:r.toLowerCase(),type:e.type,index:e.sortindex}}return e})}function d(e,t,r,a){var n=[],c=[],o=[],s=[];if(e.att_id){i.each(t,function(e){n=i.filter(r,{value:e.value}),n&&n.length>0&&i.each(n,function(e){o=i.find(a,{p_id:e.p_id}),i.isUndefined(o)||s.push(o)})});var l=i.uniqBy(s,function(e){return e._id});return l}c=p(r),r=i.each(r,function(e){return e.tags=e.tags.replace(/[\[\](){}?*+\^$\\.|\-|\s]/g,"")}),i.each(c,function(e){n=i.filter(r,{tags:e.label}),n.length>0&&i.each(n,function(e){o=i.find(a,{pb_id:e.pb_id}),i.isUndefined(o)||s.push(o)})});var l=i.uniqBy(s,function(e){return e._id});return l}function f(t,r,n,c,o){var s=[],l=[],u=[];if("attribute"==t){i.each(r,function(e){s=i.filter(n,{value:e.value}),s&&s.length>0&&i.each(s,function(e){l=i.find(c,{p_id:e.p_id}),i.isUndefined(l)||u.push(l)})});var p=i.uniqBy(u,function(e){return e._id});return p}n=i.each(n,function(e){return e.tags=e.tags.replace(/[\[\](){}?*+\^$\\.|\-|\s]/g,"")}),i.each(r,function(t){var r=[];if("orientation"==t.type){var s=a("filter")(o,{value:t.label});s&&s.length&&i.each(s,function(t){var a=i.find(e.ezehards,{product_id:t.p_id});i.isUndefined(a)||r.push(a)}),i.each(r,function(e){i.each(c,function(t){e.pb_id==t.pb_id&&u.push(t)})})}else s=i.filter(n,{tags:t.label}),s.length>0&&i.each(s,function(e){l=i.find(c,{pb_id:e.pb_id}),i.isUndefined(l)||u.push(l)})});var p=i.uniqBy(u,function(e){return e._id});return p}e.solutionTypes="EzeImpress",e.prodTypeLabel=i.isEmpty(s.get("label"))?"Solution":JSON.parse(s.get("label")),e.solutionTypes=i.isEmpty(s.get("solutiontype"))?"EzeImpress":JSON.parse(s.get("solutiontype")),e.txtSearch="",e.bundles=[],e.productDetails=[],e.seemore=!0,e.solutions=[],e.productscopy=[],e.ezewificopy=[],e.categoryWifi=[],e.screens=[],e.Screens=[],e.ScreenSize=[],e.media=[],e.MediaPlayer=[],e.Mediacopy=[],e.bundleTags=[],e.searchcopy=[],e.filtercopy=[],e.typeselected=[],e.tagselected=[],e.productsAttributesValue=[],e.hardwareType=i.isEmpty(s.get("hardtype"))?"Screens":JSON.parse(s.get("hardtype")),e.solutionTypes=i.isEmpty(s.get("solutiontype"))?"EzeImpress":JSON.parse(s.get("solutiontype")),e.location=[{_id:8,label:"Indoor",type:"location"},{_id:9,label:"Outdoor",type:"location"},{_id:10,label:"Semi Outdoor",type:"location"}],e.config=[{_id:11,label:"Wall Mounted",type:"configuration"},{_id:12,label:"Floor Mounted",type:"configuration"}],e.usages=[{_id:13,label:"24/7",type:"usages"},{_id:14,label:"16/7",type:"usages"}],e.orient=[{_id:15,label:"Landscape",type:"orientation"},{_id:16,label:"Portrait",type:"orientation"},{_id:17,label:"Custom",type:"orientation"}],e.dynamicPopover={vesa:"vesa.html",bezel:"bezel.html",usage:"usage.html",weight:"weight.html",mounting:"configuration.html",location:"location.html",dimensions:"dimensions.html",screensize:"screens.html",brightness:"brightness.html",screentype:"screentype.html",resolution:"resolution.html",orientation:"orientation.html",templateUrl7:"wifi.html",templateUrl8:"ram.html",orientation1:"ori.html",templateUrl9:"displaytechno.html",displaytechno:"displaytechno.html",displayinterface:"displayinterface.html",templateUrlStorage:"storage.html",templateUrlGraphics:"graphics.html",templateUrlResolution:"resolutions.html"},e.infiniteScrollData={},e.infiniteScrollData.numToAdd=10,e.infiniteScrollData.currentItems=10,e.resetInfScroll=function(){e.infiniteScrollData.currentItems=e.infiniteScrollData.numToAdd},e.addMoreItems=function(){e.infiniteScrollData.currentItems+=e.infiniteScrollData.numToAdd};var h=function(){async.waterfall([function(r){t.getProductBundle(function(t,n){var c=[],o=[];e.solutions=n.response.result,o=i.flattenDeep(i.map(e.solutions,function(e){return void 0!=e.product_bundle_category[0]&&c.push(e.product_bundle_category[0]),e.products.length>0||(e.weekly=0),e.products})),i.each(o,function(e){e.product_detail&&(e.productType_id=e.product_detail.productType_id,e.sell_price=e.product_detail.sell_price,e.product_detail.product_category.length>0&&(e.category_id=e.product_detail.product_category[0].category_id,e.category_label=e.product_detail.product_category[0].category_label))});var s=i.groupBy(o,"pb_id");i.map(s,function(t,r){var n=a("filter")(t,{productType_id:18}),c=a("filter")(t,{productType_id:17}),o=a("filter")(t,{productType_id:20});if(parseInt(r)==parseInt(r)){if((c.length>0||n.length>0)&&(e.resulthardwaresum=i.sum(i.map(c,function(e){return e.sell_price*e.quantity})),e.softwaresum=i.sum(i.map(n,function(e){return e.sell_price*e.quantity}))),o.length>0){var s=a("filter")(o,{category_id:87}),l=a("filter")(o,{category_id:90});(s.length>0||l.length>0)&&(e.deploymentservice=i.sum(i.map(s,function(e){return e.sell_price*e.quantity})),e.supportservice=i.sum(i.map(l,function(e){return e.sell_price*e.quantity}))),e.servicesum=i.sum(i.map(o,function(e){return e.sell_price*e.quantity}))}void 0==e.deploymentservice&&void 0==e.supportservice?(e.deploymentservice=0,e.supportservice=0):(e.deploymentservice,e.supportservice);var u=e.deploymentservice+e.softwaresum+e.resulthardwaresum;e.weekly=12*(31.111*u/1e3+e.supportservice)/52}i.each(e.solutions,function(t){t.pb_id==parseInt(r)&&(t.weekly=e.weekly,t.software=n,t.hardware=c,t.support=l,t.upfront=u,t.spPrice=i.sum(i.map(l,function(e){return e.sell_price*e.quantity})))})}),i.each(e.solutions,function(e){e.product_bundle_category.length>0&&(e.category_label=e.product_bundle_category[0].category_label,e.category_id=e.product_bundle_category[0].category_id)}),r(null,e.solutions)})},function(e,t){var r=[];i.each(e,function(e){i.each(e.hardware,function(e){r.push(e)})}),t(null,e,r)},function(e,r,a){var i=[];async.each(r,function(e,r){t.getProductAttribute(e.product_id,function(e,t){t?200==t.statusCode&&t.response.success&&(i.push(t.response.result),r()):r()})},function(t,n){a(null,e,r,i)})},function(t,r,a,n){var c=i.groupBy(a,"p_id");i.each(r,function(e){i.map(c,function(t,r){r&&i.each(t,function(t){if(t.attribute_values.length>0){var a=i.find(t.attribute_values,{is_comparable:1});i.isUndefined(a)&&r?parseInt(r)==e.product_id&&(e.comparable=0):parseInt(r)==e.product_id&&(e.comparable=1)}else parseInt(r)==e.product_id&&(e.comparable=0)})})});var o=i.groupBy(r,"pb_id");i.each(t,function(e){i.map(o,function(t,r){if(e.pb_id==r&&e.hardware){var a=i.filter(t,{comparable:1});a.length>0?e.comparable=1:e.comparable=0,e.hardware=t}})}),e.categoryWifi=i.filter(t,function(e){return 101==e.category_id}),e.EzeImpress=i.filter(t,function(e){if(1==e.is_published&&0==e.is_archived&&!i.isUndefined(e)&&"Eze Impress"==e.category_label)return e}),console.log("$scope.EzeImpress:",e.EzeImpress),e.productscopy=angular.copy(e.EzeImpress),e.ezewificopy=angular.copy(e.categoryWifi)}]),async.waterfall([function(r){t.getProduct(function(t,n){e.allproducts=n.response.result,e.hardware=i.filter(e.allproducts,function(e){return"Hardware"===e.product_type}),e.prodCateg=[];for(var c=0;c<e.hardware.length;c++)for(var o=0;o<e.hardware[c].product_category.length;o++)e.prodCateg.push(e.hardware[c].product_category[o]);i.each(e.hardware,function(t){i.find(e.prodCateg,function(e){t.p_id==e.product_id&&(t.category_id=e.category_id)})});var s=a("filter")(e.hardware,{category_id:80}),l=a("filter")(e.hardware,{category_id:83});r(null,s,l)})},function(r,a,n){var c=[];async.each(r,function(e,r){t.getProductAttribute(e.p_id,function(t,a){if(a){if(200==a.statusCode&&a.response.success&&e.p_id==a.response.result.p_id){var i=a.response.result.attribute_values;i&&i.length>0?(e.attributes=a.response.result.attribute_values,e.type="Screens"):e.attributes=null,r()}}else r()})},function(t,o){i.each(r,function(e){var t=i.filter(e.attributes,{is_comparable:1});t.length>0?e.comparable=1:e.comparable=0,1==e.is_published&&0==e.is_archived&&c.push(e)}),e.copyscreen=r,n(null,r,a,c)})},function(e,r,a,n){var c=[];async.each(r,function(e,r){t.getProductAttribute(e.p_id,function(t,a){if(200==a.statusCode&&a.response.success&&e.p_id==a.response.result.p_id){var i=a.response.result.attribute_values;i&&i.length>0?(e.attributes=a.response.result.attribute_values,e.type="Media"):e.attributes=null,r()}})},function(t,o){i.each(r,function(e){var t=i.filter(e.attributes,{is_comparable:1});t.length>0?e.comparable=1:e.comparable=0,1==e.is_published&&0==e.is_archived&&c.push(e)}),n(null,e,r,a,c)})},function(t,r,n,c,o){if(n&&n.length>0){var s=[];i.each(n,function(e){i.isNull(e.attributes)||s.push(e.attributes)});var l=n;s=i.flattenDeep(s),e.attribute_values=angular.copy(s),e.ScreenSize=a("filter")(s,{attribute:"Screen Size"}),e.Brightness=a("filter")(s,{attribute:"Brightness"}),e.Bezel=a("filter")(s,{attribute:"Bezel Size"}),e.Usage=a("filter")(s,{attribute:"Usage"}),e.Displaytechno=a("filter")(s,{attribute:"Display Technology"}),e.weight=a("filter")(s,{attribute:"Weight"}),e.dimensions=a("filter")(s,{attribute:"Dimensions"}),e.orientation=a("filter")(s,{attribute:"Orientation"}),e.orientation=i.uniqBy(e.orientation,function(e){return e.value}),e.orientation=i.each(e.orientation,function(e){e.values=e.value.split(",")}),e.ori=[],i.each(e.orientation,function(t){i.map(t.values,function(t){i.each(e.orient,function(r){t==r.label&&e.ori.push(r)})})}),e.displayinterface=a("filter")(s,{attribute:"Display Interface"}),e.vesa=a("filter")(s,{attribute:"Vesa"}),e.screentype=a("filter")(s,{attribute:"Screen type"}),e.resolution=a("filter")(s,{attribute:"Resolution"})}if(c&&c.length>0){var s=[];i.each(c,function(e){i.isNull(e.attributes)||s.push(e.attributes)});var u=c;s=i.flattenDeep(s),e.Mediaattribute_values=angular.copy(s),e.Ram=a("filter")(s,{attribute:"RAM"}),e.Storage=a("filter")(s,{attribute:"Storage"}),e.Graphics=a("filter")(s,{attribute:"Graphics"}),e.Resolution=a("filter")(s,{attribute:"Maximum Resolution"})}o(null,t,r,n,c,l,u)},function(r,a,n,c,o,s,l){s&&s.length>0&&async.each(s,function(e,r){t.getRelatedProduct(e.p_id,function(t,a){if(a){if(200==a.statusCode&&a.response.success){var n=a.response.result;n.length>0&&i.each(n,function(t){t.main_id==e.p_id&&(e.relatedhardware=a.response.result)}),r()}}else r()})},function(t,r){i.each(e.productscopy,function(e){i.each(e.products,function(t){i.each(s,function(r){t.product_id==r.p_id&&(r.solution=e)})})}),e.MediaPlayer=s,e.Mediacopy=angular.copy(e.MediaPlayer)}),o&&async.each(o,function(e,r){t.getRelatedProduct(e.p_id,function(t,a){if(200==a.statusCode&&a.response.success){var n=a.response.result;n.length>0&&i.each(n,function(t){t.main_id==e.p_id&&(e.relatedhardware=a.response.result)}),r()}})},function(t,r){i.each(e.productscopy,function(e){i.each(e.products,function(t){i.each(o,function(r){t.product_id==r.p_id&&(r.solution=e)})})}),e.Screens=o,e.Screenscopy=angular.copy(e.Screens)})}])};e.activateTab=function(t){e.solutionTypes=t,e.seemore=!0,s.set("solutiontype",JSON.stringify(e.solutionTypes)),u.trackView("Product Catalogue/"+e.prodTypeLabel+"/"+t)},e.toggleSelectedType=function(t){var r=[];if("Hardware"==e.prodTypeLabel)if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),"MediaPlayer"==e.hardwareType)if(console.log("MEDIA PLAYER"),!i.isEmpty(e.txtSearch)&&e.searchmedia)if(e.tagselected.length>0){var a=[],n=[];n=d(t,e.tagselected,e.Mediaattribute_values,e.searchmedia),l(function(){e.MediaPlayer=n,e.filterMedia=angular.copy(e.MediaPlayer),o.$broadcast("loading:finish")},600)}else l(function(){e.MediaPlayer=angular.copy(e.searchmedia),o.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var a=[],n=[];n=d(t,e.tagselected,e.Mediaattribute_values,e.Mediacopy),l(function(){e.MediaPlayer=n,e.filterMedia=angular.copy(e.MediaPlayer),o.$broadcast("loading:finish")},600)}else e.MediaPlayer=angular.copy(e.Mediacopy),l(function(){o.$broadcast("loading:finish")},600);else if(console.log("Screens"),!i.isEmpty(e.txtSearch)&&e.searchscreen)if(e.tagselected.length>0){var a=[],n=[];n=d(t,e.tagselected,e.attribute_values,e.searchscreen),e.Screens=angular.copy(n),e.filterScreens=angular.copy(n),o.$broadcast("loading:finish")}else e.Screens=angular.copy(e.searchscreen),e.filterScreens=angular.copy(e.Screens),l(function(){o.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var a=[],n=[];n=d(t,e.tagselected,e.attribute_values,e.Screenscopy),e.Screens=n,e.filterScreens=angular.copy(e.Screens),o.$broadcast("loading:finish")}else e.Screens=angular.copy(e.Screenscopy),e.filterScreens=angular.copy(e.Screens),o.$broadcast("loading:finish");else{console.log("SOLUTION");var c=[],s=[],a=[];if(i.each(e.productscopy,function(e){e.hardware.length>0&&i.each(e.hardware,function(e){c.push(e)})}),i.each(e.copyscreen,function(e){i.isNull(e.attributes)||s.push(e.attributes)}),s=i.flattenDeep(s),e.ezehards=angular.copy(c),e.attrib=angular.copy(s),"EzeImpress"==e.solutionTypes){console.log("EZE"),e.typeselected.indexOf(t)==-1?e.typeselected.push(t):e.typeselected=i.filter(e.typeselected,function(e){return e._id!=t._id}),i.map(e.productscopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})});e.typeselected.length;if(r=p(e.typeselected),console.log("typeselected:",r),!i.isEmpty(e.txtSearch)&&e.searchcopy){if(r&&r.length>0){var a=[],n=[],u=i.filter(r,function(e){return e.att_id}),h=i.filter(r,function(e){return e.label});if(h&&h.length>0)if(n=f("tags",h,e.bundleTags,e.searchcopy,e.attribute_values),e.filterProduct=i.uniqBy(n,function(e){return e._id}),i.isEmpty(e.attribute)){var y=[],n=[];i.each(u,function(e){var t=i.filter(s,{value:e.value});t&&t.length&&i.each(t,function(e){var t=i.find(c,{product_id:e.p_id});i.isUndefined(t)||a.push(t)})});var g=[];i.each(a,function(t){i.each(e.searchcopy,function(e){t.pb_id==e.pb_id&&g.push(e)})}),y.push(e.filterProduct),y.push(g),e.filterProduct=i.flattenDeep(y),e.filterProduct=i.uniqBy(e.filterProduct,function(e){return e._id})}else{var g=[];g.push(e.filterProduct),g.push(e.attribute),g=i.flattenDeep(g),e.filterProduct=i.uniqBy(g,function(e){return e._id})}else if(u&&u.length>0){i.each(u,function(e){var t=i.filter(s,{value:e.value});t&&t.length&&i.each(t,function(e){var t=i.find(c,{product_id:e.p_id});i.isUndefined(t)||a.push(t)})});var g=[];i.each(a,function(t){i.each(e.searchcopy,function(e){t.pb_id==e.pb_id&&g.push(e)})}),e.filterProduct=i.uniqBy(g,function(e){return e._id}),e.attribute=angular.copy(e.filterProduct)}else e.filterProduct=angular.copy(e.searchcopy)}else e.attribute=[],e.filterProduct=angular.copy(e.searchcopy);l(function(){e.EzeImpress=e.filterProduct,e.filtercopy=angular.copy(e.filterProduct),o.$broadcast("loading:finish")},600)}else{if(r&&r.length>0){var a=[],n=[],u=i.filter(r,function(e){return e.att_id}),h=i.filter(r,function(e){return e.label});if(h&&h.length>0){if(n=f("tags",h,e.bundleTags,e.productscopy,e.attribute_values,e.attribute_values),e.filterProduct=i.uniqBy(n,function(e){return e._id}),i.isEmpty(e.attribute)){var y=[],n=[];i.each(u,function(e){var t=i.filter(s,{value:e.value});t&&t.length&&i.each(t,function(e){var t=i.find(c,{product_id:e.p_id});i.isUndefined(t)||a.push(t)})});var g=[];i.each(a,function(t){i.each(e.productscopy,function(e){t.pb_id==e.pb_id&&g.push(e)})}),y.push(e.filterProduct),y.push(g),e.filterProduct=i.flattenDeep(y),e.filterProduct=i.uniqBy(e.filterProduct,function(e){return e._id})}else{var g=[];g.push(e.filterProduct),g.push(e.attribute),g=i.flattenDeep(g),e.filterProduct=i.uniqBy(g,function(e){return e._id})}}else if(u&&u.length>0){i.each(u,function(e){var t=i.filter(s,{value:e.value});console.log("result;",t),t&&t.length&&i.each(t,function(e){var t=i.find(c,{product_id:e.p_id});i.isUndefined(t)||a.push(t)})});var g=[];i.each(a,function(t){i.each(e.productscopy,function(e){t.pb_id==e.pb_id&&g.push(e)})}),e.filterProduct=i.uniqBy(g,function(e){return e._id}),e.attribute=angular.copy(e.filterProduct)}else scope.filterProduct=angular.copy(e.productscopy)}else e.attribute=[],e.filterProduct=angular.copy(e.productscopy);l(function(){e.EzeImpress=e.filterProduct,e.filtercopy=angular.copy(e.EzeImpress),o.$broadcast("loading:finish")},600),console.log("$scope.EzeImpress:",e.EzeImpress)}}}},e.refresh=function(){o.$broadcast("loading:progress"),l(function(){h()},100),o.$broadcast("loading:finish")},e.uncheck=function(t,r){t.checked&&("Hardware"==e.prodTypeLabel?(i.each(e.tagselected,function(e){e._id==t._id&&(e.checked=!1)}),"MediaPlayer"==e.hardwareType?e.toggleSelectedType(t):e.toggleSelectedType(t)):(i.each(e.typeselected,function(e){e._id==t._id&&(e.checked=!1)}),e.toggleSelectedType(t)))},e.searchData=function(){if(o.$broadcast("loading:progress"),"Solution"==e.prodTypeLabel){l(function(){t(),o.$broadcast("loading:finish")},600);var t=function(){i.isEmpty(e.txtSearch)?(e.searchcopy=[],"EzeImpress"==e.solutionTypes?i.isEmpty(e.typeselected)?e.EzeImpress=angular.copy(e.productscopy):e.EzeImpress=angular.copy(e.filtercopy):e.categoryWifi=angular.copy(e.ezewificopy)):i.isEmpty(e.typeselected)&&"EzeImpress"==e.solutionTypes?l(function(){e.EzeImpress=a("filter")(e.productscopy,e.txtSearch),e.searchcopy=angular.copy(e.EzeImpress),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300):i.isEmpty(e.typeselected)&&"EzeWifi"==e.solutionTypes?l(function(){e.categoryWifi=a("filter")(e.ezewificopy,e.txtSearch),e.searchcopy=angular.copy(e.products),u.trackEvent("Category Search","search",e.txtSearch,e.categoryWifi.length)},300):i.isEmpty(e.typeselected)||"EzeImpress"!=e.solutionTypes?i.isEmpty(e.typeselected)||"EzeWifi"!=e.solutionTypes||l(function(){e.EzeImpress=a("filter")(e.filtercopy,e.txtSearch),e.searchcopy=angular.copy(e.EzeImpress),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300):l(function(){e.EzeImpress=a("filter")(e.filtercopy,e.txtSearch),e.searchcopy=angular.copy(e.EzeImpress),u.trackEvent("Category Search","search",e.txtSearch,e.EzeImpress.length)},300)}}else{l(function(){t(),o.$broadcast("loading:finish")},600);var t=function(){if(i.isEmpty(e.txtSearch))if("MediaPlayer"==e.hardwareType)i.isEmpty(e.tagselected)?e.MediaPlayer=e.Mediacopy:e.MediaPlayer=angular.copy(e.filterMedia);else if(i.isEmpty(e.tagselected))e.Screens=e.Screenscopy;else{var t=[],r=[];if(e.tagselected&&e.tagselected.length>0){var n=[];i.each(e.tagselected,function(c){t=a("filter")(e.attribute_values,{value:c.value}),t&&t.length>0&&i.each(t,function(t){r=i.find(e.Screenscopy,{p_id:t.p_id}),i.isUndefined(r)||n.push(r)})});var c=i.uniqBy(n,function(e){return e._id});e.Screens=c}else e.Screens=angular.copy(e.Screenscopy)}else i.isEmpty(e.tagselected)&&"Screens"==e.hardwareType?l(function(){e.Screens=a("filter")(e.Screenscopy,e.txtSearch),e.searchscreen=angular.copy(e.Screens),u.trackEvent("Category Search","search",e.txtSearch,e.Screens.length)},300):i.isEmpty(e.tagselected)&&"MediaPlayer"==e.hardwareType?l(function(){e.MediaPlayer=a("filter")(e.Mediacopy,e.txtSearch),e.searchmedia=angular.copy(e.MediaPlayer),u.trackEvent("Category Search","search",e.txtSearch,e.MediaPlayer.length)},300):i.isEmpty(e.tagselected)||"Screens"!=e.hardwareType?i.isEmpty(e.tagselected)||"MediaPlayer"!=e.hardwareType||l(function(){e.MediaPlayer=a("filter")(e.filterMedia,e.txtSearch),e.copymedia=angular.copy(e.MediaPlayer),u.trackEvent("Category Search","search",e.txtSearch,e.MediaPlayer.length)},300):l(function(){e.Screens=a("filter")(e.filterScreens,e.txtSearch),e.copyscreens=angular.copy(e.Screens),u.trackEvent("Category Search","search",e.txtSearch,e.Screens.length)},300)}}},e.clear=function(){"Solution"==e.prodTypeLabel?i.isEmpty(e.txtSearch)&&i.isEmpty(e.typeselected)||(e.txtSearch="",i.forEach(e.typeselected,function(e){e.checked=!1}),e.typeselected.splice(e.typeselected),e.refresh()):"MediaPlayer"==e.hardwareType?i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.refresh()):i.isEmpty(e.txtSearch)&&i.isEmpty(e.tagselected)||(e.txtSearch="",i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected),e.refresh())},e.refresh(),e.activeProd=function(t){e.prodTypeLabel=t,"Hardware"==t?(e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.hardwareType)):(e.txtSearch="",e.seemore=!0,u.trackView("Product Catalogue/",t,"/",e.solutionTypes)),s.set("label",JSON.stringify(e.prodTypeLabel))},e.activeHard=function(t){e.hardwareType=t,e.txtSearch="",s.set("hardtype",JSON.stringify(e.hardwareType)),u.trackView("Product Catalogue/",e.prodTypeLabel,"/",t)},e.solutionsEzeImpress=function(e){u.trackEvent("Productcatalogue","click","Solution",i.toString(e.pb_id))},e.solutionsEzeWifi=function(e){u.trackEvent("Productcatalogue","click","Solution",i.toString(e.pb_id))},e.hardwareScreens=function(e){console.log("value",e),u.trackEvent("Productcatalogue","click","Hardware",i.toString(e.p_id))},e.hardwareMediaplayer=function(e){u.trackEvent("Productcatalogue","click","Hardware",i.toString(e.p_id))},e.togglemodal=function(e){var t=n.open({animation:!0,templateUrl:"./views/share.modal.html",controller:"articleCtrl",size:"sm",resolve:{article:function(){return e}}});t.result.then(function(){c.reload()},function(){console.info("Modal dismissed")})}}angular.module("tessaApp").controller("productCtrl",e),e.$inject=["$scope","APIFactory","$location","$filter","_","$uibModal","$state","$rootScope","localStorageService","$timeout","$frontierAnalytics"]}();
...
!function(){"use strict";function e(e,t,i,a,r,l,s,c,n,o,u,d,g,f){t.refresh=function(){f.gallery.refresh()},t.angularGridoptions={cssGrid:!0,refreshOnImgLoad:!1,gridWidth:350,gutterSize:20},t.seemore=!0,t.date=new Date,s.user=r.isEmpty(o.get("User"))?[]:JSON.parse(o.get("User")),t.expFilter=r.isEmpty(o.get("articlefilter"))?"all":JSON.parse(o.get("articlefilter")),t.selectedItem=[],t.articlesList=[],t.lists=[],t.tags=[],t.tagscopy=[],t.Portfolio=[],t.Article=[],t.selectedTag=[],t.tagselected=[],t.infiniteScrollData={},t.infiniteScrollData.numToAdd=1,t.infiniteScrollData.currentItems=10,t.dynamicPopover={templateUrl:"myPopoverTemplate.html",backdrop:"static",keyboard:!1},t.pdf={file:null,thumbnail:""},t.resetInfScroll=function(){t.infiniteScrollData.currentItems=t.infiniteScrollData.numToAdd},t.addMoreItems=function(){t.infiniteScrollData.currentItems!==t.lists.length&&(t.infiniteScrollData.currentItems+=t.infiniteScrollData.numToAdd,t.articlesList=t.lists,t.articlesList.length=t.infiniteScrollData.currentItems)},t.generateArticles=function(){t.articlesList=[],t.tags=[],t.tagscopy=[],t.lists=[],t.selectedTag=[],i.getArticles(function(e,i){if(200==i.statusCode&&i.response.success){r.each(i.response.result,function(e){e.name=e.title,e.type="Experience",e.tags.length>=1&&1==e.is_active&&t.articlesList.push(e)}),t.articlesList=r.map(r.orderBy(t.articlesList,"date_created")).reverse(),r.each(t.articlesList,function(e){t.tags.push(e.tags)}),t.tags=r.flattenDeep(t.tags),r.each(t.articlesList,function(e){if(e.mediafiles.length>0&&(e.image=e.mediafiles[0].media_path),!r.isNull(e.thumbnail_media)){var t=e.article_thumbnail;if(t){if("video/mp4"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-flv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-msvideo"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/x-ms-wmv"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css";if("video/quicktime"==t.media_mimetype)return e.article_thumbnail.url="http://www.videogular.com/styles/themes/default/latest/videogular.css"}}}),t.tagscopy=angular.copy(t.tags),t.tagscopy=r.uniqBy(t.tagscopy,function(e){return e.tags}),t.tagscopy=r.filter(t.tagscopy,function(e){if("Article"!==e.tags&&"Portfolio"!==e.tags)return e}),t.lists=angular.copy(t.articlesList);var a=c("filter")(t.tags,{tags:"Portfolio"}),l=c("filter")(t.tags,{tags:"Article"});a&&r.each(a,function(e){var i=r.find(t.lists,{article_id:e.article_id});t.Portfolio.push(i),r.each(t.articlesList,function(t){t.article_id==e.article_id&&(t.article_type=e.tags)})}),l&&r.each(l,function(e){var i=r.find(t.lists,{article_id:e.article_id});t.Article.push(i),r.each(t.articlesList,function(t){t.article_id==e.article_id&&(t.article_type=e.tags)})})}})},t.clearAll=function(){console.log("clear:",t.tagselected),r.each(t.tagselected,function(e){e.checked=!1}),t.tagselected.splice(t.tagselected)},t.product=function(){o.remove("label"),o.remove("hardtype"),l.go("main.productCatalogue")},t.toggleSelectedTag=function(e){t.event=["Filter by Industry","click",e.tags,r.toString(e.tags_id)],t.tagselected.indexOf(e)==-1?t.tagselected.push(e):t.tagselected=r.filter(t.tagselected,function(t){return t.tags_id!=e.tags_id})},t.trackExperienceArticles=function(e){d.trackEvent("Experience","View",e.title,r.toString(e.article_id))},t.trackExperiencePortfolio=function(e){d.trackEvent("Experience","View",e.title,r.toString(e.article_id))},t.trackExperienceAll=function(e){d.trackEvent(e.type,"View",e.title,r.toString(e.article_id))},t.isTagSelected=function(e){return t.tagselected.indexOf(e)!==-1},t.isOnSelectedTag=function(){return function(e){if(!(t.tagselected.length>0))return!0;var i=!1,a=r.map(t.tagselected,"tags_id");r.forEach(e.tags,function(e){a.indexOf(e.tags_id)!==-1&&(i=!0)});return i}},t.filterArticle=function(e){t.expFilter=e,o.set("articlefilter",JSON.stringify(t.expFilter))},t.$watch("expFilter",function(e){u(function(){if("all"==e)t.articlesList=angular.copy(t.lists);else{t.articlesList=[];var i=c("filter")(t.tags,{tags:e});r.each(i,function(e){var i=r.find(t.lists,{article_id:e.article_id});t.articlesList.push(i)})}},600)}),t.$on("$stateChangeSuccess",function(e,i,a,r,l){"main.experience"==i.name&&(t.tagselected=[],t.generateArticles())})}angular.module("tessaApp").service("imageService",["$q","$http",function(e,t){this.loadImages=function(){return t.jsonp("https://api.flickr.com/services/feeds/photos_public.gne?format=json&jsoncallback=JSON_CALLBACK")}}]).controller("expCtrl",e),e.$inject=["$http","$scope","APIFactory","$location","_","$state","$rootScope","$filter","$uibModal","localStorageService","$timeout","$frontierAnalytics","imageService","angularGridInstance"]}();

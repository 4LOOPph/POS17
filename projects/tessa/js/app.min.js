...
!function(){"use strict";function e(e,t,a,r,i,c,n,o,l,s,u){function d(e){return i.map(e,function(e){if("location"==e.type){var t=e.label.replace(/[\s]/g,"");return{label:t.toLowerCase(),type:e.type,index:e.sortindex}}if("configuration"==e.type)return{label:e.label,type:e.type,index:e.sortindex}})}e.solutionTypes="EzeImpress",e.prodTypeLabel=i.isEmpty(l.get("label"))?"Solution":JSON.parse(l.get("label")),u.trackView("Product Catalogue/",e.prodTypeLabel,"/",e.solutionTypes),e.txtSearch="",e.bundles=[],e.productDetails=[],e.products=[],e.productscopy=[],e.ezewificopy=[],e.categoryWifi=[],e.Screens=[],e.ScreenSize=[],e.MediaPlayer=[],e.Mediacopy=[],e.bundleTags=[],e.searchcopy=[],e.filtercopy=[],e.typeselected=[],e.tagselected=[],e.productsAttributesValue=[],e.hardwareType=i.isEmpty(l.get("hardtype"))?"Screens":JSON.parse(l.get("hardtype")),e.location=[{id:8,label:"Indoor",type:"location"},{id:9,label:"Outdoor",type:"location"},{id:10,label:"Semi Outdoor",type:"location"}],e.config=[{id:11,label:"Wall Mounted",type:"configuration"},{id:12,label:"Floor Mounted",type:"configuration"}],e.dynamicPopover={location:"location.html",mounting:"configuration.html",screensize:"screens.html",brightness:"brightness.html",bezel:"bezel.html",usage:"usage.html",displaytechno:"displaytechno.html",weight:"weight.html",dimensions:"dimensions.html",orientation:"orientation.html",displayinterface:"displayinterface.html",vesa:"vesa.html",screentype:"screentype.html",resolution:"resolution.html",templateUrl7:"wifi.html",templateUrl8:"ram.html",templateUrl9:"displaytechno.html",templateUrlStorage:"storage.html",templateUrlGraphics:"graphics.html",templateUrlResolution:"resolutions.html"},e.infiniteScrollData={},e.infiniteScrollData.numToAdd=10,e.infiniteScrollData.currentItems=10,e.resetInfScroll=function(){e.infiniteScrollData.currentItems=e.infiniteScrollData.numToAdd},e.addMoreItems=function(){e.infiniteScrollData.currentItems+=e.infiniteScrollData.numToAdd};var p=function(){async.waterfall([function(a){t.getProductBundle(function(t){var c=[],n=[];e.products=t.response.result,n=i.map(e.products,function(e){return void 0!=e.product_bundle_category[0]&&c.push(e.product_bundle_category[0]),e.products.length>0||(e.weekly=0),e.products});var o=i.flattenDeep(n),l=i.map(o,function(e){return e.product_detail});i.each(o,function(e){var t=i.find(l,{p_id:e.product_id});i.isUndefined(t)||(e.productType_id=t.productType_id,e.sell_price=t.sell_price,t.product_category.length>0&&(e.category_id=t.product_category[0].category_id))});var s=i.groupBy(o,"pb_id");if(i.map(s,function(t,a){var c=r("filter")(t,{productType_id:18}),n=r("filter")(t,{productType_id:17}),o=r("filter")(t,{productType_id:20});if(parseInt(a)==parseInt(a)){if(n.length>0&&(e.resulthardwaresum=i.sum(i.map(n,function(e){return e.sell_price*e.quantity}))),c.length>0&&(e.softwaresum=i.sum(i.map(c,function(e){return e.sell_price*e.quantity}))),o.length>0){var l=r("filter")(o,{category_id:87}),s=r("filter")(o,{category_id:90});l&&(e.deploymentservice=i.sum(i.map(l,function(e){return e.sell_price*e.quantity}))),s&&(e.supportservice=i.sum(i.map(s,function(e){return e.sell_price*e.quantity}))),e.servicesum=i.sum(i.map(o,function(e){return e.sell_price*e.quantity}))}void 0==e.deploymentservice&&void 0==e.supportservice?(e.deploymentservice=0,e.supportservice=0):(e.deploymentservice,e.supportservice);var u=e.deploymentservice+e.softwaresum+e.resulthardwaresum;e.weekly=12*(31.111*u/1e3+e.supportservice)/52}i.each(e.products,function(t){t.pb_id==parseInt(a)&&(t.weekly=e.weekly)})}),i.each(e.products,function(e){i.find(c,function(t){e.pb_id==t.bundle_id&&(e.category_label=t.category_label,e.category_id=t.category_id)})}),e.categoryWifi=i.filter(e.products,function(e){return 101==e.category_id}),e.categoryWifi&&e.categoryWifi.length>0){var u=i.map(e.categoryWifi,function(e){return e.products}),d=i.flattenDeep(u),p=i.map(d,function(e){return e.product_detail});i.each(p,function(e){i.each(e.product_category,function(t){"CMS"==t.category_label&&(e.category_label=t.category_label)})}),e.categWifi=r("filter")(p,{category_label:"CMS"})}a(null,e.products),e.productscopy=angular.copy(e.products),e.ezewificopy=angular.copy(e.categoryWifi)})},function(a,c){t.getProduct(function(t,n){e.allproducts=n.response.result,e.hardware=i.filter(e.allproducts,function(e){return"Hardware"===e.product_type}),e.prodCateg=[];for(var o=0;o<e.hardware.length;o++)for(var l=0;l<e.hardware[o].product_category.length;l++)e.prodCateg.push(e.hardware[o].product_category[l]);i.each(e.hardware,function(t){i.find(e.prodCateg,function(e){t.p_id==e.product_id&&(t.category_id=e.category_id)})});var s=r("filter")(e.hardware,{category_id:80}),u=r("filter")(e.hardware,{category_id:83});c(null,a,s,u)})},function(e,a,r,i){async.each(a,function(e,a){t.getProductAttribute(e.p_id,function(t,r){if(200==r.statusCode&&r.response.success&&e.p_id==r.response.result.p_id){var i=r.response.result.attribute_values;i&&i.length>0?e.attributes=r.response.result:e.attributes=null,a()}})},function(t,c){var n=a;i(null,e,a,r,n)})},function(e,a,r,i,c){async.each(r,function(e,a){t.getProductAttribute(e.p_id,function(t,r){if(200==r.statusCode&&r.response.success&&e.p_id==r.response.result.p_id){var i=r.response.result.attribute_values;i&&i.length>0?e.attributes=r.response.result:e.attributes=null,a()}})},function(t,n){var o=r;c(null,e,a,r,i,o)})},function(t,a,c,n,o,l){if(n&&n.length>0){e.Screens=n,e.Screenscopy=angular.copy(n);var s=[];i.each(n,function(e){i.isNull(e.attributes)||s.push(e.attributes.attribute_values)}),s=i.flattenDeep(s),e.attribute_values=angular.copy(s),e.ScreenSize=r("filter")(s,{attribute:"Screen Size"}),e.Brightness=r("filter")(s,{attribute:"Brightness"}),e.Bezel=r("filter")(s,{attribute:"Bezel Size"}),e.Usage=r("filter")(s,{attribute:"Usage"}),e.Displaytechno=r("filter")(s,{attribute:"Display Technology"}),e.weight=r("filter")(s,{attribute:"Weight"}),e.dimensions=r("filter")(s,{attribute:"Dimensions"}),e.orientation=r("filter")(s,{attribute:"Orientation"}),e.displayinterface=r("filter")(s,{attribute:"Display Interface"}),e.vesa=r("filter")(s,{attribute:"Vesa"}),e.screentype=r("filter")(s,{attribute:"Screen type"}),e.resolution=r("filter")(s,{attribute:"Resolution"})}if(o&&o.length>0){e.MediaPlayer=o,e.Mediacopy=angular.copy(o);var s=[];i.each(o,function(e){i.isNull(e.attributes)||s.push(e.attributes.attribute_values)}),s=i.flattenDeep(s),e.Mediaattribute_values=angular.copy(s),e.Ram=r("filter")(s,{attribute:"RAM"}),e.Storage=r("filter")(s,{attribute:"Storage"}),e.Graphics=r("filter")(s,{attribute:"Graphics"}),e.Resolution=r("filter")(s,{attribute:"Maximum Resolution"}),console.log("$scope.Resolution:",e.Resolution)}}])};e.activateTab=function(t){e.solutionTypes=t,u.trackView("Product Catalogue/",e.prodTypeLabel,"/",t)},e.toggleSelectedType=function(t){console.log("type;",t);var a=[];if(o.$broadcast("loading:progress"),t.att_id)if("MediaPlayer"==e.hardwareType)if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),!i.isEmpty(e.txtSearch)&&e.searchmedia)if(e.tagselected.length>0){var c=[];i.each(e.tagselected,function(t){var a=i.filter(e.Mediaattribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.searchmedia,{p_id:t.p_id});c.push(a)}),s(function(){e.MediaPlayer=c,e.filterMedia=angular.copy(e.MediaPlayer),o.$broadcast("loading:finish")},600)})}else s(function(){e.MediaPlayer=angular.copy(e.searchmedia),o.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var c=[];i.each(e.tagselected,function(t){var a=i.filter(e.Mediaattribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.Mediacopy,{p_id:t.p_id});c.push(a)}),s(function(){e.MediaPlayer=c,e.filterMedia=angular.copy(e.MediaPlayer),o.$broadcast("loading:finish")},600)})}else e.MediaPlayer=angular.copy(e.Mediacopy),s(function(){o.$broadcast("loading:finish")},600);else if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),console.log("$scope.tagselected:",e.tagselected),!i.isEmpty(e.txtSearch)&&e.searchscreen)if(e.tagselected.length>0){var c=[];i.each(e.tagselected,function(t){var a=i.filter(e.attribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.searchscreen,{p_id:t.p_id});c.push(a)}),e.Screens=c,e.filterScreens=angular.copy(c),o.$broadcast("loading:finish")})}else e.Screens=angular.copy(e.searchscreen),e.filterScreens=angular.copy(e.Screens),s(function(){o.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var c=[];i.each(e.tagselected,function(t){var a=i.filter(e.attribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.Screenscopy,{p_id:t.p_id});c.push(a)}),e.Screens=c,e.filterScreens=angular.copy(c),o.$broadcast("loading:finish")})}else e.Screens=angular.copy(e.Screenscopy),e.filterScreens=angular.copy(e.Screens),o.$broadcast("loading:finish");else{s(function(){n()},600);var n=function(){if(e.typeselected.indexOf(t)==-1?e.typeselected.push(t):e.typeselected=i.filter(e.typeselected,function(e){return e.id!=t.id}),a=d(e.typeselected),i.isEmpty(e.searchcopy)){if(a&&a.length>0){var c=[];i.map(e.productscopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})}),i.each(a,function(t){var a=[];a=r("filter")(e.bundleTags,{tags:t.label}),a.length>0&&i.each(a,function(t){var a=i.find(e.productscopy,{pb_id:t.pb_id});c.push(a)}),e.filterProduct=i.uniqBy(c,function(e){return e._id})})}else e.filterProduct=angular.copy(e.productscopy);e.products=angular.copy(e.filterProduct),e.filtercopy=angular.copy(e.filterProduct),o.$broadcast("loading:finish")}else{if(a&&a.length>0){var c=[];i.map(e.searchcopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})}),i.each(a,function(t){var a=[];a=r("filter")(e.bundleTags,{tags:t.label}),a.length>0&&i.each(a,function(t){var a=i.find(e.searchcopy,{pb_id:t.pb_id});c.push(a)}),e.filterProduct=i.uniqBy(c,function(e){return e._id}),s(function(){o.$broadcast("loading:finish")},600)})}else e.filterProduct=angular.copy(e.searchcopy),s(function(){o.$broadcast("loading:finish")},600);e.products=angular.copy(e.filterProduct),e.filtercopy=angular.copy(e.filterProduct)}}}},e.refresh=function(){o.$broadcast("loading:progress"),s(function(){p(),o.$broadcast("loading:finish")},600)},e.uncheck=function(t,a){console.log("item:",t),console.log("index:",a);var c=[];if(t.checked)if(t.att_id)if(i.each(e.tagselected,function(e){e._id==t._id&&(e.checked=!1)}),"MediaPlayer"==e.hardwareType)if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),!i.isEmpty(e.txtSearch)&&e.searchmedia)if(e.tagselected.length>0){var n=[];i.each(e.tagselected,function(t){var a=i.filter(e.Mediaattribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.searchmedia,{p_id:t.p_id});n.push(a)}),s(function(){e.MediaPlayer=n,e.filterMedia=angular.copy(e.MediaPlayer),o.$broadcast("loading:finish")},600)})}else s(function(){e.MediaPlayer=angular.copy(e.searchmedia),o.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var n=[];i.each(e.tagselected,function(t){var a=i.filter(e.Mediaattribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.Mediacopy,{p_id:t.p_id});n.push(a)}),s(function(){e.MediaPlayer=n,e.filterMedia=angular.copy(e.MediaPlayer),o.$broadcast("loading:finish")},600)})}else e.MediaPlayer=angular.copy(e.Mediacopy),s(function(){o.$broadcast("loading:finish")},600);else if(e.tagselected.indexOf(t)==-1?e.tagselected.push(t):e.tagselected=i.filter(e.tagselected,function(e){return e._id!=t._id}),!i.isEmpty(e.txtSearch)&&e.searchscreen)if(e.tagselected.length>0){var n=[];i.each(e.tagselected,function(t){var a=i.filter(e.attribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.searchscreen,{p_id:t.p_id});n.push(a)}),e.Screens=n,e.filterScreens=angular.copy(n),o.$broadcast("loading:finish")})}else e.Screens=angular.copy(e.searchscreen),e.filterScreens=angular.copy(e.Screens),s(function(){o.$broadcast("loading:finish")},600);else if(e.tagselected.length>0){var n=[];i.each(e.tagselected,function(t){var a=i.filter(e.attribute_values,{value:t.value});a&&a.length>0&&i.each(a,function(t){var a=i.find(e.Screenscopy,{p_id:t.p_id});n.push(a)}),e.Screens=n,e.filterScreens=angular.copy(n),o.$broadcast("loading:finish")})}else e.Screens=angular.copy(e.Screenscopy),e.filterScreens=angular.copy(e.Screens),o.$broadcast("loading:finish");else{if(i.each(e.typeselected,function(e){e.id==t.id&&(e.checked=!1)}),e.typeselected.splice(a,1),c=d(e.typeselected),c&&c.length>0){var n=[];i.map(e.productscopy,function(t){i.each(t.tags,function(t){i.isEmpty(t.tags)||e.bundleTags.push(t)})}),i.each(c,function(t){var a=[];a=r("filter")(e.bundleTags,{tags:t.label}),a.length>0&&i.each(a,function(t){var a=i.find(e.productscopy,{pb_id:t.pb_id});n.push(a)}),e.filterProduct=i.uniqBy(n,function(e){return e._id})})}else e.filterProduct=angular.copy(e.productscopy);e.products=angular.copy(e.filterProduct),e.filtercopy=angular.copy(e.filterProduct)}},e.searchData=function(){if(o.$broadcast("loading:progress"),"Solution"==e.prodTypeLabel){s(function(){t()},600);var t=function(){i.isEmpty(e.txtSearch)?(e.products=e.productscopy,e.refresh(),o.$broadcast("loading:finish")):i.isEmpty(e.typeselected)&&"EzeImpress"==e.solutionTypes?s(function(){e.products=r("filter")(e.productscopy,e.txtSearch),e.searchcopy=angular.copy(e.products),o.$broadcast("loading:finish")},300):i.isEmpty(e.typeselected)&&"EzeWifi"==e.solutionTypes?s(function(){e.categoryWifi=r("filter")(e.ezewificopy,e.txtSearch),e.searchcopy=angular.copy(e.products),o.$broadcast("loading:finish")},300):i.isEmpty(e.typeselected)||"EzeImpress"!=e.solutionTypes?i.isEmpty(e.typeselected)||"EzeWifi"!=e.solutionTypes||s(function(){e.products=r("filter")(e.filtercopy,e.txtSearch),e.searchcopy=angular.copy(e.products),o.$broadcast("loading:finish")},300):s(function(){e.products=r("filter")(e.filtercopy,e.txtSearch),e.searchcopy=angular.copy(e.products),o.$broadcast("loading:finish")},300)}}else{s(function(){t()},600);var t=function(){i.isEmpty(e.txtSearch)?"MediaPlayer"==e.hardwareType?i.isEmpty(e.tagselected)?(e.products=e.productscopy,e.refresh()):(e.MediaPlayer=angular.copy(e.filterMedia),o.$broadcast("loading:finish")):i.isEmpty(e.tagselected)?(e.products=e.productscopy,e.refresh()):(e.Screens=angular.copy(e.filterScreens),o.$broadcast("loading:finish")):i.isEmpty(e.tagselected)&&"Screens"==e.hardwareType?s(function(){e.Screens=r("filter")(e.Screenscopy,e.txtSearch),e.searchscreen=angular.copy(e.Screens),o.$broadcast("loading:finish")},300):i.isEmpty(e.tagselected)&&"MediaPlayer"==e.hardwareType?s(function(){e.MediaPlayer=r("filter")(e.Mediacopy,e.txtSearch),e.searchmedia=angular.copy(e.MediaPlayer),o.$broadcast("loading:finish")},300):i.isEmpty(e.tagselected)||"Screens"!=e.hardwareType?i.isEmpty(e.tagselected)||"MediaPlayer"!=e.hardwareType||s(function(){e.MediaPlayer=r("filter")(e.filterMedia,e.txtSearch),e.copymedia=angular.copy(e.MediaPlayer),o.$broadcast("loading:finish")},300):s(function(){e.Screens=r("filter")(e.filterScreens,e.txtSearch),e.copyscreens=angular.copy(e.Screens),o.$broadcast("loading:finish")},300)}}},e.clear=function(){"Solution"==e.prodTypeLabel?i.isEmpty(e.txtSearch)?i.isEmpty(e.typeselected)||(i.forEach(e.typeselected,function(e){e.checked=!1}),e.refresh()):(e.txtSearch="",e.refresh()):"MediaPlayer"==e.hardwareType?i.isEmpty(e.txtSearch)?i.isEmpty(e.tagselected)||(i.forEach(e.tagselected,function(e){e.checked=!1}),e.refresh()):(e.txtSearch="",e.refresh()):i.isEmpty(e.txtSearch)?i.isEmpty(e.tagselected)||(i.forEach(e.tagselected,function(e){e.checked=!1}),e.tagselected.splice(e.tagselected,1),e.refresh()):(e.txtSearch="",e.refresh())},e.activeProd=function(t){e.prodTypeLabel=t,"Hardware"==t?u.trackView("Product Catalogue/",t,"/",e.hardwareType):u.trackView("Product Catalogue/",t,"/",e.solutionTypes),l.set("label",JSON.stringify(e.prodTypeLabel))},e.activeHard=function(t){e.hardwareType=t,l.set("hardtype",JSON.stringify(e.hardwareType)),u.trackView("Product Catalogue/",e.prodTypeLabel,"/",t)},e.togglemodal=function(e){var t=c.open({animation:!0,templateUrl:"./views/share.modal.html",controller:"articleCtrl",size:"sm",resolve:{article:function(){return e}}});t.result.then(function(){n.reload()},function(){console.info("Modal dismissed")})},e.refresh()}angular.module("tessaApp").controller("productCtrl",e),e.$inject=["$scope","APIFactory","$location","$filter","_","$uibModal","$state","$rootScope","localStorageService","$timeout","$frontierAnalytics"]}();
...
!function(){"use strict";function e(e,s,t,o,a,i,l,r,n,d,c){function m(e,s){if(0==e)return"0 Byte";var t=1024,o=s+1||3,a=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],i=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,i)).toFixed(o))+" "+a[i]}function p(s){200==s.statusCode&&s.response.success&&(e.items=s.response.result,e.assets=angular.copy(s.response.result),e.isLoading=!1,e.showBread=!0,e.disableToolNewFolder=!1,"main.presentation"==i.current.name?(e.activeAllFiles=!0,e.showToolNewFolder=!0,e.showToolNewUpload=!0,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return null==e.folder_id}),e.assets.folderscopy=angular.copy(e.assets.folders),e.assets.assetscopy=angular.copy(e.assets.assets)):"main.presentation_starred"==i.current.name?(e.activeStarredFiles=!0,e.showToolNewFolder=!1,e.showToolNewUpload=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.assets.assets=_.filter(e.assets.assets,function(e){return 0==e.isDeleted&&1==e.isStarred}),e.starred.folderscopy=angular.copy(e.assets.folders),e.starred.assetscopy=angular.copy(e.assets.assets)):"main.presentation_trash"==i.current.name&&(e.activeTrashFiles=!0,e.showToolNewFolder=!1,e.showToolNewUpload=!1,e.showBarDelete=!1,e.showBarRestore=!0,e.showBarShare=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showBarMore=!1,e.assets.folders=_.filter(e.assets.folders,function(e){return 1==e.isDeleted}),e.assets.assets=_.filter(e.assets.assets,function(e){return 1==e.isDeleted}),e.trash.folderscopy=angular.copy(e.assets.folders),e.trash.assetscopy=angular.copy(e.assets.assets)),_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=m(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=m(e.asset_filesize),e.isActive=!1,e.isFolder=!1}),e.assets.folders&&e.assets.assets&&(e.assets.folders.length>0&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length>0&&e.assets.assets.length<1?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length>0?e.showFiles=!0:e.assets.folders.length<1&&e.assets.assets.length<1&&(e.showFiles=!1)),console.log("$scope.assets: ",e.assets))}console.log("presentationCtrl"),e.items={},e.assets={},e.trash={},e.starred={},e.selectedFile={},e.isList="null"!=s.get("isList")&&0!=s.get("isList"),e.isLoading=!0,e.showBread=!1,e.showFiles=!1,e.disableToolNewFolder=!0,e.showToolNewFolder=!0,e.showToolNewUpload=!0,e.showToolMakeCopy=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.activeAllFiles=!1,e.activeSharedFiles=!1,e.activeStarredFiles=!1,e.activeTrashFiles=!1,e.changeDisplay=function(){e.isList=!e.isList,s.set("isList",e.isList)},e.refreshAssets=function(){e.assets={},e.items={},"main.presentation"==i.current.name?e.activePage="Assets":"main.presentation_starred"==i.current.name?e.activePage="Favorites":"main.presentation_trash"==i.current.name&&(e.activePage="Trash"),a._id&&_.isUndefined(a.sub_id)?(e.isLoading=!0,o.getFolderAssets(a._id).then(p)):a._id&&a.sub_id?(e.showToolNewFolder=!1,e.isLoading=!0,o.getFolderAssets(a.sub_id).then(p)):o.getAllAssets().then(p)},e.refreshAssets(),e.showAllFiles=function(){console.log("$state.current.name:",i.current.name),"main.presentation"==i.current.name?(e.activePage="Assets",e.refreshAssets()):i.go("main.presentation")},e.showAllTrash=function(){console.log("$state.current.name:",i.current.name),"main.presentation_trash"==i.current.name?(e.activePage="Trash",e.refreshAssets()):i.go("main.presentation_trash")},e.showAllStarred=function(){"main.presentation_starred"==i.current.name?(e.activePage="Favorites",e.refreshAssets()):i.go("main.presentation_starred")},e.castModal=function(){var e=t.open({animation:!0,templateUrl:"./views/folder/cast.html",size:"lg",windowClass:"xd-modal",controller:"assetsMirrorModalCtrl"});e.result.then(function(){})},e.newFolder=function(){var e=t.open({animation:!0,templateUrl:"./views/folder/new-item.html",size:"sm",windowClass:"xd-modal",controller:"presentationFolderModalCtrl"});e.result.then(function(e){e&&i.reload()})},e.newUploader=function(){var s=t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/uploader.html",size:"lg",controller:"assetsUploadModalCtrl"});s.result.then(function(s){s&&e.refreshAssets()})},e.copySelected=function(){var e=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/copy.html",controller:"modalpresentation"});e.result.then(function(e){},function(){console.info("Modal dismissed at: "+new Date)})},e.shareToOthers=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/share.html",controller:"assetsShareModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){},function(){console.info("Modal dismissed at: "+new Date)})},e.renameSelected=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/rename.html",controller:"assetsRenameModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&i.reload()})},e.deleteSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))}console.log("deleteSelected"),e.modal={title:"Remove?",message:"Are you sure to remove this?"},d.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){_.isEmpty(e.selectedFile)||(e.selectedFile.isFolder?e.selectedFile.isDeleted?o.deleteFolder(e.selectedFile._id).then(s):o.trashFolder(e.selectedFile._id).then(s):e.selectedFile.isDeleted?o.deleteAssetFile(e.selectedFile._id).then(s):o.trashAssetFile(e.selectedFile._id).then(s))})},e.moveSelected=function(){var s=t.open({animation:!0,windowClass:"xd-modal",templateUrl:"./views/folder/move.html",controller:"assetsMoveModalCtrl",resolve:{asset_file:function(){return e.selectedFile}}});s.result.then(function(e){e&&i.reload()})},e.previewSelected=function(){e.selectedFile&&(e.selectedFile.isFolder?e.openFolder(e.selectedFile):e.openFile(e.selectedFile))},e.starredSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?o.starredFolder(e.selectedFile._id).then(s):o.starredAssetFile(e.selectedFile._id).then(s))},e.restoreSelected=function(){function s(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))}e.selectedFile&&(e.selectedFile.isFolder?o.restoreFolder(e.selectedFile._id).then(s):o.restoreAssetFile(e.selectedFile._id).then(s))},e.openLightboxModal=function(e){var s=[];s.push({url:e.asset_url,caption:e.asset_name,thumbUrl:e.asset_url}),n.openModal(s,0)},e.openVideoModal=function(e){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/media.html",controller:"assetsMediaModalCtrl",windowClass:"xd-modal",size:"lg",resolve:{files:function(){return e},type:function(){return"video"}}})},e.openAudioModal=function(e){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/media.html",controller:"assetsMediaModalCtrl",windowClass:"xd-modal",size:"md",resolve:{files:function(){return e},type:function(){return"audio"}}})},e.openDocsModal=function(e){t.open({animation:!0,backdrop:"static",templateUrl:"./views/folder/preview.html",controller:"assetsDocsModalCtrl",size:"lg",windowClass:"modal-fullscreen xd-modal",resolve:{files:function(){return e}}})},e.openFolder=function(s){console.log("openFolder: ",s),s.isFolder&&("main.presentation_trash"!==i.current.name?a._id?i.go("main.opensubfolder",{_id:a._id,sub_id:s._id}):i.go("main.openfolder",{_id:s._id}):(e.modal={title:"This folder is in your trash",message:"To view this folder, youll need to restore it from your trash. Restore folder?"},d.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.restoreFolder(s._id).then(function(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))})})))},e.openFile=function(s){if("image/jpeg"==s.asset_mimetype||"image/jpg"==s.asset_mimetype||"image/gif"==s.asset_mimetype||"image/x-ms-bmp"==s.asset_mimetype||"image/png"==s.asset_mimetype)e.openLightboxModal(s);else if("audio/mp3"==s.asset_mimetype||"audio/mp4"==s.asset_mimetype)e.openAudioModal(s);else if("video/mp4"==s.asset_mimetype||"video/x-flv"==s.asset_mimetype||"video/x-msvideo"==s.asset_mimetype||"video/x-ms-wmv"==s.asset_mimetype||"video/quicktime"==s.asset_mimetype||"video/3gpp"==s.asset_mimetype)e.openVideoModal(s);else if("application/pdf"==s.asset_mimetype)e.openDocsModal(s);else if("text/plain"==s.asset_mimetype)e.openDocsModal(s);else if("application/msword"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.wordprocessingml.document"==s.asset_mimetype)e.openDocsModal(s);else if("text/csv"==s.asset_mimetype||"application/vnd.ms-excel"==s.asset_mimetype||"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"==s.asset_mimetype)e.openDocsModal(s);else{if("application/vnd.openxmlformats-officedocument.presentationml.presentation"!=s.asset_mimetype&&"application/vnd.ms-powerpoint"!=s.asset_mimetype)return void l.warning("No available tools to open","Failed");e.openDocsModal(s)}},e.deleteFile=function(s){console.log("media: ",s),e.modal={title:"Remove File",message:"Are you sure to remove the file?"},d.openConfirm({templateUrl:"./views/folder/customDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){o.deleteAssetFile(s._id).then(function(e){200==e.statusCode&&e.response.success&&(l.success(e.response.msg,"Success"),r(function(){i.reload()},200))})})},e.clearSelection=function(){console.log("clearSelection"),e.selectedFile={},e.showBarDelete=!1,e.showBarRestore=!1,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,e.showToolOpen=!1,_.each(e.assets.folders,function(e){e.isActive=!1}),_.each(e.assets.assets,function(e){e.isActive=!1})},e.searchData=function(){_.isEmpty(e.txtSearch)||"main.presentation_trash"!=i.current.name?_.isEmpty(e.txtSearch)&&"main.presentation_trash"==i.current.name?(e.assets.folders=e.trash.folderscopy,e.assets.assets=e.trash.assetscopy):_.isEmpty(e.txtSearch)||"main.presentation_starred"!=i.current.name?_.isEmpty(e.txtSearch)&&"main.presentation_starred"==i.current.name?(e.assets.folders=e.starred.folderscopy,e.assets.assets=e.starred.assetscopy):_.isEmpty(e.txtSearch)||"main.presentation"!=i.current.name?_.isEmpty(e.txtSearch)&&"main.presentation"==i.current.name&&(e.assets.folders=e.assets.folderscopy,e.assets.assets=e.assets.assetscopy):(e.assets.folders=c("filter")(e.assets.folderscopy,e.txtSearch),e.assets.assets=c("filter")(e.assets.assetscopy,e.txtSearch)):(e.assets.folders=c("filter")(e.starred.folderscopy,e.txtSearch),e.assets.assets=c("filter")(e.starred.assetscopy,e.txtSearch)):(e.assets.folders=c("filter")(e.trash.folderscopy,e.txtSearch),e.assets.assets=c("filter")(e.trash.assetscopy,e.txtSearch)),_.each(e.assets.folders,function(e){var s=_.sumBy(e.files,function(e){return e.asset_filesize});e.folder_filesize=m(s),e.isActive=!1,e.isFolder=!0}),_.each(e.assets.assets,function(e){e.asset_filesize=m(e.asset_filesize),e.isActive=!1,e.isFolder=!1})},e.selectAll=function(){e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,_.each(e.assets.folders,function(e){e.isActive=!0}),_.each(e.assets.assets,function(e){e.isActive=!0})},e.activeSelected=function(s){console.log("folder: ",s),s&&(s.isActive=!0,"main.presentation_trash"==i.current.name?(e.showBarDelete=!0,e.showBarRestore=!0,e.showBarShare=!1,e.showBarMore=!1,e.showToolPreview=!1,e.showToolOpen=!1,e.showToolMakeCopy=!1):(e.showBarDelete=!0,e.showBarRestore=!1,e.showBarShare=!0,e.showBarMore=!0,s.isFolder?(e.showToolPreview=!1,e.showToolOpen=!0,e.showToolMakeCopy=!1):(e.showToolPreview=!0,e.showToolOpen=!1,e.showToolMakeCopy=!0)),e.selectedFile=s,_.each(e.assets.folders,function(e){e._id!==s._id&&(e.isActive=!1)}),_.each(e.assets.assets,function(e){e._id!==s._id&&(e.isActive=!1)}))}}angular.module("tessaApp").controller("presentationCtrl",e),e.$inject=["$scope","localStorageService","$uibModal","assetsFctry","$stateParams","$state","toastr","$timeout","Lightbox","ngDialog","$filter"]}();

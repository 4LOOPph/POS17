...
!function(){"use strict";function e(e,s,t,i,o,c,a,n,l){function d(){s.reload()}function r(e){console.log("Error: ",e)}e.audio="audio"==c,e.onReady=function(e){e.autoPlay=!0},e.config={autoPlay:!0,sources:[{src:o.trustAsResourceUrl(i.asset_url),type:i.asset_mimetype}],theme:{url:"http://www.videogular.com/styles/themes/default/latest/videogular.css"}},e.device={},e.asset_file=i,e.displayInstallPlugin=!1,e.activeDevices=[],a.on("pair:sendCode",function(s){_.find(e.activeDevices,{deviceUUID:s.deviceUUID})||e.activeDevices.push(s)}),DetectRTC.screen.getChromeExtensionStatus(function(s){"installed-enabled"!=s&&(DetectRTC.screen.chromeMediaSource="desktop",l(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),e.selectDevice=function(s){console.log("selectDevice"),e.device=s,e.device?(e.device.connected=!0,"audio/mp3"==e.asset_file.asset_mimetype||"audio/mp4"==e.asset_file.asset_mimetype?e.asset_file.asset_type="audio":"video/mp4"==e.asset_file.asset_mimetype||"video/x-flv"==e.asset_file.asset_mimetype||"video/x-msvideo"==e.asset_file.asset_mimetype||"video/x-ms-wmv"==e.asset_file.asset_mimetype||"video/quicktime"==e.asset_file.asset_mimetype||"video/3gpp"==e.asset_file.asset_mimetype?e.asset_file.asset_type="video":e.asset_file.asset_type="none",e.asset_file.deviceUUID=e.device.deviceUUID,e.device.asset_file=e.asset_file):(document.body.webkitRequestFullScreen(),console.log("container.webkitRequestFullScreen();"))},e.starredSelected=function(){function s(s){200==s.statusCode&&s.response.success&&(toastr.success(s.response.msg,"Success"),e.asset_file.isStarred=1)}e.asset_file&&(e.asset_file.isFolder?n.starredFolder(e.asset_file._id).then(s):n.starredAssetFile(e.asset_file._id).then(s))},e.cancel=function(){e.device&&a.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}),t.dismiss("cancel")},e.installPlugin=function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/your-chrome-extension-id",d,r)}}function s(e,s,t,i,o,c,a,n,l,d){function r(){s.reload()}function u(e){console.log("Error: ",e)}e.pdfName=o.media_name,e.file_type=o.asset_mimetype,e.device={},e.activeDevices=[],e.onMouseMoveResult="",e.displayInstallPlugin=!1;var m,p=o;DetectRTC.screen.getChromeExtensionStatus(function(s){"installed-enabled"!=s&&(DetectRTC.screen.chromeMediaSource="desktop",d(function(){e.$apply(function(){e.displayInstallPlugin=!0})},10))}),"application/pdf"==o.asset_mimetype?e.pdfUrl=i.trustAsResourceUrl(o.asset_url):"text/plain"==o.asset_mimetype?e.pdfUrl=i.trustAsResourceUrl("https://docs.google.com/gview?url="+o.asset_url+"&embedded=true"):e.pdfUrl=i.trustAsResourceUrl("https://view.officeapps.live.com/op/view.aspx?src="+o.asset_url),e.stop=function(){l.cancel(m)},e.selectDevice=function(s){e.device=s,e.device?(e.device.connected=!0,"audio/mp3"==p.asset_mimetype||"audio/mp4"==p.asset_mimetype?p.asset_type="audio":"video/mp4"==p.asset_mimetype||"video/x-flv"==p.asset_mimetype||"video/x-msvideo"==p.asset_mimetype||"video/x-ms-wmv"==p.asset_mimetype||"video/quicktime"==p.asset_mimetype||"video/3gpp"==p.asset_mimetype?p.asset_type="video":p.asset_type="none",p.deviceUUID=e.device.deviceUUID,e.device.asset_file=p):(document.body.webkitRequestFullScreen(),console.log("container.webkitRequestFullScreen();"))},e.cancel=function(){e.device&&a.emit("pair:closePresent",{deviceUUID:e.device.deviceUUID}),e.stop(),t.dismiss("cancel")},e.installPlugin=function(){!!navigator.webkitGetUserMedia&&!!window.chrome&&!!chrome.webstore&&!!chrome.webstore.install&&chrome.webstore.install("https://chrome.google.com/webstore/detail/your-chrome-extension-id",r,u)},a.on("pair:sendCode",function(s){_.find(e.activeDevices,{deviceUUID:s.deviceUUID})||e.activeDevices.push(s)})}angular.module("tessaApp").controller("assetsMediaModalCtrl",e).controller("assetsDocsModalCtrl",s),e.$inject=["$scope","$state","$uibModalInstance","files","$sce","type","socket","assetsFctry","$timeout"],s.$inject=["$scope","$state","$uibModalInstance","$sce","files","localStorageService","socket","$window","$interval","$timeout"]}();

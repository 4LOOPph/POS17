...
!function(){"use strict";angular.module("tessaApp").run(["$location","APIFactory","$rootScope","$window","$state","localStorageService","$frontierAnalytics","usSpinnerService","AuthFactory","jwtHelper","API_URL","EXT_ID","toastr","$filter","$timeout",function(e,t,n,r,i,s,a,o,c,u,l,p,d,g,h){n._=window._,window.API_URL=l,window.EXT_ID=p,n.compareproducts=[],n.allproducts=[],n.cartItems=[],n.cartItems=_.isEmpty(s.get("Cart"))?[]:JSON.parse(s.get("Cart")),n.compareproducts=_.isEmpty(s.get("ProductsCompare"))?[]:JSON.parse(s.get("ProductsCompare")),a.debugMode(!1),a.allowPageTracking(!0),a.allowEventTracking(!0),a.allowViewTracking(!0),a.allowAppTracking(!0),a.allowDeviceTracking(!0),a.Initialize({accessCode:"958441082755103",trackerName:"project-tessa",encoding:"utf-8"});var f=function(){async.waterfall([function(e){t.getArticles(function(t,n){_.each(n.response.result,function(e){e.type="Experience"}),_.each(n.response.result,function(e){e.name=e.title,e.id=e.article_id}),e(null,n.response.result)})},function(e,n){t.getProductBundle(function(t,r){_.each(r.response.result,function(e){e.type="Solutions"}),_.each(r.response.result,function(e){e.name=e.bundle_name,e.id=e.pb_id}),n(null,e,r.response.result)})},function(e,n,r){var i=[];t.getProductStatus("publish").then(function(t){i=_.filter(t.response.result,function(e){return"Hardware"==e.product_type}),_.each(i,function(e){e.type="Hardware"}),_.each(i,function(e){e.name=e.item_name,e.id=e.p_id}),r(null,e,n,i)})},function(e,n,r,i){var s=[];async.each(r,function(e,n){t.getProductAttribute(e.p_id,function(t,r){if(200==r.statusCode&&r.response.success&&e.p_id==r.response.result.p_id){var i=r.response.result.attribute_values;i&&i.length>0?e.attributes=r.response.result.attribute_values:e.attributes=null,n()}})},function(t,a){_.each(r,function(e){1==e.is_published&&0==e.is_archived&&s.push(e)}),i(null,e,n,r,s)})},function(e,t,r,i,s){var a=[];_.each(i,function(e){_.isNull(e.attributes)||a.push(e.attributes)}),a=_.flattenDeep(a),n.Brightness=g("filter")(a,{attribute:"Brightness"}),n.Bezel=g("filter")(a,{attribute:"Bezel Size"}),n.Usage=g("filter")(a,{attribute:"Usage"}),n.Brightness=_.uniqBy(n.Brightness,"value"),n.Bezel=_.uniqBy(n.Bezel,"value"),n.Usage=_.uniqBy(n.Usage,"value");var o=[];_.each(i,function(e){1==e.is_published&&0==e.is_archived&&o.push(e)}),_.each(t,function(e){1==e.is_published&&0==e.is_archived&&o.push(e)}),_.each(e,function(e){1==e.is_active&&o.push(e)}),s(null,i,t,e),n.allproducts=angular.copy(o)}])};if(c.getCurrentUser()){var m=JSON.parse(s.get("appuser"));f(),a.setUserId(_.toString(m.uc_id))}n.$on("InitializeData",function(){f()}),n.$on("loading:progress",function(){o.spin("spinner-1")}),n.$on("loading:finish",function(){o.stop("spinner-1")}),n.$on("app:reload",function(){h(function(){r.location.reload()},1e3)}),n.goBack=function(){r.history.back()},c.getCurrentUser()&&f(),n.$on("$stateChangeStart",function(t,r,a,o,l){if(n.compareIs=!0,_.isNull(c.getCurrentUser()))"login"!==r.name&&"forget-password"!==r.name&&"publicshare"!==r.name&&(n.requested=e.$$absUrl,t.preventDefault(),i.go("login"));else{var p=c.getUserToken();JSON.parse(s.get("appuser"));u.isTokenExpired(p)?c.logout().then(function(){n.$broadcast("app:reload"),e.path("/login")}):"login"==r.name&&(t.preventDefault(),i.go("main.experience"))}n.isHide=!1,n.toggleShow=function(){n.isHide=!n.isHide},n.width=Math.max(document.documentElement.clientWidth,window.innerWidth||0),n.height=Math.max(document.documentElement.clientHeight,window.innerHeight||0),n.hideNav=function(){n.isHide=!1},n.compare=function(e){console.log("items:",e);var t={},r=0;if(r=n.width<=500&&n.height<=975?2:n.width<=975&&n.height<=500?2:4,_.isEmpty(n.compareproducts))d.success("Successfully Added","Success"),n.compareIs=!1,n.compareproducts.push(e),s.set("ProductsCompare",JSON.stringify(n.compareproducts));else if(n.compareproducts.length>=1&&n.compareproducts.length<r){var i=_.filter(n.compareproducts,{_id:e._id});i.length>0?d.error("Oops. The selected item has already been added.","Warning"):(_.each(n.compareproducts,function(e,n){0==n&&(t=e)}),t.category_id==e.category_id?(d.success("Successfully Added","Success"),n.compareIs=!1,n.compareproducts.push(e),s.set("ProductsCompare",JSON.stringify(n.compareproducts))):d.error("Oops. The selected item is incomparable to the existing item(s).","Error"))}else d.error("Oops. You can not compare more than "+r+" items.","Error")}}),n.$on("$stateChangeSuccess",function(e,t,r,i,s){n.appuser=JSON.parse(c.getCurrentUser("appuser")),n.currentUser=c.getCurrentUser(),n.label="Solutions","main.search"==t.name&&f(),a.trackPage(t.name,t.url,t.templateUrl)})}])}();

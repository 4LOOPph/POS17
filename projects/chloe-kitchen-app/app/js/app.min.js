...
!function(){"use strict";function e(e,o,n,r,t,a,i,d){function c(){if(e.menuRecords&&e.menuRecords.length>0){var o=_.map(e.menuRecords,function(e){return e.orders}),n=_.flattenDeep(o);_.each(e.orderSum,function(o){var r=[],t=_.filter(n,{producttypeId:o.menuCode}),a=_.uniqBy(t,"tableno");_.each(a,function(n){if(n.producttypeId==o.menuCode){var t=_.find(e.menuRecords,{tableno:n.tableno});t?r.push(t):r=[]}}),o.menu=r}),_.each(e.menuRecords,function(e){e.orders.sort(function(e,o){return e.checked-o.checked})})}else _.each(e.orderSum,function(e){delete e.menu});console.log("SAVE $scope.menuRecords: ",e.menuRecords),r.localStorage.setItem("kitchen_orders",JSON.stringify(e.menuRecords))}e.menuRecords=[],e.orderSum=a,e.checkzz=!1,e.limit=10,e.clearDone=!1;e._menuRecords=[],o(function(){e.CurrentDate=new Date},1e3),n.on("connect",function(){console.log("socket connected...."),n.emit("register:device","Chloe"),n.on("VoidOrSuccessTo:OrderApp",function(o){if(console.log("billout: ",o),!_.isEmpty(o)){var n=_.find(e.menuRecords,{tableno:o.tableno});_.isEmpty(n)||(e.menuRecords=_.reject(e.menuRecords,{tableno:o.tableno})),c(),i(function(){d.reload()},1e3)}}),n.on("sendto:Kitchen",function(o){if(console.log("sendto:Kitchen: ",o),!_.isEmpty(o)){o.ready=!1,o.serve=!1,o.isDone=!1,o.isPaid=!1,_.isNull(o.datetime)?o.datetime1=t().format("LT"):o.datetime1=t(o.datetime).format("LT");var n=JSON.parse(r.localStorage.getItem("kitchen_orders"))||[];if(!_.isEmpty(o)){var a=_.find(n,{tableno:o.tableno});console.log("result: ",a),_.isEmpty(a)?(_.each(o.orders,function(e){e.checked=!1,e.tableno=o.tableno,e.isDone=!1}),e.menuRecords.push(o)):(_.each(n,function(e){if(e.tableno==o.tableno)if(e.orders.length<=o.orders.length)console.log("Less than ==> New orders"),_.each(o.orders,function(o){var n=_.find(e.orders,{p_id:o.p_id});_.isEmpty(n)&&e.orders.unshift(o)});else if(e.orders.length>=o.orders.length){console.log("greater than ==> remove orders: ");var n=[];_.each(o.orders,function(o){var r=_.find(e.orders,{p_id:o.p_id});_.isEmpty(r)||n.push(r)}),e.orders=n}else console.log("else")}),e.menuRecords=n)}c(),i(function(){d.reload()},1e3)}})});var s=JSON.parse(r.localStorage.getItem("kitchen_orders"))||[];_.isEmpty(s)||(e.menuRecords=s,c(),console.log("filter"),o(function(){e.menuRecords&&e.menuRecords.length>0?_.each(e.menuRecords,function(o){var n=t(new Date),r=t(o.datetime),a=n.diff(r),i=t.duration(a).asMinutes();Math.floor(i)>1?(o.isLapsed=!0,o.lapsedTime=Math.floor(i)):o.isLapsed=!1,o.serve&&(e.clearDone=!0)}):e.clearDone=!1},1e3)),e.hmSwipeleft=function(o,r){_.each(e.menuRecords,function(e){if(e.orders&&e.orders.length>0){var r=_.filter(e.orders,{p_id:o.p_id,checked:!0});r&&r.length>0?(r=r[0],r.isDone=!0):r.isDone=!1;var a=_.filter(e.orders,{isDone:!0});if(a&&a.length==e.orders.length){e.ready=!0;var i={roomname:"Chloe",tableno:e.tableno,datetime:t().format("LT"),serve:!1,done:!1};return void n.emit("ReceiveData:sendingTo:Que",i)}e.ready=!1}}),c()},e.checkChecked=function(o){_.each(e.menuRecords,function(e){if(e.orders&&e.orders.length>0){var o=_.filter(e.orders,{checked:!0});o&&o.length>0?e.checked=!0:e.checked=!1}}),c()},e.transparentcheck=function(o){_.each(e.orderSum,function(e){_.each(e.menu,function(e){var o=_.filter(e.orders,{checked:!0});if(o&&o.length?e.checked=!0:e.checked=!1,o&&o.length==e.orders.length){e.ready=!0;var r={roomname:"Chloe",tableno:e.tableno,datetime:t().format("LT"),orders:e.orders,serve:!1,done:!1};return void n.emit("ReceiveData:sendingTo:Que",r)}e.ready=!1}),c()})},e.serveOrder=function(o){console.log("serveOrder: ",o),_.each(e.menuRecords,function(r){if(r.tableno==o.tableno&&!r.serve){r.serve=!0;var a={roomname:"Chloe",tableno:o.tableno,datetime:t().format("LT"),orders:r.orders,serve:!0,done:!1};n.emit("ReceiveData:sendingTo:Que",a),e.clearDone=!0}}),c()},e.doneOrder=function(o){console.log("doneOrder: ",o),_.each(e.menuRecords,function(e){if(e.tableno==o.tableno&&e.serve&&!e.isDone){e.isDone=!0;var r={roomname:"Chloe",tableno:o.tableno,datetime:t().format("LT"),serve:!0,orders:e.orders,done:!0};n.emit("ReceiveData:sendingTo:Que",r)}}),c(),i(function(){d.reload()},1e3)},e.removeAllDone=function(){_.each(e.menuRecords,function(e){if(e.serve){e.isDone=!0;var o={roomname:"Chloe",tableno:e.tableno,datetime:t().format("LT"),serve:!0,done:!0};n.emit("ReceiveData:sendingTo:Que",o)}}),c(),i(function(){d.reload()},1e3)},e.generateRandomData=function(){var o=["Vcuie","Loy2x","Estoy","LuckyBoy","Pipoy","EJBoy","Dodong"],n=["Dine - In","Take - Out","Deliver"],r=[{quantity:_.random(1,5),item_name:"Chicken Binakol",p_id:_.uniqueId()},{quantity:_.random(1,5),item_name:"Pork Sisig",p_id:_.uniqueId()},{quantity:_.random(1,5),item_name:"Sinuglaw",p_id:_.uniqueId()},{quantity:_.random(1,5),item_name:"Sack Rice",p_id:_.uniqueId()}],i=_.random(1,15);_.each(r,function(e){var o=_.sample(a);e.producttypename=o.menuType,e.producttypeId=o.menuCode,e.checked=!1,e.tableno=i});var d={orderstatus:_.sample(n),tableno:i,waitername:_.sample(o),orders:r,datetime:t().format(),datetime1:t().format("LT"),roomname:"Chloe",ready:!1,serve:!1,isDone:!1,isPaid:!1};e.menuRecords.push(d),c()}}angular.module("chloe").controller("MainCtrl",e),e.$inject=["$scope","$interval","mySocket","$window","moment","Category","$timeout","$state"]}();

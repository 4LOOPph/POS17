...
!function(){"use strict";function e(e,t,s,o,n,r,i,a,l,u,d,c,p,f,m,g,h){function v(t){if(t)return _.find(e.suppliers,function(e){return e.s_id==t})}function P(){e.items.quantity=null,e.items.price=null,e.items.total=null,e.items.product={}}e.isColl=!1,e.radioModel="product",e.products=[],e.productBundles=[],e.items={},e.suppliers=[],e.customers=[],e.stores=[],e.details={},e.details.products_list=[],e.details.details=[];var M=!1,b=5e3;e.showMessage=!1,e.showsecondMessage=!1,e.showExportMessage=!1,e.enAbleToSendForm,e.profile={},e.datenow=h(new Date).format("MMMM Do YYYY"),e.doGreeting=function(){M&&a.cancel(M),e.showMessage=!0,M=a(function(){e.showMessage=!1,e.showsecondMessage=!0,M=a(function(){e.showsecondMessage=!1},2e3)},b)},e.doExport=function(){M&&a.cancel(M),e.showExportMessage=!0,M=a(function(){e.showExportMessage=!1,e.showsecondExportMessage=!0,M=a(function(){e.showsecondExportMessage=!1},2e3)},b)},e.changeData=function(t){e.radioModel=t},e.getoveralltotal=function(t){e.overalltotal=_.sumBy(t,function(e){return e.price*e.quantity})},e.getGeneratedPOId=function(){f.generatepoid().then(function(t){e.details.po_number=t.response.result})},e.loadpo=function(){f.getAllPurchaseOrderDetail(r.selected_id).then(function(t){t&&200==t.statusCode&&t.response.success&&(e.details=t.response.result,e.details.emailsubject="PO Number "+e.details.po_number,e.getoveralltotal(e.details.details))})},d.getAllSuppliers().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.suppliers=t.response.result)}),p.getAllPerson().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.customers=_.filter(t.response.result,function(e){return 2==e.per_type_id}))}),u.getAllProduct().then(function(t){if(t&&200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){0==t.is_archived&&null!=t.store_name&&e.products.push(t)})}}),m.getAllStore().then(function(t){t&&200==t.statusCode&&t.response.success&&(e.stores=t.response.result)}),u.getAllProductBundle().then(function(t){if(t&&200==t.statusCode&&t.response.success){var s=t.response.result;_.each(s,function(t){1!==t.is_archived&&e.productBundles.push(t)})}}),e.calculateItem=function(e){var t=0,s=0,s=e.price*e.quantity;return t+=parseFloat(s),e.total=t,e.total},e.parseDate=function(e){if(e)return h(new Date(e)).format("MMMM Do YYYY")},e.getCurrentUser=function(){t.userprofile().then(function(t){if(200==t.statusCode&&t.response.success)e.profile=t.response.result,e.currentemail=e.profile.profile.email,e.details.currentemail=e.profile.profile.email,e.details.store_id=e.profile.profile.store_id;else if(400==t.statusCode&&!t.response.success)return void l.error(t.response.msg,"Error")})},e.toast_emailnotifs=function(e){"Sent"==e||"sent"==e?l.success("Email Sent","Success"):l.warning("Email not Sent","Warning")},e.currentPage=1,e.entryLimit=5,e.selectDeselectAll=!1,e.applicationStatus="All",e.displayModel="List",e.viewby=25,e.pageSize=e.viewby,e.currentPage=1,e.itemsPerPage=20,e.totalUsers=0,e.addToList=function(t){_.isEmpty(t)?l.warning("Product list could not empty","Warning"):"product"==e.radioModel?_.isUndefined(t)||(e.details.details.push({item_name:t.product.item_name,quantity:t.quantity,price:t.price,discount:t.discount,total:t.total,product_id:t.product.p_id,bundle_id:null}),e.getoveralltotal(e.details.details),P()):"productgroup"==e.radioModel&&(_.isUndefined(t.productgroup)||(e.details.details.push({item_name:t.productgroup.bundle_name,quantity:t.quantity,price:t.price,discount:t.discount,total:t.total,product_id:null,bundle_id:t.productgroup.pb_id}),e.getoveralltotal(e.details.details),P()))},e.approvedPO=function(){var e={approved_by:r.selected_id};f.approvedPurchasedOrder(r.selected_id,e).then(function(e){e&&200==e.statusCode&&e.response.success?l.success(e.response.msg,"Success"):l.error(e?e.response.msg:"Error Found","Eror")})},e.savePO=function(t){var o=JSON.parse(s.get("user"));e.details.created_by=o.uc_id,e.details.emailmessage="",e.details.toSend=t,e.details.products_list=e.details.details,e.details.supplier_id&&e.details.deliver_to&&e.details.po_number?(e.details.suppliername=v(e.details.supplier_id).name,r.selected_id?(console.log("updating PO."),f.updatePurchaseOrder(r.selected_id,e.details).then(function(s){if(s&&200==s.statusCode&&s.response.success){l.success(s.response.msg,"Success");r.selected_id;t&&e.approvedPO(),i.go("main.view_savepo",{selected_id:r.selected_id})}else l.error(s?s.response.msg:"Error Found","Eror");t?e.toast_emailnotifs(s&&s.response.email?s.response.email:"Error Found"):""})):(console.log("saving PO."),f.savePurchaseOrder(e.details).then(function(s){if(s&&200==s.statusCode&&s.response.success){l.success(s.response.msg,"Success");var o=s.response.result.inserted_po_id;t&&e.approvedPO(),i.go("main.view_savepo",{selected_id:o})}else l.error(s?s.response.msg:"Error Found","Eror");t?e.toast_emailnotifs(s&&s.response.email?s.response.email:"Error Found"):""}))):l.warning("Fill in all the required fields in the first tab","Warning")},e.toggleModal=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){console.log(".."),e.backto_fstpasge()},function(e){console.log("reason ",e)})},e.calculateItems=function(t){var s=0,o=0;_.each(e.details.products_list,function(e){var t=e.price-e.discount;s=t*e.quantity,o+=parseFloat(s)}),e.details.sub_total=o,e.calculateBilling()},e.calculateBilling=function(){e.total=parseFloat(e.details.sub_total||0)+parseFloat(e.details.tax||0)+parseFloat(e.details.shipping_fee||0)},e.removeProduct=function(t){e.details.details.splice(t,1)},e.edit=function(e){i.go("main.products-add",{p_id:e})},e.openPOUpdateModal=function(t){e.enAbleToSendForm=t,t?e.details.po_status="Sent":e.details.po_status="Open",e.details.emailsubject="PO Number "+e.details.po_number,g.openConfirm({templateUrl:"./modules/purchase_order/po.update.modal.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){e.savePO(t)},function(e){console.log("Modal promise close: ")})},e.open_scndpage=function(){e.fstpasge=!1,e.scndpage=!0},e.onSelectedProduct=function(t){e.items.price=t.sell_price},e.goback=function(){i.go("main.purchase_order")},e.init=function(){e.getCurrentUser(),r.selected_id?e.loadpo():e.getGeneratedPOId()},e.init()}angular.module("POS17").controller("addOrderController",e),e.$inject=["$scope","AuthFctry","localStorageService","$http","$filter","$stateParams","$state","$timeout","toastr","productFactory","supplierFctry","ngTableParams","humanFactory","purchaseOrderFactory","storeFactory","ngDialog","moment"]}();
...
!function(){"use strict";function e(e,t,s,r,a,n,o,i,l,d,c,p,u,f,m,g,h,v){function S(t){var s=[];_.each(e.details,function(e){s.push({product_id:e.product_id,price:e.splycst,quantity:e.qtyrecv,quantity_ordered:e.quantity,stock_onhand:e.stock_onhand,fk_store_id:e.fk_store_id})});return s}e.datenow=h(new Date).format("MMMM Do YYYY"),e.parent_details={},e.details=[],e.po_status="",e.po_id="",e.enAbleToSendForm,e.params={},e.params.arrOfPOIds=[],e.details2=[],e.specialVar1=[],e.specialVar2=[],n.selected_id&&(e.po_id=n.selected_id,f.getAllPurchaseOrderDetail(e.po_id).then(function(t){if(t&&200==t.statusCode&&t.response.success){e.parent_details=t.response.result,e.details=t.response.result.details,e.parent_details.products_list=e.details,e.parent_details.emailsubject="PO Number "+e.parent_details.po_number,e.fstpasge=!1,e.scndpage=!0,e.getoveralltotal(e.details);var s=e.parent_details.po_status;"Open"==s||"open"==s||"OPEN"==s?e.po_status="Saved":"Sent"==s||"sent"==s||"SENT"==s?e.po_status="Sent":e.po_status=s,_.each(e.details,function(t,s){e.details[s].splycst=t.price})}else console.log("no data fetched !")}),e.getoveralltotal=function(t){e.overalltotal=_.sumBy(t,function(e){return e.price*e.quantity})},e.parseDate=function(e){if(e)return h(new Date(e)).format("MMMM Do YYYY")},e.backto_fstpasge=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){e.fstpasge=!0,e.scndpage=!1;n.selected_id;o.go("main.purchase_order")},function(e){console.log("reason ",e)})},e.getCurrentUser=function(){t.userprofile().then(function(t){if(200==t.statusCode&&t.response.success)e.profile=t.response.result,e.currentemail=e.profile.profile.email,e.parent_details.currentemail=e.profile.profile.email,e.parent_details.store_id=e.profile.profile.store_id;else if(400==t.statusCode&&!t.response.success)return void l.error(t.response.msg,"Error")})},e.toast_emailnotifs=function(e){"Sent"==e||"sent"==e?l.success("Email Sent","Success"):l.warning("Email not Sent","Warning")},e.cancelPO=function(){g.openConfirm({templateUrl:"modules/dialog/cancelDialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){var t=JSON.parse(s.get("user"));e.parent_details.created_by=t.uc_id,e.parent_details.suppliername=e.parent_details.supplier.name,e.parent_details.po_status="Cancelled",e.parent_details.products_list=e.details,e.parent_details.supplier_id&&e.parent_details.deliver_to&&e.parent_details.po_number?n.selected_id?f.updatePurchaseOrder(n.selected_id,e.parent_details).then(function(e){e&&200==e.statusCode&&e.response.success?(l.success("PO status Cancelled","Success"),o.reload()):l.error(e?e.response.msg:"Error Found","Eror")}):f.savePurchaseOrder(e.parent_details).then(function(e){e&&200==e.statusCode&&e.response.success?l.success("PO status Cancelled","Success"):l.error(e?e.response.msg:"Error Found","Eror")}):l.warning("Fill in all the required fields in the first tab","Warning")},function(e){console.log("reason ",e)})},e.approvedPO=function(){var e={approved_by:n.selected_id};f.approvedPurchasedOrder(n.selected_id,e).then(function(e){e&&200==e.statusCode&&e.response.success?l.success(e.response.msg,"Success"):l.error(e?e.response.msg:"Error Found","Eror")})},e.savePO2=function(t){var r=JSON.parse(s.get("user"));e.parent_details.created_by=r.uc_id,e.parent_details.po_status="Sent",e.parent_details.toSend=t,e.parent_details.products_list=e.details,e.parent_details.supplier_id&&e.parent_details.deliver_to&&e.parent_details.po_number?(e.parent_details.suppliername=e.parent_details.supplier.name,n.selected_id&&f.updatePurchaseOrder(n.selected_id,e.parent_details).then(function(s){if(s&&200==s.statusCode&&s.response.success){l.success(s.response.msg,"Success");n.selected_id;t&&(e.approvedPO(),o.reload())}else l.error(s?s.response.msg:"Error Found","Eror");t?e.toast_emailnotifs(s&&s.response.email?s.response.email:"Error Found"):""})):l.warning("Fill in all the required fields in the first tab","Warning")},e.openPOUpdateModal2=function(t){e.enAbleToSendForm=t,e.parent_details.po_status="",g.openConfirm({templateUrl:"./modules/purchase_order/po.sendsaved.modal.html",scope:e,className:"ngdialog-theme-default",appendClassName:"ngdialog-custom",width:"40%"}).then(function(){e.savePO2(t)},function(e){console.log("Modal promise close: ")})},e.updateReceiveItemScope=function(t,s){e.details[s].qtyrecv=e.specialVar1[s]},e.updateSupplyCostScope=function(t,s){e.details[s].splycst=e.specialVar2[s]},e.promptMsg1=function(t){e.specialVar1[t]="",l.warning("Receive count must be less than or equal to number of items ordered","Warning")},e.checkSpecialVar1=function(){var t=_.find(e.specialVar1,"");return t},e.receivePO=function(){e.obj={po_id:n.selected_id,receive_number:"",receive_date:h(new Date).format("MMMM Do YYYY, h:mm:ss a"),received_by:e.profile.profile.person_id,supplier_id:e.parent_details.supplier_id,products_list:S(),store_id:e.profile.profile.store_id},f.receivePurchasedOrder(e.obj).then(function(e){e&&200==e.statusCode&&e.response.success?(l.success(e.response.msg,"Success"),o.reload()):l.error(e?e.response.msg:"Error Found","Eror")})},e.reactivatePO=function(){l.warning("This Feature is not yet implemented..","Warning")},e.init=function(){e.getCurrentUser()},e.init())}angular.module("POS17").controller("viewSavedPOController",e),e.$inject=["$scope","AuthFctry","localStorageService","$http","$filter","$stateParams","$state","$timeout","toastr","productFactory","supplierFctry","ngTableParams","humanFactory","purchaseOrderFactory","storeFactory","ngDialog","moment"]}();
